...
/**
 * Adicionamos uma mensagem para quando nao houver fator de depreciação
 */
insert into iptucadlogcalc values (109, 'NÃO HÁ FATOR DE DEPRECIAÇÃO PARA O EXERCÍCIO ', 't');
insert into iptucadlogcalc values (110, 'NÃO HÁ VALOR DO METRO QUADRADO PARA O EXERCÍCIO ', 't');
insert into iptucadlogcalc values (108, 'NÃO HÁ FATOR DE COMERCIALIZAÇÃO PARA O EXERCÍCIO ', 't');
insert into iptucadlogcalc values (111, 'VERIFIQUE A TESTADA CADASTRADA PARA ESTA MATRÍCULA ', 't');
insert into iptucadlogcalc values (112, 'ÁREA DA CONSTRUÇÃO ZERADA', 't');
...
insert into db_sysfuncoesparam( db42_sysfuncoesparam ,db42_funcao ,db42_ordem ,db42_nome ,db42_tipo ,db42_tamanho ,db42_precisao ,db42_valor_default ,db42_descricao ) values ( 899 ,171 ,4 ,'iPercIsen' ,'numeric' ,0 ,0 ,'0' ,'PERCENTUAL DE ISENÇÃO' );
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'C2013401', 'Fabricação de adubos e fertilizantes organo-minerais' from cnae where not exists (select 1 from cnae where q71_estrutural = 'C2013401') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'C2013402', 'Fabricação de adubos e fertilizantes, exceto organo-minerais' from cnae where not exists (select 1 from cnae where q71_estrutural = 'C2013402') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'H5030103', 'Serviço de rebocadores e empurradores' from cnae where not exists (select 1 from cnae where q71_estrutural = 'H5030103') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'H5231103', 'Gestão de terminais aquaviários' from cnae where not exists (select 1 from cnae where q71_estrutural = 'H5231103') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'H5239701', 'Serviços de praticagem' from cnae where not exists (select 1 from cnae where q71_estrutural = 'H5239701') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'H5239799', 'Atividades auxiliares dos transportes aquaviários não especificadas anteriormente' from cnae where not exists (select 1 from cnae where q71_estrutural = 'H5239799') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'J5812301', 'Edição de jornais diários' from cnae where not exists (select 1 from cnae where q71_estrutural = 'J5812301') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'J5812302', 'Edição de jornais não diários' from cnae where not exists (select 1 from cnae where q71_estrutural = 'J5812302') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'J5822101', 'Edição integrada à impressão de jornais diários' from cnae where not exists (select 1 from cnae where q71_estrutural = 'J5822101') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'J5822102', 'Edição integrada à impressão de jornais não diários' from cnae where not exists (select 1 from cnae where q71_estrutural = 'J5822102') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'K64387', 'Bancos de câmbio e outras instituições de intermediação não-monetária' from cnae where not exists (select 1 from cnae where q71_estrutural = 'K64387') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'M7410299', 'Atividades de design não especificadas anteriormente' from cnae where not exists (select 1 from cnae where q71_estrutural = 'M7410299') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'N8020001', 'Atividades de monitoramento de sistemas de segurança eletrônico' from cnae where not exists (select 1 from cnae where q71_estrutural = 'N8020001') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'N8020002', 'Outras atividades de serviços de segurança' from cnae where not exists (select 1 from cnae where q71_estrutural = 'N8020002') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'S9412001', 'Atividades de fiscalização profissional' from cnae where not exists (select 1 from cnae where q71_estrutural = 'S9412001') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'S9609207', 'Alojamento de animais domésticos' from cnae where not exists (select 1 from cnae where q71_estrutural = 'S9609207') limit 1;
...
insert into cnae select nextval('cnae_q71_sequencial_seq'), 'S9609208', 'Higiene e embelezamento de animais domésticos' from cnae where not exists (select 1 from cnae where q71_estrutural = 'S9609208') limit 1;
...
insert into setorambulatorial
     select nextval('setorambulatorial_sd91_codigo_seq'), sd02_i_codigo, 'RECEPÇÃO', 1
       from unidades;
...
insert into setorambulatorial
     select nextval('setorambulatorial_sd91_codigo_seq'), sd02_i_codigo, 'CONSULTA MÉDICA', 3
       from unidades;
...
insert into db_viradacaditem values (33, 'CONFIGURAÇÕES DO CÁLCULO DA CARGA HORÁRIA');
...
-- Tabela temporario para armazenar as configurações dos últimos 3 anos
...
-- Novas configurações do ISSQN Váriavel
...
-- Inclui configurações dos 3 anos anteriores da virada em uma tabela temporaria
...
-- Inclui valores iniciais para as novas configurações do ISSQN Váriavel das 3 competências anteriores
...
select fc_executa_ddl('
  insert into db_layouttxt values (222, \'SIAFEM - EXPORTAÇÃO\', 0, \'\', 1);
  ...
  insert into db_layoutcampos values (11876, 727, \'numero_lote\', \'NÚMERO DO LOTE\', 1, 2, \'\', 5, false, true, \'d\', \'0\', 0);
  insert into db_layoutcampos values (11877, 727, \'data_geracao_lote\', \'DATA DE GERAÇÃO DO LOTE\', 1, 7, \'\', 8, false, true, \'d\', \'0\', 0);
  insert into db_layoutcampos values (11878, 727, \'hora_geracao_lote\', \'HORA DE GERAÇÃO DO LOTE\', 1, 15, \'\', 4, false, true, \'d\', \'0\', 0);
  insert into db_layoutcampos values (11879, 727, \'ano_referencia\', \'ANO DE REFERÊNCIA\', 1, 19, \'\', 4, false, true, \'d\', \'0\', 0);
  insert into db_layoutcampos values (11880, 727, \'ug_responsavel\', \'UNIDADE GESTORA RESPONSÁVEL\', 1, 23, \'\', 6, false, true, \'d\', \'0\', 0);
  insert into db_layoutcampos values (11881, 727, \'gestao\', \'GESTÃO\', 1, 29, \'\', 5, false, true, \'d\', \'0\', 0);
  ...
  insert into db_layoutcampos values (11884, 728, \'data_emissao\', \'DATA DE EMISSÃO\', 1, 2, \'\', 9, false, true, \'d\', \'\', 0);
  insert into db_layoutcampos values (11885, 728, \'numero_empenho\', \'NUMERO DO EMPENHO\', 1, 11, \'\', 20, false, true, \'d\', \'\', 0);
  insert into db_layoutcampos values (11886, 728, \'gestao\', \'GESTÃO\', 1, 31, \'\', 5, false, true, \'d\', \'\', 0);
  ...
  insert into db_layoutcampos values (11889, 728, \'historico_empenho\', \'HISTÓRICO DO EMPENHO\', 1, 48, \'\', 231, false, true, \'d\', \'\', 0);
  insert into db_layoutcampos values (11890, 728, \'identificacao_credor\', \'IDENTIFICAÇÃO DO CREDOR\', 1, 279, \'\', 14, false, true, \'d\', \'\', 0);
  ...
  insert into db_layoutcampos values (11894, 728, \'unidade_orcamentaria\', \'UNIDADE ORÇAMENTÁRIA\', 1, 312, \'\', 5, false, true, \'d\', \'\', 0);
  ...
  insert into db_layoutcampos values (11897, 728, \'modalidade_licitacao\', \'MODALIDADE DA LICITAÇÃO\', 1, 335, \'\', 2, false, true, \'d\', \'\', 0);
  insert into db_layoutcampos values (11898, 728, \'referencia_legal\', \'REFERÊNCIA LEGAL\', 1, 337, \'\', 20, false, true, \'d\', \'\', 0);
  ...
  insert into db_layoutcampos values (11933, 729, \'observacao\', \'OBSERVAÇÃO\', 1, 39, \'\', 250, false, true, \'d\', \'\', 0);
...
');
SELECT fc_executa_ddl('
  INSERT INTO tipodeficiencia VALUES (1, ''Física'');
');
SELECT fc_executa_ddl('
...
');
SELECT fc_executa_ddl('
  INSERT INTO tipodeficiencia VALUES (5, ''Múltipla'');
');
SELECT fc_executa_ddl('
...
-- Tabela de nacionalidade ajuste para emissão da RAIS
...
SELECT fc_executa_ddl('INSERT INTO rhnacionalidade VALUES (38, ''SUIÇO'');');
...
-- Ajustando antigo código de outros 50 para 80
SELECT fc_executa_ddl('
