insert into db_versao (db30_codver, db30_codversao, db30_codrelease, db30_data, db30_obs)  values (347, 3, 31, '2014-11-07', 'Tarefas: 97194, 97187,97208,97229, 97171');insert into db_versaoant (db31_codver,db31_data) values (347, current_date);
...
select setval ('db_versaocpdarq_db34_codarq_seq',(select max (db34_codarq) from db_versaocpdarq));create table bkp_db_permissao_20141107_095003 as select * from db_permissao;
