insert into db_versao (db30_codver, db30_codversao, db30_codrelease, db30_data, db30_obs)  values (349, 3, 33, '2014-12-11', 'Tarefas: 97357');insert into db_versaoant (db31_codver,db31_data) values (349, current_date);
...
select setval ('db_versaocpdarq_db34_codarq_seq',(select max (db34_codarq) from db_versaocpdarq));create table bkp_db_permissao_20141211_182709 as select * from db_permissao;
