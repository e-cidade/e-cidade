insert into db_versao (db30_codver, db30_codversao, db30_codrelease, db30_data, db30_obs)  values (339, 3, 24, '2014-05-22', 'Tarefas: 80920, 94232');insert into db_versaoant (db31_codver,db31_data) values (339, current_date);
...
select setval ('db_versaocpdarq_db34_codarq_seq',(select max (db34_codarq) from db_versaocpdarq));insert into db_versaousu (db32_codusu,db32_codver,db32_id_item,db32_obs,db32_data,db32_obsdb) values (nextval ('db_versaousu_db32_codusu_seq'),339,1100874,'Criada aba Outros Profissionais no cadastro de turma destinada ao registros de profissionais que exercem a função de Auxiliar / Assistente Educacional e Tradutor Intérprete de Libras.','2014-05-22','mensagem usuário');
insert into db_versaousutarefa (db28_sequencial,db28_codusu,db28_tarefa) values (nextval ('db_versaousutarefa_db28_sequencial_seq'),8239,80920);

insert into db_versaousu (db32_codusu,db32_codver,db32_id_item,db32_obs,db32_data,db32_obsdb) values (nextval ('db_versaousu_db32_codusu_seq'),339,9278,'Realizada a adequação do layout do censo 2014','2014-05-22','mensagem de usuário');
insert into db_versaousutarefa (db28_sequencial,db28_codusu,db28_tarefa) values (nextval ('db_versaousutarefa_db28_sequencial_seq'),8237,80920);

insert into db_versaousu (db32_codusu,db32_codver,db32_id_item,db32_obs,db32_data,db32_obsdb) values (nextval ('db_versaousu_db32_codusu_seq'),339,7310,'Realizada a alteração da aba horários do cadastro de turmas de atividade complementar/mais educação e atendimento educacional especializado, o usuário poderá marcar os dias e horários em que a atividade ou atendimento são oferecidos, juntamente com o profissional/monitor que realiza a atividade ou atendimento.','2014-05-22','mensagem usuário');
insert into db_versaousutarefa (db28_sequencial,db28_codusu,db28_tarefa) values (nextval ('db_versaousutarefa_db28_sequencial_seq'),8240,80920);

insert into db_versaousu (db32_codusu,db32_codver,db32_id_item,db32_obs,db32_data,db32_obsdb) values (nextval ('db_versaousu_db32_codusu_seq'),339,1100897,'Realizada alteração no cadastro de atividades, onde, o campo Docente foi alterado para Função e no combobox foi disponibilizado as opções Nenhum, Docente, Auxiliar / Assistente Educacional, Profissional / Monitor de Atividade Complementar e Tradutor Intérprete de Libras para atender as especificações do censo escolar.','2014-05-22','mensagem usuário');
insert into db_versaousutarefa (db28_sequencial,db28_codusu,db28_tarefa) values (nextval ('db_versaousutarefa_db28_sequencial_seq'),8242,80920);

create table bkp_db_permissao_20140522_125251 as select * from db_permissao;
