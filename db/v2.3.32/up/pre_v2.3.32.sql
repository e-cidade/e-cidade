...
---- Tarefa: 1023
----------------------------------------------------
insert into db_syscampo values(20826,'ed59_procedimento','int8','Código do Procedimento','0', 'Código do Procedimento',20,'f','f','f',1,'text','Código do Procedimento');
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente )
                  values ( 9993 ,'Alterar Proc. Avaliação Disciplina' ,'Alterar Proc. Avaliação Disciplina' ,'edu1_alteraprocedimentoavaliacaodisciplina001.php' ,'1' ,'1' ,'Menu para alteração do procedimento de avaliação das disciplinas vinculadas a uma turma.' ,'true' );
...
update db_itensmenu set descricao = 'Diário de Classe', help = 'Diário de Classe ', desctec = 'Emissão do diário de classe.', libcliente = '1' where id_item = 9941;
...
---- Tarefa: 102508
----------------------------------------------------
update db_syscampo set rotulorel = 'Início', rotulo = 'Início' where codcam = 12510;


----------------------------------------------------
---- Acerto em Base #1663
----------------------------------------------------
update db_syscampo set nomecam = 'la06_c_cns', conteudo = 'char(15)', descricao = 'Cartão SUS do Profissional', valorinicial = '', rotulo = 'Cartão SUS', nulo = 'f', tamanho = 15, maiusculo = 't', autocompl = 'f', aceitatipo = 0, tipoobj = 'text', rotulorel = 'Cartão SUS' where codcam = 16768;
 ...
 */
 -- 97192
insert into db_itensmenu values( 9992, 'Emissão de Atas', 'Relatório de atas vigentes', 'com2_relatorioatasvigentes001.php', '1', '1', 'com2_relatorioatasvigentes001.php', '1'	);
...
update db_itensmenu set descricao = 'Anexo XII - Dem.dos Imp.e Desp.com Saúde' where id_item = '8066';
...
insert into db_tipodoc( db08_codigo ,db08_descr )
  values ( 5015 ,'ASSINATURA DELIBERAÇÃO 200/96 - MODELO 5' );

insert into db_documentopadrao( db60_coddoc ,db60_descr ,db60_tipodoc ,db60_instit )
  select nextval('db_documentopadrao_db60_coddoc_seq'), 'ASSINATURA DELIBERAÇÃO 200/96 - MODELO 5' ,5015 , codigo from db_config;
...
/*
 * Menus do Registro de Preço
 */
insert into db_itensmenu values(10004, 'Por Quantidade', 'Registro de preço por quantidade', '', '1', '1', 'Registro de preço por quantidade', '1'	);
insert into db_itensmenu values(10005, 'Por Valor', 'Registro de preço por valor', '', '1', '1', 'Registro de preço por valor', '1'	);
...
insert into db_itensmenu values( 10006, 'Abertura', 'Abertura do registro de preço controlado por valor', 'com4_aberturaregistroprecoporvalor001.php', '1', '1', 'Abertura do registro de preço controlado por valor', '1'	);
insert into db_itensfilho (id_item, codfilho) values(10006,1);

insert into db_itensmenu values( 10007, 'Manifestar Interesse', 'Manifestar interesse em um registro de preço controlado por valor', '', '1', '1', 'Manifestar interesse em um registro de preço controlado por valor', '1'	);
insert into db_itensfilho (id_item, codfilho) values(10007,1);

insert into db_itensmenu values( 10008, 'Compilação', 'Processamento do registro de preço controlado por valor', '', '1', '1', 'Processamento do registro de preço controlado por valor', '1'	);
insert into db_itensmenu values( 10009, 'Inclusão', 'Processamento do registro de preço controlado por valor', 'com4_processamentoregistroprecoporvalor001.php', '1', '1', 'compilação do registro de preço controlado por valor', '1'	);
insert into db_itensmenu (id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10010 ,'Anulação' ,'Anulação da Compilação' ,'com4_anulcompregistro001.php?formacontrole=2' ,'1' ,'1' ,'Anulação da Compilação' , 'true' );
...
insert into db_itensmenu values( 10011, 'Inclusão', 'Abertura de um registro de preço por valor', 'com4_aberturaregistroprecoporvalor001.php?opcao=1', '1', '1', 'Inclusão de um registro de preço', '1'	);
insert into db_itensfilho (id_item, codfilho) values(10011,1);
insert into db_itensmenu values( 10012, 'Alteração', 'Altera a abertura de um registro de preço', 'com4_aberturaregistroprecoporvalor001.php?opcao=2', '1', '1', 'Altera a abertura de um registro de preço', '1'	);
insert into db_itensfilho (id_item, codfilho) values(10012,1);
insert into db_itensmenu values( 10013, 'Anulação', 'Anula a abertura de um registro de preço', 'com4_anulabertregistro001.php?formacontrole=2', '1', '1', 'Anulação de um registro de preço', '1'	);
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente )
  values ( 10014 ,'Inclusão' ,'Inclusão de Estimativa de Registro de Preço por Valor' ,'com4_manifestarinteresseregistroprecoporvalor001.php?acao=1' ,'1' ,'1' ,'Inclusão de Registro de Preço por Valor' ,'true' );
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente )
  values ( 10015 ,'Alteração' ,'Alteração de Estimativa de Registro de Preço por Valor' ,'com4_manifestarinteresseregistroprecoporvalor001.php?acao=2' ,'1' ,'1' ,'Alteração de Registro de Preço por Valor' ,'true' );
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente )
  values ( 10016 ,'Anulação' ,'Anulação de Estimativa de Registro de Preço por Valor' ,'com4_anulestimregistro001.php?formacontrole=2' ,'1' ,'1' ,'Anulação de Estimativa de Registro de Preço por Valor' ,'true' );
...
insert into db_syscampo values(20853,'pc54_formacontrole','int4','Forma de controle de um registro de preço controlado ou por valor ou por quantidade 1 - Quantidade 2 - Valor','0', 'Forma de Controle',10,'f','f','f',1,'text','Forma de Controle');
insert into db_sysarqcamp values(2679,20853,6,0);
insert into db_syscampo values(20854,'l20_formacontroleregistropreco','int4','Forma de Controle do Registro de Preço','1', 'Forma de Controle do RP',10,'t','f','f',1,'text','Forma de Controle do RP');
...
insert into db_itensmenu values( 10020, 'Execução Financeira', 'Visualizar a execução financeira do acordo', 'con4_mapaexecucao001.php?execucao=2', '1', '1', 'con4_mapaexecucao001.php?execucao=2', '1'	);
insert into db_itensfilho (id_item, codfilho) values(10020,1);
insert into db_itensmenu values( 10021, 'Execução do Contrato', 'Visualizar os dados com base na execução do contrato', 'con4_mapaexecucao001.php?execucao=1', '1', '1', 'Visualizar os dados com base na execução do contrato', '1'	);
...
insert into db_sysarquivo
     values (3756, 'regraencerramentonaturezaorcamentaria', 'Regra Encerramento Natureza Orçamentária', 'c117', '2014-11-21', 'Regra Encerramento Natureza Orçamentária', 0, 'f', 'f', 'f', 'f' );
...
insert into db_syscampo ( codcam ,nomecam ,conteudo ,descricao ,valorinicial ,rotulo ,tamanho ,nulo ,maiusculo ,autocompl ,aceitatipo ,tipoobj ,rotulorel )
  values ( 20874 ,'c117_sequencial' ,'int4' ,'Sequencial' ,'' ,'Sequencial' ,10 ,'false' ,'false' ,'false' ,1 ,'text' ,'Sequencial' ),
         ...
         ( 20876 ,'c117_instit' ,'int4' ,'Instituição' ,'' ,'Instituição' ,10 ,'false' ,'false' ,'false' ,1 ,'text' ,'Instituição' ),
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente )
     values ( 10022 ,'Encerramento do Exercício PCASP' ,'Encerramento do Exercício PCASP' ,'con4_processaencerramentopcasp.php' ,'1' ,'1' ,'Encerramento do Exercício PCASP' ,'true' );
insert into db_menu ( id_item ,id_item_filho ,menusequencia ,modulo )
     values ( 4197 ,10022 ,14 ,209 );

insert into conencerramentotipo
     values (6, 'Encerramento das Variações Patrimoniais'),
            (7, 'Natureza Orçamentária de controle');

insert into conhistdoc
     values (1008, 'INSCRIÇÃO DE RP PROCESSADOS', 1000),
            (1009, 'ENCERRAMENTO VARIAÇÕES PATRIMONIAIS', 1000),
            (1010, 'ENCERRAMENTO NATUREZA ORÇAMENTARIA E CONTROLE', 1000);
...
insert into db_itensmenu values(10023, 'Anulação', 'Anula a solicitação de compras', 'com4_anularsolicitacaocompras001.php', '1', '1', 'Anula a solicitação de compras.', '1'	);
...
update db_syscampo set rotulo = 'Exercício', rotulorel = 'Exercício' where codcam = 9667;
insert into db_sysarquivo values (3750, 'tipolicenca', 'Tabela que registra os tipos de licenças ambientais', 'am09', '2014-11-13', 'Tipos de Licenças', 0, 'f', 'f', 'f', 'f' );
insert into db_sysarqmod values (64,3750);
insert into db_syscampo values(20844,'am09_sequencial','int4','Tipo de Licenças','0', 'Tipo de Licença',10,'f','f','f',1,'text','Tipo de Licença');
insert into db_syscampo values(20845,'am09_descricao','varchar(50)','Descrição da Licença','', 'Descrição da Licença',50,'f','f','f',3,'text','Descrição da Licença');
...
insert into db_sysarquivo values (3751, 'condicionante', 'Condicionantes para Pareceres Técnicos Ambientais', 'am10', '2014-11-13', 'Condicionante', 0, 'f', 'f', 'f', 'f' );
insert into db_sysarqmod values (64,3751);
insert into db_syscampo values(20846,'am10_sequencial','int4','Código da Condicionante','0', 'Condicionante',10,'f','f','f',1,'text','Condicionante');
insert into db_syscampo values(20847,'am10_descricao','text','Descrição da Condicionante','', 'Descrição',300,'f','f','f',0,'text','Descrição');
insert into db_syscampo values(20848,'am10_padrao','bool','Condicionante Padrão','false', 'Padrão',1,'f','f','f',5,'text','Padrão');
insert into db_syscampo values(20849,'am10_tipolicenca','int4','Tipo de Licença','0', 'Tipo de Licença',10,'t','f','f',1,'text','Tipo de Licença');
...
insert into db_sysarquivo values (3752, 'condicionanteatividadeimpacto', 'Vínculo entre condicionantes e atividades', 'am11', '2014-11-13', 'Condicionante/Atividade', 0, 'f', 'f', 'f', 'f' );
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10001 ,'Inclusão' ,'Inclusão de Condicionantes' ,'amb1_condicionante001.php' ,'1' ,'1' ,'Inclusão de Condicionantes' ,'true' );
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10002 ,'Alteração' ,'Alteração de Condicionante' ,'amb1_condicionante002.php' ,'1' ,'1' ,'Alteração de Condicionante' ,'true' );
...
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10003 ,'Exclusão' ,'Exclusão de Condicionante' ,'amb1_condicionante003.php' ,'1' ,'1' ,'Exclusão de Condicionante' ,'true' );
...
update db_sysarquivo set nomearq = 'parecertecnico', descricao = 'Cadastro de Emissao de Pareceres Técnicos', sigla = 'am08', dataincl = '2014-11-18', rotulo = 'Cadastro de Emissao de Pareceres Técnicos', tipotabela = 0, naolibclass = 'f', naolibfunc = 'f', naolibprog = 'f', naolibform = 'f' where codarq = 3744;
delete from db_sysarqarq where codarq = 3744;
insert into db_sysarqarq values(0,3744);
update db_syscampo set nomecam = 'am08_pareceranterior', conteudo = 'int4', descricao = 'Código do Parecer Anterior a ser prorrogado ou renovado', valorinicial = '0', rotulo = 'Parecer Anterior', nulo = 't', tamanho = 10, maiusculo = 'f', autocompl = 'f', aceitatipo = 1, tipoobj = 'text', rotulorel = 'Parecer Anterior' where codcam = 20808;
delete from db_syscampodep where codcam = 20808;
delete from db_syscampodef where codcam = 20808;
insert into db_syscampo values(20856,'am08_datageracao','date','Data de Geração','null', 'Data de Geração',10,'f','f','f',0,'text','Data de Geração');
insert into db_syscampo values(20857,'am08_favoravel','bool','Parecer Favorável','f', 'Favorável',1,'f','f','f',5,'text','Favorável');
insert into db_syscampo values(20858,'am08_observacao','text','Observações','', 'Observações',1,'f','f','f',0,'text','Observações');
insert into db_syscampo values(20872,'am08_arquivo','oid','Arquivo Parecer Técnico','', 'Arquivo Parecer Técnico',1,'f','f','f',1,'text','Arquivo Parecer Técnico');
...
insert into db_sysarquivo values (3753, 'parecertecnicocondicionante', 'Vínculo entre parecer e condicionantes', 'am12', '2014-11-18', 'Parecer/Condicionante', 0, 'f', 'f', 'f', 'f' );
insert into db_sysarqmod values (64,3753);
insert into db_syscampo values(20859,'am12_sequencial','int4','Vínculo entre parecer e condicionantes','0', 'Condicionante',10,'f','f','f',1,'text','Condicionante');
...
insert into db_syscampo values(20860,'am12_parecertecnico','int4','Parecer Técnico','0', 'Parecer Técnico',10,'f','f','f',1,'text','Parecer Técnico');
insert into db_syscampo values(20861,'am12_arquivo','oid','Licença','', 'Licença',1,'f','f','f',0,'text','Licença');
...
update db_itensmenu set descricao = 'Emissão de Licença' where id_item = 9981;
insert into db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10018 ,'Emissão de Parecer Técnico' ,'Emissão de Parecer Técnico' ,'amb4_emissaodeparecertecnico001.php' ,'1' ,'1' ,'Emissão de Parecer Técnico' ,'true' );
...
insert into db_sysarquivo values (3754, 'licencaempreendimento', 'Licença', 'am13', '2014-11-18', 'Licença', 0, 'f', 'f', 'f', 'f' );
insert into db_sysarqmod values (64,3754);
insert into db_syscampo values(20863,'am13_sequencial','int4','Licença','0', 'Licença',10,'f','f','f',1,'text','Licença');
insert into db_syscampo values(20864,'am13_parecertecnico','int4','Parecer Técnico','0', 'Parecer Técnico',10,'f','f','f',1,'text','Parecer Técnico');
insert into db_syscampo values(20865,'am13_arquivo','oid','Arquivo da Licença','', 'Arquivo',1,'f','f','f',0,'text','Arquivo');
...
insert into db_documentotemplatetipo ( db80_sequencial, db80_descricao ) values ( 52, 'Parecer Técnico Favorável' );
insert into db_documentotemplatetipo ( db80_sequencial, db80_descricao ) values ( 53, 'Parecer Técnico Desfavorável' );
insert into db_documentotemplatetipo ( db80_sequencial, db80_descricao ) values ( 54, 'Licença Ambiental' );
insert into db_documentotemplatepadrao ( db81_sequencial, db81_templatetipo, db81_nomearquivo, db81_descricao ) values ( 55 , 52, 'documentos/templates/meioambiente/parecer_tecnico_favoravel.sxw',    'Parecer Técnico Favorável'    );
insert into db_documentotemplatepadrao ( db81_sequencial, db81_templatetipo, db81_nomearquivo, db81_descricao ) values ( 56 , 53, 'documentos/templates/meioambiente/parecer_tecnico_desfavoravel.sxw', 'Parecer Técnico Desfavorável' );
insert into db_documentotemplatepadrao ( db81_sequencial, db81_templatetipo, db81_nomearquivo, db81_descricao ) values ( 57 , 54, 'documentos/templates/meioambiente/licenca_ambiental.sxw', 'Licença Ambiental' );

update db_syscampo set nomecam = 'am08_sequencial', conteudo = 'int4', descricao = 'Parecer Técnico', valorinicial = '0', rotulo = 'Parecer Técnico', nulo = 'f', tamanho = 10, maiusculo = 'f', autocompl = 'f', aceitatipo = 1, tipoobj = 'text', rotulorel = 'Parecer Técnico' where codcam = 20805;
...
-- 96909
INSERT INTO db_itensmenu(id_item, descricao, help, funcao, itemativo, manutencao, desctec, libcliente)
VALUES (9997,  'Manutenção e-Cidade Online', 'Manutenção e-Cidade Online', '',                                         '1', '1', 'Libera a geração de contacheques da folha',        'true'),
       (9999,  'Liberar Folhas',             'Liberar Folhas',             'pes4_liberarfolhadbpref001.php',           '1', '1', 'Libera a geração de contracheques no DBPref',      'true'),
       (10017, 'Gerar Arquivo de Retorno',   'Gerar Arquivo de Retorno',   'pes4_geracaoarquivoretornoeconsig001.php', '1', '1', 'Rotina de geração do arquivo de retorno econsig.', 'true');
...
--97262
insert into db_sysarquivo   values (3755, 'econsigmotivo', 'Tabela responsável por armazenar as justificativas dos servidores.', 'rh147', '2014-11-18', 'E-Consig Motivo', 0, 'f', 'f', 'f', 'f' );
insert into db_sysarqarq    values (0,3755);
insert into db_sysarqmod    values (28,3755);
insert into db_syscampo     values (20869,'rh147_sequencial','int4','Identificador único da tabela.','', 'Sequencial',10,'f','f','f',1,'text','Sequencial');
insert into db_syscampo     values (20870,'rh147_motivo','varchar(100)','São os motivos disponíveis do E-Consig para os servidores.','', 'Motivo',100,'f','t','f',0,'text','Motivo');
 ...
 * db_layouttxt
 */
insert into db_layouttxt    values (220, 'ARQUIVO REMESSA E-CONSIG', 0, 'Arquivo de remessa de integração com o sistema e-consig.', 1);
 ...
 * db_layoutcampos
 */
insert into db_layoutcampos values (11841, 723, 'matricula', 'MATRÍCULA DO SERVIDOR', 2, 1, '', 10, false, true, 'e', '', 0);
...
insert into db_layoutcampos values (11849, 723, 'competencia', 'COMPETENCIA(PERÍODO)', 2, 102, '', 6, false, true, 'e', '', 0);
insert into db_layoutcampos values (11850, 723, 'situacao', 'SITUAÇÃO', 1, 108, '', 40, false, true, 'd', '', 0);
----------------------------------------------------
---- Relatório Importação
----------------------------------------------------
insert into db_syscampo values (20873, 'rh133_relatorio', 'oid', 'Esse campo irá armazenar o relatório de importação do econsig.', '', 'Relatório de Importação', 1, 't', 'f', 'f', 0, 'text', 'Relatório de Importação');
insert into db_sysarqcamp values (3675, 20873, 6, 0);
----------------------------------------------------
---- Menu Relatório de Impotacao
----------------------------------------------------
insert into db_itensmenu values( 10019, 'Reemitir Relatório de Importação', 'Reemitir Relatório de Importação', 'pes4_econsigrelatorioimportacao001.php', '1', '1', 'Item de menu responsável por imprimir o relatório de importção do e-consig', '1' );
insert into db_itensfilho (id_item, codfilho) values(10019,1008396);
insert into db_menu values(9866,10019,4,952);
----------------------------------------------------
---- Remove as referências econsig
----------------------------------------------------
...
------------------------
---- Alteração Nome de Menu
------------------------
update db_itensmenu set descricao = 'Importar Arquivo de Movimento', help = 'Importar Arquivo de Movimento', funcao = 'pes4_importacaoarquivoeconsig001.php', itemativo = '1', desctec = 'Rotina responsável pela importação do arquivo enviado pela Zetra referente ao e-consig, que são os eventos financeiros que devem ser lançados no ponto do servidor', libcliente = '0' where id_item = 9898;
