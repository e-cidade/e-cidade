...
---- TRIBUTARIO
----------------------------------------------------
insert into iptucadlogcalc(j62_codigo, j62_descr, j62_erro) values (106, 'Sem valor informado para característica ', true);
insert into iptucadlogcalc(j62_codigo, j62_descr, j62_erro) values (107, 'Valor do m2 da construção não encontrado, verifique características da construção.', true);
...
insert into tipolicenca values (1, 'Prévia');
insert into tipolicenca values (2, 'Instalação');
insert into tipolicenca values (3, 'Operação');
...
INSERT INTO econsigmotivo values (2,'SERVIDOR NÃO IDENTIFICADO');
INSERT INTO econsigmotivo values (3,'TIPO DE CONTRATO NÃO PERMITE EMPRÉSTIMO');
INSERT INTO econsigmotivo values (4,'MARGEM CONSIGNÁVEL EXCEDIDA');
INSERT INTO econsigmotivo values (5,'NÃO DESCONTADO - OUTROS MOTIVOS');
INSERT INTO econsigmotivo values (6,'SERVIDOR DESLIGADO');
INSERT INTO econsigmotivo values (7,'SERVIDOR AFASTADO EM LICENÇA SAÚDE');
