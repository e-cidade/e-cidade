insert into db_versao (db30_codver, db30_codversao, db30_codrelease, db30_data, db30_obs)  values (345, 3, 29, '2014-10-20', 'Tarefas: 97152');insert into db_versaoant (db31_codver,db31_data) values (345, current_date);
...
select setval ('db_versaocpdarq_db34_codarq_seq',(select max (db34_codarq) from db_versaocpdarq));create table bkp_db_permissao_20141020_132434 as select * from db_permissao;
