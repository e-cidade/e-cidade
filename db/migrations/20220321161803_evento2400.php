...
class Evento2400 extends PostgresMigration
{
    public function up()
    {
        $sql = <<<SQL
        ...
        WHERE db103_avaliacaogrupopergunta = 4000354;

        UPDATE avaliacaopergunta
        SET db103_camposql = LOWER(db103_identificadorcampo)
        WHERE db103_avaliacaogrupopergunta = 4000355;

        UPDATE avaliacaopergunta
        SET db103_camposql = LOWER(db103_identificadorcampo)
        WHERE db103_avaliacaogrupopergunta = 4000357;

        update avaliacaopergunta set db103_avaliacaotiporesposta = 2 where db103_sequencial = 4001203;
        update avaliacaopergunta set db103_camposql = 'dsclograd' where db103_sequencial = 4001204;
        update avaliacaopergunta set db103_camposql = 'complementolograd' where db103_sequencial = 4001206;
        update avaliacaopergunta set db103_camposql = 'dtnasctodepende' where db103_sequencial = 4001220;
