            ...
            DECLARE
                ...
                nResult              integer;
                    ...
                    INTO nIdCorrente,
                         ...
                         nDateCorrente
                    FROM corlanc
                    JOIN conlancamcorrente ON (c86_id, c86_data, c86_autent) = (corlanc.k12_id, corlanc.k12_data, corlanc.k12_autent)
                    JOIN conlancamslip ON c86_conlancam = c84_conlancam
                    WHERE c84_slip = iSlip;
                    ...
                    /* ACERTAR MOVIMENTA??O DAS CONTAS */
