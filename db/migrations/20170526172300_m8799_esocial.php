...
class M8799Esocial extends PostgresMigration
{
  ...
  public function up()
  {
    ...
    $this->execute("alter table habitacao.avaliacaogrupopergunta alter column db102_descricao type varchar(100)");

    $this->execute("alter table habitacao.avaliacaogrupopergunta alter column db102_identificador type varchar(100)");
  ...
  public function criarTabelas() {
    ...
    $avaliacao
        ->addColumn('db101_cargadados', 'text', array('null' => true))
