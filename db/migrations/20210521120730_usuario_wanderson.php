...
class UsuarioWanderson extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('WANDERSON ALVES BARBOSA','NAO INFORMADO','0','NAO INFORMADO','MONTES CLAROS','MG','39400053','2021-05-21 00:00:00.0','1','0','1','2','0','11166972623','M','2021-05-21 00:00:00.0','10:00','WANDERSON ALVES BARBOSA','true','0','0','null', 'user' => array('WANDERSON ALVES BARBOSA','wanderson.alves','99113d935eab94f0bdb78a189e185ade50a61fd4','1','wanderson.alves@contassconsultoria.com.br','0','1','2020-05-21 00:00:00.0'))
        );
