...
class Addusercontasstrubutario extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('JEFFERSON THADEU SOARES GONÇALVES', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '13227878674', 'M', '2021-03-16 00:00:00.0', '16:42', 'JEFFERSON THADEU SOARES GONÇALVES', 'true', '0', '0', 'null', 'user' => array('JEFFERSON THADEU SOARES GONÇALVES', 'jtsg.contass', 'a8625694630c8d19b0289a4c493bc4bb97a0547a', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
