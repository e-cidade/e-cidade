...
class M7315 extends PostgresMigration
{
  ...
  public function upPRETabela_tipoassedb_depart()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000629,'tipoassedb_depart_rh184_sequencial_seq',1,1,$this->execute("select maxvalueseq from db_syssequencia limit 1"),1,1)
    ));
  ...
  public function upPRETabela_db_departrhlocaltrab()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000630, 'db_departrhlocaltrab_rh185_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_tiporegistro()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000631, 'tiporegistro_rh187_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_jornada()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000632, 'jornada_rh188_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_jornadahoras()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000633, 'jornadahoras_rh189_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_gradeshorarios()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000634, 'gradeshorarios_rh190_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_gradeshorariosjornada()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000635, 'gradeshorariosjornada_rh191_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_escalaservidor()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000636, 'escalaservidor_rh192_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicojustificativa()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000642, 'pontoeletronicojustificativa_rh194_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicojustificativatipoasse()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000653, 'pontoeletronicojustificativatipoasse_rh205_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPRETabela_pontoeletronicoconfiguracoeslotacao()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000641, 'pontoeletronicoconfiguracoes_rh195_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicoconfiguracoesgerais()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000649, 'pontoeletronicoconfiguracoesgerais_rh200_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicoarquivo()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000640, 'pontoeletronicoarquivo_rh196_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicoarquivodata()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000639, 'pontoeletronicoarquivodata_rh197_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicoarquivodataregistro()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000638, 'pontoeletronicoarquivodataregistro_rh198_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upPreTabela_pontoeletronicoregistrojustificativa()
  {
    ...
    $this->tabela_db_syssequencia->insert(array('codsequencia','nomesequencia','incrseq','minvalueseq','maxvalueseq','startseq','cacheseq'), array(
      array(1000637, 'pontoeletronicoregistrojustificativa_rh199_sequencial_seq', 1, 1, $this->execute("select maxvalueseq from db_syssequencia limit 1"), 1, 1)
    ));
  ...
  public function upDDL()
  {
    ...
    $this->execute("  
                ...
                CREATE SEQUENCE configuracoes.db_pluginmodulos_db152_sequencial_seq
                  ...
                  ALTER TABLE configuracoes.db_pluginmodulos_db152_sequencial_seq
                  OWNER TO ecidade;
  
                CREATE TABLE db_pluginmodulos
                  (
                      db152_sequencial INTEGER DEFAULT nextval('db_pluginmodulos_db152_sequencial_seq' :: REGCLASS) NOT NULL
                    CONSTRAINT db_pluginmodulos_sequ_pk
                    PRIMARY KEY,
                  db152_db_plugin  INTEGER                                                                      NOT NULL
                    CONSTRAINT db_pluginmodulos_plugin_fk
                    REFERENCES db_plugin,
                  db152_db_modulo  INTEGER
                    CONSTRAINT db_pluginmodulos_modulo_fk
                    REFERENCES db_modulos,
                  db152_uid        VARCHAR(255)
                );
                CREATE INDEX db_pluginmodulos_db152_db_plugin_in
                  ON db_pluginmodulos (db152_db_plugin);
                CREATE INDEX db_pluginmodulos_db152_db_modulo_in
                  ON db_pluginmodulos (db152_db_modulo);
                
                
                CREATE TABLE pessoal.naturezatipoassentamento
                (
                  rh159_sequencial integer NOT NULL DEFAULT nextval('naturezatipoassentamento_rh159_sequencial_seq'::regclass),
                  rh159_descricao character varying(30) NOT NULL,
                  CONSTRAINT rh159_sequencial_pk PRIMARY KEY (rh159_sequencial)
                )
                WITH (
                  OIDS=TRUE
                );
                ALTER TABLE pessoal.naturezatipoassentamento
                  OWNER TO ecidade;
                GRANT ALL ON TABLE pessoal.naturezatipoassentamento TO ecidade;
                GRANT SELECT ON TABLE pessoal.naturezatipoassentamento TO dbseller;
                GRANT SELECT ON TABLE pessoal.naturezatipoassentamento TO plugin;
                
                
                CREATE INDEX naturezatipoassentamento_seq_in
                  ON pessoal.naturezatipoassentamento
                  USING btree
                  (rh159_sequencial);
  ...
  public function incluirFormulaPadraoHorasPonto()
  {
    ...
    if(empty($formulasHorasPonto)) {
      $this->table('db_formulas', array('schema'=>'public'))->insert(array('db148_nome','db148_descricao','db148_formula'), array(
