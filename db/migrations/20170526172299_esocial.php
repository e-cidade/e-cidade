...
class Esocial extends PostgresMigration
{
...
//    $aColumns = array('db100_sequencial', 'db100_descricao');
//    $aValues  = array(
//          array(5,'eSocial'),
//          array(6,'Questionario DBSeller')
//    );
//
//    $table    = $this->table('avaliacaotipo', array('schema' => 'habitacao'));
...
//    $table->saveData();
    ...
    $this->execute("update configuracoes.db_itensmenu set id_item = 8528 , descricao = 'Cadastro de Formulários' , help = 'Cadastro de Formulários' , itemativo = '1' , manutencao = '1' , desctec = 'Cadastro de formulários onde são cadastrados a estrutura genérica para os mesmos.' , libcliente = 'true' where id_item = 8528;");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 29 ,8528 ,277 ,1 )");
    $this->execute("insert into configuracoes.db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10423 ,'Manutenção Formulários' ,'Manutenção Formulários' ,'con4_manutencaoformularios.php' ,'1' ,'1' ,'Rotina para manutneção dos formulários do e-cidade' ,'true' )");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 32 ,10423 ,482 ,1 )");

    $this->execute("insert into configuracoes.db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10425 ,'Carga de Dados' ,'Carga de Dados para o esocial' ,'con4_cargaformularios001.php?tipo_formulario=5' ,'1' ,'1' ,'Menu para realização da carga de dados para o esocial.' ,'true' )");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 32 ,10425 ,483 ,10216 )");
    $this->execute("insert into configuracoes.db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10426 ,'Manutenção S1010 - Tabela de Rubricas' ,'Manutenção S1010 - Tabela de Rubricas' ,'con4_manutencaoformulario001.php?formulario=3000010' ,'1' ,'1' ,'Realiza a manutençãod e formulários para o cadastro de Rubricas' ,'true' )");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 32 ,10426 ,484 ,10216 )");
    $this->execute("insert into configuracoes.db_itensmenu ( id_item ,descricao ,help ,funcao ,itemativo ,manutencao ,desctec ,libcliente ) values ( 10427 ,'Conferência' ,'Conferência' ,'eso4_conferenciadados001.php' ,'1' ,'1' ,'Conferência' ,'true')");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 10220 ,10427 ,1 ,10216 );");
    $this->execute("update configuracoes.db_itensmenu set descricao = 'Manutenção S2100 - Dados do Servidor' , help = 'Manutenção S2100 - Dados do Servidor', desctec = 'Manutenção S2100 - Dados do Servidor' , libcliente = 'true' where id_item = 10220;");
    $this->execute("update configuracoes.db_itensmenu set id_item = 10219 , descricao = 'Preenchimento' , help = 'Preenchimento' , funcao = 'eso4_preenchimento001.php' , itemativo = '1' , manutencao = '1' , desctec = 'Preenche o formulário do e-social.' , libcliente = 'true' where id_item = 10219;");
    $this->execute("delete from configuracoes.db_menu where id_item_filho = 10219 AND modulo = 10216;");
    $this->execute("insert into configuracoes.db_menu ( id_item ,id_item_filho ,menusequencia ,modulo ) values ( 10220 ,10219 ,2 ,10216 );");
  ...
  public function criarTabelas() {
    ...
    $avaliacaoPergunta->addColumn('db103_tipo', 'integer', array('null' => true, 'default' => '1'))
                      ->addColumn('db103_mascara', 'string', array('null' => true))
                      ->addColumn('db103_dblayoutcampo', 'integer', array('null' => true))
  ...
  {
    $this->execute('delete from configuracoes.db_sysarqcamp where codcam in(1009305,5009304,5009306,5009307, 5009308, 5009309)');
    $this->execute('delete from configuracoes.db_syscampo where codcam in(1009305,5009304,5009306,5009307, 5009308, 5009309)');
  }

  private function droparDML() {


    $this->execute('alter table habitacao.avaliacaopergunta drop COLUMN IF EXISTS db103_tipo');
    $this->execute('alter table habitacao.avaliacaopergunta drop COLUMN IF EXISTS db103_mascara');
  ...
  private function deleteDadosEsocial() {
    ...
    $this->execute("delete from avaliacaoperguntaopcaolayoutcampo");
    ...
    $this->execute("delete from habitacao.avaliacaotipo");
  }
...
<<<STRING
  ...
  alter table habitacao.avaliacao alter column db101_descricao type varchar(100);
  alter table habitacao.avaliacao alter column db101_identificador type varchar(100);
  
  alter table habitacao.avaliacaogrupopergunta alter column db102_descricao type varchar(100);
  alter table habitacao.avaliacaogrupopergunta alter column db102_identificador type varchar(100);
  
  

--INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (1, 'Ficha Socio-Economica');
--INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (2, 'Censo - Dados Escola');
--INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (3, 'Censo - Dados Cursos Recurso Humano');
INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (4, 'Fichas PSF');
INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (5, 'eSocial');
INSERT INTO habitacao.avaliacaotipo (db100_sequencial, db100_descricao) VALUES (6, 'Questionario DBSeller');


INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000005, 4, 'FICHA DE ATENDIMENTO DOMICILIAR', 'Ficha de Atendimento Domiciliar do PSF.', true, 'f8', null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (1, 1, 'FICHA SÓCIO-ECONÔNICA', '', true, null, null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000006, 4, 'MARCADORES DE CONSUMO ALIMENTAR', 'Ficha Marcadores de Consumo Alimentar.', true, 'f10', null, false);
--INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000001, 2, 'COMPUTADORES', '', true, null, null, false);
--INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000000, 3, 'CENSO ESCOLA', '', true, null, null, false);
--INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000002, 3, 'CENSO RECURSO HUMANO', '', true, null, null, false);
--INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000004, 1, 'AVALIAÇÃO CIDADÃO - CADÚNICO', '', true, 'AvaliacaoCadastroUnicoCidadao', null, false);
--INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000003, 1, 'AVALIACAO FAMILIAR', '', true, 'AvaliacaoFamiliaCadastroUnico', null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000007, 4, 'AVALIAÇÃO DE ELEGIBILIDADE E ADMISSÃO', '', true, 'f9', null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000008, 5, 'eSocial S2100', '', true, 'esocial_s2100', null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000009, 5, 'e-Social S1000', '', true, 'e-Social S1000', null, false);
INSERT INTO habitacao.avaliacao (db101_sequencial, db101_avaliacaotipo, db101_descricao, db101_obs, db101_ativo, db101_identificador, db101_cargadados, db101_permiteedicao) VALUES (3000010, 5, 'S1010 - TABELA DE RUBRICAS', 'Registros do evento S-1010 - Tabela de Rubricas', true, 'S1010', 'select rh27_rubric as codigorubrica,  rh27_descr as descricaorubrica from rhrubricas where rh27_instit = fc_getsession(''DB_instit'')::int', true);
