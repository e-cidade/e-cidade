...
class AddUserJonatas extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('JÔNATAS SILVA SOARES RUAS', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '70415493641', 'M', '2021-03-16 00:00:00.0', '16:42', 'JÔNATAS SILVA SOARES RUAS', 'true', '0', '0', 'null', 'user' => array('JÔNATAS SILVA SOARES RUAS', 'jjssr.contass', 'a605521adc96e31b09f6ce5ff1020ca39607986f', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
