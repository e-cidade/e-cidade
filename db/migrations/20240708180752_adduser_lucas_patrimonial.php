...
class AdduserLucasPatrimonial extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('Lucas Silva Guimaraes', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '48145103819', 'M', '2021-03-16 00:00:00.0', '16:42', 'Lucas Silva Guimaraes', 'true', '0', '0', 'null', 'user' => array('Lucas Silva Guimaraes', 'lucasgm.contass', '10470c3b4b1fed12c3baac014be15fac67c6e815', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
