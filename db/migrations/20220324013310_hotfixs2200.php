...
class Hotfixs2200 extends PostgresMigration
{
    public function up()
    {
        $sql = "
...
--  Informações de trabalhador estatutário
    ...
    when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 306 or h13_categoria = 309) and h13_tipocargo = 6 and h13_dscapo = ''SCM'' then 4001055
    when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 306 or h13_categoria = 309) and h13_tipocargo = 6 and h13_dscapo = ''PRE'' or h13_dscapo = ''VPR'' or h13_dscapo = ''PCA'' or h13_dscapo = ''VPC'' or h13_dscapo = ''VER'' then 4001055
    end as tpProv,
