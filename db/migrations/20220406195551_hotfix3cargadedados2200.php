...
class Hotfix3cargadedados2200 extends PostgresMigration
{
    public function up()
    {
        $sql = "
    ...
    when rh02_plansegreg = 0 then 4001066
    end as tpPlanRP,
                case when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) then 4001071
                end as indTetoRGPS,
