...
class Adduserdcmscontass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('DANIEL DE CASTRO MENDES E SILVA', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '02288813660', 'M', '2021-03-16 00:00:00.0', '16:42', 'DANIEL DE CASTRO MENDES E SILVA', 'true', '0', '0', 'null', 'user' => array('DANIEL DE CASTRO MENDES E SILVA', 'dcms.contass', 'd5279acac463a578019a967ab8fe6c5709e6fcfb', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
