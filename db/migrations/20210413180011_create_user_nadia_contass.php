...
class CreateUserNadiaContass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('NÁDIA THAYNÁ SOUZA WEISSMANN','NAO INFORMADO','0','NAO INFORMADO','MONTES CLAROS','MG','39400053','2021-04-13 00:00:00.0','1','0','1','2','0','11381992650','M','2021-04-13 00:00:00.0','16:42','NÁDIA THAYNÁ SOUZA WEISSMANN','true','0','0','null', 'user' => array('NÁDIA THAYNÁ SOUZA WEISSMANN','nt.contass','31b8946a10d2e345842b245f0df49523a2b0eb24','1','nt@contassconsultoria.com.br','0','1','2021-04-13 00:00:00.0'))
        );
