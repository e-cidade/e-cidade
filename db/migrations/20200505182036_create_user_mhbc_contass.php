...
class CreateUserMhbcContass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('MARCELO HERNANE BRAGA COELHO','NAO INFORMADO','0','NAO INFORMADO','MONTES CLAROS','MG','39400053','2020-04-09 00:00:00.0','1','0','1','2','0','09845008631','M','2020-04-09 00:00:00.0','16:42','MARCELO HERNANE BRAGA COELHO','true','0','0','null', 'user' => array('MARCELO HERNANE BRAGA COELHO','mhbc.contass','19d03986b9872cb11868758f124c0ae03f9c1dc4','1','marcelo@contassconsultoria.com.br','0','1','2020-04-09 00:00:00.0'))
        );
