-- FUNCTION: public.fc_vistorias(integer)
-- DROP FUNCTION IF EXISTS public.fc_vistorias(integer);

CREATE OR REPLACE FUNCTION PUBLIC.FC_VISTORIAS(integer) RETURNS CHARACTER varying LANGUAGE 'plpgsql' COST 100 VOLATILE AS $BODY$
DECLARE
...
ALTER FUNCTION PUBLIC.FC_VISTORIAS(integer) OWNER TO DBPORTAL;
