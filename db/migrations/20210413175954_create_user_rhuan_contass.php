...
class CreateUserRhuanContass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('RHUAN MARTINEZ LOPES RAMOS','NAO INFORMADO','0','NAO INFORMADO','MONTES CLAROS','MG','39400053','2021-04-13 00:00:00.0','1','0','1','2','0','12386878651','M','2021-04-13 00:00:00.0','16:42','RHUAN MARTINEZ LOPES RAMOS','true','0','0','null', 'user' => array('RHUAN MARTINEZ LOPES RAMOS','rm.contass','53fa7e59f8d80aea13c8ed294efbc066f8a34eba','1','rm@contassconsultoria.com.br','0','1','2021-04-13 00:00:00.0'))
        );
