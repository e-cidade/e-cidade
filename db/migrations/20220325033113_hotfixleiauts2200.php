...
class Hotfixleiauts2200 extends PostgresMigration
{
    public function up()
    {
        $sql = "
        ...
        UPDATE avaliacaopergunta SET db103_avaliacaotiporesposta = 2 WHERE db103_identificador = 'instituicao-no-ecidade-4000102';
            ...
            --  Informações de trabalhador estatutário
                ...
                case when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) and rh02_plansegreg = 1 then 4001067
                when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) and rh02_plansegreg = 2 then 4001068
                when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) and rh02_plansegreg = 3 then 4001069
                end as tpPlanRP,
                ...
                case when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) and rh02_abonopermanencia = ''f'' then 4001073
                when (h13_categoria = 301 or h13_categoria = 302 or h13_categoria = 303 or h13_categoria = 306 or h13_categoria = 309) and rh02_abonopermanencia = ''t'' then 4001072
                end as indAbonoPerm,
            ...
            --Estabelecimento (CNPJ, CNO, CAEPF) onde o trabalhador (exceto doméstico) exercerá suas atividades
                    4001106 as tpinsclocaltrabgeral,
                    cgc as nrinsclocaltrabgeral,
                    nomeinst as desccomplocaltrabgeral,
