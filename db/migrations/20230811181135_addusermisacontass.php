...
class Addusermisacontass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('MARIA MIZAELLE NOGUEIRA SOUZA', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '15020186678', 'M', '2021-03-16 00:00:00.0', '16:42', 'MARIA MIZAELLE NOGUEIRA SOUZA', 'true', '0', '0', 'null', 'user' => array('MARIA MIZAELLE NOGUEIRA SOUZA', 'mmns.contass', '27688aabd179a7b828838aa5f739b27cdda3f099', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
