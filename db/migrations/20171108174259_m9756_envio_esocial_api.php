...
class M9756EnvioEsocialApi extends PostgresMigration
{
    ...
    public function up()
    {
        $this->execute("
            ...
            INSERT INTO configuracoes.db_syscampo (codcam, nomecam, conteudo, descricao, valorinicial, rotulo, tamanho, nulo, maiusculo, autocompl, aceitatipo, tipoobj, rotulorel) VALUES (21839, 'db103_tipo                              ', 'int4                                    ', 'Tipo de dado para criação do formulário.', '', 'Tipo', 5, false, false, false, 1, 'text', 'Tipo');
            INSERT INTO configuracoes.db_syscampo (codcam, nomecam, conteudo, descricao, valorinicial, rotulo, tamanho, nulo, maiusculo, autocompl, aceitatipo, tipoobj, rotulorel) VALUES (21840, 'db103_mascara                           ', 'varchar(40)                             ', 'Máscara para geração do formulário.', '', 'Máscara', 40, true, true, false, 0, 'text', 'Máscara');
