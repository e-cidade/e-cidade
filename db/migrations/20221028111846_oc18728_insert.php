...
class Oc18728Insert extends PostgresMigration
{
    public function up()
    {
        ...
        foreach ($aDados->Novas_Receitas as $contasInserir) {
            ...
            if ($contasInserir->Fonte != 'sintetica') {
    ...
    public function down()
    {
        ...
        foreach ($aDadosDown->Novas_Receitas as $contas) {

            $this->execute("DELETE FROM orcfontes
                            WHERE o57_fonte = '{$contas->Estrutural}' AND o57_anousu >= 2023");
