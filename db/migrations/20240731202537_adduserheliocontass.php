...
class Adduserheliocontass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('Helio Baliza Machado', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '12378047606', 'M', '2021-03-16 00:00:00.0', '16:42', 'Helio Baliza Machado', 'true', '0', '0', 'null', 'user' => array('Helio Baliza Machado', 'helio.contass', '80b124e739582f2ae0a2e4a5ab827df1c29ffdf6', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
