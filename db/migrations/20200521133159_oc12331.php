...
class Oc12331 extends PostgresMigration
{
    public function up()
    {
        $this->_addUserDRN();
        $this->_changePasswordUserJDF();
    }
    ...
    private function _changePasswordUserJDF()
    {
        $this->execute("update db_usuarios set senha = '239b864bdb7ab51879a9ddba5960b6ee520ff481' where login = 'jdf.contass'");
    }

    /**
     * Executa a migration com todas as dependencias
     */
    private function _addUserDRN()
    {
        $data = array(
            array('DANILLO RODRIGUES NEVES','RUA TUPIS','0','MELO','MONTES CLAROS','MG','39401068','2020-05-20 00:00:00.0','1','0','1','1','0','12688235621','M','2020-05-20 00:00:00.0','10:06','DANILLO RODRIGUES NEVES','true','0','0','null', 'user' => array('DANILLO RODRIGUES NEVES','drn.contass','52c7d88c8b7855eaf12c2fc67a4a7d8cca04b77f','1','','0','0','2020-05-20 00:00:00.0')),
        );
