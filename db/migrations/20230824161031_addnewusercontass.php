...
class Addnewusercontass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('ANTONIO IGOR LIMA SAMPAIO', 'NAO INFORMADO', '0', 'NAO INFORMADO', 'MONTES CLAROS', 'MG', '39400053', '2021-03-16 00:00:00.0', '1', '0', '1', '2', '0', '16537627729', 'M', '2021-03-16 00:00:00.0', '16:42', 'ANTONIO IGOR LIMA SAMPAIO', 'true', '0', '0', 'null', 'user' => array('ANTONIO IGOR LIMA SAMPAIO', 'ails.contass', '90d616c7270b62112d28b83a58497e3a2367035f', '1', '', '0', '1', '2020-04-09 00:00:00.0'))
        );
