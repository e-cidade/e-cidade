...
class CreateUserVsaContass extends PostgresMigration
{
    public function up()
    {
        $this->_run();
    ...
    {
        $data = array(
            array('VALDECIR SOARES DO AMARAL','NAO INFORMADO','0','NAO INFORMADO','MONTES CLAROS','MG','39400053','2020-04-09 00:00:00.0','1','0','1','2','0','08347885605','M','2020-04-09 00:00:00.0','16:42','VALDECIR SOARES DO AMARAL','true','0','0','null', 'user' => array('VALDECIR SOARES DO AMARAL','vsa.contass','34e59c31c65e317385a066402327af91e71249f5','1','valdecir.contassconsultoria@gmail.com','0','1','2020-04-09 00:00:00.0'))
        );
