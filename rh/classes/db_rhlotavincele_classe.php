...
class cl_rhlotavincele { 
   ...
   var $campos = "
                 ...
                 rh28_codeledef = int4 = Código Elemento 
                 rh28_codelenov = int4 = Código Elemento 
                 ";
   ...
   function incluir ($rh28_codlotavinc,$rh28_codeledef){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7143,'$this->rh28_codlotavinc','I')");
       $resac = pg_query("insert into db_acountkey values($acount,7144,'$this->rh28_codeledef','I')");
       $resac = pg_query("insert into db_acount values($acount,1184,7143,'','".AddSlashes(pg_result($resaco,0,'rh28_codlotavinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1184,7144,'','".AddSlashes(pg_result($resaco,0,'rh28_codeledef'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1184,7145,'','".AddSlashes(pg_result($resaco,0,'rh28_codelenov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($rh28_codlotavinc=null,$rh28_codeledef=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7143,'$this->rh28_codlotavinc','A')");
         $resac = pg_query("insert into db_acountkey values($acount,7144,'$this->rh28_codeledef','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh28_codlotavinc"]))
           $resac = pg_query("insert into db_acount values($acount,1184,7143,'".AddSlashes(pg_result($resaco,$conresaco,'rh28_codlotavinc'))."','$this->rh28_codlotavinc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh28_codeledef"]))
           $resac = pg_query("insert into db_acount values($acount,1184,7144,'".AddSlashes(pg_result($resaco,$conresaco,'rh28_codeledef'))."','$this->rh28_codeledef',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh28_codelenov"]))
           $resac = pg_query("insert into db_acount values($acount,1184,7145,'".AddSlashes(pg_result($resaco,$conresaco,'rh28_codelenov'))."','$this->rh28_codelenov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($rh28_codlotavinc=null,$rh28_codeledef=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7143,'$rh28_codlotavinc','E')");
         $resac = pg_query("insert into db_acountkey values($acount,7144,'$rh28_codeledef','E')");
         $resac = pg_query("insert into db_acount values($acount,1184,7143,'','".AddSlashes(pg_result($resaco,$iresaco,'rh28_codlotavinc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1184,7144,'','".AddSlashes(pg_result($resaco,$iresaco,'rh28_codeledef'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1184,7145,'','".AddSlashes(pg_result($resaco,$iresaco,'rh28_codelenov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query_ele ( $rh28_codlotavinc=null,$rh28_codeledef=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join orcelemento a  on  a.o56_codele = rhlotavincele.rh28_codelenov  and a.o56_anousu=".db_getsession("DB_anousu");
