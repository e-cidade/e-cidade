...
<script type="text/javascript">
  function js_logaRotinaStatusBar() {

    var oRotinaAberta          = $('corpo').contentWindow.location;

    if( $('bstatus').contentDocument.getElementById('sRotinaEmExecucao') ){

      var oStatusBarRotina       = $('bstatus').contentDocument.getElementById('sRotinaEmExecucao');
    ...
    var inner  = '<a href="#" onclick="js_minimizaTopo();"><span>Hide</span></a>';
...
<frameset id="quadroprincipal" rows="60,*,19" cols="*" frameborder="no" framespacing="0" border="0" onUnload="js_fechaJanela();">
  ...
  <frame src="instit.php"             name="corpo"     frameborder="no" scrolling="auto" noresize id="corpo"   onload="js_logaRotinaStatusBar();">
