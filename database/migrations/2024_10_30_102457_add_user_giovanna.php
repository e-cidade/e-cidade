...
class AddUserGiovanna extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function _run()
    {
        ...
        $data = array(
            array('GIOVANNA AZEVEDO DE SOUZA OLIVEIRA',
                  'NAO INFORMADO',
                  '0',
                  'NAO INFORMADO',
                  'MONTES CLAROS',
                  ...
                  '2024-01-01 00:00:00.0',
                  '08:00',
                  'GIOVANNA AZEVEDO DE SOUZA OLIVEIRA',
                  true,
                  '0',
                  '0',
                  null,
                  'user' => array('GIOVANNA AZEVEDO DE SOUZA OLIVEIRA',
                                  'gaso.contass',
