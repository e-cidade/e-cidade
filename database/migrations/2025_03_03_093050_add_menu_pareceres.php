...
class AddMenuPareceres extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::table('configuracoes.db_itensmenu')->insert([
            ...
            'descricao' => 'Parecer da Licitacao',
            'help' => 'Parecer da Licitacao',
            'funcao' => 'lic_pareceres001.php',
            'itemativo' => 1,
            'manutencao' => 1,
            'desctec' => 'Parecer da Licitacao',
            'libcliente' => 't',
        ]);
