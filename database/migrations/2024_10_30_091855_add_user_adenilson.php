...
class AddUserAdenilson extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function _run()
    {
        ...
        $data = array(
            array('ADENILSON GONCALVES DE OLIVEIRA',
                  'NAO INFORMADO',
                  '0',
                  'NAO INFORMADO',
                  'BURITIZEIRO',
                  ...
                  '2021-03-16 00:00:00.0',
                  '16:42',
                  'ADENILSON GONCALVES DE OLIVEIRA',
                  true,
                  '0',
                  '0',
                  null,
                  'user' => array('ADENILSON GONCALVES DE OLIVEIRA',
                                  'ago.contass',
