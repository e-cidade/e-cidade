...
class cl_ntf202025
{
  ...
  var $campos = "
                 ...
                 si145_codunidadesub = varchar(8) = C�digo da unidade
                 si145_dtempenho = date = Data do empenho
                 si145_nroempenho = int8 = N�mero do  empenho
                 si145_dtliquidacao = date = Data da Liquida��o do empenho
                 si145_nroliquidacao = int8 = N�mero da  liquida��o
                 si145_mes = int8 = M�s
                 si145_reg10 = int8 = reg10
                 si145_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ntf202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ntf202025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si145_nfnumero = ($this->si145_nfnumero == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_nfnumero"] : $this->si145_nfnumero);
      $this->si145_nfserie = ($this->si145_nfserie == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_nfserie"] : $this->si145_nfserie);
      $this->si145_tipodocumento = ($this->si145_tipodocumento == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_tipodocumento"] : $this->si145_tipodocumento);
      $this->si145_nrodocumento = ($this->si145_nrodocumento == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_nrodocumento"] : $this->si145_nrodocumento);
      $this->si145_chaveacesso = ($this->si145_chaveacesso == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_chaveacesso"] : $this->si145_chaveacesso);
      if ($this->si145_dtemissaonf == "") {
        $this->si145_dtemissaonf_dia = ($this->si145_dtemissaonf_dia == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_dia"] : $this->si145_dtemissaonf_dia);
        $this->si145_dtemissaonf_mes = ($this->si145_dtemissaonf_mes == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_mes"] : $this->si145_dtemissaonf_mes);
        $this->si145_dtemissaonf_ano = ($this->si145_dtemissaonf_ano == "" ? @$GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_ano"] : $this->si145_dtemissaonf_ano);
        if ($this->si145_dtemissaonf_dia != "") {
          $this->si145_dtemissaonf = $this->si145_dtemissaonf_ano . "-" . $this->si145_dtemissaonf_mes . "-" . $this->si145_dtemissaonf_dia;
        }
      }
  ...
  function incluir($si145_sequencial)
  {
    ...
    if ($this->si145_tipodocumento == null) {
      $this->si145_tipodocumento = "0";
    }
    if ($this->si145_nrodocumento == null) {
    ...
    if ($si145_sequencial == "" || $si145_sequencial == null) {
      $result = db_query("select nextval('ntf202025_si145_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ntf202025_si145_sequencial_seq do campo: si145_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ntf202025_si145_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si145_sequencial)) {
        $this->erro_sql = " Campo si145_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ntf202025 ($this->si145_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ntf202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ntf202025 ($this->si145_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si145_sequencial = null)
  {
    ...
    if (trim($this->si145_nfserie) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si145_nfserie"])) {
      ...
      $sql .= $virgula . " si145_nfserie = '$this->si145_nfserie' ";
      $virgula = ",";
    }
    if (trim($this->si145_tipodocumento) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si145_tipodocumento"])) {
      if (trim($this->si145_tipodocumento) == "" && isset($GLOBALS["HTTP_POST_VARS"]["si145_tipodocumento"])) {
        $this->si145_tipodocumento = "0";
      }
      $sql .= $virgula . " si145_tipodocumento = $this->si145_tipodocumento ";
      $virgula = ",";
    }
    if (trim($this->si145_nrodocumento) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si145_nrodocumento"])) {
      if (trim($this->si145_nrodocumento) == "" && isset($GLOBALS["HTTP_POST_VARS"]["si145_nrodocumento"])) {
        $this->si145_nrodocumento = "0";
      }
      $sql .= $virgula . " si145_nrodocumento = '$this->si145_nrodocumento' ";
      $virgula = ",";
    }
    ...
    if (trim($this->si145_dtemissaonf) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_dia"]) && ($GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_dia"] != "")) {
      $sql .= $virgula . " si145_dtemissaonf = '$this->si145_dtemissaonf' ";
      $virgula = ",";
    } else {
      if (isset($GLOBALS["HTTP_POST_VARS"]["si145_dtemissaonf_dia"])) {
        $sql .= $virgula . " si145_dtemissaonf = null ";
        $virgula = ",";
      }
    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ntf202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si145_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ntf202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si145_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si145_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ntf202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ntf202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si145_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ntf202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si145_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ntf202025 ";
    $sql .= "      left  join ntf102020  on  ntf102020.si143_sequencial = ntf202025.si145_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si145_sequencial != null) {
        $sql2 .= " where ntf202025.si145_sequencial = $si145_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
