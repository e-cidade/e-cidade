<?php
//MODULO: sicom
//CLASSE DA ENTIDADE exeobras202025
class cl_exeobras202025 {
    ...
    public $campos = "
                 ...
                 si204_mes = int4 = Mes
                 si204_instit = int4 = Institui��o
                 ";

    //funcao construtor da classe
    function __construct() {
        //classes dos rotulos dos campos
        $this->rotulo = new rotulo("exeobras202025");
    ...
    function incluir () {
        ...
        if ($this->si204_sequencial == null ) {
            $result = db_query("select nextval('exeobras202025_si204_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: exeobras202025_si204_sequencial_seq do campo: si204_sequencial";
        ...
        if ($this->si204_exercicioprocesso == null ) {
            $this->erro_sql = " Campo exercicioprocesso n�o informado.";
        ...
        if ($this->si204_codunidadesubresp == null ) {
            $this->erro_sql = " Campo Cod unidade Sub do processo licitatorio n�o informado.";
            $this->erro_campo = "si204_exercicioprocesso";
            $this->erro_banco = "";
            $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        ...
        if ($this->si204_contdeclicitacao == null ) {
            $this->erro_sql = " Campo si204_contdeclicitacao n�o informado.";
        ...
        $sql = "insert into exeobras202025(
                                       si204_sequencial
                                      ,si204_tiporegistro
                                      ,si204_codorgao
                                      ,si204_codunidadesub
    ...
    function excluir ( $si204_sequencial=null ,$dbwhere=null) {
        ...
        $sql = " delete from exeobras202025
                    where ";
        $sql2 = "";
    ...
    function sql_record($sql) {
        ...
        if ($this->numrows==0) {
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:exeobras202025";
            $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si204_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
        ...
        $sql .= " from exeobras202025 ";
        $sql2 = "";
        if ($dbwhere=="") {
            if ( $si204_sequencial != "" && $si204_sequencial != null) {
                $sql2 = " where exeobras202025.si204_sequencial = '$si204_sequencial'";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
