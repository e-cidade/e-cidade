<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp102022
class cl_dfcdcasp102022 {
  ...
  function cl_dfcdcasp102022() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dfcdcasp102022");
  ...
  function incluir ($si219_sequencial){
    ...
    if(empty($si219_sequencial)){
      $result = db_query("select nextval('dfcdcasp102022_si219_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("
","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp102022_si219_sequencial_seq do campo: si219_sequencial";
      ...
      $result = db_query("select last_value from dfcdcasp102022_si219_sequencial_seq");
    ...
    $sql = "insert into dfcdcasp102022(
                                       si219_anousu
                                      ,si219_periodo
                                      ,si219_instit
                                      ,si219_sequencial
...
","",@pg_last_error());
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "dfcdcasp102022 ($this->si219_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_banco = "dfcdcasp102022 já Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      }else{
        $this->erro_sql   = "dfcdcasp102022 ($this->si219_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
  ...
  function alterar ($si219_sequencial=null) {
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "dfcdcasp102022 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : ".$this->si219_sequencial;
      $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "dfcdcasp102022 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : ".$this->si219_sequencial;
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
  ...
  function excluir ($si219_sequencial=null,$dbwhere=null) {
    ...
    $sql = " delete from dfcdcasp102022
                    where ";
    $sql2 = "";
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "dfcdcasp102022 nao Excluído. Exclusão Abortada.\n";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "dfcdcasp102022 nao Encontrado. Exclusão não Efetuada.\n";
        $this->erro_sql .= "Valores : ".$si219_sequencial;
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
...
","",@pg_last_error());
    ...
    if($this->numrows==0){
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp102022";
      $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si219_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    $sql .= " from dfcdcasp102022 ";
    $sql2 = "";
    if($dbwhere==""){
      if($si219_sequencial!=null ){
        $sql2 .= " where dfcdcasp102022.si219_sequencial = $si219_sequencial ";
      }
    }else if($dbwhere != ""){
      $sql2 = " where $dbwhere";
    }
