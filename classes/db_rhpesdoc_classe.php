...
class cl_rhpesdoc {
   ...
   var $rh16_cnh_exp_dia = null;
   var $rh16_cnh_exp_mes = null;
   var $rh16_cnh_exp_ano = null;
   var $rh16_cnh_exp = null;
   var $rh16_emissao_dia = null;
   var $rh16_emissao_mes = null;
   var $rh16_emissao_ano = null;
   var $rh16_emissao = null;
   var $rh16_cnh_uf = null;
   ...
   var $campos = "
                 ...
                 rh16_cnh_uf = varchar(2) = UF da CNH
                 rh16_cnh_exp = date = Data de Expedição da CNH
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->rh16_cnh_exp == ""){
         $this->rh16_cnh_exp_dia = ($this->rh16_cnh_exp_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_dia"]:$this->rh16_cnh_exp_dia);
         $this->rh16_cnh_exp_mes = ($this->rh16_cnh_exp_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_mes"]:$this->rh16_cnh_exp_mes);
         $this->rh16_cnh_exp_ano = ($this->rh16_cnh_exp_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_ano"]:$this->rh16_cnh_exp_ano);
         if($this->rh16_cnh_exp_dia != ""){
            $this->rh16_cnh_exp = $this->rh16_cnh_exp_ano."-".$this->rh16_cnh_exp_mes."-".$this->rh16_cnh_exp_dia;
         }
       }
       $this->rh16_cnh_uf = ($this->rh16_cnh_uf == ""?@$GLOBALS["HTTP_POST_VARS"]["rh16_cnh_uf"]:$this->rh16_cnh_uf);
     }else{
       $this->rh16_regist = ($this->rh16_regist == ""?@$GLOBALS["HTTP_POST_VARS"]["rh16_regist"]:$this->rh16_regist);
     }
   }
   ...
   function incluir ($rh16_regist){
     ...
     if($this->rh16_cnh_exp == null ){
       $this->rh16_cnh_exp = "null";
     }
     ...
     $sql = "insert into rhpesdoc(
                ...
                values (
                               ...
                               ,'$this->rh16_cnh_uf'
                               ,".($this->rh16_cnh_exp == "null" || $this->rh16_cnh_exp == ""?"null":"'".$this->rh16_cnh_exp."'")."
                      )";
     $result = db_query($sql);
     if($result==false){
   ...
   function alterar ($rh16_regist=null) {
     ...
     if(trim($this->rh16_cnh_exp)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_dia"] !="") ){
       $sql  .= $virgula." rh16_cnh_exp = '$this->rh16_cnh_exp' ";
       $virgula = ",";
     }     else{
       if(isset($GLOBALS["HTTP_POST_VARS"]["rh16_cnh_exp_dia"])){
         $sql  .= $virgula." rh16_cnh_exp = null ";
         $virgula = ",";
       }
     }
     if(trim($this->rh16_cnh_uf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh16_cnh_uf"])){
       $sql  .= $virgula." rh16_cnh_uf = '$this->rh16_cnh_uf' ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($rh16_regist!=null){
