<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete302025
class cl_balancete302025
{
  ...
  function cl_balancete302025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete302025");
  ...
  function incluir($si242_sequencial)
  {
    ...
    if ($this->si242_tiporegistro == null) {
      $this->erro_sql = " Campo si242_tiporegistro n�o informado.";
    ...
    if ($this->si242_contacontaabil == null) {
      $this->erro_sql = " Campo si242_contacontaabil n�o informado.";
    ...
    if ($this->si242_codorgao == null) {
      $this->erro_sql = " Campo si242_codorgao n�o informado.";
    ...
    if ($this->si242_codunidadesub == null) {
      $this->erro_sql = " Campo si242_codunidadesub n�o informado.";
    ...
    if ($this->si242_codfuncao == null) {
      $this->erro_sql = " Campo si242_codfuncao n�o informado.";
    ...
    if ($this->si242_codsubfuncao == null) {
      $this->erro_sql = " Campo si242_codsubfuncao n�o informado.";
    ...
    if ($this->si242_codprograma == null) {
      $this->erro_sql = " Campo si242_codprograma n�o informado.";
    ...
    if ($this->si242_idacao == null) {
      $this->erro_sql = " Campo si242_idacao n�o informado.";
    ...
    if ($this->si242_naturezadespesa == null) {
      $this->erro_sql = " Campo si242_naturezadespesa n�o informado.";
    ...
    if ($this->si242_subelemento == null) {
      $this->erro_sql = " Campo si242_subelemento n�o informado.";
    ...
    if ($this->si242_codfontrecursos == null) {
      $this->erro_sql = " Campo si242_codfontrecursos n�o informado.";
    ...
    if ($this->si242_saldoinicialcde == null) {
      $this->erro_sql = " Campo si242_saldoinicialcde n�o informado.";
    ...
    if ($this->si242_naturezasaldoinicialcde == null) {
      $this->erro_sql = " Campo si242_naturezasaldoinicialcde n�o informado.";
    ...
    if ($this->si242_totaldebitoscde == null) {
      $this->erro_sql = " Campo si242_totaldebitoscde n�o informado.";
    ...
    if ($this->si242_totalcreditoscde == null) {
      $this->erro_sql = " Campo si242_totalcreditoscde n�o informado.";
    ...
    if ($this->si242_saldofinalcde == null) {
      $this->erro_sql = " Campo si242_saldofinalcde n�o informado.";
    ...
    if ($this->si242_naturezasaldofinalcde == null) {
      $this->erro_sql = " Campo si242_naturezasaldofinalcde n�o informado.";
    ...
    if ($this->si242_mes == null) {
      $this->erro_sql = " Campo si242_mes n�o informado.";
    ...
    if ($this->si242_instit == null) {
      $this->erro_sql = " Campo si242_instit n�o informado.";
    ...
    if ($si242_sequencial == "" || $si242_sequencial == null) {
      $result = db_query("select nextval('balancete302025_si242_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete302025_si242_sequencial_seq do campo: si242_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete302025_si242_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si242_sequencial)) {
        $this->erro_sql = " Campo si242_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete302025(
                                       si242_sequencial
                                      ,si242_tiporegistro
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete302025 ($this->si242_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete302025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete302025 ($this->si242_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete302025 set ";
    $virgula = "";
    if (trim($this->si242_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si242_sequencial"])) {
      ...
      if (trim($this->si242_sequencial) == null) {
        $this->erro_sql = " Campo si242_sequencial n�o informado.";
    ...
    if (trim($this->si242_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si242_codfundo"])) {
      ...
      if (trim($this->si242_codfundo) == null) {
        $this->erro_sql = " Campo si242_codfundo n�o informado.";
    ...
    if (trim($this->si242_idsubacao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si242_idsubacao"])) {
      ...
      if (trim($this->si242_idsubacao) == null) {
        $this->erro_sql = " Campo si242_idsubacao n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete302025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si242_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete302025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si242_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  {
    $sql = " delete from balancete302025
                    where ";
    $sql2 = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete302025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si242_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete302025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si242_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete302025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si242_sequencial != null) {
        $sql2 .= " where balancete302025.si242_sequencial = $si242_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
