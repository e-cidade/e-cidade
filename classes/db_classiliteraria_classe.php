...
class cl_classiliteraria { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->bi03_codigo = ($this->bi03_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["bi03_codigo"]:$this->bi03_codigo);
       $this->bi03_classificacao = ($this->bi03_classificacao == ""?@$GLOBALS["HTTP_POST_VARS"]["bi03_classificacao"]:$this->bi03_classificacao);
     }else{
       $this->bi03_codigo = ($this->bi03_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["bi03_codigo"]:$this->bi03_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($bi03_codigo){ 
      $this->atualizacampos();
     if($this->bi03_classificacao == null ){ 
     ...
     if($bi03_codigo == "" || $bi03_codigo == null ){
       $result = db_query("select nextval('classiliteraria_bi03_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: classiliteraria_bi03_codigo_seq do campo: bi03_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $bi03_codigo)){
         ...
         $this->bi03_codigo = $bi03_codigo; 
       }
     }
     if(($this->bi03_codigo == null) || ($this->bi03_codigo == "") ){ 
       $this->erro_sql = " Campo bi03_codigo nao declarado.";
     ...
     $sql = "insert into classiliteraria(
                                       bi03_codigo 
                                      ,bi03_classificacao 
                       )
                values (
                                $this->bi03_codigo 
                               ,'$this->bi03_classificacao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->bi03_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($bi03_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($bi03_codigo!=null){
       $sql .= " bi03_codigo = $this->bi03_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->bi03_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Classificação Literária nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi03_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Classificação Literária nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi03_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($bi03_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($bi03_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Classificação Literária nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$bi03_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Classificação Literária nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$bi03_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $bi03_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from classiliteraria ";
     $sql2 = "";
     if($dbwhere==""){
       if($bi03_codigo!=null ){
         $sql2 .= " where classiliteraria.bi03_codigo = $bi03_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
