...
class cl_censoetapa { 
   ...
   var $campos = "
                 ...
                 ed266_profissional = char(1) = Profissional 
                 ed266_ano = int4 = Ano 
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ed266_profissional = ($this->ed266_profissional == ""?@$GLOBALS["HTTP_POST_VARS"]["ed266_profissional"]:$this->ed266_profissional);
   ...
   function incluir ($ed266_i_codigo,$ed266_ano){ 
     ...
     if($this->ed266_profissional == null ){ 
       $this->erro_sql = " Campo Profissional não informado.";
       $this->erro_campo = "ed266_profissional";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if(($this->ed266_ano == null) || ($this->ed266_ano == "") ){ 
       $this->erro_sql = " Campo ed266_ano nao declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Etapas/Séries do Censo Escolar ($this->ed266_i_codigo."-".$this->ed266_ano) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,2413,21045,'','".AddSlashes(pg_result($resaco,0,'ed266_profissional'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   public function alterar ($ed266_i_codigo=null,$ed266_ano=null) { 
     ...
     if(trim($this->ed266_profissional)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed266_profissional"])){ 
       $sql  .= $virgula." ed266_profissional = '$this->ed266_profissional' ";
       $virgula = ",";
       if(trim($this->ed266_profissional) == null ){ 
         $this->erro_sql = " Campo Profissional não informado.";
         $this->erro_campo = "ed266_profissional";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["ed266_profissional"]) || $this->ed266_profissional != "")
             $resac = db_query("insert into db_acount values($acount,2413,21045,'".AddSlashes(pg_result($resaco,$conresaco,'ed266_profissional'))."','$this->ed266_profissional',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if (!$result) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Etapas/Séries do Censo Escolar nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed266_i_codigo."-".$this->ed266_ano;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Etapas/Séries do Censo Escolar nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed266_i_codigo."-".$this->ed266_ano;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($ed266_i_codigo=null,$ed266_ano=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,2413,21045,'','".AddSlashes(pg_result($resaco,$iresaco,'ed266_profissional'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if ($result == false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Etapas/Séries do Censo Escolar nao Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Etapas/Séries do Censo Escolar nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed266_i_codigo."-".$ed266_ano;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
