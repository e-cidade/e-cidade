...
class cl_cnaeanalitica { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q72_sequencial = ($this->q72_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q72_sequencial"]:$this->q72_sequencial);
       $this->q72_cnae = ($this->q72_cnae == ""?@$GLOBALS["HTTP_POST_VARS"]["q72_cnae"]:$this->q72_cnae);
     }else{
       $this->q72_sequencial = ($this->q72_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q72_sequencial"]:$this->q72_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($q72_sequencial){ 
      $this->atualizacampos();
     if($this->q72_cnae == null ){ 
     ...
     if($q72_sequencial == "" || $q72_sequencial == null ){
       $result = db_query("select nextval('cnaeanalitica_q72_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: cnaeanalitica_q72_sequencial_seq do campo: q72_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $q72_sequencial)){
         ...
         $this->q72_sequencial = $q72_sequencial; 
       }
     }
     if(($this->q72_sequencial == null) || ($this->q72_sequencial == "") ){ 
       $this->erro_sql = " Campo q72_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q72_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q72_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($q72_sequencial!=null){
       $sql .= " q72_sequencial = $this->q72_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->q72_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cnaeanalitica nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q72_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cnaeanalitica nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q72_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($q72_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q72_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($q72_sequencial != ""){
          ...
          $sql2 .= " q72_sequencial = $q72_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cnaeanalitica nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$q72_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cnaeanalitica nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q72_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $q72_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from cnaeanalitica ";
     $sql .= "      inner join cnae  on  cnae.q71_sequencial = cnaeanalitica.q72_cnae";
     $sql2 = "";
     if($dbwhere==""){
       if($q72_sequencial!=null ){
         $sql2 .= " where cnaeanalitica.q72_sequencial = $q72_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
