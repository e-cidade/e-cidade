...
class cl_cadferia { 
   ...
   function incluir (){ 
     ...
     if($this->r30_numcgm == null ){ 
       $this->erro_sql = " Campo Codigo do Funcionario no cgm nao Informado.";
     ...
     if($this->r30_faltas == null ){ 
       $this->erro_sql = " Campo Faltas Durante o Período Aquisitivo nao Informado.";
     ...
     if($this->r30_perai == null ){ 
       $this->erro_sql = " Campo Período Aquisitivo nao Informado.";
     ...
     if($this->r30_peraf == null ){ 
       $this->erro_sql = " Campo Final Período nao Informado.";
     ...
     if($this->r30_ndias == null ){ 
       $this->erro_sql = " Campo Total de Dias a Gozar nao Informado.";
     ...
     if($this->r30_per1i == null ){ 
       $this->erro_sql = " Campo Início Gozo nao Informado.";
     ...
     if($this->r30_per1f == null ){ 
       $this->erro_sql = " Campo Final Gozo nao Informado.";
     ...
     if($this->r30_proc1 == null ){ 
       $this->erro_sql = " Campo Pagamento do 1o. periodo nao Informado.";
     ...
     if($this->r30_proc2 == null ){ 
       $this->erro_sql = " Campo Pagamento do 2o periodo nao Informado.";
     ...
     if($this->r30_abono == null ){ 
       $this->erro_sql = " Campo Número de Dias do Abono nao Informado.";
     ...
     if($this->r30_proc1d == null ){ 
       $this->erro_sql = " Campo Ano/Mes do pagto da 1a dif nao Informado.";
     ...
     if($this->r30_vliq1 == null ){ 
       $this->erro_sql = " Campo vlr total das ferias - 1a nao Informado.";
     ...
     if($this->r30_vfgt1 == null ){ 
       $this->erro_sql = " Campo base fgts ferias (1a) nao Informado.";
     ...
     if($this->r30_virf1 == null ){ 
       $this->erro_sql = " Campo base irf ferias (1a) nao Informado.";
     ...
     if($this->r30_vpre1 == null ){ 
       $this->erro_sql = " Campo base prev ferias (1a) nao Informado.";
     ...
     if($this->r30_vliq1d == null ){ 
       $this->erro_sql = " Campo vlr ferias dif (1a) nao Informado.";
     ...
     if($this->r30_vfgt1d == null ){ 
       $this->erro_sql = " Campo base fgts ferias dif (1a) nao Informado.";
     ...
     if($this->r30_virf1d == null ){ 
       $this->erro_sql = " Campo base irfferias dif (1a) nao Informado.";
     ...
     if($this->r30_vpre1d == null ){ 
       $this->erro_sql = " Campo base prev ferias dif (1a) nao Informado.";
     ...
     if($this->r30_vliq2 == null ){ 
       $this->erro_sql = " Campo valor ferias (2a) nao Informado.";
     ...
     if($this->r30_vfgt2 == null ){ 
       $this->erro_sql = " Campo base fgts ferias (2a) nao Informado.";
     ...
     if($this->r30_virf2 == null ){ 
       $this->erro_sql = " Campo base irf ferias (2a) nao Informado.";
     ...
     if($this->r30_vliq2d == null ){ 
       $this->erro_sql = " Campo valor ferias dif (2a) nao Informado.";
     ...
     if($this->r30_virf2d == null ){ 
       $this->erro_sql = " Campo base irf ferias dif (2a) nao Informado.";
     ...
     if($this->r30_vfgt2d == null ){ 
       $this->erro_sql = " Campo base fgts ferias dif (2a) nao Informado.";
     ...
     if($this->r30_vpre2d == null ){ 
       $this->erro_sql = " Campo base prev ferias dif (2a) nao Informado.";
     ...
     if($this->r30_vpre2 == null ){ 
       $this->erro_sql = " Campo base prev ferias (2a) nao Informado.";
     ...
     if($this->r30_tip1 == null ){ 
       $this->erro_sql = " Campo Pgto da 1a parc ou total nao Informado.";
     ...
     if($this->r30_tip2 == null ){ 
       $this->erro_sql = " Campo Pgto da 2a parcela nao Informado.";
     ...
     if($this->r30_psal1 == null ){ 
       $this->erro_sql = " Campo .t. = pontofs/.f.=pontofe nao Informado.";
     ...
     if($this->r30_psal2 == null ){ 
       $this->erro_sql = " Campo t.t= sal pontofs/.f. = pontofe nao Informado.";
     ...
     if($this->r30_proc2d == null ){ 
       $this->erro_sql = " Campo Ano/Mês do pagto da dif do 2o período nao Informado.";
     ...
     if($this->r30_ponto == null ){ 
       $this->erro_sql = " Campo Salario/Complementar nao Informado.";
     ...
     if($this->r30_paga13 == null ){ 
       $this->erro_sql = " Campo pagamento so 1/3 das ferias nao Informado.";
     ...
     if($this->r30_descad == null ){ 
       $this->erro_sql = " Campo descontos sobre o adiantamento nao Informado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastro de Ferias                                 () nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
