...
//CLASSE DA ENTIDADE inscricaopassivoslip
class cl_inscricaopassivoslip { 
   ...
   var $campos = "
                 ...
                 c109_inscricaopassiva = int4 = Inscrição Passiva 
                 c109_slip = int4 = Código Slip 
                 ";
   //funcao construtor da classe 
   function cl_inscricaopassivoslip() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("inscricaopassivoslip"); 
   ...
   function incluir ($c109_sequencial){ 
     ...
     if($c109_sequencial == "" || $c109_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $c109_sequencial)){
         $this->erro_sql = " Campo c109_sequencial maior que último número da sequencia.";
     ...
     $sql = "insert into inscricaopassivoslip(
                                       c109_sequencial 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Slips inscrição ($this->c109_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Slips inscrição já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Slips inscrição ($this->c109_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($c109_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update inscricaopassivoslip set ";
     $virgula = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Slips inscrição nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c109_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Slips inscrição nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c109_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c109_sequencial=null,$dbwhere=null) { 
     ...
     $sql = " delete from inscricaopassivoslip
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($c109_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Slips inscrição nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Slips inscrição nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c109_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:inscricaopassivoslip";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $c109_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from inscricaopassivoslip ";
     $sql .= "      inner join slip  on  slip.k17_codigo = inscricaopassivoslip.c109_slip";
     $sql .= "      inner join inscricaopassivo  on  inscricaopassivo.c36_sequencial = inscricaopassivoslip.c109_inscricaopassiva";
     ...
     if($dbwhere==""){
       if($c109_sequencial!=null ){
         $sql2 .= " where inscricaopassivoslip.c109_sequencial = $c109_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
