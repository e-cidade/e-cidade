<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete212025
class cl_balancete212025 {
   ...
   function cl_balancete212025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("balancete212025");
   ...
   function incluir ($si188_sequencial){
     ...
     if($this->si188_tiporegistro == null ){
       $this->erro_sql = " Campo si188_tiporegistro n�o informado.";
     ...
     if($this->si188_contacontabil == null ){
       $this->erro_sql = " Campo si188_contacontabil n�o informado.";
     ...
     if($this->si188_cnpjconsorcio == null ){
       $this->erro_sql = " Campo si188_cnpjconsorcio n�o informado.";
     ...
     if($this->si188_codfontrecursos == null ){
       $this->erro_sql = " Campo si188_codfontrecursos n�o informado.";
     ...
     if($this->si188_saldoinicialconsorfr == null ){
       $this->erro_sql = " Campo si188_saldoinicialconsorfr n�o informado.";
     ...
     if($this->si188_naturezasaldoinicialconsorfr == null ){
       $this->erro_sql = " Campo si188_naturezasaldoinicialconsorfr n�o informado.";
     ...
     if($this->si188_totaldebitosconsorfr == null ){
       $this->erro_sql = " Campo si188_totaldebitosconsorfr n�o informado.";
     ...
     if($this->si188_totalcreditosconsorfr == null ){
       $this->erro_sql = " Campo si188_totalcreditosconsorfr n�o informado.";
     ...
     if($this->si188_saldofinalconsorfr == null ){
       $this->erro_sql = " Campo si188_saldofinalconsorfr n�o informado.";
     ...
     if($this->si188_naturezasaldofinalconsorfr == null ){
       $this->erro_sql = " Campo si188_naturezasaldofinalconsorfr n�o informado.";
     ...
     if($this->si188_mes == null ){
       $this->erro_sql = " Campo si188_mes n�o informado.";
     ...
     if($this->si188_instit == null ){
       $this->erro_sql = " Campo si188_instit n�o informado.";
     ...
     $sql = "insert into balancete212025(
                                       si188_sequencial
                                      ,si188_tiporegistro
                                      ,si188_contacontabil
                                      ,si188_codfundo
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "balancete212025 ($this->si188_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "balancete212025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "balancete212025 ($this->si188_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si188_sequencial=null) {
      $this->atualizacampos();
     $sql = " update balancete212025 set ";
     $virgula = "";
     if(trim($this->si188_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si188_sequencial"])){
       ...
       if(trim($this->si188_sequencial) == null ){
         $this->erro_sql = " Campo si188_sequencial n�o informado.";
     ...
     if(trim($this->si188_codfundo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si188_codfundo"])){
       ...
       if(trim($this->si188_codfundo) == null ){
         $this->erro_sql = " Campo si188_codfundo n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "balancete212025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si188_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "balancete212025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si188_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si188_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from balancete212025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si188_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "balancete212025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "balancete212025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si188_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:balancete212025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si188_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from balancete212025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si188_sequencial!=null ){
         $sql2 .= " where balancete212025.si188_sequencial = $si188_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
