...
class cl_ppadotacaoorcdotacao { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->o19_sequencial = ($this->o19_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["o19_sequencial"]:$this->o19_sequencial);
       $this->o19_ppadotacao = ($this->o19_ppadotacao == ""?@$GLOBALS["HTTP_POST_VARS"]["o19_ppadotacao"]:$this->o19_ppadotacao);
       $this->o19_coddot = ($this->o19_coddot == ""?@$GLOBALS["HTTP_POST_VARS"]["o19_coddot"]:$this->o19_coddot);
       $this->o19_anousu = ($this->o19_anousu == ""?@$GLOBALS["HTTP_POST_VARS"]["o19_anousu"]:$this->o19_anousu);
     }else{
       $this->o19_sequencial = ($this->o19_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["o19_sequencial"]:$this->o19_sequencial);
     }
   }
   ...
   function alterar ($o19_sequencial=null) { 
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dotacao do ppa nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->o19_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($o19_sequencial=null,$dbwhere=null) { 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($o19_sequencial != ""){
          ...
          $sql2 .= " o19_sequencial = $o19_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dotacao do ppa nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$o19_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $o19_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ppadotacaoorcdotacao ";
     $sql .= "      inner join orcdotacao  on  orcdotacao.o58_anousu = ppadotacaoorcdotacao.o19_anousu and  orcdotacao.o58_coddot = ppadotacaoorcdotacao.o19_coddot";
     $sql .= "      inner join ppadotacao  on  ppadotacao.o08_sequencial = ppadotacaoorcdotacao.o19_ppadotacao";
     ...
     $sql .= "      inner join orcfuncao  as a on   a.o52_funcao = ppadotacao.o08_funcao";
     $sql .= "      inner join orcsubfuncao  as b on   b.o53_subfuncao = ppadotacao.o08_subfuncao";
     $sql .= "      inner join orcprograma  as c on   c.o54_anousu = ppadotacao.o08_ano and   c.o54_programa = ppadotacao.o08_programa";
     $sql .= "      inner join orcelemento  as d on   d.o56_codele = ppadotacao.o08_elemento and   d.o56_anousu = ppadotacao.o08_ano";
     $sql .= "      inner join orcprojativ  as d on   d.o55_anousu = ppadotacao.o08_ano and   d.o55_projativ = ppadotacao.o08_projativ";
     $sql .= "      inner join orcorgao  as d on   d.o40_anousu = ppadotacao.o08_ano and   d.o40_orgao = ppadotacao.o08_orgao";
     $sql .= "      inner join orcunidade  as d on   d.o41_anousu = ppadotacao.o08_ano and   d.o41_orgao = ppadotacao.o08_orgao and   d.o41_unidade = ppadotacao.o08_unidade";
     $sql2 = "";
     if($dbwhere==""){
       if($o19_sequencial!=null ){
