...
class cl_issgruposervicoativid {
  ...
  function sql_query_ativ ( $q127_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
     ...
     $sql .= "      left join issgruposervicoativid  on  issgruposervico.q126_sequencial = issgruposervicoativid.q127_issgruposerviso";
     $sql .= "      left join ativid  on  ativid.q03_ativ = issgruposervicoativid.q127_ativid";
     $sql .= "      inner join db_estruturavalor  on  db_estruturavalor.db121_sequencial = issgruposervico.q126_db_estruturavalor";
     $sql2 = "";
     if($dbwhere==""){
       if($q127_sequencial!=null ){
