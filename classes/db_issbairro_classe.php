...
class cl_issbairro { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q13_inscr = ($this->q13_inscr == ""?@$GLOBALS["HTTP_POST_VARS"]["q13_inscr"]:$this->q13_inscr);
       $this->q13_bairro = ($this->q13_bairro == ""?@$GLOBALS["HTTP_POST_VARS"]["q13_bairro"]:$this->q13_bairro);
     }else{
       $this->q13_inscr = ($this->q13_inscr == ""?@$GLOBALS["HTTP_POST_VARS"]["q13_inscr"]:$this->q13_inscr);
     }
   }
   // funcao para inclusao
   function incluir ($q13_inscr){ 
      $this->atualizacampos();
     if($this->q13_bairro == null ){ 
       ...
       $this->q13_inscr = $q13_inscr; 
     if(($this->q13_inscr == null) || ($this->q13_inscr == "") ){ 
       $this->erro_sql = " Campo q13_inscr nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q13_inscr;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q13_inscr=null) { 
      $this->atualizacampos();
   ...
   function excluir ($q13_inscr=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q13_inscr));
     }else{ 
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$q13_inscr;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $q13_inscr=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join issbase  on  issbase.q02_inscr = issbairro.q13_inscr";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = issbase.q02_numcgm";
     $sql2 = "";
     if($dbwhere==""){
       if($q13_inscr!=null ){
         $sql2 .= " where issbairro.q13_inscr = $q13_inscr "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
