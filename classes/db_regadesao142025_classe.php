<?
//MODULO: sicom
//CLASSE DA ENTIDADE regadesao142025
class cl_regadesao142025
{
  ...
  var $campos = "
                 ...
                 si71_codorgao = varchar(2) = C�digo do �rg�o
                 si71_codunidadesub = varchar(8) = C�digo da unidade
                 si71_nroprocadesao = varchar(12) = N�mero do  processo de  ades�o
                 si71_exercicioadesao = int8 = Exerc�cio do  processo de  ades�o
                 si71_nrolote = int8 = N�mero do Lote
                 si71_coditem = int8 = C�digo do Item
                 si71_dtcotacao = date = Data da cota��o
                 si71_vlcotprecosunitario = float8 = Valor de refer�ncia
                 si71_quantidade = float8 = Quantidade do item
                 si71_mes = int8 = M�s
                 si71_reg10 = int8 = reg10
                 si71_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_regadesao142025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("regadesao142025");
  ...
  function incluir($si71_sequencial)
  {
    ...
    if ($si71_sequencial == "" || $si71_sequencial == null) {
      $result = db_query("select nextval('regadesao142025_si71_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: regadesao142025_si71_sequencial_seq do campo: si71_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from regadesao142025_si71_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si71_sequencial)) {
        $this->erro_sql = " Campo si71_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into regadesao142025(
                                       si71_sequencial
                                      ,si71_tiporegistro
                                      ,si71_codorgao
                                      ,si71_codunidadesub
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "regadesao142025 ($this->si71_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "regadesao142025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "regadesao142025 ($this->si71_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update regadesao142025 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "regadesao142025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si71_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "regadesao142025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si71_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si71_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from regadesao142025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si71_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "regadesao142025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "regadesao142025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si71_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:regadesao142025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si71_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from regadesao142025 ";
    $sql .= "      left  join regadesao102020  on  regadesao102020.si67_sequencial = regadesao142025.si71_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si71_sequencial != null) {
        $sql2 .= " where regadesao142025.si71_sequencial = $si71_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
