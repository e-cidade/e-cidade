<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge202025
class cl_conge202025 {
  ...
  public $campos = "
                 ...
                 si183_codorgao = varchar(2) = C�digo do �rg�o
                 si183_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si183_nroconvenioconge = varchar(30) = N�mero do conv�nio original ou instr
                 si183_dataassinaturaconvoriginalconge = date = Data da assinatura do conv�nio original
                 si183_nroseqtermoaditivoconge = int8 = N�mero sequencial do Termo Aditivo
                 si183_dscalteracaoconge = varchar(500) = Descri��o da altera��o do conv�nio
                 si183_dataassinaturatermoaditivoconge = date = Data da assinatura do Termo Aditivo
                 si183_datafinalvigenciaconge = date = Data final da vig�ncia do conv�nio
                 si183_valoratualizadoconvenioconge = float8 = Valor atualizado do conv�nio ou  instrum
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("conge202025");
  ...
  function incluir ($si183_sequencial) {
     ...
     if ($this->si183_nroseqtermoaditivoconge == null ) {
       $this->erro_sql = " Campo N�mero sequencial do Termo Aditivo n�o informado.";
     ...
     if ($this->si183_dscalteracaoconge == null ) {
       $this->erro_sql = " Campo Descri��o da altera��o do conv�nio n�o informado.";
     ...
     if ($this->si183_dataassinaturatermoaditivoconge == null ) {
       $this->erro_sql = " Campo Data da assinatura do Termo Aditivo n�o informado.";
     ...
     if ($this->si183_valoratualizadoconvenioconge == null ) {
       $this->erro_sql = " Campo Valor atualizado do conv�nio ou  instrum n�o informado.";
     ...
     if ($this->si183_valoratualizadocontrapartidaconge == null ) {
       $this->erro_sql = " Campo Valor atualizado da Contrapartida n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Detalhamento dos Termos ($this->si183_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Detalhamento dos Termos j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Detalhamento dos Termos ($this->si183_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
  ...
  function excluir ($si183_sequencial=null,$dbwhere=null) {
    ...
    /* if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Detalhamento dos Termos nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Detalhamento dos Termos nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si183_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge202025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si183_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge202025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si183_sequencial!=null ) {
         $sql2 .= " where conge202025.si183_sequencial = $si183_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
