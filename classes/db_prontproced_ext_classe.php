...
require_once("db_prontproced_classe.php"); 
class cl_prontproced_ext extends cl_prontproced { 
   function sql_query_ext ( $sd29_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     //removida linha, agora o cid esta no procedimento
  ...
  /**
   * Funзгo retorna as FAA's q nгo estejam no lote
   *
   * @param Cуdigo Sequencial $sd29_i_codigo
   * @param Campos $campos
   * @param Ordenaзгo $ordem
   * @param Condiзгo $dbwhere
   * @return String SQL
   */
