<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete102025
class cl_balancete102025
{
  ...
  function cl_balancete102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete102025");
  ...
  function incluir($si177_sequencial)
  {
    ...
    if ($this->si177_tiporegistro == null) {
      $this->erro_sql = " Campo si177_tiporegistro n�o informado.";
    ...
    if ($this->si177_contacontaabil == null) {
      $this->erro_sql = " Campo si177_contacontaabil n�o informado.";
    ...
    if ($this->si177_saldoinicial == null) {
      $this->erro_sql = " Campo si177_saldoinicial n�o informado.";
    ...
    if ($this->si177_naturezasaldoinicial == null) {
      $this->erro_sql = " Campo si177_naturezasaldoinicial n�o informado.";
    ...
    if ($this->si177_totaldebitos == null) {
      $this->erro_sql = " Campo si177_totaldebitos n�o informado.";
    ...
    if ($this->si177_totalcreditos == null) {
      $this->erro_sql = " Campo si177_totalcreditos n�o informado.";
    ...
    if ($this->si177_saldofinal == null) {
      $this->erro_sql = " Campo si177_saldofinal n�o informado.";
    ...
    if ($this->si177_naturezasaldofinal == null) {
      $this->erro_sql = " Campo si177_naturezasaldofinal n�o informado.";
    ...
    if ($this->si177_mes == null) {
      $this->erro_sql = " Campo si177_mes n�o informado.";
    ...
    if ($this->si177_instit == null) {
      $this->erro_sql = " Campo si177_instit n�o informado.";
    ...
    if ($si177_sequencial == "" || $si177_sequencial == null) {
      $result = db_query("select nextval('balancete102025_si177_sequencial_seq')");

      if ($result == false) {
        $this->erro_banco = str_replace("", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete102025_si177_sequencial_seq do campo: si177_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete102025_si177_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si177_sequencial)) {
        $this->erro_sql = " Campo si177_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete102025(
                                       si177_sequencial
                                      ,si177_tiporegistro
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete102025 ($this->si177_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete102025 ($this->si177_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete102025 set ";
    $virgula = "";
    if (trim($this->si177_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si177_sequencial"])) {
      ...
      if (trim($this->si177_sequencial) == null) {
        $this->erro_sql = " Campo si177_sequencial n�o informado.";
    ...
    if (trim($this->si177_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si177_codfundo"])) {
      ...
      if (trim($this->si177_codfundo) == null) {
        $this->erro_sql = " Campo si177_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql = "balancete102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si177_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si177_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si177_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete102025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si177_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql = "balancete102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si177_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql)
  {
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si177_sequencial = null, $campos_filtro = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= $campos;
    $sql .= " from balancete102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si177_sequencial != null) {
        $sql2 .= " where balancete102025.si177_sequencial = $si177_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
