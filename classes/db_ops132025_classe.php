...
class cl_ops132025
{
  ...
  var $campos = "
                 ...
                 si135_codreduzidoop = int8 = C�digo Identificador da Ordem
                 si135_tiporetencao = varchar(4) = Tipo de Reten��o
                 si135_descricaoretencao = varchar(50) = Descri��o da  Reten��o
                 si135_vlretencao = float8 = Valor da reten��o
                 si135_vlantecipado = float8 = Valor extraor�ament�rio
                 si135_mes = int8 = M�s
                 si135_reg10 = int8 = reg10
                 si135_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ops132025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ops132025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si135_vlantecipado = ($this->si135_vlantecipado == "" ? @$GLOBALS["HTTP_POST_VARS"]["si135_vlantecipado"] : $this->si135_vlantecipado);
  ...
  function incluir($si135_sequencial)
  {
    ...
    if ($this->si135_vlantecipado == null) {
      $this->si135_vlantecipado = "0";
    }
    ...
    if ($si135_sequencial == "" || $si135_sequencial == null) {
      $result = db_query("select nextval('ops132025_si135_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ops132025_si135_sequencial_seq do campo: si135_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ops132025_si135_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si135_sequencial)) {
        $this->erro_sql = " Campo si135_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ops132025 ($this->si135_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ops132025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ops132025 ($this->si135_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si135_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops132025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si135_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops132025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si135_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si135_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops132025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops132025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si135_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ops132025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si135_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ops132025 ";
    $sql .= "      left  join ops102020  on  ops102020.si132_sequencial = ops132025.si135_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si135_sequencial != null) {
        $sql2 .= " where ops132025.si135_sequencial = $si135_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
