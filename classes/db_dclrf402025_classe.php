<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf402025
class cl_dclrf402025 {
   ...
   var $campos = "
                 ...
                 si193_publicrgf = int4 = Publica��o do RGF da LRF
                 si193_dtpublicacaorgf = date = Data de publica��o do RGF da LRF
                 ...
                 si193_exerciciotpperiodo = int4 = Exerc�cio a que se refere o per�odo
                 si193_mes = int2 = M�s de refer�ncia
                 si193_instit = int8 = Institui��o
                 si193_reg10 = int4 = Sequencial DCLRF
                 ";
   //funcao construtor da classe
   function cl_dclrf402025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dclrf402025");
   ...
   function incluir ($si193_sequencial){
      $this->atualizacampos();
	   if($si193_sequencial == "" || $si193_sequencial == null ){
		   $result = @pg_query("select nextval('dclrf402025_si193_sequencial_seq')");
		   if($result==false){
			   $this->erro_banco = str_replace("\n","",@pg_last_error());
			   $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf402025_si192_sequencial_seq do campo: si193_sequencial";
		   ...
		   $result = @pg_query("select last_value from dclrf402025_si193_sequencial_seq");
		   if(($result != false) && (pg_result($result,0,0) < $si193_sequencial)){
			   $this->erro_sql = " Campo si192_sequencial maior que �ltimo n�mero da sequencia.";
       ...
       if($this->si193_publicrgf == null ){
		   $this->erro_sql = " Campo Publica��o do RGF da LRF nao Informado.";
...
//	   die($sql);
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Publica��o e Periodicidade do RGF da LRF () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Publica��o e Periodicidade do RGF da LRF j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Publica��o e Periodicidade do RGF da LRF () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($si193_sequencial=null ) {
     ...
     if(trim($this->si193_dtpublicacaorgf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si193_dtpublicacaorgf_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["si193_dtpublicacaorgf_dia"] !="") ){
       ...
       if(trim($this->si193_dtpublicacaorgf) == null ){
         $this->erro_sql = " Campo Data de publica��o do RGF da LRF nao Informado.";
     ...
     if(trim($this->si193_exerciciotpperiodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si193_exerciciotpperiodo"])){
       ...
       if(trim($this->si193_exerciciotpperiodo) == null ){
         $this->erro_sql = " Campo Exerc�cio a que se refere o per�odo nao Informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Publica��o e Periodicidade do RGF da LRF nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       return false;
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Publica��o e Periodicidade do RGF da LRF nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         return true;
...
//     $sql2 = "si193_reg10 = $si193_reg10";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "dclrf402025 n�o Exclu�do. Exclus�o Abortada.\\n";
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       return false;
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dclrf402025 nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         return true;
   ...
   function sql_query ( $si193_sequencial = null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join  dclrf102020 on  dclrf102020.si157_sequencial = dclrf402025.si193_reg10 ";
     // $sql .= "      inner join   on  . = dclrf402025.si191_reg10 and  . = dclrf402025.si192_reg10 and  . = dclrf402025.si193_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if( $si193_sequencial != "" && $si193_sequencial != null){
          $sql2 = " where dclrf402025.si193_sequencial = $si193_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
