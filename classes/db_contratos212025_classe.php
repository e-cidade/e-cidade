<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos212025
class cl_contratos212025 {
   ...
   var $si88_tipomaterial = null;
   var $si88_coditemsinapi = null;
   var $si88_coditemsimcro = null;
   var $si88_descoutrosmateriais = null;
   var $si88_itemplanilha = null;
   var $si88_mes = 0;
   var $si88_reg20 = 0;
   var $si88_instit = 0;
   var $si88_nrolote = 0;
   ...
   var $campos = "
                 ...
                 si88_codaditivo = int8 = C�digo do Termo  Aditivo
                 si88_coditem = int8 = C�digo do Item
                 si88_tipoalteracaoitem = int8 = Tipo de altera��o  sofrida pelo item
                 si88_quantacrescdecresc = float8 = Quantidade acrescida
                 si88_valorunitarioitem = float8 = Valor unit�rio do  item
                 si88_tipomaterial = int8 = tipo de material
                 si88_coditemsinapi = vachar = codigo do item sinapi
                 si88_coditemsimcro = vachar = codigo do item simcro
                 si88_descoutrosmateriais = text = descricao do material
                 si88_itemplanilha = int8 = codigo da planilha
                 si88_mes = int8 = M�s
                 si88_reg20 = int8 = reg20
                 si88_instit = int8 = Institui��o
                 si88_nrolote = int8 = Numero do Lote
                 ";
   //funcao construtor da classe
   function cl_contratos212025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos212025");
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si88_tipomaterial = ($this->si88_tipomaterial == ""?@$GLOBALS["HTTP_POST_VARS"]["si88_tipomaterial"]:$this->si88_tipomaterial);
       $this->si88_coditemsinapi = ($this->si88_coditemsinapi == ""?@$GLOBALS["HTTP_POST_VARS"]["si88_coditemsinapi"]:$this->si88_coditemsinapi);
   ...
   function incluir ($si88_sequencial){
     ...
     if($this->si88_tipomaterial == null){
       $this->si88_tipomaterial = "0";
     }
     if($this->si88_itemplanilha == null){
       $this->si88_itemplanilha = "0";
     }
     ...
     if($si88_sequencial == "" || $si88_sequencial == null ){
       $result = db_query("select nextval('contratos212025_si88_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos212025_si88_sequencial_seq do campo: si88_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos212025_si88_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si88_sequencial)){
         $this->erro_sql = " Campo si88_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into contratos212025(
                                       si88_sequencial
                                      ,si88_tiporegistro
                                      ,si88_codaditivo
                                      ,si88_coditem
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos212025 ($this->si88_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos212025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos212025 ($this->si88_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si88_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos212025 set ";
     $virgula = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos212025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si88_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos212025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si88_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si88_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos212025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si88_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos212025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos212025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si88_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos212025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si88_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contratos212025 ";
     $sql .= "      left  join contratos202025  on  contratos202025.si87_sequencial = contratos212025.si88_reg20";
     $sql2 = "";
     if($dbwhere==""){
       if($si88_sequencial!=null ){
         $sql2 .= " where si88_sequencial = $si88_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
