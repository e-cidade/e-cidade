<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf102021
class cl_dclrf102021 {
   ...
   function cl_dclrf102021() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dclrf102021");
   ...
   function incluir (){
     ...
     if($si157_sequencial == "" || $si157_sequencial == null ){
       $result = @pg_query("select nextval('dclrf102021_si157_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf102021_si157_sequencial_seq do campo: si157_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = @pg_query("select last_value from dclrf102021_si157_sequencial_seq");
...
//     die($sql);
   ...
   function sql_query ( $si157_sequencial = null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dclrf102021 ";
     $sql2 = "";
     if($dbwhere==""){
       if( $si157_sequencial != "" && $si157_sequencial != null){
          $sql2 = " where dclrf102021.si157_sequencial = $si157_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
