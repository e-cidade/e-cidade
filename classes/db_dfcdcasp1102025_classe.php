<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp1102025
class cl_dfcdcasp1102025 {
   ...
   function cl_dfcdcasp1102025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp1102025");
   ...
   function incluir ($si229_sequencial){
     ...
     if(empty($si229_sequencial)){
       $result = db_query("select nextval('dfcdcasp1102025_si229_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp1102025_si229_sequencial_seq do campo: si229_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp1102025_si229_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si229_sequencial)){
         $this->erro_sql = " Campo si229_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp1102025(
                                       si229_anousu
                                      ,si229_periodo
                                      ,si229_instit
                                      ,si229_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp1102025 ($this->si229_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp1102025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp1102025 ($this->si229_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si229_sequencial=null) {
      $this->atualizacampos();
     $sql = " update dfcdcasp1102025 set ";
     $virgula = "";
     if(trim($this->si229_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si229_sequencial"])){
       ...
       if(trim($this->si229_sequencial) == null ){
         $this->erro_sql = " Campo si229_sequencial n�o informado.";
     ...
     if(trim($this->si229_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si229_tiporegistro"])){
       ...
       if(trim($this->si229_tiporegistro) == null ){
         $this->erro_sql = " Campo si229_tiporegistro n�o informado.";
     ...
     if(trim($this->si229_vlcaixaequivalentecaixainicial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si229_vlcaixaequivalentecaixainicial"])){
       ...
       if(trim($this->si229_vlcaixaequivalentecaixainicial) == null ){
         $this->erro_sql = " Campo si229_vlcaixaequivalentecaixainicial n�o informado.";
     ...
     if(trim($this->si229_vlcaixaequivalentecaixafinal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si229_vlcaixaequivalentecaixafinal"])){
       ...
       if(trim($this->si229_vlcaixaequivalentecaixafinal) == null ){
         $this->erro_sql = " Campo si229_vlcaixaequivalentecaixafinal n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp1102025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si229_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp1102025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si229_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si229_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp1102025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp1102025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp1102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si229_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp1102025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si229_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp1102025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si229_sequencial!=null ){
         $sql2 .= " where dfcdcasp1102025.si229_sequencial = $si229_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
