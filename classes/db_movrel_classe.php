...
class cl_movrel
{
    ...
    var $campos = "
                 ...
                 r54_quant1 = float8 = Valor Rubrica 1 
                 r54_quant2 = float8 = Valor Rubrica 2 
                 r54_quant3 = float8 = Valor Rubrica 3 
                 r54_quant4 = float8 = Quantidade Rubrica 1
                 r54_quant5 = float8 = Quantidade Rubrica 2
                 r54_quant6 = float8 = Quantidade Rubrica 3
    ...
    function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->r54_quant4 = ($this->r54_quant4 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r54_quant4"] : $this->r54_quant4);
            $this->r54_quant5 = ($this->r54_quant5 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r54_quant5"] : $this->r54_quant5);
            $this->r54_quant6 = ($this->r54_quant6 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r54_quant6"] : $this->r54_quant6);
    ...
    function incluir()
    {
        ...
        if ($this->r54_quant4 == null) {
            $this->erro_sql = " Campo Quantidade Rubrica 1 nao Informado.";
            $this->erro_campo = "r54_quant4";
            $this->erro_banco = "";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if ($this->r54_quant5 == null) {
            $this->erro_sql = " Campo Quantidade Rubrica 1 nao Informado.";
            $this->erro_campo = "r54_quant5";
            $this->erro_banco = "";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if ($this->r54_quant6 == null) {
            $this->erro_sql = " Campo Quantidade Rubrica 1 nao Informado.";
            $this->erro_campo = "r54_quant6";
            $this->erro_banco = "";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
    ...
    function alterar($oid = null)
    {
        ...
        if (trim($this->r54_quant1) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r54_quant1"])) {
            ...
            if (trim($this->r54_quant1) == null) {
                $this->erro_sql = " Campo Valor Rubrica 1 nao Informado.";
                $this->erro_campo = "r54_quant1";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        ...
        if (trim($this->r54_quant4) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r54_quant4"])) {
            $sql  .= $virgula . " r54_quant4 = $this->r54_quant4 ";
            $sql1 .= " and r54_quant4 = $this->r54_quant4 ";
            $virgula = ",";
            if (trim($this->r54_quant1) == null) {
                $this->erro_sql = " Campo Quantidade Rubrica 1 nao Informado.";
                $this->erro_campo = "r54_quant4";
        ...
        if (trim($this->r54_quant5) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r54_quant5"])) {
            $sql  .= $virgula . " r54_quant5 = $this->r54_quant5 ";
            $sql1 .= " and r54_quant5 = $this->r54_quant5 ";
            $virgula = ",";
            if (trim($this->r54_quant1) == null) {
                $this->erro_sql = " Campo Quantidade Rubrica 2 nao Informado.";
                $this->erro_campo = "r54_quant5";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        ...
        if (trim($this->r54_quant6) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r54_quant6"])) {
            $sql  .= $virgula . " r54_quant6 = $this->r54_quant6 ";
            $sql1 .= " and r54_quant6 = $this->r54_quant6 ";
            $virgula = ",";
            if (trim($this->r54_quant1) == null) {
                $this->erro_sql = " Campo Quantidade Rubrica 3 nao Informado.";
                $this->erro_campo = "r54_quant6";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
