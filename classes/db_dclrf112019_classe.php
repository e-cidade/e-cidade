...
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf112019
class cl_dclrf112019 {
   ...
   function cl_dclrf112019() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dclrf112019");
	   ...
	   if($this->si205_medidasadotadas == null ){
		...
		if($this->si205_instit == null ){
	     ...
	     if($si205_sequencial == "" || $si205_sequencial == null ){
		   $result = @pg_query("select nextval('dclrf112019_si205_sequencial_seq')");
		   if($result==false){
			 $this->erro_banco = str_replace("\n","",@pg_last_error());
			 $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf112019_si205_sequencial_seq do campo: si205_sequencial";
			 $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
			 $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
			 $this->erro_status = "0";
			 return false;
		   ...
		   $result = @pg_query("select last_value from dclrf112019_si205_sequencial_seq");
...
//     echo $sql.$sql2;exit;
   ...
   // funcao do sql
   function sql_query ( $si205_sequencial = null,$campos="dclrf112019.si205_sequencial,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from dclrf112019 ";
	 $sql .= " 		left join dclrf102019 on dclrf102019.si157_sequencial = dclrf112019.si205_reg10 ";
	 $sql2 = "";
     if($dbwhere==""){
       if( $si205_sequencial != "" && $si205_sequencial != null){
          $sql2 = " where dclrf112019.si205_sequencial = $si205_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
