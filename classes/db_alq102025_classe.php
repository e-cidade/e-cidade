...
class cl_alq102025
{
  ...
  var $campos = "
                 ...
                 si121_codreduzido = int8 = C�digo Identificador do registro
                 si121_codorgao = varchar(2) = C�digo do �rg�o
                 si121_codunidadesub = varchar(8) = C�digo da unidade
                 si121_nroempenho = int8 = N�mero do  empenho
                 si121_dtempenho = date = Data do empenho
                 si121_dtliquidacao = date = Data da  liquida��o
                 si121_nroliquidacao = int8 = N�mero da  Liquida��o
                 si121_dtanulacaoliq = date = Data da anula��o  da liquida��o
                 si121_nroliquidacaoanl = int8 = N�mero da  anula��o da  liquida��o
                 si121_tpliquidacao = int8 = Tipo de  liquida��o
                 si121_justificativaanulacao = varchar(500) = Justificativa para  a anula��o
                 si121_vlanulado = float8 = Valor anulado da  liquida��o
                 si121_mes = int8 = M�s
                 si121_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_alq102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("alq102025");
  ...
  function incluir($si121_sequencial)
  {
    ...
    if ($si121_sequencial == "" || $si121_sequencial == null) {
      $result = db_query("select nextval('alq102025_si121_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: alq102025_si121_sequencial_seq do campo: si121_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from alq102025_si121_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si121_sequencial)) {
        $this->erro_sql = " Campo si121_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "alq102025 ($this->si121_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "alq102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "alq102025 ($this->si121_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si121_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "alq102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si121_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "alq102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si121_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si121_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "alq102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "alq102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si121_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:alq102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si121_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si121_sequencial != null) {
        $sql2 .= " where alq102025.si121_sequencial = $si121_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
