...
class cl_rsp102025
{
  ...
  var $campos = "
                 ...
                 si112_codreduzidorsp = int8 = C�digo Identificador do resto a pagar
                 si112_codorgao = varchar(2) = C�digo do �rg�o
                 si112_codunidadesub = varchar(8) = C�digo da  unidade
                 si112_codunidadesuborig = varchar(8) = C�digo da  unidade
                 si112_nroempenho = int8 = N�mero do  empenho
                 si112_exercicioempenho = int8 = Exerc�cio do  empenho
                 si112_dtempenho = date = Data do empenho
                 si112_dotorig = varchar(21) = Classifica��o da  Despesa
                 ...
                 si112_mes = int8 = M�s
                 si112_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_rsp102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("rsp102025");
  ...
  function incluir($si112_sequencial)
  {
    ...
    if ($si112_sequencial == "" || $si112_sequencial == null) {
      $result = db_query("select nextval('rsp102025_si112_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: rsp102025_si112_sequencial_seq do campo: si112_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from rsp102025_si112_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si112_sequencial)) {
        $this->erro_sql = " Campo si112_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "rsp102025 ($this->si112_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "rsp102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "rsp102025 ($this->si112_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si112_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "rsp102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si112_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "rsp102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si112_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si112_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "rsp102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "rsp102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si112_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:rsp102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si112_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si112_sequencial != null) {
        $sql2 .= " where rsp102025.si112_sequencial = $si112_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
  ...
  public function sql_Reg10($ano, $instit)
  {
    $sql = "SELECT tiporegistro,
              ...
              (SELECT '10' AS tiporegistro,
                      ...
                      substr(ano2025, 1, 7) AS new_codfontrecursos,
                      CASE
                ...
                GROUP BY e60_anousu, e60_codemp, e60_emiss, z01_numcgm, z01_cgccpf, z01_nome, e60_numemp, o58_codigo, o58_orgao, o58_unidade, o41_subunidade, o58_funcao, o58_subfuncao, o58_programa, o58_projativ,
                        orcelemento.o56_elemento, t1.o56_elemento, o15_codtri, si09_codorgaotce, o40_codtri, orcorgao.o40_orgao, orcunidade.o41_codtri, orcunidade.o41_unidade, de_para_fontes.ano2022, de_para_fontes.ano2025,e60_codco) AS restos
