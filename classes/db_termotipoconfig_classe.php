...
class cl_termotipoconfig { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->k42_sequencial = ($this->k42_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k42_sequencial"]:$this->k42_sequencial);
       $this->k42_cadtipo = ($this->k42_cadtipo == ""?@$GLOBALS["HTTP_POST_VARS"]["k42_cadtipo"]:$this->k42_cadtipo);
       $this->k42_tiponovo = ($this->k42_tiponovo == ""?@$GLOBALS["HTTP_POST_VARS"]["k42_tiponovo"]:$this->k42_tiponovo);
       $this->k42_instit = ($this->k42_instit == ""?@$GLOBALS["HTTP_POST_VARS"]["k42_instit"]:$this->k42_instit);
     }else{
       $this->k42_sequencial = ($this->k42_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k42_sequencial"]:$this->k42_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($k42_sequencial){ 
      $this->atualizacampos();
     if($this->k42_cadtipo == null ){ 
     ...
     if($k42_sequencial == "" || $k42_sequencial == null ){
       $result = db_query("select nextval('termotipoconfig_k42_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: termotipoconfig_k42_sequencial_seq do campo: k42_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $k42_sequencial)){
         ...
         $this->k42_sequencial = $k42_sequencial; 
       }
     }
     if(($this->k42_sequencial == null) || ($this->k42_sequencial == "") ){ 
       $this->erro_sql = " Campo k42_sequencial nao declarado.";
     ...
     $sql = "insert into termotipoconfig(
                                       k42_sequencial 
                                      ,k42_cadtipo 
                                      ,k42_tiponovo 
                                      ,k42_instit 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k42_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($k42_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($k42_sequencial!=null){
       $sql .= " k42_sequencial = $this->k42_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->k42_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de debito a apos parcelamento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k42_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de debito a apos parcelamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k42_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k42_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($k42_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($k42_sequencial != ""){
          ...
          $sql2 .= " k42_sequencial = $k42_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de debito a apos parcelamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$k42_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de debito a apos parcelamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k42_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $k42_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from termotipoconfig ";
     $sql .= "      inner join arretipo  on  arretipo.k00_tipo = termotipoconfig.k42_tiponovo";
     $sql .= "      inner join db_config  on  db_config.codigo = termotipoconfig.k42_instit";
     $sql .= "      inner join cadtipo  on  cadtipo.k03_tipo = termotipoconfig.k42_cadtipo";
     $sql .= "      inner join db_config  as a on   a.codigo = arretipo.k00_instit";
     $sql .= "      inner join cadtipo  as b on   b.k03_tipo = arretipo.k03_tipo";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = db_config.numcgm";
     $sql2 = "";
     if($dbwhere==""){
       if($k42_sequencial!=null ){
         $sql2 .= " where termotipoconfig.k42_sequencial = $k42_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
