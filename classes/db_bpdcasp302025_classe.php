<?
//MODULO: sicom
//CLASSE DA ENTIDADE bpdcasp302025
class cl_bpdcasp302025 {
   ...
   function cl_bpdcasp302025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bpdcasp302025");
   ...
   function incluir ($si210_sequencial){
     ...
     if($this->si210_tiporegistro == null ){
       $this->erro_sql = " Campo si210_tiporegistro n�o informado.";
     ...
     $sql = "insert into bpdcasp302025(
                ...
                values (
                                (select nextval('bpdcasp302025_si210_sequencial_seq'))
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bpdcasp302025 ($this->si210_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bpdcasp302025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bpdcasp302025 ($this->si210_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si210_sequencial=null) {
     ...
     if(trim($this->si210_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si210_sequencial"])){
       ...
       if(trim($this->si210_sequencial) == null ){
         $this->erro_sql = " Campo si210_sequencial n�o informado.";
     ...
     if(trim($this->si210_vlativofinanceiro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si210_vlativofinanceiro"])){
       ...
       if(trim($this->si210_vlativofinanceiro) == null ){
         $this->erro_sql = " Campo si210_vlativofinanceiro n�o informado.";
     ...
     if(trim($this->si210_vlativopermanente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si210_vlativopermanente"])){
       ...
       if(trim($this->si210_vlativopermanente) == null ){
         $this->erro_sql = " Campo si210_vlativopermanente n�o informado.";
     ...
     if(trim($this->si210_vltotalativofinanceiropermanente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si210_vltotalativofinanceiropermanente"])){
       ...
       if(trim($this->si210_vltotalativofinanceiropermanente) == null ){
         $this->erro_sql = " Campo si210_vltotalativofinanceiropermanente n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp302025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si210_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp302025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si210_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si210_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp302025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si210_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bpdcasp302025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si210_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bpdcasp302025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si210_sequencial!=null ){
         $sql2 .= " where bpdcasp302025.si210_sequencial = $si210_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
