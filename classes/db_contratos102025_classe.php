<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos102025
class cl_contratos102025
{
  ...
  var $si83_cnpjorgaoentresp = null;
  ...
  var $campos = "
                 ...
                 si83_codcontrato = int8 = C�digo do contrato
                 si83_codorgao = varchar(2) = C�digo do �rg�o
                 si83_codunidadesub = varchar(8) = C�digo da unidade
                 si83_nrocontrato = int8 = N�mero do  Contrato
                 si83_exerciciocontrato = int8 = Exerc�cio do  Contrato
                 si83_dataassinatura = date = Data da assinatura  do Contrato
                 si83_contdeclicitacao = int8 = Contrato decorrente de Licita��o
                 si83_cnpjorgaoentresp = varchar(14) = CNPJ do �rg�o/entidade
                 si83_codunidadesubresp = varchar(8) = C�digo da unidade
                 si83_nroprocesso = varchar(12) = N�mero do  processo
                 si83_exercicioprocesso = int8 = Exerc�cio do  processo
                 ...
                 si83_datainiciovigencia = date = Data inicial da  vig�ncia
                 si83_datafinalvigencia = date = Data final da  vig�ncia
                 ...
                 si83_prazoexecucao = int8 = Prazo de Execu��o
                 si83_multarescisoria = varchar(100) = Multa Rescis�ria
                 si83_multainadimplemento = varchar(100) = Multa  inadimplemento
                 si83_garantia = int8 = Tipo de garantia  contratual
                 si83_cpfsignatariocontratante = varchar(11) = N�mero do CPF do  signat�rio
                 si83_datapublicacao = date = Data da publica��o  do contrato
                 si83_veiculodivulgacao = varchar(50) = Ve�culo de  Divulga��o
                 si83_mes = int8 = M�s
                 si83_instit = int8 = Institui��o
                 ...
                 si83_vigenciaindeterminada = int = Prazo de Vig�ncia Indeterminada.
                 ";
  ...
  function cl_contratos102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("contratos102025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si83_cnpjorgaoentresp = ($this->si83_cnpjorgaoentresp == "" ? @$GLOBALS["HTTP_POST_VARS"]["si83_cnpjorgaoentresp"] : $this->si83_cnpjorgaoentresp);
  ...
  function incluir($si83_sequencial)
  {
    ...
    if ($si83_sequencial == "" || $si83_sequencial == null) {
      $result = db_query("select nextval('contratos102025_si83_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("", "", @pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: contratos102025_si83_sequencial_seq do campo: si83_sequencial";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from contratos102025_si83_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si83_sequencial)) {
        $this->erro_sql = " Campo si83_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into contratos102025(
                                       si83_sequencial
                                      ,si83_tiporegistro
                                      ,si83_tipocadastro
                                      ,si83_codcontrato
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "contratos102025 ($this->si83_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "contratos102025 j� Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql   = "contratos102025 ($this->si83_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      ...
      $resac = db_query("insert into db_acount values($acount,2010312,2010407,'','" . AddSlashes(pg_result($resaco, 0, 'si83_cnpjorgaoentresp')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
  ...
  {
    $this->atualizacampos();
    $sql = " update contratos102025 set ";
    $virgula = "";
    ...
    if (trim($this->si83_cnpjorgaoentresp) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si83_cnpjorgaoentresp"])) {
      $sql  .= $virgula . " si83_cnpjorgaoentresp = '$this->si83_cnpjorgaoentresp' ";
      $virgula = ",";
    }
    ...
    if ($this->numrows > 0) {
      for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
        ...
        if (isset($GLOBALS["HTTP_POST_VARS"]["si83_cnpjorgaoentresp"]) || $this->si83_cnpjorgaoentresp != "")
          $resac = db_query("insert into db_acount values($acount,2010312,2010407,'" . AddSlashes(pg_result($resaco, $conresaco, 'si83_cnpjorgaoentresp')) . "','$this->si83_cnpjorgaoentresp'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql   = "contratos102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si83_sequencial;
      $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si83_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si83_sequencial = null, $dbwhere = null)
  {
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
        ...
        $resac = db_query("insert into db_acount values($acount,2010312,2010407,'','" . AddSlashes(pg_result($resaco, $iresaco, 'si83_cnpjorgaoentresp')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
    ...
    $sql = " delete from contratos102025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si83_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql   = "contratos102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si83_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql)
  {
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:contratos102025";
      $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si83_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from contratos102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si83_sequencial != null) {
        $sql2 .= " where si83_sequencial = $si83_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
