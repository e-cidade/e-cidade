...
class cl_mer_requiitem_ext { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->me17_i_unidade = ($this->me17_i_unidade == ""?@$GLOBALS["HTTP_POST_VARS"]["me17_i_unidade"]:$this->me17_i_unidade);
       $this->me17_i_item = ($this->me17_i_item == ""?@$GLOBALS["HTTP_POST_VARS"]["me17_i_item"]:$this->me17_i_item);
   ...
   function sql_query ( $me17_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join mer_unidade  on  mer_unidade.me15_i_codigo = mer_requiitem.me17_i_unidade";
     $sql .= "      inner join mer_requi  on  mer_requi.me16_i_codigo = mer_requiitem.me17_i_merrequi";
     $sql .= "      inner join mer_item  on  mer_item.me10_i_codigo = mer_requiitem.me17_i_item";
