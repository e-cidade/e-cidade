...
class cl_debcontaarquivoregret { 
   ...
   var $campos = "
                 ...
                 d76_debcontatiporet = int4 = Código do tipo de retorno 
   ...
   function incluir ($d76_sequencial){ 
     ...
     if($this->d76_debcontatiporet == null ){ 
       $this->erro_sql = " Campo Código do tipo de retorno nao Informado.";
     ...
     if($d76_sequencial == "" || $d76_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $d76_sequencial)){
         $this->erro_sql = " Campo d76_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Retorno dos arquivos de debito em conta ($this->d76_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Retorno dos arquivos de debito em conta já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Retorno dos arquivos de debito em conta ($this->d76_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($d76_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Retorno dos arquivos de debito em conta nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Retorno dos arquivos de debito em conta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$d76_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
