...
class cl_issnotaavulsaservico {
   ...
   var $q62_baseirrf      = null;
   var $q62_basecalcaposinss  = null;
   var $q62_aliquotairrf      = null;
   var $q62_baseinss      = null;
   ...
   var $campos = "
                 ...
                 q62_baseirrf = float8 = q62_baseirrf
                 q62_basecalcaposinss = float8 = q62_basecalcaposinss
                 q62_aliquotairrf = float8 = q62_aliquotairrf
                 q62_baseinss = float8 = q62_baseinss
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->q62_baseirrf = ($this->q62_baseirrf == ""?@$GLOBALS["HTTP_POST_VARS"]["q62_baseirrf"]:$this->q62_baseirrf);
       $this->q62_baseinss = ($this->q62_baseinss == ""?@$GLOBALS["HTTP_POST_VARS"]["q62_baseinss"]:$this->q62_baseinss);
       $this->q62_basecalcaposinss = ($this->q62_basecalcaposinss == ""?@$GLOBALS["HTTP_POST_VARS"]["q62_basecalcaposinss"]:$this->q62_basecalcaposinss);
       $this->q62_aliquotairrf = ($this->q62_aliquotairrf == ""?@$GLOBALS["HTTP_POST_VARS"]["q62_aliquotairrf"]:$this->q62_aliquotairrf);
     }else{
       $this->q62_sequencial = ($this->q62_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q62_sequencial"]:$this->q62_sequencial);
     }
   }
   ...
   function incluir ($q62_sequencial){
     ...
     if ($this->q62_baseirrf == null ) {
      $this->q62_baseirrf = '0';
     }
     if ($this->q62_basecalcaposinss == null ) {
      $this->q62_basecalcaposinss = '0';
     }
     if ($this->q62_aliquotairrf == null ) {
      $this->q62_aliquotairrf = '0';
     }
     if ($this->q62_baseinss == null ) {
      $this->q62_baseinss = '0';
     }
     ...
     $sql = "insert into issnotaavulsaservico(
                ...
                values (
                               ...
                               ,{$this->q62_baseirrf}
                               ,{$this->q62_basecalcaposinss}
                               ,{$this->q62_aliquotairrf}
                               ,{$this->q62_baseinss}
                      )";
     $result = db_query($sql);
     if($result==false){
   ...
   function alterar ($q62_sequencial=null) {
     ...
     if(trim($this->q62_baseirrf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q62_baseirrf"])){
        if(trim($this->q62_baseirrf)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q62_baseirrf"])){
           $this->q62_baseirrf = '0';
        }
       $sql  .= $virgula." q62_baseirrf = {$this->q62_baseirrf} ";
       $virgula = ",";
     }
     if(trim($this->q62_basecalcaposinss)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q62_basecalcaposinss"])){
        if(trim($this->q62_basecalcaposinss)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q62_basecalcaposinss"])){
           $this->q62_basecalcaposinss = '0';
        }
       $sql  .= $virgula." q62_basecalcaposinss = {$this->q62_basecalcaposinss} ";
       $virgula = ",";
     }
     if(trim($this->q62_aliquotairrf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q62_aliquotairrf"])){
        if(trim($this->q62_aliquotairrf)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q62_aliquotairrf"])){
           $this->q62_aliquotairrf = '0';
        }
       $sql  .= $virgula." q62_aliquotairrf = {$this->q62_aliquotairrf} ";
       $virgula = ",";
     }
     if(trim($this->q62_baseinss)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q62_baseinss"])){
        if(trim($this->q62_baseinss)=="" && isset($GLOBALS["HTTP_POST_VARS"]["q62_baseinss"])){
           $this->q62_baseinss = '0';
        }
       $sql  .= $virgula." q62_baseinss = {$this->q62_baseinss} ";
       $virgula = ",";
     }
     $sql .= " where ";
