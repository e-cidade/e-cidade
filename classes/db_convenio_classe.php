...
class cl_convenio
{
    ...
    var $campos = "
                 ...
                 r56_posq01 = varchar(6) = Valor rubrica 1 
                 r56_posq02 = varchar(6) = Valor rubrica 2 
                 r56_posq03 = varchar(6) = Valor rubrica 3 
                 r56_posq04 = varchar(6) = Quantidade rubrica 1 
                 r56_posq05 = varchar(6) = Quantidade rubrica 2 
                 r56_posq06 = varchar(6) = Quantidade rubrica 3 
    ...
    function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->r56_posq04 = ($this->r56_posq04 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r56_posq04"] : $this->r56_posq04);
            $this->r56_posq05 = ($this->r56_posq05 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r56_posq05"] : $this->r56_posq05);
            $this->r56_posq06 = ($this->r56_posq06 == "" ? @$GLOBALS["HTTP_POST_VARS"]["r56_posq06"] : $this->r56_posq06);
    ...
    function alterar($r56_codrel = null, $r56_instit = null)
    {
        ...
        if (trim($this->r56_posq03) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r56_posq03"])) {
            ...
            $sql  .= $virgula . " r56_posq03 = '' ";
            $virgula = ",";
        }
        if (trim($this->r56_posq04) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r56_posq04"])) {
            $sql  .= $virgula . " r56_posq04 = '$this->r56_posq04' ";
            $virgula = ",";
        } else {
            $sql  .= $virgula . " r56_posq04 = '' ";
            $virgula = ",";
        }
        if (trim($this->r56_posq05) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r56_posq05"])) {
            $sql  .= $virgula . " r56_posq05 = '$this->r56_posq05' ";
            $virgula = ",";
        } else {
            $sql  .= $virgula . " r56_posq05 = '' ";
            $virgula = ",";
        }
        if (trim($this->r56_posq06) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r56_posq06"])) {
            $sql  .= $virgula . " r56_posq06 = '$this->r56_posq06' ";
            $virgula = ",";
        } else {
            $sql  .= $virgula . " r56_posq06 = '' ";
            $virgula = ",";
        }
