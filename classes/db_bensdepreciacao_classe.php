...
class cl_bensdepreciacao
{
  ...
  var $campos = "
                 t44_sequencial = int4 = Cdigo 
                 t44_bens = int4 = Cdigo so Bem 
                 t44_benstipoaquisicao = int4 = Tipo Aquisio 
                 t44_benstipodepreciacao = int4 = Tipo depreciao 
                 t44_vidautil = int4 = Vida til 
  ...
  function incluir($t44_sequencial)
  {
    ...
    if ($this->t44_bens == null) {
      $this->erro_sql = " Campo Cdigo so Bem nao Informado.";
    ...
    if ($this->t44_benstipoaquisicao == null) {
      $this->erro_sql = " Campo Tipo Aquisio nao Informado.";
    ...
    if ($this->t44_benstipodepreciacao == null) {
      $this->erro_sql = " Campo Tipo depreciao nao Informado.";
    ...
    if ($this->t44_vidautil == null) {
      $this->erro_sql = " Campo Vida til nao Informado.";
    ...
    if ($t44_sequencial == "" || $t44_sequencial == null) {
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $t44_sequencial)) {
        $this->erro_sql = " Campo t44_sequencial maior que ltimo nmero da sequencia.";
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Depreciao de Bens ($this->t44_sequencial) nao Includo. Inclusao Abortada.";
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Depreciao de Bens j Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Depreciao de Bens ($this->t44_sequencial) nao Includo. Inclusao Abortada.";
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function alterar($t44_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Depreciao de Bens nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : " . $this->t44_sequencial;
      $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Depreciao de Bens nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : " . $this->t44_sequencial;
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
  ...
  function excluir($t44_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Depreciao de Bens nao Excludo. Excluso Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Depreciao de Bens nao Encontrado. Excluso no Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $t44_sequencial;
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
