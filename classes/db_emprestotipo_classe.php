...
class cl_emprestotipo { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->e90_codigo = ($this->e90_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["e90_codigo"]:$this->e90_codigo);
       $this->e90_descr = ($this->e90_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["e90_descr"]:$this->e90_descr);
       $this->e90_estrut = ($this->e90_estrut == ""?@$GLOBALS["HTTP_POST_VARS"]["e90_estrut"]:$this->e90_estrut);
     }else{
       $this->e90_codigo = ($this->e90_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["e90_codigo"]:$this->e90_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($e90_codigo){ 
      $this->atualizacampos();
     if($this->e90_descr == null ){ 
       ...
       $this->e90_codigo = $e90_codigo; 
     if(($this->e90_codigo == null) || ($this->e90_codigo == "") ){ 
       $this->erro_sql = " Campo e90_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->e90_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($e90_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($e90_codigo!=null){
       $sql .= " e90_codigo = $this->e90_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->e90_codigo));
     if($this->numrows>0){
   ...
   function excluir ($e90_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($e90_codigo));
     }else{ 
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$e90_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $e90_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from emprestotipo ";
     $sql2 = "";
     if($dbwhere==""){
       if($e90_codigo!=null ){
         $sql2 .= " where emprestotipo.e90_codigo = $e90_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
