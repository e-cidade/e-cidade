...
class cl_ctb302025
{
  ...
  var $si99_cnpjagentearrecadador = null;
  ...
  var $campos = "
                 ...
                 si99_codorgao = varchar(2) = C�digo do �rg�o
                 si99_codagentearrecadador = int8 = C�digo do agente  arrecadador
                 si99_cnpjagentearrecadador = varchar(50) = Descri��o do  agente  arrecadador
                 si99_vlsaldoinicial = float8 = Valor do saldo no  in�cio do m�s
                 si99_vlsaldofinal = float8 = Valor do saldo no  final do m�s
                 si99_mes = int8 = M�s
                 si99_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ctb302025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ctb302025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si99_cnpjagentearrecadador = ($this->si99_cnpjagentearrecadador == "" ? @$GLOBALS["HTTP_POST_VARS"]["si99_cnpjagentearrecadador"] : $this->si99_cnpjagentearrecadador);
  ...
  function incluir($si99_sequencial)
  {
    ...
    if ($this->si99_cnpjagentearrecadador == null) {
      $this->erro_sql = " Campo Descri��o do  agente  arrecadador nao Informado.";
      $this->erro_campo = "si99_cnpjagentearrecadador";
      $this->erro_banco = "";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
    ...
    if ($this->si99_vlsaldoinicial == null) {
      $this->erro_sql = " Campo Valor do saldo no  in�cio do m�s nao Informado.";
    ...
    if ($this->si99_vlsaldofinal == null) {
      $this->erro_sql = " Campo Valor do saldo no  final do m�s nao Informado.";
    ...
    if ($si99_sequencial == "" || $si99_sequencial == null) {
      $result = db_query("select nextval('ctb302025_si99_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ctb302025_si99_sequencial_seq do campo: si99_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ctb302025_si99_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si99_sequencial)) {
        $this->erro_sql = " Campo si99_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into ctb302025(
                                       si99_sequencial
                                      ,si99_tiporegistro
                                      ,si99_codorgao
                                      ,si99_codagentearrecadador
                                      ,si99_cnpjagentearrecadador
                                      ,si99_vlsaldoinicial
                                      ,si99_vlsaldofinal
                                      ,si99_mes
                                      ,si99_instit
                ...
                values (
                               ...
                               ,'$this->si99_cnpjagentearrecadador'
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ctb302025 ($this->si99_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ctb302025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ctb302025 ($this->si99_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      ...
      $resac = db_query("insert into db_acount values($acount,2010328,2010592,'','" . AddSlashes(pg_result($resaco, 0, 'si99_cnpjagentearrecadador')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
  ...
  function alterar($si99_sequencial = null)
  {
    ...
    if (trim($this->si99_cnpjagentearrecadador) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si99_cnpjagentearrecadador"])) {
      $sql .= $virgula . " si99_cnpjagentearrecadador = '$this->si99_cnpjagentearrecadador' ";
      $virgula = ",";
      if (trim($this->si99_cnpjagentearrecadador) == null) {
        $this->erro_sql = " Campo Descri��o do  agente  arrecadador nao Informado.";
        $this->erro_campo = "si99_cnpjagentearrecadador";
        $this->erro_banco = "";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
    ...
    if ($this->numrows > 0) {
      for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
        ...
        if (isset($GLOBALS["HTTP_POST_VARS"]["si99_cnpjagentearrecadador"]) || $this->si99_cnpjagentearrecadador != "") {
          $resac = db_query("insert into db_acount values($acount,2010328,2010592,'" . AddSlashes(pg_result($resaco, $conresaco, 'si99_cnpjagentearrecadador')) . "','$this->si99_cnpjagentearrecadador'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
        }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ctb302025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si99_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ctb302025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si99_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si99_sequencial = null, $dbwhere = null)
  {
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
        ...
        $resac = db_query("insert into db_acount values($acount,2010328,2010592,'','" . AddSlashes(pg_result($resaco, $iresaco, 'si99_cnpjagentearrecadador')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ctb302025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ctb302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si99_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ctb302025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si99_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si99_sequencial != null) {
        $sql2 .= " where ctb302025.si99_sequencial = $si99_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
