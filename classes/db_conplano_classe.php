...
class cl_conplano
{
  ...
  function incluir($c60_codcon = null, $c60_anousu = null, $subtipo = null, $iTipoConta = null)
  {
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Plano de Contas ($this->c60_codcon." - ".$this->c60_anousu) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function db_verifica_conplano_exclusao($conplano, $anousu)
  {
    ...
    if ($this->numrows > 0) {
      $this->erro_status = 0;
      $this->erro_msg = 'Exclusão abortada. Existe uma conta de nï¿½vel inferior cadastrada!';
      return false;
    }
