<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras202021
class cl_cadobras202021 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("cadobras202021");
  ...
  function incluir () {
    ...
    if ($this->si199_sequencial == null ) {
      $result = db_query("select nextval('cadobras202021_si199_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras202021_si199_sequencial_seq do campo: si199_sequencial";
...
//    }
    ...
    $sql = "insert into cadobras202021(
                                       si199_sequencial
                                      ,si199_tiporegistro
                                      ,si199_codorgaoresp
                                      ,si199_codobra
  ...
  function excluir ( $si199_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras202021
                    where ";
    $sql2 = "";
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras202021";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si199_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras202021 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si199_sequencial != "" && $si199_sequencial != null) {
        $sql2 = " where cadobras202021.si199_sequencial = '$si199_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
