...
class cl_notaserv { 
   ...
   function incluir ($cm09_i_codigo){ 
     ...
     if($cm09_i_codigo == "" || $cm09_i_codigo == null ){
       $result = @pg_query("select nextval('notaserv_cm09_i_codigo_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from notaserv_cm09_i_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,1000100,'$this->cm09_i_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1000022,1000100,'','".AddSlashes(pg_result($resaco,0,'cm09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1000022,1000102,'','".AddSlashes(pg_result($resaco,0,'cm09_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1000022,1000103,'','".AddSlashes(pg_result($resaco,0,'cm09_d_emissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($cm09_i_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,1000100,'$this->cm09_i_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm09_i_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1000022,1000100,'".AddSlashes(pg_result($resaco,$conresaco,'cm09_i_codigo'))."','$this->cm09_i_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm09_i_sepultamento"]))
           $resac = pg_query("insert into db_acount values($acount,1000022,1000102,'".AddSlashes(pg_result($resaco,$conresaco,'cm09_i_sepultamento'))."','$this->cm09_i_sepultamento',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["cm09_d_emissao"]))
           $resac = pg_query("insert into db_acount values($acount,1000022,1000103,'".AddSlashes(pg_result($resaco,$conresaco,'cm09_d_emissao'))."','$this->cm09_d_emissao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($cm09_i_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,1000100,'$this->cm09_i_codigo','E')");
         $resac = pg_query("insert into db_acount values($acount,1000022,1000100,'','".AddSlashes(pg_result($resaco,$iresaco,'cm09_i_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1000022,1000102,'','".AddSlashes(pg_result($resaco,$iresaco,'cm09_i_sepultamento'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1000022,1000103,'','".AddSlashes(pg_result($resaco,$iresaco,'cm09_d_emissao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
