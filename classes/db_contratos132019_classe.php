<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos132019
class cl_contratos132019 { 
   ...
   var $si86_cpfrepresentantelegal = null; 
   var $si86_mes = 0; 
   var $si86_reg10 = 0; 
   var $si86_instit = 0; 
   ...
   var $campos = "
                 ...
                 si86_cpfrepresentantelegal = varchar(11) = Número do CPF do  Representante 
                 si86_mes = int8 = Mês 
                 si86_reg10 = int8 = reg10 
                 si86_instit = int8 = Instituição 
                 ";
   //funcao construtor da classe 
   function cl_contratos132019() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos132019"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si86_cpfrepresentantelegal = ($this->si86_cpfrepresentantelegal == ""?@$GLOBALS["HTTP_POST_VARS"]["si86_cpfrepresentantelegal"]:$this->si86_cpfrepresentantelegal);
   ...
   function incluir ($si86_sequencial){ 
     ...
     if($si86_sequencial == "" || $si86_sequencial == null ){
       $result = db_query("select nextval('contratos132019_si86_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos132019_si86_sequencial_seq do campo: si86_sequencial"; 
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from contratos132019_si86_sequencial_seq");
     ...
     $sql = "insert into contratos132019(
                                       si86_sequencial 
                                      ,si86_tiporegistro 
                                      ,si86_codcontrato 
                                      ,si86_tipodocumento 
                                      ,si86_nrodocumento 
                                      ,si86_cpfrepresentantelegal 
                                      ,si86_mes 
                                      ,si86_reg10 
                                      ,si86_instit 
                       )
                values (
                               ...
                               ,'$this->si86_cpfrepresentantelegal' 
                               ,$this->si86_mes 
                               ,$this->si86_reg10 
                               ,$this->si86_instit 
                      )";
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos132019 ($this->si86_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos132019 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos132019 ($this->si86_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010315,2010455,'','".AddSlashes(pg_result($resaco,0,'si86_cpfrepresentantelegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($si86_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update contratos132019 set ";
     $virgula = "";
     ...
     if(trim($this->si86_cpfrepresentantelegal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si86_cpfrepresentantelegal"])){ 
       $sql  .= $virgula." si86_cpfrepresentantelegal = '$this->si86_cpfrepresentantelegal' ";
       $virgula = ",";
     }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si86_cpfrepresentantelegal"]) || $this->si86_cpfrepresentantelegal != "")
           $resac = db_query("insert into db_acount values($acount,2010315,2010455,'".AddSlashes(pg_result($resaco,$conresaco,'si86_cpfrepresentantelegal'))."','$this->si86_cpfrepresentantelegal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos132019 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si86_sequencial;
       $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos132019 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si86_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si86_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010315,2010455,'','".AddSlashes(pg_result($resaco,$iresaco,'si86_cpfrepresentantelegal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     $sql = " delete from contratos132019
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si86_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos132019 nao Excluído. Exclusão Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos132019 nao Encontrado. Exclusão não Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si86_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos132019";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si86_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from contratos132019 ";
     $sql .= "      left  join contratos102019  on  contratos102019.si83_sequencial = contratos132019.si86_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si86_sequencial!=null ){
         $sql2 .= " where contratos132019.si86_sequencial = $si86_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
