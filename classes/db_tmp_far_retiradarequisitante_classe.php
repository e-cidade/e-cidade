...
class cl_tmp_far_retiradarequisitante { 
   ...
   var $campos = "
                 ...
                 fa08_i_cgsund = int4 = Cgs 
                 fa08_i_retirada = int4 = Retirada 
                 ";
   //funcao construtor da classe 
   function cl_tmp_far_retiradarequisitante() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("tmp_far_retiradarequisitante"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->fa08_i_cgsund = ($this->fa08_i_cgsund == ""?@$GLOBALS["HTTP_POST_VARS"]["fa08_i_cgsund"]:$this->fa08_i_cgsund);
   ...
   function incluir ($fa08_i_codigo){ 
      $this->atualizacampos();
     if($this->fa08_i_cgsund == null ){ 
       $this->erro_sql = " Campo Cgs nao Informado.";
       $this->erro_campo = "fa08_i_cgsund";
       $this->erro_banco = "";
     ...
     $sql = "insert into ".$this->tmp_far_retiradarequisitante."(
                                       fa08_i_codigo 
                                      ,fa08_i_cgsund 
                                      ,fa08_i_retirada 
                       )
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "".$this->tmp_far_retiradarequisitante." ($this->fa08_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "".$this->tmp_far_retiradarequisitante." já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "".$this->tmp_far_retiradarequisitante." ($this->fa08_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($fa08_i_codigo=null) { 
      $this->atualizacampos();
     $sql = " update ".$this->tmp_far_retiradarequisitante." set ";
     $virgula = "";
     ...
     if(trim($this->fa08_i_cgsund)!="" || isset($GLOBALS["HTTP_POST_VARS"]["fa08_i_cgsund"])){ 
       $sql  .= $virgula." fa08_i_cgsund = $this->fa08_i_cgsund ";
       $virgula = ",";
       if(trim($this->fa08_i_cgsund) == null ){ 
         $this->erro_sql = " Campo Cgs nao Informado.";
         $this->erro_campo = "fa08_i_cgsund";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "".$this->tmp_far_retiradarequisitante." nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->fa08_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($fa08_i_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "".$this->tmp_far_retiradarequisitante." nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$fa08_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:".$this->tmp_far_retiradarequisitante."";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $fa08_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ".$this->tmp_far_retiradarequisitante." ";
     $sql .= "      left join ".$this->tmp_far_retirada."  on  ".$this->tmp_far_retirada.".fa04_i_codigo = ".$this->tmp_far_retiradarequisitante.".fa08_i_retirada";
     $sql .= "      inner join cgs_und  on  cgs_und.z01_i_cgsund = ".$this->tmp_far_retiradarequisitante.".fa08_i_cgsund";
     ...
     $sql .= "      inner join medicos  on  medicos.sd03_i_codigo = ".$this->tmp_far_retirada.".fa04_i_profissional";
    // $sql .= "      inner join cgs_und  as a on   a.z01_i_cgsund = far_retirada.fa04_i_cgsund";
    ...
    // $sql .= "      inner join cgs  as b on   b.z01_i_numcgs = cgs_und.z01_i_cgsund";
     ...
     if($dbwhere==""){
       if($fa08_i_codigo!=null ){
         $sql2 .= " where ".$this->tmp_far_retiradarequisitante.".fa08_i_codigo = $fa08_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
