...
class cl_rhpessalario { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->rh04_seqpes = ($this->rh04_seqpes == ""?@$GLOBALS["HTTP_POST_VARS"]["rh04_seqpes"]:$this->rh04_seqpes);
       $this->rh04_salari = ($this->rh04_salari == ""?@$GLOBALS["HTTP_POST_VARS"]["rh04_salari"]:$this->rh04_salari);
     }else{
       $this->rh04_seqpes = ($this->rh04_seqpes == ""?@$GLOBALS["HTTP_POST_VARS"]["rh04_seqpes"]:$this->rh04_seqpes);
     }
   }
   // funcao para inclusao
   function incluir ($rh04_seqpes){ 
      $this->atualizacampos();
     if($this->rh04_salari == null ){ 
       ...
       $this->rh04_seqpes = $rh04_seqpes; 
     if(($this->rh04_seqpes == null) || ($this->rh04_seqpes == "") ){ 
       $this->erro_sql = " Campo rh04_seqpes nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->rh04_seqpes;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($rh04_seqpes=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($rh04_seqpes!=null){
       $sql .= " rh04_seqpes = $this->rh04_seqpes";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->rh04_seqpes));
     if($this->numrows>0){
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Salário nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh04_seqpes;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($rh04_seqpes=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($rh04_seqpes));
     }else{ 
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$rh04_seqpes;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Salário nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh04_seqpes;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $rh04_seqpes=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from rhpessalario ";
     $sql2 = "";
     if($dbwhere==""){
       if($rh04_seqpes!=null ){
         $sql2 .= " where rhpessalario.rh04_seqpes = $rh04_seqpes "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
