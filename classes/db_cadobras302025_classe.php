<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras302025
class cl_cadobras302025 {
  ...
  public $campos = "
                 ...
                 si201_mes = int4 = Mes
                 si201_pdf = text = pdf
                 si201_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("cadobras302025");
  ...
  function incluir () {
    ...
    if ($this->si201_sequencial == null ) {
      $result = db_query("select nextval('cadobras302025_si201_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras302025_si201_sequencial_seq do campo: si201_sequencial";
    ...
    if ($this->si201_tipomedicao == null ) {
      $this->erro_sql = " Campo tipo medicao n�o informado.";
...
//      $this->erro_sql = " Campo desc outros tipos medicao n�o informado.";
...
//    }
    if ($this->si201_nummedicao == null ) {
      $this->erro_sql = " Campo numero medicao n�o informado.";
...
//      $this->erro_sql = " Campo desc medicao n�o informado.";
...
//    }
    if ($this->si201_dtiniciomedicao == null ) {
      $this->erro_sql = " Campo data incio n�o informado.";
    ...
    if ($this->si201_dtfimmedicao == null ) {
      $this->erro_sql = " Campo data fim n�o informado.";
    ...
    if ($this->si201_dtmedicao == null ) {
      $this->erro_sql = " Campo data medicao n�o informado.";
    ...
    if ($this->si201_valormedicao == null ) {
      $this->erro_sql = " Campo valor medicao n�o informado.";
    ...
    $sql = "insert into cadobras302025(
                                       si201_sequencial
                                      ,si201_tiporegistro
                                      ,si201_codorgaoresp
                                      ,si201_codobra
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "detalhamento da medicao () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "detalhamento da medicao j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "detalhamento da medicao () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
//    }
  ...
  function excluir ( $si201_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras302025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "detalhamento da medicao nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "detalhamento da medicao nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras302025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si201_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras302025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si201_sequencial != "" && $si201_sequencial != null) {
        $sql2 = " where cadobras302025.si201_sequencial = '$si201_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
