...
require_once("db_sau_procedimento_classe.php");

class cl_sau_procedimento_ext extends cl_sau_procedimento { 
   function sql_query_ext ( $sd63_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
