<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf402023
class cl_dclrf402023 {
   ...
   function cl_dclrf402023() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dclrf402023");
   ...
   function incluir ($si193_sequencial){
      $this->atualizacampos();
	   if($si193_sequencial == "" || $si193_sequencial == null ){
		   $result = @pg_query("select nextval('dclrf402023_si193_sequencial_seq')");
		   if($result==false){
			   $this->erro_banco = str_replace("\n","",@pg_last_error());
			   $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf402023_si192_sequencial_seq do campo: si193_sequencial";
		   ...
		   $result = @pg_query("select last_value from dclrf402023_si193_sequencial_seq");
...
//     $sql2 = "si193_reg10 = $si193_reg10";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "dclrf402023 não Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       return false;
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dclrf402023 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         return true;
   ...
   function sql_query ( $si193_sequencial = null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join  dclrf102020 on  dclrf102020.si157_sequencial = dclrf402023.si193_reg10 ";
     // $sql .= "      inner join   on  . = dclrf402023.si191_reg10 and  . = dclrf402023.si192_reg10 and  . = dclrf402023.si193_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if( $si193_sequencial != "" && $si193_sequencial != null){
          $sql2 = " where dclrf402023.si193_sequencial = $si193_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
