...
class cl_proctransferintand { 
   ...
   function incluir (){ 
     ...
     $sql = "insert into proctransferintand(
                                       p87_codtransferint 
                                      ,p87_codandam 
                       )
                values (
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from proctransferintand
                    where ";
     $sql2 = "";
   ...
   function sql_query ( $oid = null,$campos="proctransferintand.oid,*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from proctransferintand ";
     $sql .= "      inner join procandam  on  procandam.p61_codandam = proctransferintand.p87_codandam";
     $sql .= "      inner join proctransferint  on  proctransferint.p88_codigo = proctransferintand.p87_codtransferint";
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where proctransferintand.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   function sql_query_cert ( $oid = null,$campos="proctransferintand.oid,*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
     ...
     $sql .= "      inner join db_usuarios  on  db_usuarios.id_usuario = procandam.p61_id_usuario";
     $sql .= "      inner join db_depart  on  db_depart.coddepto = procandam.p61_coddepto";
     $sql .= "      inner join protprocesso  on  protprocesso.p58_codandam = procandam.p61_codandam";
     $sql .= "      inner join db_usuarios  as a on   a.id_usuario = proctransferint.p88_usuario";
     $sql2 = "";
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
