...
class cl_bensbaix {
   ...
   var $campos = "
                 ...
                 t55_destino = int8 = Cgm de destino do bem
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->t55_destino = ($this->t55_destino == ""?@$GLOBALS["HTTP_POST_VARS"]["t55_destino"]:$this->t55_destino);
     }else{
       $this->t55_codbem = ($this->t55_codbem == ""?@$GLOBALS["HTTP_POST_VARS"]["t55_codbem"]:$this->t55_codbem);
     }
   }
   ...
   function incluir ($t55_codbem){
     ...
     $sql = "insert into bensbaix(
                ...
                values (
                               ...
                               ,$this->t55_motivo 
                               ,'$this->t55_obs' 
                               ,".($this->t55_destino == "null" || $this->t55_destino == ""?"null":"'".$this->t55_destino."'")."
                      )";
     $result = db_query($sql);
     if($result==false){
   ...
   function alterar ($t55_codbem=null) {
     ...
     if(trim($this->t55_destino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t55_destino"])){ 
       $sql  .= $virgula." t55_destino = '$this->t55_destino' ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($t55_codbem!=null){
