<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge402025
class cl_conge402025 {
  ...
  public $campos = "
                 ...
                 si185_codorgao = varchar(2) = C�digo do �rg�o
                 si185_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si185_nroconvenioconge = varchar(30) = N�mero do conv�nio original ou instr
                 si185_dataassinaturaconvoriginalconge = date = Data da assinatura do conv�nio original
                 si185_numeroparcela = int8 = N�mero da parcela
                 si185_datarepasseconge = date = Data do repasse
                 si185_prestacaocontasparcela = int8 = Informar se houve presta��o de contas
                 si185_dataprestacontasparcela = date = Data da efetiva presta��o de contas
                 si185_prestacaocontas = int8 = Resultado da an�lise da presta��o de con
                 si185_datacienfatos = date = Data da ci�ncia dos fatos
                 si185_prorrogprazo = int8 = Informar se houve prorroga��o de prazo
                 si185_dataprorrogprazo = date = Nova data final para presta��o de contas
                 si185_nrocpfrespprestconge = varchar(11) = N�mero do CPF do respons�vel pela aprova
                 si185_dsccargorespprestconge = varchar(50) = Cargo do respons�vel pela aprova��o
                 si185_mes = int8 = M�s
                 si185_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conge402025");
  ...
  function incluir ($si185_sequencial) {
     ...
     if ($this->si185_nroconvenioconge == null ) {
       $this->erro_sql = " Campo N�mero do conv�nio original ou instr n�o informado.";
     ...
     if ($this->si185_dataassinaturaconvoriginalconge == null ) {
       $this->erro_sql = " Campo Data da assinatura do conv�nio original n�o informado.";
     ...
     if ($this->si185_numeroparcela == null ) {
       $this->erro_sql = " Campo N�mero da parcela n�o informado.";
     ...
     if ($this->si185_datarepasseconge == null ) {
       $this->erro_sql = " Campo Data do repasse n�o informado.";
     ...
     if ($this->si185_prestacaocontasparcela == null ) {
       $this->erro_sql = " Campo Informar se houve presta��o de contas n�o informado.";
     ...
     if ($this->si185_dataprestacontasparcela == null ) {
       $this->erro_sql = " Campo Data da efetiva presta��o de contas n�o informado.";
     ...
     if ($this->si185_prestacaocontas == null ) {
       $this->erro_sql = " Campo Resultado da an�lise da presta��o de con n�o informado.";
     ...
     if ($this->si185_datacienfatos == null ) {
       $this->erro_sql = " Campo Data da ci�ncia dos fatos n�o informado.";
     ...
     if ($this->si185_prorrogprazo == null ) {
       $this->erro_sql = " Campo Informar se houve prorroga��o de prazo n�o informado.";
     ...
     if ($this->si185_dataprorrogprazo == null ) {
       $this->erro_sql = " Campo Nova data final para presta��o de contas n�o informado.";
     ...
     if ($this->si185_nrocpfrespprestconge == null ) {
       $this->erro_sql = " Campo N�mero do CPF do respons�vel pela aprova n�o informado.";
     ...
     if ($this->si185_dsccargorespprestconge == null ) {
       $this->erro_sql = " Campo Cargo do respons�vel pela aprova��o n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Detalhamento da Presta��o de Contas  ($this->si185_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Detalhamento da Presta��o de Contas  j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Detalhamento da Presta��o de Contas  ($this->si185_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($si185_sequencial=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Detalhamento da Presta��o de Contas  nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si185_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Detalhamento da Presta��o de Contas  nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si185_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Detalhamento da Presta��o de Contas  nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Detalhamento da Presta��o de Contas  nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si185_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge402025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si185_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge402025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si185_sequencial!=null ) {
         $sql2 .= " where conge402025.si185_sequencial = $si185_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
