...
class cl_aguasitleitura { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->x17_codigo = ($this->x17_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["x17_codigo"]:$this->x17_codigo);
       $this->x17_descr = ($this->x17_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["x17_descr"]:$this->x17_descr);
       $this->x17_regra = ($this->x17_regra == ""?@$GLOBALS["HTTP_POST_VARS"]["x17_regra"]:$this->x17_regra);
     }else{
       $this->x17_codigo = ($this->x17_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["x17_codigo"]:$this->x17_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($x17_codigo){ 
      $this->atualizacampos();
     if($this->x17_descr == null ){ 
     ...
     if($x17_codigo == "" || $x17_codigo == null ){
       $result = db_query("select nextval('aguasitleitura_x17_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: aguasitleitura_x17_codigo_seq do campo: x17_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $x17_codigo)){
         ...
         $this->x17_codigo = $x17_codigo; 
       }
     }
     if(($this->x17_codigo == null) || ($this->x17_codigo == "") ){ 
       $this->erro_sql = " Campo x17_codigo nao declarado.";
     ...
     $sql = "insert into aguasitleitura(
                                       x17_codigo 
                                      ,x17_descr 
                                      ,x17_regra 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->x17_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($x17_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($x17_codigo!=null){
       $sql .= " x17_codigo = $this->x17_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->x17_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Situaçao de Leituras nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->x17_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Situaçao de Leituras nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->x17_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($x17_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($x17_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Situaçao de Leituras nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$x17_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Situaçao de Leituras nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$x17_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $x17_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from aguasitleitura ";
     $sql2 = "";
     if($dbwhere==""){
       if($x17_codigo!=null ){
         $sql2 .= " where aguasitleitura.x17_codigo = $x17_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
