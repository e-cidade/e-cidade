<?
	...
	class cl_cute212025
	{
		...
		var $campos = "
                 ...
                 si201_codctb = int8 = C�digo da identificador da conta
                 si201_codfontrecursos = int8 = C�digo da fonte de recursos
                 si201_tipomovimentacao = int8 = Tipo de movimenta��o
                 si201_tipoentrsaida = varchar(2) = Tipo de entrada ou sa�da
                 si201_valorentrsaida = float8 = Valor da entrada
                 si201_codorgaotransf = varchar(2) = C�digo do �rg�o
                 si201_reg10 = int8 = reg10
                 si201_mes = int8 = M�s
                 si201_instit = int8 = Institui��o
                 ";

		//funcao construtor da classe
		function cl_cute212025()
		{
			//classes dos rotulos dos campos
			$this->rotulo = new rotulo("cute212025");
		...
		function incluir($si201_sequencial)
		{
			...
			if ($si201_sequencial == "" || $si201_sequencial == null) {
				$result = db_query("select nextval('cute212025_si201_sequencial_seq')");
				if ($result == false) {
					$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
					$this->erro_sql = "Verifique o cadastro da sequencia: cute212025_si201_sequencial_seq do campo: si201_sequencial";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "0";
				...
				$result = db_query("select last_value from cute212025_si201_sequencial_seq");
				if (($result != false) && (pg_result($result, 0, 0) < $si201_sequencial)) {
					...
					$this->erro_codfontrecursos = "Sequencia menor que este n�mero.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "0";
			...
			if ($result == false) {
				...
				if (strpos(strtolower($this->erro_codfontrecursos), "duplicate key") != 0) {
					$this->erro_sql = "cute212025 ($this->si201_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_codfontrecursos = "cute212025 j� Cadastrado";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				} else {
					$this->erro_sql = "cute212025 ($this->si201_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
...
//			}
			...
			if ($result == false) {
				$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
				$this->erro_sql = "cute212025 nao Alterado. Alteracao Abortada.\n";
				$this->erro_sql .= "Valores : " . $this->si201_sequencial;
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				$this->erro_status = "0";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_codfontrecursos = "";
					$this->erro_sql = "cute212025 nao foi Alterado. Alteracao Executada.\n";
					$this->erro_sql .= "Valores : " . $this->si201_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "1";
...
//			}
			...
			if ($result == false) {
				$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
				$this->erro_sql = "cute212025 nao Exclu�do. Exclus�o Abortada.\n";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_codfontrecursos = "";
					$this->erro_sql = "cute212025 nao Encontrado. Exclus�o n�o Efetuada.\n";
					$this->erro_sql .= "Valores : " . $si201_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "1";
		...
		function sql_record($sql)
		{
			...
			if ($this->numrows == 0) {
				$this->erro_codfontrecursos = "";
				$this->erro_sql = "Record Vazio na Tabela:cute212025";
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				$this->erro_status = "0";
		...
		function sql_query($si201_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
		{
			...
			$sql .= " from cute212025 ";
			$sql .= "      left  join cute102020  on  cute102020.si199_sequencial = cute212025.si201_reg10";
			$sql2 = "";
			if ($dbwhere == "") {
				if ($si201_sequencial != null) {
					$sql2 .= " where cute212025.si201_sequencial = $si201_sequencial ";
				}
			} else if ($dbwhere != "") {
				$sql2 = " where $dbwhere";
			}
