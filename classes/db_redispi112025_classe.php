<?
//MODULO: sicom
//CLASSE DA ENTIDADE redispi112025
class cl_redispi112025
{
  ...
  var $campos = "
                 ...
                 si184_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si184_codunidadesubresp = varchar(8) = C�digo da unidade
                 si184_codunidadesubrespestadual = varchar(4) = C�digo da unidade respons�vel
                 si184_exercicioprocesso = int8 = Exerc�cio em que foi instaurado
                 si184_nroprocesso = varchar(12) = N�mero sequencial  do processo
                 ...
                 si184_tipoatividadeservico = int4 = Tipo Atividade Servi�o
                 si184_dscatividadeservico = varchar(150) = Descri��o das atividades do servi�o
                 si184_tipoatividadeserviespecializado = int4 = Tipo Atividade Servi�o T�cnico Especializado
                 si184_dscatividadeserviespecializado = varchar(150) = Descri��o das atividades do servi�o Especializado
                 si184_codfuncao = char(2) = C�digo da Fun��o
                 si184_codsubfuncao = char(3) = C�digo da Subfun��o
                 si184_codbempublico = int4 = C�digo do Equipamento ou bem p�blico
  ...
  function cl_redispi112025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("redispi112025");
  ...
  function incluir($si184_sequencial)
  {
    ...
    if ($si184_sequencial == "" || $si184_sequencial == null) {
      $result = db_query("select nextval('redispi112025_si184_sequencial_seq')");
      if ($result == false) {
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "redispi112025 ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "redispi112025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "redispi112025 ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si184_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "redispi112025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si184_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "redispi112025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si184_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si184_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "redispi112025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "redispi112025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si184_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:redispi112025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si184_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from redispi112025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si184_sequencial != null) {
        $sql2 .= " where redispi112025.si184_sequencial = si184_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
