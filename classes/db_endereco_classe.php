...
class cl_endereco {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       // $this->db76_codigoibge = ($this->db76_codigoibge == ""?@$GLOBALS["HTTP_POST_VARS"]["db76_codigoibge"]:$this->db76_codigoibge);
     }else{
       $this->db76_sequencial = ($this->db76_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db76_sequencial"]:$this->db76_sequencial);
     }
   }
   ...
   function alterar ($db76_sequencial=null) {
     ...
     // if(trim($this->db76_codigoibge)!="" || isset($GLOBALS["HTTP_POST_VARS"]["db76_codigoibge"])){
     //   $sql  .= $virgula." db76_codigoibge = '$this->db76_codigoibge' ";
     //   $virgula = ",";
     // }
     $sql .= " where ";
