...
class cl_grupocaracteristica { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->db139_sequencial = ($this->db139_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db139_sequencial"]:$this->db139_sequencial);
       $this->db139_grupoutilizacao = ($this->db139_grupoutilizacao == ""?@$GLOBALS["HTTP_POST_VARS"]["db139_grupoutilizacao"]:$this->db139_grupoutilizacao);
       $this->db139_descricao = ($this->db139_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["db139_descricao"]:$this->db139_descricao);
     }else{
       $this->db139_sequencial = ($this->db139_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db139_sequencial"]:$this->db139_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($db139_sequencial){ 
      $this->atualizacampos();
     if($this->db139_grupoutilizacao == null ){ 
     ...
     if($db139_sequencial == "" || $db139_sequencial == null ){
       $result = db_query("select nextval('grupocaracteristica_db139_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: grupocaracteristica_db139_sequencial_seq do campo: db139_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $db139_sequencial)){
         ...
         $this->db139_sequencial = $db139_sequencial; 
       }
     }
     if(($this->db139_sequencial == null) || ($this->db139_sequencial == "") ){ 
       $this->erro_sql = " Campo db139_sequencial nao declarado.";
     ...
     $sql = "insert into grupocaracteristica(
                                       db139_sequencial 
                                      ,db139_grupoutilizacao 
                                      ,db139_descricao 
                       )
                values (
                                $this->db139_sequencial 
                               ,$this->db139_grupoutilizacao 
                               ,'$this->db139_descricao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->db139_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->db139_sequencial  ));
   ...
   function alterar ($db139_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($db139_sequencial!=null){
       $sql .= " db139_sequencial = $this->db139_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "grupocaracteristica nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db139_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "grupocaracteristica nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db139_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db139_sequencial=null,$dbwhere=null) { 
     ...
     if (isset($lSessaoDesativarAccount) && $lSessaoDesativarAccount === false) {
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($db139_sequencial));
       } else { 
     ...
     $sql = " delete from grupocaracteristica
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($db139_sequencial != ""){
          ...
          $sql2 .= " db139_sequencial = $db139_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "grupocaracteristica nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$db139_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "grupocaracteristica nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db139_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $db139_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from grupocaracteristica ";
     $sql .= "      inner join grupoutilizacao  on  grupoutilizacao.db138_sequencial = grupocaracteristica.db139_grupoutilizacao";
     $sql2 = "";
     if($dbwhere==""){
       if($db139_sequencial!=null ){
         $sql2 .= " where grupocaracteristica.db139_sequencial = $db139_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
