...
class cl_bensconfplaca { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->t40_codigo = ($this->t40_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["t40_codigo"]:$this->t40_codigo);
       $this->t40_descr = ($this->t40_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["t40_descr"]:$this->t40_descr);
     }else{
       $this->t40_codigo = ($this->t40_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["t40_codigo"]:$this->t40_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($t40_codigo){ 
      $this->atualizacampos();
     if($this->t40_descr == null ){ 
     ...
     if($t40_codigo == "" || $t40_codigo == null ){
       $result = db_query("select nextval('bensconfplaca_t40_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: bensconfplaca_t40_codigo_seq do campo: t40_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $t40_codigo)){
         ...
         $this->t40_codigo = $t40_codigo; 
       }
     }
     if(($this->t40_codigo == null) || ($this->t40_codigo == "") ){ 
       $this->erro_sql = " Campo t40_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->t40_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($t40_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($t40_codigo!=null){
       $sql .= " t40_codigo = $this->t40_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->t40_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipos de configuração da placa do bem  nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->t40_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipos de configuração da placa do bem  nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->t40_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($t40_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($t40_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipos de configuração da placa do bem  nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$t40_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipos de configuração da placa do bem  nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$t40_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $t40_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from bensconfplaca ";
     $sql2 = "";
     if($dbwhere==""){
       if($t40_codigo!=null ){
         $sql2 .= " where bensconfplaca.t40_codigo = $t40_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
