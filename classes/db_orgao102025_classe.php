<?
//MODULO: sicom
//CLASSE DA ENTIDADE orgao102025
class cl_orgao102025
{
  ...
  var $campos = "
                 ...
                 si14_codorgao = varchar(2) = cod Org�o
                 si14_tipoorgao = varchar(2) = Tipo do �rg�o
                 si14_cnpjorgao = varchar(14) = N�mero do CNPJ
                 si14_tipodocumentofornsoftware = int8 = Tipo de documento do fornecedor
                 si14_nrodocumentofornsoftware = varchar(14) = N�mero do documento do fornecedor
                 si14_versaosoftware = varchar(50) = Vers�o do Software
                 ...
                 si14_mes = int8 = M�s
                 si14_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_orgao102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("orgao102025");
  ...
  function incluir($si14_sequencial)
  {
    ...
    if ($si14_sequencial == "" || $si14_sequencial == null) {
      $result = db_query("select nextval('orgao102025_si14_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: orgao102025_si14_sequencial_seq do campo: si14_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from orgao102025_si14_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si14_sequencial)) {
        $this->erro_sql = " Campo si14_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "Org�o ($this->si14_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:orgao102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si14_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from orgao102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si14_sequencial != null) {
        $sql2 .= " where orgao102025.si14_sequencial = $si14_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
