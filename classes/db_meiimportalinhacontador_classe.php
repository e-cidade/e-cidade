...
//MODULO: ISSQN
//CLASSE DA ENTIDADE meiimportalinhacontador
class cl_meiimportalinhacontador { 
   ...
   var $campos = "
                 ...
                 q109_meiimportalinha = int4 = Linha de Importação do MEI 
   ...
   function cl_meiimportalinhacontador() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("meiimportalinhacontador"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->q109_meiimportalinha = ($this->q109_meiimportalinha == ""?@$GLOBALS["HTTP_POST_VARS"]["q109_meiimportalinha"]:$this->q109_meiimportalinha);
   ...
   function incluir ($q109_sequencial){ 
     ...
     if($this->q109_meiimportalinha == null ){ 
       $this->erro_sql = " Campo Linha de Importação do MEI nao Informado.";
       $this->erro_campo = "q109_meiimportalinha";
       $this->erro_banco = "";
     ...
     if($q109_sequencial == "" || $q109_sequencial == null ){
       $result = db_query("select nextval('meiimportalinhacontador_q109_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: meiimportalinhacontador_q109_sequencial_seq do campo: q109_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from meiimportalinhacontador_q109_sequencial_seq");
     ...
     $sql = "insert into meiimportalinhacontador(
                                       q109_sequencial 
                                      ,q109_municipio 
                                      ,q109_meiimportalinha 
                                      ,q109_ufcrc 
                                      ,q109_codigocrc 
                                      ,q109_datacrc 
                                      ,q109_cnpjcpf 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2855,16297,'','".AddSlashes(pg_result($resaco,0,'q109_meiimportalinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($q109_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update meiimportalinhacontador set ";
     $virgula = "";
     ...
     if(trim($this->q109_meiimportalinha)!="" || isset($GLOBALS["HTTP_POST_VARS"]["q109_meiimportalinha"])){ 
       $sql  .= $virgula." q109_meiimportalinha = $this->q109_meiimportalinha ";
       $virgula = ",";
       if(trim($this->q109_meiimportalinha) == null ){ 
         $this->erro_sql = " Campo Linha de Importação do MEI nao Informado.";
         $this->erro_campo = "q109_meiimportalinha";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q109_meiimportalinha"]) || $this->q109_meiimportalinha != "")
           $resac = db_query("insert into db_acount values($acount,2855,16297,'".AddSlashes(pg_result($resaco,$conresaco,'q109_meiimportalinha'))."','$this->q109_meiimportalinha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function excluir ($q109_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2855,16297,'','".AddSlashes(pg_result($resaco,$iresaco,'q109_meiimportalinha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     $sql = " delete from meiimportalinhacontador
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($q109_sequencial != ""){
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:meiimportalinhacontador";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $q109_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from meiimportalinhacontador ";
     $sql .= "      inner join meiimportalinha  on  meiimportalinha.q105_sequencial = meiimportalinhacontador.q109_meiimportalinha";
     $sql .= "      inner join meiimporta  on  meiimporta.q104_sequencial = meiimportalinha.q105_meiimporta";
     $sql2 = "";
     if($dbwhere==""){
       if($q109_sequencial!=null ){
         $sql2 .= " where meiimportalinhacontador.q109_sequencial = $q109_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
