...
class cl_clientesprodutoscomercial { 
   ...
   var $campos = "
                 ...
                 at91_fornecedor = varchar(100) = Fornecedor 
                 at91_datavenccontrato = date = Vencimento 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->at91_sequencial = ($this->at91_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_sequencial"]:$this->at91_sequencial);
       $this->at91_cliente = ($this->at91_cliente == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_cliente"]:$this->at91_cliente);
       $this->at91_nome = ($this->at91_nome == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_nome"]:$this->at91_nome);
       $this->at91_fornecedor = ($this->at91_fornecedor == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_fornecedor"]:$this->at91_fornecedor);
       if($this->at91_datavenccontrato == ""){
         $this->at91_datavenccontrato_dia = ($this->at91_datavenccontrato_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_dia"]:$this->at91_datavenccontrato_dia);
         $this->at91_datavenccontrato_mes = ($this->at91_datavenccontrato_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_mes"]:$this->at91_datavenccontrato_mes);
         $this->at91_datavenccontrato_ano = ($this->at91_datavenccontrato_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_ano"]:$this->at91_datavenccontrato_ano);
         if($this->at91_datavenccontrato_dia != ""){
            $this->at91_datavenccontrato = $this->at91_datavenccontrato_ano."-".$this->at91_datavenccontrato_mes."-".$this->at91_datavenccontrato_dia;
         }
       }
       $this->at91_obs = ($this->at91_obs == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_obs"]:$this->at91_obs);
     }else{
       $this->at91_sequencial = ($this->at91_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["at91_sequencial"]:$this->at91_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($at91_sequencial){ 
      $this->atualizacampos();
     if($this->at91_cliente == null ){ 
     ...
     if($this->at91_datavenccontrato == null ){ 
       $this->at91_datavenccontrato = "null";
     }
     if($at91_sequencial == "" || $at91_sequencial == null ){
       $result = db_query("select nextval('clientesprodutoscomercial_at91_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: clientesprodutoscomercial_at91_sequencial_seq do campo: at91_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $at91_sequencial)){
         ...
         $this->at91_sequencial = $at91_sequencial; 
       }
     }
     if(($this->at91_sequencial == null) || ($this->at91_sequencial == "") ){ 
       $this->erro_sql = " Campo at91_sequencial nao declarado.";
     ...
     $sql = "insert into clientesprodutoscomercial(
                                       at91_sequencial 
                                      ,at91_cliente 
                                      ,at91_nome 
                                      ,at91_fornecedor 
                                      ,at91_datavenccontrato 
                                      ,at91_obs 
                       )
                values (
                                $this->at91_sequencial 
                               ,$this->at91_cliente 
                               ,'$this->at91_nome' 
                               ,'$this->at91_fornecedor' 
                               ,".($this->at91_datavenccontrato == "null" || $this->at91_datavenccontrato == ""?"null":"'".$this->at91_datavenccontrato."'")." 
                               ,'$this->at91_obs' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->at91_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($at91_sequencial=null) { 
      $this->atualizacampos();
     ...
     if(trim($this->at91_datavenccontrato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_dia"] !="") ){ 
       ...
       if(isset($GLOBALS["HTTP_POST_VARS"]["at91_datavenccontrato_dia"])){ 
         $sql  .= $virgula." at91_datavenccontrato = null ";
         $virgula = ",";
       }
     }
     ...
     $sql .= " where ";
     if($at91_sequencial!=null){
       $sql .= " at91_sequencial = $this->at91_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->at91_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Produtos do Cliente nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->at91_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Produtos do Cliente nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->at91_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($at91_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($at91_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($at91_sequencial != ""){
          ...
          $sql2 .= " at91_sequencial = $at91_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Produtos do Cliente nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$at91_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Produtos do Cliente nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$at91_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $at91_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from clientesprodutoscomercial ";
     $sql .= "      inner join clientes  on  clientes.at01_codcli = clientesprodutoscomercial.at91_cliente";
     $sql2 = "";
     if($dbwhere==""){
       if($at91_sequencial!=null ){
         $sql2 .= " where clientesprodutoscomercial.at91_sequencial = $at91_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
