...
class cl_conciliastatus { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->k95_sequencial = ($this->k95_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k95_sequencial"]:$this->k95_sequencial);
       $this->k95_descr = ($this->k95_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["k95_descr"]:$this->k95_descr);
       $this->k95_fechada = ($this->k95_fechada == "f"?@$GLOBALS["HTTP_POST_VARS"]["k95_fechada"]:$this->k95_fechada);
     }else{
       $this->k95_sequencial = ($this->k95_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k95_sequencial"]:$this->k95_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($k95_sequencial){ 
      $this->atualizacampos();
     if($this->k95_descr == null ){ 
     ...
     if($this->k95_fechada == null ){ 
       ...
       $this->k95_sequencial = $k95_sequencial; 
     if(($this->k95_sequencial == null) || ($this->k95_sequencial == "") ){ 
       $this->erro_sql = " Campo k95_sequencial nao declarado.";
     ...
     $sql = "insert into conciliastatus(
                                       k95_sequencial 
                                      ,k95_descr 
                                      ,k95_fechada 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k95_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($k95_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($k95_sequencial!=null){
       $sql .= " k95_sequencial = $this->k95_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->k95_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "status da conciliacao nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k95_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "status da conciliacao nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k95_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k95_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($k95_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($k95_sequencial != ""){
          ...
          $sql2 .= " k95_sequencial = $k95_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "status da conciliacao nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$k95_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "status da conciliacao nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k95_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $k95_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from conciliastatus ";
     $sql2 = "";
     if($dbwhere==""){
       if($k95_sequencial!=null ){
         $sql2 .= " where conciliastatus.k95_sequencial = $k95_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
