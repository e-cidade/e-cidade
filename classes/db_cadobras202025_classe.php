<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras202025
class cl_cadobras202025 {
  ...
  public $campos = "
                 ...
                 si199_mes = int4 = Mes
                 si199_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("cadobras202025");
  ...
  function incluir () {
    ...
    if ($this->si199_sequencial == null ) {
      $result = db_query("select nextval('cadobras202025_si199_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras202025_si199_sequencial_seq do campo: si199_sequencial";
    ...
    if ($this->si199_situacaodaobra == null ) {
      $this->erro_sql = " Campo situacao da obra n�o informado.";
    ...
    if ($this->si199_dtsituacao == null ) {
      $this->erro_sql = " Campo dtsituacao n�o informado.";
    ...
    if ($this->si199_veiculopublicacao == null ) {
      $this->erro_sql = " Campo viculo publicacao n�o informado.";
    ...
    if ($this->si199_dtpublicacao == null ) {
      $this->erro_sql = " Campo dtpublicacao n�o informado.";
...
//      $this->erro_sql = " Campo desc situacao obra n�o informado.";
...
//    }
    ...
    $sql = "insert into cadobras202025(
                                       si199_sequencial
                                      ,si199_tiporegistro
                                      ,si199_codorgaoresp
                                      ,si199_codobra
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "execucao do objeto () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "execucao do objeto j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "execucao do objeto () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function excluir ( $si199_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras202025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "execucao do objeto nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "execucao do objeto nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras202025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si199_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras202025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si199_sequencial != "" && $si199_sequencial != null) {
        $sql2 = " where cadobras202025.si199_sequencial = '$si199_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
