...
class cl_atendimento_top {
   ...
   function sql_query ( $at14_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join db_usuclientes on db_usuclientes.at10_usuario = atendimento_CurrentWindow.at14_usuario ";
	 $sql .= "      inner join clientes       on clientes.at01_codcli        = atendimento_CurrentWindow.at14_codcli  and
                                                 clientes.at01_codcli        = db_usuclientes.at10_codcli ";
     $sql2 = "";
     if($dbwhere==""){
       if($at14_sequencial!=null ){
         $sql2 .= " where atendimento_CurrentWindow.at14_sequencial = $at14_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
