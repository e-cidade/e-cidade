...
class cl_setorloc { 
   ...
   var $j05_codigo = 0; 
   var $j05_descr = null; 
   var $j05_codigoproprio = null; 
   // cria propriedade com as variaveis do arquivo 
   var $campos = "
                 j05_codigo = int4 = Código 
                 j05_descr = varchar(40) = Descrição 
                 j05_codigoproprio = varchar(10) = Código Próprio 
                 ";
   //funcao construtor da classe 
   function cl_setorloc() { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->j05_codigo = ($this->j05_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["j05_codigo"]:$this->j05_codigo);
       $this->j05_descr = ($this->j05_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["j05_descr"]:$this->j05_descr);
       $this->j05_codigoproprio = ($this->j05_codigoproprio == ""?@$GLOBALS["HTTP_POST_VARS"]["j05_codigoproprio"]:$this->j05_codigoproprio);
     }else{
       $this->j05_codigo = ($this->j05_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["j05_codigo"]:$this->j05_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($j05_codigo){ 
      $this->atualizacampos();
     if($this->j05_descr == null ){ 
     ...
     if($this->j05_codigoproprio == null ){ 
       ...
       $this->j05_codigo = $j05_codigo; 
     if(($this->j05_codigo == null) || ($this->j05_codigo == "") ){ 
       $this->erro_sql = " Campo j05_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->j05_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($j05_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($j05_codigo!=null){
       $sql .= " j05_codigo = $this->j05_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->j05_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "setorloc nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->j05_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "setorloc nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->j05_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($j05_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($j05_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "setorloc nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$j05_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "setorloc nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$j05_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $j05_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     if($dbwhere==""){
       if($j05_codigo!=null ){
         $sql2 .= " where setorloc.j05_codigo = $j05_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql 
   function sql_query_file ( $j05_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
