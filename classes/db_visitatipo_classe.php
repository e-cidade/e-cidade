...
class cl_visitatipo { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->as13_sequencial = ($this->as13_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["as13_sequencial"]:$this->as13_sequencial);
       $this->as13_descricao = ($this->as13_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["as13_descricao"]:$this->as13_descricao);
       $this->as13_exigeencaminhamento = ($this->as13_exigeencaminhamento == "f"?@$GLOBALS["HTTP_POST_VARS"]["as13_exigeencaminhamento"]:$this->as13_exigeencaminhamento);
     }else{
       $this->as13_sequencial = ($this->as13_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["as13_sequencial"]:$this->as13_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($as13_sequencial){ 
      $this->atualizacampos();
     if($this->as13_descricao == null ){ 
     ...
     if($this->as13_exigeencaminhamento == null ){ 
     ...
     if($as13_sequencial == "" || $as13_sequencial == null ){
       $result = db_query("select nextval('visitatipo_as13_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: visitatipo_as13_sequencial_seq do campo: as13_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $as13_sequencial)){
         ...
         $this->as13_sequencial = $as13_sequencial; 
       }
     }
     if(($this->as13_sequencial == null) || ($this->as13_sequencial == "") ){ 
       $this->erro_sql = " Campo as13_sequencial nao declarado.";
     ...
     $sql = "insert into visitatipo(
                                       as13_sequencial 
                                      ,as13_descricao 
                                      ,as13_exigeencaminhamento 
                       )
                values (
                                $this->as13_sequencial 
                               ,'$this->as13_descricao' 
                               ,'$this->as13_exigeencaminhamento' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->as13_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->as13_sequencial  ));
   ...
   function alterar ($as13_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($as13_sequencial!=null){
       $sql .= " as13_sequencial = $this->as13_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Visita Tipo nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->as13_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Visita Tipo nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->as13_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($as13_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($as13_sequencial));
       } else { 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($as13_sequencial != ""){
          ...
          $sql2 .= " as13_sequencial = $as13_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Visita Tipo nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$as13_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Visita Tipo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$as13_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $as13_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($as13_sequencial!=null ){
         $sql2 .= " where visitatipo.as13_sequencial = $as13_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
