...
class cl_tabcurritipo { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->h02_codigo = ($this->h02_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["h02_codigo"]:$this->h02_codigo);
       $this->h02_descr = ($this->h02_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["h02_descr"]:$this->h02_descr);
       $this->h02_obs = ($this->h02_obs == ""?@$GLOBALS["HTTP_POST_VARS"]["h02_obs"]:$this->h02_obs);
     }else{
       $this->h02_codigo = ($this->h02_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["h02_codigo"]:$this->h02_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($h02_codigo){ 
      $this->atualizacampos();
     if($this->h02_descr == null ){ 
     ...
     if($h02_codigo == "" || $h02_codigo == null ){
       $result = db_query("select nextval('tabcurritipo_h02_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tabcurritipo_h02_codigo_seq do campo: h02_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $h02_codigo)){
         ...
         $this->h02_codigo = $h02_codigo; 
       }
     }
     if(($this->h02_codigo == null) || ($this->h02_codigo == "") ){ 
       $this->erro_sql = " Campo h02_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->h02_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($h02_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($h02_codigo!=null){
       $sql .= " h02_codigo = $this->h02_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->h02_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Contem a tabela tipos de cursos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->h02_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Contem a tabela tipos de cursos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->h02_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($h02_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($h02_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Contem a tabela tipos de cursos nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$h02_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Contem a tabela tipos de cursos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$h02_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $h02_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tabcurritipo ";
     $sql2 = "";
     if($dbwhere==""){
       if($h02_codigo!=null ){
         $sql2 .= " where tabcurritipo.h02_codigo = $h02_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
