...
class cl_escola {
   ...
   var $ed18_i_cnpjprivada = 0;
   var $ed18_i_cnpjmantprivada = 0;
   ...
   var $campos = "
                 ...
                 ed18_i_cnpjprivada = int8 = CNPJ da Escola Privada
                 ed18_i_cnpjmantprivada = int4 = CNPJ Mantenedora Privada
                 ed18_latitude = varchar(10) = Latitude
                 ed18_longitude = varchar(10) = Longitude
   ...
   function incluir ($ed18_i_codigo){
     ...
     if($this->ed18_c_nome == null ){
       $this->erro_sql = " Campo Nome da Escola nao Informado.";
     ...
     if($this->ed18_i_anoinicio == null ){
       $this->erro_sql = " Campo Ano Início nao Informado.";
     ...
     if($this->ed18_c_codigoinep == null ){
       $this->erro_sql = " Campo Código INEP nao Informado.";
     ...
     if($this->ed18_i_locdiferenciada == null ){
       $this->erro_sql = " Campo Localização Diferenciada nao Informado.";
     ...
     if($this->ed18_i_educindigena == null ){
       $this->erro_sql = " Campo Educação Indígena nao Informado.";
     ...
     if($this->ed18_i_credenciamento == null ){
       $this->erro_sql = " Campo Credenciamento nao Informado.";
     ...
     if($this->ed18_i_funcionamento == null ){
       $this->erro_sql = " Campo Situação de Funcionamento nao Informado.";
     ...
     if(($this->ed18_i_codigo == null) || ($this->ed18_i_codigo == "") ){
       $this->erro_sql = " Campo ed18_i_codigo nao declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Escola ($this->ed18_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($ed18_i_codigo=null) {
      $this->atualizacampos();
   ...
   if(trim($this->ed18_i_cnas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ed18_i_cnas"])){
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Escola nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed18_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Escola nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed18_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed18_i_codigo=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Escola nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Escola nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed18_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql
function sql_query ( $ed18_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql
   function sql_query_file ( $ed18_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
