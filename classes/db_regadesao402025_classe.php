<?
//MODULO: sicom
//CLASSE DA ENTIDADE regadesao402025
class cl_regadesao402025
{
    ...
    var $campos = "
                 ...
                 si73_codorgao = varchar(2) = C�digo do �rg�o
                 si73_codunidadesub = varchar(8) = C�digo da unidade
                 si73_nroprocadesao = varchar(12) = N�mero do  processo de  ades�o
                 si73_exercicioadesao = int8 = Exerc�cio do  processo de  ades�o
                 si73_nrolote = int8 = N�mero do Lote
                 si73_coditem = int8 = C�digo do item
                 si73_percdesconto = float8 = Percentual do  desconto
                 si73_tipodocumento = int8 = Tipo do  documento
                 si73_nrodocumento = varchar(14) = N�mero do  documento
                 si73_mes = int8 = M�s
                 si73_instit = int8 = Institui��o
    ...
    function cl_regadesao()
    {
        ...
        $this->rotulo = new rotulo("regadesao402025");
    ...
    function incluir($si73_sequencial)
    {
        ...
        if ($si73_sequencial == "" || $si73_sequencial == null) {
            $result = db_query("select nextval('regadesao402025_si73_sequencial_seq')");
            if ($result == false) {
                $this->erro_banco = str_replace("
", "", @pg_last_error());
                $this->erro_sql = "Verifique o cadastro da sequencia: regadesao402025_si73_sequencial_seq do campo: si73_sequencial";
                $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
                $this->erro_status = "0";
                return false;
            ...
            $result = db_query("select last_value from regadesao402025_si73_sequencial_seq");
            if (($result != false) && (pg_result($result, 0, 0) < $si73_sequencial)) {
                $this->erro_sql = " Campo si73_sequencial maior que �ltimo n�mero da sequencia.";
        ...
        $sql = "insert into regadesao402025(
                                       si73_sequencial
                                      ,si73_tiporegistro
                                      ,si73_codorgao
                                      ,si73_codunidadesub
...
", "", @pg_last_error());
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql = "regadesao402025 ($this->si73_sequencial) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
                $this->erro_banco = "regadesao402025 j� Cadastrado";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
            } else {
                $this->erro_sql = "regadesao402025 ($this->si73_sequencial) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
    ...
    {
        $this->atualizacampos();
        $sql = " update regadesao402025 set ";
        $virgula = "";
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("
", "", @pg_last_error());
            $this->erro_sql = "regadesao402025 nao Alterado. Alteracao Abortada.\n";
            $this->erro_sql .= "Valores : " . $this->si73_sequencial;
            $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "regadesao402025 nao foi Alterado. Alteracao Executada.\n";
                $this->erro_sql .= "Valores : " . $this->si73_sequencial;
                $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
                $this->erro_status = "1";
    ...
    function excluir($si73_sequencial = null, $dbwhere = null)
    {
        ...
        $sql = " delete from regadesao402025
                    where ";
        $sql2 = "";
        if ($dbwhere == null || $dbwhere == "") {
            if ($si73_sequencial != "") {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("
", "", @pg_last_error());
            $this->erro_sql = "regadesao402025 nao Exclu�do. Exclus�o Abortada.\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "regadesao402025 nao Encontrado. Exclus�o n�o Efetuada.\n";
                $this->erro_sql .= "Valores : " . $si73_sequencial;
                $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
                $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
                $this->erro_status = "1";
...
", "", @pg_last_error());
        ...
        if ($this->numrows == 0) {
            $this->erro_banco = "";
            $this->erro_sql = "Record Vazio na Tabela:regadesao402025";
            $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
            $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query($si73_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        ...
        $sql .= " from regadesao402025 ";
        $sql2 = "";
        if ($dbwhere == "") {
            if ($si73_sequencial != null) {
                $sql2 .= " where regadesao402025.si73_sequencial = $si73_sequencial ";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
