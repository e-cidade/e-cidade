...
class cl_matparam { 
   ...
   function incluir (){ 
     ...
     if($this->m90_sigaf == null ){ 
       $this->erro_sql = " Campo Habilita Sigaf nao Informado.";
       $this->erro_campo = "m90_versaldoitemreq";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
   ...
   function alterar ( $oid=null ) { 
     ...
     if(trim($this->m90_sigaf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["m90_sigaf"])){ 
       $sql  .= $virgula." m90_sigaf = '$this->m90_sigaf' ";
       $virgula = ",";
       if(trim($this->m90_sigaf) == null ){ 
         $this->erro_sql = " Campo Sigaf nao Informado.";
         $this->erro_campo = "m90_sigaf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
