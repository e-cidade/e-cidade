<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete122025
class cl_balancete122025
{
  ...
  function cl_balancete122025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete122025");
  ...
  function incluir($si179_sequencial)
  {
    ...
    if ($this->si179_tiporegistro == null) {
      $this->erro_sql = " Campo si179_tiporegistro n�o informado.";
    ...
    if ($this->si179_contacontabil == null) {
      $this->erro_sql = " Campo si179_contacontabil n�o informado.";
    ...
    if ($this->si179_naturezareceita == null) {
      $this->erro_sql = " Campo si179_naturezareceita n�o informado.";
    ...
    if ($this->si179_codfontrecursos == null) {
      $this->erro_sql = " Campo si179_codfontrecursos n�o informado.";
    ...
    if ($this->si179_saldoinicialcr == null) {
      $this->erro_sql = " Campo si179_saldoinicialcr n�o informado.";
    ...
    if ($this->si179_naturezasaldoinicialcr == null) {
      $this->erro_sql = " Campo si179_naturezasaldoinicialcr n�o informado.";
    ...
    if ($this->si179_totaldebitoscr == null) {
      $this->erro_sql = " Campo si179_totaldebitoscr n�o informado.";
    ...
    if ($this->si179_totalcreditoscr == null) {
      $this->erro_sql = " Campo si179_totalcreditoscr n�o informado.";
    ...
    if ($this->si179_saldofinalcr == null) {
      $this->erro_sql = " Campo si179_saldofinalcr n�o informado.";
    ...
    if ($this->si179_naturezasaldofinalcr == null) {
      $this->erro_sql = " Campo si179_naturezasaldofinalcr n�o informado.";
    ...
    if ($this->si179_mes == null) {
      $this->erro_sql = " Campo si179_mes n�o informado.";
    ...
    if ($this->si179_instit == null) {
      $this->erro_sql = " Campo si179_instit n�o informado.";
    ...
    if ($si179_sequencial == "" || $si179_sequencial == null) {
      $result = db_query("select nextval('balancete122025_si179_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete122025_si179_sequencial_seq do campo: si179_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete122025_si179_sequencial_seq");
    ...
    $sql = "insert into balancete122025(
                                       si179_sequencial
                                      ,si179_tiporegistro
                                      ,si179_contacontabil
                                      ,si179_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete122025 ($this->si179_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete122025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete122025 ($this->si179_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete122025 set ";
    $virgula = "";
    if (trim($this->si179_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si179_sequencial"])) {
      ...
      if (trim($this->si179_sequencial) == null) {
        $this->erro_sql = " Campo si179_sequencial n�o informado.";
    ...
    if (trim($this->si179_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si179_codfundo"])) {
      ...
      if (trim($this->si179_codfundo) == null) {
        $this->erro_sql = " Campo si179_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete122025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si179_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete122025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si179_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si179_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete122025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si179_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete122025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete122025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si179_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete122025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si179_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete122025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si179_sequencial != null) {
        $sql2 .= " where balancete122025.si179_sequencial = $si179_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
