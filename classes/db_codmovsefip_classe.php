...
class cl_codmovsefip { 
   ...
   var $campos = "
                 r66_anousu = float4 = Ano do Exercício 
                 r66_mesusu = float4 = Mês do Exercício 
                 r66_codigo = varchar(2) = Código da Movimentação 
                 r66_descr = varchar(40) = Descrição 
   ...
   function incluir ($r66_anousu,$r66_mesusu,$r66_codigo){ 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Movimentações da Sefip ($this->r66_anousu."-".$this->r66_mesusu."-".$this->r66_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Movimentações da Sefip já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Movimentações da Sefip ($this->r66_anousu."-".$this->r66_mesusu."-".$this->r66_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($r66_anousu=null,$r66_mesusu=null,$r66_codigo=null) { 
     ...
     if(trim($this->r66_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["r66_codigo"])){ 
       ...
       if(trim($this->r66_codigo) == null ){ 
         $this->erro_sql = " Campo Código da Movimentação nao Informado.";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimentações da Sefip nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->r66_anousu."-".$this->r66_mesusu."-".$this->r66_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Movimentações da Sefip nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->r66_anousu."-".$this->r66_mesusu."-".$this->r66_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($r66_anousu=null,$r66_mesusu=null,$r66_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Movimentações da Sefip nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Movimentações da Sefip nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$r66_anousu."-".$r66_mesusu."-".$r66_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
