...
class cl_saltescontrapartida { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->k103_sequencial = ($this->k103_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k103_sequencial"]:$this->k103_sequencial);
       $this->k103_saltes = ($this->k103_saltes == ""?@$GLOBALS["HTTP_POST_VARS"]["k103_saltes"]:$this->k103_saltes);
       $this->k103_contrapartida = ($this->k103_contrapartida == ""?@$GLOBALS["HTTP_POST_VARS"]["k103_contrapartida"]:$this->k103_contrapartida);
     }else{
       $this->k103_sequencial = ($this->k103_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k103_sequencial"]:$this->k103_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($k103_sequencial){ 
      $this->atualizacampos();
     if($this->k103_saltes == null ){ 
     ...
     if($this->k103_contrapartida == null ){ 
     ...
     if($k103_sequencial == "" || $k103_sequencial == null ){
       $result = db_query("select nextval('saltescontrapartida_k103_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: saltescontrapartida_k103_sequencial_seq do campo: k103_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $k103_sequencial)){
         ...
         $this->k103_sequencial = $k103_sequencial; 
       }
     }
     if(($this->k103_sequencial == null) || ($this->k103_sequencial == "") ){ 
       $this->erro_sql = " Campo k103_sequencial nao declarado.";
     ...
     $sql = "insert into saltescontrapartida(
                                       k103_sequencial 
                                      ,k103_saltes 
                                      ,k103_contrapartida 
                       )
                values (
                                $this->k103_sequencial 
                               ,$this->k103_saltes 
                               ,$this->k103_contrapartida 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k103_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($k103_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($k103_sequencial!=null){
       $sql .= " k103_sequencial = $this->k103_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->k103_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Contrapartida da conta nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k103_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Contrapartida da conta nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k103_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k103_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($k103_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($k103_sequencial != ""){
          ...
          $sql2 .= " k103_sequencial = $k103_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Contrapartida da conta nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$k103_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Contrapartida da conta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k103_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $k103_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from saltescontrapartida ";
     $sql .= "      inner join saltes  on  saltes.k13_conta = saltescontrapartida.k103_saltes";
     $sql2 = "";
     if($dbwhere==""){
       if($k103_sequencial!=null ){
         $sql2 .= " where saltescontrapartida.k103_sequencial = $k103_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   function sql_query_contrapartida ( $k103_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from saltescontrapartida ";
     $sql .= "      inner join saltes  on  saltes.k13_conta = saltescontrapartida.k103_contrapartida";
     $sql2 = "";
     if($dbwhere==""){
       if($k103_sequencial!=null ){
         $sql2 .= " where saltescontrapartida.k103_sequencial = $k103_sequencial "; 
