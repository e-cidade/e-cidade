<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos102020
class cl_contratos102020 {
  ...
  // cria propriedade com as variaveis do arquivo
   ...
   function cl_contratos102020() {
     ...
     $this->rotulo = new rotulo("contratos102020");
   ...
   function incluir ($si83_sequencial){
     ...
     if($si83_sequencial == "" || $si83_sequencial == null ){
       $result = db_query("select nextval('contratos102020_si83_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos102020_si83_sequencial_seq do campo: si83_sequencial";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos102020_si83_sequencial_seq");
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos102020 ($this->si83_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos102020 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos102020 ($this->si83_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si83_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos102020 set ";
     $virgula = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("","",@pg_last_error());
       $this->erro_sql   = "contratos102020 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si83_sequencial;
       $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos102020 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si83_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si83_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos102020
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si83_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("","",@pg_last_error());
       $this->erro_sql   = "contratos102020 nao Excluído. Exclusão Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos102020 nao Encontrado. Exclusão não Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si83_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos102020";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si83_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contratos102020 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si83_sequencial!=null ){
         $sql2 .= " where contratos102020.si83_sequencial = $si83_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
