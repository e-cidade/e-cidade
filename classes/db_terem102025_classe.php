<?
//MODULO: sicom
//CLASSE DA ENTIDADE terem102025
class cl_terem102025 {
  ...
  var $campos = "
                 ...
                 si194_codteto = int8 = C�digo do Teto
                 si194_vlrparateto = float8 = Valor para o teto
                 si194_tipocadastro = int8 = Tipo de cadastro
                 si194_dtinicial = date = Data Inicial

                 si194_nrleiteto = int8 = N�mero da lei do teto
                 si194_dtpublicacaolei = date = Data da publica��o

                 si194_dtfinal = date = Data Final
                 si194_justalteracao = varchar(100) = Justificativa para a altera��o
                 si194_mes = int8 = si194_mes
                 si194_inst = int8 = si194_inst
                 ";
  //funcao construtor da classe
  function cl_terem102025() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("terem102025");
  ...
  function atualizacampos($exclusao=false) {
    if($exclusao==false){
      ...
      $this->si194_codteto = ($this->si194_codteto == ""?@$GLOBALS["HTTP_POST_VARS"]["si194_codteto"]:$this->si194_codteto);
  ...
  function incluir ($si194_sequencial){
    ...
    if($this->si194_cnpj == null ){
      $this->erro_sql = " Campo CNPJ n�o informado.";
    ...
    if($this->si194_codteto == null ){
      $this->erro_sql = " Campo C�digo do Teto n�o informado.";
      $this->erro_campo = "si194_codteto";
      $this->erro_banco = "";
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
    ...
    if($this->si194_dtinicial == null ){
      ...
      if($this->si194_nrleiteto == null ){
          $this->erro_sql = " Campo nro lei n�o informado.";
      ...
      if($this->si194_dtpublicacaolei == null ){
          $this->erro_sql = " Campo Data publicacao da lei n�o informado.";
...
//    }
    ...
    if($this->si194_mes == null ){
      $this->erro_sql = " Campo si194_mes n�o informado.";
    ...
    if($this->si194_inst == null ){
      $this->erro_sql = " Campo si194_inst n�o informado.";
    ...
    if($si194_sequencial == "" || $si194_sequencial == null ){
      $result = db_query("select nextval('terem102025_si194_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("
","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: terem102025_si194_sequencial_seq do campo: si194_sequencial";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from terem102025_si194_sequencial_seq");
      if(($result != false) && (pg_result($result,0,0) < $si194_sequencial)){
        $this->erro_sql = " Campo si194_sequencial maior que �ltimo n�mero da sequencia.";
...
","",@pg_last_error());
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "terem102025 ($this->si194_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_banco = "terem102025 j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      }else{
        $this->erro_sql   = "terem102025 ($this->si194_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
  ...
  function alterar ($si194_sequencial=null) {
    ...
    if(trim($this->si194_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si194_sequencial"])){
      ...
      if(trim($this->si194_sequencial) == null ){
        $this->erro_sql = " Campo si194_sequencial n�o informado.";
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "terem102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : ".$this->si194_sequencial;
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "terem102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : ".$this->si194_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
  ...
  function excluir ($si194_sequencial=null,$dbwhere=null) {
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "terem102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "terem102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : ".$si194_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
...
","",@pg_last_error());
    ...
    if($this->numrows==0){
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:terem102025";
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si194_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    $sql .= " from terem102025 ";
    $sql2 = "";
    if($dbwhere==""){
      if($si194_sequencial!=null ){
        $sql2 .= " where terem102025.si194_sequencial = $si194_sequencial ";
      }
    }else if($dbwhere != ""){
      $sql2 = " where $dbwhere";
    }
