<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete182025
class cl_balancete182025
{
  ...
  var $campos = "
                 ...
                 si185_codfundo = varchar(8) = si185_codfundo
  ...
  function cl_balancete182025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete182025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si185_codfundo = ($this->si185_codfundo == "" ? @$GLOBALS["HTTP_POST_VARS"]["si185_codfundo"] : $this->si185_codfundo);
  ...
  function incluir($si185_sequencial)
  {
    ...
    if ($this->si185_tiporegistro == null) {
      $this->erro_sql = " Campo si185_tiporegistro n�o informado.";
    ...
    if ($this->si185_contacontabil == null) {
      $this->erro_sql = " Campo si185_contacontabil n�o informado.";
    ...
    if ($this->si185_codfontrecursos == null) {
      $this->erro_sql = " Campo si185_codfontrecursos n�o informado.";
    ...
    if ($this->si185_saldoinicialfr == null) {
      $this->erro_sql = " Campo si185_saldoinicialfr n�o informado.";
    ...
    if ($this->si185_naturezasaldoinicialfr == null) {
      $this->erro_sql = " Campo si185_naturezasaldoinicialfr n�o informado.";
    ...
    if ($this->si185_totaldebitosfr == null) {
      $this->erro_sql = " Campo si185_totaldebitosfr n�o informado.";
    ...
    if ($this->si185_totalcreditosfr == null) {
      $this->erro_sql = " Campo si185_totalcreditosfr n�o informado.";
    ...
    if ($this->si185_saldofinalfr == null) {
      $this->erro_sql = " Campo si185_saldofinalfr n�o informado.";
    ...
    if ($this->si185_naturezasaldofinalfr == null) {
      $this->erro_sql = " Campo si185_naturezasaldofinalfr n�o informado.";
    ...
    if ($this->si185_mes == null) {
      $this->erro_sql = " Campo si185_mes n�o informado.";
    ...
    if ($this->si185_instit == null) {
      $this->erro_sql = " Campo si185_instit n�o informado.";
    ...
    if ($si185_sequencial == "" || $si185_sequencial == null) {
      $result = db_query("select nextval('balancete182025_si185_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete182025_si185_sequencial_seq do campo: si185_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete182025_si185_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si185_sequencial)) {
        $this->erro_sql = " Campo si185_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete182025(
                                       si185_sequencial
                                      ,si185_tiporegistro
                                      ,si185_contacontabil
                                      ,si185_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete182025 ($this->si185_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete182025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete182025 ($this->si185_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete182025 set ";
    $virgula = "";
    if (trim($this->si185_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si185_sequencial"])) {
      ...
      if (trim($this->si185_sequencial) == null) {
        $this->erro_sql = " Campo si185_sequencial n�o informado.";
    ...
    if (trim($this->si185_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si185_codfundo"])) {
      $sql .= $virgula . " si185_codfundo = '$this->si185_codfundo' ";
      $virgula = ",";
      if (trim($this->si185_codfundo) == null) {
        $this->erro_sql = " Campo si185_codfundo n�o informado.";
        $this->erro_campo = "si185_codfundo";
        $this->erro_banco = "";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete182025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si185_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete182025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si185_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si185_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete182025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si185_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete182025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete182025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si185_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete182025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si185_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete182025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si185_sequencial != null) {
        $sql2 .= " where balancete182025.si185_sequencial = $si185_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
