...
class cl_exemplar {
   ...
   var $campos = "
                 bi23_codigo = int8 = Código do Exemplar
   ...
   function incluir ($bi23_codigo){
     ...
     if($this->bi23_codbarras == null ){
       $this->erro_sql = " Campo Cód. Barras nao Informado.";
     ...
     if($this->bi23_aquisicao == null ){
       $this->erro_sql = " Campo Tipo de Aquisição nao Informado.";
     ...
     if(($this->bi23_codigo == null) || ($this->bi23_codigo == "") ){
       $this->erro_sql = " Campo bi23_codigo nao declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastro de Exemplares dos Acervos ($this->bi23_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($bi23_codigo=null) {
      $this->atualizacampos();
     ...
     if(trim($this->bi23_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi23_codigo"])){
       ...
       if(trim($this->bi23_codigo) == null ){
         $this->erro_sql = " Campo Código do Exemplar nao Informado.";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_codigo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_acervo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_codbarras"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_aquisicao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_dataaquisicao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["bi23_situacao"]))
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de Exemplares dos Acervos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi23_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de Exemplares dos Acervos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi23_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($bi23_codigo=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de Exemplares dos Acervos nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de Exemplares dos Acervos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$bi23_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $bi23_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
   ...
   function sql_query_file ( $bi23_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
