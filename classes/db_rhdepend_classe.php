...
class cl_rhdepend
{
    ...
    function atualizacampos($exclusao = false)
    {
        if ($exclusao == false) {
            ...
            $this->rh31_sexo = ($this->rh31_sexo == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh31_sexo"] : $this->rh31_sexo);
        } else {
            $this->rh31_codigo = ($this->rh31_codigo == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh31_codigo"] : $this->rh31_codigo);
        }
    }
    ...
    function incluir($rh31_codigo)
    {
        ...
        if ($this->rh31_regist == null) {
            $this->erro_sql = " Campo MatrÃ­cula do Servidor nao Informado.";
        ...
        if ($this->rh31_depend == null) {
            $this->erro_sql = " Campo SalÃ¡rio FamÃ­lia nao Informado.";
        ...
        if ($this->rh31_cpf == null && $this->rh31_irf != 0) {
        ...
        if ($rh31_codigo == "" || $rh31_codigo == null) {
            ...
            if ($result == false) {
                ...
                $this->erro_sql   = "Verifique o cadastro da sequência: rhdepend_rh31_codigo_seq do campo: rh31_codigo";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "0";
                return false;
            ...
            if (($result != false) && (pg_result($result, 0, 0) < $rh31_codigo)) {
                $this->erro_sql = " Campo rh31_codigo maior que Último número da sequência.";
                $this->erro_banco = "Sequência menor que este número.";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "0";
                return false;
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql   = "Dependentes ($this->rh31_codigo) nao IncluÃ­do. Inclusao Abortada.";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_banco = "Dependentes jÃ¡ Cadastrado";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            } else {
                $this->erro_sql   = "Dependentes ($this->rh31_codigo) nao IncluÃ­do. Inclusao Abortada.";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    function alterar($rh31_codigo = null)
    {
        ...
        if (trim($this->rh31_sexo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh31_sexo"])) {
            $sql  .= $virgula . " rh31_sexo = '$this->rh31_sexo' ";
            $virgula = ",";
            if (trim($this->rh31_sexo) == null) {
                $this->erro_sql = " Campo Sexo não Informado.";
                $this->erro_campo = "rh31_sexo";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "0";
    ...
    function excluir($rh31_codigo = null, $dbwhere = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Dependentes nao ExcluÃ­do. ExclusÃ£o Abortada.\\n";
