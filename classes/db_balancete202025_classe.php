<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete202025
class cl_balancete202025
{
  ...
  function cl_balancete202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete202025");
  ...
  function incluir($si187_sequencial)
  {
    ...
    if ($this->si187_tiporegistro == null) {
      $this->erro_sql = " Campo si187_tiporegistro n�o informado.";
    ...
    if ($this->si187_contacontabil == null) {
      $this->erro_sql = " Campo si187_contacontabil n�o informado.";
    ...
    if ($this->si187_cnpjconsorcio == null) {
      $this->erro_sql = " Campo si187_cnpjconsorcio n�o informado.";
    ...
    if ($this->si187_tiporecurso == null) {
      $this->erro_sql = " Campo si187_tiporecurso n�o informado.";
    ...
    if ($this->si187_codfuncao == null) {
      $this->erro_sql = " Campo si187_codfuncao n�o informado.";
    ...
    if ($this->si187_codsubfuncao == null) {
      $this->erro_sql = " Campo si187_codsubfuncao n�o informado.";
    ...
    if ($this->si187_naturezadespesa == null) {
      $this->erro_sql = " Campo si187_naturezadespesa n�o informado.";
    ...
    if ($this->si187_subelemento == null) {
      $this->erro_sql = " Campo si187_subelemento n�o informado.";
    ...
    if ($this->si187_codfontrecursos == null) {
      $this->erro_sql = " Campo si187_codfontrecursos n�o informado.";
    ...
    if ($this->si187_saldoinicialconscf == null) {
      $this->erro_sql = " Campo si187_saldoinicialconscf n�o informado.";
    ...
    if ($this->si187_naturezasaldoinicialconscf == null) {
      $this->erro_sql = " Campo si187_naturezasaldoinicialconscf n�o informado.";
    ...
    if ($this->si187_totaldebitosconscf == null) {
      $this->erro_sql = " Campo si187_totaldebitosconscf n�o informado.";
    ...
    if ($this->si187_totalcreditosconscf == null) {
      $this->erro_sql = " Campo si187_totalcreditosconscf n�o informado.";
    ...
    if ($this->si187_saldofinalconscf == null) {
      $this->erro_sql = " Campo si187_saldofinalconscf n�o informado.";
    ...
    if ($this->si187_naturezasaldofinalconscf == null) {
      $this->erro_sql = " Campo si187_naturezasaldofinalconscf n�o informado.";
    ...
    if ($this->si187_mes == null) {
      $this->erro_sql = " Campo si187_mes n�o informado.";
    ...
    if ($this->si187_instit == null) {
      $this->erro_sql = " Campo si187_instit n�o informado.";
    ...
    if($si187_sequencial == "" || $si187_sequencial == null ){
      $result = db_query("select nextval('balancete202025_si187_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("
","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: balancete202025_si187_sequencial_seq do campo: si187_sequencial";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from balancete202025_si187_sequencial_seq");
      if(($result != false) && (pg_result($result,0,0) < $si187_sequencial)){
        $this->erro_sql = " Campo si187_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete202025(
                                       si187_sequencial
                                      ,si187_tiporegistro
                                      ,si187_contacontabil
                                      ,si187_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete202025 ($this->si187_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete202025 ($this->si187_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete202025 set ";
    $virgula = "";
    if (trim($this->si187_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si187_sequencial"])) {
      ...
      if (trim($this->si187_sequencial) == null) {
        $this->erro_sql = " Campo si187_sequencial n�o informado.";
    ...
    if (trim($this->si187_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si187_codfundo"])) {
      ...
      if (trim($this->si187_codfundo) == null) {
        $this->erro_sql = " Campo si187_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si187_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si187_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si187_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete202025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si187_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si187_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si187_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete202025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si187_sequencial != null) {
        $sql2 .= " where balancete202025.si187_sequencial = $si187_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
