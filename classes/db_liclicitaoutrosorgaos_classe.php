...
class cl_liclicitaoutrosorgaos { 
  ...
  function incluir ($lic211_sequencial) { 
     ...
     if ($this->lic211_orgao == null ) { 
       $this->erro_sql = " Campo Orgao Responsavel não informado.";
     ...
     if ($this->lic211_processo == null ) { 
       $this->erro_sql = " Campo Numero do Processo não informado.";
     ...
     if ($this->lic211_numero == null ) { 
       $this->erro_sql = " Campo Numedo da Modalidade não informado.";
     ...
     if ($this->lic211_anousu == null ) { 
       $this->erro_sql = " Campo Ano da Licitacao não informado.";
     ...
     if ($this->lic211_tipo == null ) {
       $this->erro_sql = " Campo Tipo de Licitacao não informado.";
     ...
     if ($lic211_sequencial == "" || $lic211_sequencial == null ) {
       ...
       if (($result != false) && (pg_result($result,0,0) < $lic211_sequencial)) {
         $this->erro_sql = " Campo lic211_sequencial maior que último número da sequencia.";
     ...
     if ($result==false) { 
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "licitacoes de outros orgaos ($this->lic211_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "licitacoes de outros orgaos já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "licitacoes de outros orgaos ($this->lic211_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($lic211_sequencial=null) { 
     ...
     if (trim($this->lic211_codorgaoresplicit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["lic211_codorgaoresplicit"]) && ($this->lic211_tipo != 7 && $this->lic211_tipo != 8 && $this->lic211_tipo != 9)) {
       ...
       if (trim($this->lic211_codorgaoresplicit) == null ) {
         $this->erro_sql = " Campo CodOrgaoRespLicit não informado.";
         $this->erro_campo = "lic211_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     ...
     if (trim($this->lic211_codunisubres)!="" || isset($GLOBALS["HTTP_POST_VARS"]["lic211_codunisubres"]) && ( $this->lic211_tipo != 8 && $this->lic211_tipo != 9)) {
       ...
       if (trim($this->lic211_codunisubres) == null ) {
         $this->erro_sql = " Campo CodUnidadeSubResp não informado.";
         $this->erro_campo = "lic211_tipo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
...
//     }
     ...
     if ($result==false) { 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "licitacoes de outros orgaos nao Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "licitacoes de outros orgaos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$lic211_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
