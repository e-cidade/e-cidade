...
class cl_pctipocompranumero { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->pc51_codtipocom = ($this->pc51_codtipocom == ""?@$GLOBALS["HTTP_POST_VARS"]["pc51_codtipocom"]:$this->pc51_codtipocom);
       $this->pc51_anonumer = ($this->pc51_anonumer == ""?@$GLOBALS["HTTP_POST_VARS"]["pc51_anonumer"]:$this->pc51_anonumer);
       $this->pc51_numeracao = ($this->pc51_numeracao == ""?@$GLOBALS["HTTP_POST_VARS"]["pc51_numeracao"]:$this->pc51_numeracao);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     $sql = "insert into pctipocompranumero(
                                       pc51_codtipocom 
                                      ,pc51_anonumer 
                                      ,pc51_numeracao 
                       )
                values (
                                $this->pc51_codtipocom 
                               ,$this->pc51_anonumer 
                               ,$this->pc51_numeracao 
                      )";
     $result = db_query($sql); 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "pctipocompranumero nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from pctipocompranumero
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "pctipocompranumero nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "pctipocompranumero nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="pctipocompranumero.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from pctipocompranumero ";
     $sql .= "      inner join pctipocompra  on  pctipocompra.pc50_codcom = pctipocompranumero.pc51_codtipocom";
     $sql2 = "";
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where pctipocompranumero.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
