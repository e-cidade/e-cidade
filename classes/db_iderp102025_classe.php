<?php
//MODULO: sicom
//CLASSE DA ENTIDADE iderp102025
class cl_iderp102025 {
  ...
  public $campos = "
                 ...
                 si179_codiderp = int8 = C�digo identificador dos  restos a pagar
                 si179_codorgao = varchar(2) = C�digo do �rg�o
                 si179_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si179_nroempenho = int8 = N�mero do empenho
                 si179_tiporestospagar = int8 = Tipo de restos a pagar
                 si179_disponibilidadecaixa = int8 = Situa��o dos restos a pagar
                 si179_vlinscricao = float8 = Valor da inscri��o de restos a pagar
                 si179_mes = int8 = M�s
                 si179_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("iderp102025");
  ...
  function incluir ($si179_sequencial) {
     ...
     if ($this->si179_codiderp == null ) {
       $this->erro_sql = " Campo C�digo identificador dos  restos a pagar n�o informado.";
     ...
     if ($this->si179_tiporestospagar == null ) {
       $this->erro_sql = " Campo Tipo de restos a pagar n�o informado.";
     ...
     if ($this->si179_disponibilidadecaixa == null ) {
       $this->erro_sql = " Campo Situa��o dos restos a pagar n�o informado.";
     ...
     if ($this->si179_vlinscricao == null ) {
       $this->erro_sql = " Campo Valor da inscri��o de restos a pagar n�o informado.";
     ...
     if ($si179_sequencial == "" || $si179_sequencial == null ) {
       $result = db_query("select nextval('iderp102025_si179_sequencial_seq')");
       if ($result==false) {
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: iderp102025_si179_sequencial_seq do campo: si179_sequencial";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from iderp102025_si179_sequencial_seq");
       if (($result != false) && (pg_result($result,0,0) < $si179_sequencial)) {
         $this->erro_sql = " Campo si179_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Inscri��o de Despesas do Exerc�cio em Restos a Pag ($this->si179_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Inscri��o de Despesas do Exerc�cio em Restos a Pag j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Inscri��o de Despesas do Exerc�cio em Restos a Pag ($this->si179_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Inscri��o de Despesas do Exerc�cio em Restos a Pag nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si179_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Inscri��o de Despesas do Exerc�cio em Restos a Pag nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si179_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Inscri��o de Despesas do Exerc�cio em Restos a Pag nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Inscri��o de Despesas do Exerc�cio em Restos a Pag nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si179_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:iderp102025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si179_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from iderp102025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si179_sequencial!=null ) {
         $sql2 .= " where iderp102025.si179_sequencial = $si179_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
