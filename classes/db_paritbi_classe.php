...
class cl_paritbi {
   ...
   var $it24_inclusaoautomaticapromitente = 'f';
   var $it24_proced = 0;
   var $it24_devedor = 0;
   ...
   var $campos = "
                 ...
                 it24_inclusaoautomaticapromitente = bool = Inclusão automatica do promitente do imovel
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->it24_inclusaoautomaticapromitente = ($this->it24_inclusaoautomaticapromitente == "f"?@$GLOBALS["HTTP_POST_VARS"]["it24_inclusaoautomaticapromitente"]:$this->it24_inclusaoautomaticapromitente);
   ...
   function incluir ($it24_anousu){
     ...
     if($this->it24_inclusaoautomaticapromitente == null ){
       $this->erro_sql = " Campo Inclusão Automatica do Promitente não informado.";
       $this->erro_campo = "it24_inclusaoautomaticapromitente";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $sql = "insert into paritbi(
                                      ...
                                      ,it24_inclusaoautomaticapromitente
                ...
                values (
                               ...
                               ,'$this->it24_inclusaoautomaticapromitente'
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,2362,20656,'','".AddSlashes(pg_result($resaco,0,'it24_inclusaoautomaticapromitente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($it24_anousu=null) {
     ...
     if(trim($this->it24_proced)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it24_proced"])){
     ...
     if(trim($this->it24_inclusaoautomaticapromitente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["it24_inclusaoautomaticapromitente"])){
       $sql  .= $virgula." it24_inclusaoautomaticapromitente = '$this->it24_inclusaoautomaticapromitente' ";
       $virgula = ",";
       if(trim($this->it24_inclusaoautomaticapromitente) == null ){
         $this->erro_sql = " Campo Inclusao Automática do Promitente não informado.";
         $this->erro_campo = "it24_inclusaoautomaticapromitente";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if($this->numrows>0){
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["it24_transfautomatica"]) || $this->it24_transfautomatica != "")
           ...
           if(isset($GLOBALS["HTTP_POST_VARS"]["it24_inclusaoautomaticapromitente"]) || $this->it24_inclusaoautomaticapromitente != "")
             $resac = db_query("insert into db_acount values($acount,2362,20656,'".AddSlashes(pg_result($resaco,$conresaco,'it24_inclusaoautomaticapromitente'))."','$this->it24_inclusaoautomaticapromitente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
