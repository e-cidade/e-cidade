<?php
//MODULO: sicom
//CLASSE DA ENTIDADE licobras302025
class cl_licobras302025 {
    ...
    function __construct() {
        ...
        $this->rotulo = new rotulo("licobras302025");
    ...
    function incluir () {
        ...
        if ($this->si203_sequencial == null ) {
            $result = db_query("select nextval('licobras302025_si203_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: licobras302025_si203_sequencial_seq do campo: si203_sequencial";
        ...
        if ($this->si203_codobra == null ) {
            $this->erro_sql = " Campo codigo da obra n�o informado.";
        ...
        if ($this->si203_codunidadesubrespestadual == null ) {
            $this->erro_sql = " Campo cod unidade sub resp estadual n�o informado.";
        ...
        if ($this->si203_nroseqtermoaditivo == null ) {
            $this->erro_sql = " Campo numero sequencial termo aditivo n�o informado.";
        ...
        if ($this->si203_dataassinaturatermoaditivo == null ) {
            $this->erro_sql = " Campo data assinatura do termo aditivo n�o informado.";
        ...
        if ($this->si203_tipoalteracaovalor == null ) {
            $this->erro_sql = " Campo Tipo alteracao valor n�o informado.";
        ...
        if ($this->si203_tipotermoaditivo == null ) {
            $this->erro_sql = " Campo tipo termo aditivo n�o informado.";
        ...
        $sql = "insert into licobras302025(
                                       si203_sequencial
                                      ,si203_tiporegistro
                                      ,si203_codorgaoresp
                                      ,si203_codobra
    ...
    function excluir ( $si203_sequencial=null ,$dbwhere=null) {
        ...
        $sql = " delete from licobras302025
                    where ";
        $sql2 = "";
    ...
    function sql_record($sql) {
        ...
        if ($this->numrows==0) {
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:licobras302025";
            $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si203_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
        ...
        $sql .= " from licobras302025 ";
        $sql2 = "";
        if ($dbwhere=="") {
            if ( $si203_sequencial != "" && $si203_sequencial != null) {
                $sql2 = " where licobras302025.si203_sequencial = '$si203_sequencial'";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
