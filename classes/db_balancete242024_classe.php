<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete242024
class cl_balancete242024
{
  ...
  function cl_balancete242024()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete242024");
  ...
  function incluir()
  {
    ...
    $sql = "insert into balancete242024(
                                       si191_sequencial
                                      ,si191_tiporegistro
                                      ,si191_contacontabil
                                      ,si191_codfundo
                ...
                values (
                                nextval('balancete242024_si191_sequencial_seq')
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete242024 () nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete242024 já Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete242024 () nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete242024 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete242024 nao Alterado. Alteracao Abortada.\n";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete242024 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si191_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete242024
                    where ";
    $sql2 = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete242024 nao Excluído. Exclusão Abortada.\n";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete242024 nao Encontrado. Exclusão não Efetuada.\n";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
";
  ...
  // funcao do sql
  function sql_query($oid = null, $campos = "balancete242024.oid,*", $ordem = null, $dbwhere = "")
  {
    $sql = "select ";
    if ($campos != "*") {
    ...
    $sql .= " from balancete242024 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($oid != "" && $oid != null) {
        $sql2 = " where balancete242024.oid = $oid";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
