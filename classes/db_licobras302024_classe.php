<?php
//MODULO: sicom
//CLASSE DA ENTIDADE licobras302024
class cl_licobras302024 {
    ...
    function __construct() {
        ...
        $this->rotulo = new rotulo("licobras302024");
    ...
    function incluir () {
        ...
        if ($this->si203_sequencial == null ) {
            $result = db_query("select nextval('licobras302024_si203_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: licobras302024_si203_sequencial_seq do campo: si203_sequencial";
    ...
    function excluir ( $si203_sequencial=null ,$dbwhere=null) {
        ...
        $sql = " delete from licobras302024
                    where ";
        $sql2 = "";
    ...
    function sql_record($sql) {
        ...
        if ($this->numrows==0) {
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:licobras302024";
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si203_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
        ...
        $sql .= " from licobras302024 ";
        $sql2 = "";
        if ($dbwhere=="") {
            if ( $si203_sequencial != "" && $si203_sequencial != null) {
                $sql2 = " where licobras302024.si203_sequencial = '$si203_sequencial'";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
