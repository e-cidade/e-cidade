<?
//MODULO: sicom
//CLASSE DA ENTIDADE aberlic102025
class cl_aberlic102025
{
  ...
  var $campos = "
                 ...
                 si46_codorgaoresp = varchar(2) = C�digo do �rg�o
                 si46_codunidadesubresp = varchar(8) = C�digo da unidade
                 si46_exerciciolicitacao = int8 = Exerc�cio
                 si46_exercicioedital = int8 = Exerc�cio Edital
                 si46_nroprocessolicitatorio = varchar(12) = N�mero sequencial do processo
                 si46_codmodalidadelicitacao = int8 = Modalidade da Licita��o
                 si46_nroedital = int8 = N�mero sequencial do edital por exerc�cio
                 si46_naturezaprocedimento = int8 = Natureza do Procedimento
                 si46_dtabertura = date = Data de abertura
                 si46_dteditalconvite = date = Data de emiss�o
                 si46_dtpublicacaoeditaldo = date = Data de publica��o do edital
                 si46_dtpublicacaoeditalveiculo1 = date = Data de Publica��o do edital no ve�culo
                 si46_veiculo1publicacao = varchar(50) = Nome do ve�culo   de divulga��o
                 si46_dtpublicacaoeditalveiculo2 = date = Data de Publica��o    do edital
                 si46_veiculo2publicacao = varchar(50) = Nome do ve�culo
                 si46_dtrecebimentodoc = date = Data prevista para  recebimento
                 si46_tipolicitacao = int8 = Tipo de licita��o
                 si46_naturezaobjeto = int8 = Natureza do objeto
                 si46_objeto = varchar(1000) = Objeto da licita��o
                 si46_regimeexecucaoobras = int8 = Regime de  execu��o para    obras
                 si46_nroconvidado = int8 = N�mero de   convidados
                 si46_clausulaprorrogacao = varchar(250) = se  existente a  cl�usula de   prorroga��o
                 si46_unidademedidaprazoexecucao = int8 = Unidade de medida
                 si46_prazoexecucao = int8 = Prazo para entrega  do objeto
                 si46_formapagamento = varchar(80) = Descri��o da forma    de pagamento
                 si46_criterioaceitabilidade = varchar(80) = Descri��o do crit�rio de aceitabilidade
                 si46_criterioadjudicacao = int8 = Informar crit�rio de adjudica��o
                 si46_processoporlote = int8 = Informar
                 si46_criteriodesempate = int8 = Licita��o com    prefer�ncia
                 si46_destinacaoexclusiva = int8 = Destina��o exclusiva
                 si46_subcontratacao = int8 = Subcontrata��o
                 si46_limitecontratacao = int8 = Limite para a  contrata��o
                 si46_mes = int8 = M�s
                 si46_instit = int8 = Institui��o
                 si46_leidalicitacao = int8 = Lei da Licitaca��o
                 ...
                 si46_diariooficialdivulgacao = int8 = Di�rio Oficla de Divulga��o
                 si46_mododisputa = Modo Disputa
                 si46_codunidadesubedital = int = codunidadesubedital
                 ";

  //funcao construtor da classe
  function cl_aberlic102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("aberlic102025");
  ...
  function incluir($si46_sequencial)
  {
    ...
    if ($si46_sequencial == "" || $si46_sequencial == null) {
      $result = db_query("select nextval('aberlic102025_si46_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: aberlic102025_si46_sequencial_seq do campo: si46_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from aberlic102025_si46_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si46_sequencial)) {
        $this->erro_sql = " Campo si46_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aberlic102025 ($this->si46_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aberlic102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aberlic102025 ($this->si46_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si46_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si46_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si46_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si46_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si46_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:aberlic102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si46_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from aberlic102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si46_sequencial != null) {
        $sql2 .= " where aberlic102025.si46_sequencial = $si46_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
