<?
	//MODULO: sicom
	//CLASSE DA ENTIDADE balancete272025
	class cl_balancete272025
	{
		...
		function cl_balancete272025()
		{
			//classes dos rotulos dos campos
			$this->rotulo = new rotulo("balancete272025");
		...
		function incluir($si197_sequencial)
		{
			...
			if ($this->si197_tiporegistro == null) {
				$this->erro_sql = " Campo si197_tiporegistro n�o informado.";
			...
			if ($this->si197_contacontabil == null) {
				$this->erro_sql = " Campo si197_contacontabil n�o informado.";
			...
			if ($this->si197_tipodocumentooufontesf == null) {
				$this->erro_sql = " Campo si197_tipodocumentooufontesf n�o informado.";
			...
			if ($this->si197_nrodocumentooufontesf == null) {
				$this->erro_sql = " Campo si197_nrodocumentooufontesf n�o informado.";
			...
			if ($this->si197_atributosf == null) {
				$this->erro_sql = " Campo si197_atributosf n�o informado.";
			...
			if ($this->si197_saldoinicialoufontesf == null) {
				$this->erro_sql = " Campo si197_saldoinicialoufontesf n�o informado.";
			...
			if ($this->si197_naturezasaldoinicialoufontesf == null) {
				$this->erro_sql = " Campo si197_naturezasaldoinicialoufontesf n�o informado.";
			...
			if ($this->si197_totaldebitosoufontesf == null) {
				$this->erro_sql = " Campo si197_totaldebitosoufontesf n�o informado.";
			...
			if ($this->si197_totalcreditosoufontesf == null) {
				$this->erro_sql = " Campo si197_totalcreditosoufontesf n�o informado.";
			...
			if ($this->si197_saldofinaloufontesf == null) {
				$this->erro_sql = " Campo si197_saldofinaloufontesf n�o informado.";
			...
			if ($this->si197_naturezasaldofinaloufontesf == null) {
				$this->erro_sql = " Campo si197_naturezasaldofinaloufontesf n�o informado.";
			...
			if ($this->si197_instit == null) {
				$this->erro_sql = " Campo si197_instit n�o informado.";
			...
			if ($si197_sequencial == "" || $si197_sequencial == null) {
				$result = db_query("select nextval('balancete272025_si197_sequencial_seq')");
				if ($result == false) {
					$this->erro_banco = str_replace("
", "", @pg_last_error());
					$this->erro_sql = "Verifique o cadastro da sequencia: balancete272025_si197_sequencial_seq do campo: si197_sequencial";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "0";
				...
				$result = db_query("select last_value from balancete272025_si197_sequencial_seq");
			...
			$sql = "insert into balancete272025(
                                       si197_sequencial
                                      ,si197_tiporegistro
                                      ,si197_contacontabil
                                      ,si197_codfundo
...
", "", @pg_last_error());
				if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
					$this->erro_sql = "balancete272025 ($this->si197_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_banco = "balancete272025 j� Cadastrado";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				} else {
					$this->erro_sql = "balancete272025 ($this->si197_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
		...
		{
			$this->atualizacampos();
			$sql = " update balancete272025 set ";
			$virgula = "";
			...
			if (trim($this->si197_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si197_codfundo"])) {
				...
				if (trim($this->si197_codfundo) == null) {
					$this->erro_sql = " Campo si197_codfundo n�o informado.";
			...
			if (trim($this->si197_codorgao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si197_codorgao"])) {
				...
				if (trim($this->si197_codorgao) == null) {
					$this->erro_sql = " Campo si197_codorgao n�o informado.";
			...
			if (trim($this->si197_codunidadesub) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si197_codunidadesub"])) {
				...
				if (trim($this->si197_codunidadesub) == null) {
					$this->erro_sql = " Campo si197_codunidadesub n�o informado.";
			...
			if (trim($this->si197_codfontrecursos) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si197_codfontrecursos"])) {
				...
				if (trim($this->si197_codfontrecursos) == null) {
					$this->erro_sql = " Campo si197_codfontrecursos n�o informado.";
			...
			if ($result == false) {
				$this->erro_banco = str_replace("
", "", @pg_last_error());
				$this->erro_sql = "balancete272025 nao Alterado. Alteracao Abortada.\n";
				$this->erro_sql .= "Valores : " . $this->si197_sequencial;
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "balancete272025 nao foi Alterado. Alteracao Executada.\n";
					$this->erro_sql .= "Valores : " . $this->si197_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
		...
		function excluir($si197_sequencial = null, $dbwhere = null)
		{
			...
			$sql = " delete from balancete272025
                    where ";
			$sql2 = "";
			if ($dbwhere == null || $dbwhere == "") {
				if ($si197_sequencial != "") {
			...
			if ($result == false) {
				$this->erro_banco = str_replace("
", "", @pg_last_error());
				$this->erro_sql = "balancete272025 nao Exclu�do. Exclus�o Abortada.\n";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "balancete272025 nao Encontrado. Exclus�o n�o Efetuada.\n";
					$this->erro_sql .= "Valores : " . $si197_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
...
", "", @pg_last_error());
			...
			if ($this->numrows == 0) {
				$this->erro_banco = "";
				$this->erro_sql = "Record Vazio na Tabela:balancete272025";
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
		...
		function sql_query($si197_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
		{
			...
			$sql .= " from balancete272025 ";
			$sql2 = "";
			if ($dbwhere == "") {
				if ($si197_sequencial != null) {
					$sql2 .= " where balancete272025.si197_sequencial = $si197_sequencial ";
				}
			} else {
				if ($dbwhere != "") {
					$sql2 = " where $dbwhere";
