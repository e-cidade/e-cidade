...
class cl_orciniciativa { 
   ...
   var $campos = "
                 o147_sequencial = int4 = Código da Iniciativa 
                 o147_descricao = varchar(250) = Descrição 
   ...
   function incluir ($o147_sequencial){ 
     ...
     if($this->o147_iniciativa == null ){ 
       $this->erro_sql = " Campo Iniciativa não informado.";
     ...
     if($this->o147_orcmeta == null ){ 
       $this->erro_sql = " Campo Meta não informado.";
     ...
     if($this->o147_ano == null ){ 
       $this->erro_sql = " Campo Ano da iniciativa não informado.";
     ...
     if($o147_sequencial == "" || $o147_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $o147_sequencial)){
         $this->erro_sql = " Campo o147_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Iniciativa ($this->o147_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Iniciativa já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Iniciativa ($this->o147_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($o147_sequencial=null) { 
     ...
     if(trim($this->o147_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o147_sequencial"])){ 
       ...
       if(trim($this->o147_sequencial) == null ){ 
         $this->erro_sql = " Campo Código da Iniciativa não informado.";
   ...
   function excluir ($o147_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Iniciativa nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Iniciativa nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$o147_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
