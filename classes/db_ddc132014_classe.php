...
class cl_ddc132014 { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si153_codcontrato = ($this->si153_codcontrato == ""?@$GLOBALS["HTTP_POST_VARS"]["si153_codcontrato"]:$this->si153_codcontrato);
       ...
       $this->si153_reg10 = ($this->si153_reg10 == ""?@$GLOBALS["HTTP_POST_VARS"]["si153_reg10"]:$this->si153_reg10);
     }else{
       $this->si153_sequencial = ($this->si153_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["si153_sequencial"]:$this->si153_sequencial);
     }
   }
   ...
   function incluir ($si153_sequencial){ 
     ...
     if($this->si153_codcontrato == null ){ 
       $this->erro_sql = " Campo Código do  Contrato nao Informado.";
       $this->erro_campo = "si153_codcontrato";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->si153_nroleiautorizacao == null ){ 
       $this->erro_sql = " Campo Número da Lei de  Autorização nao Informado.";
       $this->erro_campo = "si153_nroleiautorizacao";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->si153_dtleiautorizacao == null ){ 
       ...
       $this->erro_campo = "si153_dtleiautorizacao_dia";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->si153_reg10 == null ){ 
       $this->erro_sql = " Campo reg10 nao Informado.";
       $this->erro_campo = "si153_reg10";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($si153_sequencial == "" || $si153_sequencial == null ){
       $result = db_query("select nextval('ddc132014_si153_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: ddc132014_si153_sequencial_seq do campo: si153_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from ddc132014_si153_sequencial_seq");
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "ddc132014 ($this->si153_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "ddc132014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "ddc132014 ($this->si153_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010382,2011170,'','".AddSlashes(pg_result($resaco,0,'si153_codcontrato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       ...
       $resac = db_query("insert into db_acount values($acount,2010382,2011174,'','".AddSlashes(pg_result($resaco,0,'si153_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($si153_sequencial=null) { 
     ...
     if(trim($this->si153_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si153_sequencial"])){ 
       ...
       $virgula = ",";
       if(trim($this->si153_sequencial) == null ){ 
         $this->erro_sql = " Campo sequencial nao Informado.";
         $this->erro_campo = "si153_sequencial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->si153_codcontrato)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si153_codcontrato"])){ 
       $sql  .= $virgula." si153_codcontrato = $this->si153_codcontrato ";
       $virgula = ",";
       if(trim($this->si153_codcontrato) == null ){ 
         $this->erro_sql = " Campo Código do  Contrato nao Informado.";
         $this->erro_campo = "si153_codcontrato";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si153_nroleiautorizacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si153_nroleiautorizacao"])){ 
       ...
       $virgula = ",";
       if(trim($this->si153_nroleiautorizacao) == null ){ 
         $this->erro_sql = " Campo Número da Lei de  Autorização nao Informado.";
         $this->erro_campo = "si153_nroleiautorizacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si153_dtleiautorizacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si153_dtleiautorizacao_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["si153_dtleiautorizacao_dia"] !="") ){ 
       ...
       $virgula = ",";
       if(trim($this->si153_dtleiautorizacao) == null ){ 
         $this->erro_sql = " Campo Data da Lei de  Autorização nao Informado.";
         $this->erro_campo = "si153_dtleiautorizacao_dia";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si153_reg10)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si153_reg10"])){ 
       $sql  .= $virgula." si153_reg10 = $this->si153_reg10 ";
       $virgula = ",";
       if(trim($this->si153_reg10) == null ){ 
         $this->erro_sql = " Campo reg10 nao Informado.";
         $this->erro_campo = "si153_reg10";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si153_codcontrato"]) || $this->si153_codcontrato != "")
           $resac = db_query("insert into db_acount values($acount,2010382,2011170,'".AddSlashes(pg_result($resaco,$conresaco,'si153_codcontrato'))."','$this->si153_codcontrato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si153_reg10"]) || $this->si153_reg10 != "")
           $resac = db_query("insert into db_acount values($acount,2010382,2011174,'".AddSlashes(pg_result($resaco,$conresaco,'si153_reg10'))."','$this->si153_reg10',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ddc132014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si153_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ddc132014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si153_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si153_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010382,2011170,'','".AddSlashes(pg_result($resaco,$iresaco,'si153_codcontrato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         $resac = db_query("insert into db_acount values($acount,2010382,2011174,'','".AddSlashes(pg_result($resaco,$iresaco,'si153_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from ddc132014
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si153_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ddc132014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ddc132014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si153_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:ddc132014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si153_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ddc132014 ";
     $sql .= "      inner join ddc102014  on  ddc102014.si150_sequencial = ddc132014.si153_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si153_sequencial!=null ){
         $sql2 .= " where ddc132014.si153_sequencial = $si153_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
