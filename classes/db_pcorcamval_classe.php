...
class cl_pcorcamval {
   ...
   public function excluir ($pc23_orcamforne=null,$pc23_orcamitem=null,$dbwhere=null) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Valores dos itens do orçamento nao Excluído. Exclusão Abortada1.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Valores dos itens do orçamento nao Encontrado. Exclusão não Efetuada2.\\n";
         $this->erro_sql .= "Valores : ".$pc23_orcamforne."-".$pc23_orcamitem;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
