...
class cl_emp102025
{
  ...
  var $si106_despdecconvenioconge = 2;
  ...
  var $si106_mes = 0;
  var $si106_instit = 0;
  var $si106_exerciciocontrato = null;
  // cria propriedade com as variaveis do arquivo
  var $campos = "
                 si106_sequencial = int8 = sequencial
                 si106_tiporegistro = int8 = Tipo do  registro
                 si106_codorgao = varchar(2) = C�digo do �rg�o
                 si106_codunidadesub = varchar(8) = C�digo da unidade
                 si106_codfuncao = varchar(2) = C�digo da fun��o
                 si106_codsubfuncao = varchar(3) = C�digo da  Subfun��o
                 si106_codprograma = varchar(4) = C�digo do  programa
                 si106_idacao = varchar(4) = C�digo que  identifica a A��o
                 si106_idsubacao = varchar(4) = C�digo que  identifica SubA��o
                 si106_naturezadespesa = int8 = C�digo da   natureza da despesa
                 si106_subelemento = varchar(2) = Subelemento da  despesa
                 si106_nroempenho = int8 = N�mero do  empenho
                 ...
                 si106_especificacaoempenho = varchar(200) = Especifica��o do  empenho
                 si106_despdeccontrato = int8 = Despesa  decorrente de  contrato
                 si106_codorgaorespcontrato = varchar(2) = C�digo do �rg�o que firmou contrato
                 si106_codunidadesubrespcontrato = varchar(8) = C�digo da unidade
                 si106_nrocontrato = int8 = N�mero do  Contrato
                 si106_dtassinaturacontrato = date = Data da assinatura  do Contrato
                 si106_nrosequencialtermoaditivo = varchar(2) = N�mero sequencial do Termo Aditivo
                 si106_despdecconvenio = int8 = Despesa  decorrente de conv�nio
                 si106_nroconvenio = varchar(30) = N�mero do  Conv�nio
                 si106_dataassinaturaconvenio = date = Data da assinatura do
                 si106_despdecconvenioconge = int8 = A despesa realizada e decorrente de convenio?
                 ...
                 si106_despdeclicitacao = int8 = Despesa decorrente de Licita��o
                 si106_numdocumentoorgao = varchar(14) = doc do �rg�o  respons�vel
                 si106_codunidadesubresplicit = varchar(8) = C�digo da unidade
                 si106_nroprocessolicitatorio = varchar(12) = N�mero do  processo  licitat�rio
                 si106_exercicioprocessolicitatorio = int8 = Exerc�cio do  processo  licitat�rio
                 si106_tipoprocesso = int8 = Tipo de processo
                 si106_cpfordenador = varchar(11) = Exercicio Contrato
                 si106_exerciciocontrato = int = Ano 
                 si106_mes = int8 = M�s
                 si106_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_emp102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("emp102025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si106_codsubfuncao = ($this->si106_codsubfuncao == "" ? @$GLOBALS["HTTP_POST_VARS"]["si106_cod subfuncao"] : $this->si106_codsubfuncao);
      ...
      $this->si106_despdecconvenioconge = ($this->si106_despdecconvenioconge == ""? @$GLOBALS["HTTP_POST_VARS"]["si106_despdecconvenioconge"] : $this->si106_despdecconvenioconge);
      ...
      $this->si106_exerciciocontrato = ($this->si106_exerciciocontrato == "" ? @$GLOBALS["HTTP_POST_VARS"]["si106_exerciciocontrato"] : $this->si106_exerciciocontrato);
  ...
  function incluir($si106_sequencial)
  {
    ...
    if ($si106_sequencial == "" || $si106_sequencial == null) {
      $result = db_query("select nextval('emp102025_si106_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: emp102025_si106_sequencial_seq do campo: si106_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from emp102025_si106_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si106_sequencial)) {
        $this->erro_sql = " Campo si106_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into emp102025(
                ...
                values (
                               ...
                               ,$this->si106_despdecconvenioconge
                               ...
                               ,". ($this->si106_exerciciocontrato == "null" || $this->si106_exerciciocontrato == "" ? "null" : $this->si106_exerciciocontrato ). "
                               ,$this->si106_mes
                               ,$this->si106_instit
                      )";
    $result = db_query($sql);
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "emp102025 ($this->si106_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "emp102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "emp102025 ($this->si106_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      ...
      $resac = db_query("insert into db_acount values($acount,2010335,2011375,'','" . AddSlashes(pg_result($resaco, 0, 'si106_tipoprocesso')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
      $resac = db_query("insert into db_acount values($acount,2010335,2010676,'','" . AddSlashes(pg_result($resaco, 0, 'si106_cpfordenador')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
  ...
  function alterar($si106_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "emp102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si106_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "emp102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si106_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si106_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "emp102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "emp102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si106_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:emp102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si106_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si106_sequencial != null) {
        $sql2 .= " where emp102025.si106_sequencial = $si106_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
