<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa122025
class cl_dispensa122025 {
   ...
   var $campos = "
                 ...
                 si76_codorgaoresp = varchar(2) = C�digo do �rg�o  respons�vel
                 si76_codunidadesubresp = varchar(8) = C�digo da unidade
                 si76_exercicioprocesso = int8 = Exerc�cio em que  foi instaurado
                 si76_nroprocesso = varchar(12) = N�mero sequencial  do processo
                 si76_tipoprocesso = int8 = Tipo de processo
                 si76_coditem = int8 = C�digo do Item
                 si76_nroitem = int8 = N�mero do Item
                 si76_mes = int8 = M�s
                 si76_reg10 = int8 = reg10
                 si76_instit = int8 = Institui��o
                 ";
   //funcao construtor da classe
   function cl_dispensa122025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dispensa122025");
   ...
   function incluir ($si76_sequencial){
     ...
     if($si76_sequencial == "" || $si76_sequencial == null ){
       $result = db_query("select nextval('dispensa122025_si76_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dispensa122025_si76_sequencial_seq do campo: si76_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from dispensa122025_si76_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si76_sequencial)){
         $this->erro_sql = " Campo si76_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dispensa122025(
                                       si76_sequencial
                                      ,si76_tiporegistro
                                      ,si76_codorgaoresp
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dispensa122025 ($this->si76_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dispensa122025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dispensa122025 ($this->si76_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si76_sequencial=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dispensa122025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si76_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dispensa122025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si76_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si76_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dispensa122025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si76_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dispensa122025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dispensa122025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si76_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dispensa122025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si76_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dispensa122025 ";
     $sql .= "      left  join dispensa102020  on  dispensa102020.si74_sequencial = dispensa122025.si76_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si76_sequencial!=null ){
         $sql2 .= " where dispensa122025.si76_sequencial = $si76_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
