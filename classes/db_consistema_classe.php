...
class cl_consistema { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->c52_codsis = ($this->c52_codsis == ""?@$GLOBALS["HTTP_POST_VARS"]["c52_codsis"]:$this->c52_codsis);
       $this->c52_descr = ($this->c52_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["c52_descr"]:$this->c52_descr);
       $this->c52_descrred = ($this->c52_descrred == ""?@$GLOBALS["HTTP_POST_VARS"]["c52_descrred"]:$this->c52_descrred);
     }else{
       $this->c52_codsis = ($this->c52_codsis == ""?@$GLOBALS["HTTP_POST_VARS"]["c52_codsis"]:$this->c52_codsis);
     }
   }
   // funcao para inclusao
   function incluir ($c52_codsis){ 
      $this->atualizacampos();
     if($this->c52_descr == null ){ 
     ...
     if($this->c52_descrred == null ){ 
       ...
       $this->c52_codsis = $c52_codsis; 
     if(($this->c52_codsis == null) || ($this->c52_codsis == "") ){ 
       $this->erro_sql = " Campo c52_codsis nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->c52_codsis;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($c52_codsis=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($c52_codsis!=null){
       $sql .= " c52_codsis = $this->c52_codsis";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->c52_codsis));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Identificação da Conta nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c52_codsis;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Identificação da Conta nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c52_codsis;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c52_codsis=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($c52_codsis));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Identificação da Conta nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$c52_codsis;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Identificação da Conta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c52_codsis;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $c52_codsis=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($c52_codsis!=null ){
         $sql2 .= " where consistema.c52_codsis = $c52_codsis "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
