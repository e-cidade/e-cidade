...
class cl_isscalcloginscr { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q48_codigo = ($this->q48_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_codigo"]:$this->q48_codigo);
       $this->q48_isscalclog = ($this->q48_isscalclog == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_isscalclog"]:$this->q48_isscalclog);
       $this->q48_inscr = ($this->q48_inscr == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_inscr"]:$this->q48_inscr);
       $this->q48_isscadlog = ($this->q48_isscadlog == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_isscadlog"]:$this->q48_isscadlog);
       $this->q48_obs = ($this->q48_obs == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_obs"]:$this->q48_obs);
     }else{
       $this->q48_codigo = ($this->q48_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["q48_codigo"]:$this->q48_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($q48_codigo){ 
      $this->atualizacampos();
     if($this->q48_isscalclog == null ){ 
     ...
     if($q48_codigo == "" || $q48_codigo == null ){
       $result = db_query("select nextval('isscalcloginscr_q48_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: isscalcloginscr_q48_codigo_seq do campo: q48_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $q48_codigo)){
         ...
         $this->q48_codigo = $q48_codigo; 
       }
     }
     if(($this->q48_codigo == null) || ($this->q48_codigo == "") ){ 
       $this->erro_sql = " Campo q48_codigo nao declarado.";
     ...
     $sql = "insert into isscalcloginscr(
                                       q48_codigo 
                                      ,q48_isscalclog 
                                      ,q48_inscr 
                                      ,q48_isscadlog 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q48_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q48_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($q48_codigo!=null){
       $sql .= " q48_codigo = $this->q48_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->q48_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "isscalcloginscr nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q48_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "isscalcloginscr nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q48_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($q48_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q48_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "isscalcloginscr nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$q48_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "isscalcloginscr nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q48_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $q48_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join isscalclog  on  isscalclog.q47_codigo = isscalcloginscr.q48_isscalclog";
     ...
     if($dbwhere==""){
       if($q48_codigo!=null ){
         $sql2 .= " where isscalcloginscr.q48_codigo = $q48_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
