<?
//MODULO: sicom
//CLASSE DA ENTIDADE pessoaflpgo102025
class cl_pessoaflpgo102025 {
  ...
  var $campos = "
                 ...
                 si193_nrodocumento = varchar(14) = N�mero do documento
                 si193_nome = varchar(120) = Nome da pessoa f�sica
                 ...
                 si193_justalteracao = varchar(100) = Justificativa para a altera��o
                 si193_mes = int8 = si193_mes
                 si193_inst = int8 = si193_inst
                 ";
  //funcao construtor da classe
  function cl_pessoaflpgo102025() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("pessoaflpgo102025");
  ...
  function incluir ($si193_sequencial){
    ...
    if($this->si193_nome == null ){
      $this->erro_sql = " Campo Nome da pessoa f�sica n�o informado.";
    ...
    if(trim($this->si193_indsexo) == null && strlen($this->si193_nrodocumento) == 11){
      $this->erro_sql = " Campo Indica o sexo n�o informado.". $this->si193_nrodocumento;
    ...
    if($this->si193_datanascimento == null && strlen($this->si193_nrodocumento) == 11){
      $this->erro_sql = " Campo Data de nascimento n�o informado.";
    ...
    if($this->si193_inst == null ){
      $this->erro_sql = " Campo si193_inst n�o informado.";
    ...
    if($si193_sequencial == "" || $si193_sequencial == null ){
      $result = db_query("select nextval('pessoaflpgo102025_si193_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("
","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: pessoaflpgo102025_si193_sequencial_seq do campo: si193_sequencial";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from pessoaflpgo102025_si193_sequencial_seq");
    ...
    $sql = "insert into pessoaflpgo102025(
                                       si193_sequencial
                                      ,si193_tiporegistro
                                      ,si193_tipodocumento
                                      ,si193_nrodocumento
...
","",@pg_last_error());
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "pessoaflpgo102025 ($this->si193_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_banco = "pessoaflpgo102025 j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      }else{
        $this->erro_sql   = "pessoaflpgo102025 ($this->si193_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
  ...
  function alterar ($si193_sequencial=null) {
    $this->atualizacampos();
    $sql = " update pessoaflpgo102025 set ";
    $virgula = "";
    ...
    if(trim($this->si193_indsexo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si193_indsexo"])){
      ...
      $virgula = ",";
      if(trim($this->si193_indsexo) == null && strlen($this->si193_nrodocumento) == 11){
        $this->erro_sql = " Campo Indica o sexo n�o informado.";
        $this->erro_campo = "si193_indsexo";
        $this->erro_banco = "";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "pessoaflpgo102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : ".$this->si193_sequencial;
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "pessoaflpgo102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : ".$this->si193_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
  ...
  function excluir ($si193_sequencial=null,$dbwhere=null) {
    ...
    $sql = " delete from pessoaflpgo102025
                    where ";
    $sql2 = "";
    if($dbwhere==null || $dbwhere ==""){
      if($si193_sequencial != ""){
    ...
    if($result==false){
      $this->erro_banco = str_replace("
","",@pg_last_error());
      $this->erro_sql   = "pessoaflpgo102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "pessoaflpgo102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : ".$si193_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "1";
...
","",@pg_last_error());
    ...
    if($this->numrows==0){
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:pessoaflpgo102025";
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si193_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    $sql .= " from pessoaflpgo102025 ";
    $sql2 = "";
    if($dbwhere==""){
      if($si193_sequencial!=null ){
        $sql2 .= " where pessoaflpgo102025.si193_sequencial = $si193_sequencial ";
      }
    }else if($dbwhere != ""){
      $sql2 = " where $dbwhere";
    }
