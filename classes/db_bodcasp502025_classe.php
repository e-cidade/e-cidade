<?
//MODULO: sicom
//CLASSE DA ENTIDADE bodcasp502025
class cl_bodcasp502025 {
   ...
   function cl_bodcasp502025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bodcasp502025");
   ...
   function incluir ($si205_sequencial){
     ...
     if($si205_sequencial == "" || $si205_sequencial == null ){
       $result = db_query("select nextval('bodcasp502025_si205_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: bodcasp502025_si205_sequencial_seq do campo: si205_sequencial";
       ...
       $result = db_query("select last_value from bodcasp502025_si205_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si205_sequencial)){
         $this->erro_sql = " Campo si205_sequencial maior que �ltimo n�mero da sequencia.";
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bodcasp502025 ($this->si205_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bodcasp502025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bodcasp502025 ($this->si205_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si205_sequencial=null) {
     ...
     if(trim($this->si205_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_sequencial"])){
       ...
       if(trim($this->si205_sequencial) == null ){
         $this->erro_sql = " Campo si205_sequencial n�o informado.";
     ...
     if(trim($this->si205_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_tiporegistro"])){
       ...
       if(trim($this->si205_tiporegistro) == null ){
         $this->erro_sql = " Campo si205_tiporegistro n�o informado.";
     ...
     if(trim($this->si205_faserestospagarprocnaoliqui)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_faserestospagarprocnaoliqui"])){
       ...
       if(trim($this->si205_faserestospagarprocnaoliqui) == null ){
         $this->erro_sql = " Campo si205_faserestospagarprocnaoliqui n�o informado.";
     ...
     if(trim($this->si205_vlrspprocliqpessoalencarsoc)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocliqpessoalencarsoc"])){
       ...
       if(trim($this->si205_vlrspprocliqpessoalencarsoc) == null ){
         $this->erro_sql = " Campo si205_vlrspprocliqpessoalencarsoc n�o informado.";
     ...
     if(trim($this->si205_vlrspprocliqjurosencardiv)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocliqjurosencardiv"])){
       ...
       if(trim($this->si205_vlrspprocliqjurosencardiv) == null ){
         $this->erro_sql = " Campo si205_vlrspprocliqjurosencardiv n�o informado.";
     ...
     if(trim($this->si205_vlrspprocliqoutrasdespcorrentes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocliqoutrasdespcorrentes"])){
       ...
       if(trim($this->si205_vlrspprocliqoutrasdespcorrentes) == null ){
         $this->erro_sql = " Campo si205_vlrspprocliqoutrasdespcorrentes n�o informado.";
     ...
     if(trim($this->si205_vlrspprocesliqinv)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocesliqinv"])){
       ...
       if(trim($this->si205_vlrspprocesliqinv) == null ){
         $this->erro_sql = " Campo si205_vlrspprocesliqinv n�o informado.";
     ...
     if(trim($this->si205_vlrspprocliqinverfinan)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocliqinverfinan"])){
       ...
       if(trim($this->si205_vlrspprocliqinverfinan) == null ){
         $this->erro_sql = " Campo si205_vlrspprocliqinverfinan n�o informado.";
     ...
     if(trim($this->si205_vlrspprocliqamortizadivida)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vlrspprocliqamortizadivida"])){
       ...
       if(trim($this->si205_vlrspprocliqamortizadivida) == null ){
         $this->erro_sql = " Campo si205_vlrspprocliqamortizadivida n�o informado.";
     ...
     if(trim($this->si205_vltotalexecrspprocnaoproceli)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si205_vltotalexecrspprocnaoproceli"])){
       ...
       if(trim($this->si205_vltotalexecrspprocnaoproceli) == null ){
         $this->erro_sql = " Campo si205_vltotalexecrspprocnaoproceli n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp502025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si205_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp502025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si205_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si205_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp502025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp502025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si205_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bodcasp502025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si205_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bodcasp502025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si205_sequencial!=null ){
         $sql2 .= " where bodcasp502025.si205_sequencial = $si205_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
