<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete112025
class cl_balancete112025
{
  ...
  function cl_balancete112025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete112025");
  ...
  function incluir($si178_sequencial)
  {
    ...
    if ($this->si178_tiporegistro == null) {
      $this->erro_sql = " Campo si178_tiporegistro n�o informado.";
    ...
    if ($this->si178_contacontaabil == null) {
      $this->erro_sql = " Campo si178_contacontaabil n�o informado.";
    ...
    if ($this->si178_codorgao == null) {
      $this->erro_sql = " Campo si178_codorgao n�o informado.";
    ...
    if ($this->si178_codunidadesub == null) {
      $this->erro_sql = " Campo si178_codunidadesub n�o informado.";
    ...
    if ($this->si178_codfuncao == null) {
      $this->erro_sql = " Campo si178_codfuncao n�o informado.";
    ...
    if ($this->si178_codsubfuncao == null) {
      $this->erro_sql = " Campo si178_codsubfuncao n�o informado.";
    ...
    if ($this->si178_codprograma == null) {
      $this->erro_sql = " Campo si178_codprograma n�o informado.";
    ...
    if ($this->si178_idacao == null) {
      $this->erro_sql = " Campo si178_idacao n�o informado.";
    ...
    if ($this->si178_naturezadespesa == null) {
      $this->erro_sql = " Campo si178_naturezadespesa n�o informado.";
    ...
    if ($this->si178_codfontrecursos == null) {
      $this->erro_sql = " Campo si178_codfontrecursos n�o informado.";
    ...
    if ($this->si178_saldoinicialcd == null) {
      $this->erro_sql = " Campo si178_saldoinicialcd n�o informado.";
    ...
    if ($this->si178_naturezasaldoinicialcd == null) {
      $this->erro_sql = " Campo si178_naturezasaldoinicialcd n�o informado.";
    ...
    if ($this->si178_totaldebitoscd == null) {
      $this->erro_sql = " Campo si178_totaldebitoscd n�o informado.";
    ...
    if ($this->si178_totalcreditoscd == null) {
      $this->erro_sql = " Campo si178_totalcreditoscd n�o informado.";
    ...
    if ($this->si178_saldofinalcd == null) {
      $this->erro_sql = " Campo si178_saldofinalcd n�o informado.";
    ...
    if ($this->si178_naturezasaldofinalcd == null) {
      $this->erro_sql = " Campo si178_naturezasaldofinalcd n�o informado.";
    ...
    if ($this->si178_mes == null) {
      $this->erro_sql = " Campo si178_mes n�o informado.";
    ...
    if ($this->si178_instit == null) {
      $this->erro_sql = " Campo si178_instit n�o informado.";
    ...
    if ($si178_sequencial == "" || $si178_sequencial == null) {
      $result = db_query("select nextval('balancete112025_si178_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete112025_si178_sequencial_seq do campo: si178_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete112025_si178_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si178_sequencial)) {
        $this->erro_sql = " Campo si178_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete112025(
                                       si178_sequencial
                                      ,si178_tiporegistro
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete112025 ($this->si178_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete112025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete112025 ($this->si178_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete112025 set ";
    $virgula = "";
    if (trim($this->si178_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si178_sequencial"])) {
      ...
      if (trim($this->si178_sequencial) == null) {
        $this->erro_sql = " Campo si178_sequencial n�o informado.";
    ...
    if (trim($this->si178_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si178_codfundo"])) {
      ...
      if (trim($this->si178_codfundo) == null) {
        $this->erro_sql = " Campo si178_codfundo n�o informado.";
    ...
    if (trim($this->si178_idsubacao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si178_idsubacao"])) {
      ...
      if (trim($this->si178_idsubacao) == null) {
        $this->erro_sql = " Campo si178_idsubacao n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete112025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si178_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete112025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si178_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si178_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete112025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si178_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete112025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete112025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si178_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete112025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si178_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete112025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si178_sequencial != null) {
        $sql2 .= " where balancete112025.si178_sequencial = $si178_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
