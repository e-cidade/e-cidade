...
class cl_conlancaminscrestosapagarprocessados
{
  ...
  var $campos = "
                 ...
                 c108_codlan = int4 = CÃ³digo LanÃ§amento 
  ...
  function incluir($c108_sequencial)
  {
    ...
    if ($this->c108_codlan == null) {
      $this->erro_sql = " Campo CÃ³digo LanÃ§amento nao Informado.";
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = " ($this->c108_sequencial) nao IncluÃ­do. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function excluir($c108_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = " nao Encontrado. ExclusÃ£o não Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $c108_sequencial;
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
