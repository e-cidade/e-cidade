...
class cl_consdispcaixaano { 
   ...
   var $campos = "
                 c203_sequencial = int8 = Código Sequencial 
                 c203_consconsorcios = int8 = Código Consórcio 
                 c203_codfontrecursos = int8 = Código da fonte de recursos
   ...
   function incluir ($c203_sequencial){ 
     ...
     if($c203_sequencial == "" || $c203_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $c203_sequencial)){
         $this->erro_sql = " Campo c203_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Disponibilidade de Caixa 31/12 do ano ($this->c203_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Disponibilidade de Caixa 31/12 do ano já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Disponibilidade de Caixa 31/12 do ano ($this->c203_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($c203_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Disponibilidade de Caixa 31/12 do ano nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Disponibilidade de Caixa 31/12 do ano nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c203_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
