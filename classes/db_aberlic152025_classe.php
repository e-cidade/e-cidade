<?
//MODULO: sicom
//CLASSE DA ENTIDADE aberlic152025
class cl_aberlic152025
{
  ...
  var $campos = "
                 ...
                 si51_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si51_codunidadesubresp = varchar(8) = C�digo da unidade
                 si51_exerciciolicitacao = int8 = Exerc�cio em que   foi instaurado
                 si51_nroprocessolicitatorio = varchar(12) = N�mero sequencial   do processo
                 si51_nrolote = int8 = N�mero do Lote
                 si51_coditem = int8 = C�digo do Item
                 si51_vlitem = float8 = Valor do Item
                 si51_mes = int8 = M�s
                 si51_reg10 = int8 = reg10
                 si51_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_aberlic152025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("aberlic152025");
  ...
  function incluir($si51_sequencial)
  {
    ...
    if ($si51_sequencial == "" || $si51_sequencial == null) {
      $result = db_query("select nextval('aberlic152025_si51_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: aberlic152025_si51_sequencial_seq do campo: si51_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from aberlic152025_si51_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si51_sequencial)) {
        $this->erro_sql = " Campo si51_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aberlic152025 ($this->si51_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aberlic152025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aberlic152025 ($this->si51_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si51_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic152025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si51_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic152025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si51_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si51_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic152025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic152025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si51_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:aberlic152025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si51_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from aberlic152025 ";
    $sql .= "      left  join aberlic102020  on  aberlic102020.si46_sequencial = aberlic152025.si51_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si51_sequencial != null) {
        $sql2 .= " where aberlic152025.si51_sequencial = $si51_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
