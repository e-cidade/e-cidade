<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa172025
class cl_dispensa172025
{
  ...
  var $campos = "
                 ...
                 si81_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si81_codunidadesubresp = varchar(8) = C�digo da unidade
                 si81_exercicioprocesso = int8 = Exerc�cio em que  foi instaurado
                 si81_nroprocesso = varchar(12) = N�mero sequencial  do processo
                 si81_tipoprocesso = int8 = Tipo de processo
                 si81_tipodocumento = int8 = Tipo do  documento
                 si81_nrodocumento = varchar(14) = N�mero do  documento
                 si81_nroinscricaoestadual = varchar(30) = N�mero da  inscri��o estadual
                 si81_ufinscricaoestadual = varchar(2) = UF da inscri��o  estadual
                 si81_nrocertidaoregularidadeinss = varchar(30) = N�mero da certid�o de R INSS
                 si81_dtemissaocertidaoregularidadeinss = date = Data de emiss�o  da certid�o
                 si81_dtvalidadecertidaoregularidadeinss = date = Data de validade  da certid�o
                 si81_nrocertidaoregularidadefgts = varchar(30) = N�mero da certid�o  de R FGTS
                 si81_dtemissaocertidaoregularidadefgts = date = Data de emiss�o  da certid�o
                 si81_dtvalidadecertidaoregularidadefgts = date = Data de validade  da certid�o
                 si81_nrocndt = varchar(30) = N�mero da  Certid�o Negativa  de D�bitos
                 si81_dtemissaocndt = date = Data de emiss�o  da certid�o  Negativa
                 si81_dtvalidadecndt = date = Data de validade  da certid�o  Negativa
                 si81_nrolote = int8 = N�mero do Lote
                 si81_coditem = int8 = C�digo do Item
                 si81_quantidade = float8 = Quantidade do item
                 si81_vlitem = float8 = Valor do Item
                 si81_mes = int8 = M�s
                 si81_reg10 = int8 = reg10
                 si81_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_dispensa172025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dispensa172025");
  ...
  function incluir($si81_sequencial)
  {
    ...
    if ($si81_sequencial == "" || $si81_sequencial == null) {
      $result = db_query("select nextval('dispensa172025_si81_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: dispensa172025_si81_sequencial_seq do campo: si81_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from dispensa172025_si81_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si81_sequencial)) {
        $this->erro_sql = " Campo si81_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into dispensa172025(
                                       si81_sequencial
                                      ,si81_tiporegistro
                                      ,si81_codorgaoresp
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "dispensa172025 ($this->si81_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "dispensa172025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "dispensa172025 ($this->si81_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si81_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa172025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si81_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa172025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si81_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si81_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from dispensa172025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si81_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa172025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa172025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si81_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:dispensa172025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si81_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from dispensa172025 ";
    $sql .= "      left  join dispensa102020  on  dispensa102020.si74_sequencial = dispensa172025.si81_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si81_sequencial != null) {
        $sql2 .= " where dispensa172025.si81_sequencial = $si81_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
