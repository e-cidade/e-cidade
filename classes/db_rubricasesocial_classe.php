<?
//MODULO: pessoal
//CLASSE DA ENTIDADE rubricasesocial
class cl_rubricasesocial {
   ...
   function alterar ($e990_sequencial=null) {
      $this->atualizacampos();
     ...
     $sql .= " where e990_sequencial = '$e990_sequencial' ";
     $result = @pg_exec($sql);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($e990_sequencial=null) {
     $this->atualizacampos(true);
     $sql = " delete from rubricasesocial
                    where ";
     $sql2 = "";
     $sql2 = "e990_sequencial = '$e990_sequencial'";
   ...
   // funcao do sql
   function sql_query ( $e990_sequencial = null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
