<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp302025
class cl_dfcdcasp302025 {
   ...
   function cl_dfcdcasp302025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp302025");
   ...
   function incluir ($si221_sequencial){
     ...
     if(empty($si221_sequencial)){
       $result = db_query("select nextval('dfcdcasp302025_si221_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp302025_si221_sequencial_seq do campo: si221_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp302025_si221_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si221_sequencial)){
         $this->erro_sql = " Campo si221_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp302025(
                                       si221_anousu
                                      ,si221_periodo
                                      ,si221_instit
                                      ,si221_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp302025 ($this->si221_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp302025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp302025 ($this->si221_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si221_sequencial=null) {
     ...
     if(trim($this->si221_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si221_sequencial"])){
       ...
       if(trim($this->si221_sequencial) == null ){
         $this->erro_sql = " Campo si221_sequencial n�o informado.";
     ...
     if(trim($this->si221_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si221_tiporegistro"])){
       ...
       if(trim($this->si221_tiporegistro) == null ){
         $this->erro_sql = " Campo si221_tiporegistro n�o informado.";
     ...
     if(trim($this->si221_vlfluxocaixaliquidooperacional)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si221_vlfluxocaixaliquidooperacional"])){
       ...
       if(trim($this->si221_vlfluxocaixaliquidooperacional) == null ){
         $this->erro_sql = " Campo si221_vlfluxocaixaliquidooperacional n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp302025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si221_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp302025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si221_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si221_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp302025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp302025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si221_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp302025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si221_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp302025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si221_sequencial!=null ){
         $sql2 .= " where dfcdcasp302025.si221_sequencial = $si221_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
