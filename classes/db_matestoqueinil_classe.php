...
class cl_matestoqueinil { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->m86_codigo = ($this->m86_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["m86_codigo"]:$this->m86_codigo);
       $this->m86_matestoqueini = ($this->m86_matestoqueini == ""?@$GLOBALS["HTTP_POST_VARS"]["m86_matestoqueini"]:$this->m86_matestoqueini);
     }else{
       $this->m86_codigo = ($this->m86_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["m86_codigo"]:$this->m86_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($m86_codigo){ 
      $this->atualizacampos();
     if($this->m86_matestoqueini == null ){ 
     ...
     if($m86_codigo == "" || $m86_codigo == null ){
       $result = db_query("select nextval('matestoqueinil_m86_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: matestoqueinil_m86_codigo_seq do campo: m86_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $m86_codigo)){
         ...
         $this->m86_codigo = $m86_codigo; 
       }
     }
     if(($this->m86_codigo == null) || ($this->m86_codigo == "") ){ 
       $this->erro_sql = " Campo m86_codigo nao declarado.";
     ...
     $sql = "insert into matestoqueinil(
                                       m86_codigo 
                                      ,m86_matestoqueini 
                       )
                values (
                                $this->m86_codigo 
                               ,$this->m86_matestoqueini 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->m86_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($m86_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($m86_codigo!=null){
       $sql .= " m86_codigo = $this->m86_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->m86_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ligação do matestoqueini nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->m86_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ligação do matestoqueini nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->m86_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($m86_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($m86_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ligação do matestoqueini nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$m86_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ligação do matestoqueini nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$m86_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $m86_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($m86_codigo!=null ){
         $sql2 .= " where matestoqueinil.m86_codigo = $m86_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
