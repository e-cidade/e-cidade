 ...
 $sql .= $sql2;
  ...
  function consultaMovimentosDaOp($e50_codord = null, $sCampos = "*", $ordem = null, $dbWhere = ""){
    $sql = "select ";
     ...
     $sql .= "      left join conplanoreduz on";
     $sql .= "        conplanoreduz.c61_reduz = empagetipo.e83_conta";
     $sql .= "        and conplanoreduz.c61_anousu = empempenho.e60_anousu";
     $sql .= "        and conplanoreduz.c61_instit = empempenho.e60_instit";
     $sql .= "      left join conplanoconta on";
     $sql .= "        conplanoconta.c63_codcon = conplanoreduz.c61_codcon";
     $sql .= "        and conplanoconta.c63_anousu = conplanoreduz.c61_anousu";
     $sql .= "      left join conplanocontabancaria on";
     ...
     $sql .= "      left join contabancaria on";
