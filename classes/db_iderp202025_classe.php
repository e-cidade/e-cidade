<?php
//MODULO: sicom
//CLASSE DA ENTIDADE iderp202025
class cl_iderp202025 {
  ...
  public $campos = "
                 ...
                 si181_codorgao = varchar(2) = C�digo do �rg�o
                 si181_codfontrecursos = int8 = C�digo da fonte de recursos
                 si181_vlcaixabruta = float8 = Valor da disponibilidade de caixa bruta
                 si181_vlrspexerciciosanteriores = float8 = Restos a pagar de exerc�cios anteriores
                 si181_vlrestituiveisrecolher = float8 = Valores restitu�veis a recolher
                 si181_vlrestituiveisativofinanceiro = float8 = Valores restitu�veis registrados no Ativ
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("iderp202025");
  ...
  function incluir ($si181_sequencial) {
     ...
     if ($this->si181_vlcaixabruta == null ) {
       $this->erro_sql = " Campo Valor da disponibilidade de caixa bruta n�o informado.";
     ...
     if ($this->si181_vlrspexerciciosanteriores == null ) {
       $this->erro_sql = " Campo Restos a pagar de exerc�cios anteriores n�o informado.";
...
//       $this->erro_sql = " Campo Valores restitu�veis a recolher n�o informado.";
...
//       $this->erro_sql = " Campo Valores restitu�veis registrados no Ativ n�o informado.";
...
//     }
     if ($this->si181_vlsaldodispcaixa == null ) {
       $this->erro_sql = " Campo Saldo da disponibilidade de caixa n�o informado.";
     ...
     if ($si181_sequencial == "" || $si181_sequencial == null ) {
       $result = db_query("select nextval('iderp202025_si181_sequencial_seq')");
       if ($result==false) {
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: iderp202025_si181_sequencial_seq do campo: si181_sequencial";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from iderp202025_si181_sequencial_seq");
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Disponibilidade de Caixa ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Disponibilidade de Caixa j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Disponibilidade de Caixa ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Disponibilidade de Caixa nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Disponibilidade de Caixa nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si181_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:iderp202025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si181_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from iderp202025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si181_sequencial!=null ) {
         $sql2 .= " where iderp202025.si181_sequencial = $si181_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
