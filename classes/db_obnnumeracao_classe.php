...
class cl_obnnumeracao { 
   ...
   function incluir ($o150_sequencial){ 
      $this->atualizacampos();
     if($this->o150_instit == null ){ 
     ...
     if($this->o150_proximonumero == null ){ 
     ...
     if($o150_sequencial == "" || $o150_sequencial == null ){
       $result = db_query("select nextval('obnnumeracao_o150_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: obnnumeracao_o150_sequencial_seq do campo: o150_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $o150_sequencial)){
         ...
         $this->o150_sequencial = $o150_sequencial; 
       }
     }
     if(($this->o150_sequencial == null) || ($this->o150_sequencial == "") ){ 
       $this->erro_sql = " Campo o150_sequencial nao declarado.";
     ...
     $sql = "insert into obnnumeracao(
                                       o150_sequencial 
                                      ,o150_instit 
                                      ,o150_proximonumero 
                       )
                values (
                                $this->o150_sequencial 
                               ,$this->o150_instit 
                               ,$this->o150_proximonumero 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->o150_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->o150_sequencial  ));
   ...
   function alterar ($o150_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($o150_sequencial!=null){
       $sql .= " o150_sequencial = $this->o150_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Numerção OBN nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->o150_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Numerção OBN nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->o150_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($o150_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($o150_sequencial));
       } else { 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($o150_sequencial != ""){
          ...
          $sql2 .= " o150_sequencial = $o150_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Numerção OBN nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$o150_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Numerção OBN nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$o150_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $o150_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from obnnumeracao ";
     $sql .= "      inner join db_config  on  db_config.codigo = obnnumeracao.o150_instit";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = db_config.numcgm";
     $sql .= "      inner join db_tipoinstit  on  db_tipoinstit.db21_codtipo = db_config.db21_tipoinstit";
     $sql2 = "";
     if($dbwhere==""){
       if($o150_sequencial!=null ){
         $sql2 .= " where obnnumeracao.o150_sequencial = $o150_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
