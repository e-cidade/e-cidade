...
//MODULO: pessoal
//CLASSE DA ENTIDADE rhlocaltrab
class cl_rhlocaltrab { 
   ...
   function incluir ($rh55_codigo,$rh55_instit){ 
      $this->atualizacampos();
     if($this->rh55_estrut == null ){ 
       $this->erro_sql = " Campo Estrutural nao Informado.";
       $this->erro_campo = "rh55_estrut";
       $this->erro_banco = "";
     ...
     if($this->rh55_descr == null ){ 
       $this->erro_sql = " Campo Descrição nao Informado.";
       $this->erro_campo = "rh55_descr";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if(($this->rh55_codigo == null) || ($this->rh55_codigo == "") ){ 
       $this->erro_sql = " Campo rh55_codigo nao declarado.";
     ...
     if(($this->rh55_instit == null) || ($this->rh55_instit == "") ){ 
       $this->erro_sql = " Campo rh55_instit nao declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Cadastro de local de trabalho ($this->rh55_codigo."-".$this->rh55_instit) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Cadastro de local de trabalho já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Cadastro de local de trabalho ($this->rh55_codigo."-".$this->rh55_instit) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($rh55_codigo=null,$rh55_instit=null) { 
      $this->atualizacampos();
     ...
     if(trim($this->rh55_codigo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["rh55_codigo"])){ 
       ...
       if(trim($this->rh55_codigo) == null ){ 
         $this->erro_sql = " Campo Cód. Local nao Informado.";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh55_instit"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh55_codigo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh55_estrut"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["rh55_descr"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de local de trabalho nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh55_codigo."-".$this->rh55_instit;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de local de trabalho nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh55_codigo."-".$this->rh55_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($rh55_codigo=null,$rh55_instit=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de local de trabalho nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de local de trabalho nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh55_codigo."-".$rh55_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $rh55_codigo=null,$rh55_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   function sql_query_file ( $rh55_codigo=null,$rh55_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
