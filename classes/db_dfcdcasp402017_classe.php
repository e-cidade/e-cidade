<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp402017
class cl_dfcdcasp402017 {
   ...
   var $campos = "
                 ...
                 si222_exercicio = int4 = si222_exercicio
   ...
   function cl_dfcdcasp402017() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp402017");
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si222_exercicio = ($this->si222_exercicio == ""?@$GLOBALS["HTTP_POST_VARS"]["si222_exercicio"]:$this->si222_exercicio);
   ...
   function incluir ($si222_sequencial){
     ...
     if ( empty($this->si222_exercicio) ){
       $this->erro_sql = " Campo si222_exercicio não informado.";
       $this->erro_campo = "si222_exercicio";
       $this->erro_banco = "";
     ...
     if(empty($si222_sequencial)){
       $result = db_query("select nextval('dfcdcasp402017_si222_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp402017_si222_sequencial_seq do campo: si222_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from dfcdcasp402017_si222_sequencial_seq");
     ...
     $sql = "insert into dfcdcasp402017(
                                       si222_anousu
                                      ,si222_periodo
                                      ,si222_instit
                                      ,si222_sequencial
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp402017 ($this->si222_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "dfcdcasp402017 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "dfcdcasp402017 ($this->si222_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($si222_sequencial=null) {
     ...
     if(trim($this->si222_exercicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_exercicio"])){
       $sql  .= $virgula." si222_exercicio = $this->si222_exercicio ";
       $virgula = ",";
       if(trim($this->si222_exercicio) == null ){
         $this->erro_sql = " Campo si222_exercicio não informado.";
         $this->erro_campo = "si222_exercicio";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp402017 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si222_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp402017 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si222_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si222_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp402017
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp402017 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp402017 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si222_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp402017";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si222_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp402017 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si222_sequencial!=null ){
         $sql2 .= " where dfcdcasp402017.si222_sequencial = $si222_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
