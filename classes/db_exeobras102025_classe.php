<?php
//MODULO: sicom
//CLASSE DA ENTIDADE exeobras102025
class cl_exeobras102025 {
  ...
  public $campos = "
                 ...
                 si197_mes = int4 = Mes
                 si197_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("exeobras102025");
  ...
  function incluir () {
    ...
    if ($this->si197_sequencial == null ) {
      $result = db_query("select nextval('exeobras102025_si197_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: exeobras102025_si197_sequencial_seq do campo: si197_sequencial";
    ...
    if ($this->si197_codunidadesub == null ) {
      $this->erro_sql = " Campo codunidadesub n�o informado.";
    ...
    if ($this->si197_nrocontrato == null ) {
      $this->erro_sql = " Campo nroContrato n�o informado.";
    ...
    if ($this->si197_nroprocessolicitatorio == null ) {
      $this->erro_sql = " Campo numero processo licitatorio n�o informado.";
    ...
    if ($this->si197_codunidadesubresp == null ) {
      $this->erro_sql = " Campo cod Unidade Sub Processo Licitatorio n�o informado.";
      $this->erro_campo = "si197_nroprocessolicitatorio";
      $this->erro_banco = "";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
    ...
    if ($this->si197_exerciciolicitacao == null ) {
      $this->erro_sql = " Campo exercicio da licita��o n�o informado.";
    ...
    if ($this->si197_nrolote == null ) {
      $this->erro_sql = " Campo numero do lote n�o informado.";
    ...
    $sql = "insert into exeobras102025(
                                 si197_sequencial
                                ,si197_tiporegistro
                                ,si197_codorgao
                                ,si197_codunidadesub
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "execucao de obras () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "execucao de obras j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "execucao de obras () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function excluir ( $si197_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from exeobras102025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "execucao de obras nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "execucao de obras nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:exeobras102025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si197_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from exeobras102025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si197_sequencial != "" && $si197_sequencial != null) {
        $sql2 = " where exeobras102025.si197_sequencial = '$si197_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
