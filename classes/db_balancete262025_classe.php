<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete262025
class cl_balancete262025
{
  ...
  function cl_balancete262025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete262025");
  ...
  function incluir($si196_sequencial)
  {
    ...
    if ($this->si196_tiporegistro == null) {
      $this->erro_sql = " Campo si196_tiporegistro n�o informado.";
    ...
    if ($this->si196_contacontabil == null) {
      $this->erro_sql = " Campo si196_contacontabil n�o informado.";
    ...
    if ($this->si196_tipodocumentopessoaatributosf == null) {
      $this->erro_sql = " Campo si196_tipodocumentopessoaatributosf n�o informado.";
    ...
    if ($this->si196_nrodocumentopessoaatributosf == null) {
      $this->erro_sql = " Campo si196_nrodocumentopessoaatributosf n�o informado.";
    ...
    if ($this->si196_atributosf == null) {
      $this->erro_sql = " Campo si196_atributosf n�o informado.";
    ...
    if ($this->si196_saldoinicialpessoaatributosf == null) {
      $this->erro_sql = " Campo si196_saldoinicialpessoaatributosf n�o informado.";
    ...
    if ($this->si196_naturezasaldoinicialpessoaatributosf == null) {
      $this->erro_sql = " Campo si196_naturezasaldoinicialpessoaatributosf n�o informado.";
    ...
    if ($this->si196_totaldebitospessoaatributosf == null) {
      $this->erro_sql = " Campo si196_totaldebitospessoaatributosf n�o informado.";
    ...
    if ($this->si196_totalcreditospessoaatributosf == null) {
      $this->erro_sql = " Campo si196_totalcreditospessoaatributosf n�o informado.";
    ...
    if ($this->si196_saldofinalpessoaatributosf == null) {
      $this->erro_sql = " Campo si196_saldofinalpessoaatributosf n�o informado.";
    ...
    if ($this->si196_naturezasaldofinalpessoaatributosf == null) {
      $this->erro_sql = " Campo si196_naturezasaldofinalpessoaatributosf n�o informado.";
    ...
    if ($this->si196_instit == null) {
      $this->erro_sql = " Campo si196_instit n�o informado.";
    ...
    if ($si196_sequencial == "" || $si196_sequencial == null) {
      $result = db_query("select nextval('balancete262025_si196_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete262025_si196_sequencial_seq do campo: si196_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete262025_si196_sequencial_seq");
    ...
    $sql = "insert into balancete262025(
                                       si196_sequencial
                                      ,si196_tiporegistro
                                      ,si196_contacontabil
                                      ,si196_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete262025 ($this->si196_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete262025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete262025 ($this->si196_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete262025 set ";
    $virgula = "";
    ...
    if (trim($this->si196_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si196_codfundo"])) {
      ...
      if (trim($this->si196_codfundo) == null) {
        $this->erro_sql = " Campo si196_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete262025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si196_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete262025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si196_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si196_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete262025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si196_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete262025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete262025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si196_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete262025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si196_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete262025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si196_sequencial != null) {
        $sql2 .= " where balancete262025.si196_sequencial = $si196_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
