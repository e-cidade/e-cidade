<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge302025
class cl_conge302025 {
  ...
  public $campos = "
                 ...
                 si184_codorgao = varchar(2) = C�digo do �rg�o
                 si184_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si184_nroconvenioconge = varchar(30) = N�mero do conv�nio original ou instrum
                 si184_dataassinaturaconvoriginalconge = date = Data da assinatura do conv�nio original
                 si184_numeroparcela = int8 = N�mero da parcela
                 si184_datarepasseconge = date = Data do repasse
                 si184_vlrepassadoconge = float8 = Valor repassado da parcela
                 si184_banco = int8 = N�mero do banco  para o qual foi repass
                 si184_agencia = varchar(6) = N�mero da ag�ncia banc�ria
                 si184_digitoverificadoragencia = varchar(2) = Digito verificador Ag�ncia
                 si184_contabancaria = int8 = N�mero da conta banc�ria
                 si184_digitoverificadorcontabancaria = varchar(2) = D�gito verificador da conta banc�ria
                 si184_tipodocumentotitularconta = int8 = Tipo do documento do titular da conta
                 si184_nrodocumentotitularconta = varchar(14) = N�mero do  documento do titular da conta
                 si184_prazoprestacontas = date = Data final para presta��o de contas
                 si184_mes = int8 = M�s
                 si184_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conge302025");
  ...
  function incluir ($si184_sequencial) {
     ...
     if ($this->si184_nroconvenioconge == null ) {
       $this->erro_sql = " Campo N�mero do conv�nio original ou instrum n�o informado.";
     ...
     if ($this->si184_vlrepassadoconge == null ) {
       $this->erro_sql = " Campo Valor repassado da parcela n�o informado.";
     ...
     if ($this->si184_banco == null ) {
       $this->erro_sql = " Campo N�mero do banco  para o qual foi repass n�o informado.";
     ...
     if ($this->si184_agencia == null ) {
       $this->erro_sql = " Campo N�mero da ag�ncia banc�ria n�o informado.";
     ...
     if ($this->si184_digitoverificadoragencia == null ) {
       $this->erro_sql = " Campo Digito verificador Ag�ncia n�o informado.";
     ...
     if ($this->si184_contabancaria == null ) {
       $this->erro_sql = " Campo N�mero da conta banc�ria n�o informado.";
     ...
     if ($this->si184_digitoverificadorcontabancaria == null ) {
       $this->erro_sql = " Campo D�gito verificador da conta banc�ria n�o informado.";
     ...
     if ($this->si184_tipodocumentotitularconta == null ) {
       $this->erro_sql = " Campo Tipo do documento do titular da conta n�o informado.";
     ...
     if ($this->si184_nrodocumentotitularconta == null ) {
       $this->erro_sql = " Campo N�mero do  documento do titular da conta n�o informado.";
     ...
     if ($this->si184_prazoprestacontas == null ) {
       $this->erro_sql = " Campo Data final para presta��o de contas n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Repasses Realizados por meio de Conv�n ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Repasses Realizados por meio de Conv�n j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Repasses Realizados por meio de Conv�n ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($si184_sequencial=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Repasses Realizados por meio de Conv�n nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si184_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Repasses Realizados por meio de Conv�n nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si184_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function excluir ($si184_sequencial=null,$dbwhere=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Repasses Realizados por meio de Conv�n nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Repasses Realizados por meio de Conv�n nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si184_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge302025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si184_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge302025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si184_sequencial!=null ) {
         $sql2 .= " where conge302025.si184_sequencial = $si184_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
