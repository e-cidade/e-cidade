...
class cl_issplanitop {
   ...
   function sql_query ( $q96_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join issplanit  on  issplanit.q21_sequencial = issplaniCurrentWindow.q96_issplanit";
     $sql .= "      inner join pagordem  on  pagordem.e50_codord = issplaniCurrentWindow.q96_pagordem";
