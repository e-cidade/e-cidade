...
class cl_rhavaliacaotipoavaliacao { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->h76_sequencial = ($this->h76_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["h76_sequencial"]:$this->h76_sequencial);
       $this->h76_rhtipoavaliacao = ($this->h76_rhtipoavaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["h76_rhtipoavaliacao"]:$this->h76_rhtipoavaliacao);
       $this->h76_rhavaliacao = ($this->h76_rhavaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["h76_rhavaliacao"]:$this->h76_rhavaliacao);
       $this->h76_pontos = ($this->h76_pontos == ""?@$GLOBALS["HTTP_POST_VARS"]["h76_pontos"]:$this->h76_pontos);
     }else{
       $this->h76_sequencial = ($this->h76_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["h76_sequencial"]:$this->h76_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($h76_sequencial){ 
      $this->atualizacampos();
     if($this->h76_rhtipoavaliacao == null ){ 
     ...
     if($h76_sequencial == "" || $h76_sequencial == null ){
       $result = db_query("select nextval('rhavaliacaotipoavaliacao_h76_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: rhavaliacaotipoavaliacao_h76_sequencial_seq do campo: h76_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $h76_sequencial)){
         ...
         $this->h76_sequencial = $h76_sequencial; 
       }
     }
     if(($this->h76_sequencial == null) || ($this->h76_sequencial == "") ){ 
       $this->erro_sql = " Campo h76_sequencial nao declarado.";
     ...
     $sql = "insert into rhavaliacaotipoavaliacao(
                                       h76_sequencial 
                                      ,h76_rhtipoavaliacao 
                                      ,h76_rhavaliacao 
                                      ,h76_pontos 
                ...
                values (
                                $this->h76_sequencial 
                               ,$this->h76_rhtipoavaliacao 
                               ,$this->h76_rhavaliacao 
                               ,$this->h76_pontos 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->h76_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($h76_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($h76_sequencial!=null){
       $sql .= " h76_sequencial = $this->h76_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->h76_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de avaliação nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->h76_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de avaliação nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->h76_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($h76_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($h76_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($h76_sequencial != ""){
          ...
          $sql2 .= " h76_sequencial = $h76_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de avaliação nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$h76_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de avaliação nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$h76_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $h76_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from rhavaliacaotipoavaliacao ";
     $sql .= "      inner join rhtipoavaliacao  on  rhtipoavaliacao.h69_sequencial = rhavaliacaotipoavaliacao.h76_rhtipoavaliacao";
     $sql .= "      inner join rhavaliacao  on  rhavaliacao.h73_sequencial = rhavaliacaotipoavaliacao.h76_rhavaliacao";
     ...
     if($dbwhere==""){
       if($h76_sequencial!=null ){
         $sql2 .= " where rhavaliacaotipoavaliacao.h76_sequencial = $h76_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
