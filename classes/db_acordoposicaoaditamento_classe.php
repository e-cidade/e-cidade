...
class cl_acordoposicaoaditamento
{
  ...
  function incluir($ac35_sequencial)
  {
    ...
    if ($this->ac35_dataassinaturatermoaditivo == null || $this->ac35_dataassinaturatermoaditivo == '') {
      $this->ac35_dataassinaturatermoaditivo = 'null';
    }
    if ($this->ac35_datareferencia == null || $this->ac35_datareferencia == '') {
      $this->ac35_datareferencia = 'null';
    }
    if ($this->ac35_datapublicacao == null || $this->ac35_datapublicacao == '') {
      $this->ac35_datapublicacao = 'null';
    }
    if ($this->ac35_veiculodivulgacao == null || $this->ac35_veiculodivulgacao == '') {
    ...
    $sql = "insert into acordoposicaoaditamento(
                ...
                values (
                               ...
                               ," . ($this->ac35_dataassinaturatermoaditivo == "null" ? "null" : "'" . $this->ac35_dataassinaturatermoaditivo . "'") . "
  ...
  function alterar($ac35_sequencial = null)
  {
    ...
    if (trim($this->ac35_dataassinaturatermoaditivo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_dataassinaturatermoaditivo"])) {
      $sql  .= $virgula . " ac35_dataassinaturatermoaditivo = '$this->ac35_dataassinaturatermoaditivo' ";
      $virgula = ",";
      if (trim($this->ac35_dataassinaturatermoaditivo) == null) {
    ...
    if (trim($this->ac35_datapublicacao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_datapublicacao"])) {
      $sql  .= $virgula . " ac35_datapublicacao = '$this->ac35_datapublicacao' ";
      $virgula = ",";
      if (trim($this->ac35_datapublicacao) == null) {
    ...
    if (trim($this->ac35_veiculodivulgacao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["ac35_veiculodivulgacao"])) {
      $sql  .= $virgula . " ac35_veiculodivulgacao = '$this->ac35_veiculodivulgacao' ";
      $virgula = ",";
      if (trim($this->ac35_veiculodivulgacao) == null) {
