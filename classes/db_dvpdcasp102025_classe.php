<?
//MODULO: sicom
//CLASSE DA ENTIDADE dvpdcasp102025
class cl_dvpdcasp102025 {
   ...
   function cl_dvpdcasp102025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dvpdcasp102025");
   ...
   function incluir ($si216_sequencial){
     ...
     if($this->si216_tiporegistro == null ){
       $this->erro_sql = " Campo si216_tiporegistro n�o informado.";
     ...
     $sql = "insert into dvpdcasp102025(
                                       si216_sequencial
                                      ,si216_tiporegistro
                                      ,si216_vlimpostos
                ...
                values (
                                (select nextval('dvpdcasp102025_si216_sequencial_seq'))
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dvpdcasp102025 ($this->si216_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dvpdcasp102025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dvpdcasp102025 ($this->si216_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si216_sequencial=null) {
     ...
     if(trim($this->si216_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_sequencial"])){
       ...
       if(trim($this->si216_sequencial) == null ){
         $this->erro_sql = " Campo si216_sequencial n�o informado.";
     ...
     if(trim($this->si216_vlimpostos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vlimpostos"])){
       ...
       if(trim($this->si216_vlimpostos) == null ){
         $this->erro_sql = " Campo si216_vlimpostos n�o informado.";
     ...
     if(trim($this->si216_vlcontribuicoes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vlcontribuicoes"])){
       ...
       if(trim($this->si216_vlcontribuicoes) == null ){
         $this->erro_sql = " Campo si216_vlcontribuicoes n�o informado.";
     ...
     if(trim($this->si216_vlexploracovendasdireitos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vlexploracovendasdireitos"])){
       ...
       if(trim($this->si216_vlexploracovendasdireitos) == null ){
         $this->erro_sql = " Campo si216_vlexploracovendasdireitos n�o informado.";
     ...
     if(trim($this->si216_vlvariacoesaumentativasfinanceiras)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vlvariacoesaumentativasfinanceiras"])){
       ...
       if(trim($this->si216_vlvariacoesaumentativasfinanceiras) == null ){
         $this->erro_sql = " Campo si216_vlvariacoesaumentativasfinanceiras n�o informado.";
     ...
     if(trim($this->si216_vltransfdelegacoesrecebidas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vltransfdelegacoesrecebidas"])){
       ...
       if(trim($this->si216_vltransfdelegacoesrecebidas) == null ){
         $this->erro_sql = " Campo si216_vltransfdelegacoesrecebidas n�o informado.";
     ...
     if(trim($this->si216_vlvalorizacaoativodesincorpassivo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vlvalorizacaoativodesincorpassivo"])){
       ...
       if(trim($this->si216_vlvalorizacaoativodesincorpassivo) == null ){
         $this->erro_sql = " Campo si216_vlvalorizacaoativodesincorpassivo n�o informado.";
     ...
     if(trim($this->si216_vloutrasvariacoespatriaumentativas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vloutrasvariacoespatriaumentativas"])){
       ...
       if(trim($this->si216_vloutrasvariacoespatriaumentativas) == null ){
         $this->erro_sql = " Campo si216_vloutrasvariacoespatriaumentativas n�o informado.";
     ...
     if(trim($this->si216_vltotalvpaumentativas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si216_vltotalvpaumentativas"])){
       ...
       if(trim($this->si216_vltotalvpaumentativas) == null ){
         $this->erro_sql = " Campo si216_vltotalvpaumentativas n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dvpdcasp102025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si216_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dvpdcasp102025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si216_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si216_sequencial=null,$dbwhere=null) {
     $sql = " delete from dvpdcasp102025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dvpdcasp102025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dvpdcasp102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si216_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dvpdcasp102025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si216_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dvpdcasp102025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si216_sequencial!=null ){
         $sql2 .= " where dvpdcasp102025.si216_sequencial = $si216_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
