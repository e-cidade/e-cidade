...
class cl_regraarredondamentofaixa { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed317_sequencial = ($this->ed317_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_sequencial"]:$this->ed317_sequencial);
       $this->ed317_regraarredondamento = ($this->ed317_regraarredondamento == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_regraarredondamento"]:$this->ed317_regraarredondamento);
       $this->ed317_inicial = ($this->ed317_inicial == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_inicial"]:$this->ed317_inicial);
       $this->ed317_final = ($this->ed317_final == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_final"]:$this->ed317_final);
       $this->ed317_arredondar = ($this->ed317_arredondar == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_arredondar"]:$this->ed317_arredondar);
     }else{
       $this->ed317_sequencial = ($this->ed317_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ed317_sequencial"]:$this->ed317_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($ed317_sequencial){ 
      $this->atualizacampos();
     if($this->ed317_regraarredondamento == null ){ 
     ...
     if($ed317_sequencial == "" || $ed317_sequencial == null ){
       $result = db_query("select nextval('regraarredondamentofaixa_ed317_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: regraarredondamentofaixa_ed317_sequencial_seq do campo: ed317_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed317_sequencial)){
         ...
         $this->ed317_sequencial = $ed317_sequencial; 
       }
     }
     if(($this->ed317_sequencial == null) || ($this->ed317_sequencial == "") ){ 
       $this->erro_sql = " Campo ed317_sequencial nao declarado.";
     ...
     $sql = "insert into regraarredondamentofaixa(
                                       ed317_sequencial 
                                      ,ed317_regraarredondamento 
                                      ,ed317_inicial 
                                      ,ed317_final 
                                      ,ed317_arredondar 
                       )
                values (
                                $this->ed317_sequencial 
                               ,$this->ed317_regraarredondamento 
                               ,$this->ed317_inicial 
                               ,$this->ed317_final 
                               ,'$this->ed317_arredondar' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ed317_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ed317_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ed317_sequencial!=null){
       $sql .= " ed317_sequencial = $this->ed317_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ed317_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Faixa da regra de arredondamento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed317_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Faixa da regra de arredondamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed317_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed317_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ed317_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ed317_sequencial != ""){
          ...
          $sql2 .= " ed317_sequencial = $ed317_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Faixa da regra de arredondamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ed317_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Faixa da regra de arredondamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed317_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ed317_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from regraarredondamentofaixa ";
     $sql .= "      inner join regraarredondamento  on  regraarredondamento.ed316_sequencial = regraarredondamentofaixa.ed317_regraarredondamento";
     $sql2 = "";
     if($dbwhere==""){
       if($ed317_sequencial!=null ){
         $sql2 .= " where regraarredondamentofaixa.ed317_sequencial = $ed317_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
