...
class cl_debcontapedidomatric { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->d68_codigo = ($this->d68_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["d68_codigo"]:$this->d68_codigo);
       $this->d68_matric = ($this->d68_matric == ""?@$GLOBALS["HTTP_POST_VARS"]["d68_matric"]:$this->d68_matric);
     }else{
       $this->d68_codigo = ($this->d68_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["d68_codigo"]:$this->d68_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($d68_codigo){ 
      $this->atualizacampos();
     if($this->d68_matric == null ){ 
       ...
       $this->d68_codigo = $d68_codigo; 
     if(($this->d68_codigo == null) || ($this->d68_codigo == "") ){ 
       $this->erro_sql = " Campo d68_codigo nao declarado.";
     ...
     $sql = "insert into debcontapedidomatric(
                                       d68_codigo 
                                      ,d68_matric 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->d68_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($d68_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($d68_codigo!=null){
       $sql .= " d68_codigo = $this->d68_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->d68_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Matricula do debito em conta nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->d68_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Matricula do debito em conta nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->d68_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($d68_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($d68_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Matricula do debito em conta nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$d68_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Matricula do debito em conta nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$d68_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $d68_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from debcontapedidomatric ";
     $sql .= "      inner join iptubase  on  iptubase.j01_matric = debcontapedidomatric.d68_matric";
     $sql .= "      inner join debcontapedido  on  debcontapedido.d63_codigo = debcontapedidomatric.d68_codigo";
     ...
     if($dbwhere==""){
       if($d68_codigo!=null ){
         $sql2 .= " where debcontapedidomatric.d68_codigo = $d68_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
