<?
	...
	class cl_cute212020
	{
		...
		function cl_cute212020()
		{
			//classes dos rotulos dos campos
			$this->rotulo = new rotulo("cute212020");
		...
		function incluir($si201_sequencial)
		{
			...
			if ($si201_sequencial == "" || $si201_sequencial == null) {
				$result = db_query("select nextval('cute212020_si201_sequencial_seq')");
				if ($result == false) {
					$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
					$this->erro_sql = "Verifique o cadastro da sequencia: cute212020_si201_sequencial_seq do campo: si201_sequencial";
					$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "0";
				...
				$result = db_query("select last_value from cute212020_si201_sequencial_seq");
			...
			if ($result == false) {
				...
				if (strpos(strtolower($this->erro_codfontrecursos), "duplicate key") != 0) {
					$this->erro_sql = "cute212020 ($this->si201_sequencial) nao Incluído. Inclusao Abortada.";
					$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_codfontrecursos = "cute212020 já Cadastrado";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				} else {
					$this->erro_sql = "cute212020 ($this->si201_sequencial) nao Incluído. Inclusao Abortada.";
					$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
...
//			}
			...
			if ($result == false) {
				$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
				$this->erro_sql = "cute212020 nao Alterado. Alteracao Abortada.\n";
				$this->erro_sql .= "Valores : " . $this->si201_sequencial;
				$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				$this->erro_status = "0";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_codfontrecursos = "";
					$this->erro_sql = "cute212020 nao foi Alterado. Alteracao Executada.\n";
					$this->erro_sql .= "Valores : " . $this->si201_sequencial;
					$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "1";
...
//			}
			...
			if ($result == false) {
				$this->erro_codfontrecursos = str_replace("", "", @pg_last_error());
				$this->erro_sql = "cute212020 nao Excluído. Exclusão Abortada.\n";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_codfontrecursos = "";
					$this->erro_sql = "cute212020 nao Encontrado. Exclusão não Efetuada.\n";
					$this->erro_sql .= "Valores : " . $si201_sequencial;
					$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
					$this->erro_status = "1";
		...
		function sql_record($sql)
		{
			...
			if ($this->numrows == 0) {
				$this->erro_codfontrecursos = "";
				$this->erro_sql = "Record Vazio na Tabela:cute212020";
				$this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_codfontrecursos . " \n"));
				$this->erro_status = "0";
		...
		function sql_query($si201_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
		{
			...
			$sql .= " from cute212020 ";
			$sql .= "      left  join cute102020  on  cute102020.si199_sequencial = cute212020.si201_reg10";
			$sql2 = "";
			if ($dbwhere == "") {
				if ($si201_sequencial != null) {
					$sql2 .= " where cute212020.si201_sequencial = $si201_sequencial ";
				}
			} else if ($dbwhere != "") {
				$sql2 = " where $dbwhere";
			}
