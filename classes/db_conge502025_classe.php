<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge502025
class cl_conge502025 {
  ...
  public $campos = "
                 ...
                 si186_codorgao = varchar(2) = C�digo do �rg�o
                 si186_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si186_nroconvenioconge = varchar(30) = N�mero do conv�nio original ou instr
                 si186_dataassinaturaconvoriginalconge = date = Data da assinatura do conv�nio original
                 si186_dscmedidaadministrativa = varchar(500) = Descri��o das medidas administrativas
                 ...
                 si186_adocaomedidasadmin = int8 = Ado��o das medidas administrativas
                 si186_nrocpfrespmedidaconge = varchar(11) = N�mero do CPF do respons�vel pelas medid
                 si186_dsccargorespmedidaconge = varchar(50) = Cargo do respons�vel pelas medidas adm
                 si186_mes = int8 = M�s
                 si186_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conge502025");
  ...
  function incluir ($si186_sequencial) {
     ...
     if ($this->si186_dscmedidaadministrativa == null ) {
       $this->erro_sql = " Campo Descri��o das medidas administrativas n�o informado.";
     ...
     if ($this->si186_datainiciomedida == null ) {
       $this->erro_sql = " Campo Data inicial das medidas administrativas n�o informado.";
     ...
     if ($this->si186_datafinalmedida == null ) {
       $this->erro_sql = " Campo Data final das medidas administrativas n�o informado.";
     ...
     if ($this->si186_adocaomedidasadmin == null ) {
       $this->erro_sql = " Campo Ado��o das medidas administrativas n�o informado.";
     ...
     if ($this->si186_nrocpfrespmedidaconge == null ) {
       $this->erro_sql = " Campo N�mero do CPF do respons�vel pelas medid n�o informado.";
     ...
     if ($this->si186_dsccargorespmedidaconge == null ) {
       $this->erro_sql = " Campo Cargo do respons�vel pelas medidas adm n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Detalhamento das Medidas Administrativas ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Detalhamento das Medidas Administrativas j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Detalhamento das Medidas Administrativas ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function excluir ($si186_sequencial=null,$dbwhere=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Detalhamento das Medidas Administrativas nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Detalhamento das Medidas Administrativas nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si186_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge502025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si186_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge502025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si186_sequencial!=null ) {
         $sql2 .= " where conge502025.si186_sequencial = $si186_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
