<?
//MODULO: sicom
//CLASSE DA ENTIDADE \d flpgo102025
class cl_flpgo102025 {
    ...
    var $si195_vinculoefetivoapo = null;
    var $si195_opcaoremuneracaocargoefetivo = null;
    ...
    var $campos = "
                 ...
                 si195_codvinculopessoa = int8 = Codigo do vinculo do agente publico
                 si195_regime = varchar(1) = Civil (C) ou Militar (M)
                 si195_indtipopagamento = varchar(1) = Tipo de pagamento
                 si195_dsctipopagextra = varchar(150) = Descricao do tipo de pagamento extra
                 si195_indsituacaoservidorpensionista = varchar(1) = Indica a situacao do servidor publico
                 si195_dataTransferenciaReserva = date = Data de transferencia reserva
                 si195_nrocpfinstituidor = varchar(11) = Numero do CPF do instituidor da pensao
                 si195_datobitoinstituidor = date = Data de cebito do instituidor
                 si195_tipodependencia = int8 = Tipo de dependencia do pensionista
                 ...
                 si195_datconcessaoaposentadoriapensao = date = Data de concessao da aposentadoria
                 si195_datfastpreliminar = date = Data do afastamento preeliminar a aposentadoria
                 si195_dsccargo = varchar(120) = Nome do cargo
                 si195_codcargo = int8 = Codigo do cargo
                 si195_sglcargo = varchar(3) = Sigla de Cargo
                 si195_dscapo = varchar(3) = Descricao do tipo de cargo do agente politico
                 si195_natcargo = int8 = Natureza do Cargo
                 si195_vinculoefetivoapo = int4 = Indicador de outro vinculo efetivo
                 si195_opcaoremuneracaocargoefetivo = int4 = Indicador de opcao pela remuneracao de cargo efetivo
                 si195_indcessao = varchar(3) = Servidor Cedido com onus
                 si195_dsclotacao = varchar(250) = Descricao da lotacao
                 si195_indsalaaula = varchar(1) = Atividade em sala de aula para o professor
                 si195_dedicacaoexclusiva = varchar(1) = Dedicacao exclusiva
                 si195_vlrcargahorariasemanal = int8 = Valor da carga horaria
                 si195_datefetexercicio = date = Data de exercicio no cargo
                 si195_datcomissionado = date = Data de ingresso no cargo comissionado
                 si195_datexclusao = date = Data de exclusao
                 si195_datcomissionadoexclusao = date = Data de termino do exercicio no cargo comissionado
                 si195_vlrremuneracaobruta = float8 = Valor total dos rendimentos
                 si195_vlrdescontos = float8 = Valor das deducoes obrigatorias
                 si195_vlrremuneracaoliquida = float8 = Valor total dos rendimentos liquidos
                 si195_natsaldoliquido = varchar(1) = Natureza do saldo remuneratario liquido
                 si195_mes = int8 = si195_mes
                 si195_inst = int8 = si195_inst
                 ";
    //funcao construtor da classe
    function cl_flpgo102025() {
        //classes dos rotulos dos campos
        $this->rotulo = new rotulo("flpgo102025");
    ...
    function atualizacampos($exclusao=false) {
        if($exclusao==false){
            ...
            $this->si195_vinculoefetivoapo = ($this->si195_vinculoefetivoapo == ""?@$GLOBALS["HTTP_POST_VARS"]["si195_vinculoefetivoapo"]:$this->si195_vinculoefetivoapo);
            $this->si195_opcaoremuneracaocargoefetivo = ($this->si195_opcaoremuneracaocargoefetivo == ""?@$GLOBALS["HTTP_POST_VARS"]["si195_opcaoremuneracaocargoefetivo"]:$this->si195_opcaoremuneracaocargoefetivo);
    ...
    function incluir ($si195_sequencial){
        ...
        if($this->si195_regime == null ){
            $this->erro_sql = " Campo Civil (C) ou Militar (M) nao informado.";
        ...
        if($this->si195_indtipopagamento == null ){
            $this->erro_sql = " Campo Tipo de pagamento nao informado.";
        ...
        if($this->si195_indsituacaoservidorpensionista == null ){
            $this->erro_sql = " Campo Indica a situacao do servidor publico nao informado.";
        ...
        if($this->si195_vlrremuneracaobruta == null ){
            $this->erro_sql = " Campo Valor total dos rendimentos nao informado.";
        ...
        if($this->si195_vlrremuneracaoliquida == null ){
            $this->erro_sql = " Campo Valor total dos rendimentos liquidos nao informado.";
        ...
        if($this->si195_vlrdescontos == null ){
            $this->erro_sql = " Campo Valor das deducoes obrigatorias nao informado.";
        ...
        if($this->si195_mes == null ){
            $this->erro_sql = " Campo si195_mes nao informado.";
        ...
        if($this->si195_inst == null ){
            $this->erro_sql = " Campo si195_inst nao informado.";
        ...
        if($si195_sequencial == "" || $si195_sequencial == null ){
            $result = db_query("select nextval('flpgo102025_si195_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: flpgo102025_si195_sequencial_seq do campo: si195_sequencial";
                $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
                $this->erro_status = "0";
                return false;
            ...
            $result = db_query("select last_value from flpgo102025_si195_sequencial_seq");
            if(($result != false) && (pg_result($result,0,0) < $si195_sequencial)){
                $this->erro_sql = " Campo si195_sequencial maior que ï¿½ltimo nï¿½mero da sequencia.";
        ...
        $sql = "insert into flpgo102025(
                                      ...
                                      ,si195_dscapo
                                      ,si195_natcargo
                                      ,si195_vinculoefetivoapo
                                      ,si195_opcaoremuneracaocargoefetivo
                                      ,si195_indcessao
                                      ,si195_dsclotacao
                                      ,si195_indsalaaula
                ...
                values (
                               ...
                               ,".($this->si195_vinculoefetivoapo == "null" || $this->si195_vinculoefetivoapo == "" ? "null":"'".$this->si195_vinculoefetivoapo."'")."
                               ,".($this->si195_opcaoremuneracaocargoefetivo == "null" || $this->si195_opcaoremuneracaocargoefetivo == "" ? "null":"'".$this->si195_opcaoremuneracaocargoefetivo."'")."
        ...
        $result = db_query($sql);
            ...
            if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
                $this->erro_sql   = "flpgo102025 ($this->si195_sequencial) nao Incluído. Inclusao Abortada.";
                $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
                $this->erro_banco = "flpgo102025 já Cadastrado";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
            }else{
                $this->erro_sql   = "flpgo102025 ($this->si195_sequencial) nao Incluï¿½do. Inclusao Abortada.";
                $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
            }
            $this->erro_status = "0";
    ...
    function alterar ($si195_sequencial=null) {
        ...
        if(trim($this->si195_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si195_sequencial"])){
            ...
            if(trim($this->si195_sequencial) == null ){
                $this->erro_sql = " Campo si195_sequencial nao informado.";
        ...
        if(trim($this->si195_dsctipopagextra)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si195_dsctipopagextra"])){
            ...
            if(trim($this->si195_dsctipopagextra) == null ){
                $this->erro_sql = " Campo Descriï¿½ï¿½o do tipo de pagamento extra nao informado.";
        ...
        if(trim($this->si195_dsccargo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si195_dsccargo"])){
            ...
            if(trim($this->si195_dsccargo) == null ){
                $this->erro_sql = " Campo Nome do cargo nao informado.";
        ...
        if(trim($this->si195_datefetexercicio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si195_datefetexercicio_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["si195_datefetexercicio_dia"] !="") ){
            ...
            if(trim($this->si195_datefetexercicio) == null ){
                $this->erro_sql = " Campo Data de exercicio no cargo nao informado.";
        ...
        if(trim($this->si195_natsaldoliquido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si195_natsaldoliquido"])){
            ...
            if(trim($this->si195_natsaldoliquido) == null ){
                $this->erro_sql = " Campo Natureza do saldo remuneratorio liquido nao informado.";
...
//        }
        ...
        if($result==false){
            $this->erro_banco = str_replace("","",@pg_last_error());
            $this->erro_sql   = "flpgo102025 nao Alterado. Alteracao Abortada.\n";
            $this->erro_sql .= "Valores : ".$this->si195_sequencial;
            $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
            $this->erro_status = "0";
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "flpgo102025 nao foi Alterado. Alteracao Executada.\n";
                $this->erro_sql .= "Valores : ".$this->si195_sequencial;
                $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
                $this->erro_status = "1";
    ...
    function excluir ($si195_sequencial=null,$dbwhere=null) {
        ...
        if($result==false){
            $this->erro_banco = str_replace("","",@pg_last_error());
            $this->erro_sql   = "flpgo102025 nao Excluido. exclusao Abortada.\n";
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "flpgo102025 nao Encontrado. exclusao nao Efetuada.\n";
                $this->erro_sql .= "Valores : ".$si195_sequencial;
                $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
                $this->erro_status = "1";
    ...
    function sql_record($sql) {
        ...
        if($this->numrows==0){
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:flpgo102025";
            $this->erro_msg   = "Usuario: \n\n ".$this->erro_sql." \n\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si195_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
        ...
        $sql .= " from flpgo102025 ";
        $sql2 = "";
        if($dbwhere==""){
            if($si195_sequencial!=null ){
                $sql2 .= " where flpgo102025.si195_sequencial = $si195_sequencial ";
            }
        }else if($dbwhere != ""){
            $sql2 = " where $dbwhere";
        }
