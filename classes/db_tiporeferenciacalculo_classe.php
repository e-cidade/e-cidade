   ...
   function incluir ($la61_sequencial){ 
     ...
     $sql = "insert into tiporeferenciacalculo(
                ...
                values (
                               ...
                               ,".($this->la61_tiporeferencialnumerico == "null" || $this->la61_tiporeferencialnumerico == ""?"null":"'".$this->la61_tiporeferencialnumerico."'")."
                               ,".($this->la61_atributobase == "null" || $this->la61_atributobase == ""?"null":"'".$this->la61_atributobase."'")."
                               ,".($this->la61_tipocalculo == "null" || $this->la61_tipocalculo == ""?"null":"'".$this->la61_tipocalculo."'")."
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
