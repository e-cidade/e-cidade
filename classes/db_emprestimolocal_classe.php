...
//MODULO: Biblioteca
//CLASSE DA ENTIDADE emprestimolocal
class cl_emprestimolocal { 
   ...
   var $campos = "
                 bi20_codigo = int8 = Código 
                 bi20_descr = char(30) = Descrição do Local 
                 ";
   //funcao construtor da classe 
   function cl_emprestimolocal() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("emprestimolocal"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->bi20_descr = ($this->bi20_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["bi20_descr"]:$this->bi20_descr);
     }else{
       $this->bi20_codigo = ($this->bi20_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["bi20_codigo"]:$this->bi20_codigo);
     }
   }
   ...
   function incluir ($bi20_codigo){ 
      $this->atualizacampos();
     if($this->bi20_descr == null ){ 
       $this->erro_sql = " Campo Descrição do Local nao Informado.";
       $this->erro_campo = "bi20_descr";
       $this->erro_banco = "";
     ...
     $sql = "insert into emprestimolocal(
                                       bi20_codigo 
                                      ,bi20_descr 
                       )
                values (
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Local de Empréstimo ($this->bi20_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Local de Empréstimo já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Local de Empréstimo ($this->bi20_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($bi20_codigo=null) { 
      $this->atualizacampos();
     $sql = " update emprestimolocal set ";
     $virgula = "";
     ...
     if(trim($this->bi20_descr)!="" || isset($GLOBALS["HTTP_POST_VARS"]["bi20_descr"])){ 
       $sql  .= $virgula." bi20_descr = '$this->bi20_descr' ";
       $virgula = ",";
       if(trim($this->bi20_descr) == null ){ 
         $this->erro_sql = " Campo Descrição do Local nao Informado.";
         $this->erro_campo = "bi20_descr";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Local de Empréstimo nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->bi20_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($bi20_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Local de Empréstimo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$bi20_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:emprestimolocal";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $bi20_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from emprestimolocal ";
     $sql2 = "";
     if($dbwhere==""){
       if($bi20_codigo!=null ){
         $sql2 .= " where emprestimolocal.bi20_codigo = $bi20_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
