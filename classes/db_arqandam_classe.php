...
class cl_arqandam { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->p69_codarquiv = ($this->p69_codarquiv == ""?@$GLOBALS["HTTP_POST_VARS"]["p69_codarquiv"]:$this->p69_codarquiv);
       $this->p69_codandam = ($this->p69_codandam == ""?@$GLOBALS["HTTP_POST_VARS"]["p69_codandam"]:$this->p69_codandam);
       $this->p69_arquivado = ($this->p69_arquivado == "f"?@$GLOBALS["HTTP_POST_VARS"]["p69_arquivado"]:$this->p69_arquivado);
     }else{
     }
   }
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "andamento do arquivamento nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "andamento do arquivamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "andamento do arquivamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "andamento do arquivamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="arqandam.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from arqandam ";
     $sql .= "      inner join procandam  on  procandam.p61_codandam = arqandam.p69_codandam";
     $sql .= "      inner join procarquiv  on  procarquiv.p67_codarquiv = arqandam.p69_codarquiv";
