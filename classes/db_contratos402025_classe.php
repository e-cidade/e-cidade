<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos402025
class cl_contratos402025 {
   ...
   var $si91_exerciciocontrato = null;
   // cria propriedade com as variaveis do arquivo
   var $campos = "
                 si91_sequencial = int8 = sequencial
                 si91_tiporegistro = int8 = Tipo do  registro
                 si91_codorgao = varchar(2) = C�digo do �rg�o
                 si91_codunidadesub = varchar(8) = C�digo da unidade
                 si91_nrocontrato = int8 = N�mero do  Contrato Original
                 si91_dtassinaturacontoriginal = date = Data da assinatura  do Contrato
                 si91_datarescisao = date = Data da Rescis�o Contratual
                 si91_valorcancelamentocontrato = float8 = Valor do  Cancelamento do Contrato
                 si91_mes = int8 = M�s
                 si91_instit = int8 = Institui��o
                 si91_codunidadesubatual = varchar(8) = C�digo da unidade atual;
                 si91_exerciciocontrato = int = Exercicio Contrato;
                 ";
   //funcao construtor da classe
   function cl_contratos402025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos402025");
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si91_exerciciocontrato = ($this->si91_exerciciocontrato == "" ? @$GLOBALS["HTTP_POST_VARS"]["si91_exerciciocontrato"] : $this->si91_exerciciocontrato);
     }else{
       $this->si91_sequencial = ($this->si91_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["si91_sequencial"]:$this->si91_sequencial);
     }
   }
   ...
   function incluir ($si91_sequencial){
     ...
     if($si91_sequencial == "" || $si91_sequencial == null ){
       $result = db_query("select nextval('contratos402025_si91_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos402025_si91_sequencial_seq do campo: si91_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos402025_si91_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si91_sequencial)){
         $this->erro_sql = " Campo si91_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into contratos402025(
                                       si91_sequencial
                                      ,si91_tiporegistro
                                      ,si91_codorgao
                                      ,si91_codunidadesub
                ...
                values (
                               ...
                               ,". ($this->si91_exerciciocontrato == "null" || $this->si91_exerciciocontrato == "" ? "null" : $this->si91_exerciciocontrato ). "
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos402025 ($this->si91_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos402025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos402025 ($this->si91_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si91_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos402025 set ";
     $virgula = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos402025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si91_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos402025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si91_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si91_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos402025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si91_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos402025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos402025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si91_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos402025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si91_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contratos402025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si91_sequencial!=null ){
         $sql2 .= " where si91_sequencial = $si91_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   function sql_query_file ( $si91_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     if($dbwhere==""){
       if($si91_sequencial!=null ){
         $sql2 .= " where contratos402025.si91_sequencial = $si91_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
