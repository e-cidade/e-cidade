...
class cl_solicita
{
 ...
 from ( select pc11_numero,
   ...
   * @return string
   */
  function sql_query_processo_orcamento($sCampos = "*", $sOrdem = null, $sWhere = null)
  {

    $sSql  = " select {$sCampos} ";
    $sSql .= "   from solicita   ";
    $sSql .= "        left join solicitem on solicitem.pc11_numero = solicita.pc10_numero                        ";
    $sSql .= "        left join pcprocitem on pcprocitem.pc81_solicitem = solicitem.pc11_codigo                  ";
    $sSql .= "        left join pcproc on pcproc.pc80_codproc = pcprocitem.pc81_codproc                          ";
    $sSql .= "        left join pcorcamitemproc on pcorcamitemproc.pc31_pcprocitem = pcprocitem.pc81_codprocitem ";
    $sSql .= "        left join pcorcamitem on pcorcamitem.pc22_orcamitem = pcorcamitemproc.pc31_orcamitem       ";
    $sSql .= "        left join pcorcam on pcorcamitem.pc22_codorc = pcorcam.pc20_codorc                         ";
