...
class cl_orcprojeto
{
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->o39_justi = ($this->o39_justi == "" ? @$GLOBALS["HTTP_POST_VARS"]["o39_justi"] : $this->o39_justi);
      if ($this->o39_data == "") {
  ...
  function incluir($o39_codproj)
  {
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      ...
      $resac = db_query("insert into db_acount values($acount,969,17714,'','" . AddSlashes(pg_result($resaco, 0, 'o39_justi')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
    }
    return true;
  }
