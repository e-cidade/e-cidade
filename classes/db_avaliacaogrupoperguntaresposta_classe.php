...
class cl_avaliacaogrupoperguntaresposta
{
    ...
    public function cl_avaliacaogrupoperguntaresposta()
    {
    ...
    public function incluir($db108_sequencial)
    {
        $this->atualizacampos();
    ...
    public function alterar($db108_sequencial=null)
    {
        $this->atualizacampos();
        ...
        if ($result==false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Avaliação Grupo Pergunta Resposta nao Alterado. Alteracao Abortada.\\n";
            $this->erro_sql .= "Valores : ".$this->db108_sequencial;
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result)==0) {
                $this->erro_banco = "";
                $this->erro_sql = "Avaliação Grupo Pergunta Resposta nao foi Alterado. Alteracao Executada.\\n";
                $this->erro_sql .= "Valores : ".$this->db108_sequencial;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
    ...
    public function excluir($db108_sequencial=null, $dbwhere=null)
    {
        if (!isset($_SESSION["DB_usaAccount"])) {
        ...
        if ($result==false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Avaliação Grupo Pergunta Resposta nao Excluído. Exclusão Abortada.\\n";
            ...
            if (pg_affected_rows($result)==0) {
                $this->erro_banco = "";
                $this->erro_sql = "Avaliação Grupo Pergunta Resposta nao Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : ".$db108_sequencial;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
    ...
    // funcao do sql
    public function sql_query($db108_sequencial=null, $campos="*", $ordem=null, $dbwhere="")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    public function sql_query_pergunta($db108_sequencial=null, $campos="*", $ordem=null, $dbwhere="")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    // funcao do sql
    public function sql_query_file($db108_sequencial=null, $campos="*", $ordem=null, $dbwhere="")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_avaliacao($db108_sequencial=null, $campos="*", $ordem=null, $dbwhere="")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_UltimaResposta($db108_sequencial=null, $campos="*", $ordem=null, $dbwhere="")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
