...
class cl_saltes
{
  ...
  function sql_query($k13_conta = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= "      left join contabancaria on contabancaria.db83_conta = conplanoconta.c63_conta and c63_tipoconta = db83_tipoconta";
  ...
  function sql_query_anousu($k13_conta = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= "      LEFT JOIN conplanocontabancaria ON c56_codcon = c60_codcon AND c56_anousu = c60_anousu";
    $sql .= "      LEFT JOIN contabancaria on contabancaria.db83_sequencial = c56_contabancaria";
    $sql .= "      LEFT JOIN db_operacaodecredito ON op01_sequencial = db83_codigoopcredito::int ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($k13_conta != null) {
        $sql2 .= " where saltes.k13_conta = $k13_conta ";
  ...
  function sql_query_orcamento_recurso($iConta = null, $sInstituicoes, $iAnoUsu, $sCampos = "*", $sOrdem = null, $sWhere = "", $sGroupBy)
  {
  ...
  function sql_query_convenio_conta($k13_conta = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= "     left join placaixarec on placaixarec.k81_conta = saltes.k13_conta                                    ";
