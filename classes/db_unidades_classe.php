...
class cl_unidades {
   ...
   var $campos = "
                 ...
                 sd02_i_tipounidade = int4 = tipo unidade
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->sd02_i_tipounidade = ($this->sd02_i_tipounidade == ""?@$GLOBALS["HTTP_POST_VARS"]["sd02_i_tipounidade"]:$this->sd02_i_tipounidade);
     }else{
       $this->sd02_i_codigo = ($this->sd02_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd02_i_codigo"]:$this->sd02_i_codigo);
     }
   }
   ...
   function incluir ($sd02_i_codigo){
     ...
     if($this->sd02_v_cnes == null ){
       $this->erro_sql = " Campo CNES nao Informado.";
       $this->erro_campo = "sd02_v_cnes";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->sd02_i_tipounidade == null ){
       $this->sd02_i_tipounidade = "null";
     }
   ...
   public function alterar ($sd02_i_codigo=null) {
     ...
     if(trim($this->sd02_i_tipounidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["sd02_i_tipounidade"])){
       $sql  .= $virgula." sd02_i_tipounidade = '$this->sd02_i_tipounidade' ";
       $virgula = ",";
     }
