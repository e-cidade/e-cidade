...
class cl_ops112025
{
  ...
  var $campos = "
                 ...
                 si133_codreduzidoop = int8 = C�digo  Identificador da  Ordem
                 si133_codunidadesub = varchar(8) = C�digo da unidade
                 si133_nroop = int8 = N�mero da  Ordem de  Pagamento
                 si133_dtpagamento = date = Data de  pagamento da  OP
                 si133_tipopagamento = int8 = Tipo do  Pagamento
                 si133_nroempenho = int8 = N�mero do  empenho
                 si133_dtempenho = date = Data do empenho
                 si133_nroliquidacao = int8 = N�mero da  Liquida��o
                 si133_dtliquidacao = date = Data da  Liquida��o do  empenho
                 si133_codfontrecursos = int8 = C�digo da fonte de recursos
                 si133_codco = varchar(4) = C�digo do Acompanhamento Or�ament�rio
                 si133_valorfonte = float8 = Valor bruto do pagamento por fonte
                 si133_tipodocumentocredor = int8 = Tipo de  Documento do  credor
                 si133_nrodocumento = varchar(14) = N�mero do documento do credor
                 si133_codorgaoempop = varchar(2) = C�digo do �rg�o
                 si133_codunidadeempop = varchar(8) = C�digo da  unidade
                 si133_mes = int8 = M�s
                 si133_reg10 = int8 = reg10
                 si133_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ops112025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ops112025");
  ...
  function incluir($si133_sequencial)
  {
    ...
    if ($si133_sequencial == "" || $si133_sequencial == null) {
      $result = db_query("select nextval('ops112025_si133_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ops112025_si133_sequencial_seq do campo: si133_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ops112025_si133_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si133_sequencial)) {
        $this->erro_sql = " Campo si133_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ops112025 ($this->si133_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ops112025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ops112025 ($this->si133_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si133_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops112025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si133_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops112025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si133_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si133_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops112025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops112025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si133_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ops112025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si133_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ops112025 ";
    $sql .= "      left  join ops102020  on  ops102020.si132_sequencial = ops112025.si133_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si133_sequencial != null) {
        $sql2 .= " where ops112025.si133_sequencial = $si133_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
