...
class cl_atolegal
{
  ...
  var $ed05_i_aparecerelatorio = false;
  ...
  var $campos = "
                 ...
                 ed05_i_aparecerelatorio = bool = Aparece no Relatório 
                 ";
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->ed05_i_aparecerelatorio = ($this->ed05_i_aparecerelatorio == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed05_i_aparecerelatorio"] : $this->ed05_i_aparecerelatorio);
    } else {
      $this->ed05_i_codigo = ($this->ed05_i_codigo == "" ? @$GLOBALS["HTTP_POST_VARS"]["ed05_i_codigo"] : $this->ed05_i_codigo);
    }
  }
  ...
  function incluir($ed05_i_codigo)
  {
    ...
    if ($this->ed05_i_aparecerelatorio == null) {
      $this->erro_sql = " Campo Aparece no Relatório nao Informado.";
      $this->erro_campo = "ed05_i_aparecerelatorio";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
