<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf102017
class cl_dclrf102017 {
    ...
    var $si157_publiclrf = 0;
    var $si157_dtpublicacaorelatoriolrf  = null;
    var $si157_tpbimestre = 0;
    var $si157_metarrecada = 0;
    var $si157_dscmedidasadotadas = 0;
    var $si157_mes = 0;
    var $si157_instit = 0;
    ...
    var $campos = "
                 ...
                 si157_vlsaldoatualconcgarantiainterna = float8 = Saldo atual das concessões de garantia interna
                 si157_vlsaldoatualconcgarantia = float8 = Saldo atual das  concessões
                 si157_vlsaldoatualcontragarantiainterna = float8 = Saldo atual das contragarantias  interna recebidas
                 si157_vlsaldoatualcontragarantiaexterna = float8 = Saldo atual das contragarantias externas recebidas
                 si157_medidascorretivas = float8 = Medidas corretivas adotadas
                 ...
                 si157_publiclrf = float8 = Publicação dos relatórios da LRF
                 si157_dtpublicacaorelatoriolrf = date = Data de publicação dos relatórios da LRF
                 si157_tpbimestre = int8 = Periodo a que se refere a data de publicação da LRF
                 si157_metarrecada = int8 = Atingimento da meta bimestral de arrecadação
                 si157_dscmedidasadotadas = varchar(4000) = Medidas adotadas e a adotar
                 si157_mes = int8 = Mês 
                 si157_instit = int8 = Instituição 
                 ";
    //funcao construtor da classe
    function cl_dclrf102017() {
        //classes dos rotulos dos campos
        $this->rotulo = new rotulo("dclrf102017");
    ...
    function atualizacampos($exclusao=false) {
        if($exclusao==false){
            ...
            $this->si157_publiclrf = ($this->si157_publiclrf == ""?@$GLOBALS["HTTP_POST_VARS"]["si157_publiclrf"]:$this->si157_publiclrf);
            $this->si157_dtpublicacaorelatoriolrf = ($this->si157_dtpublicacaorelatoriolrf == ""?@$GLOBALS["HTTP_POST_VARS"]["si157_dtpublicacaorelatoriolrf"]:$this->si157_dtpublicacaorelatoriolrf);
    ...
    function incluir ($si157_sequencial){
        ...
        if($this->si157_vlsaldoatualconcgarantiainterna == null ){
            $this->si157_vlsaldoatualconcgarantiainterna = "0";
        }
        ...
        if($this->si157_vlsaldoatualcontragarantiainterna == null ){
            $this->si157_vlsaldoatualcontragarantiainterna = "0";
        }
        if($this->si157_vlsaldoatualcontragarantiaexterna == null ){
            $this->si157_vlsaldoatualcontragarantiaexterna = "0";
        }
        if($this->si157_medidascorretivas == null ){
            $this->si157_medidascorretivas = "0";
        }
        ...
        if($this->si157_publiclrf == null ){
            $this->si157_publiclrf = "0";
        }
        if($this->si157_dtpublicacaorelatoriolrf == null ){
            $this->si157_dtpublicacaorelatoriolrf = "0";
        }
        if($this->si157_tpbimestre == null ){
            $this->si157_tpbimestre = "0";
        }
        if($this->si157_metarrecada == null ){
            $this->si157_metarrecada = "0";
        }
        if($this->si157_dscmedidasadotadas == null ){
            $this->si157_dscmedidasadotadas = "0";
        }
        ...
        if($si157_sequencial == "" || $si157_sequencial == null ){
            $result = db_query("select nextval('dclrf102017_si157_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf102017_si157_sequencial_seq do campo: si157_sequencial";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "0";
                return false;
            ...
            $result = db_query("select last_value from dclrf102017_si157_sequencial_seq");
        ...
        if($result==false){die($sql);
            ...
            if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
                $this->erro_sql   = "dclrf102017 ($this->si157_sequencial) nao Incluído. Inclusao Abortada.";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_banco = "dclrf102017 já Cadastrado";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            }else{
                $this->erro_sql   = "dclrf102017 ($this->si157_sequencial) nao Incluído. Inclusao Abortada.";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    function alterar ($si157_sequencial=null) {
        ...
        if($result==false){
            $this->erro_banco = str_replace("\n","",@pg_last_error());
            $this->erro_sql   = "dclrf102017 nao Alterado. Alteracao Abortada.\\n";
            $this->erro_sql .= "Valores : ".$this->si157_sequencial;
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "dclrf102017 nao foi Alterado. Alteracao Executada.\\n";
                $this->erro_sql .= "Valores : ".$this->si157_sequencial;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
    ...
    function excluir ($si157_sequencial=null,$dbwhere=null) {
        ...
        if($result==false){
            $this->erro_banco = str_replace("\n","",@pg_last_error());
            $this->erro_sql   = "dclrf102017 nao Excluído. Exclusão Abortada.\\n";
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "dclrf102017 nao Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : ".$si157_sequencial;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
    ...
    function sql_record($sql) {
        ...
        if($this->numrows==0){
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:dclrf102017";
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si157_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
        ...
        $sql .= " from dclrf102017 ";
        $sql2 = "";
        if($dbwhere==""){
            if($si157_sequencial!=null ){
                $sql2 .= " where dclrf102017.si157_sequencial = $si157_sequencial ";
            }
        }else if($dbwhere != ""){
            $sql2 = " where $dbwhere";
        }
