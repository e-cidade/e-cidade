...
class cl_afasta
{
  ...
  var $r45_codigoafasta = null;
  var $r45_mesmadoenca = null;
  ...
  var $campos = "
                 ...
                 r45_codigoafasta = varchar = Motivos de Afastamentos eSocial
                 r45_mesmadoenca = varchar(1) = Mesma Doença do Afastamento Anterior
                 ";
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->r45_codigoafasta = ($this->r45_codigoafasta == "" ? @$GLOBALS["HTTP_POST_VARS"]["r45_codigoafasta"] : $this->r45_codigoafasta);
      $this->r45_mesmadoenca = ($this->r45_mesmadoenca == "" ? @$GLOBALS["HTTP_POST_VARS"]["r45_mesmadoenca"] : $this->r45_mesmadoenca);
    } else {
      $this->r45_codigo = ($this->r45_codigo == "" ? @$GLOBALS["HTTP_POST_VARS"]["r45_codigo"] : $this->r45_codigo);
    }
  }
  ...
  function incluir($r45_codigo)
  {
    ...
    if (($this->r45_codigoafasta == null) || ($this->r45_codigoafasta == "")) {
      $this->erro_sql = " Campo Codigo Afastamento nao declarado.";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
    ...
    if (($this->r45_mesmadoenca == null) || ($this->r45_mesmadoenca == "")) {
      $this->erro_sql = " Campo Mesma Doença do Afastamento Anterior nao declarado.";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
    ...
    $sql = "insert into afasta(
                ...
                values (
                               ...
                               ,'$this->r45_codigoafasta'
                               ,'$this->r45_mesmadoenca'
  ...
  function alterar($r45_codigo = null)
  {
    ...
    if (trim($this->r45_codigoafasta) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r45_codigoafasta"])) {
      $sql  .= $virgula . " r45_codigoafasta = '$this->r45_codigoafasta' ";
      $virgula = ",";
      if (trim($this->r45_codigoafasta) == null) {
        $this->erro_sql = " Campo Retorno Sefip não informado.";
        $this->erro_campo = "r45_codigoafasta";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "0";
    ...
    if (trim($this->r45_mesmadoenca) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r45_mesmadoenca"])) {
      $sql  .= $virgula . " r45_mesmadoenca = '$this->r45_mesmadoenca' ";
      $virgula = ",";
      if (trim($this->r45_mesmadoenca) == null) {
        $this->erro_sql = " Campo Retorno Sefip não informado.";
        $this->erro_campo = "r45_mesmadoenca";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "0";
