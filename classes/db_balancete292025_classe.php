<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete292025
class cl_balancete292025
{
  ...
  function cl_balancete292025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete292025");
  ...
  function incluir($si241_sequencial)
  {
    ...
    if ($this->si241_tiporegistro == null) {
      $this->erro_sql = " Campo si241_tiporegistro n�o informado.";
    ...
    if ($this->si241_contacontabil == null) {
      $this->erro_sql = " Campo si241_contacontabil n�o informado.";
    ...
    if ($this->si241_atributosf == null) {
      $this->erro_sql = " Campo si241_atributosf n�o informado.";
    ...
    if ($this->si241_dividaconsolidada == null) {
        $this->erro_sql = " Campo si241_dividaconsolidada n�o informado.";
    ...
    if ($this->si241_saldoinicialfontsf == null) {
      $this->erro_sql = " Campo si241_saldoinicialfontsf n�o informado.";
    ...
    if ($this->si241_naturezasaldoinicialfontsf == null) {
      $this->erro_sql = " Campo si241_naturezasaldoinicialfontsf n�o informado.";
    ...
    if ($this->si241_totaldebitosfontsf == null) {
      $this->erro_sql = " Campo si241_totaldebitosfontsf n�o informado.";
    ...
    if ($this->si241_totalcreditosfontsf == null) {
      $this->erro_sql = " Campo si241_totalcreditosfontsf n�o informado.";
    ...
    if ($this->si241_saldofinalfontsf == null) {
      $this->erro_sql = " Campo si241_saldofinalfontsf n�o informado.";
    ...
    if ($this->si241_naturezasaldofinalfontsf == null) {
      $this->erro_sql = " Campo si241_naturezasaldofinalfontsf n�o informado.";
    ...
    if ($this->si241_mes == null) {
      $this->erro_sql = " Campo si241_mes n�o informado.";
    ...
    if ($this->si241_instit == null) {
      $this->erro_sql = " Campo si241_instit n�o informado.";
    ...
    if ($si241_sequencial == "" || $si241_sequencial == null) {
      $result = db_query("select nextval('balancete292025_si241_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete292025_si241_sequencial_seq do campo: si241_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete292025_si241_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si241_sequencial)) {
        $this->erro_sql = " Campo si241_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete292025(
                                       si241_sequencial
                                      ,si241_tiporegistro
                                      ,si241_contacontabil
                                      ,si241_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete292025 ($this->si241_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete292025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete292025 ($this->si241_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete292025 set ";
    $virgula = "";
    if (trim($this->si241_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si241_sequencial"])) {
      ...
      if (trim($this->si241_sequencial) == null) {
        $this->erro_sql = " Campo si241_sequencial n�o informado.";
    ...
    if (trim($this->si241_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si241_codfundo"])) {
      ...
      if (trim($this->si241_codfundo) == null) {
        $this->erro_sql = " Campo si241_codfundo n�o informado.";
    ...
    if (trim($this->si241_codfontrecursos) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si241_codfontrecursos"])) {
      ...
      if (trim($this->si241_codfontrecursos) == null) {
        $this->erro_sql = " Campo si241_codfontrecursos n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete292025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si241_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete292025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si241_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si241_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete292025
                    where ";
    $sql2 = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete292025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete292025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si241_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete292025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si241_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete292025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si241_sequencial != null) {
        $sql2 .= " where balancete292025.si241_sequencial = $si241_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
