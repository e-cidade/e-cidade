...
class cl_itbiconstrespecie { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->it09_codigo = ($this->it09_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["it09_codigo"]:$this->it09_codigo);
       $this->it09_caract = ($this->it09_caract == ""?@$GLOBALS["HTTP_POST_VARS"]["it09_caract"]:$this->it09_caract);
     }else{
       $this->it09_codigo = ($this->it09_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["it09_codigo"]:$this->it09_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($it09_codigo){ 
      $this->atualizacampos();
     if($this->it09_caract == null ){ 
       ...
       $this->it09_codigo = $it09_codigo; 
     if(($this->it09_codigo == null) || ($this->it09_codigo == "") ){ 
       $this->erro_sql = " Campo it09_codigo nao declarado.";
     ...
     $sql = "insert into itbiconstrespecie(
                                       it09_codigo 
                                      ,it09_caract 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->it09_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($it09_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($it09_codigo!=null){
       $sql .= " it09_codigo = $this->it09_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->it09_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Espécie da construção nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->it09_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Espécie da construção nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->it09_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($it09_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($it09_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Espécie da construção nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$it09_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Espécie da construção nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$it09_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $it09_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($it09_codigo!=null ){
         $sql2 .= " where itbiconstrespecie.it09_codigo = $it09_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
