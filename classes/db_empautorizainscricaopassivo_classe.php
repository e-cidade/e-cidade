...
class cl_empautorizainscricaopassivo { 
   ...
   function incluir (){ 
     ...
     if($this->e16_inscricaopassivo == null ){ 
     ...
     $sql = "insert into empautorizainscricaopassivo(
                                       e16_empautoriza 
                                      ,e16_inscricaopassivo 
                       )
                values (
                                $this->e16_empautoriza 
                               ,$this->e16_inscricaopassivo 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "autorização de empenho nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "autorização de empenho nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from empautorizainscricaopassivo
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "autorização de empenho nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "autorização de empenho nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="empautorizainscricaopassivo.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from empautorizainscricaopassivo ";
     $sql .= "      inner join empautoriza  on  empautoriza.e54_autori = empautorizainscricaopassivo.e16_empautoriza";
     $sql .= "      inner join inscricaopassivo  on  inscricaopassivo.c36_sequencial = empautorizainscricaopassivo.e16_inscricaopassivo";
     ...
     $sql .= "      inner join db_usuarios  as b on   b.id_usuario = inscricaopassivo.c36_db_usuarios";
     $sql2 = "";
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where empautorizainscricaopassivo.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
