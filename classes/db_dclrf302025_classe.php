<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf302025
class cl_dclrf302025 {
    ...
    var $campos = "
                 ...
                 si192_publiclrf = int4 = Publica��o do RREO da LRF
                 si192_dtpublicacaorelatoriolrf = date = Data de publica��o do RREO da LRF
                 ...
                 si192_exerciciotpbimestre = int4 = Exerc�cio a que se refere o per�odo
                 si192_mes = int2 = M�s de refer�ncia
                 si192_instit = int8 = Institui��o
                 si192_reg10 = int4 = Sequencial DCLRF
                 ";
    //funcao construtor da classe
    function cl_dclrf302025() {
        //classes dos rotulos dos campos
        $this->rotulo = new rotulo("dclrf302025");
    ...
    function incluir ($si192_sequencial){
        ...
        if($si192_sequencial == "" || $si192_sequencial == null ){
            $result = @pg_query("select nextval('dclrf302025_si192_sequencial_seq')");
            if($result==false){
...
//            $this->erro_sql = " Campo Publica��o do RREO da LRF nao Informado.";
...
//        }
        ...
        if($this->si192_mes == null ){
            $this->erro_sql = " Campo M�s de refer�ncia nao Informado.";
...
//        die($sql);
        ...
        if($result==false){
            ...
            if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
                $this->erro_sql   = "Publica��o e Periodicidade do RREO da LRF () nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_banco = "Publica��o e Periodicidade do RREO da LRF j� Cadastrado";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            }else{
                $this->erro_sql   = "Publica��o e Periodicidade do RREO da LRF () nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
//     	si192_reg10 = $si192_reg10 ";
        ...
        if($result==false){
            $this->erro_banco = str_replace("\n","",@pg_last_error());
            $this->erro_sql   = "Publica��o e Periodicidade do RREO da LRF nao Alterado. Alteracao Abortada.\\n";
            $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "Publica��o e Periodicidade do RREO da LRF nao foi Alterado. Alteracao Executada.\\n";
                $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
                return true;
...
//       echo $sql.$sql2;exit;
    ...
    function sql_query ( $si192_sequencial = null, $campos = "*",$ordem=null,$dbwhere=""){
        ...
        $sql .= " from dclrf302025 ";
        $sql .= " 		left join dclrf102020 on dclrf102020.si157_sequencial = dclrf302025.si192_reg10 ";
        $sql2 = "";
        if($dbwhere==""){
            if( $si192_sequencial != null){
                $sql2 = " where dclrf302025.si192_sequencial = $si192_sequencial";
            }
        }else if($dbwhere != ""){
            $sql2 = " where $dbwhere";
        }
