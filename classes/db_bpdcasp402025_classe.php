<?
//MODULO: sicom
//CLASSE DA ENTIDADE bpdcasp402025
class cl_bpdcasp402025 {
   ...
   function cl_bpdcasp402025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bpdcasp402025");
   ...
   function incluir ($si211_sequencial){
     ...
     if($this->si211_tiporegistro == null ){
       $this->erro_sql = " Campo si211_tiporegistro n�o informado.";
     ...
     $sql = "insert into bpdcasp402025(
                ...
                values (
                                (select nextval('bpdcasp402025_si211_sequencial_seq'))
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bpdcasp402025 ($this->si211_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bpdcasp402025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bpdcasp402025 ($this->si211_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si211_sequencial=null) {
     ...
     if(trim($this->si211_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si211_sequencial"])){
       ...
       if(trim($this->si211_sequencial) == null ){
         $this->erro_sql = " Campo si211_sequencial n�o informado.";
     ...
     if(trim($this->si211_vlpassivofinanceiro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si211_vlpassivofinanceiro"])){
       ...
       if(trim($this->si211_vlpassivofinanceiro) == null ){
         $this->erro_sql = " Campo si211_vlpassivofinanceiro n�o informado.";
     ...
     if(trim($this->si211_vlpassivopermanente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si211_vlpassivopermanente"])){
       ...
       if(trim($this->si211_vlpassivopermanente) == null ){
         $this->erro_sql = " Campo si211_vlpassivopermanente n�o informado.";
     ...
     if(trim($this->si211_vltotalpassivofinanceiropermanente)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si211_vltotalpassivofinanceiropermanente"])){
       ...
       if(trim($this->si211_vltotalpassivofinanceiropermanente) == null ){
         $this->erro_sql = " Campo si211_vltotalpassivofinanceiropermanente n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp402025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si211_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp402025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si211_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si211_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp402025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp402025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si211_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bpdcasp402025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si211_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bpdcasp402025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si211_sequencial!=null ){
         $sql2 .= " where bpdcasp402025.si211_sequencial = $si211_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
