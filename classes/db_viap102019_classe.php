...
class cl_viap102019
{
  ...
  function __construct()
  {
    ...
    $this->rotulo = new rotulo("viap102019");
  ...
  function incluir($si198_sequencial)
  {
    ...
    if ($si198_sequencial == "" || $si198_sequencial == null) {
      $result = db_query("select nextval('viap102019_si198_sequencial_seq')");
      if ($result == false) {
  ...
  function sql_query($si198_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si198_sequencial != null) {
        $sql2 .= " where viap102019.si198_sequencial = $si198_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
