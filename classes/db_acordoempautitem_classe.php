...
//MODULO: Acordos
//CLASSE DA ENTIDADE acordoempautitem
class cl_acordoempautitem { 
   ...
   var $ac19_sequen = 0; 
   var $ac19_autori = 0; 
   var $ac19_acordoitem = 0; 
   // cria propriedade com as variaveis do arquivo 
   var $campos = "
                 ac19_sequencial = int4 = Sequencial 
                 ac19_sequen = int4 = Sequencia 
                 ac19_autori = int4 = Autorização 
                 ac19_acordoitem = int4 = Acordo Item 
                 ";
   //funcao construtor da classe 
   function cl_acordoempautitem() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("acordoempautitem"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->ac19_acordoitem = ($this->ac19_acordoitem == ""?@$GLOBALS["HTTP_POST_VARS"]["ac19_acordoitem"]:$this->ac19_acordoitem);
     }else{
       $this->ac19_sequencial = ($this->ac19_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ac19_sequencial"]:$this->ac19_sequencial);
       $this->ac19_sequen = ($this->ac19_sequen == ""?@$GLOBALS["HTTP_POST_VARS"]["ac19_sequen"]:$this->ac19_sequen);
     }
   ...
   function incluir ($ac19_sequencial){ 
     ...
     if($this->ac19_acordoitem == null ){ 
       $this->erro_sql = " Campo Acordo Item nao Informado.";
       $this->erro_campo = "ac19_acordoitem";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($ac19_sequencial == "" || $ac19_sequencial == null ){
       $result = db_query("select nextval('acordoempautitem_ac19_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: acordoempautitem_ac19_sequencial_seq do campo: ac19_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from acordoempautitem_ac19_sequencial_seq");
     ...
     $sql = "insert into acordoempautitem(
                                       ac19_sequencial 
                                      ,ac19_sequen 
                                      ,ac19_autori 
                                      ,ac19_acordoitem 
                ...
                values (
                               ...
                               ,$this->ac19_sequen 
                               ,$this->ac19_autori 
                               ,$this->ac19_acordoitem 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Acordo Empenho Automatico por Item ($this->ac19_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Acordo Empenho Automatico por Item já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Acordo Empenho Automatico por Item ($this->ac19_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2839,16197,'','".AddSlashes(pg_result($resaco,0,'ac19_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($ac19_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update acordoempautitem set ";
     $virgula = "";
     ...
     if(trim($this->ac19_acordoitem)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ac19_acordoitem"])){ 
       $sql  .= $virgula." ac19_acordoitem = $this->ac19_acordoitem ";
       $virgula = ",";
       if(trim($this->ac19_acordoitem) == null ){ 
         $this->erro_sql = " Campo Acordo Item nao Informado.";
         $this->erro_campo = "ac19_acordoitem";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["ac19_acordoitem"]) || $this->ac19_acordoitem != "")
           $resac = db_query("insert into db_acount values($acount,2839,16197,'".AddSlashes(pg_result($resaco,$conresaco,'ac19_acordoitem'))."','$this->ac19_acordoitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Acordo Empenho Automatico por Item nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ac19_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Acordo Empenho Automatico por Item nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ac19_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ac19_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2839,16197,'','".AddSlashes(pg_result($resaco,$iresaco,'ac19_acordoitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from acordoempautitem
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($ac19_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Acordo Empenho Automatico por Item nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Acordo Empenho Automatico por Item nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ac19_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:acordoempautitem";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $ac19_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from acordoempautitem ";
     $sql .= "      inner join empautitem  on  empautitem.e55_autori = acordoempautitem.ac19_autori and  empautitem.e55_sequen = acordoempautitem.ac19_sequen";
     $sql .= "      inner join acordoitem  on  acordoitem.ac20_sequencial = acordoempautitem.ac19_acordoitem";
     ...
     $sql .= "      inner join acordo  as b on   b.ac16_sequencial = acordoitem.ac20_acordo";
     $sql2 = "";
     if($dbwhere==""){
       if($ac19_sequencial!=null ){
         $sql2 .= " where acordoempautitem.ac19_sequencial = $ac19_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
