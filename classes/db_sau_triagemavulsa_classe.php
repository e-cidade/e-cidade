...
class cl_sau_triagemavulsa {
   ...
   var $campos = "
                 ...
                 s152_i_alimentacaoexameglicemia = int4 = Alimentação
   ...
   function incluir ($s152_i_codigo){
     ...
     if($this->s152_i_alimentacaoexameglicemia == null ){
       $this->erro_sql = " Campo Alimentação não informado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "sau_triagemavulsa ($this->s152_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   public function excluir ($s152_i_codigo=null,$dbwhere=null) {
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "sau_triagemavulsa nao Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "sau_triagemavulsa nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$s152_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
