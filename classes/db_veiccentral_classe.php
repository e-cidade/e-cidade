...
class cl_veiccentral {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ve40_sequencial = ($this->ve40_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ve40_sequencial"]:$this->ve40_sequencial);
       $this->ve40_veiccadcentral = ($this->ve40_veiccadcentral == ""?@$GLOBALS["HTTP_POST_VARS"]["ve40_veiccadcentral"]:$this->ve40_veiccadcentral);
       $this->ve40_veiculos = ($this->ve40_veiculos == ""?@$GLOBALS["HTTP_POST_VARS"]["ve40_veiculos"]:$this->ve40_veiculos);
     }else{
       $this->ve40_sequencial = ($this->ve40_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ve40_sequencial"]:$this->ve40_sequencial);
     }
   }
   ...
   function incluir ($ve40_sequencial){
     ...
     if($ve40_sequencial == "" || $ve40_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $ve40_sequencial)){
         $this->erro_sql = " Campo ve40_sequencial maior que último número da sequencia.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         ...
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Central de veiculos já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Central de veiculos ($this->ve40_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     $resaco = $this->sql_record($this->sql_query_file($this->ve40_sequencial));
     if(($resaco!=false)||($this->numrows!=0)){
       $resac = db_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
       $resac = db_query("insert into db_acountkey values($acount,11270,'$this->ve40_sequencial','I')");
       $resac = db_query("insert into db_acount values($acount,1937,11270,'','".AddSlashes(pg_result($resaco,0,'ve40_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,1937,11271,'','".AddSlashes(pg_result($resaco,0,'ve40_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($ve40_sequencial=null) {
     ...
     if($ve40_sequencial!=null){
       $sql .= " ve40_sequencial = $this->ve40_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ve40_sequencial));
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
         $resac = db_query("insert into db_acountkey values($acount,11270,'$this->ve40_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve40_sequencial"]))
           $resac = db_query("insert into db_acount values($acount,1937,11270,'".AddSlashes(pg_result($resaco,$conresaco,'ve40_sequencial'))."','$this->ve40_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve40_veiccadcentral"]))
           $resac = db_query("insert into db_acount values($acount,1937,11271,'".AddSlashes(pg_result($resaco,$conresaco,'ve40_veiccadcentral'))."','$this->ve40_veiccadcentral',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["ve40_veiculos"]))
           $resac = db_query("insert into db_acount values($acount,1937,11272,'".AddSlashes(pg_result($resaco,$conresaco,'ve40_veiculos'))."','$this->ve40_veiculos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Central de veiculos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ve40_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ve40_sequencial=null,$dbwhere=null) {
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $acount = pg_result($resac,0,0);
         $resac = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
         $resac = db_query("insert into db_acountkey values($acount,11270,'$ve40_sequencial','E')");
         $resac = db_query("insert into db_acount values($acount,1937,11270,'','".AddSlashes(pg_result($resaco,$iresaco,'ve40_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1937,11271,'','".AddSlashes(pg_result($resaco,$iresaco,'ve40_veiccadcentral'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1937,11272,'','".AddSlashes(pg_result($resaco,$iresaco,'ve40_veiculos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from veiccentral
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($ve40_sequencial != ""){
          ...
          $sql2 .= " ve40_sequencial = $ve40_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Central de veiculos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ve40_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:veiccentral";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
