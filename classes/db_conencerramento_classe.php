...
class cl_conencerramento {
  ...
  public function lancaBloqueioContabil($sListaEncerramento = '2,3,4') {
    ...
    if ($iLinhasAnoInsti > 0) {
      ...
      $iTodosTipoEnc  = $oQueryAnoInsti->c42_encerramentotipo;

      /**
       * Verifica se existem a soma de 3 posições no array e se a soma dos valores é igual a 9 (2+3+4)
       */
      if ($iTodosTipoEnc == 3) {
        ...
        /**
         * Se existir registro, faz update nada data (c99_data)
         */
      ...
      } else if ($iTodosTipoEnc != 3) {

        /**
         * Se o Array não possuir 3 posições, significa que não há um dos lançamentos em conencerramento
