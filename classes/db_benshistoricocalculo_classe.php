...
class cl_benshistoricocalculo
{
  ...
  var $campos = "
                 ...
                 t57_mes = int4 = Ms de competncia 
                 t57_ano = int4 = Ano de competncia 
                 t57_datacalculo = date = Data 
                 t57_usuario = int4 = Usurio 
                 t57_instituicao = int4 = Instituio 
                 t57_tipocalculo = int4 = Tipo do clculo 
  ...
  function incluir($t57_sequencial)
  {
    ...
    if ($this->t57_mes == null) {
      $this->erro_sql = " Campo Ms de competncia nao Informado.";
    ...
    if ($this->t57_ano == null) {
      $this->erro_sql = " Campo Ano de competncia nao Informado.";
    ...
    if ($this->t57_usuario == null) {
      $this->erro_sql = " Campo Usurio nao Informado.";
    ...
    if ($this->t57_tipocalculo == null) {
      $this->erro_sql = " Campo Tipo do clculo nao Informado.";
    ...
    if ($t57_sequencial == "" || $t57_sequencial == null) {
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $t57_sequencial)) {
        $this->erro_sql = " Campo t57_sequencial maior que ltimo nmero da sequencia.";
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Histrico clculo depreciao ($this->t57_sequencial) nao Includo. Inclusao Abortada.";
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Histrico clculo depreciao j Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Histrico clculo depreciao ($this->t57_sequencial) nao Includo. Inclusao Abortada.";
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function alterar($t57_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Histrico clculo depreciao nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : " . $this->t57_sequencial;
      $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Histrico clculo depreciao nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : " . $this->t57_sequencial;
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
  ...
  function excluir($t57_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Histrico clculo depreciao nao Excludo. Excluso Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Histrico clculo depreciao nao Encontrado. Excluso no Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $t57_sequencial;
        $this->erro_msg   = "Usurio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
