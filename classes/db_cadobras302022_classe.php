<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras302022
class cl_cadobras302022 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("cadobras302022");
  ...
  function incluir () {
    ...
    if ($this->si201_sequencial == null ) {
      $result = db_query("select nextval('cadobras302022_si201_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras302022_si201_sequencial_seq do campo: si201_sequencial";
...
//    }
    ...
    $sql = "insert into cadobras302022(
                                       si201_sequencial
                                      ,si201_tiporegistro
                                      ,si201_codorgaoresp
                                      ,si201_codobra
...
//    }
  ...
  function excluir ( $si201_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras302022
                    where ";
    $sql2 = "";
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras302022";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si201_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras302022 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si201_sequencial != "" && $si201_sequencial != null) {
        $sql2 = " where cadobras302022.si201_sequencial = '$si201_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
