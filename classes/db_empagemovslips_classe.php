...
class cl_empagemovslips { 
   ...
   function incluir ($k107_sequencial){ 
     ...
     if($this->k107_valor == null ){ 
       $this->erro_sql = " Campo Valor do Movimento nao Informado.";
     ...
     if($this->k107_ctacredito == null ){ 
       $this->erro_sql = " Campo Conta a Credito nao Informado.";
     ...
     if($this->k107_ctadebito == null ){ 
       $this->erro_sql = " Campo Conta a Debito nao Informado.";
     ...
     if(($this->k107_sequencial == null) || ($this->k107_sequencial == "") ){ 
       $this->erro_sql = " Campo k107_sequencial nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Slips a Realizar ($this->k107_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($k107_sequencial=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_sequencial"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_empagemov"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_data"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_valor"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_ctacredito"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["k107_ctadebito"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Slips a Realizar nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k107_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Slips a Realizar nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k107_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k107_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Slips a Realizar nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Slips a Realizar nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k107_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $k107_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $k107_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
