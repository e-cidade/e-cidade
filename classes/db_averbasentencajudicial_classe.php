...
class cl_averbasentencajudicial { 
   ...
   var $campos = "
                 j101_sequencial = int4 = Código 
                 j101_averbacao = int4 = Averbação 
   ...
   function incluir ($j101_sequencial){ 
     ...
     if($j101_sequencial == "" || $j101_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $j101_sequencial)){
         $this->erro_sql = " Campo j101_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Averba sentença Judicial ($this->j101_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
