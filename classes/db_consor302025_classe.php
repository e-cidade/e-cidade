<?
//MODULO: sicom
//CLASSE DA ENTIDADE consor302025
class cl_consor302025
{
  ...
  var $si18_mesreferencia = null;
  var $si18_codfuncao = null;
  var $si18_codsubfuncao = null;
  var $si18_naturezadespesa = 0;
  var $si18_subelemento = null;
  var $si18_codfontrecursos = null;
  var $si18_vlempenhadofonte = 0;
  var $si18_vlanulacaoempenhofonte = 0;
  var $si18_vlliquidadofonte = 0;
  ...
  var $campos = "
                 ...
                 si18_cnpjconsorcio = varchar(14) = C�digo do  Cons�rcio
                 si18_mesreferencia = varchar(2) = M�s de refer�ncia
                 si18_codfuncao = varchar(2) = C�digo da fun��o
                 si18_codsubfuncao = varchar(3) = C�digo da  Subfun��o
                 si18_naturezadespesa = int8 = C�digo da natureza
                 si18_subelemento = varchar(2) = Subelemento da  despesa
                 si18_codfontrecursos = int8 = Fonte Recurso
                 si18_vlempenhadofonte = float8 = Valor empenhado  no m�s
                 si18_vlanulacaoempenhofonte = float8 = Valor de empenhos  anulados no m�s
                 si18_vlliquidadofonte = float8 = Valor liquidado no  m�s
                 si18_vlanulacaoliquidacaofonte = float8 = Valor de  liquida��es
                 si18_vlpagofonte = float8 = Valor pago no m�s
                 si18_vlanulacaopagamentofonte = float8 = Valor de  pagamentos
                 si18_mes = int8 = M�s
                 si18_instit = int8 = Institui��o
                 si18_codacompanhamento = text = C�digo acompanhamento
                 ";

  //funcao construtor da classe
  function cl_consor302025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("consor302025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si18_mesreferencia = ($this->si18_mesreferencia == "" ? @$GLOBALS["HTTP_POST_VARS"]["si18_mesreferencia"] : $this->si18_mesreferencia);
      ...
      $this->si18_codfontrecursos = ($this->si18_codfontrecursos == "" ? @$GLOBALS["HTTP_POST_VARS"]["si18_codfontrecursos"] : $this->si18_codfontrecursos);
...
//    }
//    if ($this->si18_vlempenhadofonte == null) {
//      $this->si18_vlempenhadofonte = "0";
//    }
//    if ($this->si18_vlanulacaoempenhofonte == null) {
//      $this->si18_vlanulacaoempenhofonte = "0";
//    }
//    if ($this->si18_vlliquidadofonte == null) {
//      $this->si18_vlliquidadofonte = "0";
//    }
//    if ($this->si18_vlanulacaoliquidacaofonte == null) {
//      $this->si18_vlanulacaoliquidacaofonte = "0";
//    }
//    if ($this->si18_vlpagofonte == null) {
//      $this->si18_vlpagofonte = "0";
//    }
//    if ($this->si18_vlanulacaopagamentofonte == null) {
//      $this->si18_vlanulacaopagamentofonte = "0";
//    }
    ...
    if ($this->si18_codacompanhamento == null) {
      $this->erro_sql = " Campo C�digo de acompanhamento nao Informado.";
    ...
    if ($si18_sequencial == "" || $si18_sequencial == null) {
      $result = db_query("select nextval('consor302025_si18_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: consor302025_si18_sequencial_seq do campo: si18_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from consor302025_si18_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si18_sequencial)) {
        $this->erro_sql = " Campo si18_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into consor302025(
                                      ...
                                      ,si18_subelemento
                                      ,si18_codfontrecursos
                                      ,si18_vlempenhadofonte
                                      ,si18_vlanulacaoempenhofonte
                                      ,si18_vlliquidadofonte
                ...
                values (
                               ...
                               ,'$this->si18_mesreferencia'
                               ,'$this->si18_codfuncao'
                               ,'$this->si18_codsubfuncao'
                               ,$this->si18_naturezadespesa
                               ,'$this->si18_subelemento'
                               ,$this->si18_codfontrecursos
                               ,$this->si18_vlempenhadofonte
                               ,$this->si18_vlanulacaoempenhofonte
                               ,$this->si18_vlliquidadofonte
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "consor302025 ($this->si18_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "consor302025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "consor302025 ($this->si18_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si18_sequencial = null)
  {
    ...
    if (trim($this->si18_mesreferencia) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si18_mesreferencia"])) {
      $sql .= $virgula . " si18_mesreferencia = '$this->si18_mesreferencia' ";
      $virgula = ",";
    }
    ...
    if (trim($this->si18_codacompanhamento) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si18_codacompanhamento"])) {
      ...
      if (trim($this->si18_codacompanhamento) == null) {
        $this->erro_sql = " Campo C�digo acompanhamento nao Informado.";
        $this->erro_campo = "si18_codacompanhamento";
        $this->erro_banco = "";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
...
//    }
    ...
    if ($result == false) {
      ...
      $this->erro_sql = "consor302025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si18_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "consor302025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si18_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
//    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "consor302025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "consor302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si18_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:consor302025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si18_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from consor302025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si18_sequencial != null) {
        $sql2 .= " where consor302025.si18_sequencial = $si18_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
