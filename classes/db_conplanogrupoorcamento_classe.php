...
class cl_conplanogrupoorcamento { 
   ...
   function incluir ($c21_sequencial){ 
     ...
     if($c21_sequencial == "" || $c21_sequencial == null ){
       $result = db_query("select nextval('conplanogrupoorcamento_c21_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: conplanogrupoorcamento_c21_sequencial_seq do campo: c21_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
     ...
     $sql = "insert into conplanogrupoorcamento(
                                       c21_sequencial 
                                      ,c21_anousu 
                                      ,c21_codcon 
                                      ,c21_congrupo 
   ...
   function sql_query ( $c21_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from conplanogrupoorcamento ";
     $sql .= "      inner join conplanoorcamento  on  conplanoorcamento.c60_codcon = conplanogrupoorcamento.c21_codcon and  conplanoorcamento.c60_anousu = conplanogrupoorcamento.c21_anousu";
     $sql .= "      inner join congrupoorcamento  on  congrupoorcamento.c20_sequencial = conplanogrupoorcamento.c21_congrupo";
     ...
     if($dbwhere==""){
       if($c21_sequencial!=null ){
         $sql2 .= " where conplanogrupoorcamento.c21_sequencial = $c21_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
