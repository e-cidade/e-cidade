<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete132025
class cl_balancete132025
{
  ...
  var $si180_naturezasaldofinaipa = 0;
  var $si180_reg10;
  ...
  function cl_balancete132025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete132025");
  ...
  function incluir($si180_sequencial)
  {
    ...
    if ($this->si180_saldoinicialpa == null) {
      $this->erro_sql = " Campo si180_saldoinicialpa n�o informado.";
    ...
    if ($this->si180_naturezasaldoinicialpa == null) {
      $this->erro_sql = " Campo si180_naturezasaldoinicialpa n�o informado.";
    ...
    if ($this->si180_saldofinalpa == null) {
      $this->erro_sql = " Campo si180_saldofinalpa n�o informado.";
    ...
    if ($this->si180_naturezasaldofinalpa == null) {
      $this->erro_sql = " Campo si180_naturezasaldofinalpa n�o informado.";
    ...
    if ($si180_sequencial == "" || $si180_sequencial == null) {
      $result = db_query("select nextval('balancete132025_si180_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete132025_si180_sequencial_seq do campo: si180_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete132025_si180_sequencial_seq");
    ...
    $sql = "insert into balancete132025(
                                       si180_sequencial
                                      ,si180_tiporegistro
                                      ,si180_contacontabil
                                      ,si180_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete132025 ($this->si180_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete132025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete132025 ($this->si180_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete132025 set ";
    $virgula = "";
    ...
    if (trim($this->si180_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si180_codfundo"])) {
      ...
      if (trim($this->si180_codfundo) == null) {
        $this->erro_sql = " Campo si180_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete132025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si180_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete132025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si180_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si180_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete132025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si180_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete132025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete132025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si180_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete132025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si180_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete132025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si180_sequencial != null) {
        $sql2 .= " where balancete132025.si180_sequencial = $si180_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
