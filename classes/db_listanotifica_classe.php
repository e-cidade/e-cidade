...
class cl_listanotifica { 
   ...
   var $campos = "
                 k63_codigo = int4 = Código da Lista 
                 k63_numpre = int4 = Numpre Notificado 
                 k63_notifica = int4 = Número da Notificação 
                 ";
   ...
   function incluir ($k63_codigo,$k63_numpre,$k63_notifica){ 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Listas Notificadas ($this->k63_codigo."-".$this->k63_numpre."-".$this->k63_notifica) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Listas Notificadas já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Listas Notificadas ($this->k63_codigo."-".$this->k63_numpre."-".$this->k63_notifica) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($k63_codigo=null,$k63_numpre=null,$k63_notifica=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Listas Notificadas nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Listas Notificadas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k63_codigo."-".$k63_numpre."-".$k63_notifica;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
