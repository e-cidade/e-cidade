...
class cl_conplanoconplanoorcamento {
    ...
    function atualizacampos($exclusao=false) {
        if($exclusao==false){
            ...
            $this->sTipoConta = ($this->sTipoConta == ""?@$GLOBALS["HTTP_POST_VARS"]["sTipoConta"]:$this->sTipoConta);
    ...
    function incluir ($c72_sequencial){
        ...
        $sql = "insert into conplanoconplanoorcamento(
                ...
                values (
                                $this->c72_sequencial
                               ,".($this->c72_conplano == "null" || $this->c72_conplano == ""?"null":"'".$this->c72_conplano."'")."
