<?
	...
	class cl_emp302025
	{
		...
		var $si206_exerciciocontrato = null;
    var $si206_mes = 0;
		var $si206_instit = 0;
		...
		var $campos = "
                 ...
                 si206_codorgao = varchar(2) = C�digo do �rg�o
                 si206_codunidadesub = varchar(8) = C�digo da unidade
                 si206_nroempenho = int8 = N�mero do  empenho
                 si206_dtempenho = date = Data do empenho
                 si206_codorgaorespcontrato = varchar(2) = C�digo do �rg�o
                 si206_codunidadesubrespcontrato = varchar(8) = C�digo da unidade ou subunidade
                 si206_nrocontrato = int8 = N�mero do contrato
                 si206_dtassinaturacontrato = date = Data da assinatura
                 si206_nrosequencialtermoaditivo = int8 = N�mero sequencial do termo aditivo
                 si206_nroconvenio = varchar(30) = N�mero do conv�nio
                 si206_dtassinaturaconvenio = date = Data da assinatura do conv�nio
                 si206_nroconvenioconge = varchar(30) = N�mero do conv�nio conge
                 si206_dtassinaturaconge = date = Data da assinatura conge
				 si206_exerciciocontrato = int = Ano 
                 si206_mes = int8 = M�s
                 si206_instit = int8 = Institui��o
                 ";

		//funcao construtor da classe
		function cl_emp302025()
		{
			//classes dos rotulos dos campos
			$this->rotulo = new rotulo("emp302025");
		...
		function atualizacampos($exclusao = false)
		{
			if ($exclusao == false) {
				...
				$this->si206_exerciciocontrato = ($this->si206_exerciciocontrato == "" ? @$GLOBALS["HTTP_POST_VARS"]["si206_exerciciocontrato"] : $this->si206_exerciciocontrato);
		...
		function incluir($si206_sequencial)
		{
			...
			if ($this->si206_codunidadesub == null) {
				$this->erro_sql = " Campo C�digo da unidade ou subunidade n�o Informado.";
      ...
      if ($this->si206_mes == null) {
			...
			if ($si206_sequencial == "" || $si206_sequencial == null) {
				$result = db_query("select nextval('emp302025_si206_sequencial_seq')");
				if ($result == false) {
					$this->erro_banco = str_replace("", "", @pg_last_error());
					$this->erro_sql = "Verifique o cadastro da sequencia: emp302025_si206_sequencial_seq do campo: si206_sequencial";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "0";
				...
				$result = db_query("select last_value from emp302025_si206_sequencial_seq");
			...
			$sql = "insert into emp302025(
                ...
                values (
                               ...
                               ,". ($this->si206_exerciciocontrato == "null" || $this->si206_exerciciocontrato == "" ? "null" : $this->si206_exerciciocontrato ). "
			...
			if ($result == false) {
				...
				if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
					$this->erro_sql = "emp302025 ($this->si206_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_banco = "emp302025 j� Cadastrado";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				} else {
					$this->erro_sql = "emp302025 ($this->si206_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
...
//			}
		...
		function alterar($si206_sequencial = null)
		{
			...
			if (trim($this->si206_codorgao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si206_codorgao"])) {
				...
				$virgula = ",";
        if (trim($this->si206_tiporegistro) == null) {
          $this->erro_sql = " Campo C�digo �rg�o nao Informado.";
          $this->erro_campo = "si206_codorgao";
          $this->erro_banco = "";
          $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
          $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
...
//			}
			...
			if ($result == false) {
				$this->erro_banco = str_replace("", "", @pg_last_error());
				$this->erro_sql = "emp302025 nao Alterado. Alteracao Abortada.\n";
				$this->erro_sql .= "Valores : " . $this->si206_sequencial;
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "emp302025 nao foi Alterado. Alteracao Executada.\n";
					$this->erro_sql .= "Valores : " . $this->si206_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
...
//			}
			...
			if ($result == false) {
				$this->erro_banco = str_replace("", "", @pg_last_error());
				$this->erro_sql = "emp302025 nao Exclu�do. Exclus�o Abortada.\n";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "emp302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
					$this->erro_sql .= "Valores : " . $si206_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
		...
		function sql_record($sql)
		{
			...
			if ($this->numrows == 0) {
				$this->erro_banco = "";
				$this->erro_sql = "Record Vazio na Tabela:emp302025";
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
		...
		function sql_query($si206_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
		{
		  ...
		  $sql2 = "";
			if ($dbwhere == "") {
				if ($si206_sequencial != null) {
					$sql2 .= " where emp302025.si206_sequencial = $si206_sequencial ";
				}
			} else if ($dbwhere != "") {
				$sql2 = " where $dbwhere";
			}
