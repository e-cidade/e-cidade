...
class cl_benslote { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->t43_codigo = ($this->t43_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["t43_codigo"]:$this->t43_codigo);
       $this->t43_codlote = ($this->t43_codlote == ""?@$GLOBALS["HTTP_POST_VARS"]["t43_codlote"]:$this->t43_codlote);
       $this->t43_bem = ($this->t43_bem == ""?@$GLOBALS["HTTP_POST_VARS"]["t43_bem"]:$this->t43_bem);
     }else{
       $this->t43_codigo = ($this->t43_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["t43_codigo"]:$this->t43_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($t43_codigo){ 
      $this->atualizacampos();
     if($this->t43_codlote == null ){ 
     ...
     if($t43_codigo == "" || $t43_codigo == null ){
       $result = db_query("select nextval('benslote_t43_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: benslote_t43_codigo_seq do campo: t43_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $t43_codigo)){
         ...
         $this->t43_codigo = $t43_codigo; 
       }
     }
     if(($this->t43_codigo == null) || ($this->t43_codigo == "") ){ 
       $this->erro_sql = " Campo t43_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->t43_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($t43_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($t43_codigo!=null){
       $sql .= " t43_codigo = $this->t43_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->t43_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Lote que foi incluido o bem. nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->t43_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Lote que foi incluido o bem. nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->t43_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($t43_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($t43_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Lote que foi incluido o bem. nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$t43_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Lote que foi incluido o bem. nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$t43_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $t43_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from benslote ";
     $sql .= "      inner join bens  on  bens.t52_bem = benslote.t43_bem";
     $sql .= "      inner join benscadlote  on  benscadlote.t42_codigo = benslote.t43_codlote";
     ...
     if($dbwhere==""){
       if($t43_codigo!=null ){
         $sql2 .= " where benslote.t43_codigo = $t43_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   function sql_query_file ( $t43_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
