...
class cl_conlancamreconhecimentocontabil { 
   ...
   var $campos = "
                 ...
                 c113_codlan = int4 = Código Lançamento 
                 ";
   ...
   function incluir ($c113_sequencial){ 
     ...
     if($this->c113_reconhecimentocontabil == null ){ 
       $this->erro_sql = " Campo Reconhecimento Contabil não informado.";
     ...
     if($c113_sequencial == "" || $c113_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $c113_sequencial)){
         $this->erro_sql = " Campo c113_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Ligacao com reconheciemtento contabil ($this->c113_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Ligacao com reconheciemtento contabil já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Ligacao com reconheciemtento contabil ($this->c113_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($c113_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ligacao com reconheciemtento contabil nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ligacao com reconheciemtento contabil nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c113_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
