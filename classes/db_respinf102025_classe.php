<?
//MODULO: sicom
//CLASSE DA ENTIDADE respinf102025
class cl_respinf102025 {
  ...
  var $campos = "
                 ...
                 si197_nrodocumento = varchar(11) = N�mero do documento da pessoa f�sica
  ...
  function cl_respinf102025() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("respinf102025");
  ...
  function incluir ($si197_sequencial){
    ...
    if($this->si197_nrodocumento == null ){
      $this->erro_sql = " Campo N�mero do documento da pessoa f�sica n�o informado.";
    ...
    if($si197_sequencial == "" || $si197_sequencial == null ){
      $result = db_query("select nextval('respinf2025_si197_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("
","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: respinf2025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from respinf2025");
...
","",@pg_last_error());
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "respinf2025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_banco = "respinf2025";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      }else{
        $this->erro_sql   = "respinf2025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
  ...
  function alterar ($si197_sequencial=null) {
    ...
    if(trim($this->si197_nomeresponsavel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si197_nomeresponsavel"])){
      ...
      if(trim($this->si197_nomeresponsavel) == null ){
        $this->erro_sql = " Campo Nome do Responsavel n�o informado.";
    ...
    if(trim($this->si197_cartident)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si197_cartident"])){
      ...
      if(trim($this->si197_cartident) == null ){
        $this->erro_sql = " Campo Identidade do respons�vel n�o informado.";
    ...
    if(trim($this->si197_orgemissorci)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si197_orgemissorci"])){
      ...
      if(trim($this->si197_orgemissorci) == null ){
        $this->erro_sql = " Campo �rg�o emissor da carteira de identidade n�o informado.";
    ...
    if(trim($this->si197_nrodocumento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si197_nrodocumento"])){
      ...
      if(trim($this->si197_nrodocumento) == null ){
        $this->erro_sql = " Campo N�mero do nrodocumento do respons�vel n�o informado.";
        $this->erro_campo = "si197_nrodocumento";
        $this->erro_banco = "";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
...
","",@pg_last_error());
    ...
    if($this->numrows==0){
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:respinf2025";
      $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si197_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    $sql .= " from respinf2025 ";
    $sql2 = "";
    if($dbwhere==""){
      if($si197_sequencial!=null ){
        $sql2 .= " where respinf2025.si197_sequencial = $si197_sequencial ";
      }
    }else if($dbwhere != ""){
      $sql2 = " where $dbwhere";
    }
