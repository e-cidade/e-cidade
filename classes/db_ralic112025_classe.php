<?
//MODULO: sicom
//CLASSE DA ENTIDADE ralic112025
class cl_ralic112025
{
  ...
  var $campos = "
                 ...
                 si181_codorgaoresp = varchar(2) = C�digo do �rg�o
                 si181_codunidadesubresp = varchar(8) = C�digo da unidade
                 si181_codunidadesubrespestadual = varchar(4) = C�digo da unidade respons�vel
                 si181_exerciciolicitacao = int8 = Exerc�cio da licita��o
                 si181_nroprocessolicitatorio = varchar(12) = N�mero sequencial do processo
                 si181_codobralocal = int8 = N�mero sequencial do processo
                 si181_classeobjeto = int8 = Classe do objeto
                 si181_tipoatividadeobra = int8 = Atividade da obra
                 si181_tipoatividadeservico = int8 = Atividade do servi�o
                 si181_dscatividadeservico = varchar(150) = Classe do objeto
                 si181_tipoatividadeservespecializado = int8 = Servi�o t�cnico especializado
                 si181_dscatividadeservespecializado = varchar(150) = Descri��o do Servi�o especializado
                 si181_codfuncao = varchar(2) = C�digo da fun��o
                 si181_codsubfuncao = varchar(3) = C�digo da fun��o
                 si181_codbempublico = int8 = C�digo do equipamento
                 si181_nrolote = int4 = N�mero do lote
                 si181_mes = int8 = M�s
                 si181_instit = int8 = Institui��o
                 si181_utilizacaoplanilhamodelo= int8 = Utilizacao planilha modelo
                 ";
  // cria propriedade com as variaveis do arquivo

  //funcao construtor da classe
  function cl_ralic112025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ralic112025");
  ...
  function incluir($si181_sequencial)
  {
    ...
    if ($si181_sequencial == "" || $si181_sequencial == null) {
      $result = db_query("select nextval('ralic112025_si181_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ralic112025_si181_sequencial_seq do campo: si181_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ralic112025_si181_sequencial_seq");
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ralic112025 ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ralic112025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ralic112025 ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si181_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ralic112025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si181_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ralic112025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si181_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si181_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ralic112025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ralic112025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si181_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ralic112025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si181_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ralic112025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si181_sequencial != null) {
        $sql2 .= " where ralic112025.si181_sequencial = $si181_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
