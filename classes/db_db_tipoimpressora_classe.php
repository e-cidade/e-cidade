...
class cl_db_tipoimpressora { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->db65_descricao = ($this->db65_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["db65_descricao"]:$this->db65_descricao);
       $this->db65_sequencial = ($this->db65_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db65_sequencial"]:$this->db65_sequencial);
     }else{
       $this->db65_sequencial = ($this->db65_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db65_sequencial"]:$this->db65_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($db65_sequencial){ 
      $this->atualizacampos();
     if($this->db65_descricao == null ){ 
     ...
     if($db65_sequencial == "" || $db65_sequencial == null ){
       $result = db_query("select nextval('db_tipoimpressora_db65_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: db_tipoimpressora_db65_sequencial_seq do campo: db65_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $db65_sequencial)){
         ...
         $this->db65_sequencial = $db65_sequencial; 
       }
     }
     if(($this->db65_sequencial == null) || ($this->db65_sequencial == "") ){ 
       $this->erro_sql = " Campo db65_sequencial nao declarado.";
     ...
     $sql = "insert into db_tipoimpressora(
                                       db65_descricao 
                                      ,db65_sequencial 
                       )
                values (
                                '$this->db65_descricao' 
                               ,$this->db65_sequencial 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->db65_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($db65_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($db65_sequencial!=null){
       $sql .= " db65_sequencial = $this->db65_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->db65_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Impressora nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db65_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Impressora nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db65_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db65_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($db65_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($db65_sequencial != ""){
          ...
          $sql2 .= " db65_sequencial = $db65_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Impressora nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$db65_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Impressora nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db65_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $db65_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from db_tipoimpressora ";
     $sql2 = "";
     if($dbwhere==""){
       if($db65_sequencial!=null ){
         $sql2 .= " where db_tipoimpressora.db65_sequencial = $db65_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
