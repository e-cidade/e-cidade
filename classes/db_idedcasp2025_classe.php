<?
//MODULO: sicom
//CLASSE DA ENTIDADE idedcasp2025
class cl_idedcasp2025 {
   ...
   function cl_idedcasp2025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("idedcasp2025");
   ...
   function incluir ($si200_sequencial){
     ...
     if($this->si200_codmunicipio == null ){
       $this->erro_sql = " Campo si200_codmunicipio n�o informado.";
     ...
     if($this->si200_cnpjorgao == null ){
       $this->erro_sql = " Campo si200_cnpjorgao n�o informado.";
     ...
     if($this->si200_codorgao == null ){
       $this->erro_sql = " Campo si200_codorgao n�o informado.";
     ...
     if($this->si200_tipoorgao == null ){
       $this->erro_sql = " Campo si200_tipoorgao n�o informado.";
     ...
     if($this->si200_tipodemcontabil == null ){
       $this->erro_sql = " Campo si200_tipodemcontabil n�o informado.";
     ...
     if($this->si200_exercicioreferencia == null ){
       $this->erro_sql = " Campo si200_exercicioreferencia n�o informado.";
     ...
     if($this->si200_datageracao == null ){
       $this->erro_sql = " Campo si200_datageracao n�o informado.";
     ...
     if($this->si200_codcontroleremessa == null ){
       $this->erro_sql = " Campo si200_codcontroleremessa n�o informado.";
     ...
     if(empty($si200_sequencial)){
       $result = db_query("select nextval('idedcasp2025_si200_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: idedcasp2025_si200_sequencial_seq do campo: si200_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from idedcasp2025_si200_sequencial_seq");
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "idedcasp2025 ($this->si200_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "idedcasp2025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "idedcasp2025 ($this->si200_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si200_sequencial=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "idedcasp2025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si200_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "idedcasp2025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si200_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si200_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "idedcasp2025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "idedcasp2025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si200_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:idedcasp2025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si200_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from idedcasp2025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si200_sequencial!=null ){
         $sql2 .= " where idedcasp2025.si200_sequencial = $si200_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
