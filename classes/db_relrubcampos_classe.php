...
class cl_relrubcampos { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->rh120_sequencial = ($this->rh120_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh120_sequencial"]:$this->rh120_sequencial);
       $this->rh120_campo = ($this->rh120_campo == ""?@$GLOBALS["HTTP_POST_VARS"]["rh120_campo"]:$this->rh120_campo);
       $this->rh120_tamanho = ($this->rh120_tamanho == ""?@$GLOBALS["HTTP_POST_VARS"]["rh120_tamanho"]:$this->rh120_tamanho);
       $this->rh120_limite = ($this->rh120_limite == ""?@$GLOBALS["HTTP_POST_VARS"]["rh120_limite"]:$this->rh120_limite);
     }else{
       $this->rh120_sequencial = ($this->rh120_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh120_sequencial"]:$this->rh120_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($rh120_sequencial){ 
      $this->atualizacampos();
     if($this->rh120_campo == null ){ 
     ...
     if($rh120_sequencial == "" || $rh120_sequencial == null ){
       $result = db_query("select nextval('relrubcampos_rh120_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: relrubcampos_rh120_sequencial_seq do campo: rh120_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $rh120_sequencial)){
         ...
         $this->rh120_sequencial = $rh120_sequencial; 
       }
     }
     if(($this->rh120_sequencial == null) || ($this->rh120_sequencial == "") ){ 
       $this->erro_sql = " Campo rh120_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->rh120_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->rh120_sequencial  ));
   ...
   function alterar ($rh120_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($rh120_sequencial!=null){
       $sql .= " rh120_sequencial = $this->rh120_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Relação dos campos da Rubrica nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh120_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Relação dos campos da Rubrica nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh120_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($rh120_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($rh120_sequencial));
       } else { 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($rh120_sequencial != ""){
          ...
          $sql2 .= " rh120_sequencial = $rh120_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Relação dos campos da Rubrica nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$rh120_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Relação dos campos da Rubrica nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh120_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $rh120_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from relrubcampos ";
     $sql2 = "";
     if($dbwhere==""){
       if($rh120_sequencial!=null ){
         $sql2 .= " where relrubcampos.rh120_sequencial = $rh120_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
  ...
  /**
   * Busca campos do gerador de relatorio (relatorio de rubricas)
   *
   * @param string $sCampos
   * @access public
   * @return string
   */
  public function sql_queryCamposRelatorio($sCampos = '*', $sWhere = null) {

    $sSql  = "   select {$sCampos}                                      ";
    $sSql .= "     from relrubcampos                                    ";
    ...
    $sSql .= " order by rh120_sequencial ";
