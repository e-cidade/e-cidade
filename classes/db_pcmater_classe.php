...
class cl_pcmater
{
  ...
  function alterar($pc01_codmater = null)
  {
    ...
    if (trim($this->pc01_regimobiliario) != "" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_regimobiliario"])) {
      $sql  .= $virgula . " pc01_regimobiliario = '$this->pc01_regimobiliario' ";
      $virgula = ",";
    }
    ...
    /*OC3770*/
    if (trim($this->pc01_tabela) != "" || isset($GLOBALS["HTTP_POST_VARS"]["pc01_tabela"])) {
      $sql  .= $virgula . " pc01_tabela = '$this->pc01_tabela' ";
      $virgula = ",";
    }
