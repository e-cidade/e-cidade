...
class cl_far_fatorrisco { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->fa44_i_codigo = ($this->fa44_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["fa44_i_codigo"]:$this->fa44_i_codigo);
       $this->fa44_c_descr = ($this->fa44_c_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["fa44_c_descr"]:$this->fa44_c_descr);
       $this->fa44_i_codrisco = ($this->fa44_i_codrisco == ""?@$GLOBALS["HTTP_POST_VARS"]["fa44_i_codrisco"]:$this->fa44_i_codrisco);
     }else{
       $this->fa44_i_codigo = ($this->fa44_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["fa44_i_codigo"]:$this->fa44_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($fa44_i_codigo){ 
      $this->atualizacampos();
     if($this->fa44_c_descr == null ){ 
     ...
     if($fa44_i_codigo == "" || $fa44_i_codigo == null ){
       $result = db_query("select nextval('far_fatorrisco_fa44_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: far_fatorrisco_fa44_i_codigo_seq do campo: fa44_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $fa44_i_codigo)){
         ...
         $this->fa44_i_codigo = $fa44_i_codigo; 
       }
     }
     if(($this->fa44_i_codigo == null) || ($this->fa44_i_codigo == "") ){ 
       $this->erro_sql = " Campo fa44_i_codigo nao declarado.";
     ...
     $sql = "insert into far_fatorrisco(
                                       fa44_i_codigo 
                                      ,fa44_c_descr 
                                      ,fa44_i_codrisco 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->fa44_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($fa44_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($fa44_i_codigo!=null){
       $sql .= " fa44_i_codigo = $this->fa44_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->fa44_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "far_fatorrisco nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->fa44_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "far_fatorrisco nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->fa44_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($fa44_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($fa44_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($fa44_i_codigo != ""){
          ...
          $sql2 .= " fa44_i_codigo = $fa44_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "far_fatorrisco nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$fa44_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "far_fatorrisco nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$fa44_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $fa44_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from far_fatorrisco ";
     $sql2 = "";
     if($dbwhere==""){
       if($fa44_i_codigo!=null ){
         $sql2 .= " where far_fatorrisco.fa44_i_codigo = $fa44_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
