...
class cl_empprestaitemempagemov { 
   ...
   var $campos = "
                 ...
                 e26_codmov = int4 = Código do Movimento 
                 ";
   ...
   function incluir ($e26_sequencial){ 
     ...
     if($this->e26_empprestaitem == null ){ 
       $this->erro_sql = " Campo emprestaitem não informado.";
     ...
     if($e26_sequencial == "" || $e26_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $e26_sequencial)){
         $this->erro_sql = " Campo e26_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "empprestaitemempagemov ($this->e26_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "empprestaitemempagemov já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "empprestaitemempagemov ($this->e26_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($e26_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "empprestaitemempagemov nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "empprestaitemempagemov nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$e26_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
