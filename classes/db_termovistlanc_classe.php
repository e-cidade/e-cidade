...
class cl_termovistlanc { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->y92_termovist = ($this->y92_termovist == ""?@$GLOBALS["HTTP_POST_VARS"]["y92_termovist"]:$this->y92_termovist);
       $this->y92_codvist = ($this->y92_codvist == ""?@$GLOBALS["HTTP_POST_VARS"]["y92_codvist"]:$this->y92_codvist);
     }else{
     }
   }
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Termo de Vistorias lancadas nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Termo de Vistorias lancadas nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Termo de Vistorias lancadas nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Termo de Vistorias lancadas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="termovistlanc.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from termovistlanc ";
     $sql .= "      inner join vistorias  on  vistorias.y70_codvist = termovistlanc.y92_codvist";
     $sql .= "      inner join termovist  on  termovist.y91_termovist = termovistlanc.y92_termovist";
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where termovistlanc.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
