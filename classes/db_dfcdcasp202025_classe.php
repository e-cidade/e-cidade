<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp202025
class cl_dfcdcasp202025 {
   ...
   function cl_dfcdcasp202025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp202025");
   ...
   function incluir ($si220_sequencial){
     ...
     if(empty($si220_sequencial)){
       $result = db_query("select nextval('dfcdcasp202025_si220_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp202025_si220_sequencial_seq do campo: si220_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp202025_si220_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si220_sequencial)){
         $this->erro_sql = " Campo si220_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp202025(
                                       si220_anousu
                                      ,si220_periodo
                                      ,si220_instit
                                      ,si220_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp202025 ($this->si220_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp202025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp202025 ($this->si220_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si220_sequencial=null) {
     ...
     if(trim($this->si220_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_sequencial"])){
       ...
       if(trim($this->si220_sequencial) == null ){
         $this->erro_sql = " Campo si220_sequencial n�o informado.";
     ...
     if(trim($this->si220_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_tiporegistro"])){
       ...
       if(trim($this->si220_tiporegistro) == null ){
         $this->erro_sql = " Campo si220_tiporegistro n�o informado.";
     ...
     if(trim($this->si220_vldesembolsopessoaldespesas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_vldesembolsopessoaldespesas"])){
       ...
       if(trim($this->si220_vldesembolsopessoaldespesas) == null ){
         $this->erro_sql = " Campo si220_vldesembolsopessoaldespesas n�o informado.";
     ...
     if(trim($this->si220_vldesembolsojurosencargdivida)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_vldesembolsojurosencargdivida"])){
       ...
       if(trim($this->si220_vldesembolsojurosencargdivida) == null ){
         $this->erro_sql = " Campo si220_vldesembolsojurosencargdivida n�o informado.";
     ...
     if(trim($this->si220_vldesembolsotransfconcedidas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_vldesembolsotransfconcedidas"])){
       ...
       if(trim($this->si220_vldesembolsotransfconcedidas) == null ){
         $this->erro_sql = " Campo si220_vldesembolsotransfconcedidas n�o informado.";
     ...
     if(trim($this->si220_vloutrosdesembolsos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_vloutrosdesembolsos"])){
       ...
       if(trim($this->si220_vloutrosdesembolsos) == null ){
         $this->erro_sql = " Campo si220_vloutrosdesembolsos n�o informado.";
     ...
     if(trim($this->si220_vltotaldesembolsosativoperacionais)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si220_vltotaldesembolsosativoperacionais"])){
       ...
       if(trim($this->si220_vltotaldesembolsosativoperacionais) == null ){
         $this->erro_sql = " Campo si220_vltotaldesembolsosativoperacionais n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp202025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si220_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp202025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si220_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si220_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp202025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp202025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si220_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp202025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si220_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp202025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si220_sequencial!=null ){
         $sql2 .= " where dfcdcasp202025.si220_sequencial = $si220_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
