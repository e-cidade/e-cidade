...
class cl_ctb412022
 { 
   ...
   function cl_ctb412022
   () { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("ctb412022
     "); 
   ...
   function incluir ($si100_sequencial){ 
     ...
     if($si100_sequencial == "" || $si100_sequencial == null ){
       $result = db_query("select nextval('ctb412022
       _si100_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: ctb412022
       ...
       $result = db_query("select last_value from ctb412022
       _si100_sequencial_seq");
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:ctb412022
        ";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
   ...
   function sql_query ( $si100_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ctb412022
      ";
     $sql .= "      inner join ctb402020  on  ctb402020.si99_sequencial = ctb412022
     .si100_reg40";
     $sql2 = "";
     if($dbwhere==""){
       if($si100_sequencial!=null ){
         $sql2 .= " where ctb412022
