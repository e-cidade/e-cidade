...
class cl_tiposituacaocadastrounico { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->as11_sequencial = ($this->as11_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["as11_sequencial"]:$this->as11_sequencial);
       $this->as11_situacao = ($this->as11_situacao == ""?@$GLOBALS["HTTP_POST_VARS"]["as11_situacao"]:$this->as11_situacao);
     }else{
       $this->as11_sequencial = ($this->as11_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["as11_sequencial"]:$this->as11_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($as11_sequencial){ 
      $this->atualizacampos();
     if($this->as11_situacao == null ){ 
     ...
     if($as11_sequencial == "" || $as11_sequencial == null ){
       $result = db_query("select nextval('tiposituacaocadastrounico_as11_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tiposituacaocadastrounico_as11_sequencial_seq do campo: as11_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $as11_sequencial)){
         ...
         $this->as11_sequencial = $as11_sequencial; 
       }
     }
     if(($this->as11_sequencial == null) || ($this->as11_sequencial == "") ){ 
       $this->erro_sql = " Campo as11_sequencial nao declarado.";
     ...
     $sql = "insert into tiposituacaocadastrounico(
                                       as11_sequencial 
                                      ,as11_situacao 
                       )
                values (
                                $this->as11_sequencial 
                               ,'$this->as11_situacao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->as11_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->as11_sequencial  ));
   ...
   function alterar ($as11_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($as11_sequencial!=null){
       $sql .= " as11_sequencial = $this->as11_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo SItuação Cadastro Único nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->as11_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo SItuação Cadastro Único nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->as11_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($as11_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($as11_sequencial));
       } else { 
     ...
     $sql = " delete from tiposituacaocadastrounico
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($as11_sequencial != ""){
          ...
          $sql2 .= " as11_sequencial = $as11_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo SItuação Cadastro Único nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$as11_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo SItuação Cadastro Único nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$as11_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $as11_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tiposituacaocadastrounico ";
     $sql2 = "";
     if($dbwhere==""){
       if($as11_sequencial!=null ){
         $sql2 .= " where tiposituacaocadastrounico.as11_sequencial = $as11_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
