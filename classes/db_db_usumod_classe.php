...
class cl_db_usumod { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->datausu == ""){
         $this->datausu_dia = ($this->datausu_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["datausu_dia"]:$this->datausu_dia);
         $this->datausu_mes = ($this->datausu_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["datausu_mes"]:$this->datausu_mes);
         $this->datausu_ano = ($this->datausu_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["datausu_ano"]:$this->datausu_ano);
         if($this->datausu_dia != ""){
            $this->datausu = $this->datausu_ano."-".$this->datausu_mes."-".$this->datausu_dia;
         }
       }
     }else{
     }
   ...
   function incluir (){ 
     ...
     $sql = "insert into db_usumod(
                ...
                values (
                               ...
                               ,$this->anousu 
                               ,$this->id_usuario 
                               ,".($this->datausu == "null" || $this->datausu == ""?"null":"'".$this->datausu."'")." 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Usuário módulo nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Usuário módulo nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Usuário módulo nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Usuário módulo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
  ...
  function alterar_where( $dbwhere=null ) { 
     $this->atualizacampos();
     $sql = " update db_usumod set ";
     $virgula = "";
     if(trim($this->id_item)!="" || isset($GLOBALS["HTTP_POST_VARS"]["id_item"])){ 
