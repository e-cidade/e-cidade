<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp502025
class cl_dfcdcasp502025 {
   ...
   function cl_dfcdcasp502025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp502025");
   ...
   function incluir ($si223_sequencial){
     ...
     if(empty($si223_sequencial)){
       $result = db_query("select nextval('dfcdcasp502025_si223_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp502025_si223_sequencial_seq do campo: si223_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp502025_si223_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si223_sequencial)){
         $this->erro_sql = " Campo si223_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp502025(
                                       si223_anousu
                                      ,si223_periodo
                                      ,si223_instit
                                      ,si223_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp502025 ($this->si223_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp502025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp502025 ($this->si223_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si223_sequencial=null) {
     ...
     if(trim($this->si223_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_sequencial"])){
       ...
       if(trim($this->si223_sequencial) == null ){
         $this->erro_sql = " Campo si223_sequencial n�o informado.";
     ...
     if(trim($this->si223_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_tiporegistro"])){
       ...
       if(trim($this->si223_tiporegistro) == null ){
         $this->erro_sql = " Campo si223_tiporegistro n�o informado.";
     ...
     if(trim($this->si223_vlaquisicaoativonaocirculante)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_vlaquisicaoativonaocirculante"])){
       ...
       if(trim($this->si223_vlaquisicaoativonaocirculante) == null ){
         $this->erro_sql = " Campo si223_vlaquisicaoativonaocirculante n�o informado.";
     ...
     if(trim($this->si223_vlconcessaoempresfinanciamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_vlconcessaoempresfinanciamento"])){
       ...
       if(trim($this->si223_vlconcessaoempresfinanciamento) == null ){
         $this->erro_sql = " Campo si223_vlconcessaoempresfinanciamento n�o informado.";
     ...
     if(trim($this->si223_vloutrosdesembolsos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_vloutrosdesembolsos"])){
       ...
       if(trim($this->si223_vloutrosdesembolsos) == null ){
         $this->erro_sql = " Campo si223_vloutrosdesembolsos n�o informado.";
     ...
     if(trim($this->si223_vltotaldesembolsoatividainvestimen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si223_vltotaldesembolsoatividainvestimen"])){
       ...
       if(trim($this->si223_vltotaldesembolsoatividainvestimen) == null ){
         $this->erro_sql = " Campo si223_vltotaldesembolsoatividainvestimen n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp502025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si223_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp502025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si223_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si223_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp502025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp502025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp502025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si223_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp502025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si223_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp502025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si223_sequencial!=null ){
         $sql2 .= " where dfcdcasp502025.si223_sequencial = $si223_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
