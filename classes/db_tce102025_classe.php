...
class cl_tce102025 {
  ...
  public $campos = "
                 ...
                 si187_numprocessotce = varchar(12) = N�mero do processo da tomada de contas
                 si187_datainstauracaotce = date = Data da instaura��o da tomada de contas
                 si187_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�am
                 si187_nroconvenioconge = varchar(30) = N�mero do conv�nio original ou instr
                 si187_dataassinaturaconvoriginalconge = date = Data da assinatura do conv�nio original
                 si187_dscinstrumelegaltce = varchar(50) = Instrumento Legal de Instaura��o da TCE
                 si187_nrocpfautoridadeinstauratce = varchar(11) = N�mero do CPF do respons�vel
                 si187_dsccargoresptce = varchar(50) = Cargo do respons�vel pela instaura��o
                 si187_vloriginaldano = float8 = Valor original do dano
                 si187_vlatualizadodano = float8 = Valor atualizado do dano
                 si187_dataatualizacao = date = Data da atualiza��o do valor do dano
                 si187_indice = varchar(20) = �ndice utilizado
                 si187_ocorrehipotese = int8 = Ocorr�ncia das hip�teses previstas
                 si187_identiresponsavel = int8 = Identifica��o dos respons�veis com estab
                 si187_mes = int8 = M�s
                 si187_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("tce102025");
  ...
  function incluir ($si187_sequencial) {
     ...
     if ($this->si187_numprocessotce == null ) {
       $this->erro_sql = " Campo N�mero do processo da tomada de contas n�o informado.";
     ...
     if ($this->si187_datainstauracaotce == null ) {
       $this->erro_sql = " Campo Data da instaura��o da tomada de contas n�o informado.";
     ...
     if ($this->si187_dscinstrumelegaltce == null ) {
       $this->erro_sql = " Campo Instrumento Legal de Instaura��o da TCE n�o informado.";
     ...
     if ($this->si187_nrocpfautoridadeinstauratce == null ) {
       $this->erro_sql = " Campo N�mero do CPF do respons�vel n�o informado.";
     ...
     if ($this->si187_dsccargoresptce == null ) {
       $this->erro_sql = " Campo Cargo do respons�vel pela instaura��o n�o informado.";
     ...
     if ($this->si187_vloriginaldano == null ) {
       $this->erro_sql = " Campo Valor original do dano n�o informado.";
     ...
     if ($this->si187_vlatualizadodano == null ) {
       $this->erro_sql = " Campo Valor atualizado do dano n�o informado.";
     ...
     if ($this->si187_dataatualizacao == null ) {
       $this->erro_sql = " Campo Data da atualiza��o do valor do dano n�o informado.";
     ...
     if ($this->si187_indice == null ) {
       $this->erro_sql = " Campo �ndice utilizado n�o informado.";
     ...
     if ($this->si187_ocorrehipotese == null ) {
       $this->erro_sql = " Campo Ocorr�ncia das hip�teses previstas n�o informado.";
     ...
     if ($this->si187_identiresponsavel == null ) {
       $this->erro_sql = " Campo Identifica��o dos respons�veis com estab n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Cadastro das Tomadas de Contas Especiais ($this->si187_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Cadastro das Tomadas de Contas Especiais j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Cadastro das Tomadas de Contas Especiais ($this->si187_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro das Tomadas de Contas Especiais nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro das Tomadas de Contas Especiais nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si187_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:tce102025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si187_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     if ($dbwhere=="") {
       if ($si187_sequencial!=null ) {
         $sql2 .= " where tce102025.si187_sequencial = $si187_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
