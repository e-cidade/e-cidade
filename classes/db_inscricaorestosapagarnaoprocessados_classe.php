...
//CLASSE DA ENTIDADE inscricaorestosapagarnaoprocessados
class cl_inscricaorestosapagarnaoprocessados { 
   ...
   function cl_inscricaorestosapagarnaoprocessados() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("inscricaorestosapagarnaoprocessados"); 
   ...
   function incluir ($c107_sequencial){ 
     ...
     if($c107_sequencial == "" || $c107_sequencial == null ){
       $result = db_query("select nextval('inscricaorestosapagarnaoprocessados_c107_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: inscricaorestosapagarnaoprocessados_c107_sequencial_seq do campo: c107_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from inscricaorestosapagarnaoprocessados_c107_sequencial_seq");
     ...
     $sql = "insert into inscricaorestosapagarnaoprocessados(
                                       c107_sequencial 
                                      ,c107_usuario 
                                      ,c107_instit 
                                      ,c107_ano 
   ...
   function alterar ($c107_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update inscricaorestosapagarnaoprocessados set ";
     $virgula = "";
   ...
   function excluir ($c107_sequencial=null,$dbwhere=null) { 
     ...
     $sql = " delete from inscricaorestosapagarnaoprocessados
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($c107_sequencial != ""){
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:inscricaorestosapagarnaoprocessados";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $c107_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from inscricaorestosapagarnaoprocessados ";
     ...
     if($dbwhere==""){
       if($c107_sequencial!=null ){
         $sql2 .= " where inscricaorestosapagarnaoprocessados.c107_sequencial = $c107_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
