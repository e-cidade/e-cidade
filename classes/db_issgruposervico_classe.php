...
class cl_issgruposervico {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q126_sequencial = ($this->q126_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q126_sequencial"]:$this->q126_sequencial);
       $this->q126_db_estruturavalor = ($this->q126_db_estruturavalor == ""?@$GLOBALS["HTTP_POST_VARS"]["q126_db_estruturavalor"]:$this->q126_db_estruturavalor);
     }else{
       $this->q126_sequencial = ($this->q126_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q126_sequencial"]:$this->q126_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($q126_sequencial){
      $this->atualizacampos();
     if($this->q126_db_estruturavalor == null ){
     ...
     if($q126_sequencial == "" || $q126_sequencial == null ){
       $result = db_query("select nextval('issgruposervico_q126_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: issgruposervico_q126_sequencial_seq do campo: q126_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $q126_sequencial)){
         ...
         $this->q126_sequencial = $q126_sequencial;
       }
     }
     if(($this->q126_sequencial == null) || ($this->q126_sequencial == "") ){
       $this->erro_sql = " Campo q126_sequencial nao declarado.";
     ...
     $sql = "insert into issgruposervico(
                                       q126_sequencial
                                      ,q126_db_estruturavalor
                       )
                values (
                                $this->q126_sequencial
                               ,$this->q126_db_estruturavalor
                      )";
     $result = db_query($sql);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q126_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q126_sequencial=null) {
      $this->atualizacampos();
     ...
     if($q126_sequencial!=null){
       $sql .= " q126_sequencial = $this->q126_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->q126_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Grupo de Serviço LC 116 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q126_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Grupo de Serviço LC 116 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q126_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($q126_sequencial=null,$dbwhere=null) {
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q126_sequencial));
     }else{
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($q126_sequencial != ""){
          ...
          $sql2 .= " q126_sequencial = $q126_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Grupo de Serviço LC 116 nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$q126_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Grupo de Serviço LC 116 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q126_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $q126_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     if($dbwhere==""){
       if($q126_sequencial!=null ){
         $sql2 .= " where issgruposervico.q126_sequencial = $q126_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
  ...
  function sql_query_EstruturalExercicio( $q126_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from issgruposervico ";
     $sql .= "      inner join db_estruturavalor           on db_estruturavalor.db121_sequencial = issgruposervico.q126_db_estruturavalor           ";
     $sql .= "      left  join issconfiguracaogruposervico on issgruposervico.q126_sequencial    = issconfiguracaogruposervico.q136_issgruposervico and q136_exercicio = ".db_getsession('DB_anousu');
     $sql2 = "";
     if($dbwhere==""){
       if($q126_sequencial!=null ){
         $sql2 .= " where issgruposervico.q126_sequencial = $q126_sequencial ";
