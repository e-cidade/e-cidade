...
class cl_fiscalmatric { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->y35_codnoti = ($this->y35_codnoti == ""?@$GLOBALS["HTTP_POST_VARS"]["y35_codnoti"]:$this->y35_codnoti);
       $this->y35_matric = ($this->y35_matric == ""?@$GLOBALS["HTTP_POST_VARS"]["y35_matric"]:$this->y35_matric);
     }else{
       $this->y35_codnoti = ($this->y35_codnoti == ""?@$GLOBALS["HTTP_POST_VARS"]["y35_codnoti"]:$this->y35_codnoti);
     }
   }
   // funcao para inclusao
   function incluir ($y35_codnoti){ 
      $this->atualizacampos();
     if($this->y35_matric == null ){ 
       ...
       $this->y35_codnoti = $y35_codnoti; 
     if(($this->y35_codnoti == null) || ($this->y35_codnoti == "") ){ 
       $this->erro_sql = " Campo y35_codnoti nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->y35_codnoti;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($y35_codnoti=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($y35_codnoti!=null){
       $sql .= " y35_codnoti = $this->y35_codnoti";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->y35_codnoti));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "fiscalmatric nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->y35_codnoti;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "fiscalmatric nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->y35_codnoti;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($y35_codnoti=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($y35_codnoti));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "fiscalmatric nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$y35_codnoti;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "fiscalmatric nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$y35_codnoti;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $y35_codnoti=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from fiscalmatric ";
     $sql .= "      inner join iptubase  on  iptubase.j01_matric = fiscalmatric.y35_matric";
     $sql .= "      inner join fiscal  on  fiscal.y30_codnoti = fiscalmatric.y35_codnoti";
     ...
     if($dbwhere==""){
       if($y35_codnoti!=null ){
         $sql2 .= " where fiscalmatric.y35_codnoti = $y35_codnoti "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
