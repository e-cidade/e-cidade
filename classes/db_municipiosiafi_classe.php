...
class cl_municipiosiafi { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q110_sequencial = ($this->q110_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_sequencial"]:$this->q110_sequencial);
       $this->q110_codigo = ($this->q110_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_codigo"]:$this->q110_codigo);
       $this->q110_descricao = ($this->q110_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_descricao"]:$this->q110_descricao);
       $this->q110_uf = ($this->q110_uf == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_uf"]:$this->q110_uf);
       $this->q110_cnpj = ($this->q110_cnpj == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_cnpj"]:$this->q110_cnpj);
     }else{
       $this->q110_sequencial = ($this->q110_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q110_sequencial"]:$this->q110_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($q110_sequencial){ 
      $this->atualizacampos();
     if($this->q110_codigo == null ){ 
     ...
     if($q110_sequencial == "" || $q110_sequencial == null ){
       $result = db_query("select nextval('municipiosiafi_q110_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: municipiosiafi_q110_sequencial_seq do campo: q110_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $q110_sequencial)){
         ...
         $this->q110_sequencial = $q110_sequencial; 
       }
     }
     if(($this->q110_sequencial == null) || ($this->q110_sequencial == "") ){ 
       $this->erro_sql = " Campo q110_sequencial nao declarado.";
     ...
     $sql = "insert into municipiosiafi(
                                       q110_sequencial 
                                      ,q110_codigo 
                                      ,q110_descricao 
                                      ,q110_uf 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q110_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q110_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($q110_sequencial!=null){
       $sql .= " q110_sequencial = $this->q110_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->q110_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tabela de Municipios SIAFI nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q110_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tabela de Municipios SIAFI nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q110_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($q110_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q110_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($q110_sequencial != ""){
          ...
          $sql2 .= " q110_sequencial = $q110_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tabela de Municipios SIAFI nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$q110_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tabela de Municipios SIAFI nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q110_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $q110_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from municipiosiafi ";
     $sql2 = "";
     if($dbwhere==""){
       if($q110_sequencial!=null ){
         $sql2 .= " where municipiosiafi.q110_sequencial = $q110_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
