...
class cl_censoetapamodal { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed273_i_codigo = ($this->ed273_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed273_i_codigo"]:$this->ed273_i_codigo);
       $this->ed273_i_sequencia = ($this->ed273_i_sequencia == ""?@$GLOBALS["HTTP_POST_VARS"]["ed273_i_sequencia"]:$this->ed273_i_sequencia);
       $this->ed273_i_modalidade = ($this->ed273_i_modalidade == ""?@$GLOBALS["HTTP_POST_VARS"]["ed273_i_modalidade"]:$this->ed273_i_modalidade);
       $this->ed273_c_etapa = ($this->ed273_c_etapa == ""?@$GLOBALS["HTTP_POST_VARS"]["ed273_c_etapa"]:$this->ed273_c_etapa);
     }else{
       $this->ed273_i_codigo = ($this->ed273_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed273_i_codigo"]:$this->ed273_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($ed273_i_codigo){ 
      $this->atualizacampos();
     if($this->ed273_i_sequencia == null ){ 
     ...
     if($this->ed273_i_modalidade == null ){ 
     ...
     if($ed273_i_codigo == "" || $ed273_i_codigo == null ){
       $result = db_query("select nextval('censoetapamodal_ed273_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: censoetapamodal_ed273_i_codigo_seq do campo: ed273_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed273_i_codigo)){
         ...
         $this->ed273_i_codigo = $ed273_i_codigo; 
       }
     }
     if(($this->ed273_i_codigo == null) || ($this->ed273_i_codigo == "") ){ 
       $this->erro_sql = " Campo ed273_i_codigo nao declarado.";
     ...
     $sql = "insert into censoetapamodal(
                                       ed273_i_codigo 
                                      ,ed273_i_sequencia 
                                      ,ed273_i_modalidade 
                                      ,ed273_c_etapa 
                ...
                values (
                                $this->ed273_i_codigo 
                               ,$this->ed273_i_sequencia 
                               ,$this->ed273_i_modalidade 
                               ,'$this->ed273_c_etapa' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ed273_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ed273_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ed273_i_codigo!=null){
       $sql .= " ed273_i_codigo = $this->ed273_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ed273_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Regras Etapas x Modalidades nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed273_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Regras Etapas x Modalidades nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed273_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed273_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ed273_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ed273_i_codigo != ""){
          ...
          $sql2 .= " ed273_i_codigo = $ed273_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Regras Etapas x Modalidades nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ed273_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Regras Etapas x Modalidades nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed273_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ed273_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from censoetapamodal ";
     $sql2 = "";
     if($dbwhere==""){
       if($ed273_i_codigo!=null ){
         $sql2 .= " where censoetapamodal.ed273_i_codigo = $ed273_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
