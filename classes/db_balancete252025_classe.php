<?php
//MODULO: sicom
//CLASSE DA ENTIDADE balancete252025
class cl_balancete252025 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("balancete252025");
  ...
  function incluir ($si195_sequencial) {
     ...
     if ($this->si195_tiporegistro == null ) {
       $this->erro_sql = " Campo si195_tiporegistro n�o informado.";
     ...
     if ($this->si195_contacontabil == null ) {
       $this->erro_sql = " Campo si195_contacontabil n�o informado.";
     ...
     if ($this->si195_codfundo == null ) {
       $this->erro_sql = " Campo si195_codfundo n�o informado.";
     ...
     if ($this->si195_atributosf == null ) {
       $this->erro_sql = " Campo si195_atributosf n�o informado.";
     ...
     if ($this->si195_naturezareceita == null ) {
       $this->erro_sql = " Campo si195_naturezareceita n�o informado.";
    ...
    //   $this->erro_sql = " Campo si195_saldoinicialnrsf n�o informado.";
    ...
    // }
     if ($this->si195_naturezasaldoinicialnrsf == null ) {
       $this->erro_sql = " Campo si195_naturezasaldoinicialnrsf n�o informado.";
...
//       $this->erro_sql = " Campo si195_totaldebitosnrsf n�o informado.";
...
//       $this->erro_sql = " Campo si195_totalcreditosnrsf n�o informado.";
...
//     }
     if ($this->si195_saldofinalnrsf == null ) {
       $this->erro_sql = " Campo si195_saldofinalnrsf n�o informado.";
     ...
     if ($this->si195_naturezasaldofinalnrsf == null ) {
       $this->erro_sql = " Campo si195_naturezasaldofinalnrsf n�o informado.";
     ...
     if ($this->si195_instit == null ) {
       $this->erro_sql = " Campo si195_instit n�o informado.";
     ...
     if ($this->si195_reg10 == null ) {
       $this->erro_sql = " Campo si195_reg10 n�o informado.";
    ...
    if ($si195_sequencial == "" || $si195_sequencial == null) {
      $result = db_query("select nextval('balancete252025_si195_sequencial_seq')");

      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete252025_si195_sequencial_seq do campo: si195_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete252025_si195_sequencial_seq");
    ...
    if (($this->si195_sequencial == null) || ($this->si195_sequencial == "")) {
     ...
     $sql = "insert into balancete252025(
                                       si195_sequencial
                                      ,si195_tiporegistro
                                      ,si195_contacontabil
                                      ,si195_codfundo
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "balancete252025 ($this->si195_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "balancete252025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "balancete252025 ($this->si195_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
  ...
  function alterar ($si195_sequencial=null) {
      $this->atualizacampos();
     $sql = " update balancete252025 set ";
     $virgula = "";
    ...
    /* if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "balancete252025 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si195_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "balancete252025 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si195_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
...
/*       if (($resaco != false) || ($this->numrows!=0)) {
     ...
     $sql = " delete from balancete252025
                    where ";
     $sql2 = "";
     if ($dbwhere==null || $dbwhere =="") {
        if ($si195_sequencial != "") {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "balancete252025 nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "balancete252025 nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si195_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:balancete252025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si195_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from balancete252025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si195_sequencial!=null ) {
         $sql2 .= " where balancete252025.si195_sequencial = $si195_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
