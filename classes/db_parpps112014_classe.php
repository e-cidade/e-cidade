<?
//MODULO: sicom
//CLASSE DA ENTIDADE parpps112014
class cl_parpps112014 { 
   ...
   var $campos = "
                 ...
                 si156_mes = int8 = Mês 
                 si156_reg10 = int8 = reg10 
                 ";
   //funcao construtor da classe 
   function cl_parpps112014() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("parpps112014"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si156_reg10 = ($this->si156_reg10 == ""?@$GLOBALS["HTTP_POST_VARS"]["si156_reg10"]:$this->si156_reg10);
     }else{
       $this->si156_sequencial = ($this->si156_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["si156_sequencial"]:$this->si156_sequencial);
     }
   }
   ...
   function incluir ($si156_sequencial){ 
     ...
     if($this->si156_vlsaldofinanceiroexercicioanterior == null ){ 
       ...
       $this->erro_campo = "si156_vlsaldofinanceiroexercicioanterior";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->si156_reg10 == null ){ 
       $this->erro_sql = " Campo reg10 nao Informado.";
       $this->erro_campo = "si156_reg10";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($si156_sequencial == "" || $si156_sequencial == null ){
       $result = db_query("select nextval('parpps112014_si156_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: parpps112014_si156_sequencial_seq do campo: si156_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from parpps112014_si156_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si156_sequencial)){
         $this->erro_sql = " Campo si156_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "parpps112014 ($this->si156_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "parpps112014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "parpps112014 ($this->si156_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010385,2011198,'','".AddSlashes(pg_result($resaco,0,'si156_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($si156_sequencial=null) { 
     ...
     if(trim($this->si156_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si156_sequencial"])){ 
       ...
       $virgula = ",";
       if(trim($this->si156_sequencial) == null ){ 
         $this->erro_sql = " Campo sequencial nao Informado.";
         $this->erro_campo = "si156_sequencial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->si156_vlsaldofinanceiroexercicioanterior)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si156_vlsaldofinanceiroexercicioanterior"])){ 
       ...
       $virgula = ",";
       if(trim($this->si156_vlsaldofinanceiroexercicioanterior) == null ){ 
         $this->erro_sql = " Campo Valor do Saldo  financeiro nao Informado.";
         $this->erro_campo = "si156_vlsaldofinanceiroexercicioanterior";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si156_reg10)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si156_reg10"])){ 
       $sql  .= $virgula." si156_reg10 = $this->si156_reg10 ";
       $virgula = ",";
       if(trim($this->si156_reg10) == null ){ 
         $this->erro_sql = " Campo reg10 nao Informado.";
         $this->erro_campo = "si156_reg10";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si156_reg10"]) || $this->si156_reg10 != "")
           $resac = db_query("insert into db_acount values($acount,2010385,2011198,'".AddSlashes(pg_result($resaco,$conresaco,'si156_reg10'))."','$this->si156_reg10',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parpps112014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si156_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parpps112014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si156_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si156_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010385,2011198,'','".AddSlashes(pg_result($resaco,$iresaco,'si156_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from parpps112014
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si156_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parpps112014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parpps112014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si156_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:parpps112014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si156_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from parpps112014 ";
     $sql .= "      inner join parpps102014  on  parpps102014.si155_sequencial = parpps112014.si156_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si156_sequencial!=null ){
         $sql2 .= " where parpps112014.si156_sequencial = $si156_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
