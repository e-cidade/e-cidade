<?php
//MODULO: sicom
//CLASSE DA ENTIDADE iderp102022
class cl_iderp102022 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("iderp102022");
  ...
  function incluir ($si179_sequencial) {
     ...
     if ($si179_sequencial == "" || $si179_sequencial == null ) {
       $result = db_query("select nextval('iderp102022_si179_sequencial_seq')");
       if ($result==false) {
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: iderp102022_si179_sequencial_seq do campo: si179_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from iderp102022_si179_sequencial_seq");
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:iderp102022";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si179_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from iderp102022 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si179_sequencial!=null ) {
         $sql2 .= " where iderp102022.si179_sequencial = $si179_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
