...
class cl_rpsd112019 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("rpsd112019");
  ...
  function incluir ($si190_sequencial) {
     ...
     if ($si190_sequencial == "" || $si190_sequencial == null ) {
       $result = db_query("select nextval('rpsd112019_si190_sequencial_seq')");
       if ($result==false) {
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: rpsd112019_si190_sequencial_seq do campo: si190_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from rpsd112019_si190_sequencial_seq");
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:rpsd112019";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si190_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from rpsd112019 ";
     $sql .= "      inner join rpsd102019  on  rpsd102019.si189_sequencial = rpsd112019.si190_reg10";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si190_sequencial!=null ) {
         $sql2 .= " where rpsd112019.si190_sequencial = $si190_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
