...
class cl_rhrubricas
{
    ...
    function incluir($rh27_rubric, $rh27_instit)
    {
        ...
        /**
         * Se a fundamentação for vazia o campo é preenchido com null.
         */
        ...
        if (($this->rh27_codincidprev == null) || ($this->rh27_codincidprev == "")) {
            $this->erro_sql = " Campo rh27_codincidprev não declarado.";
        ...
        if (($this->rh27_codincidirrf == null) || ($this->rh27_codincidirrf == "")) {
            $this->erro_sql = " Campo rh27_codincidirrf não declarado.";
            $this->erro_banco = "Chave Primaria zerada.";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if (($this->rh27_codincidfgts == null) || ($this->rh27_codincidfgts == "")) {
            $this->erro_sql = " Campo rh27_codincidfgts não declarado.";
            $this->erro_banco = "Chave Primaria zerada.";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if (($this->rh27_codincidregime == null) || ($this->rh27_codincidregime == "")) {
            $this->erro_sql = " Campo rh27_codincidregime não declarado.";
            $this->erro_banco = "Chave Primaria zerada.";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
        ...
        if (($this->rh27_tetoremun == null) || ($this->rh27_tetoremun == "")) {
            $this->erro_sql = " Campo rh27_tetoremun não declarado.";
            $this->erro_banco = "Chave Primaria zerada.";
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
    ...
    function alterar($rh27_rubric = null, $rh27_instit = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Tabela de rubricas não Alterado. Alteracao Abortada.\\n";
            $this->erro_sql .= "Valores : " . $this->rh27_rubric . "-" . $this->rh27_instit;
            $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Tabela de rubricas não foi Alterado. Alteracao Executada.\\n";
                $this->erro_sql .= "Valores : " . $this->rh27_rubric . "-" . $this->rh27_instit;
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
