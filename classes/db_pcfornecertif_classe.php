...
class cl_pcfornecertif {
  ...
  var $campos = "
                 ...
                 pc74_observacao = text = Observação 
                 ";
  ...
  function atualizacampos($exclusao=false) {
    if($exclusao==false){
      ...
      $this->pc74_observacao = ($this->pc74_observacao == ""?@$GLOBALS["HTTP_POST_VARS"]["pc74_observacao"]:$this->pc74_observacao);
      if($this->pc74_data == ""){
  ...
  function incluir ($pc74_codigo){
    ...
    if($this->pc74_observacao == null ){
      $this->pc74_observacao = "";
    }
  ...
  function alterar ($pc74_codigo=null) {
    ...
    if(trim($this->pc74_observacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc74_observacao"])){
      $sql  .= $virgula." pc74_observacao = '$this->pc74_observacao' ";
      $virgula = ",";
    }
