<?
//MODULO: sicom
//CLASSE DA ENTIDADE bpdcasp102024
class cl_bpdcasp102024 { 
   ...
   function cl_bpdcasp102024() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bpdcasp102024"); 
  ...
  if($this->si208_vlativocircudemaiscredicurtoprazo == null){
   ...
   if($si208_sequencial == "" || $si208_sequencial == null ){
       $result = db_query("select nextval('bpdcasp102024_si208_sequencial_seq')");
       if($result==false){
           $this->erro_banco = str_replace("
","",@pg_last_error());
           $this->erro_sql   = "Verifique o cadastro da sequencia: bpdcasp102024_si208_sequencial_seq do campo: si208_sequencial";
           $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
           $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
           $this->erro_status = "0";
           return false;
       ...
       $result = db_query("select last_value from bpdcasp102024_si208_sequencial_seq");
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bpdcasp102024 ($this->si208_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bpdcasp102024 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bpdcasp102024 ($this->si208_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si208_sequencial=null) { 
    ...
    if(trim($this->si208_vlativocircuativobio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si208_vlativocircuativobio"])){
     ...
     if(trim($this->si208_vlativocircuativobio) == null ){
       $this->erro_sql = " Campo si208_vlativocircuativobio não informado.";
    ...
    if(trim($this->si208_vltotalativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si208_vltotalativo"])){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp102024 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si208_sequencial;
       $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp102024 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si208_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si208_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp102024 nao Excluído. Exclusão Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp102024 nao Encontrado. Exclusão não Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si208_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bpdcasp102024";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si208_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from bpdcasp102024 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si208_sequencial!=null ){
         $sql2 .= " where bpdcasp102024.si208_sequencial = $si208_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
