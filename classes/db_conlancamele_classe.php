...
class cl_conlancamele { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->c67_codlan = ($this->c67_codlan == ""?@$GLOBALS["HTTP_POST_VARS"]["c67_codlan"]:$this->c67_codlan);
       $this->c67_codele = ($this->c67_codele == ""?@$GLOBALS["HTTP_POST_VARS"]["c67_codele"]:$this->c67_codele);
     }else{
       $this->c67_codlan = ($this->c67_codlan == ""?@$GLOBALS["HTTP_POST_VARS"]["c67_codlan"]:$this->c67_codlan);
     }
   }
   // funcao para inclusao
   function incluir ($c67_codlan){ 
      $this->atualizacampos();
     if($this->c67_codele == null ){ 
       ...
       $this->c67_codlan = $c67_codlan; 
     if(($this->c67_codlan == null) || ($this->c67_codlan == "") ){ 
       $this->erro_sql = " Campo c67_codlan nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Elementos dos lançamentos ($this->c67_codlan) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->c67_codlan;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     $this->numrows_incluir= pg_affected_rows($result);
     $resaco = $this->sql_record($this->sql_query_file($this->c67_codlan));
   ...
   function alterar ($c67_codlan=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($c67_codlan!=null){
       $sql .= " c67_codlan = $this->c67_codlan";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->c67_codlan));
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c67_codlan"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["c67_codele"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Elementos dos lançamentos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c67_codlan;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Elementos dos lançamentos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c67_codlan;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c67_codlan=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($c67_codlan));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Elementos dos lançamentos nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$c67_codlan;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Elementos dos lançamentos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c67_codlan;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conlancamele";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $c67_codlan=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join orcelemento  on  orcelemento.o56_codele = conlancamele.c67_codele and orcelemento.o56_anousu = ".db_getsession("DB_anousu");
     $sql .= "      inner join conlancam  on  conlancam.c70_codlan = conlancamele.c67_codlan";
     $sql2 = "";
     if($dbwhere==""){
       if($c67_codlan!=null ){
         $sql2 .= " where conlancamele.c67_codlan = $c67_codlan "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
