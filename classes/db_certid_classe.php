...
class cl_certid {
  ...
  public function sql_queryCertidao ($iCodigoPesquisa = null, $sTipoPesquisa = 'certidao', $sCampos) {
    ...
    $sSqlCertidao .= "               v01_numcgm     as numcgm,                                                   \n";
    $sSqlCertidao .= "               case                                                                        \n";
  ...
  function sql_query_arrecad($sCampos, $iCertidao) {
    ...
    $sSql .= "        left  join termodiv on certter.v14_parcel = termodiv.parcel    ";
    $sSql .= "        inner join divida   on divida.v01_coddiv  = termodiv.coddiv    ";
    $sSql .= "                            or divida.v01_coddiv  = certdiv.v14_coddiv ";
   ...
   * @return string  query pronta
   */
  function sql_query_abatimento( $iCertidao, $sCampos = "*", $iTipoAbatimento = 1 ) {
    ...
    $sSql .= "  where v13_certid in ({$iCertidao})                                               ";
