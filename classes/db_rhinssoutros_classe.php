...
class cl_rhinssoutros
{
  ...
  var $rh51_indicadesconto = null;
  var $rh51_cgcvinculo = null;
  var $rh51_categoria = null;
  ...
  var $campos = "
                 ...
                 rh51_indicadesconto = int4 = Indicativo de Desconto
                 rh51_cgcvinculo = varchar(14) = cpf ou cnpj
                 rh51_categoria = int4 = Categoria do Trabalhador no outro Vínculo
                 ";
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->rh51_indicadesconto = ($this->rh51_indicadesconto == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh51_indicadesconto"] : $this->rh51_indicadesconto);
      $this->rh51_cgcvinculo = ($this->rh51_cgcvinculo == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh51_cgcvinculo"] : $this->rh51_cgcvinculo);
      $this->rh51_categoria = ($this->rh51_categoria == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh51_categoria"] : $this->rh51_categoria);
    } else {
      $this->rh51_seqpes = ($this->rh51_seqpes == "" ? @$GLOBALS["HTTP_POST_VARS"]["rh51_seqpes"] : $this->rh51_seqpes);
    }
  }
  ...
  function incluir($rh51_seqpes)
  {
    ...
    if ($this->rh51_cgcvinculo == null) {
      $this->erro_sql = " Campo CNPJ/CPF do Outro Vínculo nao Informado.";
    ...
    if ($this->rh51_categoria == null) {
      $this->erro_sql = " Campo Categoria do Trabalhador no outro Vínculo nao Informado.";
      $this->erro_campo = "rh51_categoria";
      $this->erro_banco = "";
      $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
  ...
  function alterar($rh51_seqpes = null)
  {
    ...
    if (trim($this->rh51_indicadesconto) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh51_indicadesconto"])) {
      if (trim($this->rh51_indicadesconto) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh51_indicadesconto"])) {
        $this->rh51_indicadesconto = "0";
      }
      $sql  .= $virgula . " rh51_indicadesconto = $this->rh51_indicadesconto ";
      $virgula = ",";
    }
    ...
    if (trim($this->rh51_categoria) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh51_categoria"])) {
      if (trim($this->rh51_categoria) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh51_categoria"])) {
        $this->rh51_categoria = "0";
      }
      $sql  .= $virgula . " rh51_categoria = $this->rh51_categoria ";
      $virgula = ",";
    }
    $sql .= " where ";
    if ($rh51_seqpes != null) {
