...
class cl_cgs_und {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       //$this->z01_d_falecimento = ($this->z01_d_falecimento == ""?@$GLOBALS["HTTP_POST_VARS"]["z01_d_falecimento"]:$this->z01_d_falecimento);
       //if($this->z01_d_falecimento == ""){
...
if($this->z01_i_cgm == null ){
     ...
     if($this->z01_b_faleceu !== null && $this->z01_d_falecimento == null ){
    ...
    $sql2 = "INSERT INTO cgs_und_ext (z01_i_cgsund,
                          ...
                          VALUES(
                                      ...
                                      ".(empty($this->z01_v_ufnasc) || $this->z01_v_ufnasc == 'null' ? 'null' : "'".$this->z01_v_ufnasc."'").",
   ...
   public function alterar ($z01_i_cgsund=null) {
     ...
     if(trim($this->z01_v_telef)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_v_telef"])){
       ...
       $virgula = ",";
     } else if ( is_null($this->z01_v_telef) ) {
       $sql  .= $virgula." z01_v_telef = null ";
     }
     ...
     if(trim($this->z01_v_telcel)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_v_telcel"])){
       ...
       $virgula = ",";
     } else if ( is_null($this->z01_v_telcel) ) {
       $sql  .= $virgula." z01_v_telcel = null ";
     }
  ...
  function alterarExt()
  {
    ...
    if(trim($this->z01_i_cgm)!=""){
      $sql  .= $virgula." z01_i_cgm = '$this->z01_i_cgm' ";
      $virgula = ",";
    }
    if(trim($this->z01_i_cge)!=""){
      $sql  .= $virgula." z01_i_cge = '$this->z01_i_cge' ";
      $virgula = ",";
    }
    if(trim($this->z01_i_cidadao)!=""){
      $sql  .= $virgula." z01_i_cidadao = '$this->z01_i_cidadao' ";
      $virgula = ",";
    }
    ...
    if($this->z01_b_faleceu != "") {
      $sql  .= $virgula." z01_b_faleceu = TRUE ";
      $virgula = ",";
    } else {
      $sql  .= $virgula." z01_b_faleceu = FALSE ";
      $virgula = ",";
    }
    ...
    if(trim($this->z01_b_descnomemae)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_b_descnomemae"])){
      $sql  .= $virgula." z01_b_descnomemae = TRUE ";
      $virgula = ",";
    } else {
      $sql  .= $virgula." z01_b_descnomemae = FALSE ";
      $virgula = ",";
    }
    ...
    if(trim($this->z01_i_escolaridade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_i_escolaridade"])){
    ...
    if(!empty($this->z01_i_codocupacao)){
      $sql  .= $virgula." z01_i_codocupacao = '$this->z01_i_codocupacao' ";
      $virgula = ",";
    }

    if(trim($this->z01_b_inativo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["z01_b_inativo"])){
      $sql  .= $virgula." z01_b_inativo = TRUE ";
      $virgula = ",";
    } else {
      $sql  .= $virgula." z01_b_inativo = FALSE ";
      $virgula = ",";
    }
  ...
  function sql_query_etnia ($z01_i_cgsund = null, $campos = "*", $ordem = null, $dbwhere = "") {
   ...
   function sql_query_cgs_beneficiadosajudacusto($z01_i_cgsund=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= ' from ';
     $sql .= '   ((select cgs_und.*, tf01_i_codigo, 1 as tipo,z01_nome,tf17_d_datasaida,tf17_c_horasaida,tf25_i_destino, tf01_i_situacao, 2 as tf13_i_anulado ';
     $sql .= '       from cgs_und ';
     ...
     $sql .= '             union ';
     $sql .= '    (select cgs_und.*, tf01_i_codigo, 2 as tipo,z01_nome,tf17_d_datasaida,tf17_c_horasaida,tf25_i_destino, tf01_i_situacao, tf13_i_anulado ';
     $sql .= '       from cgs_und ';
