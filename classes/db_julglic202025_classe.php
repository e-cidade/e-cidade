<?
//MODULO: sicom
//CLASSE DA ENTIDADE julglic202025
class cl_julglic202025
{
  ...
  var $campos = "
                 ...
                 si61_codorgao = varchar(2) = C�digo do �rg�o
                 si61_codunidadesub = varchar(8) = C�digo da unidade
                 si61_exerciciolicitacao = int8 = Exerc�cio em que  foi instaurado
                 si61_nroprocessolicitatorio = varchar(12) = N�mero sequencial do processo
                 si61_tipodocumento = int8 = Tipo de documento
                 si61_nrodocumento = varchar(14) = N�mero do  documento
                 si61_nrolote = int8 = N�mero do lote  licitado
                 si61_coditem = varchar(15) = C�digo do Item
                 si61_percdesconto = float8 = Percentual do  desconto
                 si61_mes = int8 = M�s
                 si61_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_julglic202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("julglic202025");
  ...
  function incluir($si61_sequencial)
  {
    ...
    if ($si61_sequencial == "" || $si61_sequencial == null) {
      $result = db_query("select nextval('julglic202025_si61_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: julglic202025_si61_sequencial_seq do campo: si61_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from julglic202025_si61_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si61_sequencial)) {
        $this->erro_sql = " Campo si61_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "julglic202025 ($this->si61_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "julglic202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "julglic202025 ($this->si61_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si61_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "julglic202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si61_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "julglic202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si61_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si61_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "julglic202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "julglic202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si61_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:julglic202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si61_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from julglic202025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si61_sequencial != null) {
        $sql2 .= " where julglic202025.si61_sequencial = $si61_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
