<?
//MODULO: sicom
//CLASSE DA ENTIDADE ideedital2025
class cl_ideedital2025
{
  ...
  var $campos = "
                 ...
                 si186_codidentificador = int8 = C�digo do Munic�pio
                 si186_cnpj = varchar(14) = cnpj
                 si186_codorgao = char(3) = C�digo do Org�o
                 si186_tipoorgao = char(2) = Tipo do Org�o
                 si186_exercicioreferencia = int4 = Exerc�cio de  refer�ncia
                 si186_mesreferencia = char(2) = M�s de refer�ncia
                 si186_datageracao = date = Data de gera��o
                 si186_codcontroleremessa = varchar(20) = C�digo de controle
                 si186_codseqremessames = int4 = C�digo sequencial da Remessa
                 si186_mes = int8 = M�s
                 si186_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ideedital2025(){
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ideedital2025");
  ...
  function incluir($si186_sequencial){
	...
	if ($si186_sequencial == "" || $si186_sequencial == null) {
      $result = db_query("select nextval('ideedital2025_si186_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ideedital2025_si186_sequencial_seq do campo: si186_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ideedital2025_si186_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si186_sequencial)) {
        $this->erro_sql = " Campo si186_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ideedital2025 ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ideedital2025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      }
      else {
        $this->erro_sql = "ideedital2025 ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
  ...
  function alterar($si186_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ideedital2025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si186_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ideedital2025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si186_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si186_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ideedital2025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ideedital2025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si186_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ideedital2025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si186_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ideedital2025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si186_sequencial != null) {
        $sql2 .= " where ideedital2025.si186_sequencial = $si186_sequencial ";
      }
    }
    else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
