...
class cl_dfcdcasp702017 {
   ...
   function incluir ($si225_sequencial){
     ...
     if(empty($si225_sequencial)){
       $result = db_query("select nextval('dfcdcasp702017_si225_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp702017_si225_sequencial_seq do campo: si225_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from dfcdcasp702017_si225_sequencial_seq");
