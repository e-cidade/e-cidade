<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf102025
class cl_dclrf102025 {
   ...
   var $campos = "
                 ...
                 si157_codorgao = char(2) = C�digo do �rg�o
                 si157_vlsaldoatualconcgarantiainterna = double = Saldo atual das concess�es de garantia
                 si157_vlsaldoatualconcgarantia = double = Saldo atual das concess�es de garantia
                 ...
                 si157_recalieninvpermanente = Double = c�lculo apurado da receita de aliena��o
                 si157_vldotinicialincentcontrib = Double = valor dota��o inicial de incentivo  a contribuinte
                 si157_vldotatualizadaincentcontrib = double = Valor da dota��o atualizada de Incentivo
                 si157_vlempenhadoicentcontrib = Double = Valor empenhado de Incentivo
                 si157_vldotinicialincentinstfinanc = Double = valor dota��o de incentivo concedido por institui��o financeira
                 si157_vldotatualizadaincentinstfinanc = double = Valor da dota��o atualizada de Incentivo
                 ...
                 si157_vlirpnpincentcontrib = double = Restos a Pagar N�o Processados
                 si157_vlirpnpincentinstfinanc = double = Restos a Pagar N�o Processados de Incen
                 si157_vlapropiacaodepositosjudiciais = double = Saldo apurado da apropria��o
                 si157_vlajustesrelativosrpps = double = valor de ajustes relativos ao rpps
                 si157_vloutrosajustes = double = Valores n�o considerados
                 ...
                 si157_instit = int8 = Institui��o
                 ";
   //funcao construtor da classe
   function cl_dclrf102025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dclrf102025");
   ...
   function incluir (){
     ...
     if($this->si157_vlsaldoatualconcgarantiainterna == null ){
       $this->erro_sql = " Campo Saldo atual das concess�es de garantia nao Informado.";
     ...
     if($this->si157_recalieninvpermanente == null ){
       $this->erro_sql = " Campo c�lculo apurado da receita de aliena��o nao Informado.";
       ...
       if($this->si157_vldotinicialincentcontrib == null ){
           $this->erro_sql = " Campo valor dota��o inicial de incentivo  a contribuinte nao Informado.";
     ...
     if($this->si157_vldotatualizadaincentcontrib == null ){
       $this->erro_sql = " Campo Valor da dota��o atualizada de Incentivo nao Informado.";
     ...
     if($this->si157_vlempenhadoicentcontrib == null ){
       ...
       if($this->si157_vldotinicialincentinstfinanc == null ){
           $this->erro_sql = " Campo valor dota��o de incentivo concedido por institui��o financeira nao Informado.";
     ...
     if($this->si157_vlirpnpincentcontrib == null ){
       $this->erro_sql = " Campo Restos a Pagar N�o Processados nao Informado.";
     ...
     if($this->si157_vlirpnpincentinstfinanc == null ){
       $this->erro_sql = " Campo Restos a Pagar N�o Processados de Incen nao Informado.";
     ...
     if($this->si157_vlapropiacaodepositosjudiciais == null ){
       $this->erro_sql = " Campo Saldo apurado da apropria��o nao Informado.";
     ...
     if($this->si157_vloutrosajustes == null ){
       $this->erro_sql = " Campo Valores n�o considerados nao Informado.";
     ...
     if($si157_sequencial == "" || $si157_sequencial == null ){
       $result = @pg_query("select nextval('dclrf102025_si157_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf102025_si157_sequencial_seq do campo: si157_sequencial";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = @pg_query("select last_value from dclrf102025_si157_sequencial_seq");
...
//     die($sql);
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Dados Complementares � LRF () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Dados Complementares � LRF j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Dados Complementares � LRF () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ( $si157_sequencial=null ) {
     ...
     if(trim($this->si157_vlrecursosnaoaplicados)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si157_vlrecursosnaoaplicados"])){
       ...
       if(trim($this->si157_vlrecursosnaoaplicados) == null ){
         $this->erro_sql = " Campo Recursos do FUNDEB n�o aplicados nao Informado.";
   ...
   function excluir ( $si157_mes=null, $si157_codorgao=null ) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Dados Complementares � LRF nao Exclu�do. Exclus�o Abortada.\\n";
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       return false;
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Dados Complementares � LRF nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         return true;
   ...
   function sql_query ( $si157_sequencial = null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dclrf102025 ";
     $sql2 = "";
     if($dbwhere==""){
       if( $si157_sequencial != "" && $si157_sequencial != null){
          $sql2 = " where dclrf102025.si157_sequencial = $si157_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
