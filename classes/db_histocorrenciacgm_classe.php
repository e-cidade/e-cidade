...
class cl_histocorrenciacgm { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ar24_sequencial = ($this->ar24_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ar24_sequencial"]:$this->ar24_sequencial);
       $this->ar24_numcgm = ($this->ar24_numcgm == ""?@$GLOBALS["HTTP_POST_VARS"]["ar24_numcgm"]:$this->ar24_numcgm);
       $this->ar24_histocorrencia = ($this->ar24_histocorrencia == ""?@$GLOBALS["HTTP_POST_VARS"]["ar24_histocorrencia"]:$this->ar24_histocorrencia);
     }else{
       $this->ar24_sequencial = ($this->ar24_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ar24_sequencial"]:$this->ar24_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($ar24_sequencial){ 
      $this->atualizacampos();
     if($this->ar24_numcgm == null ){ 
     ...
     if($this->ar24_histocorrencia == null ){ 
     ...
     if($ar24_sequencial == "" || $ar24_sequencial == null ){
       $result = db_query("select nextval('histocorrenciacgm_ar24_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: histocorrenciacgm_ar24_sequencial_seq do campo: ar24_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ar24_sequencial)){
         ...
         $this->ar24_sequencial = $ar24_sequencial; 
       }
     }
     if(($this->ar24_sequencial == null) || ($this->ar24_sequencial == "") ){ 
       $this->erro_sql = " Campo ar24_sequencial nao declarado.";
     ...
     $sql = "insert into histocorrenciacgm(
                                       ar24_sequencial 
                                      ,ar24_numcgm 
                                      ,ar24_histocorrencia 
                       )
                values (
                                $this->ar24_sequencial 
                               ,$this->ar24_numcgm 
                               ,$this->ar24_histocorrencia 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ar24_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ar24_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ar24_sequencial!=null){
       $sql .= " ar24_sequencial = $this->ar24_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ar24_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "histocorrenciacgm nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ar24_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "histocorrenciacgm nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ar24_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ar24_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ar24_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ar24_sequencial != ""){
          ...
          $sql2 .= " ar24_sequencial = $ar24_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "histocorrenciacgm nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ar24_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "histocorrenciacgm nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ar24_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ar24_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from histocorrenciacgm ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = histocorrenciacgm.ar24_numcgm";
     $sql .= "      inner join histocorrencia  on  histocorrencia.ar23_sequencial = histocorrenciacgm.ar24_histocorrencia";
     ...
     if($dbwhere==""){
       if($ar24_sequencial!=null ){
         $sql2 .= " where histocorrenciacgm.ar24_sequencial = $ar24_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
