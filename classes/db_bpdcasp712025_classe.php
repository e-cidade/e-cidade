<?
//MODULO: sicom
//CLASSE DA ENTIDADE bpdcasp712025
class cl_bpdcasp712025 { 
   ...
   function cl_bpdcasp712025() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bpdcasp712025"); 
   ...
   function incluir ($si215_sequencial){ 
     ...
     if($this->si215_tiporegistro == null ){
       $this->erro_sql = " Campo si215_tiporegistro n�o informado.";
     ...
     $sql = "insert into bpdcasp712025(
                ...
                values (
                                (select nextval('bpdcasp712025_si215_sequencial_seq'))
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bpdcasp712025 ($this->si215_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bpdcasp712025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bpdcasp712025 ($this->si215_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si215_sequencial=null) { 
     ...
     if(trim($this->si215_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si215_sequencial"])){ 
       ...
       if(trim($this->si215_sequencial) == null ){ 
         $this->erro_sql = " Campo si215_sequencial n�o informado.";
     ...
     if(trim($this->si215_codfontrecursos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si215_codfontrecursos"])){ 
       ...
       if(trim($this->si215_codfontrecursos) == null ){ 
         $this->erro_sql = " Campo si215_codfontrecursos n�o informado.";
     ...
     if(trim($this->si215_codfontrecursos24)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si215_codfontrecursos24"])){ 
      ...
      if(trim($this->si215_codfontrecursos24) == null ){ 
        $this->erro_sql = " Campo si215_codfontrecursos24 n�o informado.";
     ...
     if(trim($this->si215_vlsaldofonte)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si215_vlsaldofonte"])){ 
       ...
       if(trim($this->si215_vlsaldofonte) == null ){ 
         $this->erro_sql = " Campo si215_vlsaldofonte n�o informado.";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp712025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si215_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp712025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si215_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si215_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp712025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp712025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si215_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bpdcasp712025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si215_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from bpdcasp712025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si215_sequencial!=null ){
         $sql2 .= " where bpdcasp712025.si215_sequencial = $si215_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
