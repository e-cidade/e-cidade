<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa182025
class cl_dispensa182025
{
  ...
  var $campos = "
                 ...
                 si82_codorgaoresp = varchar(2) = C�digo do �rg�o  respons�vel
                 si82_codunidadesubresp = varchar(8) = C�digo da unidade
                 si82_exercicioprocesso = int8 = Exerc�cio em que  foi instaurado
                 si82_nroprocesso = varchar(12) = N�mero sequencial do processo
                 si82_tipoprocesso = int8 = Tipo de processo
                 si82_tipodocumento = int8 = Tipo do documento
                 si82_nrodocumento = varchar(14) = N�mero do  documento
                 si82_datacredenciamento = date = Data do  credenciamento
                 si82_nrolote = int8 = N�mero do Lote
                 si82_coditem = int8 = C�digo do Item
                 si82_nroinscricaoestadual = varchar(30) = N�mero da  Inscri��o estadual
                 si82_ufinscricaoestadual = varchar(2) = UF da inscri��o  estadual
                 si82_nrocertidaoregularidadeinss = varchar(30) = N�mero da certid�o  de R do INSS
                 si82_dataemissaocertidaoregularidadeinss = date = Data de emiss�o  da certid�o
                 si82_dtvalidadecertidaoregularidadeinss = date = Data de validade  da certid�o
                 si82_nrocertidaoregularidadefgts = varchar(30) = N�mero da certid�o  de regularidade
                 si82_dtemissaocertidaoregularidadefgts = date = Data de emiss�o  da certid�o
                 si82_dtvalidadecertidaoregularidadefgts = date = Data de validade  da certid�
                 si82_nrocndt = varchar(30) = N�mero da  Certid�o Negativa  de D�bitos
                 si82_dtemissaocndt = date = Data de emiss�o  da certid�o
                 si82_dtvalidadecndt = date = Data de validade  da certid�o
                 si82_mes = int8 = M�s
                 si82_reg10 = int8 = reg10
                 si82_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_dispensa182025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dispensa182025");
  ...
  function incluir($si82_sequencial)
  {
    ...
    if ($si82_sequencial == "" || $si82_sequencial == null) {
      $result = db_query("select nextval('dispensa182025_si82_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: dispensa182025_si82_sequencial_seq do campo: si82_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from dispensa182025_si82_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si82_sequencial)) {
        $this->erro_sql = " Campo si82_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into dispensa182025(
                                       si82_sequencial
                                      ,si82_tiporegistro
                                      ,si82_codorgaoresp
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "dispensa182025 ($this->si82_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "dispensa182025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "dispensa182025 ($this->si82_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si82_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa182025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si82_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa182025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si82_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si82_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from dispensa182025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si82_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa182025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa182025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si82_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:dispensa182025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si82_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from dispensa182025 ";
    $sql .= "      left  join dispensa102020  on  dispensa102020.si74_sequencial = dispensa182025.si82_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si82_sequencial != null) {
        $sql2 .= " where dispensa182025.si82_sequencial = $si82_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
