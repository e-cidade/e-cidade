<?
//MODULO: sicom
//CLASSE DA ENTIDADE metareal102025
class cl_metareal102025
{
  ...
  var $campos = "
                 ...
                 si171_codorgao = varchar(2) = c�digo do �rg�o
                 si171_codunidadesub = varchar(8) = c�digo da unidade ou subunidade or�ament�ria
                 si171_codfuncao = int8 = grupo da despesa
                 si171_codsubfuncao = float8 = valor referente a dota��o mensal da despesa
                 si171_codprograma = varchar(4) = c�digo do programa
                 si171_idacao = varchar(4) = c�digo que identifica a a��o
                 si171_idsubacao = varchar(4) = c�digo que identifica a suba��o
                 si171_metarealizada = float8 = quantidade realizada da meta f�sica no exerc�cio
                 si171_justificativa = varchar(1000) = justificativa
                 si171_mes = int8 = M�s
                 si171_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_metareal102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("metareal102025");
  ...
  function incluir($si171_sequencial)
  {
    ...
    if ($si171_sequencial == "" || $si171_sequencial == null) {
      $result = db_query("select nextval('metareal102025_si171_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: metareal102025_si171_sequencial_seq do campo: si171_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from metareal102025_si171_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si171_sequencial)) {
        $this->erro_sql = " Campo si171_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into metareal102025(
                                       si171_sequencial
                                      ,si171_tiporegistro
                                      ,si171_codorgao
                                      ,si171_codunidadesub
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "metareal102025 ($this->si171_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "metareal102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "metareal102025 ($this->si171_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si171_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "metareal102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si171_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "metareal102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si171_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si171_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from metareal102025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si171_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "metareal102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "metareal102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si171_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:metareal102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si171_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from metareal102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si171_sequencial != null) {
        $sql2 .= " where metareal102025.si171_sequencial = $si171_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
