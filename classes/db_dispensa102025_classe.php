<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa102025
class cl_dispensa102025
{
  ...
  var $si74_codunidadesubedital = null;
  var $si74_tipocriterio = null;
  // cria propriedade com as variaveis do arquivo
  var $campos = "
                 si74_sequencial = int8 = sequencial
                 si74_tiporegistro = int8 = Tipo do  registro
                 si74_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si74_codunidadesubresp = varchar(8) = C�digo da unidade
                 si74_exercicioprocesso = int8 = Exerc�cio em que foi instaurado
                 si74_nroprocesso = varchar(12) = N�mero sequencial  do processo
                 si74_tipoprocesso = int8 = Tipo de processo
                 si74_dtabertura = date = Data de abertura
                 si74_naturezaobjeto = int8 = Natureza do objeto
                 si74_objeto = varchar(500) = Objeto da  contrata��o
                 si74_justificativa = varchar(250) = Justificativa
                 si74_razao = varchar(250) = Raz�o
                 si74_dtpublicacaotermoratificacao = date = Data de Publica��o  do Termo
                 si74_veiculopublicacao = varchar(50) = Nome do ve�culo
                 si74_processoporlote = int8 = Processo por Lote
                 si74_processoporlote = int8 = Tipo de cadastro
                 si74_mes = int8 = M�s
                 si74_instit = int8 = Institui��o
                 si74_leidalicitacao = int8 = Lei da Licita��o
                 si74_codunidadesubedital = int = Cod Unidade Sub Edital
                 si74_tipocriterio = int = Tipo Criterio;
                 ";

  //funcao construtor da classe
  function cl_dispensa102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dispensa102025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si74_codunidadesubedital = ($this->si74_codunidadesubedital == "" ? @$GLOBALS["HTTP_POST_VARS"]["si74_codunidadesubedital"] : $this->si74_codunidadesubedital);
      $this->si74_tipocriterio = ($this->si74_tipocriterio == "" ? @$GLOBALS["HTTP_POST_VARS"]["si74_tipocriterio"] : $this->si74_tipocriterio);
    } else {
      $this->si74_sequencial = ($this->si74_sequencial == "" ? @$GLOBALS["HTTP_POST_VARS"]["si74_sequencial"] : $this->si74_sequencial);
    }
  }
  ...
  function incluir($si74_sequencial)
  {
    ...
    if ($this->si74_codunidadesubedital == null) {
      $this->erro_sql = " Campo Cod Unidade SUb Edital nao Informado.";
      $this->erro_campo = "si74_codunidadesubedital";
      $this->erro_banco = "";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
    ...
    if ($si74_sequencial == "" || $si74_sequencial == null) {
      $result = db_query("select nextval('dispensa102025_si74_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: dispensa102025_si74_sequencial_seq do campo: si74_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from dispensa102025_si74_sequencial_seq");
    ...
    $sql = "insert into dispensa102025(
                                       si74_sequencial
                                      ,si74_tiporegistro
                                      ,si74_codorgaoresp
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "dispensa102025 ($this->si74_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "dispensa102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "dispensa102025 ($this->si74_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si74_sequencial = null)
  {
    ...
    if (trim($this->si74_leidalicitacao) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si74_leidalicitacao"])) {
      ...
      if (trim($this->si74_leidalicitacao) == null) {
        $this->erro_sql = " Campo da Lei de Licita��o n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si74_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si74_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si74_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from dispensa102025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si74_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si74_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:dispensa102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si74_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from dispensa102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si74_sequencial != null) {
        $sql2 .= " where dispensa102025.si74_sequencial = $si74_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
