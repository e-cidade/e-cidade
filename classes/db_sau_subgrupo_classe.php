...
class cl_sau_subgrupo { 
   ...
   var $campos = "
                 ...
                 sd61_c_nome = varchar(100) = Sub Grupo 
                 sd61_i_anocomp = int4 = Ano 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->sd61_i_codigo = ($this->sd61_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_i_codigo"]:$this->sd61_i_codigo);
       $this->sd61_c_subgrupo = ($this->sd61_c_subgrupo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_c_subgrupo"]:$this->sd61_c_subgrupo);
       $this->sd61_i_grupo = ($this->sd61_i_grupo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_i_grupo"]:$this->sd61_i_grupo);
       $this->sd61_c_nome = ($this->sd61_c_nome == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_c_nome"]:$this->sd61_c_nome);
       $this->sd61_i_anocomp = ($this->sd61_i_anocomp == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_i_anocomp"]:$this->sd61_i_anocomp);
       $this->sd61_i_mescomp = ($this->sd61_i_mescomp == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_i_mescomp"]:$this->sd61_i_mescomp);
     }else{
       $this->sd61_i_codigo = ($this->sd61_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd61_i_codigo"]:$this->sd61_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($sd61_i_codigo){ 
      $this->atualizacampos();
     if($this->sd61_c_subgrupo == null ){ 
     ...
     if($sd61_i_codigo == "" || $sd61_i_codigo == null ){
       $result = db_query("select nextval('sau_subgrupo_sd61_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: sau_subgrupo_sd61_i_codigo_seq do campo: sd61_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $sd61_i_codigo)){
         ...
         $this->sd61_i_codigo = $sd61_i_codigo; 
       }
     }
     if(($this->sd61_i_codigo == null) || ($this->sd61_i_codigo == "") ){ 
       $this->erro_sql = " Campo sd61_i_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->sd61_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($sd61_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($sd61_i_codigo!=null){
       $sql .= " sd61_i_codigo = $this->sd61_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->sd61_i_codigo));
     if($this->numrows>0){
   ...
   function excluir ($sd61_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($sd61_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($sd61_i_codigo != ""){
          ...
          $sql2 .= " sd61_i_codigo = $sd61_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Sub Grupo nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$sd61_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Sub Grupo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$sd61_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $sd61_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from sau_subgrupo ";
     $sql .= "      inner join sau_grupo  on  sau_grupo.sd60_i_codigo = sau_subgrupo.sd61_i_grupo";
     $sql2 = "";
     if($dbwhere==""){
       if($sd61_i_codigo!=null ){
         $sql2 .= " where sau_subgrupo.sd61_i_codigo = $sd61_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
