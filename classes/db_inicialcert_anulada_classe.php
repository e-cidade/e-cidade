...
class cl_inicialcert_anulada { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->v49_inicial = ($this->v49_inicial == ""?@$GLOBALS["HTTP_POST_VARS"]["v49_inicial"]:$this->v49_inicial);
       $this->v49_certidao = ($this->v49_certidao == ""?@$GLOBALS["HTTP_POST_VARS"]["v49_certidao"]:$this->v49_certidao);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     $sql = "insert into inicialcert_anulada(
                                       v49_inicial 
                                      ,v49_certidao 
                       )
                values (
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Certidões de Iniciais Anuladas nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Certidões de Iniciais Anuladas nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from inicialcert_anulada
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Certidões de Iniciais Anuladas nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Certidões de Iniciais Anuladas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="inicialcert_anulada.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from inicialcert_anulada ";
     $sql .= "      inner join inicial  on  inicial.v50_inicial = inicialcert_anulada.v49_inicial";
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where inicialcert_anulada.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
