<?
//MODULO: sicom
//CLASSE DA ENTIDADE bodcasp202025
class cl_bodcasp202025 {
   ...
   function cl_bodcasp202025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bodcasp202025");
   ...
   function incluir ($si202_sequencial){
     ...
     if($si202_sequencial == "" || $si202_sequencial == null ){
       $result = db_query("select nextval('bodcasp202025_si202_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: bodcasp202025_si202_sequencial_seq do campo: si202_sequencial";
       ...
       $result = db_query("select last_value from bodcasp202025_si202_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si202_sequencial)){
         $this->erro_sql = " Campo si202_sequencial maior que �ltimo n�mero da sequencia.";
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bodcasp202025 ($this->si202_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bodcasp202025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bodcasp202025 ($this->si202_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si202_sequencial=null) {
     ...
     if(trim($this->si202_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si202_sequencial"])){
       ...
       if(trim($this->si202_sequencial) == null ){
         $this->erro_sql = " Campo si202_sequencial n�o informado.";
     ...
     if(trim($this->si202_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si202_tiporegistro"])){
       ...
       if(trim($this->si202_tiporegistro) == null ){
         $this->erro_sql = " Campo si202_tiporegistro n�o informado.";
     ...
     if(trim($this->si202_faserecorcamentaria)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si202_faserecorcamentaria"])){
       ...
       if(trim($this->si202_faserecorcamentaria) == null ){
         $this->erro_sql = " Campo si202_faserecorcamentaria n�o informado.";
     ...
     if(trim($this->si202_vlsaldoexeantsupfin)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si202_vlsaldoexeantsupfin"])){
       ...
       if(trim($this->si202_vlsaldoexeantsupfin) == null ){
         $this->erro_sql = " Campo si202_vlsaldoexeantsupfin n�o informado.";
     ...
     if(trim($this->si202_vltotalsaldoexeant)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si202_vltotalsaldoexeant"])){
       ...
       if(trim($this->si202_vltotalsaldoexeant) == null ){
         $this->erro_sql = " Campo si202_vltotalsaldoexeant n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp202025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si202_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp202025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si202_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si202_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp202025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si202_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bodcasp202025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si202_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bodcasp202025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si202_sequencial!=null ){
         $sql2 .= " where bodcasp202025.si202_sequencial = $si202_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
