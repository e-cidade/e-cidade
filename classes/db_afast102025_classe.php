<?php
//MODULO: sicom
//CLASSE DA ENTIDADE afast102025
class cl_afast102025 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("afast102025");
  ...
  function incluir ($si199_sequencial) {
     ...
     if ($this->si199_tiporegistro == null ) {
       $this->erro_sql = " Campo si199_tiporegistro n�o informado.";
     ...
     if ($this->si199_codvinculopessoa == null ) {
       $this->erro_sql = " Campo si199_codvinculopessoa n�o informado.";
     ...
     if ($this->si199_codafastamento == null ) {
       $this->erro_sql = " Campo si199_codafastamento n�o informado.";
     ...
     if ($this->si199_dtinicioafastamento == null ) {
       $this->erro_sql = " Campo si199_dtinicioafastamento n�o informado.";
     ...
     if ($this->si199_dtretornoafastamento == null ) {
       $this->erro_sql = " Campo si199_dtretornoafastamento n�o informado.";
     ...
     if ($this->si199_tipoafastamento == null ) {
       $this->erro_sql = " Campo si199_tipoafastamento n�o informado.";
     ...
     if ($this->si199_mes == null ) {
       $this->erro_sql = " Campo si199_mes n�o informado.";
     ...
     if ($this->si199_inst == null ) {
       $this->erro_sql = " Campo si199_inst n�o informado.";
      ...
      if($si199_sequencial == "" || $si199_sequencial == null ){
          $result = db_query("select nextval('afast102025_si199_sequencial_seq')");
          if($result==false){
              $this->erro_banco = str_replace("\n","",@pg_last_error());
              $this->erro_sql   = "Verifique o cadastro da sequencia: afast102025_si199_sequencial_seq do campo: si199_sequencial";
              $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
              $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
              $this->erro_status = "0";
              return false;
          ...
          $result = db_query("select last_value from afast102025_si199_sequencial_seq");
          if(($result != false) && (pg_result($result,0,0) < $si199_sequencial)){
              $this->erro_sql = " Campo si199_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "afast102025 ($this->si199_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "afast102025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "afast102025 ($this->si199_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($si199_sequencial=null) {
     ...
     if (trim($this->si199_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si199_sequencial"])) {
       ...
       if (trim($this->si199_sequencial) == null ) {
         $this->erro_sql = " Campo si199_sequencial n�o informado.";
     ...
     if (trim($this->si199_dscoutrosafastamentos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si199_dscoutrosafastamentos"])) {
       ...
       if (trim($this->si199_dscoutrosafastamentos) == null ) {
         $this->erro_sql = " Campo si199_dscoutrosafastamentos n�o informado.";
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "afast102025 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si199_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "afast102025 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si199_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function excluir ($si199_sequencial=null,$dbwhere=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "afast102025 nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "afast102025 nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si199_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:afast102025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si199_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from afast102025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si199_sequencial!=null ) {
         $sql2 .= " where afast102025.si199_sequencial = $si199_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
