...
class cl_causaafastamento { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->rh115_sequencial = ($this->rh115_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh115_sequencial"]:$this->rh115_sequencial);
       $this->rh115_sigla = ($this->rh115_sigla == ""?@$GLOBALS["HTTP_POST_VARS"]["rh115_sigla"]:$this->rh115_sigla);
       $this->rh115_descricao = ($this->rh115_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["rh115_descricao"]:$this->rh115_descricao);
     }else{
       $this->rh115_sequencial = ($this->rh115_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["rh115_sequencial"]:$this->rh115_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($rh115_sequencial){ 
      $this->atualizacampos();
     if($this->rh115_sigla == null ){ 
     ...
     if($rh115_sequencial == "" || $rh115_sequencial == null ){
       $result = db_query("select nextval('causaafastamento_rh115_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: causaafastamento_rh115_sequencial_seq do campo: rh115_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $rh115_sequencial)){
         ...
         $this->rh115_sequencial = $rh115_sequencial; 
       }
     }
     if(($this->rh115_sequencial == null) || ($this->rh115_sequencial == "") ){ 
       $this->erro_sql = " Campo rh115_sequencial nao declarado.";
     ...
     $sql = "insert into causaafastamento(
                                       rh115_sequencial 
                                      ,rh115_sigla 
                                      ,rh115_descricao 
                       )
                values (
                                $this->rh115_sequencial 
                               ,'$this->rh115_sigla' 
                               ,'$this->rh115_descricao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->rh115_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($rh115_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($rh115_sequencial!=null){
       $sql .= " rh115_sequencial = $this->rh115_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->rh115_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Causas de afastamento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh115_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Causas de afastamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->rh115_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($rh115_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($rh115_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($rh115_sequencial != ""){
          ...
          $sql2 .= " rh115_sequencial = $rh115_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Causas de afastamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$rh115_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Causas de afastamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$rh115_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $rh115_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from causaafastamento ";
     $sql2 = "";
     if($dbwhere==""){
       if($rh115_sequencial!=null ){
         $sql2 .= " where causaafastamento.rh115_sequencial = $rh115_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
