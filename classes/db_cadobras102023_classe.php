<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras102023
class cl_cadobras102023 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("cadobras102023");
  ...
  function incluir () {
    ...
    if ($this->si198_sequencial == null ) {
      $result = db_query("select nextval('cadobras102023_si198_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras102023_si198_sequencial_seq do campo: si198_sequencial";
    ...
    $sql = "insert into cadobras102023(
                                       si198_sequencial
                                      ,si198_tiporegistro
                                      ,si198_codorgaoresp
                                      ,si198_codobra
  ...
  function excluir ( $si198_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras102023
                    where ";
    $sql2 = "";
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras102023";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si198_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras102023 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si198_sequencial != "" && $si198_sequencial != null) {
        $sql2 = " where cadobras102023.si198_sequencial = '$si198_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
