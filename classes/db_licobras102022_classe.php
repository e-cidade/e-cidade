<?php
//MODULO: sicom
//CLASSE DA ENTIDADE licobras102022
class cl_licobras102022 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("licobras102022");
  ...
  function incluir () {
    ...
    if ($this->si195_sequencial == null ) {
      $result = db_query("select nextval('licobras102022_si195_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: licobras102022_si195_sequencial_seq do campo: si195_sequencial";
    ...
    $sql = "insert into licobras102022(
                                       si195_sequencial
                                      ,si195_tiporegistro
                                      ,si195_codorgaoresp
  ...
  function excluir ( $si195_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from licobras102022
                    where ";
    $sql2 = "";
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:licobras102022";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si195_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from licobras102022 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si195_sequencial != "" && $si195_sequencial != null) {
        $sql2 = " where licobras102022.si195_sequencial = '$si195_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
