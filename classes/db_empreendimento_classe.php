...
class cl_empreendimento {
  ...
  public function sql_query_condicionante ($iCodigoEmpreendimento, $iCodigoTipoLicenca) {
    ...
    $sSql  = " select distinct * from condicionante where am10_tipolicenca = {$iCodigoTipoLicenca}         ";
    $sSql .= " union all                                                                                   ";
    $sSql .= " select distinct condicionante.*                                                             ";
    $sSql .= "   from empreendimento                                                                       ";
    $sSql .= "        inner join empreendimentoatividadeimpacto on am05_sequencial = am06_empreendimento   ";
    $sSql .= "        inner join atividadeimpacto on am06_atividadeimpacto         = am03_sequencial       ";
    $sSql .= "        inner join condicionanteatividadeimpacto on am03_sequencial  = am11_atividadeimpacto ";
    $sSql .= "        inner join condicionante on am10_sequencial                  = am11_condicionante    ";
