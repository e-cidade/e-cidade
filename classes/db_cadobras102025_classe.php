<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras102025
class cl_cadobras102025 {
  ...
  public $campos = "
                 ...
                 si198_mes = int4 = Mes
                 si198_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("cadobras102025");
  ...
  function incluir () {
    ...
    if ($this->si198_sequencial == null ) {
      $result = db_query("select nextval('cadobras102025_si198_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras102025_si198_sequencial_seq do campo: si198_sequencial";
    ...
    if ($this->si198_tiporesponsavel == null ) {
      $this->erro_sql = " Campo Tipo responsavel n�o informado.";
    ...
    if ($this->si198_nrodocumento == null ) {
      $this->erro_sql = " Campo Numero Documento n�o informado.";
    ...
    if ($this->si198_tiporegistroconselho == null ) {
      $this->erro_sql = " Campo tipoRegistroConselho n�o informado.";
    ...
    if ($this->si198_nroregistroconseprof == null ) {
      $this->erro_sql = " Campo nroregistroconseprof n�o informado.";
    ...
    if ($this->si198_dtinicioatividadeseng == null ) {
      $this->erro_sql = " Campo dtinicioatividadeseng n�o informado.";
    ...
    if ($this->si198_tipovinculo == null ) {
      $this->erro_sql = " Campo Tipovinculo n�o informado.";
    ...
    $sql = "insert into cadobras102025(
                                       si198_sequencial
                                      ,si198_tiporegistro
                                      ,si198_codorgaoresp
                                      ,si198_codobra
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "detalhamento dos responsaveis () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "detalhamento dos responsaveis j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "detalhamento dos responsaveis () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ( $si198_sequencial=null ) {
    ...
    if (trim($this->si198_numrt)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si198_numrt"])) {
      ...
      if (trim($this->si198_numrt) == null ) {
        $this->erro_sql = " Campo numRT n�o informado.";
  ...
  function excluir ( $si198_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras102025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "detalhamento dos responsaveis nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "detalhamento dos responsaveis nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras102025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si198_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras102025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si198_sequencial != "" && $si198_sequencial != null) {
        $sql2 = " where cadobras102025.si198_sequencial = '$si198_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
