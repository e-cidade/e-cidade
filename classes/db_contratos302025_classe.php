<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos302025
class cl_contratos302025
{
  ...
  var $si89_exerciciocontrato = null;
  // cria propriedade com as variaveis do arquivo
  var $campos = "
                 si89_sequencial = int8 = sequencial
                 si89_tiporegistro = int8 = Tipo do  registro
                 si89_codorgao = varchar(2) = C�digo do �rg�o
                 si89_codunidadesub = varchar(8) = C�digo da unidade
                 si89_nrocontrato = int8 = N�mero do  Contrato Original
                 si89_dtassinaturacontoriginal = date = Data da assinatura  do Contrato
                 si89_tipoapostila = varchar(2) = Tipo de Apostila
                 si89_nroseqapostila = int8 = N�mero sequencial  da apostila
                 si89_dataapostila = date = Data da apostila
                 si89_tipoalteracaoapostila = int8 = Tipo de altera��o
                 si89_dscalteracao = varchar(250) = Descri��o da  altera��o
                 si89_valorapostila = float8 = Valor da Aposlila
                 si89_mes = int8 = M�s
                 si89_instit = int8 = Institui��o
                 si89_percentualreajuste = float8 = Percentual de Reajuste
                 si89_indiceunicoreajuste = int8 = Indice do Reajuste
                 si89_dscreajuste = varchar(300) = Descri��o do Reajuste
                 si89_codunidadesub = varchar(8) = Codigo Unidade Atual;
                 si89_criterioreajuste = int = Criterio Reajuste;
                 si89_exerciciocontrato = int = Exercicio Contrato;
                 ";
  //funcao construtor da classe
  function cl_contratos302025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("contratos302025");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si89_exerciciocontrato = ($this->si89_exerciciocontrato == "" ? @$GLOBALS["HTTP_POST_VARS"]["si89_exerciciocontrato"] : $this->si89_exerciciocontrato);
    } else {
      $this->si89_sequencial = ($this->si89_sequencial == "" ? @$GLOBALS["HTTP_POST_VARS"]["si89_sequencial"] : $this->si89_sequencial);
    }
  }
  ...
  function incluir($si89_sequencial)
  {
    ...
    if ($si89_sequencial == "" || $si89_sequencial == null) {
      $result = db_query("select nextval('contratos302025_si89_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: contratos302025_si89_sequencial_seq do campo: si89_sequencial";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from contratos302025_si89_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si89_sequencial)) {
        $this->erro_sql = " Campo si89_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into contratos302025(
                                       si89_sequencial
                                      ,si89_tiporegistro
                                      ,si89_codorgao
                                      ,si89_codunidadesub
                ...
                values (
                               ...
                               ,". ($this->si89_exerciciocontrato == "null" || $this->si89_exerciciocontrato == "" ? "null" : $this->si89_exerciciocontrato ). "
                      )";
    $result = db_query($sql);
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "contratos302025 ($this->si89_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "contratos302025 j� Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql   = "contratos302025 ($this->si89_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update contratos302025 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql   = "contratos302025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si89_sequencial;
      $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos302025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si89_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si89_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from contratos302025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si89_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql   = "contratos302025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si89_sequencial;
        $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:contratos302025";
      $this->erro_msg   = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si89_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from contratos302025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si89_sequencial != null) {
        $sql2 .= " where si89_sequencial = $si89_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
