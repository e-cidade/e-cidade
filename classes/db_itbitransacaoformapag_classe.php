...
class cl_itbitransacaoformapag { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->it25_sequencial = ($this->it25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["it25_sequencial"]:$this->it25_sequencial);
       $this->it25_itbiformapagamento = ($this->it25_itbiformapagamento == ""?@$GLOBALS["HTTP_POST_VARS"]["it25_itbiformapagamento"]:$this->it25_itbiformapagamento);
       $this->it25_itbitransacao = ($this->it25_itbitransacao == ""?@$GLOBALS["HTTP_POST_VARS"]["it25_itbitransacao"]:$this->it25_itbitransacao);
       $this->it25_ativo = ($this->it25_ativo == "f"?@$GLOBALS["HTTP_POST_VARS"]["it25_ativo"]:$this->it25_ativo);
     }else{
       $this->it25_sequencial = ($this->it25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["it25_sequencial"]:$this->it25_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($it25_sequencial){ 
      $this->atualizacampos();
     if($this->it25_itbiformapagamento == null ){ 
     ...
     if($this->it25_itbitransacao == null ){ 
     ...
     if($it25_sequencial == "" || $it25_sequencial == null ){
       $result = db_query("select nextval('itbitransacaoformapag_it25_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: itbitransacaoformapag_it25_sequencial_seq do campo: it25_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $it25_sequencial)){
         ...
         $this->it25_sequencial = $it25_sequencial; 
       }
     }
     if(($this->it25_sequencial == null) || ($this->it25_sequencial == "") ){ 
       $this->erro_sql = " Campo it25_sequencial nao declarado.";
     ...
     $sql = "insert into itbitransacaoformapag(
                                       it25_sequencial 
                ...
                values (
                                $this->it25_sequencial 
                               ,$this->it25_itbiformapagamento 
                               ,$this->it25_itbitransacao 
                               ,'$this->it25_ativo' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->it25_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($it25_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($it25_sequencial!=null){
       $sql .= " it25_sequencial = $this->it25_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->it25_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "itbitransacaoformapag nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->it25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "itbitransacaoformapag nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->it25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($it25_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($it25_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($it25_sequencial != ""){
          ...
          $sql2 .= " it25_sequencial = $it25_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "itbitransacaoformapag nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$it25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "itbitransacaoformapag nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$it25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $it25_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from itbitransacaoformapag ";
     ...
     if($dbwhere==""){
       if($it25_sequencial!=null ){
         $sql2 .= " where itbitransacaoformapag.it25_sequencial = $it25_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
