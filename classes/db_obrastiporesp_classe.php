...
class cl_obrastiporesp { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ob02_cod = ($this->ob02_cod == ""?@$GLOBALS["HTTP_POST_VARS"]["ob02_cod"]:$this->ob02_cod);
       $this->ob02_descr = ($this->ob02_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["ob02_descr"]:$this->ob02_descr);
     }else{
       $this->ob02_cod = ($this->ob02_cod == ""?@$GLOBALS["HTTP_POST_VARS"]["ob02_cod"]:$this->ob02_cod);
     }
   }
   // funcao para inclusao
   function incluir ($ob02_cod){ 
      $this->atualizacampos();
     if($this->ob02_descr == null ){ 
     ...
     if($ob02_cod == "" || $ob02_cod == null ){
       $result = db_query("select nextval('obrastiporesp_ob02_cod_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: obrastiporesp_ob02_cod_seq do campo: ob02_cod"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ob02_cod)){
         ...
         $this->ob02_cod = $ob02_cod; 
       }
     }
     if(($this->ob02_cod == null) || ($this->ob02_cod == "") ){ 
       $this->erro_sql = " Campo ob02_cod nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ob02_cod;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ob02_cod=null) { 
      $this->atualizacampos();
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tipo de responsável da obra nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ob02_cod;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tipo de responsável da obra nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ob02_cod;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ob02_cod=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ob02_cod));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tipo de responsável da obra nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ob02_cod;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tipo de responsável da obra nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ob02_cod;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ob02_cod=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from obrastiporesp ";
     $sql2 = "";
     if($dbwhere==""){
       if($ob02_cod!=null ){
         $sql2 .= " where obrastiporesp.ob02_cod = $ob02_cod "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
