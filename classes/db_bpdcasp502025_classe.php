<?
//MODULO: sicom
//CLASSE DA ENTIDADE bpdcasp502025
class cl_bpdcasp502025 {
   ...
   function cl_bpdcasp502025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bpdcasp502025");
   ...
   function incluir ($si212_sequencial){
     ...
     if($this->si212_tiporegistro == null ){
       $this->erro_sql = " Campo si212_tiporegistro n�o informado.";
     ...
     $sql = "insert into bpdcasp502025(
                ...
                values (
                                (select nextval('bpdcasp502025_si212_sequencial_seq'))
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bpdcasp502025 ($this->si212_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bpdcasp502025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bpdcasp502025 ($this->si212_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si212_sequencial=null) {
     ...
     if(trim($this->si212_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si212_sequencial"])){
       ...
       if(trim($this->si212_sequencial) == null ){
         $this->erro_sql = " Campo si212_sequencial n�o informado.";
     ...
     if(trim($this->si212_vlsaldopatrimonial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si212_vlsaldopatrimonial"])){
       ...
       if(trim($this->si212_vlsaldopatrimonial) == null ){
         $this->erro_sql = " Campo si212_vlsaldopatrimonial n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp502025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si212_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp502025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si212_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si212_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bpdcasp502025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bpdcasp502025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si212_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bpdcasp502025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si212_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bpdcasp502025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si212_sequencial!=null ){
         $sql2 .= " where bpdcasp502025.si212_sequencial = $si212_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
