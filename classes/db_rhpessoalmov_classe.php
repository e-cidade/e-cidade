...
class cl_rhpessoalmov
{
    ...
    function incluir($rh02_seqpes, $rh02_instit, $bValida = true)
    {
        ...
        if ($rh02_seqpes == "" || $rh02_seqpes == null) {
            ...
            if ($result == false) {
                ...
                $this->erro_sql   = "Verifique o cadastro da sequência: rhpessoalmov_rh02_seqpes_seq do campo: rh02_seqpes";
                $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "0";
                return false;
            ...
            if (($result != false) && (pg_result($result, 0, 0) < $rh02_seqpes)) {
                $this->erro_sql = " Campo rh02_seqpes maior que último número da sequência.";
     ...
     * @param boolean $lIsPlanilha13 - Indicador se e planilha de salário ou de salario 13
    ...
    function sql_query_rescisao_afastamento($iAno, $iMes, $sWhere = "")
    {
        ...
        $sSql .= "    and case                                                                                                                                        \n";
        $sSql .= "          when gerfres.r20_regist is null                                       /* Caso não tenha calculo                              */           \n";
        $sSql .= "          then (afasta.r45_regist is not null and rhcadregime.rh52_regime <> 2) /* Valida se tem afastamento e se o servidor não e CLT */           \n";
    ...
    /**
     * Retorna todas as matriculas com duplo vinculo ativas na competencia informada como parâmetro
