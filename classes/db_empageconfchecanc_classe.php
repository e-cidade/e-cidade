...
class cl_empageconfchecanc { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->e93_codcheque = ($this->e93_codcheque == ""?@$GLOBALS["HTTP_POST_VARS"]["e93_codcheque"]:$this->e93_codcheque);
       $this->e93_codmov = ($this->e93_codmov == ""?@$GLOBALS["HTTP_POST_VARS"]["e93_codmov"]:$this->e93_codmov);
       $this->e93_cheque = ($this->e93_cheque == ""?@$GLOBALS["HTTP_POST_VARS"]["e93_cheque"]:$this->e93_cheque);
       $this->e93_valor = ($this->e93_valor == ""?@$GLOBALS["HTTP_POST_VARS"]["e93_valor"]:$this->e93_valor);
     }else{
     }
   }
   ...
   function incluir (){ 
     ...
     $sql = "insert into empageconfchecanc(
                                       e93_codcheque 
                                      ,e93_codmov 
                                      ,e93_cheque 
                                      ,e93_valor 
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cheque cancelados nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cheque cancelados nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     $sql = " delete from empageconfchecanc
                    where ";
     $sql2 = "";
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cheque cancelados nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cheque cancelados nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="empageconfchecanc.oid,*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if( $oid != "" && $oid != null){
          $sql2 = " where empageconfchecanc.oid = '$oid'";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
