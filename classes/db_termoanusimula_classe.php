...
class cl_termoanusimula { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->v20_sequencial = ($this->v20_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["v20_sequencial"]:$this->v20_sequencial);
       $this->v20_termosimula = ($this->v20_termosimula == ""?@$GLOBALS["HTTP_POST_VARS"]["v20_termosimula"]:$this->v20_termosimula);
       $this->v20_termoanu = ($this->v20_termoanu == ""?@$GLOBALS["HTTP_POST_VARS"]["v20_termoanu"]:$this->v20_termoanu);
     }else{
       $this->v20_sequencial = ($this->v20_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["v20_sequencial"]:$this->v20_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($v20_sequencial){ 
      $this->atualizacampos();
     if($this->v20_termosimula == null ){ 
     ...
     if($v20_sequencial == "" || $v20_sequencial == null ){
       $result = db_query("select nextval('termoanusimula_v20_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: termoanusimula_v20_sequencial_seq do campo: v20_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $v20_sequencial)){
         ...
         $this->v20_sequencial = $v20_sequencial; 
       }
     }
     if(($this->v20_sequencial == null) || ($this->v20_sequencial == "") ){ 
       $this->erro_sql = " Campo v20_sequencial nao declarado.";
     ...
     $sql = "insert into termoanusimula(
                                       v20_sequencial 
                                      ,v20_termosimula 
                                      ,v20_termoanu 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->v20_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($v20_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($v20_sequencial!=null){
       $sql .= " v20_sequencial = $this->v20_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->v20_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ligacao da simulacao anulacao nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->v20_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ligacao da simulacao anulacao nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->v20_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($v20_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($v20_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($v20_sequencial != ""){
          ...
          $sql2 .= " v20_sequencial = $v20_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ligacao da simulacao anulacao nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$v20_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ligacao da simulacao anulacao nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$v20_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $v20_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from termoanusimula ";
     $sql .= "      inner join termoanu  on  termoanu.v09_sequencial = termoanusimula.v20_termoanu";
     $sql .= "      inner join termosimula  on  termosimula.v21_sequencial = termoanusimula.v20_termosimula";
     ...
     $sql .= "      inner join termo  on  termo.v07_parcel = termosimula.v21_parcel";
     $sql .= "      inner join db_usuarios  as a on   a.id_usuario = termosimula.v21_usuario";
     $sql2 = "";
     if($dbwhere==""){
       if($v20_sequencial!=null ){
         $sql2 .= " where termoanusimula.v20_sequencial = $v20_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
