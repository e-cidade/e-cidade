<?
//MODULO: sicom
//CLASSE DA ENTIDADE orgao102022
class cl_orgao102022
{
  ...
  function cl_orgao102022()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("orgao102022");
  ...
  function incluir($si14_sequencial)
  {
    ...
    if ($si14_sequencial == "" || $si14_sequencial == null) {
      $result = db_query("select nextval('orgao102022_si14_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: orgao102022_si14_sequencial_seq do campo: si14_sequencial";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from orgao102022_si14_sequencial_seq");
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:orgao102022";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si14_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from orgao102022 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si14_sequencial != null) {
        $sql2 .= " where orgao102022.si14_sequencial = $si14_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
