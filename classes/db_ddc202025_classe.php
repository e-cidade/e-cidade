...
class cl_ddc202025
{
  ...
  var $campos = "
                 ...
                 si154_codorgao = varchar(2) = C�digo do �rg�o
                 si154_nrocontratodivida = varchar(30) = N�mero do  Contrato
                 si154_dtassinatura = date = Data da  assinatura do Contrato
                 si154_tipolancamento = varchar(2) = Tipo de  Lan�amento
                 si154_subtipo = varchar(1) = Subtipo
                 si154_tipodocumentocredor = int8 = Tipo de  Documento do credor
                 si154_nrodocumentocredor = varchar(14) = N�mero do  documento do Credor
                 ...
                 si154_vlcontratacao = float8 = Valor de  Contrata��o
                 si154_vlamortizacao = float8 = Valor de  Amortiza��o
                 si154_vlcancelamento = float8 = Valor de  Cancelamento
                 si154_vlencampacao = float8 = Valor de  Encampa��o
                 si154_vlatualizacao = float8 = Valor da  Atualiza��o
                 si154_vlsaldoatual = float8 = Valor do Saldo  Atual
                 si154_mes = int8 = M�s
                 si154_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ddc202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ddc202025");
  ...
  function incluir($si154_sequencial)
  {
    ...
    if ($si154_sequencial == "" || $si154_sequencial == null) {
      $result = db_query("select nextval('ddc202025_si154_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ddc202025_si154_sequencial_seq do campo: si154_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ddc202025_si154_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si154_sequencial)) {
        $this->erro_sql = " Campo si154_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ddc202025 ($this->si154_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ddc202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ddc202025 ($this->si154_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si154_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ddc202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si154_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ddc202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si154_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si154_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ddc202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ddc202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si154_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ddc202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si154_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si154_sequencial != null) {
        $sql2 .= " where ddc202025.si154_sequencial = $si154_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
