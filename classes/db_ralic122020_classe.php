<?
//MODULO: sicom
//CLASSE DA ENTIDADE ralic122020
class cl_ralic122020
{
  ...
  var $si182_municipio = '';
  var $si182_cep = '';
  var $si182_graulatitude = '';
  var $si182_minutolatitude = '';
  var $si182_segundolatitude = '';
  var $si182_graulongitude = '';
  var $si182_minutolongitude = '';
  var $si182_segundolongitude = '';
  var $si182_mes = 0;
  var $si182_instit = 0;
  var $si182_reg10 = 0;
  var $campos = "
                 ...
                 si182_graulatitude = int4 = Graus da Latitude
                 si182_minutolatitude = int4 = Minuto da Latitude
                 si182_segundolatitude = int4 = Segundo da Latitude
                 si182_graulongitude = int4 = Graus da Longitude
                 si182_minutolongitude = int4 = Minuto da Longitude
                 si182_segundolongitude = int4 = Segundo da Longitude
                 si182_mes = int8 = Mês
  ...
  function cl_ralic122020()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ralic122020");
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->si182_graulatitude = ($this->si182_graulatitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_graulatitude"] : $this->si182_graulatitude);
      $this->si182_minutolatitude = ($this->si182_minutolatitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_minutolatitude"] : $this->si182_minutolatitude);
      $this->si182_segundolatitude = ($this->si182_segundolatitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_segundolatitude"] : $this->si182_segundolatitude);
      $this->si182_graulongitude = ($this->si182_graulongitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_graulongitude"] : $this->si182_graulongitude);
      $this->si182_minutolongitude = ($this->si182_minutolongitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_minutolongitude"] : $this->si182_minutolongitude);
      $this->si182_segundolongitude = ($this->si182_segundolongitude == "" ? @$GLOBALS["HTTP_POST_VARS"]["$this->si182_segundolongitude"] : $this->si182_segundolongitude);
  ...
  function incluir($si182_sequencial)
  {
    ...
    if ($si182_sequencial == "" || $si182_sequencial == null) {
      $result = db_query("select nextval('ralic122020_si182_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ralic122020_si182_sequencial_seq do campo: si182_sequencial";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ralic122020_si182_sequencial_seq");
    ...
    $sql = "insert into ralic122020(
                                      ...
                                      ,si182_cep
                                      ,si182_graulatitude
                                      ,si182_minutolatitude
                                      ,si182_segundolatitude
                                      ,si182_graulongitude
                                      ,si182_minutolongitude
                                      ,si182_segundolongitude
                                      ,si182_reg10
                                      ,si182_mes
                                      ,si182_instit
                       )
                values (
                               ...
                               ,$this->si182_cep
                               ,$this->si182_graulatitude
                               ,$this->si182_minutolatitude
                               ,$this->si182_segundolatitude
                               ,$this->si182_graulongitude
                               ,$this->si182_minutolongitude
                               ,$this->si182_segundolongitude
                               ,$this->si182_reg10
                               ,$this->si182_mes
                               ,$this->si182_instit
                      )";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ralic122020 ($this->si182_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ralic122020 já Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ralic122020 ($this->si182_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si182_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ralic122020 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si182_sequencial;
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ralic122020 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si182_sequencial;
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si182_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ralic122020 nao Excluído. Exclusão Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ralic122020 nao Encontrado. Exclusão não Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si182_sequencial;
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ralic122020";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si182_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from ralic122020 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si182_sequencial != null) {
        $sql2 .= " where ralic122020.si182_sequencial = $si182_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
