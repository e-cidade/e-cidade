<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos102024
class cl_contratos102024
{
  ...
  var $campos = "
                 ...
                 si83_cnpjorgaoentresp = varchar(14) = CNPJ do órgão/entidade
  ...
  function cl_contratos102024()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("contratos102024");
  ...
  function incluir($si83_sequencial)
  {
    ...
    if ($si83_sequencial == "" || $si83_sequencial == null) {
      ...
      if ($result == false) {
        ...
        $this->erro_sql   = "Verifique o cadastro da sequencia: contratos102024_si83_sequencial_seq do campo: si83_sequencial";
        $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from contratos102024_si83_sequencial_seq");
    ...
    $sql = "insert into contratos102024(
                                       si83_sequencial
                                      ,si83_tiporegistro
                                      ,si83_tipocadastro
                                      ,si83_codcontrato
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "contratos102024 ($this->si83_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "contratos102024 já Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql   = "contratos102024 ($this->si83_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update contratos102024 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql   = "contratos102024 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si83_sequencial;
      $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos102024 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si83_sequencial;
        $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si83_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from contratos102024
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si83_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("", "", @pg_last_error());
      $this->erro_sql   = "contratos102024 nao Excluído. Exclusão Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "contratos102024 nao Encontrado. Exclusão não Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si83_sequencial;
        $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql)
  {
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:contratos102024";
      $this->erro_msg   = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
