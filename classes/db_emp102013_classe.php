...
class cl_emp102013
{
  ...
  var $si106_vlbruto = 0;
  var $si106_nomecredor = null;
  var $si106_tipodocumento = null ;
  var $si106_nrodocumento  = null ;
  var $si106_especificacaoempenho = null;
  var $si106_despdeccontrato = 0;
  var $si106_codorgaoresp = null;
  ...
  var $campos = "
                 ...
                 si106_elementodespesa = int8 = Código da   natureza da despesa
                 ...
                 si106_nomecredor = varchar(200) = Nome Credor ,
                 si106_tipodocumento = int8 = Tipo Documento,
                 si106_especificacaoempenho = varchar(200) = Especificação do  empenho
                 si106_despdeccontrato = int8 = Despesa  decorrente de  contrato
                 si106_codorgaoresp = varchar(2) = Código do órgão  responsável
                 ...
                 si106_nomeordenador = varchar(200) = Nome Ordenador ,
                 si106_cpfordenador  =  varchar(11) = Cpf Ordenador  ,
                 si106_mes = int8 = Mês
                 si106_instit = int8 = Instituição
                 ";
  
  //funcao construtor da classe
  function cl_emp102013()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("emp102013");
  ...
  function incluir($si106_sequencial)
  {
    ...
    if ($si106_sequencial == "" || $si106_sequencial == null) {
      $result = db_query("select nextval('emp102013_si106_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("\n", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: emp102013_si106_sequencial_seq do campo: si106_sequencial";
        $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from emp102013_si106_sequencial_seq");
    ...
    $sql = "insert into emp102013(
                ...
                values (
                               ...
                               ,$this->si106_vlbruto
                               ,'$this->si106_nomecredor' 
                               ,$this->si106_tipodocumento
                               ,$this->si106_nrodocumento
                               ,'$this->si106_especificacaoempenho'
                               ,$this->si106_despdeccontrato
                               ,'$this->si106_codorgaoresp'
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "emp102013 ($this->si106_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "emp102013 já Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql = "emp102013 ($this->si106_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
...
//      }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql = "emp102013 nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : " . $this->si106_sequencial;
      $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "emp102013 nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : " . $this->si106_sequencial;
        $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
...
//      }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql = "emp102013 nao Excluído. Exclusão Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "emp102013 nao Encontrado. Exclusão não Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $si106_sequencial;
        $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql)
  {
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:emp102013";
      $this->erro_msg = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
  ...
  function sql_query($si106_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si106_sequencial != null) {
        $sql2 .= " where emp102013.si106_sequencial = $si106_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
