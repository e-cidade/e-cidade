<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp802024
class cl_dfcdcasp802024 {
   ...
   function cl_dfcdcasp802024() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp802024");
   ...
   function incluir ($si226_sequencial){
     ...
     if(empty($si226_sequencial)){
       $result = db_query("select nextval('dfcdcasp802024_si226_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp802024_si226_sequencial_seq do campo: si226_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp802024_si226_sequencial_seq");
     ...
     $sql = "insert into dfcdcasp802024(
                                       si226_anousu
                                      ,si226_periodo
                                      ,si226_instit
                                      ,si226_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp802024 ($this->si226_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp802024 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp802024 ($this->si226_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si226_sequencial=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp802024 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si226_sequencial;
       $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp802024 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si226_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si226_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp802024
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp802024 nao Excluído. Exclusão Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp802024 nao Encontrado. Exclusão não Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si226_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp802024";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si226_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp802024 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si226_sequencial!=null ){
         $sql2 .= " where dfcdcasp802024.si226_sequencial = $si226_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
