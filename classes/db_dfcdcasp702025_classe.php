<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp702025
class cl_dfcdcasp702025 {
   ...
   function cl_dfcdcasp702025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp702025");
   ...
   function incluir ($si225_sequencial){
     ...
     if(empty($si225_sequencial)){
       $result = db_query("select nextval('dfcdcasp702025_si225_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp702025_si225_sequencial_seq do campo: si225_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp702025_si225_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si225_sequencial)){
         $this->erro_sql = " Campo si225_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp702025(
                                       si225_anousu
                                      ,si225_periodo
                                      ,si225_instit
                                      ,si225_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp702025 ($this->si225_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp702025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp702025 ($this->si225_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si225_sequencial=null) {
     ...
     if(trim($this->si225_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_sequencial"])){
       ...
       if(trim($this->si225_sequencial) == null ){
         $this->erro_sql = " Campo si225_sequencial n�o informado.";
     ...
     if(trim($this->si225_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_tiporegistro"])){
       ...
       if(trim($this->si225_tiporegistro) == null ){
         $this->erro_sql = " Campo si225_tiporegistro n�o informado.";
     ...
     if(trim($this->si225_vloperacoescredito)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_vloperacoescredito"])){
       ...
       if(trim($this->si225_vloperacoescredito) == null ){
         $this->erro_sql = " Campo si225_vloperacoescredito n�o informado.";
     ...
     if(trim($this->si225_vlintegralizacaodependentes)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_vlintegralizacaodependentes"])){
       ...
       if(trim($this->si225_vlintegralizacaodependentes) == null ){
         $this->erro_sql = " Campo si225_vlintegralizacaodependentes n�o informado.";
     ...
     if(trim($this->si225_vltranscapitalrecebida)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_vltranscapitalrecebida"])){
       ...
       if(trim($this->si225_vltranscapitalrecebida) == null ){
         $this->erro_sql = " Campo si225_vltranscapitalrecebida n�o informado.";
     ...
     if(trim($this->si225_vloutrosingressosfinanciamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_vloutrosingressosfinanciamento"])){
       ...
       if(trim($this->si225_vloutrosingressosfinanciamento) == null ){
         $this->erro_sql = " Campo si225_vloutrosingressosfinanciamento n�o informado.";
     ...
     if(trim($this->si225_vltotalingressoatividafinanciament)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si225_vltotalingressoatividafinanciament"])){
       ...
       if(trim($this->si225_vltotalingressoatividafinanciament) == null ){
         $this->erro_sql = " Campo si225_vltotalingressoatividafinanciament n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp702025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si225_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp702025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si225_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si225_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp702025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp702025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp702025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si225_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp702025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si225_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp702025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si225_sequencial!=null ){
         $sql2 .= " where dfcdcasp702025.si225_sequencial = $si225_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
