<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge102025
class cl_conge102025 {
  ...
  public $campos = "
                 ...
                 si182_codconvenioconge = int8 = C�digo do conv�nio
                 si182_codorgao = varchar(2) = C�digo do �rg�o
                 si182_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�ament
                 si182_nroconvenioconge = varchar(30) = N�mero do conv�nio ou instrumento cong�n
                 si182_dscinstrumento = varchar(50) = Descri��o do instrumento de repasse
                 si182_dataassinaturaconge = date = Data da assinatura do conv�nio ou instr
                 si182_datapublicconge = date = Data da publica��o do conv�nio ou instr
                 si182_nrocpfrespconge = varchar(11) = N�mero do CPF do respons�vel pela assin
                 si182_dsccargorespconge = varchar(50) = Cargo do respons�vel pela assinatura
                 si182_objetoconvenioconge = varchar(500) = Objeto do conv�nio ou instrumento cong�n
                 si182_datainiciovigenciaconge = varchar(8) = Data inicial da vig�ncia do conv�nio
                 si182_datafinalvigenciaconge = date = Data final da vig�ncia do conv�nio
                 si182_formarepasse = int8 = Forma pela qual os recursos ser�o repass
                 ai182_tipodocumentoincentivador = int8 = Tipo do documento do incentivador
                 si182_nrodocumentoincentivador = varchar(14) = N�mero do  Documento do incentivador
                 si182_quantparcelas = int8 = Quantidade de parcelas
                 si182_vltotalconvenioconge = float8 = Valor total do conv�nio ou instrumento
                 si182_vlcontrapartidaconge = float8 = Valor da contrapartida, se houver
                 si182_tipodocumentobeneficiario = int8 = Tipo do documento do benefici�rio do rec
                 si182_nrodocumentobeneficiario = varchar(14) = N�mero do  Documento do benefici�rio
                 si182_mes = int8 = M�s
                 si182_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conge102025");
  ...
  function incluir ($si182_sequencial) {
     ...
     if ($this->si182_codconvenioconge == null ) {
       $this->erro_sql = " Campo C�digo do conv�nio n�o informado.";
     ...
     if ($this->si182_codunidadesub == null ) {
       $this->erro_sql = " Campo C�digo da unidade ou subunidade or�ament n�o informado.";
     ...
     if ($this->si182_nroconvenioconge == null ) {
       $this->erro_sql = " Campo N�mero do conv�nio ou instrumento cong�n n�o informado.";
     ...
     if ($this->si182_dscinstrumento == null ) {
       $this->erro_sql = " Campo Descri��o do instrumento de repasse n�o informado.";
     ...
     if ($this->si182_dataassinaturaconge == null ) {
       $this->erro_sql = " Campo Data da assinatura do conv�nio ou instr n�o informado.";
     ...
     if ($this->si182_datapublicconge == null ) {
       $this->erro_sql = " Campo Data da publica��o do conv�nio ou instr n�o informado.";
     ...
     if ($this->si182_nrocpfrespconge == null ) {
       $this->erro_sql = " Campo N�mero do CPF do respons�vel pela assin n�o informado.";
     ...
     if ($this->si182_dsccargorespconge == null ) {
       $this->erro_sql = " Campo Cargo do respons�vel pela assinatura n�o informado.";
     ...
     if ($this->si182_objetoconvenioconge == null ) {
       $this->erro_sql = " Campo Objeto do conv�nio ou instrumento cong�n n�o informado.";
     ...
     if ($this->si182_datainiciovigenciaconge == null ) {
       $this->erro_sql = " Campo Data inicial da vig�ncia do conv�nio n�o informado.";
     ...
     if ($this->si182_datafinalvigenciaconge == null ) {
       $this->erro_sql = " Campo Data final da vig�ncia do conv�nio n�o informado.";
     ...
     if ($this->si182_formarepasse == null ) {
       $this->erro_sql = " Campo Forma pela qual os recursos ser�o repass n�o informado.";
     ...
     if ($this->ai182_tipodocumentoincentivador == null ) {
       $this->erro_sql = " Campo Tipo do documento do incentivador n�o informado.";
     ...
     if ($this->si182_nrodocumentoincentivador == null ) {
       $this->erro_sql = " Campo N�mero do  Documento do incentivador n�o informado.";
     ...
     if ($this->si182_quantparcelas == null ) {
       $this->erro_sql = " Campo Quantidade de parcelas n�o informado.";
     ...
     if ($this->si182_vltotalconvenioconge == null ) {
       $this->erro_sql = " Campo Valor total do conv�nio ou instrumento n�o informado.";
     ...
     if ($this->si182_vlcontrapartidaconge == null ) {
       $this->erro_sql = " Campo Valor da contrapartida, se houver n�o informado.";
     ...
     if ($this->si182_tipodocumentobeneficiario == null ) {
       $this->erro_sql = " Campo Tipo do documento do benefici�rio do rec n�o informado.";
     ...
     if ($this->si182_nrodocumentobeneficiario == null ) {
       $this->erro_sql = " Campo N�mero do  Documento do benefici�rio n�o informado.";
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "Cadastro dos Conv�nios e Instrumentos ($this->si182_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Cadastro dos Conv�nios e Instrumentos j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "Cadastro dos Conv�nios e Instrumentos ($this->si182_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
  ...
  function alterar ($si182_sequencial=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro dos Conv�nios e Instrumentos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si182_sequencial;
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro dos Conv�nios e Instrumentos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si182_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro dos Conv�nios e Instrumentos nao Exclu�do. Exclus�o Abortada.\\n";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro dos Conv�nios e Instrumentos nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si182_sequencial;
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge102025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si182_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge102025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si182_sequencial!=null ) {
         $sql2 .= " where conge102025.si182_sequencial = $si182_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
