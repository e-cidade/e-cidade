<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete172025
class cl_balancete172025
{
  ...
  function cl_balancete172025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete172025");
  ...
  function incluir($si184_sequencial)
  {
    ...
    if ($this->si184_tiporegistro == null) {
      $this->erro_sql = " Campo si184_tiporegistro n�o informado.";
    ...
    if ($this->si184_contacontabil == null) {
      $this->erro_sql = " Campo si184_contacontabil n�o informado.";
    ...
    if ($this->si184_atributosf == null) {
      $this->erro_sql = " Campo si184_atributosf n�o informado.";
    ...
    if ($this->si184_saldoinicialctb == null) {
      $this->erro_sql = " Campo si184_saldoinicialctb n�o informado.";
    ...
    if ($this->si184_naturezasaldoinicialctb == null) {
      $this->erro_sql = " Campo si184_naturezasaldoinicialctb n�o informado.";
    ...
    if ($this->si184_totaldebitosctb == null) {
      $this->erro_sql = " Campo si184_totaldebitosctb n�o informado.";
    ...
    if ($this->si184_totalcreditosctb == null) {
      $this->erro_sql = " Campo si184_totalcreditosctb n�o informado.";
    ...
    if ($this->si184_saldofinalctb == null) {
      $this->erro_sql = " Campo si184_saldofinalctb n�o informado.";
    ...
    if ($this->si184_naturezasaldofinalctb == null) {
      $this->erro_sql = " Campo si184_naturezasaldofinalctb n�o informado.";
    ...
    if ($this->si184_mes == null) {
      $this->erro_sql = " Campo si184_mes n�o informado.";
    ...
    if ($this->si184_instit == null) {
      $this->erro_sql = " Campo si184_instit n�o informado.";
    ...
    if ($si184_sequencial == "" || $si184_sequencial == null) {
      $result = db_query("select nextval('balancete172025_si184_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete172025_si184_sequencial_seq do campo: si184_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete172025_si184_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si184_sequencial)) {
        $this->erro_sql = " Campo si184_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete172025(
                                       si184_sequencial
                                      ,si184_tiporegistro
                                      ,si184_contacontabil
                                      ,si184_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete172025 ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete172025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete172025 ($this->si184_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete172025 set ";
    $virgula = "";
    if (trim($this->si184_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si184_sequencial"])) {
      ...
      if (trim($this->si184_sequencial) == null) {
        $this->erro_sql = " Campo si184_sequencial n�o informado.";
    ...
    if (trim($this->si184_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si184_codfundo"])) {
      ...
      if (trim($this->si184_codfundo) == null) {
        $this->erro_sql = " Campo si184_codfundo n�o informado.";
    ...
    if (trim($this->si184_codctb) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si184_codctb"])) {
      ...
      if (trim($this->si184_codctb) == null) {
        $this->erro_sql = " Campo si184_codctb n�o informado.";
    ...
    if (trim($this->si184_codfontrecursos) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si184_codfontrecursos"])) {
      ...
      if (trim($this->si184_codfontrecursos) == null) {
        $this->erro_sql = " Campo si184_codfontrecursos n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete172025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si184_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete172025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si184_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si184_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete172025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si184_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete172025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete172025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si184_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete172025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si184_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete172025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si184_sequencial != null) {
        $sql2 .= " where balancete172025.si184_sequencial = $si184_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
