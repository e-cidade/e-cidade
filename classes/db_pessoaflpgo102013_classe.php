<?
//MODULO: sicom
//CLASSE DA ENTIDADE pessoaflpgo102013
class cl_pessoaflpgo102013 {
  ...
  function cl_pessoaflpgo102013() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("pessoaflpgo102013");
  ...
  function incluir ($si193_sequencial){
    ...
    if($si193_sequencial == "" || $si193_sequencial == null ){
      $result = db_query("select nextval('pessoaflpgo102013_si193_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: pessoaflpgo102013_si193_sequencial_seq do campo: si193_sequencial";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from pessoaflpgo102013_si193_sequencial_seq");
    ...
    $sql = "insert into pessoaflpgo102013(
                                       si193_sequencial 
                                      ,si193_tiporegistro 
                                      ,si193_tipodocumento 
                                      ,si193_nrodocumento 
    ...
    if($result==false){
      ...
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "pessoaflpgo102013 ($this->si193_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "pessoaflpgo102013 já Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      }else{
        $this->erro_sql   = "pessoaflpgo102013 ($this->si193_sequencial) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($si193_sequencial=null) {
    $this->atualizacampos();
    $sql = " update pessoaflpgo102013 set ";
    $virgula = "";
    ...
    if($result==false){
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "pessoaflpgo102013 nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : ".$this->si193_sequencial;
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "pessoaflpgo102013 nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : ".$this->si193_sequencial;
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
  ...
  function excluir ($si193_sequencial=null,$dbwhere=null) {
    ...
    $sql = " delete from pessoaflpgo102013
                    where ";
    $sql2 = "";
    if($dbwhere==null || $dbwhere ==""){
      if($si193_sequencial != ""){
    ...
    if($result==false){
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "pessoaflpgo102013 nao Excluído. Exclusão Abortada.\\n";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "pessoaflpgo102013 nao Encontrado. Exclusão não Efetuada.\\n";
        $this->erro_sql .= "Valores : ".$si193_sequencial;
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql) {
    ...
    if($this->numrows==0){
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:pessoaflpgo102013";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si193_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
    ...
    $sql .= " from pessoaflpgo102013 ";
    $sql2 = "";
    if($dbwhere==""){
      if($si193_sequencial!=null ){
        $sql2 .= " where pessoaflpgo102013.si193_sequencial = $si193_sequencial ";
      }
    }else if($dbwhere != ""){
      $sql2 = " where $dbwhere";
    }
