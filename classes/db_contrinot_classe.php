...
class cl_contrinot { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->d08_sequencial = ($this->d08_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["d08_sequencial"]:$this->d08_sequencial);
       $this->d08_contricalc = ($this->d08_contricalc == ""?@$GLOBALS["HTTP_POST_VARS"]["d08_contricalc"]:$this->d08_contricalc);
       $this->d08_notif = ($this->d08_notif == ""?@$GLOBALS["HTTP_POST_VARS"]["d08_notif"]:$this->d08_notif);
     }else{
       $this->d08_sequencial = ($this->d08_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["d08_sequencial"]:$this->d08_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($d08_sequencial){ 
      $this->atualizacampos();
     if($this->d08_contricalc == null ){ 
     ...
     if($d08_sequencial == "" || $d08_sequencial == null ){
       $result = db_query("select nextval('contrinot_d08_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contrinot_d08_sequencial_seq do campo: d08_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $d08_sequencial)){
         ...
         $this->d08_sequencial = $d08_sequencial; 
       }
     }
     if(($this->d08_sequencial == null) || ($this->d08_sequencial == "") ){ 
       $this->erro_sql = " Campo d08_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->d08_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($d08_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($d08_sequencial!=null){
       $sql .= " d08_sequencial = $this->d08_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->d08_sequencial));
     if($this->numrows>0){
   ...
   function excluir ($d08_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($d08_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($d08_sequencial != ""){
          ...
          $sql2 .= " d08_sequencial = $d08_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$d08_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $d08_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($d08_sequencial!=null ){
         $sql2 .= " where contrinot.d08_sequencial = $d08_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
