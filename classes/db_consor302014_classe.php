<?
//MODULO: sicom
//CLASSE DA ENTIDADE consor302014
class cl_consor302014 { 
   ...
   var $si20_codorgao = null; 
   var $si20_cnpjconsorcio = null; 
   var $si20_tipoencerramento = 0; 
   var $si20_dtencerramento_dia = null; 
   var $si20_dtencerramento_mes = null; 
   var $si20_dtencerramento_ano = null; 
   ...
   var $campos = "
                 ...
                 si20_cnpjconsorcio = varchar(14) = Código do  Consórcio 
                 si20_tipoencerramento = int8 = Tipo de  Encerramento 
                 si20_dtencerramento = date = Data do  encerramento 
                 si20_mes = int8 = Mês 
                 si20_instit = int8 = Instituição 
                 ";
   //funcao construtor da classe 
   function cl_consor302014() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("consor302014"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->si20_dtencerramento == ""){
         $this->si20_dtencerramento_dia = ($this->si20_dtencerramento_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["si20_dtencerramento_dia"]:$this->si20_dtencerramento_dia);
         $this->si20_dtencerramento_mes = ($this->si20_dtencerramento_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["si20_dtencerramento_mes"]:$this->si20_dtencerramento_mes);
         $this->si20_dtencerramento_ano = ($this->si20_dtencerramento_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["si20_dtencerramento_ano"]:$this->si20_dtencerramento_ano);
         if($this->si20_dtencerramento_dia != ""){
            $this->si20_dtencerramento = $this->si20_dtencerramento_ano."-".$this->si20_dtencerramento_mes."-".$this->si20_dtencerramento_dia;
         }
       }
   ...
   function incluir ($si20_sequencial){ 
     ...
     if($this->si20_tipoencerramento == null ){ 
       $this->si20_tipoencerramento = "0";
     }
     if($this->si20_dtencerramento == null ){ 
       $this->si20_dtencerramento = "null";
     }
     ...
     if($si20_sequencial == "" || $si20_sequencial == null ){
       $result = db_query("select nextval('consor302014_si20_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: consor302014_si20_sequencial_seq do campo: si20_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from consor302014_si20_sequencial_seq");
     ...
     $sql = "insert into consor302014(
                ...
                values (
                               ...
                               ,".($this->si20_dtencerramento == "null" || $this->si20_dtencerramento == ""?"null":"'".$this->si20_dtencerramento."'")." 
                               ,$this->si20_mes 
                               ,$this->si20_instit 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "consor302014 ($this->si20_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "consor302014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "consor302014 ($this->si20_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010248,2011307,'','".AddSlashes(pg_result($resaco,0,'si20_codorgao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,2010248,2009649,'','".AddSlashes(pg_result($resaco,0,'si20_cnpjconsorcio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       ...
       $resac = db_query("insert into db_acount values($acount,2010248,2011538,'','".AddSlashes(pg_result($resaco,0,'si20_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($si20_sequencial=null) { 
     ...
     if(trim($this->si20_codorgao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si20_codorgao"])){ 
       $sql  .= $virgula." si20_codorgao = '$this->si20_codorgao' ";
       $virgula = ",";
     }
     if(trim($this->si20_cnpjconsorcio)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si20_cnpjconsorcio"])){ 
       $sql  .= $virgula." si20_cnpjconsorcio = '$this->si20_cnpjconsorcio' ";
       $virgula = ",";
     }
     ...
     if(trim($this->si20_instit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si20_instit"])){ 
       $sql  .= $virgula." si20_instit = $this->si20_instit ";
       $virgula = ",";
       if(trim($this->si20_instit) == null ){ 
         $this->erro_sql = " Campo Instituição nao Informado.";
         $this->erro_campo = "si20_instit";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si20_codorgao"]) || $this->si20_codorgao != "")
           $resac = db_query("insert into db_acount values($acount,2010248,2011307,'".AddSlashes(pg_result($resaco,$conresaco,'si20_codorgao'))."','$this->si20_codorgao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["si20_cnpjconsorcio"]) || $this->si20_cnpjconsorcio != "")
           $resac = db_query("insert into db_acount values($acount,2010248,2009649,'".AddSlashes(pg_result($resaco,$conresaco,'si20_cnpjconsorcio'))."','$this->si20_cnpjconsorcio',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si20_instit"]) || $this->si20_instit != "")
           $resac = db_query("insert into db_acount values($acount,2010248,2011538,'".AddSlashes(pg_result($resaco,$conresaco,'si20_instit'))."','$this->si20_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "consor302014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si20_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "consor302014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si20_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si20_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010248,2011307,'','".AddSlashes(pg_result($resaco,$iresaco,'si20_codorgao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,2010248,2009649,'','".AddSlashes(pg_result($resaco,$iresaco,'si20_cnpjconsorcio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         $resac = db_query("insert into db_acount values($acount,2010248,2011538,'','".AddSlashes(pg_result($resaco,$iresaco,'si20_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from consor302014
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si20_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "consor302014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "consor302014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si20_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:consor302014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si20_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from consor302014 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si20_sequencial!=null ){
         $sql2 .= " where consor302014.si20_sequencial = $si20_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
