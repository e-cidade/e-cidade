<?
//MODULO: sicom
//CLASSE DA ENTIDADE dclrf302022
class cl_dclrf302022 {
    ...
    function cl_dclrf302022() {
        //classes dos rotulos dos campos
        $this->rotulo = new rotulo("dclrf302022");
    ...
    function incluir ($si192_sequencial){
        ...
        if($si192_sequencial == "" || $si192_sequencial == null ){
            $result = @pg_query("select nextval('dclrf302022_si192_sequencial_seq')");
            if($result==false){
...
//       echo $sql.$sql2;exit;
    ...
    function sql_query ( $si192_sequencial = null, $campos = "*",$ordem=null,$dbwhere=""){
        ...
        $sql .= " from dclrf302022 ";
        $sql .= " 		left join dclrf102020 on dclrf102020.si157_sequencial = dclrf302022.si192_reg10 ";
        $sql2 = "";
        if($dbwhere==""){
            if( $si192_sequencial != null){
                $sql2 = " where dclrf302022.si192_sequencial = $si192_sequencial";
            }
        }else if($dbwhere != ""){
            $sql2 = " where $dbwhere";
        }
