...
class cl_vara { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->v53_codvara = ($this->v53_codvara == ""?@$GLOBALS["HTTP_POST_VARS"]["v53_codvara"]:$this->v53_codvara);
       $this->v53_descr = ($this->v53_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["v53_descr"]:$this->v53_descr);
     }else{
       $this->v53_codvara = ($this->v53_codvara == ""?@$GLOBALS["HTTP_POST_VARS"]["v53_codvara"]:$this->v53_codvara);
     }
   }
   // funcao para inclusao
   function incluir ($v53_codvara){ 
      $this->atualizacampos();
     if($this->v53_descr == null ){ 
     ...
     if($v53_codvara == "" || $v53_codvara == null ){
       $result = db_query("select nextval('vara_v53_codvara_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: vara_v53_codvara_seq do campo: v53_codvara"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $v53_codvara)){
         ...
         $this->v53_codvara = $v53_codvara; 
       }
     }
     if(($this->v53_codvara == null) || ($this->v53_codvara == "") ){ 
       $this->erro_sql = " Campo v53_codvara nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->v53_codvara;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($v53_codvara=null) { 
      $this->atualizacampos();
     $sql = " update vara set ";
     $virgula = "";
     ...
     $sql .= " where ";
     if($v53_codvara!=null){
       $sql .= " v53_codvara = $this->v53_codvara";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->v53_codvara));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "vara nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->v53_codvara;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "vara nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->v53_codvara;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($v53_codvara=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($v53_codvara));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "vara nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$v53_codvara;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "vara nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$v53_codvara;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $v53_codvara=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($v53_codvara!=null ){
         $sql2 .= " where vara.v53_codvara = $v53_codvara "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
