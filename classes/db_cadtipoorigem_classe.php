...
class cl_cadtipoorigem { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->k14_sequencial = ($this->k14_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k14_sequencial"]:$this->k14_sequencial);
       $this->k14_cadtipo = ($this->k14_cadtipo == ""?@$GLOBALS["HTTP_POST_VARS"]["k14_cadtipo"]:$this->k14_cadtipo);
       $this->k14_cadorigem = ($this->k14_cadorigem == ""?@$GLOBALS["HTTP_POST_VARS"]["k14_cadorigem"]:$this->k14_cadorigem);
     }else{
       $this->k14_sequencial = ($this->k14_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k14_sequencial"]:$this->k14_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($k14_sequencial){ 
      $this->atualizacampos();
     if($this->k14_cadtipo == null ){ 
     ...
     if($k14_sequencial == "" || $k14_sequencial == null ){
       $result = db_query("select nextval('cadtipoorigem_k14_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: cadtipoorigem_k14_sequencial_seq do campo: k14_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $k14_sequencial)){
         ...
         $this->k14_sequencial = $k14_sequencial; 
       }
     }
     if(($this->k14_sequencial == null) || ($this->k14_sequencial == "") ){ 
       $this->erro_sql = " Campo k14_sequencial nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k14_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($k14_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($k14_sequencial!=null){
       $sql .= " k14_sequencial = $this->k14_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->k14_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de ligação cadtipo/cadorigem nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k14_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de ligação cadtipo/cadorigem nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k14_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k14_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($k14_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($k14_sequencial != ""){
          ...
          $sql2 .= " k14_sequencial = $k14_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cadastro de ligação cadtipo/cadorigem nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$k14_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cadastro de ligação cadtipo/cadorigem nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k14_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $k14_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from cadtipoorigem ";
     $sql .= "      inner join cadtipo  on  cadtipo.k03_tipo = cadtipoorigem.k14_cadtipo";
     $sql .= "      inner join cadorigem  on  cadorigem.k33_sequencial = cadtipoorigem.k14_cadorigem";
     $sql2 = "";
     if($dbwhere==""){
       if($k14_sequencial!=null ){
         $sql2 .= " where cadtipoorigem.k14_sequencial = $k14_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
