...
class cl_aop102025
{
  ...
  var $campos = "
                 ...
                 si137_codreduzido = int8 = C�digo identificador da anula��o
                 si137_codorgao = varchar(2) = C�digo do �rg�o
                 si137_codunidadesub = varchar(8) = C�digo da unidade
                 si137_nroop = int8 = N�mero da  Ordem de  Pagamento
                 si137_dtpagamento = date = Data de  pagamento da  OP
                 si137_nroanulacaoop = int8 = N�mero da  anula��o da  ordem pagamento
                 si137_dtanulacaoop = date = Data da anula��o  da OP
                 si137_justificativaanulacao = varchar(500) = Justificativa para a anula��o
                 si137_vlanulacaoop = float8 = Valor da  Anula��o da OP
                 si137_mes = int8 = M�s
                 si137_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_aop102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("aop102025");
  ...
  function incluir($si137_sequencial)
  {
    ...
    if ($si137_sequencial == "" || $si137_sequencial == null) {
      $result = db_query("select nextval('aop102025_si137_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: aop102025_si137_sequencial_seq do campo: si137_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from aop102025_si137_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si137_sequencial)) {
        $this->erro_sql = " Campo si137_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aop102025 ($this->si137_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aop102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aop102025 ($this->si137_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si137_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aop102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si137_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aop102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si137_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si137_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aop102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aop102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si137_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:aop102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si137_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si137_sequencial != null) {
        $sql2 .= " where aop102025.si137_sequencial = $si137_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
  ...
  function sql_query_file($si137_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    public function sqlPrincipal($iInstit, $sDataInicial, $sDataFinal)
    {
        return "SELECT c71_coddoc,
                   ...
                   e50_obs,
                   CASE
                       WHEN date_part('year',e50_data) < 2025 THEN e71_codnota::varchar
