...
class cl_rhpessoal
{
    ...
    public $rh01_lotac = 0;
    public $rh01_admiss_dia = null;
    public $rh01_admiss_mes = null;
    public $rh01_admiss_ano = null;
    public $rh01_admiss = null;
    public $rh01_nasc_dia = null;
    public $rh01_nasc_mes = null;
    public $rh01_nasc_ano = null;
    public $rh01_nasc = null;
    public $rh01_nacion = 0;
    public $rh01_anoche = 0;
    public $rh01_instru = 0;
    public $rh01_sexo = null;
    public $rh01_estciv = 0;
    public $rh01_tipadm = 0;
    public $rh01_natura = null;
    public $rh01_raca = 0;
    public $rh01_clas1 = null;
    public $rh01_clas2_dia = null;
    public $rh01_clas2_mes = null;
    public $rh01_clas2_ano = null;
    public $rh01_clas2 = null;
    public $rh01_trienio_dia = null;
    public $rh01_trienio_mes = null;
    public $rh01_trienio_ano = null;
    public $rh01_trienio = null;
    public $rh01_progres_dia = null;
    public $rh01_progres_mes = null;
    public $rh01_progres_ano = null;
    public $rh01_progres = null;
    public $rh01_instit = 0;
    public $rh01_vale = null;
    public $rh01_ponto = 0;
    public $rh01_depirf = 0;
    public $rh01_depsf = 0;
    public $rh01_observacao = null;
    public $rh01_rhsindicato = 0;
    public $rh01_reajusteparidade = 0;
    public $rh01_sicom = 1;
    ...
    public function incluir($rh01_regist)
    {
        $this->atualizacampos();
    ...
    public function alterar($rh01_regist = null)
    {
        $this->atualizacampos();
    ...
    public function excluir($rh01_regist = null, $dbwhere = null)
    {
    ...
    // funcao do sql
    public function sql_query($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
    ...
    // funcao do sql
    public function sql_query_file($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_cgm($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_cgm_mov_periodo($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "", $ano, $mes)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_rescisao($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_pesdoc($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_ferias($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_pesquisa($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "", $ano, $mes)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_afasta($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_cgmmov($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select distinct ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_relPREVID($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "", $ano = null, $mes = null, $arr_dados = null)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function retorna_arquivo($sigla)
    {
        $arquivo = "";
        if ($sigla == 'r14') {
            $arquivo = ' gerfsal';
    ...
    public function sql_query_lotafuncres($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_cgmmovpad($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_cargo($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function sql_query_func_rhpessoal($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "", $sQuery = null)
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
     ...
     */
    public function sql_query_baseRelatorios($sTabela, $sSigla, $iAno = null, $iMes = null, $iInstituicao = null, $sCampos = "*", $sWhere = "", $sOrderBy = "", $sCadAtual = null)
    {
    ...
    public function sql_queryInsntituicoesServidoresVinculo($iMesCompetencia = null, $iAnoCompetencia = null)
    {
     ...
     * @return String
     */
    public function sql_queryMargemEConsig($iAnousu, $iMesusu, $iInstit, $sBaseProvendos = 'B105', $sBaseDescontos = 'B106')
    {
     ...
     * @return String
     */
    public function sql_queryServidoresConsignar($iAnousu, $iMesusu, $iInstit, $lEstagiario = null)
    {
        $sSql = "   select  rh02_regist,                                                                           ";
        $sSql .= "          z01_cgccpf,                                                                            ";
        $sSql .= "          z01_nome,                                                                              ";
     ...
     */
    public function sql_queryReajuste($iTipoReajuste, $sCampos = "*", $sOrdem = null, $sWhere = "")
    {
     ...
     * @return String
     */
    public function sql_verificaSituacaoServidor($iMatriculaServidor, $iAnoCompetencia, $iMesCompetencia)
    {
    ...
    // funcao do sql
    public function sql_query_com_temporarios($rh01_regist = null, $campos = "*", $ordem = null, $dbwhere = "")
    {
        $sql = "select ";
        if ($campos != "*") {
            $campos_sql = split("#", $campos);
    ...
    public function verificaMatriculaECargo($iNumCgm)
    {
        ...
        $sSql .= " WHERE rh37_instit = {$instit} AND rh01_regist = (";
        $sSql .= " SELECT max(rh01_regist)";
        $sSql .= " FROM rhpessoal";
        $sSql .= " WHERE rh01_numcgm = {$iNumCgm} AND rh01_instit = {$instit} AND rh01_regist NOT IN (";
        ...
        $sSql .= " WHERE rh05_recis IS NOT NULL AND rh01_numcgm = {$iNumCgm} AND rh01_instit = {$instit}))";
