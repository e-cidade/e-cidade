<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa152025
class cl_dispensa152025
{
  ...
  var $campos = "
                 ...
                 si79_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si79_codunidadesubresp = varchar(8) = C�digo da unidade
                 si79_exercicioprocesso = int8 = Exerc�cio em que   foi instaurado
                 si79_nroprocesso = varchar(12) = N�mero sequencial do processo
                 si79_tipoprocesso = int8 = Tipo de processo
                 si79_nrolote = int8 = N�mero do Lote
                 si79_coditem = int8 = C�digo do Item
                 si79_vlcotprecosunitario = float8 = Valor de refer�ncia
                 si79_quantidade = float8 = Quantidade do item
                 si79_mes = int8 = M�s
                 si79_reg10 = int8 = reg10
                 si79_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_dispensa152025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dispensa152025");
  ...
  function incluir($si79_sequencial)
  {
    ...
    if ($si79_sequencial == "" || $si79_sequencial == null) {
      $result = db_query("select nextval('dispensa152025_si79_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: dispensa152025_si79_sequencial_seq do campo: si79_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from dispensa152025_si79_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si79_sequencial)) {
        $this->erro_sql = " Campo si79_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into dispensa152025(
                                       si79_sequencial
                                      ,si79_tiporegistro
                                      ,si79_codorgaoresp
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "dispensa152025 ($this->si79_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "dispensa152025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "dispensa152025 ($this->si79_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si79_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa152025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si79_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa152025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si79_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si79_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from dispensa152025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si79_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa152025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa152025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si79_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:dispensa152025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si79_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from dispensa152025 ";
    $sql .= "      left  join dispensa102020  on  dispensa102020.si74_sequencial = dispensa152025.si79_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si79_sequencial != null) {
        $sql2 .= " where dispensa152025.si79_sequencial = $si79_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
