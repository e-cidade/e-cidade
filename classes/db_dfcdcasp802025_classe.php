<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp802025
class cl_dfcdcasp802025 {
   ...
   function cl_dfcdcasp802025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp802025");
   ...
   function incluir ($si226_sequencial){
     ...
     if(empty($si226_sequencial)){
       $result = db_query("select nextval('dfcdcasp802025_si226_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp802025_si226_sequencial_seq do campo: si226_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp802025_si226_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si226_sequencial)){
         $this->erro_sql = " Campo si226_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp802025(
                                       si226_anousu
                                      ,si226_periodo
                                      ,si226_instit
                                      ,si226_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp802025 ($this->si226_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp802025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp802025 ($this->si226_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si226_sequencial=null) {
     ...
     if(trim($this->si226_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si226_sequencial"])){
       ...
       if(trim($this->si226_sequencial) == null ){
         $this->erro_sql = " Campo si226_sequencial n�o informado.";
     ...
     if(trim($this->si226_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si226_tiporegistro"])){
       ...
       if(trim($this->si226_tiporegistro) == null ){
         $this->erro_sql = " Campo si226_tiporegistro n�o informado.";
     ...
     if(trim($this->si226_vlamortizacaorefinanciamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si226_vlamortizacaorefinanciamento"])){
       ...
       if(trim($this->si226_vlamortizacaorefinanciamento) == null ){
         $this->erro_sql = " Campo si226_vlamortizacaorefinanciamento n�o informado.";
     ...
     if(trim($this->si226_vloutrosdesembolsosfinanciamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si226_vloutrosdesembolsosfinanciamento"])){
       ...
       if(trim($this->si226_vloutrosdesembolsosfinanciamento) == null ){
         $this->erro_sql = " Campo si226_vloutrosdesembolsosfinanciamento n�o informado.";
     ...
     if(trim($this->si226_vltotaldesembolsoatividafinanciame)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si226_vltotaldesembolsoatividafinanciame"])){
       ...
       if(trim($this->si226_vltotaldesembolsoatividafinanciame) == null ){
         $this->erro_sql = " Campo si226_vltotaldesembolsoatividafinanciame n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp802025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si226_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp802025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si226_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si226_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp802025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp802025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp802025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si226_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp802025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si226_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp802025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si226_sequencial!=null ){
         $sql2 .= " where dfcdcasp802025.si226_sequencial = $si226_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
