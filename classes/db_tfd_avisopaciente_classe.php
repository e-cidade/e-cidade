   ...
   function incluir ($tf21_i_codigo){ 
     ...
     if($tf21_i_codigo == "" || $tf21_i_codigo == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $tf21_i_codigo)){
         $this->erro_sql = " Campo tf21_i_codigo maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->tf21_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
