...
class cl_aidofautenticidade { 
   ...
   var $campos = "
                 ...
                 y01_aidof = int4 = Código da aidof 
   ...
   function incluir ($y01_sequencial){ 
     ...
     if($this->y01_aidof == null ){ 
       $this->erro_sql = " Campo Código da aidof nao Informado.";
     ...
     if($this->y01_codautenticidade == null ){ 
       $this->erro_sql = " Campo Código de autenticidade nao Informado.";
     ...
     if($y01_sequencial == "" || $y01_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $y01_sequencial)){
         $this->erro_sql = " Campo y01_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Autenticidade ($this->y01_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Autenticidade já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Autenticidade ($this->y01_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($y01_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Autenticidade nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Autenticidade nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$y01_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
