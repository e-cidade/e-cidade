<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete192025
class cl_balancete192025
{
  ...
  function cl_balancete192025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete192025");
  ...
  function incluir($si186_sequencial)
  {
    ...
    if ($this->si186_tiporegistro == null) {
      $this->erro_sql = " Campo si186_tiporegistro n�o informado.";
    ...
    if ($this->si186_contacontabil == null) {
      $this->erro_sql = " Campo si186_contacontabil n�o informado.";
    ...
    if ($this->si186_cnpjconsorcio == null) {
      $this->erro_sql = " Campo si186_cnpjconsorcio n�o informado.";
    ...
    if ($this->si186_saldoinicialconsor == null) {
      $this->erro_sql = " Campo si186_saldoinicialconsor n�o informado.";
    ...
    if ($this->si186_naturezasaldoinicialconsor == null) {
      $this->erro_sql = " Campo si186_naturezasaldoinicialconsor n�o informado.";
    ...
    if ($this->si186_totaldebitosconsor == null) {
      $this->erro_sql = " Campo si186_totaldebitosconsor n�o informado.";
    ...
    if ($this->si186_totalcreditosconsor == null) {
      $this->erro_sql = " Campo si186_totalcreditosconsor n�o informado.";
    ...
    if ($this->si186_saldofinalconsor == null) {
      $this->erro_sql = " Campo si186_saldofinalconsor n�o informado.";
    ...
    if ($this->si186_naturezasaldofinalconsor == null) {
      $this->erro_sql = " Campo si186_naturezasaldofinalconsor n�o informado.";
    ...
    if ($this->si186_mes == null) {
      $this->erro_sql = " Campo si186_mes n�o informado.";
    ...
    $sql = "insert into balancete192025(
                                       si186_sequencial
                                      ,si186_tiporegistro
                                      ,si186_contacontabil
                                      ,si186_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete192025 ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete192025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete192025 ($this->si186_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete192025 set ";
    $virgula = "";
    if (trim($this->si186_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si186_sequencial"])) {
      ...
      if (trim($this->si186_sequencial) == null) {
        $this->erro_sql = " Campo si186_sequencial n�o informado.";
    ...
    if (trim($this->si186_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si186_codfundo"])) {
      ...
      if (trim($this->si186_codfundo) == null) {
        $this->erro_sql = " Campo si186_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete192025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si186_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete192025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si186_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si186_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete192025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si186_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete192025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete192025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si186_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete192025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si186_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete192025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si186_sequencial != null) {
        $sql2 .= " where balancete192025.si186_sequencial = $si186_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
