<?php
//MODULO: sicom
//CLASSE DA ENTIDADE partlic102025
class cl_partlic102025 {
  ...
  public $campos = "
                 ...
                 si203_mes = int8 = M�s
                 si203_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("partlic102025");
  ...
  function incluir ($si203_sequencial) {
     ...
     if ($this->si203_sequencial == null ) {
      $result = db_query("select nextval('partlic102025_si203_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: partlic102025_si203_sequencial_seq do campo: si203_sequencial";
      ...
      $result = db_query("select last_value from partlic102025_si203_sequencial_seq");
     ...
     if ($this->si203_codorgao == null ) {
       $this->erro_sql = " Campo si203_codorgao n�o informado.";
     ...
     if ($this->si203_codunidadesub == null ) {
       $this->erro_sql = " Campo si203_codunidadesub n�o informado.";
     ...
     if ($this->si203_exerciciolicitacao == null ) {
       $this->erro_sql = " Campo si203_exerciciolicitacao n�o informado.";
     ...
     if ($this->si203_nroprocessolicitatorio == null ) {
       $this->erro_sql = " Campo si203_nroprocessolicitatorio n�o informado.";
     ...
     if ($this->si203_tipodocumento == null ) {
       $this->erro_sql = " Campo si203_tipodocumento n�o informado.";
     ...
     if ($this->si203_nrodocumento == null ) {
       $this->erro_sql = " Campo si203_nrodocumento n�o informado.";
    ...
    if ($this->si203_instit == null) {
     ...
     if ($result==false) {
       ...
       if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
         $this->erro_sql   = "partlic102025 () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "partlic102025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       } else {
         $this->erro_sql   = "partlic102025 () nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
...
$sql .= "oid = '$oid'";     $result = db_query($sql);
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "partlic102025 nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "partlic102025 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
  ...
  function excluir ( $oid=null ,$dbwhere=null) {
     ...
     if ($result==false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "partlic102025 nao Exclu�do. Exclus�o Abortada.\\n";
       $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "partlic102025 nao Encontrado. Exclus�o n�o Efetuada.\\n";
         $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:partlic102025";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  // funcao do sql
  function sql_query ( $oid = null,$campos="partlic102025.oid,*",$ordem=null,$dbwhere="") {
     $sql = "select ";
     if ($campos != "*" ) {
     ...
     $sql .= " from partlic102025 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ( $oid != "" && $oid != null) {
          $sql2 = " where partlic102025.oid = '$oid'";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
