<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos122025
class cl_contratos122025 {
   ...
   var $campos = "
                 ...
                 si85_codcontrato = int8 = C�digo do contrato
                 si85_codorgao = varchar(2) = C�digo do �rg�o
                 si85_codunidadesub = varchar(8) = C�digo da unidade
                 si85_codfuncao = varchar(2) = C�digo da fun��o
                 si85_codsubfuncao = varchar(3) = C�digo da  Subfun��o
                 si85_codprograma = varchar(4) = C�digo do  programa
                 si85_idacao = varchar(4) = C�digo que identifica a A��o
                 si85_idsubacao = varchar(4) = C�digo que  identifica a SubA��o
                 si85_naturezadespesa = int8 = C�digo da   natureza da   despesa
                 si85_codfontrecursos = int8 = C�digo da fonte de  recursos
                 si85_vlrecurso = float8 = Valor do recurso  or�ament�rio
                 si85_mes = int8 = M�s
                 si85_reg10 = int8 = reg10
                 si85_instit = int8 = Institui��o
                 ";
   //funcao construtor da classe
   function cl_contratos122025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos122025");
   ...
   function incluir ($si85_sequencial){
     ...
     if($si85_sequencial == "" || $si85_sequencial == null ){
       $result = db_query("select nextval('contratos122025_si85_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos122025_si85_sequencial_seq do campo: si85_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos122025_si85_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si85_sequencial)){
         $this->erro_sql = " Campo si85_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into contratos122025(
                                       si85_sequencial
                                      ,si85_tiporegistro
                                      ,si85_codcontrato
                                      ,si85_codorgao
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos122025 ($this->si85_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos122025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos122025 ($this->si85_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si85_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos122025 set ";
     $virgula = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos122025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si85_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos122025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si85_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si85_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos122025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si85_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos122025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos122025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si85_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos122025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si85_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contratos122025 ";
     $sql .= "      left  join contratos102025  on  contratos102025.si83_sequencial = contratos122025.si85_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si85_sequencial!=null ){
         $sql2 .= " where contratos122025.si85_sequencial = $si85_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
