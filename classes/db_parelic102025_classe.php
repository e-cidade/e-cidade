<?
//MODULO: sicom
//CLASSE DA ENTIDADE parelic102025
class cl_parelic102025
{
  ...
  var $campos = "
                 ...
                 si66_codorgao = varchar(2) = C�digo do �rg�o
                 si66_codunidadesub = varchar(8) = C�digo da unidade
                 si66_exerciciolicitacao = int8 = Exerc�cio em que  foi instaurado
                 si66_nroprocessolicitatorio = varchar(12) = N�mero sequencial   do processo
                 si66_dataparecer = date = Data do parecer
                 si66_tipoparecer = int8 = Tipo do parecer
                 si66_nrocpf = varchar(11) = N�mero do CPF
                 si66_mes = int8 = M�s
                 si66_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_parelic102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("parelic102025");
  ...
  function incluir($si66_sequencial)
  {
    ...
    if (strlen($this->si66_nrocpf) > 11) {
      $this->erro_sql = " Campo Cpf do respons�vel n�o pode ser um cnpj. Favor corrigir no cadastro do parecer. Processo Licitat�rio $this->si66_nroprocessolicitatorio / $this->si66_exerciciolicitacao";
...
", "", @pg_last_error());
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $si66_sequencial)) {
        $this->erro_sql = " Campo si66_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "parelic102025 ($this->si66_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "parelic102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "parelic102025 ($this->si66_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si66_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "parelic102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si66_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "parelic102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si66_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si66_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "parelic102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "parelic102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si66_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:parelic102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si66_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from parelic102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si66_sequencial != null) {
        $sql2 .= " where parelic102025.si66_sequencial = $si66_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
