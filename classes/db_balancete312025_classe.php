<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete312025
class cl_balancete312025
{
  ...
  function cl_balancete312025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete312025");
  ...
  function incluir($si243_sequencial)
  {
    ...
    if ($this->si243_saldoinicialcre == null) {
      $this->erro_sql = " Campo si243_saldoinicialcre n�o informado.";
    ...
    if ($this->si243_naturezasaldoinicialcre == null) {
      $this->erro_sql = " Campo si243_naturezasaldoinicialcre n�o informado.";
    ...
    if ($this->si243_totaldebitoscre == null) {
      $this->erro_sql = " Campo si243_totaldebitoscre n�o informado.";
    ...
    if ($this->si243_totalcreditoscre == null) {
      $this->erro_sql = " Campo si243_totalcreditoscre n�o informado.";
    ...
    if ($this->si243_saldofinalcre == null) {
      $this->erro_sql = " Campo si243_saldofinalcre n�o informado.";
    ...
    if ($this->si243_naturezasaldofinalcre == null) {
      $this->erro_sql = " Campo si243_naturezasaldofinalcre n�o informado.";
    ...
    if ($si243_sequencial == "" || $si243_sequencial == null) {
      $result = db_query("select nextval('balancete312025_si243_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete312025_si243_sequencial_seq do campo: si243_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete312025_si243_sequencial_seq");
    ...
    $sql = "insert into balancete312025(
                                       si243_sequencial
                                      ,si243_tiporegistro
                                      ,si243_contacontabil
                                      ,si243_codfundo
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete312025 ($this->si243_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete312025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete312025 ($this->si243_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete312025 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete312025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si243_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete312025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si243_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  {
    $sql = " delete from balancete312025
                    where ";
    $sql2 = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete312025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete312025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si243_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete312025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si243_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete312025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si243_sequencial != null) {
        $sql2 .= " where balancete312025.si243_sequencial = $si243_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
