...
class cl_progconvocacaores { 
   ...
   var $campos = "
                 ed127_i_codigo = int8 = Código 
                 ed127_i_progmatricula = int8 = Matrícula 
                 ed127_i_usuario = int8 = Usuário 
                 ed127_d_data = date = Data 
                 ed127_i_ano = int4 = Ano Referente 
                 ed127_i_nconvoca = int4 = N° de Convocações 
                 ed127_i_nparticipa = int4 = N° Participações 
                 ed127_i_nfaltajust = int4 = N° Faltas Justificadas 
                 ed127_i_nfaltanjust = int4 = N° Faltas não Justificadas 
                 ";
   ...
   function incluir ($ed127_i_codigo){ 
     ...
     if($this->ed127_i_nconvoca == null ){ 
       $this->erro_sql = " Campo N° de Convocações nao Informado.";
     ...
     if($ed127_i_codigo == "" || $ed127_i_codigo == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed127_i_codigo)){
         $this->erro_sql = " Campo ed127_i_codigo maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Registro das Participações nas Convocações ($this->ed127_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "Registro das Participações nas Convocações já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "Registro das Participações nas Convocações ($this->ed127_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($ed127_i_codigo=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Registro das Participações nas Convocações nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed127_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Registro das Participações nas Convocações nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed127_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed127_i_codigo=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Registro das Participações nas Convocações nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Registro das Participações nas Convocações nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed127_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
