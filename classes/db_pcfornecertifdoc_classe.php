...
class cl_pcfornecertifdoc {
  ...
  var $campos = "
                 ...
                 pc75_numdocumento = varchar(20) = N° do Documento 
                 ";
  ...
  function atualizacampos($exclusao=false) {
    if($exclusao==false){
      ...
      $this->pc75_numdocumento = ($this->pc75_numdocumento == ""?@$GLOBALS["HTTP_POST_VARS"]["pc75_numdocumento"]:$this->pc75_numdocumento);
  ...
  function incluir ($pc75_codigo){
    ...
    if($this->pc75_numdocumento == null ){
      $this->pc75_numdocumento = "";
    }
  ...
  function alterar ($pc75_codigo=null) {
    ...
    if(trim($this->pc75_numdocumento)!='' || isset($GLOBALS["HTTP_POST_VARS"]["pc75_numdocumento"])) {
      $sql .= $virgula . " pc75_numdocumento = '$this->pc75_numdocumento' ";
      $virgula = ",";
    }
