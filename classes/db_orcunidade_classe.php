...
class cl_orcunidade { 
   ...
   var $o41_ident = 0; 
   var $o41_instit = 0;
   var $o41_orddespesa = null;
   var $o41_ordliquidacao = null;
   var $o41_ordpagamento = null;
   var $o41_subunidade = 0;  
   ...
   var $campos = "
                 ...
                 o41_orddespesa = int8 = Ordenador Despesa;
                 o41_ordliquidacao = int8 = Ordena Liquidação;
                 o41_ordpagamento = int8 = Ordena Pagamento; 
                 o41_subunidade = int8 = Subunidade; 
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->o41_orddespesa = ($this->o41_orddespesa == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_orddespesa"]:$this->o41_orddespesa);
       $this->o41_ordliquidacao = ($this->o41_ordliquidacao == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_ordliquidacao"]:$this->o41_ordliquidacao);
       $this->o41_ordpagamento = ($this->o41_ordpagamento == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_ordpagamento"]:$this->o41_ordpagamento);
       $this->o41_subunidade = ($this->o41_subunidade == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_subunidade"]:$this->o41_subunidade);
     }else{
       $this->o41_anousu = ($this->o41_anousu == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_anousu"]:$this->o41_anousu);
       $this->o41_orgao = ($this->o41_orgao == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_orgao"]:$this->o41_orgao);
       $this->o41_unidade = ($this->o41_unidade == ""?@$GLOBALS["HTTP_POST_VARS"]["o41_unidade"]:$this->o41_unidade);
   ...
   function incluir ($o41_anousu,$o41_orgao,$o41_unidade){ 
     ...
     $sql = "insert into orcunidade(
                ...
                values (
                               ...
                               ,$this->o41_ident 
                               ,$this->o41_instit
                               ,".($this->o41_orddespesa == '' ? 'null' : $this->o41_orddespesa)."
                               ,".($this->o41_ordliquidacao == '' ? 'null' : $this->o41_ordliquidacao)."
                               ,".($this->o41_ordpagamento == '' ? 'null' : $this->o41_ordpagamento)."
                               ,".($this->o41_subunidade == '' ? '0' : $this->o41_subunidade)." 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
   ...
   function alterar ($o41_anousu=null,$o41_orgao=null,$o41_unidade=null) { 
     ...
     if(trim($this->o41_orddespesa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o41_orddespesa"])){ 
        if(trim($this->o41_orddespesa)=="" && isset($GLOBALS["HTTP_POST_VARS"]["o41_orddespesa"])){ 
           $this->o41_orddespesa = "null" ; 
        } 
       $sql  .= $virgula." o41_orddespesa = $this->o41_orddespesa ";
       $virgula = ",";
     }
     if(trim($this->o41_ordliquidacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o41_ordliquidacao"])){ 
        if(trim($this->o41_ordliquidacao)=="" && isset($GLOBALS["HTTP_POST_VARS"]["o41_ordliquidacao"])){ 
           $this->o41_ordliquidacao = "null" ; 
        } 
       $sql  .= $virgula." o41_ordliquidacao = $this->o41_ordliquidacao ";
       $virgula = ",";
     }
     if(trim($this->o41_ordpagamento)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o41_ordpagamento"])){ 
        if(trim($this->o41_ordpagamento)=="" && isset($GLOBALS["HTTP_POST_VARS"]["o41_ordpagamento"])){ 
           $this->o41_ordpagamento = "null" ; 
        } 
       $sql  .= $virgula." o41_ordpagamento = $this->o41_ordpagamento ";
       $virgula = ",";
     }
     if(trim($this->o41_subunidade)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o41_subunidade"])){
       if(trim($this->o41_subunidade)=="" && isset($GLOBALS["HTTP_POST_VARS"]["o41_subunidade"])){ 
           $this->o41_subunidade = "0" ; 
       } 
       $sql  .= $virgula." o41_subunidade = $this->o41_subunidade ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($o41_anousu!=null){
