...
class cl_procservicos { 
   ...
   function erro($mostra,$retorna) { 
     if(($this->erro_status == "0") || ($mostra == true && $this->erro_status != null )){
        ...
        if($retorna==true){
           echo "<script>location.href='sau1_procservicos001.php?sd19_i_procedimento='+document.form1.sd19_i_procedimento.value;</script>";
        }
     }
   }
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->sd19_i_codigo = ($this->sd19_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd19_i_codigo"]:$this->sd19_i_codigo);
       $this->sd19_i_procedimento = ($this->sd19_i_procedimento == ""?@$GLOBALS["HTTP_POST_VARS"]["sd19_i_procedimento"]:$this->sd19_i_procedimento);
       $this->sd19_i_servico = ($this->sd19_i_servico == ""?@$GLOBALS["HTTP_POST_VARS"]["sd19_i_servico"]:$this->sd19_i_servico);
     }else{
       $this->sd19_i_codigo = ($this->sd19_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd19_i_codigo"]:$this->sd19_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($sd19_i_codigo){ 
      $this->atualizacampos();
     if($this->sd19_i_procedimento == null ){ 
     ...
     if($this->sd19_i_servico == null ){ 
       $this->sd19_i_servico = "0";
     }
     if($sd19_i_codigo == "" || $sd19_i_codigo == null ){
       $result = db_query("select nextval('procservicos_sd19_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: procservicos_sd19_i_codigo_seq do campo: sd19_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $sd19_i_codigo)){
         ...
         $this->sd19_i_codigo = $sd19_i_codigo; 
       }
     }
     if(($this->sd19_i_codigo == null) || ($this->sd19_i_codigo == "") ){ 
       $this->erro_sql = " Campo sd19_i_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->sd19_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($sd19_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($sd19_i_codigo!=null){
       $sql .= " sd19_i_codigo = $this->sd19_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->sd19_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Serviços para o Procedimento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd19_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Serviços para o Procedimento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->sd19_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($sd19_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($sd19_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($sd19_i_codigo != ""){
          ...
          $sql2 .= " sd19_i_codigo = $sd19_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Serviços para o Procedimento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$sd19_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Serviços para o Procedimento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$sd19_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $sd19_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from procservicos ";
     $sql .= "      inner join procedimentos  on  procedimentos.sd09_i_codigo = procservicos.sd19_i_procedimento";
     $sql .= "      inner join servicos  on  servicos.sd12_i_codigo = procservicos.sd19_i_servico";
     $sql .= "      inner join grupoproc  on  grupoproc.sd11_c_codigo = procedimentos.sd09_c_grupoproc";
     $sql2 = "";
     if($dbwhere==""){
       if($sd19_i_codigo!=null ){
         $sql2 .= " where procservicos.sd19_i_codigo = $sd19_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
