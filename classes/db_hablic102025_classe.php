<?
//MODULO: sicom
//CLASSE DA ENTIDADE hablic102025
class cl_hablic102025
{
  ...
  var $campos = "
                 ...
                 si57_codorgao = varchar(2) = C�digo do �rg�o
                 si57_codunidadesub = varchar(8) = C�digo da unidade
                 si57_exerciciolicitacao = int8 = Exerc�cio em que  foi instaurado
                 si57_nroprocessolicitatorio = varchar(12) = N�mero sequencial do processo
                 si57_tipodocumento = int8 = Tipo do  documento
                 si57_nrodocumento = varchar(14) = N�mero do  documento do  participante
                 si57_objetosocial = varchar(2000) = Objeto Social
                 si57_orgaorespregistro = int8 = �rg�o respons�vel
                 si57_dataregistro = date = Data do Registro
                 si57_nroregistro = varchar(20) = N�mero do  Registro
                 si57_dataregistrocvm = date = Data do Registro
                 si57_nroregistrocvm = varchar(20) = N�mero do  Registro
                 si57_nroinscricaoestadual = varchar(30) = N�mero da  inscri��o estadual
                 si57_ufinscricaoestadual = varchar(2) = Sigla da unidade  da Federa��o
                 si57_nrocertidaoregularidadeinss = varchar(30) = N�mero da certid�o
                 si57_dtemissaocertidaoregularidadeinss = date = Data de emiss�o  da certid�o
                 si57_dtvalidadecertidaoregularidadeinss = date = Data de validade  da certid�o
                 si57_nrocertidaoregularidadefgts = varchar(30) = N�mero da certid�o  de regularidade FGTS
                 si57_dtemissaocertidaoregularidadefgts = date = Data de emiss�o  da certid�o r fgts
                 si57_dtvalidadecertidaoregularidadefgts = date = Data de validade  da certid�o FGTS
                 si57_nrocndt = varchar(30) = N�mero da  Certid�o Negativa  de D�bitos
                 si57_dtemissaocndt = date = Data de emiss�o  da certid�o Negativa
                 si57_dtvalidadecndt = date = Data de validade  da C.N.D.T
                 si57_dthabilitacao = date = Data da habilita��o
                 si57_presencalicitantes = int8 = Presen�a Licitantes
                 si57_renunciarecurso = int8 = Informar a  exist�ncia de  ren�ncia
                 si57_mes = int8 = M�s
                 si57_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_hablic102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("hablic102025");
  ...
  function incluir($si57_sequencial)
  {
    ...
    if ($si57_sequencial == "" || $si57_sequencial == null) {
      $result = db_query("select nextval('hablic102025_si57_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: hablic102025_si57_sequencial_seq do campo: si57_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from hablic102025_si57_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si57_sequencial)) {
        $this->erro_sql = " Campo si57_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "hablic102025 ($this->si57_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "hablic102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "hablic102025 ($this->si57_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si57_sequencial = null)
  {
    ...
    if (trim($this->si57_nroprocessolicitatorio) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si57_nroprocessolicitatorio"])) {
      ...
      if (trim($this->si57_nroprocessolicitatorio) == null) {
        $this->erro_sql = " Campo N�mero sequencial por ano n�o Informado.";
    ...
    if (trim($this->si57_tipodocumento) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si57_tipodocumento"])) {
      ...
      if (trim($this->si57_tipodocumento) == null) {
        $this->erro_sql = " Campo Tipo do documento n�o Informado.";
    ...
    if (trim($this->si57_nrodocumento) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si57_nrodocumento"])) {
      ...
      if (trim($this->si57_nrodocumento) == null) {
        $this->erro_sql = " Campo N�mero do documento n�o Informado.";
    ...
    if (trim($this->si57_presencalicitantes) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si57_presencalicitantes"])) {
      if (trim($this->si57_presencalicitantes) == "" && isset($GLOBALS["HTTP_POST_VARS"]["si57_presencalicitantes"])) {
        $this->erro_sql = " Campo Presen�a dos Licitantes n�o Informado.";
        $this->erro_campo = "si57_tiporegistro";
        $this->erro_banco = "";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
    ...
    if (trim($this->si57_renunciarecurso) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si57_renunciarecurso"])) {
      if (trim($this->si57_renunciarecurso) == "" && isset($GLOBALS["HTTP_POST_VARS"]["si57_renunciarecurso"])) {
        $this->erro_sql = " Campo Renuncia recurso n�o Informado.";
        $this->erro_campo = "si57_tiporegistro";
        $this->erro_banco = "";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "hablic102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si57_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "hablic102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si57_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si57_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "hablic102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "hablic102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si57_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:hablic102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si57_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from hablic102025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si57_sequencial != null) {
        $sql2 .= " where hablic102025.si57_sequencial = $si57_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
