...
class cl_pcorcamforne {
   ...
   function incluir ($pc21_orcamforne){
     ...
     if($this->pc21_importado == null ){
       $this->erro_sql = " Campo Importado nao Informado.";
     ...
     if(($this->pc21_orcamforne == null) || ($this->pc21_orcamforne == "") ){
       $this->erro_sql = " Campo pc21_orcamforne nao declarado.";
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Fornecedores do orçamento ($this->pc21_orcamforne) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($pc21_orcamforne=null) {
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_orcamforne"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_codorc"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_numcgm"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_importado"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_prazoent"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc21_validadorc"]))
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Fornecedores do orçamento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->pc21_orcamforne;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Fornecedores do orçamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->pc21_orcamforne;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($pc21_orcamforne=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Fornecedores do orçamento nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Fornecedores do orçamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$pc21_orcamforne;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
  ...
  {
    return "select z01_numcgm,z01_nome,z01_cgccpf,pc31_orcamforne  from pcorcamforne 
