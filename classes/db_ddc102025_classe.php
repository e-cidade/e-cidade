...
class cl_ddc102025
{
  ...
  var $campos = "
                 ...
                 si153_codorgao = varchar(2) = C�digo do �rg�o
                 si153_nrocontratodivida = varchar(30) = N�mero do  Contrato de  D�vida
                 si153_dtassinatura = date = Data da assinatura  do Contrato
                 si153_contratodeclei = int8 = Contrato decorrente de Lei
                 si153_nroleiautorizacao = varchar(6) = N�mero da Lei de  Autoriza��o
                 si153_dtleiautorizacao = date = Data da Lei de  Autoriza��o
                 si153_objetocontratodivida = varchar(1000) = Objeto do contrato
                 si153_especificacaocontratodivida = varchar(500) = Descri��o da  d�vida  consolidada
                 si153_mes = int8 = M�s
                 si153_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ddc102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ddc102025");
  ...
  function incluir($si153_sequencial)
  {
    ...
    if ($si153_sequencial == "" || $si153_sequencial == null) {
      $result = db_query("select nextval('ddc102025_si153_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ddc102025_si153_sequencial_seq do campo: si153_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ddc102025_si153_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si153_sequencial)) {
        $this->erro_sql = " Campo si153_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ddc102025 ($this->si153_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ddc102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ddc102025 ($this->si153_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si153_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ddc102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si153_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ddc102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si153_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si153_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      ...
      $this->erro_sql = "ddc102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ddc102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si153_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function sql_record($sql)
  {
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ddc102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si153_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si153_sequencial != null) {
        $sql2 .= " where ddc102025.si153_sequencial = $si153_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
