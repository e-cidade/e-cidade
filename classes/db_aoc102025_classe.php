...
class cl_aoc102025
{
  ...
  var $campos = "
                 ...
                 si38_codorgao = varchar(2) = Cï¿½digo do ï¿½rgï¿½o
                 si38_nrodecreto = int8 = Nï¿½mero do Decreto
                 si38_datadecreto = date = Data do Decreto
                 si38_mes = int8 = Mï¿½s
                 si38_instit = int8 = Instituiï¿½ï¿½o
  ...
  function incluir($si38_sequencial)
  {
    ...
    if ($this->si38_mes == null) {
      $this->erro_sql = " Campo Mï¿½s nao Informado.";
...
", "", @pg_last_error());
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $si38_sequencial)) {
        $this->erro_sql = " Campo si38_sequencial maior que ï¿½ltimo nï¿½mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aoc102025 ($this->si38_sequencial) nao Incluï¿½do. Inclusao Abortada.";
        $this->erro_msg = "Usuï¿½rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aoc102025 jï¿½ Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aoc102025 ($this->si38_sequencial) nao Incluï¿½do. Inclusao Abortada.";
        $this->erro_msg = "Usuï¿½rio: \n\n " . $this->erro_sql . " \n\n";
...
", "", @pg_last_error());
  ...
  function excluir($si38_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aoc102025 nao Excluï¿½do. Exclusï¿½o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aoc102025 nao Encontrado. Exclusï¿½o nï¿½o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si38_sequencial;
        $this->erro_msg = "Usuï¿½rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
