...
class cl_aguaconsumorec { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->x20_codconsumotipo = ($this->x20_codconsumotipo == ""?@$GLOBALS["HTTP_POST_VARS"]["x20_codconsumotipo"]:$this->x20_codconsumotipo);
       $this->x20_codconsumo = ($this->x20_codconsumo == ""?@$GLOBALS["HTTP_POST_VARS"]["x20_codconsumo"]:$this->x20_codconsumo);
       $this->x20_valor = ($this->x20_valor == ""?@$GLOBALS["HTTP_POST_VARS"]["x20_valor"]:$this->x20_valor);
     }else{
       $this->x20_codconsumotipo = ($this->x20_codconsumotipo == ""?@$GLOBALS["HTTP_POST_VARS"]["x20_codconsumotipo"]:$this->x20_codconsumotipo);
       $this->x20_codconsumo = ($this->x20_codconsumo == ""?@$GLOBALS["HTTP_POST_VARS"]["x20_codconsumo"]:$this->x20_codconsumo);
     }
   ...
   function incluir ($x20_codconsumo,$x20_codconsumotipo){ 
      $this->atualizacampos();
     if($this->x20_valor == null ){ 
       ...
       $this->x20_codconsumo = $x20_codconsumo; 
       $this->x20_codconsumotipo = $x20_codconsumotipo; 
     if(($this->x20_codconsumo == null) || ($this->x20_codconsumo == "") ){ 
       $this->erro_sql = " Campo x20_codconsumo nao declarado.";
     ...
     if(($this->x20_codconsumotipo == null) || ($this->x20_codconsumotipo == "") ){ 
       $this->erro_sql = " Campo x20_codconsumotipo nao declarado.";
       $this->erro_banco = "Chave Primaria zerada.";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     $sql = "insert into aguaconsumorec(
                                       x20_codconsumotipo 
                                      ,x20_codconsumo 
                                      ,x20_valor 
                       )
                values (
                                $this->x20_codconsumotipo 
                               ,$this->x20_codconsumo 
                               ,$this->x20_valor 
                      )";
     $result = db_query($sql); 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->x20_codconsumo."-".$this->x20_codconsumotipo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($x20_codconsumo=null,$x20_codconsumotipo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($x20_codconsumo!=null){
       $sql .= " x20_codconsumo = $this->x20_codconsumo";
     }
     if($x20_codconsumotipo!=null){
       $sql .= " and  x20_codconsumotipo = $this->x20_codconsumotipo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->x20_codconsumo,$this->x20_codconsumotipo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aguaconsumorec nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->x20_codconsumo."-".$this->x20_codconsumotipo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aguaconsumorec nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->x20_codconsumo."-".$this->x20_codconsumotipo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($x20_codconsumo=null,$x20_codconsumotipo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($x20_codconsumo,$x20_codconsumotipo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($x20_codconsumo != ""){
          ...
          $sql2 .= " x20_codconsumo = $x20_codconsumo ";
        }
        if($x20_codconsumotipo != ""){
          if($sql2!=""){
            $sql2 .= " and ";
          }
          $sql2 .= " x20_codconsumotipo = $x20_codconsumotipo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aguaconsumorec nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$x20_codconsumo."-".$x20_codconsumotipo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aguaconsumorec nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$x20_codconsumo."-".$x20_codconsumotipo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $x20_codconsumo=null,$x20_codconsumotipo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from aguaconsumorec ";
     $sql .= "      inner join aguaconsumo  on  aguaconsumo.x19_codconsumo = aguaconsumorec.x20_codconsumo";
     $sql .= "      inner join aguaconsumotipo  on  aguaconsumotipo.x25_codconsumotipo = aguaconsumorec.x20_codconsumotipo";
     $sql .= "      inner join caracter  on  caracter.j31_codigo = aguaconsumo.x19_caract";
     ...
     if($dbwhere==""){
       if($x20_codconsumo!=null ){
         $sql2 .= " where aguaconsumorec.x20_codconsumo = $x20_codconsumo "; 
       } 
       if($x20_codconsumotipo!=null ){
         if($sql2!=""){
            $sql2 .= " and ";
         ...
         $sql2 .= " aguaconsumorec.x20_codconsumotipo = $x20_codconsumotipo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
