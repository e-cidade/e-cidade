...
class cl_conv102025
{
  ...
  var $campos = "
                 ...
                 si92_codconvenio = int8 = C�digo do  Conv�nio
                 si92_codorgao = varchar(2) = C�digo do �rg�o
                 si92_nroconvenio = varchar(30) = N�mero do  Conv�nio
                 si92_dataassinatura = date = Data da assinatura  do Conv�nio
                 si92_objetoconvenio = varchar(500) = Objeto do conv�nio
                 si92_datainiciovigencia = date = Data inicial da  vig�ncia do  conv�nio
                 si92_datafinalvigencia = date = Data final da  vig�ncia do  conv�nio
                 si92_vlconvenio = float8 = Valor do conv�nio
                 si92_vlcontrapartida = float8 = Valor da  contrapartida
                 si92_codfontrecursos = int8 = Tipo de Recurso
                 si92_mes = int8 = M�s
                 si92_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_conv102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conv102025");
  ...
  function incluir($si92_sequencial)
  {
    ...
    if ($this->si92_codfontrecursos == null) {
      $this->erro_sql = " C�digo da fonte de Recurso n�o informado.";
    ...
    if ($si92_sequencial == "" || $si92_sequencial == null) {
      $result = db_query("select nextval('conv102025_si92_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: conv102025_si92_sequencial_seq do campo: si92_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from conv102025_si92_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si92_sequencial)) {
        $this->erro_sql = " Campo si92_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "conv102025 ($this->si92_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "conv102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "conv102025 ($this->si92_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si92_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "conv102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si92_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "conv102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si92_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si92_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "conv102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "conv102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si92_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:conv102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si92_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si92_sequencial != null) {
        $sql2 .= " where conv102025.si92_sequencial = $si92_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
