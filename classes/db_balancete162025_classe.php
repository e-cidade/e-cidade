<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete162025
class cl_balancete162025
{
  ...
  function cl_balancete162025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete162025");
  ...
  function incluir($si183_sequencial)
  {
    ...
    if ($this->si183_tiporegistro == null) {
      $this->erro_sql = " Campo si183_tiporegistro n�o informado.";
    ...
    if ($this->si183_contacontabil == null) {
      $this->erro_sql = " Campo si183_contacontabil n�o informado.";
    ...
    if ($this->si183_atributosf == null) {
      $this->erro_sql = " Campo si183_atributosf n�o informado.";
    ...
    if ($this->si183_saldoinicialfontsf == null) {
      $this->erro_sql = " Campo si183_saldoinicialfontsf n�o informado.";
    ...
    if ($this->si183_naturezasaldoinicialfontsf == null) {
      $this->erro_sql = " Campo si183_naturezasaldoinicialfontsf n�o informado.";
    ...
    if ($this->si183_totaldebitosfontsf == null) {
      $this->erro_sql = " Campo si183_totaldebitosfontsf n�o informado.";
    ...
    if ($this->si183_totalcreditosfontsf == null) {
      $this->erro_sql = " Campo si183_totalcreditosfontsf n�o informado.";
    ...
    if ($this->si183_saldofinalfontsf == null) {
      $this->erro_sql = " Campo si183_saldofinalfontsf n�o informado.";
    ...
    if ($this->si183_naturezasaldofinalfontsf == null) {
      $this->erro_sql = " Campo si183_naturezasaldofinalfontsf n�o informado.";
    ...
    if ($this->si183_mes == null) {
      $this->erro_sql = " Campo si183_mes n�o informado.";
    ...
    if ($this->si183_instit == null) {
      $this->erro_sql = " Campo si183_instit n�o informado.";
    ...
    if ($si183_sequencial == "" || $si183_sequencial == null) {
      $result = db_query("select nextval('balancete162025_si183_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete162025_si183_sequencial_seq do campo: si183_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete162025_si183_sequencial_seq");
    ...
    $sql = "insert into balancete162025(
                                       si183_sequencial
                                      ,si183_tiporegistro
                                      ,si183_contacontabil
                                      ,si183_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete162025 ($this->si183_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete162025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete162025 ($this->si183_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete162025 set ";
    $virgula = "";
    if (trim($this->si183_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si183_sequencial"])) {
      ...
      if (trim($this->si183_sequencial) == null) {
        $this->erro_sql = " Campo si183_sequencial n�o informado.";
    ...
    if (trim($this->si183_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si183_codfundo"])) {
      ...
      if (trim($this->si183_codfundo) == null) {
        $this->erro_sql = " Campo si183_codfundo n�o informado.";
    ...
    if (trim($this->si183_codfontrecursos) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si183_codfontrecursos"])) {
      ...
      if (trim($this->si183_codfontrecursos) == null) {
        $this->erro_sql = " Campo si183_codfontrecursos n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete162025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si183_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete162025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si183_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si183_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete162025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si183_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete162025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete162025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si183_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete162025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si183_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete162025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si183_sequencial != null) {
        $sql2 .= " where balancete162025.si183_sequencial = $si183_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
