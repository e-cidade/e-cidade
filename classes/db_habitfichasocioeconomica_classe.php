...
class cl_habitfichasocioeconomica { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ht12_sequencial = ($this->ht12_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ht12_sequencial"]:$this->ht12_sequencial);
       $this->ht12_avaliacaogruporesposta = ($this->ht12_avaliacaogruporesposta == ""?@$GLOBALS["HTTP_POST_VARS"]["ht12_avaliacaogruporesposta"]:$this->ht12_avaliacaogruporesposta);
       $this->ht12_habitcandidato = ($this->ht12_habitcandidato == ""?@$GLOBALS["HTTP_POST_VARS"]["ht12_habitcandidato"]:$this->ht12_habitcandidato);
     }else{
       $this->ht12_sequencial = ($this->ht12_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["ht12_sequencial"]:$this->ht12_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($ht12_sequencial){ 
      $this->atualizacampos();
     if($this->ht12_avaliacaogruporesposta == null ){ 
     ...
     if($this->ht12_habitcandidato == null ){ 
     ...
     if($ht12_sequencial == "" || $ht12_sequencial == null ){
       $result = db_query("select nextval('habitfichasocioeconomica_ht12_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: habitfichasocioeconomica_ht12_sequencial_seq do campo: ht12_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $ht12_sequencial)){
         ...
         $this->ht12_sequencial = $ht12_sequencial; 
       }
     }
     if(($this->ht12_sequencial == null) || ($this->ht12_sequencial == "") ){ 
       $this->erro_sql = " Campo ht12_sequencial nao declarado.";
     ...
     $sql = "insert into habitfichasocioeconomica(
                                       ht12_sequencial 
                                      ,ht12_avaliacaogruporesposta 
                                      ,ht12_habitcandidato 
                       )
                values (
                                $this->ht12_sequencial 
                               ,$this->ht12_avaliacaogruporesposta 
                               ,$this->ht12_habitcandidato 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ht12_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ht12_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ht12_sequencial!=null){
       $sql .= " ht12_sequencial = $this->ht12_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ht12_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ficha Sócio Econônica da Habitação nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ht12_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ficha Sócio Econônica da Habitação nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ht12_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ht12_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ht12_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ht12_sequencial != ""){
          ...
          $sql2 .= " ht12_sequencial = $ht12_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Ficha Sócio Econônica da Habitação nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ht12_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Ficha Sócio Econônica da Habitação nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ht12_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ht12_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from habitfichasocioeconomica ";
     ...
     $sql .= "      inner join habitcandidato  on  habitcandidato.ht10_sequencial = habitfichasocioeconomica.ht12_habitcandidato";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = habitcandidato.ht10_numcgm";
     $sql2 = "";
     if($dbwhere==""){
       if($ht12_sequencial!=null ){
         $sql2 .= " where habitfichasocioeconomica.ht12_sequencial = $ht12_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
