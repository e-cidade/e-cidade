...
class cl_aex112014 { 
   ...
   var $campos = "
                 ...
                 si130_codreduzidoaex = int8 = Código identificador da anulação 
   ...
   function cl_aex112014() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("aex112014"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si130_codreduzidoaex = ($this->si130_codreduzidoaex == ""?@$GLOBALS["HTTP_POST_VARS"]["si130_codreduzidoaex"]:$this->si130_codreduzidoaex);
       ...
       $this->si130_reg10 = ($this->si130_reg10 == ""?@$GLOBALS["HTTP_POST_VARS"]["si130_reg10"]:$this->si130_reg10);
   ...
   function incluir ($si130_sequencial){ 
     ...
     if($this->si130_codreduzidoaex == null ){ 
       $this->si130_codreduzidoaex = "0";
     }
     ...
     if($si130_sequencial == "" || $si130_sequencial == null ){
       $result = db_query("select nextval('aex112014_si130_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: aex112014_si130_sequencial_seq do campo: si130_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from aex112014_si130_sequencial_seq");
     ...
     $sql = "insert into aex112014(
                                       si130_sequencial 
                                      ,si130_tiporegistro 
                                      ,si130_codreduzidoaex 
                                      ,si130_nroop 
                                      ,si130_dtpagamento 
                                      ,si130_nroanulacaoop 
                                      ,si130_dtanulacaoop 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "aex112014 ($this->si130_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "aex112014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "aex112014 ($this->si130_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010359,2010911,'','".AddSlashes(pg_result($resaco,0,'si130_codreduzidoaex'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($si130_sequencial=null) { 
     ...
     if(trim($this->si130_codreduzidoaex)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si130_codreduzidoaex"])){ 
        if(trim($this->si130_codreduzidoaex)=="" && isset($GLOBALS["HTTP_POST_VARS"]["si130_codreduzidoaex"])){ 
           $this->si130_codreduzidoaex = "0" ; 
        } 
       $sql  .= $virgula." si130_codreduzidoaex = $this->si130_codreduzidoaex ";
       $virgula = ",";
     }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si130_codreduzidoaex"]) || $this->si130_codreduzidoaex != "")
           $resac = db_query("insert into db_acount values($acount,2010359,2010911,'".AddSlashes(pg_result($resaco,$conresaco,'si130_codreduzidoaex'))."','$this->si130_codreduzidoaex',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aex112014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si130_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aex112014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si130_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si130_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010359,2010911,'','".AddSlashes(pg_result($resaco,$iresaco,'si130_codreduzidoaex'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "aex112014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "aex112014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si130_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:aex112014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si130_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from aex112014 ";
     $sql .= "      left  join aex102014  on  aex102014.si129_sequencial = aex112014.si130_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si130_sequencial!=null ){
         $sql2 .= " where aex112014.si130_sequencial = $si130_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
