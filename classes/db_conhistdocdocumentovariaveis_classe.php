...
//CLASSE DA ENTIDADE conhistdocdocumentovariaveis
class cl_conhistdocdocumentovariaveis { 
   ...
   function cl_conhistdocdocumentovariaveis() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("conhistdocdocumentovariaveis"); 
   ...
   function incluir ($c93_sequencial){ 
     ...
     if($c93_sequencial == "" || $c93_sequencial == null ){
       $result = db_query("select nextval('conhistdocdocumentovariaveis_c93_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: conhistdocdocumentovariaveis_c93_sequencial_seq do campo: c93_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from conhistdocdocumentovariaveis_c93_sequencial_seq");
     ...
     $sql = "insert into conhistdocdocumentovariaveis(
                                       c93_sequencial 
                                      ,c93_conhistdoctipo 
                                      ,c93_descricao 
                                      ,c93_variavel 
   ...
   function alterar ($c93_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update conhistdocdocumentovariaveis set ";
     $virgula = "";
   ...
   function excluir ($c93_sequencial=null,$dbwhere=null) { 
     ...
     $sql = " delete from conhistdocdocumentovariaveis
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($c93_sequencial != ""){
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conhistdocdocumentovariaveis";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $c93_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from conhistdocdocumentovariaveis ";
     $sql .= "      inner join conhistdoctipo  on  conhistdoctipo.c57_sequencial = conhistdocdocumentovariaveis.c93_conhistdoctipo";
     $sql2 = "";
     if($dbwhere==""){
       if($c93_sequencial!=null ){
         $sql2 .= " where conhistdocdocumentovariaveis.c93_sequencial = $c93_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
