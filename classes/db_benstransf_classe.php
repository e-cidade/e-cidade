...
class cl_benstransf {
    ...
    var $campos = "
                 ...
                 t93_tipo    = int4 = Tipo de transferencia
                 ";
    ...
    function atualizacampos($exclusao=false) {
        if($exclusao==false){
            ...
            $this->t93_tipo = ($this->t93_tipo == ""?@$GLOBALS["HTTP_POST_VARS"]["t93_tipo"]:$this->t93_tipo);
        }else{
            $this->t93_codtran = ($this->t93_codtran == ""?@$GLOBALS["HTTP_POST_VARS"]["t93_codtran"]:$this->t93_codtran);
        }
    }
    ...
    function incluir ($t93_codtran){
        ...
        if(($this->t93_tipo == null) || ($this->t93_tipo == "") ){
            $this->erro_sql = " Campo t93_tipo nao declarado.";
    ...
    function alterar ($t93_codtran=null) {
        ...
        if(trim($this->t93_tipo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["t93_tipo"])){
            if(trim($this->t93_tipo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["t93_tipo"])){
                $this->t93_tipo = "0" ;
            }
            $sql  .= $virgula." t93_tipo = $this->t93_tipo ";
            $virgula = ",";
        }
        $sql .= " where ";
        if($t93_codtran!=null){
