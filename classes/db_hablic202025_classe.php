<?
//MODULO: sicom
//CLASSE DA ENTIDADE hablic202025
class cl_hablic202025
{
  ...
  var $campos = "
                 ...
                 si59_codorgao = varchar(2) = C�digo do �rg�o
                 si59_codunidadesub = varchar(8) = C�digo da unidade
                 si59_exerciciolicitacao = int8 = Exerc�cio em que   foi instaurado
                 si59_nroprocessolicitatorio = varchar(12) = N�mero sequencial
                 si59_tipodocumento = int8 = Tipo do  documento
                 si59_nrodocumento = varchar(14) = N�mero do  documento
                 si59_datacredenciamento = date = Data do  credenciamento
                 si59_nrolote = int8 = N�mero do Lote
                 si59_coditem = int8 = C�digo do Item
                 si59_nroinscricaoestadual = varchar(30) = N�mero da  Inscri��o estadual
                 si59_ufinscricaoestadual = varchar(2) = UF da inscri��o  estadual
                 si59_nrocertidaoregularidadeinss = varchar(30) = N�mero da certid�o de regularidade FGTS
                 si59_dataemissaocertidaoregularidadeinss = date = Data de emiss�o  da certid�o
                 si59_dtvalidadecertidaoregularidadeinss = date = Data de validade  da certid�o
                 si59_nrocertidaoregularidadefgts = varchar(30) = N�mero da certid�o  de regularidade FGTS
                 si59_dtemissaocertidaoregularidadefgts = date = Data de emiss�o da certid�o de regularidade
                 si59_dtvalidadecertidaoregularidadefgts = date = Data de validade  da certid�o FGTS
                 si59_nrocndt = varchar(30) = N�mero da  Certid�o Negativa  de D�bitos
                 si59_dtemissaocndt = date = Data de emiss�o  da certid�o  Negativa
                 si59_dtvalidadecndt = date = Data de validade  da certid�o  Negativa
                 si59_mes = int8 = M�s
                 si59_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_hablic202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("hablic202025");
  ...
  function incluir($si59_sequencial)
  {
    ...
    if ($si59_sequencial == "" || $si59_sequencial == null) {
      $result = db_query("select nextval('hablic202025_si59_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: hablic202025_si59_sequencial_seq do campo: si59_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from hablic202025_si59_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si59_sequencial)) {
        $this->erro_sql = " Campo si59_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "hablic202025 ($this->si59_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "hablic202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "hablic202025 ($this->si59_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si59_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "hablic202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si59_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "hablic202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si59_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si59_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "hablic202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "hablic202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si59_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:hablic202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si59_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from hablic202025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si59_sequencial != null) {
        $sql2 .= " where hablic202025.si59_sequencial = $si59_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
