...
class cl_db_almox { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->m91_codigo = ($this->m91_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["m91_codigo"]:$this->m91_codigo);
       $this->m91_depto = ($this->m91_depto == ""?@$GLOBALS["HTTP_POST_VARS"]["m91_depto"]:$this->m91_depto);
     }else{
       $this->m91_codigo = ($this->m91_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["m91_codigo"]:$this->m91_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($m91_codigo){ 
      $this->atualizacampos();
     if($this->m91_depto == null ){ 
     ...
     if($m91_codigo == "" || $m91_codigo == null ){
       $result = db_query("select nextval('db_almox_m91_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: db_almox_m91_codigo_seq do campo: m91_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $m91_codigo)){
         ...
         $this->m91_codigo = $m91_codigo; 
       }
     }
     if(($this->m91_codigo == null) || ($this->m91_codigo == "") ){ 
       $this->erro_sql = " Campo m91_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->m91_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($m91_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($m91_codigo!=null){
       $sql .= " m91_codigo = $this->m91_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->m91_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cadastro de almox. nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->m91_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cadastro de almox. nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->m91_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($m91_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($m91_codigo));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cadastro de almox. nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$m91_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cadastro de almox. nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$m91_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $m91_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     if($dbwhere==""){
       if($m91_codigo!=null ){
         $sql2 .= " where db_almox.m91_codigo = $m91_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql 
   function sql_query_file ( $m91_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
