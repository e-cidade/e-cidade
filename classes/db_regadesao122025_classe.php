<?
//MODULO: sicom
//CLASSE DA ENTIDADE regadesao122025
class cl_regadesao122025
{
  ...
  var $campos = "
                 ...
                 si69_codorgao = varchar(2) = C�digo do �rg�o
                 si69_codunidadesub = varchar(8) = C�digo da unidade
                 si69_nroprocadesao = varchar(12) = N�mero do  processo
                 si69_exercicioadesao = int8 = Exerc�cio do processo de ades�o
                 si69_coditem = int8 = C�digo do Item
                 si69_nroitem = int8 = N�mero do Item
                 si69_mes = int8 = M�s
                 si69_reg10 = int8 = reg10
                 si69_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_regadesao122025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("regadesao122025");
  ...
  function incluir($si69_sequencial)
  {
    ...
    if ($si69_sequencial == "" || $si69_sequencial == null) {
      $result = db_query("select nextval('regadesao122025_si69_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: regadesao122025_si69_sequencial_seq do campo: si69_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from regadesao122025_si69_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si69_sequencial)) {
        $this->erro_sql = " Campo si69_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into regadesao122025(
                                       si69_sequencial
                                      ,si69_tiporegistro
                                      ,si69_codorgao
                                      ,si69_codunidadesub
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "regadesao122025 ($this->si69_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "regadesao122025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "regadesao122025 ($this->si69_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update regadesao122025 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "regadesao122025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si69_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "regadesao122025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si69_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si69_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from regadesao122025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si69_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "regadesao122025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "regadesao122025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si69_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:regadesao122025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si69_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from regadesao122025 ";
    $sql .= "      left  join regadesao102020  on  regadesao102020.si67_sequencial = regadesao122025.si69_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si69_sequencial != null) {
        $sql2 .= " where regadesao122025.si69_sequencial = $si69_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
