...
class cl_db_tipoinstit { 
   ...
   function incluir ($db21_codtipo){ 
     ...
     if($this->db21_nome == null ){ 
       $this->erro_sql = " Campo Nome do Tipo nao Informado.";
     ...
     if($this->db21_idtribunal == null ){ 
       $this->erro_sql = " Campo Identificador no Tribunal de Contas nao Informado.";
     ...
     if(($this->db21_codtipo == null) || ($this->db21_codtipo == "") ){ 
       $this->erro_sql = " Campo db21_codtipo nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = " ($this->db21_codtipo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($db21_codtipo=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db21_codtipo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db21_nome"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["db21_idtribunal"]))
   ...
   function excluir ($db21_codtipo=null,$dbwhere=null) { 
   ...
   function sql_query ( $db21_codtipo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   function sql_query_file ( $db21_codtipo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
