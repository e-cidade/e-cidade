...
class cl_aex102025
{
  ...
  var $campos = "
                 ...
                 si130_codext = int8 = C�digo identificador da anula��o
                 si130_codfontrecursos = int8 = C�digo da fonte de recursos
                 si130_nroop = int8 = C�digo da fonte de recursos
                 si130_codunidadesub = varchar(8) = C�digo da unidade ou subunidade or�ament�ria
                 si130_dtpagamento = date = Data de  pagamento da  OP
                 si130_nroanulacaoop = int8 = N�mero da  anula��o da OP
                 si130_dtanulacaoop = date = Data da anula��o  da OP
                 si130_vlanulacaoop = float8 = Valor da  Anula��o da OP
                 si130_mes = int8 = M�s
                 si130_reg10 = int8 = reg10
                 si130_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_aex102025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("aex102025");
  ...
  function incluir($si130_sequencial)
  {
    ...
    if ($si130_sequencial == "" || $si130_sequencial == null) {
      $result = db_query("select nextval('aex102025_si130_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: aex102025_si130_sequencial_seq do campo: si130_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from aex102025_si130_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si130_sequencial)) {
        $this->erro_sql = " Campo si130_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aex102025 ($this->si130_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aex102025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aex102025 ($this->si130_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si130_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aex102025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si130_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aex102025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si130_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si130_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aex102025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aex102025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si130_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:aex102025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si130_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from aex102025 ";
    $sql .= "      left  join aex102025  on  aex102025.si129_sequencial = aex102025.si130_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si130_sequencial != null) {
        $sql2 .= " where aex102025.si130_sequencial = $si130_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
