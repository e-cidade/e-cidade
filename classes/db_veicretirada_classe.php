...
//       return false;
    ...
    if($this->ve60_horasaida == null ){
      $this->erro_sql = " Campo Hora Retirada nao Informado.";
    ...
    if($this->ve60_destino == null ){
      $this->erro_sql = " Campo Observação nao Informado."; // o nome é Observação mas o campo é Destino
    ...
    if(($this->ve60_codigo == null) || ($this->ve60_codigo == "") ){
      $this->erro_sql = " Campo ve60_codigo nao declarado.";
    ...
    if($result==false){
      ...
      if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
        $this->erro_sql   = "Retirada dos Veículos ($this->ve60_codigo) nao Incluído. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ($ve60_codigo=null) {
    $this->atualizacampos();
...
//         return false;
    ...
    if(trim($this->ve60_destino)!="" || isset($GLOBALS["HTTP_POST_VARS"]["ve60_destino"])){
      ...
      if(trim($this->ve60_destino) == null ){
        $this->erro_sql = " Campo Observação não Informado."; // o nome é Observação mas é o campo destino
        $this->erro_campo = "ve60_destino";
        $this->erro_banco = "";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
    ...
    if($this->numrows>0){
      for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_codigo"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_veiculo"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_veicmotoristas"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_datasaida"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_horasaida"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_destino"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_coddepto"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_usuario"]))
        ...
        if(isset($GLOBALS["HTTP_POST_VARS"]["ve60_data"]))
    ...
    if($result==false){
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "Retirada dos Veículos nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : ".$this->ve60_codigo;
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "Retirada dos Veículos nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : ".$this->ve60_codigo;
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
  ...
  function excluir ($ve60_codigo=null,$dbwhere=null) {
    ...
    if($result==false){
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "Retirada dos Veículos nao Excluído. Exclusão Abortada.\\n";
      ...
      if(pg_affected_rows($result)==0){
        $this->erro_banco = "";
        $this->erro_sql = "Retirada dos Veículos nao Encontrado. Exclusão não Efetuada.\\n";
        $this->erro_sql .= "Valores : ".$ve60_codigo;
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
  ...
  // funcao do sql
  function sql_query ( $ve60_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
    ...
    $sql .= "      left join veiccadcategcnh  as b on   b.ve30_codigo = veicmotoristas.ve05_veiccadcategcnh";
  ...
  // funcao do sql
  function sql_query_file ( $ve60_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
    $sql = "select ";
    if($campos != "*" ){
      $campos_sql = explode("#",$campos);
      $virgula = "";
