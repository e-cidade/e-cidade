...
class cl_grupoproc { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->sd11_c_codigo = ($this->sd11_c_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd11_c_codigo"]:$this->sd11_c_codigo);
       $this->sd11_c_descr = ($this->sd11_c_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["sd11_c_descr"]:$this->sd11_c_descr);
       $this->sd11_f_orcamento = ($this->sd11_f_orcamento == ""?@$GLOBALS["HTTP_POST_VARS"]["sd11_f_orcamento"]:$this->sd11_f_orcamento);
     }else{
       $this->sd11_c_codigo = ($this->sd11_c_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["sd11_c_codigo"]:$this->sd11_c_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($sd11_c_codigo){ 
      $this->atualizacampos();
     if($this->sd11_c_descr == null ){ 
     ...
     if($this->sd11_f_orcamento == null ){ 
       ...
       $this->sd11_c_codigo = $sd11_c_codigo; 
     if(($this->sd11_c_codigo == null) || ($this->sd11_c_codigo == "") ){ 
       $this->erro_sql = " Campo sd11_c_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->sd11_c_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($sd11_c_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($sd11_c_codigo!=null){
       $sql .= " sd11_c_codigo = '$this->sd11_c_codigo'";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->sd11_c_codigo));
     if($this->numrows>0){
   ...
   function excluir ($sd11_c_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($sd11_c_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($sd11_c_codigo != ""){
          ...
          $sql2 .= " sd11_c_codigo = '$sd11_c_codigo' ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$sd11_c_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $sd11_c_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     if($dbwhere==""){
       if($sd11_c_codigo!=null ){
         $sql2 .= " where grupoproc.sd11_c_codigo = '$sd11_c_codigo' "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
