...
class cl_procjur { 
   ...
   function incluir ($v62_sequencial){ 
     ...
     if(($this->v62_sequencial == null) || ($this->v62_sequencial == "") ){ 
       $this->erro_sql = " Campo v62_sequencial nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Processo Juridico ($this->v62_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($v62_sequencial=null) { 
      $this->atualizacampos();
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_sequencial"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_procjurtipo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_descricao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_data"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_hora"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_usuario"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_dataini"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_datafim"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_situacao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["v62_obs"]))
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Processo Juridico nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->v62_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Processo Juridico nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->v62_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($v62_sequencial=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Processo Juridico nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Processo Juridico nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$v62_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $v62_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= "      left  join procjurjudicialadvog on  procjurjudicial.v63_procjur  	= procjur.v62_sequencial			";
   ...
   // funcao do sql 
   function sql_query_file ( $v62_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
