...
class cl_issarqsimplesregissbase { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->q134_sequencial = ($this->q134_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q134_sequencial"]:$this->q134_sequencial);
       $this->q134_inscr = ($this->q134_inscr == ""?@$GLOBALS["HTTP_POST_VARS"]["q134_inscr"]:$this->q134_inscr);
       $this->q134_issarqsimplesreg = ($this->q134_issarqsimplesreg == ""?@$GLOBALS["HTTP_POST_VARS"]["q134_issarqsimplesreg"]:$this->q134_issarqsimplesreg);
     }else{
       $this->q134_sequencial = ($this->q134_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["q134_sequencial"]:$this->q134_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($q134_sequencial){ 
      $this->atualizacampos();
     if($this->q134_inscr == null ){ 
     ...
     if($this->q134_issarqsimplesreg == null ){ 
     ...
     if($q134_sequencial == "" || $q134_sequencial == null ){
       $result = db_query("select nextval('issarqsimplesregissbase_q134_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: issarqsimplesregissbase_q134_sequencial_seq do campo: q134_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $q134_sequencial)){
         ...
         $this->q134_sequencial = $q134_sequencial; 
       }
     }
     if(($this->q134_sequencial == null) || ($this->q134_sequencial == "") ){ 
       $this->erro_sql = " Campo q134_sequencial nao declarado.";
     ...
     $sql = "insert into issarqsimplesregissbase(
                                       q134_sequencial 
                                      ,q134_inscr 
                                      ,q134_issarqsimplesreg 
                       )
                values (
                                $this->q134_sequencial 
                               ,$this->q134_inscr 
                               ,$this->q134_issarqsimplesreg 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->q134_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($q134_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($q134_sequencial!=null){
       $sql .= " q134_sequencial = $this->q134_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->q134_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tabela issarqsimplesregissbase nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->q134_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tabela issarqsimplesregissbase nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->q134_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($q134_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($q134_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($q134_sequencial != ""){
          ...
          $sql2 .= " q134_sequencial = $q134_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tabela issarqsimplesregissbase nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$q134_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tabela issarqsimplesregissbase nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$q134_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $q134_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from issarqsimplesregissbase ";
     $sql .= "      inner join issbase  on  issbase.q02_inscr = issarqsimplesregissbase.q134_inscr";
     $sql .= "      inner join issarqsimplesreg  on  issarqsimplesreg.q23_sequencial = issarqsimplesregissbase.q134_issarqsimplesreg";
     ...
     if($dbwhere==""){
       if($q134_sequencial!=null ){
         $sql2 .= " where issarqsimplesregissbase.q134_sequencial = $q134_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql 
   function sql_query_inscricao ($iCnpj) {
     
     if($iCnpj == "") {
       throw new Exception("Nenhum CNPJ informado!");
     }
     
     $sSql = "select q02_inscr 
                from cgm 
                     inner join issbase on issbase.q02_numcgm = cgm.z01_numcgm 
               where cgm.z01_cgccpf = '$iCnpj'";
     return $sSql;          
   }
