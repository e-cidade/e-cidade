...
//MODULO: escola
//CLASSE DA ENTIDADE turmaturnoadicional
class cl_turmaturnoadicional { 
   ...
   function cl_turmaturnoadicional() { 
   ...
   function incluir ($ed246_i_codigo){ 
     ...
     $sql = "insert into turmaturnoadicional(
                                       ed246_i_codigo 
                                      ,ed246_i_turma 
                                      ,ed246_i_turno 
                       )
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "turmaturnoadicional ($this->ed246_i_codigo) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($ed246_i_codigo=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "turmaturnoadicional nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed246_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "turmaturnoadicional nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed246_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed246_i_codigo=null,$dbwhere=null) { 
     ...
     $sql = " delete from turmaturnoadicional
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($ed246_i_codigo != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "turmaturnoadicional nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "turmaturnoadicional nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed246_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:turmaturnoadicional";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $ed246_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from turmaturnoadicional ";
     $sql .= "      inner join turno      on  turno.ed15_i_codigo      = turmaturnoadicional.ed246_i_turno";
     $sql .= "      inner join turma      on  turma.ed57_i_codigo      = turmaturnoadicional.ed246_i_turma";
     ...
     if($dbwhere==""){
       if($ed246_i_codigo!=null ){
         $sql2 .= " where turmaturnoadicional.ed246_i_codigo = $ed246_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
