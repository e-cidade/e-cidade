...
class cl_cgmtipoempresa { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->z03_tipoempresa = ($this->z03_tipoempresa == ""?@$GLOBALS["HTTP_POST_VARS"]["z03_tipoempresa"]:$this->z03_tipoempresa);
     }else{
       $this->z03_sequencial = ($this->z03_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["z03_sequencial"]:$this->z03_sequencial);
     }
   }
   ...
   function incluir ($z03_sequencial){ 
     ...
     if($z03_sequencial == "" || $z03_sequencial == null ){
       $result = db_query("select nextval('cgmtipoempresa_z03_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: cgmtipoempresa_z03_sequencial_seq do campo: z03_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $z03_sequencial)){
         ...
         $this->z03_sequencial = $z03_sequencial; 
       }
     }
     if(($this->z03_sequencial == null) || ($this->z03_sequencial == "") ){ 
       $this->erro_sql = " Campo z03_sequencial nao declarado.";
     ...
     $sql = "insert into cgmtipoempresa(
                                       z03_sequencial 
                                      ,z03_numcgm 
                                      ,z03_tipoempresa 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->z03_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($z03_sequencial=null) { 
     ...
     $sql .= " where ";
     if($z03_sequencial!=null){
       $sql .= " z03_sequencial = $this->z03_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->z03_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cgm Tipo Empresa nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->z03_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cgm Tipo Empresa nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->z03_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($z03_sequencial=null,$dbwhere=null) { 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($z03_sequencial != ""){
          ...
          $sql2 .= " z03_sequencial = $z03_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Cgm Tipo Empresa nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$z03_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Cgm Tipo Empresa nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$z03_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $z03_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from cgmtipoempresa ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = cgmtipoempresa.z03_numcgm";
     $sql .= "      inner join tipoempresa  on  tipoempresa.db98_sequencial = cgmtipoempresa.z03_tipoempresa";
     $sql2 = "";
     if($dbwhere==""){
       if($z03_sequencial!=null ){
         $sql2 .= " where cgmtipoempresa.z03_sequencial = $z03_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
