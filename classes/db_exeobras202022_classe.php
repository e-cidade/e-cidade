<?php
//MODULO: sicom
//CLASSE DA ENTIDADE exeobras202022
class cl_exeobras202022 {
    ...
    function __construct() {
        ...
        $this->rotulo = new rotulo("exeobras202022");
    ...
    function incluir () {
        ...
        if ($this->si204_sequencial == null ) {
            $result = db_query("select nextval('exeobras202022_si204_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: exeobras202022_si204_sequencial_seq do campo: si204_sequencial";
        ...
        $sql = "insert into exeobras202022(
                                       si204_sequencial
                                      ,si204_tiporegistro
                                      ,si204_codorgao
                                      ,si204_codunidadesub
    ...
    function excluir ( $si204_sequencial=null ,$dbwhere=null) {
        ...
        $sql = " delete from exeobras202022
                    where ";
        $sql2 = "";
    ...
    function sql_record($sql) {
        ...
        if ($this->numrows==0) {
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:exeobras202022";
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si204_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
        ...
        $sql .= " from exeobras202022 ";
        $sql2 = "";
        if ($dbwhere=="") {
            if ( $si204_sequencial != "" && $si204_sequencial != null) {
                $sql2 = " where exeobras202022.si204_sequencial = '$si204_sequencial'";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
