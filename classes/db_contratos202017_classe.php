<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos202017
class cl_contratos202017 { 
   ...
   var $si87_dataassinaturacontoriginal_dia = null; 
   var $si87_dataassinaturacontoriginal_mes = null; 
   var $si87_dataassinaturacontoriginal_ano = null; 
   var $si87_dataassinaturacontoriginal = null; 
   ...
   var $campos = "
                 ...
                 si87_dataassinaturacontoriginal = date = Data da assinatura  do Contrato 
   ...
   function cl_contratos202017() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos202017"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->si87_dataassinaturacontoriginal == ""){
         $this->si87_dataassinaturacontoriginal_dia = ($this->si87_dataassinaturacontoriginal_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_dia"]:$this->si87_dataassinaturacontoriginal_dia);
         $this->si87_dataassinaturacontoriginal_mes = ($this->si87_dataassinaturacontoriginal_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_mes"]:$this->si87_dataassinaturacontoriginal_mes);
         $this->si87_dataassinaturacontoriginal_ano = ($this->si87_dataassinaturacontoriginal_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_ano"]:$this->si87_dataassinaturacontoriginal_ano);
         if($this->si87_dataassinaturacontoriginal_dia != ""){
            $this->si87_dataassinaturacontoriginal = $this->si87_dataassinaturacontoriginal_ano."-".$this->si87_dataassinaturacontoriginal_mes."-".$this->si87_dataassinaturacontoriginal_dia;
         }
       }
   ...
   function incluir ($si87_sequencial){ 
     ...
     if($this->si87_dataassinaturacontoriginal == null ){ 
       $this->si87_dataassinaturacontoriginal = "null";
     }
     ...
     if($si87_sequencial == "" || $si87_sequencial == null ){
       $result = db_query("select nextval('contratos202017_si87_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos202017_si87_sequencial_seq do campo: si87_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from contratos202017_si87_sequencial_seq");
     ...
     $sql = "insert into contratos202017(
                                       si87_sequencial 
                                      ,si87_tiporegistro 
                                      ,si87_codaditivo 
                                      ,si87_codorgao 
                                      ,si87_codunidadesub 
                                      ,si87_nrocontrato 
                                      ,si87_dataassinaturacontoriginal 
                ...
                values (
                               ...
                               ,".($this->si87_dataassinaturacontoriginal == "null" || $this->si87_dataassinaturacontoriginal == ""?"null":"'".$this->si87_dataassinaturacontoriginal."'")." 
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos202017 ($this->si87_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "contratos202017 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "contratos202017 ($this->si87_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010316,2010464,'','".AddSlashes(pg_result($resaco,0,'si87_dataassinaturacontoriginal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($si87_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update contratos202017 set ";
     $virgula = "";
     ...
     if(trim($this->si87_dataassinaturacontoriginal)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_dia"] !="") ){ 
       $sql  .= $virgula." si87_dataassinaturacontoriginal = '$this->si87_dataassinaturacontoriginal' ";
       $virgula = ",";
     }     else{ 
       if(isset($GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal_dia"])){ 
         $sql  .= $virgula." si87_dataassinaturacontoriginal = null ";
         $virgula = ",";
       }
     }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si87_dataassinaturacontoriginal"]) || $this->si87_dataassinaturacontoriginal != "")
           $resac = db_query("insert into db_acount values($acount,2010316,2010464,'".AddSlashes(pg_result($resaco,$conresaco,'si87_dataassinaturacontoriginal'))."','$this->si87_dataassinaturacontoriginal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "contratos202017 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si87_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos202017 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si87_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si87_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010316,2010464,'','".AddSlashes(pg_result($resaco,$iresaco,'si87_dataassinaturacontoriginal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     $sql = " delete from contratos202017
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si87_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "contratos202017 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos202017 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si87_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos202017";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si87_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from contratos202017 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si87_sequencial!=null ){
         $sql2 .= " where contratos202017.si87_sequencial = $si87_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
