<?
//MODULO: sicom
//CLASSE DA ENTIDADE dispensa162025
class cl_dispensa162025
{
  ...
  var $campos = "
                 ...
                 si80_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si80_codunidadesubresp = varchar(8) = C�digo da unidade
                 si80_exercicioprocesso = int8 = Exerc�cio em que foi instaurado
                 si80_nroprocesso = varchar(12) = N�mero sequencial   do processo
                 si80_tipoprocesso = int8 = Tipo de processo
                 si80_codorgao = varchar(2) = C�digo do �rg�o
                 si80_codunidadesub = varchar(8) = C�digo da unidade
                 si80_codfuncao = varchar(2) = C�digo da fun��o
                 si80_codsubfuncao = varchar(3) = C�digo da  Subfun��o
                 si80_codprograma = varchar(4) = C�digo do   programa
                 si80_idacao = varchar(4) = C�digo que  identifica a A��o
                 si80_idsubacao = varchar(4) = C�digo que identifica a SubA��o
                 si80_naturezadespesa = int8 = C�digo da natureza da despesa
                 si80_codfontrecursos = int8 = C�digo da fonte   de recursos
                 si80_vlrecurso = float8 = Valor do recurso  previsto
                 si80_mes = int8 = M�s
                 si80_reg10 = int8 = reg10
                 si80_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_dispensa162025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("dispensa162025");
  ...
  function incluir($si80_sequencial)
  {
    ...
    if ($si80_sequencial == "" || $si80_sequencial == null) {
      $result = db_query("select nextval('dispensa162025_si80_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: dispensa162025_si80_sequencial_seq do campo: si80_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
        return false;
      ...
      $result = db_query("select last_value from dispensa162025_si80_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si80_sequencial)) {
        $this->erro_sql = " Campo si80_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into dispensa162025(
                                       si80_sequencial
                                      ,si80_tiporegistro
                                      ,si80_codorgaoresp
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "dispensa162025 ($this->si80_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "dispensa162025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "dispensa162025 ($this->si80_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si80_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa162025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si80_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa162025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si80_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si80_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from dispensa162025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si80_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "dispensa162025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "dispensa162025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si80_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:dispensa162025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query($si80_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from dispensa162025 ";
    $sql .= "      left  join dispensa102020  on  dispensa102020.si74_sequencial = dispensa162025.si80_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si80_sequencial != null) {
        $sql2 .= " where dispensa162025.si80_sequencial = $si80_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
