<?
//MODULO: sicom
//CLASSE DA ENTIDADE bodcasp302025
class cl_bodcasp302025 {
   ...
   function cl_bodcasp302025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("bodcasp302025");
   ...
   function incluir ($si203_sequencial){
     ...
     if($si203_sequencial == "" || $si203_sequencial == null ){
       $result = db_query("select nextval('bodcasp302025_si203_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: bodcasp302025_si203_sequencial_seq do campo: si203_sequencial";
       ...
       $result = db_query("select last_value from bodcasp302025_si203_sequencial_seq");
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "bodcasp302025 ($this->si203_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "bodcasp302025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "bodcasp302025 ($this->si203_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si203_sequencial=null) {
     ...
     if(trim($this->si203_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_sequencial"])){
       ...
       if(trim($this->si203_sequencial) == null ){
         $this->erro_sql = " Campo si203_sequencial n�o informado.";
     ...
     if(trim($this->si203_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_tiporegistro"])){
       ...
       if(trim($this->si203_tiporegistro) == null ){
         $this->erro_sql = " Campo si203_tiporegistro n�o informado.";
     ...
     if(trim($this->si203_fasedespesaorca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_fasedespesaorca"])){
       ...
       if(trim($this->si203_fasedespesaorca) == null ){
         $this->erro_sql = " Campo si203_fasedespesaorca n�o informado.";
     ...
     if(trim($this->si203_vlpessoalencarsoci)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlpessoalencarsoci"])){
       ...
       if(trim($this->si203_vlpessoalencarsoci) == null ){
         $this->erro_sql = " Campo si203_vlpessoalencarsoci n�o informado.";
     ...
     if(trim($this->si203_vljurosencardividas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vljurosencardividas"])){
       ...
       if(trim($this->si203_vljurosencardividas) == null ){
         $this->erro_sql = " Campo si203_vljurosencardividas n�o informado.";
     ...
     if(trim($this->si203_vloutrasdespcorren)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vloutrasdespcorren"])){
       ...
       if(trim($this->si203_vloutrasdespcorren) == null ){
         $this->erro_sql = " Campo si203_vloutrasdespcorren n�o informado.";
     ...
     if(trim($this->si203_vlinvestimentos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlinvestimentos"])){
       ...
       if(trim($this->si203_vlinvestimentos) == null ){
         $this->erro_sql = " Campo si203_vlinvestimentos n�o informado.";
     ...
     if(trim($this->si203_vlinverfinanceira)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlinverfinanceira"])){
       ...
       if(trim($this->si203_vlinverfinanceira) == null ){
         $this->erro_sql = " Campo si203_vlinverfinanceira n�o informado.";
     ...
     if(trim($this->si203_vlamortizadivida)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlamortizadivida"])){
       ...
       if(trim($this->si203_vlamortizadivida) == null ){
         $this->erro_sql = " Campo si203_vlamortizadivida n�o informado.";
     ...
     if(trim($this->si203_vlreservacontingen)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlreservacontingen"])){
       ...
       if(trim($this->si203_vlreservacontingen) == null ){
         $this->erro_sql = " Campo si203_vlreservacontingen n�o informado.";
     ...
     if(trim($this->si203_vlreservarpps)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlreservarpps"])){
       ...
       if(trim($this->si203_vlreservarpps) == null ){
         $this->erro_sql = " Campo si203_vlreservarpps n�o informado.";
     ...
     if(trim($this->si203_vlamortizadiviintermob)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlamortizadiviintermob"])){
       ...
       if(trim($this->si203_vlamortizadiviintermob) == null ){
         $this->erro_sql = " Campo si203_vlamortizadiviintermob n�o informado.";
     ...
     if(trim($this->si203_vlamortizadividacontratualinternas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlamortizadividacontratualinternas"])){
       ...
       if(trim($this->si203_vlamortizadividacontratualinternas) == null ){
         $this->erro_sql = " Campo si203_vlamortizadividacontratualinternas n�o informado.";
     ...
     if(trim($this->si203_vlamortizadivextmob)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlamortizadivextmob"])){
       ...
       if(trim($this->si203_vlamortizadivextmob) == null ){
         $this->erro_sql = " Campo si203_vlamortizadivextmob n�o informado.";
     ...
     if(trim($this->si203_vlamortizadividacontratualexternas)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlamortizadividacontratualexternas"])){
       ...
       if(trim($this->si203_vlamortizadividacontratualexternas) == null ){
         $this->erro_sql = " Campo si203_vlamortizadividacontratualexternas n�o informado.";
     ...
     if(trim($this->si203_vlsuperavit)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vlsuperavit"])){
       ...
       if(trim($this->si203_vlsuperavit) == null ){
         $this->erro_sql = " Campo si203_vlsuperavit n�o informado.";
     ...
     if(trim($this->si203_vltotalquadrodespesa)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si203_vltotalquadrodespesa"])){
       ...
       if(trim($this->si203_vltotalquadrodespesa) == null ){
         $this->erro_sql = " Campo si203_vltotalquadrodespesa n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp302025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si203_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp302025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si203_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si203_sequencial=null,$dbwhere=null) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "bodcasp302025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "bodcasp302025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si203_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:bodcasp302025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si203_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from bodcasp302025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si203_sequencial!=null ){
         $sql2 .= " where bodcasp302025.si203_sequencial = $si203_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
