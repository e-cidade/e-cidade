...
class cl_cancdebitostipo { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->k73_sequencial = ($this->k73_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k73_sequencial"]:$this->k73_sequencial);
       $this->k73_descricao = ($this->k73_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["k73_descricao"]:$this->k73_descricao);
     }else{
       $this->k73_sequencial = ($this->k73_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["k73_sequencial"]:$this->k73_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($k73_sequencial){ 
      $this->atualizacampos();
     if($this->k73_descricao == null ){ 
     ...
     if($k73_sequencial == "" || $k73_sequencial == null ){
       $result = db_query("select nextval('cancdebitostipo_k73_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: cancdebitostipo_k73_sequencial_seq do campo: k73_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $k73_sequencial)){
         ...
         $this->k73_sequencial = $k73_sequencial; 
       }
     }
     if(($this->k73_sequencial == null) || ($this->k73_sequencial == "") ){ 
       $this->erro_sql = " Campo k73_sequencial nao declarado.";
     ...
     $sql = "insert into cancdebitostipo(
                                       k73_sequencial 
                                      ,k73_descricao 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->k73_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($k73_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($k73_sequencial!=null){
       $sql .= " k73_sequencial = $this->k73_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->k73_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cancdebitostipo nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->k73_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cancdebitostipo nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->k73_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($k73_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($k73_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($k73_sequencial != ""){
          ...
          $sql2 .= " k73_sequencial = $k73_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "cancdebitostipo nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$k73_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "cancdebitostipo nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$k73_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $k73_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from cancdebitostipo ";
     $sql2 = "";
     if($dbwhere==""){
       if($k73_sequencial!=null ){
         $sql2 .= " where cancdebitostipo.k73_sequencial = $k73_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
