...
class cl_empnotadadospit { 
   ...
   var $campos = "
                 ...
                 e11_basecalculoicms = float8 = Base de Cálculo ICMS 
                 e11_inscricaosubstitutofiscal = int4 = Inscricao Substituto Fiscal 
                 e11_valoricms = float4 = Valor ICMS 
                 e11_basecalculosubstitutotrib = float4 = Base Calculo Substituto Trib 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->e11_sequencial = ($this->e11_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_sequencial"]:$this->e11_sequencial);
       $this->e11_cfop = ($this->e11_cfop == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_cfop"]:$this->e11_cfop);
       $this->e11_seriefiscal = ($this->e11_seriefiscal == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_seriefiscal"]:$this->e11_seriefiscal);
       $this->e11_basecalculoicms = ($this->e11_basecalculoicms == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_basecalculoicms"]:$this->e11_basecalculoicms);
       $this->e11_inscricaosubstitutofiscal = ($this->e11_inscricaosubstitutofiscal == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_inscricaosubstitutofiscal"]:$this->e11_inscricaosubstitutofiscal);
       $this->e11_valoricms = ($this->e11_valoricms == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_valoricms"]:$this->e11_valoricms);
       $this->e11_basecalculosubstitutotrib = ($this->e11_basecalculosubstitutotrib == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_basecalculosubstitutotrib"]:$this->e11_basecalculosubstitutotrib);
       $this->e11_valoricmssubstitutotrib = ($this->e11_valoricmssubstitutotrib == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_valoricmssubstitutotrib"]:$this->e11_valoricmssubstitutotrib);
     }else{
       $this->e11_sequencial = ($this->e11_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e11_sequencial"]:$this->e11_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($e11_sequencial){ 
      $this->atualizacampos();
     if($this->e11_cfop == null ){ 
     ...
     if($this->e11_basecalculoicms == null ){ 
       $this->e11_basecalculoicms = "0";
     }
     if($this->e11_inscricaosubstitutofiscal == null ){ 
       $this->e11_inscricaosubstitutofiscal = "0";
     }
     if($this->e11_valoricms == null ){ 
       $this->e11_valoricms = "0";
     }
     if($this->e11_basecalculosubstitutotrib == null ){ 
       $this->e11_basecalculosubstitutotrib = "0";
     }
     if($this->e11_valoricmssubstitutotrib == null ){ 
       $this->e11_valoricmssubstitutotrib = "0";
     }
     if($e11_sequencial == "" || $e11_sequencial == null ){
       $result = db_query("select nextval('empnotadadospit_e11_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: empnotadadospit_e11_sequencial_seq do campo: e11_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $e11_sequencial)){
         ...
         $this->e11_sequencial = $e11_sequencial; 
       }
     }
     if(($this->e11_sequencial == null) || ($this->e11_sequencial == "") ){ 
       $this->erro_sql = " Campo e11_sequencial nao declarado.";
     ...
     $sql = "insert into empnotadadospit(
                                       e11_sequencial 
                                      ,e11_cfop 
                                      ,e11_seriefiscal 
                                      ,e11_basecalculoicms 
                ...
                values (
                                $this->e11_sequencial 
                               ,$this->e11_cfop 
                               ,'$this->e11_seriefiscal' 
                               ,$this->e11_basecalculoicms 
                               ,$this->e11_inscricaosubstitutofiscal 
                               ,$this->e11_valoricms 
                               ,$this->e11_basecalculosubstitutotrib 
                               ,$this->e11_valoricmssubstitutotrib 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->e11_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($e11_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($e11_sequencial!=null){
       $sql .= " e11_sequencial = $this->e11_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->e11_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "empnotadadospit nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->e11_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "empnotadadospit nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->e11_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($e11_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($e11_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($e11_sequencial != ""){
          ...
          $sql2 .= " e11_sequencial = $e11_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "empnotadadospit nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$e11_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "empnotadadospit nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$e11_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $e11_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from empnotadadospit ";
     $sql .= "      inner join cfop  on  cfop.e10_sequencial = empnotadadospit.e11_cfop";
     $sql2 = "";
     if($dbwhere==""){
       if($e11_sequencial!=null ){
         $sql2 .= " where empnotadadospit.e11_sequencial = $e11_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
  ...
  function sql_query_notas ($e11_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {  
    ...
    $sql .= " from empnotadadospit ";
    $sql .= "      inner join empnotadadospitnotas on e11_sequencial = e13_empnotadadospit "; 
    $sql .= "      inner join empnota              on e69_codnota    = e13_empnota  ";
    ...
    $sql .= "      left join cfop  on  cfop.e10_sequencial = empnotadadospit.e11_cfop ";
    $sql .= "      left join emparquivopitnotas    on  e15_empnotadadospit  = e11_sequencial ";
    $sql .= "      left join emparquivopit         on  e15_emparquivopit    = e14_sequencial ";
    $sql2 = "";
