...
class cl_pareceraval {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->ed93_i_codigo = ($this->ed93_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed93_i_codigo"]:$this->ed93_i_codigo);
       $this->ed93_i_diarioavaliacao = ($this->ed93_i_diarioavaliacao == ""?@$GLOBALS["HTTP_POST_VARS"]["ed93_i_diarioavaliacao"]:$this->ed93_i_diarioavaliacao);
       $this->ed93_t_parecer = ($this->ed93_t_parecer == ""?@$GLOBALS["HTTP_POST_VARS"]["ed93_t_parecer"]:$this->ed93_t_parecer);
     }else{
       $this->ed93_i_codigo = ($this->ed93_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["ed93_i_codigo"]:$this->ed93_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($ed93_i_codigo){
      $this->atualizacampos();
     if($this->ed93_i_diarioavaliacao == null ){
     ...
     if($ed93_i_codigo == "" || $ed93_i_codigo == null ){
       $result = db_query("select nextval('pareceraval_ed93_i_codigo_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: pareceraval_ed93_i_codigo_seq do campo: ed93_i_codigo";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $ed93_i_codigo)){
         ...
         $this->ed93_i_codigo = $ed93_i_codigo;
       }
     }
     if(($this->ed93_i_codigo == null) || ($this->ed93_i_codigo == "") ){
       $this->erro_sql = " Campo ed93_i_codigo nao declarado.";
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->ed93_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($ed93_i_codigo=null) {
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($ed93_i_codigo!=null){
       $sql .= " ed93_i_codigo = $this->ed93_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->ed93_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Parecer das avaliações nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed93_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Parecer das avaliações nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->ed93_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($ed93_i_codigo=null,$dbwhere=null) {
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($ed93_i_codigo));
     }else{
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($ed93_i_codigo != ""){
          ...
          $sql2 .= " ed93_i_codigo = $ed93_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Parecer das avaliações nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$ed93_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Parecer das avaliações nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$ed93_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $ed93_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from pareceraval ";
     $sql .= "      inner join diarioavaliacao  on  diarioavaliacao.ed72_i_codigo = pareceraval.ed93_i_diarioavaliacao";
     ...
     if($dbwhere==""){
       if($ed93_i_codigo!=null ){
         $sql2 .= " where pareceraval.ed93_i_codigo = $ed93_i_codigo ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   function sql_query_file ( $ed93_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
