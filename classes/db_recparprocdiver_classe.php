...
class cl_recparprocdiver { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->procdiver = ($this->procdiver == ""?@$GLOBALS["HTTP_POST_VARS"]["procdiver"]:$this->procdiver);
       $this->receita = ($this->receita == ""?@$GLOBALS["HTTP_POST_VARS"]["receita"]:$this->receita);
     }else{
       $this->procdiver = ($this->procdiver == ""?@$GLOBALS["HTTP_POST_VARS"]["procdiver"]:$this->procdiver);
     }
   }
   // funcao para inclusao
   function incluir ($procdiver){ 
      $this->atualizacampos();
     if($this->receita == null ){ 
       ...
       $this->procdiver = $procdiver; 
     if(($this->procdiver == null) || ($this->procdiver == "") ){ 
       $this->erro_sql = " Campo procdiver nao declarado.";
     ...
     $sql = "insert into recparprocdiver(
                                       procdiver 
                                      ,receita 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->procdiver;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($procdiver=null) { 
      $this->atualizacampos();
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "receita de parcelamento dos diversos nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->procdiver;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "receita de parcelamento dos diversos nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->procdiver;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($procdiver=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($procdiver));
     }else{ 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "receita de parcelamento dos diversos nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$procdiver;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "receita de parcelamento dos diversos nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$procdiver;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $procdiver=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from recparprocdiver ";
     $sql .= "      inner join tabrec      on  tabrec.k02_codigo 				= recparprocdiver.receita";
     $sql .= "      inner join procdiver   on  procdiver.dv09_procdiver = recparprocdiver.procdiver";
     $sql .= "      inner join tabrecjm    on  tabrecjm.k02_codjm       = tabrec.k02_codjm";
     $sql .= "      inner join histcalc    on  histcalc.k01_codigo      = procdiver.dv09_hist";
     $sql .= "      inner join tabrec as t on  t.k02_codigo 		        = procdiver.dv09_receit";
     ...
     if($dbwhere==""){
       if($procdiver!=null ){
         $sql2 .= " where recparprocdiver.procdiver = $procdiver "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
