<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete222025
class cl_balancete222025
{
  ...
  function cl_balancete222025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete222025");
  ...
  function incluir($si189_sequencial)
  {
    ...
    if ($this->si189_tiporegistro == null) {
      $this->erro_sql = " Campo si189_tiporegistro n�o informado.";
    ...
    if ($this->si189_contacontabil == null) {
      $this->erro_sql = " Campo si189_contacontabil n�o informado.";
    ...
    if ($this->si189_atributosf == null) {
      $this->erro_sql = " Campo si189_atributosf n�o informado.";
    ...
    if ($this->si189_codctb == null) {
      $this->erro_sql = " Campo si189_codctb n�o informado.";
    ...
    if ($this->si189_saldoInicialctbsf == null) {
      $this->erro_sql = " Campo si189_saldoInicialctbsf n�o informado.";
    ...
    if ($this->si189_naturezasaldoinicialctbsf == null) {
      $this->erro_sql = " Campo si189_naturezasaldoinicialctbsf n�o informado.";
    ...
    if ($this->si189_totaldebitosctbsf == null) {
      $this->erro_sql = " Campo si189_totaldebitosctbsf n�o informado.";
    ...
    if ($this->si189_totalcreditosctbsf == null) {
      $this->erro_sql = " Campo si189_totalcreditosctbsf n�o informado.";
    ...
    if ($this->si189_saldofinalctbsf == null) {
      $this->erro_sql = " Campo si189_saldofinalctbsf n�o informado.";
    ...
    if ($this->si189_naturezasaldofinalctbsf == null) {
      $this->erro_sql = " Campo si189_naturezasaldofinalctbsf n�o informado.";
    ...
    if ($this->si189_mes == null) {
      $this->erro_sql = " Campo si189_mes n�o informado.";
    ...
    if ($this->si189_instit == null) {
      $this->erro_sql = " Campo si189_instit n�o informado.";
    ...
    $sql = "insert into balancete222025(
                                       si189_sequencial
                                      ,si189_tiporegistro
                                      ,si189_contacontabil
                                      ,si189_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete222025 ($this->si189_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete222025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete222025 ($this->si189_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete222025 set ";
    $virgula = "";
    if (trim($this->si189_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si189_sequencial"])) {
      ...
      if (trim($this->si189_sequencial) == null) {
        $this->erro_sql = " Campo si189_sequencial n�o informado.";
    ...
    if (trim($this->si189_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si189_codfundo"])) {
      ...
      if (trim($this->si189_codfundo) == null) {
        $this->erro_sql = " Campo si189_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete222025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si189_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete222025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si189_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si189_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete222025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si189_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete222025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete222025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si189_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete222025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si189_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete222025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si189_sequencial != null) {
        $sql2 .= " where balancete222025.si189_sequencial = $si189_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
