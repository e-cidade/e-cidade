...
class cl_veicbaixa
{
  ...
  function sql_buscar_detalhes($codigo, $campos = "*")
  {
    ...
    $sql .= " from veicbaixa as vb";
    $sql .= " inner join veiculos as v  on  v.ve01_codigo = vb.ve04_veiculo";
    $sql .= " inner join veiccadtipobaixa as tb  on  tb.ve12_sequencial = vb.ve04_veiccadtipobaixa";
    $sql .= " inner join db_usuarios as u on u.id_usuario = vb.ve04_usuario";
    $sql .= " where ve04_codigo = $codigo";
