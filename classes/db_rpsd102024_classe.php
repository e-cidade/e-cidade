...
class cl_rpsd102024 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("rpsd102024");
  ...
  function incluir ($si189_sequencial) {
     ...
     if ($si189_sequencial == "" || $si189_sequencial == null ) {
       $result = db_query("select nextval('rpsd102024_si189_sequencial_seq')");
       if ($result==false) {
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: rpsd102024_si189_sequencial_seq do campo: si189_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from rpsd102024_si189_sequencial_seq");
     ...
     /*if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco!=false)||($this->numrows!=0)) {
         ...
         $resac = db_query("insert into db_acountkey values($acount,2012024,'$this->si189_sequencial','I')");
         $resac = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,0,'si189_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         ...
         $resac = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,0,'si189_vlpagorsp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,0,'si189_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,0,'si189_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
    }*/
    return true;
  }
     ...
     /*if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows>0) {
         ...
         for($conresaco=0;$conresaco<$this->numrows;$conresaco++) {
           ...
           $acount = pg_result($resac,0,0);
           $resac = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
           $resac = db_query("insert into db_acountkey values($acount,2012024,'$this->si189_sequencial','A')");
           if (isset($GLOBALS["HTTP_POST_VARS"]["si189_sequencial"]) || $this->si189_sequencial != "")
             $resac = db_query("insert into db_acount values($acount,1010202,2012024,'".AddSlashes(pg_result($resaco,$conresaco,'si189_sequencial'))."','$this->si189_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["si189_vlpagorsp"]) || $this->si189_vlpagorsp != "")
             $resac = db_query("insert into db_acount values($acount,1010202,2012024,'".AddSlashes(pg_result($resaco,$conresaco,'si189_vlpagorsp'))."','$this->si189_vlpagorsp',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["si189_mes"]) || $this->si189_mes != "")
             $resac = db_query("insert into db_acount values($acount,1010202,2012024,'".AddSlashes(pg_result($resaco,$conresaco,'si189_mes'))."','$this->si189_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           if (isset($GLOBALS["HTTP_POST_VARS"]["si189_instit"]) || $this->si189_instit != "")
             $resac = db_query("insert into db_acount values($acount,1010202,2012024,'".AddSlashes(pg_result($resaco,$conresaco,'si189_instit'))."','$this->si189_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }*/
     $result = db_query($sql);
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $acount = pg_result($resac,0,0);
           $resac  = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
           $resac  = db_query("insert into db_acountkey values($acount,2012024,'$si189_sequencial','E')");
           $resac  = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,$iresaco,'si189_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           ...
           $resac  = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,$iresaco,'si189_vlpagorsp'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,$iresaco,'si189_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010202,2012024,'','".AddSlashes(pg_result($resaco,$iresaco,'si189_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }*/
     $sql = " delete from rpsd102024
                    where ";
     $sql2 = "";
     if ($dbwhere==null || $dbwhere =="") {
        if ($si189_sequencial != "") {
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:rpsd102024";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si189_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     if ($dbwhere=="") {
       if ($si189_sequencial!=null ) {
         $sql2 .= " where rpsd102024.si189_sequencial = $si189_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
