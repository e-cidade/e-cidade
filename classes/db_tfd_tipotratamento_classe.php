...
class cl_tfd_tipotratamento { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->tf04_i_codigo = ($this->tf04_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["tf04_i_codigo"]:$this->tf04_i_codigo);
       $this->tf04_c_descr = ($this->tf04_c_descr == ""?@$GLOBALS["HTTP_POST_VARS"]["tf04_c_descr"]:$this->tf04_c_descr);
       $this->tf04_c_abreviatura = ($this->tf04_c_abreviatura == ""?@$GLOBALS["HTTP_POST_VARS"]["tf04_c_abreviatura"]:$this->tf04_c_abreviatura);
     }else{
       $this->tf04_i_codigo = ($this->tf04_i_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["tf04_i_codigo"]:$this->tf04_i_codigo);
     }
   }
   // funcao para inclusao
   function incluir ($tf04_i_codigo){ 
      $this->atualizacampos();
     if($this->tf04_c_descr == null ){ 
     ...
     if($this->tf04_c_abreviatura == null ){ 
     ...
     if($tf04_i_codigo == "" || $tf04_i_codigo == null ){
       $result = db_query("select nextval('tfd_tipotratamento_tf04_i_codigo_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tfd_tipotratamento_tf04_i_codigo_seq do campo: tf04_i_codigo"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $tf04_i_codigo)){
         ...
         $this->tf04_i_codigo = $tf04_i_codigo; 
       }
     }
     if(($this->tf04_i_codigo == null) || ($this->tf04_i_codigo == "") ){ 
       $this->erro_sql = " Campo tf04_i_codigo nao declarado.";
     ...
     $sql = "insert into tfd_tipotratamento(
                                       tf04_i_codigo 
                                      ,tf04_c_descr 
                                      ,tf04_c_abreviatura 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->tf04_i_codigo;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($tf04_i_codigo=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($tf04_i_codigo!=null){
       $sql .= " tf04_i_codigo = $this->tf04_i_codigo";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->tf04_i_codigo));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tfd_tipotratamento nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->tf04_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tfd_tipotratamento nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->tf04_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($tf04_i_codigo=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($tf04_i_codigo));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($tf04_i_codigo != ""){
          ...
          $sql2 .= " tf04_i_codigo = $tf04_i_codigo ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "tfd_tipotratamento nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$tf04_i_codigo;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "tfd_tipotratamento nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$tf04_i_codigo;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $tf04_i_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tfd_tipotratamento ";
     $sql2 = "";
     if($dbwhere==""){
       if($tf04_i_codigo!=null ){
         $sql2 .= " where tfd_tipotratamento.tf04_i_codigo = $tf04_i_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
