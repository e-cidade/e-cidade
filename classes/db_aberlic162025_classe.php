<?
//MODULO: sicom
//CLASSE DA ENTIDADE aberlic162025
class cl_aberlic162025
{
  ...
  var $campos = "
                 ...
                 si52_codorgaoresp = varchar(2) = C�digo do �rg�o respons�vel
                 si52_codunidadesubresp = varchar(8) = C�digo da unidade
                 si52_exerciciolicitacao = int8 = Exerc�cio em que   foi instaurado
                 si52_nroprocessolicitatorio = varchar(12) = N�mero sequencial do processo
                 si52_codorgao = varchar(2) = C�digo do �rg�o
                 si52_codunidadesub = varchar(8) = C�digo da unidade
                 si52_codfuncao = varchar(2) = C�digo da fun��o
                 si52_codsubfuncao = varchar(3) = C�digo da   Subfun��o
                 si52_codprograma = varchar(4) = C�digo do   programa
                 si52_idacao = varchar(4) = C�digo que   identifica a A��o
                 si52_idsubacao = varchar(4) = C�digo que   identifica a SubA��o
                 si52_naturezadespesa = int8 = C�digo da   natureza da   despesa
                 si52_codfontrecursos = int8 = C�digo da fonte   de recursos
                 si52_vlrecurso = float8 = Previs�o dos recursos or�ament�rios
                 si52_mes = int8 = M�s
                 si52_reg10 = int8 = reg10
                 si52_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_aberlic162025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("aberlic162025");
  ...
  function incluir($si52_sequencial)
  {
    ...
    if ($si52_sequencial == "" || $si52_sequencial == null) {
      $result = db_query("select nextval('aberlic162025_si52_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: aberlic162025_si52_sequencial_seq do campo: si52_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from aberlic162025_si52_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si52_sequencial)) {
        $this->erro_sql = " Campo si52_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "aberlic162025 ($this->si52_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "aberlic162025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "aberlic162025 ($this->si52_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si52_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic162025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si52_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic162025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si52_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si52_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "aberlic162025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "aberlic162025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si52_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:aberlic162025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si52_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from aberlic162025 ";
    $sql .= "      left  join aberlic102020  on  aberlic102020.si46_sequencial = aberlic162025.si52_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si52_sequencial != null) {
        $sql2 .= " where aberlic162025.si52_sequencial = $si52_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
