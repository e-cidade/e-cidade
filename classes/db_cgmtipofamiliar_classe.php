...
//MODULO: protocolo
//CLASSE DA ENTIDADE cgmtipofamiliar
class cl_cgmtipofamiliar { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->z14_sequencial = ($this->z14_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["z14_sequencial"]:$this->z14_sequencial);
       $this->z14_descricao = ($this->z14_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["z14_descricao"]:$this->z14_descricao);
     }else{
       $this->z14_sequencial = ($this->z14_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["z14_sequencial"]:$this->z14_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($z14_sequencial){ 
      $this->atualizacampos();
     if($this->z14_descricao == null ){ 
       ...
       $this->z14_sequencial = $z14_sequencial; 
     if(($this->z14_sequencial == null) || ($this->z14_sequencial == "") ){ 
       $this->erro_sql = " Campo z14_sequencial nao declarado.";
     ...
     $sql = "insert into cgmtipofamiliar(
                                       z14_sequencial 
                                      ,z14_descricao 
                       )
                values (
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->z14_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     $this->numrows_incluir= pg_affected_rows($result);
     $resaco = $this->sql_record($this->sql_query_file($this->z14_sequencial));
   ...
   function alterar ($z14_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update cgmtipofamiliar set ";
     $virgula = "";
     ...
     $sql .= " where ";
     if($z14_sequencial!=null){
       $sql .= " z14_sequencial = $this->z14_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->z14_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Familiar do CGM nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->z14_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Familiar do CGM nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->z14_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($z14_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($z14_sequencial));
     }else{ 
     ...
     $sql = " delete from cgmtipofamiliar
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($z14_sequencial != ""){
          ...
          $sql2 .= " z14_sequencial = $z14_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Familiar do CGM nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$z14_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Familiar do CGM nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$z14_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:cgmtipofamiliar";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $z14_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from cgmtipofamiliar ";
     $sql2 = "";
     if($dbwhere==""){
       if($z14_sequencial!=null ){
         $sql2 .= " where cgmtipofamiliar.z14_sequencial = $z14_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
