...
class cl_tipoidentificacaocredorgenerica { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->c25_sequencial = ($this->c25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c25_sequencial"]:$this->c25_sequencial);
       $this->c25_tipoidentificacaocredor = ($this->c25_tipoidentificacaocredor == ""?@$GLOBALS["HTTP_POST_VARS"]["c25_tipoidentificacaocredor"]:$this->c25_tipoidentificacaocredor);
       $this->c25_descricao = ($this->c25_descricao == ""?@$GLOBALS["HTTP_POST_VARS"]["c25_descricao"]:$this->c25_descricao);
     }else{
       $this->c25_sequencial = ($this->c25_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["c25_sequencial"]:$this->c25_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($c25_sequencial){ 
      $this->atualizacampos();
     if($this->c25_tipoidentificacaocredor == null ){ 
     ...
     if($c25_sequencial == "" || $c25_sequencial == null ){
       $result = db_query("select nextval('tipoidentificacaocredorgenerica_c25_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: tipoidentificacaocredorgenerica_c25_sequencial_seq do campo: c25_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $c25_sequencial)){
         ...
         $this->c25_sequencial = $c25_sequencial; 
       }
     }
     if(($this->c25_sequencial == null) || ($this->c25_sequencial == "") ){ 
       $this->erro_sql = " Campo c25_sequencial nao declarado.";
     ...
     $sql = "insert into tipoidentificacaocredorgenerica(
                                       c25_sequencial 
                                      ,c25_tipoidentificacaocredor 
                                      ,c25_descricao 
                       )
                values (
                                $this->c25_sequencial 
                               ,$this->c25_tipoidentificacaocredor 
                               ,'$this->c25_descricao' 
                      )";
     $result = db_query($sql); 
     if($result==false){ 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->c25_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($c25_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($c25_sequencial!=null){
       $sql .= " c25_sequencial = $this->c25_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->c25_sequencial));
     if($this->numrows>0){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Identificação do Credor Genérica nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->c25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Identificação do Credor Genérica nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($c25_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($c25_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($c25_sequencial != ""){
          ...
          $sql2 .= " c25_sequencial = $c25_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Tipo de Identificação do Credor Genérica nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$c25_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Tipo de Identificação do Credor Genérica nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$c25_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $c25_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from tipoidentificacaocredorgenerica ";
     $sql .= "      inner join tipoidentificacaocredor  on  tipoidentificacaocredor.c24_sequencial = tipoidentificacaocredorgenerica.c25_tipoidentificacaocredor";
     $sql2 = "";
     if($dbwhere==""){
       if($c25_sequencial!=null ){
         $sql2 .= " where tipoidentificacaocredorgenerica.c25_sequencial = $c25_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
