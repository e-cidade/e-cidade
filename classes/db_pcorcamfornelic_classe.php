...
class cl_pcorcamfornelic { 
   ...
   function incluir ($pc31_orcamforne){ 
     ...
     if($this->pc31_regata == null ){ 
       $this->erro_sql = " Campo Reg. Ata presença nao Informado.";
       $this->erro_campo = "pc31_regata";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->pc31_renunrecurso == null ){ 
       $this->erro_sql = " Campo Renuncia de Recurso nao Informado.";
       $this->erro_campo = "pc31_renunrecurso";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($this->pc31_liclicita == null ){ 
       $this->erro_sql = " Campo Código da Licitação nao Informado.";
       $this->erro_campo = "pc31_liclicita";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "pcorcamfornelic ($this->pc31_orcamforne) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   if(trim($this->pc31_regata)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc31_regata"])){ 
       $sql  .= $virgula." pc31_regata = $this->pc31_regata ";
       $virgula = ",";
       if(trim($this->pc31_regata) == null ){ 
         $this->erro_sql = " Campo Reg. Ata presença nao Informado.";
         $this->erro_campo = "pc31_regata";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->pc31_renunrecurso)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc31_renunrecurso"])){ 
       $sql  .= $virgula." pc31_renunrecurso = $this->pc31_renunrecurso ";
       $virgula = ",";
       if(trim($this->pc31_renunrecurso) == null ){ 
         $this->erro_sql = " Campo Renuncia de Recurso nao Informado.";
         $this->erro_campo = "pc31_renunrecurso";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->pc31_liclicita)!="" || isset($GLOBALS["HTTP_POST_VARS"]["pc31_liclicita"])){ 
       $sql  .= $virgula." pc31_liclicita = $this->pc31_liclicita ";
       $virgula = ",";
       if(trim($this->pc31_liclicita) == null ){ 
         $this->erro_sql = " Campo Código da Licitação nao Informado.";
         $this->erro_campo = "pc31_liclicita";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function excluir ($pc31_orcamforne=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "pcorcamfornelic nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$pc31_orcamforne;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
