...
class cl_orclei { 
   ...
   var $o45_tipolei = 0;
   var $o45_datalei_dia = null; 
   var $o45_datalei_mes = null; 
   var $o45_datalei_ano = null; 
   var $o45_datalei = null;  
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->o45_datalei == ""){
         $this->o45_datalei_dia = ($this->o45_datalei_dia == ""?@$GLOBALS["HTTP_POST_VARS"]["o45_datalei_dia"]:$this->o45_datalei_dia);
         $this->o45_datalei_mes = ($this->o45_datalei_mes == ""?@$GLOBALS["HTTP_POST_VARS"]["o45_datalei_mes"]:$this->o45_datalei_mes);
         $this->o45_datalei_ano = ($this->o45_datalei_ano == ""?@$GLOBALS["HTTP_POST_VARS"]["o45_datalei_ano"]:$this->o45_datalei_ano);
         if($this->o45_datalei_dia != ""){
            $this->o45_datalei = $this->o45_datalei_ano."-".$this->o45_datalei_mes."-".$this->o45_datalei_dia;
         }
       }
     }else{
       $this->o45_codlei = ($this->o45_codlei == ""?@$GLOBALS["HTTP_POST_VARS"]["o45_codlei"]:$this->o45_codlei);
   ...
   function incluir ($o45_codlei){ 
     ...
     $sql = "insert into orclei(
                ...
                values (
                               ...
                               ,$this->o45_tipolei 
                               ,".($this->o45_datalei == "null" || $this->o45_datalei == ""?"null":"'".$this->o45_datalei."'")."
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function alterar ($o45_codlei=null) { 
     ...
     if(trim($this->o45_datalei)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o45_datalei_dia"]) &&  ($GLOBALS["HTTP_POST_VARS"]["o45_datalei_dia"] !="") ){ 
       $sql  .= $virgula." o45_datalei = '$this->o45_datalei' ";
       $virgula = ",";
     }
     $sql .= " where ";
     if($o45_codlei!=null){
