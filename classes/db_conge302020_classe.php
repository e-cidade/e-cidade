<?php
//MODULO: sicom
//CLASSE DA ENTIDADE conge302020
class cl_conge302020 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("conge302020");
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:conge302020";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si184_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from conge302020 ";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si184_sequencial!=null ) {
         $sql2 .= " where conge302020.si184_sequencial = $si184_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
