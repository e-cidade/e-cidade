...
class cl_aidofnumeracao { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->y115_numeracao = ($this->y115_numeracao == ""?@$GLOBALS["HTTP_POST_VARS"]["y115_numeracao"]:$this->y115_numeracao);
     }else{
       $this->y115_numeracao = ($this->y115_numeracao == ""?@$GLOBALS["HTTP_POST_VARS"]["y115_numeracao"]:$this->y115_numeracao);
     }
   }
   // funcao para inclusao
   function incluir ($y115_numeracao){ 
      $this->atualizacampos();
       $this->y115_numeracao = $y115_numeracao; 
     if(($this->y115_numeracao == null) || ($this->y115_numeracao == "") ){ 
       $this->erro_sql = " Campo y115_numeracao nao declarado.";
     ...
     $sql = "insert into aidofnumeracao(
                                       y115_numeracao 
                       )
                values (
                                $this->y115_numeracao 
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->y115_numeracao;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->y115_numeracao  ));
   ...
   function alterar ($y115_numeracao=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($y115_numeracao!=null){
       $sql .= " y115_numeracao = $this->y115_numeracao";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Numeração de Notas nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->y115_numeracao;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Numeração de Notas nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->y115_numeracao;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($y115_numeracao=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($y115_numeracao));
       } else { 
     ...
     $sql = " delete from aidofnumeracao
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($y115_numeracao != ""){
          ...
          $sql2 .= " y115_numeracao = $y115_numeracao ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Numeração de Notas nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$y115_numeracao;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "Numeração de Notas nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$y115_numeracao;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $y115_numeracao=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from aidofnumeracao ";
     $sql2 = "";
     if($dbwhere==""){
       if($y115_numeracao!=null ){
         $sql2 .= " where aidofnumeracao.y115_numeracao = $y115_numeracao "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
