<?
	//MODULO: sicom
	//CLASSE DA ENTIDADE balancete282025
	class cl_balancete282025
	{
		...
		var $campos = "
                 ...
                 si198_contacontabil = int8 = C�digo da Conta Cont�bil
                 si198_codfundo = varchar(8) = C�digo identificador do Fundo
                 si198_codctb = int8 = C�digo identificador da conta
                 si198_codfontrecursos = int8 = C�digo da Fonte
                 ...
                 si198_totaldebitosctbfonte = float8 = Total de d�bitos
                 si198_totalcreditosctbfonte = float8 = Total de cr�ditos
                 si198_saldofinalctbfonte = float8 = Saldo final no m�s
		...
		function cl_balancete282025()
		{
			//classes dos rotulos dos campos
			$this->rotulo = new rotulo("balancete282025");
		...
		function incluir($si198_sequencial)
		{
			...
			if ($this->si198_tiporegistro == null) {
				$this->erro_sql = " Campo si198_tiporegistro n�o informado.";
			...
			if ($this->si198_contacontabil == null) {
				$this->erro_sql = " Campo si198_contacontabil n�o informado.";
			...
			if ($this->si198_tipodocumentoctbfonte == null) {
				$this->erro_sql = " Campo si198_tipodocumentoctbfonte n�o informado.";
			...
			if ($this->si198_nrodocumentoctbfonte == null) {
				$this->erro_sql = " Campo si198_nrodocumentoctbfonte n�o informado.";
			...
			if ($this->si198_atributosf == null) {
				$this->erro_sql = " Campo si198_atributosf n�o informado.";
			...
			if ($this->si198_saldoinicialctbfonte == null) {
				$this->erro_sql = " Campo si198_saldoinicialctbfonte n�o informado.";
			...
			if ($this->si198_naturezasaldoinicialctbfonte == null) {
				$this->erro_sql = " Campo si198_naturezasaldoinicialctbfonte n�o informado.";
			...
			if ($this->si198_totaldebitosctbfonte == null) {
				$this->erro_sql = " Campo si198_totaldebitosctbfonte n�o informado.";
			...
			if ($this->si198_totalcreditosctbfonte == null) {
				$this->erro_sql = " Campo si198_totalcreditosctbfonte n�o informado.";
			...
			if ($this->si198_saldofinalctbfonte == null) {
				$this->erro_sql = " Campo si198_saldofinalctbfonte n�o informado.";
			...
			if ($this->si198_naturezasaldofinalctbfonte == null) {
				$this->erro_sql = " Campo si198_naturezasaldofinalctbfonte n�o informado.";
			...
			if ($this->si198_mes == null) {
				$this->erro_sql = " Campo si198_mes n�o informado.";
			...
			if ($this->si198_instit == null) {
				$this->erro_sql = " Campo si198_instit n�o informado.";
			...
			if ($si198_sequencial == "" || $si198_sequencial == null) {
				$result = db_query("select nextval('balancete282025_si198_sequencial_seq')");
				if ($result == false) {
					$this->erro_banco = str_replace("", "", @pg_last_error());
					$this->erro_sql = "Verifique o cadastro da sequencia: balancete282025_si198_sequencial_seq do campo: si198_sequencial";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "0";
				...
				$result = db_query("select last_value from balancete282025_si198_sequencial_seq");
				if (($result != false) && (pg_result($result, 0, 0) < $si198_sequencial)) {
					$this->erro_sql = " Campo si198_sequencial maior que �ltimo n�mero da sequencia.";
			...
			$sql = "insert into balancete282025(
                                       si198_sequencial
                                      ,si198_tiporegistro
                                      ,si198_contacontabil
                                      ,si198_codfundo
			...
			if ($result == false) {
				...
				if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
					$this->erro_sql = "balancete282025 ($this->si198_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_banco = "balancete282025 j� Cadastrado";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				} else {
					$this->erro_sql = "balancete282025 ($this->si198_sequencial) nao Inclu�do. Inclusao Abortada.";
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
		...
		{
			$this->atualizacampos();
			$sql = " update balancete282025 set ";
			$virgula = "";
			if (trim($this->si198_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si198_sequencial"])) {
				...
				if (trim($this->si198_sequencial) == null) {
					$this->erro_sql = " Campo si198_sequencial n�o informado.";
			...
			if (trim($this->si198_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si198_codfundo"])) {
				...
				if (trim($this->si198_codfundo) == null) {
					$this->erro_sql = " Campo si198_codfundo n�o informado.";
			...
			if (trim($this->si198_codctb) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si198_codctb"])) {
				...
				if (trim($this->si198_codctb) == null) {
					$this->erro_sql = " Campo si198_codctb n�o informado.";
...
", "", @pg_last_error());
				$this->erro_sql = "balancete282025 nao Alterado. Alteracao Abortada.\n";
				$this->erro_sql .= "Valores : " . $this->si198_sequencial;
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "balancete282025 nao foi Alterado. Alteracao Executada.\n";
					$this->erro_sql .= "Valores : " . $this->si198_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
		...
		function excluir($si198_sequencial = null, $dbwhere = null)
		{
			...
			$sql = " delete from balancete282025
                    where ";
			$sql2 = "";
			if ($dbwhere == null || $dbwhere == "") {
				if ($si198_sequencial != "") {
			...
			if ($result == false) {
				$this->erro_banco = str_replace("
", "", @pg_last_error());
				$this->erro_sql = "balancete282025 nao Exclu�do. Exclus�o Abortada.\n";
				...
				if (pg_affected_rows($result) == 0) {
					$this->erro_banco = "";
					$this->erro_sql = "balancete282025 nao Encontrado. Exclus�o n�o Efetuada.\n";
					$this->erro_sql .= "Valores : " . $si198_sequencial;
					$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
					$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
					$this->erro_status = "1";
...
", "", @pg_last_error());
			...
			if ($this->numrows == 0) {
				$this->erro_banco = "";
				$this->erro_sql = "Record Vazio na Tabela:balancete282025";
				$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
				$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
				$this->erro_status = "0";
		...
		function sql_query($si198_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
		{
			...
			$sql .= " from balancete282025 ";
			$sql2 = "";
			if ($dbwhere == "") {
				if ($si198_sequencial != null) {
					$sql2 .= " where balancete282025.si198_sequencial = $si198_sequencial ";
				}
			} else {
				if ($dbwhere != "") {
					$sql2 = " where $dbwhere";
