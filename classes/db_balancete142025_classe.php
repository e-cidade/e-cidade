<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete142025
class cl_balancete142025
{
  ...
  function cl_balancete142025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete142025");
  ...
  function incluir($si181_sequencial)
  {
    ...
    if ($this->si181_tiporegistro == null) {
      $this->erro_sql = " Campo si181_tiporegistro n�o informado.";
    ...
    if ($this->si181_contacontabil == null) {
      $this->erro_sql = " Campo si181_contacontabil n�o informado.";
    ...
    if ($this->si181_codorgao == null) {
      $this->erro_sql = " Campo si181_codorgao n�o informado.";
    ...
    if ($this->si181_codunidadesub == null) {
      $this->erro_sql = " Campo si181_codunidadesub n�o informado.";
    ...
    if ($this->si181_codunidadesuborig == null) {
      $this->erro_sql = " Campo si181_codunidadesuborig n�o informado.";
    ...
    if ($this->si181_codfuncao == null) {
      $this->erro_sql = " Campo si181_codfuncao n�o informado.";
    ...
    if ($this->si181_codsubfuncao == null) {
      $this->erro_sql = " Campo si181_codsubfuncao n�o informado.";
    ...
    if ($this->si181_codprograma == null) {
      $this->erro_sql = " Campo si181_codprograma n�o informado.";
    ...
    if ($this->si181_idacao == null) {
      $this->erro_sql = " Campo si181_idacao n�o informado.";
    ...
    if ($this->si181_naturezadespesa == null) {
      $this->erro_sql = " Campo si181_naturezadespesa n�o informado.";
    ...
    if ($this->si181_subelemento == null) {
      $this->erro_sql = " Campo si181_subelemento n�o informado.";
    ...
    if ($this->si181_codfontrecursos == null) {
      $this->erro_sql = " Campo si181_codfontrecursos n�o informado.";
    ...
    if ($this->si181_nroempenho == null) {
      $this->erro_sql = " Campo si181_nroempenho n�o informado.";
    ...
    if ($this->si181_anoinscricao == null) {
      $this->erro_sql = " Campo si181_anoinscricao n�o informado.";
    ...
    if ($this->si181_saldoinicialrsp == null) {
      $this->erro_sql = " Campo si181_saldoinicialrsp n�o informado.";
    ...
    if ($this->si181_naturezasaldoinicialrsp == null) {
      $this->erro_sql = " Campo si181_naturezasaldoinicialrsp n�o informado.";
    ...
    if ($this->si181_totaldebitosrsp == null) {
      $this->erro_sql = " Campo si181_totaldebitosrsp n�o informado.";
    ...
    if ($this->si181_totalcreditosrsp == null) {
      $this->erro_sql = " Campo si181_totalcreditosrsp n�o informado.";
    ...
    if ($this->si181_saldofinalrsp == null) {
      $this->erro_sql = " Campo si181_saldofinalrsp n�o informado.";
    ...
    if ($this->si181_naturezasaldofinalrsp == null) {
      $this->erro_sql = " Campo si181_naturezasaldofinalrsp n�o informado.";
    ...
    if ($this->si181_mes == null) {
      $this->erro_sql = " Campo si181_mes n�o informado.";
    ...
    if ($this->si181_instit == null) {
      $this->erro_sql = " Campo si181_instit n�o informado.";
    ...
    if ($si181_sequencial == "" || $si181_sequencial == null) {
      $result = db_query("select nextval('balancete142025_si181_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete142025_si181_sequencial_seq do campo: si181_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete142025_si181_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si181_sequencial)) {
        $this->erro_sql = " Campo si181_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete142025(
                                       si181_sequencial
                                      ,si181_tiporegistro
                                      ,si181_contacontabil
                                      ,si181_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete142025 ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete142025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete142025 ($this->si181_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete142025 set ";
    $virgula = "";
    if (trim($this->si181_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si181_sequencial"])) {
      ...
      if (trim($this->si181_sequencial) == null) {
        $this->erro_sql = " Campo si181_sequencial n�o informado.";
    ...
    if (trim($this->si181_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si181_codfundo"])) {
      ...
      if (trim($this->si181_codfundo) == null) {
        $this->erro_sql = " Campo si181_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete142025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si181_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete142025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si181_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si181_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete142025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si181_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete142025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete142025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si181_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete142025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si181_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete142025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si181_sequencial != null) {
        $sql2 .= " where balancete142025.si181_sequencial = $si181_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
