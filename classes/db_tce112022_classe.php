...
class cl_tce112022 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("tce112022");
...
/*     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
  ...
  function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if ($this->numrows==0) {
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:tce112022";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
  ...
  function sql_query ( $si188_sequencial=null,$campos="*",$ordem=null,$dbwhere="") {
     ...
     $sql .= " from tce112022 ";
     $sql .= "      inner join tce112022  on  tce112022.si188_sequencial = tce112022.si188_reg10";
     $sql .= "      inner join tce112022  on  tce112022.si188_sequencial = tce112022.si188_reg10";
     $sql2 = "";
     if ($dbwhere=="") {
       if ($si188_sequencial!=null ) {
         $sql2 .= " where tce112022.si188_sequencial = $si188_sequencial ";
       }
     } else if ($dbwhere != "") {
       $sql2 = " where $dbwhere";
     }
