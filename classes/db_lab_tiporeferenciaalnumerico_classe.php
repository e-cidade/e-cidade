...
class cl_lab_tiporeferenciaalnumerico
{
  ...
  var $campos = "
                 la30_i_codigo = int4 = CÃ³digo
                 la30_i_valorref = int4 = Valor Referencial
                 la30_f_normalmin = float4 = Normal MÃ­nimo
                 la30_f_normalmax = float4 = Normal MÃ¡ximo
                 la30_c_calculavel = char(50) = CalculÃ¡vel
                 la30_f_absurdomin = float4 = Absurdo MÃ­nimo
                 la30_f_absurdomax = float4 = Absurdo MÃ¡ximo
                 la30_casasdecimaisapresentacao = int4 = Casas Decimais para ApresentaÃ§Ã£o
                 ";
  ...
  function incluir($la30_i_codigo)
  {
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Tipo referencial numÃ©rico ($this->la30_i_codigo) nao IncluÃ­do. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Tipo referencial numÃ©rico jÃ¡ Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Tipo referencial numÃ©rico ($this->la30_i_codigo) nao IncluÃ­do. Inclusao Abortada.";
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  public function alterar($la30_i_codigo = null)
  {
    ...
    if (!$result) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Tipo referencial numÃ©rico nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : " . $this->la30_i_codigo;
      $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Tipo referencial numÃ©rico nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : " . $this->la30_i_codigo;
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
  ...
  public function excluir($la30_i_codigo = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Tipo referencial numÃ©rico nao ExcluÃ­do. ExclusÃ£o Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Tipo referencial numÃ©rico nao Encontrado. ExclusÃ£o não Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $la30_i_codigo;
        $this->erro_msg   = "Usuário: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
