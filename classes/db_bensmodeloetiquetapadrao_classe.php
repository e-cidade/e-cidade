...
class cl_bensmodeloetiquetapadrao { 
   ...
   var $campos = "
                 t72_sequencial = int4 = Código 
                 t72_descr = varchar(100) = Descrição 
                 t72_strxml = text = XML 
                 ";
   ...
   function incluir ($t72_sequencial){ 
     ...
     if($t72_sequencial == "" || $t72_sequencial == null ){
       ...
       if(($result != false) && (pg_result($result,0,0) < $t72_sequencial)){
         $this->erro_sql = " Campo t72_sequencial maior que último número da sequencia.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Modelo de Etiqueta dos Bens ($this->t72_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
