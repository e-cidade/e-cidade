...
class cl_ops122025
{
  ...
  var $campos = "
                 ...
                 si134_codreduzidoop = int8 = C�digo  Identificador da  Ordem
                 si134_tipodocumentoop = varchar(2) = Tipo do Documento
                 si134_nrodocumento = varchar(15) = N�mero do  documento
                 si134_codctb = int8 = C�digo Identificador da Conta Banc�ria
                 si134_codfontectb = int8 = C�digo da fonte de recursos
                 si134_dtemissao = date = Data de emiss�o do documento
                 si134_vldocumento = float8 = Valor da OP associado ao documento
                 si134_desctipodocumentoop = varchar(50) = Descri��o
                 si134_mes = int8 = M�s
                 si134_reg10 = int8 = reg10
                 si134_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ops122025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ops122025");
  ...
  function incluir($si134_sequencial)
  {
    ...
    if ($si134_sequencial == "" || $si134_sequencial == null) {
      $result = db_query("select nextval('ops122025_si134_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ops122025_si134_sequencial_seq do campo: si134_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ops122025_si134_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si134_sequencial)) {
        $this->erro_sql = " Campo si134_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ops122025 ($this->si134_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ops122025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "ops122025 ($this->si134_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si134_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops122025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si134_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops122025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si134_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si134_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ops122025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ops122025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si134_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ops122025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
...
function sql_query($si134_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
{
    ...
    $sql .= " from ops122025 ";
    $sql .= " left join ops10{$ano} on ops10{$ano}.si132_sequencial = ops122025.si134_reg10";
    $sql2 = "";
    if ($dbwhere == "") {
        if ($si134_sequencial != null) {
            $sql2 .= " where ops122025.si134_sequencial = $si134_sequencial ";
        }
    } else if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
    }
