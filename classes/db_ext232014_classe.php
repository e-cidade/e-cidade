...
class cl_ext232014 { 
   ...
   var $campos = "
                 ...
                 si127_mes = int8 = Mês 
                 si127_reg22 = int8 = reg22 
                 si127_instit = int8 = Instituição 
                 ";
   //funcao construtor da classe 
   function cl_ext232014() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("ext232014"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si127_reg22 = ($this->si127_reg22 == ""?@$GLOBALS["HTTP_POST_VARS"]["si127_reg22"]:$this->si127_reg22);
   ...
   function incluir ($si127_sequencial){ 
     ...
     if($si127_sequencial == "" || $si127_sequencial == null ){
       $result = db_query("select nextval('ext232014_si127_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: ext232014_si127_sequencial_seq do campo: si127_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from ext232014_si127_sequencial_seq");
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "ext232014 ($this->si127_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "ext232014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "ext232014 ($this->si127_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010356,2010887,'','".AddSlashes(pg_result($resaco,0,'si127_reg22'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
   ...
   function alterar ($si127_sequencial=null) { 
     ...
     if(trim($this->si127_reg22)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si127_reg22"])){ 
        if(trim($this->si127_reg22)=="" && isset($GLOBALS["HTTP_POST_VARS"]["si127_reg22"])){ 
           $this->si127_reg22 = "0" ; 
        } 
       $sql  .= $virgula." si127_reg22 = $this->si127_reg22 ";
       $virgula = ",";
     }
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si127_reg22"]) || $this->si127_reg22 != "")
           $resac = db_query("insert into db_acount values($acount,2010356,2010887,'".AddSlashes(pg_result($resaco,$conresaco,'si127_reg22'))."','$this->si127_reg22',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ext232014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si127_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ext232014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si127_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si127_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010356,2010887,'','".AddSlashes(pg_result($resaco,$iresaco,'si127_reg22'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ext232014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ext232014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si127_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:ext232014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si127_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ext232014 ";
     $sql .= "      left  join ext222014  on  ext222014.si126_sequencial = ext232014.si127_reg22";
     $sql .= "      left  join ext212014  on  ext212014.si125_sequencial = ext222014.si126_reg21";
     $sql2 = "";
     if($dbwhere==""){
       if($si127_sequencial!=null ){
         $sql2 .= " where ext232014.si127_sequencial = $si127_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
