<?
//MODULO: sicom
//CLASSE DA ENTIDADE dfcdcasp402025
class cl_dfcdcasp402025 {
   ...
   function cl_dfcdcasp402025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("dfcdcasp402025");
   ...
   function incluir ($si222_sequencial){
     ...
     if(empty($si222_sequencial)){
       $result = db_query("select nextval('dfcdcasp402025_si222_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: dfcdcasp402025_si222_sequencial_seq do campo: si222_sequencial";
       ...
       $result = db_query("select last_value from dfcdcasp402025_si222_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si222_sequencial)){
         $this->erro_sql = " Campo si222_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into dfcdcasp402025(
                                       si222_anousu
                                      ,si222_periodo
                                      ,si222_instit
                                      ,si222_sequencial
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "dfcdcasp402025 ($this->si222_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "dfcdcasp402025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "dfcdcasp402025 ($this->si222_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si222_sequencial=null) {
     ...
     if(trim($this->si222_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_sequencial"])){
       ...
       if(trim($this->si222_sequencial) == null ){
         $this->erro_sql = " Campo si222_sequencial n�o informado.";
     ...
     if(trim($this->si222_tiporegistro)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_tiporegistro"])){
       ...
       if(trim($this->si222_tiporegistro) == null ){
         $this->erro_sql = " Campo si222_tiporegistro n�o informado.";
     ...
     if(trim($this->si222_vlalienacaobens)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_vlalienacaobens"])){
       ...
       if(trim($this->si222_vlalienacaobens) == null ){
         $this->erro_sql = " Campo si222_vlalienacaobens n�o informado.";
     ...
     if(trim($this->si222_vlamortizacaoemprestimoconcedido)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_vlamortizacaoemprestimoconcedido"])){
       ...
       if(trim($this->si222_vlamortizacaoemprestimoconcedido) == null ){
         $this->erro_sql = " Campo si222_vlamortizacaoemprestimoconcedido n�o informado.";
     ...
     if(trim($this->si222_vloutrosingressos)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_vloutrosingressos"])){
       ...
       if(trim($this->si222_vloutrosingressos) == null ){
         $this->erro_sql = " Campo si222_vloutrosingressos n�o informado.";
     ...
     if(trim($this->si222_vltotalingressosatividainvestiment)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si222_vltotalingressosatividainvestiment"])){
       ...
       if(trim($this->si222_vltotalingressosatividainvestiment) == null ){
         $this->erro_sql = " Campo si222_vltotalingressosatividainvestiment n�o informado.";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp402025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si222_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp402025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si222_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si222_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from dfcdcasp402025
                    where ";
     $sql2 = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "dfcdcasp402025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "dfcdcasp402025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si222_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:dfcdcasp402025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si222_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from dfcdcasp402025 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si222_sequencial!=null ){
         $sql2 .= " where dfcdcasp402025.si222_sequencial = $si222_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
