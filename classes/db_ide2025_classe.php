...
class cl_ide2025
{
  ...
  var $campos = "
                 ...
                 si11_cnpjmunicipio = varchar(14) = cnpjmunicipio Municipio
                 si11_codorgao = varchar(2) = C�digo do Org�o
                 si11_tipoorgao = varchar(2) = Tipo do Org�o
                 si11_exercicioreferencia = int8 = Exerc�cio de  refer�ncia
                 si11_mesreferencia = varchar(2) = M�s de refer�ncia
                 si11_datageracao = date = Data de gera��o
                 si11_codcontroleremessa = varchar(20) = C�digo de controle
                 si11_mes = int8 = M�s
                 si11_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_ide2025(){
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("ide2025");
  ...
  function incluir($si11_sequencial){
    ...
    if ($this->si11_codmunicipio == null){
		$this->erro_sql = " Campo C�digo do Munic�pio nao Informado.";
		$this->erro_campo = "si11_codmunicipio";
		$this->erro_banco = "";
		$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
		$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
		$this->erro_status = "0";
    ...
    if ($this->si11_cnpjmunicipio == null){
	  	$this->erro_sql = " Campo cnpjmunicipio do Munic�pio n�o Informado.";
	 	$this->erro_campo = "si11_cnpjmunicipio";
	 	$this->erro_banco = "";
	 	$this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
	 	$this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
	 	$this->erro_status = "0";
	...
	if ($si11_sequencial == "" || $si11_sequencial == null) {
      $result = db_query("select nextval('ide2025_si11_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: ide2025_si11_sequencial_seq do campo: si11_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from ide2025_si11_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si11_sequencial)) {
        $this->erro_sql = " Campo si11_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "ide2025 ($this->si11_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "ide2025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      }
      else {
        $this->erro_sql = "ide2025 ($this->si11_sequencial) nao Inclu�do. Inclusao Abortada.";
...
//    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ide2025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si11_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ide2025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si11_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
//    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "ide2025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "ide2025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si11_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:ide2025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si11_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si11_sequencial != null) {
        $sql2 .= " where ide2025.si11_sequencial = $si11_sequencial ";
      }
    }
    else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
