<?php
//MODULO: sicom
//CLASSE DA ENTIDADE licobras202024
class cl_licobras202024 {
    ...
    function __construct() {
        ...
        $this->rotulo = new rotulo("licobras202024");
    ...
    function incluir () {
        ...
        if ($this->si196_sequencial == null ) {
            $result = db_query("select nextval('licobras202024_si196_sequencial_seq')");
            if($result==false){
                $this->erro_banco = str_replace("\n","",@pg_last_error());
                $this->erro_sql   = "Verifique o cadastro da sequencia: licobras202024_si196_sequencial_seq do campo: si196_sequencial";
        ...
        $sql = "insert into licobras202024(
                                       si196_sequencial
                                      ,si196_tiporegistro
                                      ,si196_codorgaoresp
    ...
    function excluir ( $si196_sequencial=null ,$dbwhere=null) {
        ...
        $sql = " delete from licobras202024
                    where ";
        $sql2 = "";
    ...
    function sql_record($sql) {
        ...
        if ($this->numrows==0) {
            $this->erro_banco = "";
            $this->erro_sql   = "Record Vazio na Tabela:licobras202024";
            $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
            $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            $this->erro_status = "0";
            return false;
    ...
    function sql_query ( $si196_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
        ...
        $sql .= " from licobras202024 ";
        $sql2 = "";
        if ($dbwhere=="") {
            if ( $si196_sequencial != "" && $si196_sequencial != null) {
                $sql2 = " where licobras202024.si196_sequencial = '$si196_sequencial'";
            }
        } else if ($dbwhere != "") {
            $sql2 = " where $dbwhere";
        }
