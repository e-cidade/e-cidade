...
class cl_empageconcarpeculiar { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->e79_sequencial = ($this->e79_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e79_sequencial"]:$this->e79_sequencial);
       $this->e79_concarpeculiar = ($this->e79_concarpeculiar == ""?@$GLOBALS["HTTP_POST_VARS"]["e79_concarpeculiar"]:$this->e79_concarpeculiar);
       $this->e79_empagemov = ($this->e79_empagemov == ""?@$GLOBALS["HTTP_POST_VARS"]["e79_empagemov"]:$this->e79_empagemov);
     }else{
       $this->e79_sequencial = ($this->e79_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["e79_sequencial"]:$this->e79_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($e79_sequencial){ 
      $this->atualizacampos();
     if($this->e79_empagemov == null ){ 
     ...
     if($e79_sequencial == "" || $e79_sequencial == null ){
       $result = db_query("select nextval('empageconcarpeculiar_e79_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: empageconcarpeculiar_e79_sequencial_seq do campo: e79_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       if(($result != false) && (pg_result($result,0,0) < $e79_sequencial)){
         ...
         $this->e79_sequencial = $e79_sequencial; 
       }
     }
     if(($this->e79_sequencial == null) || ($this->e79_sequencial == "") ){ 
       $this->erro_sql = " Campo e79_sequencial nao declarado.";
     ...
     $sql = "insert into empageconcarpeculiar(
                                       e79_sequencial 
                                      ,e79_concarpeculiar 
                                      ,e79_empagemov 
                       )
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->e79_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
   ...
   function alterar ($e79_sequencial=null) { 
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($e79_sequencial!=null){
       $sql .= " e79_sequencial = $this->e79_sequencial";
     }
     $resaco = $this->sql_record($this->sql_query_file($this->e79_sequencial));
     if($this->numrows>0){
   ...
   function excluir ($e79_sequencial=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($e79_sequencial));
     }else{ 
     ...
     if($dbwhere==null || $dbwhere ==""){
        if($e79_sequencial != ""){
          ...
          $sql2 .= " e79_sequencial = $e79_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){ 
       ...
       $this->erro_sql .= "Valores : ".$e79_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
   ...
   function sql_query ( $e79_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from empageconcarpeculiar ";
     $sql .= "      inner join empagemov  on  empagemov.e81_codmov = empageconcarpeculiar.e79_empagemov";
     $sql .= "      left  join concarpeculiar  on  concarpeculiar.c58_sequencial = empageconcarpeculiar.e79_concarpeculiar";
     $sql .= "      inner join empage  on  empage.e80_codage = empagemov.e81_codage";
     $sql2 = "";
     if($dbwhere==""){
       if($e79_sequencial!=null ){
         $sql2 .= " where empageconcarpeculiar.e79_sequencial = $e79_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
