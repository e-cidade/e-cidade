<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras212025
class cl_cadobras212025 {
  ...
  public $campos = "
                 ...
                 si200_mes = int4 = Mes
                 si200_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("cadobras212025");
  ...
  function incluir () {
    ...
    if ($this->si200_sequencial == null ) {
      $result = db_query("select nextval('cadobras212025_si200_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras212025_si200_sequencial_seq do campo: si200_sequencial";
    ...
    if ($this->si200_dtparalisacao == null ) {
      $this->erro_sql = " Campo dtparalisacao n�o informado.";
    ...
    if ($this->si200_motivoparalisacap == null ) {
      $this->erro_sql = " Campo motivo paralisacao n�o informado.";
    ...
    if($this->si200_motivoparalisacap == "99"){
        if ($this->si200_descoutrosparalisacao == null ) {
            $this->erro_sql = " Campo desc outros paralisacao n�o informado.";
...
//      $this->erro_sql = " Campo dtretomada n�o informado.";
...
//    }
    ...
    $sql = "insert into cadobras212025(
                                       si200_sequencial
                                      ,si200_tiporegistro
                                      ,si200_codorgaoresp
                                      ,si200_codobra
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "detalhamento da paralisacao () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "detalhamento da paralisacao j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "detalhamento da paralisacao () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function excluir ( $si200_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras212025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "detalhamento da paralisacao nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "detalhamento da paralisacao nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras212025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si200_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras212025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si200_sequencial != "" && $si200_sequencial != null) {
        $sql2 = " where cadobras212025.si200_sequencial = '$si200_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
