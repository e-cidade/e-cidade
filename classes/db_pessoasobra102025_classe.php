<?php
//MODULO: sicom
//CLASSE DA ENTIDADE pessoasobra102025
class cl_pessoasobra102025 {
  ...
  public $campos = "
                 ...
                 si194_mes = int4 = Mes
                 si194_instit = int4 = Institui��o
                 ";

  //funcao construtor da classe
  function __construct() {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("pessoasobra102025");
  ...
  function incluir () {
    ...
    if ($this->si194_sequencial == null ) {
      $result = db_query("select nextval('pessoasobra102025_si194_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: pessoasobra102025_si194_sequencial_seq do campo: si194_sequencial";
    ...
    if ($this->si194_tipocadastro == null ) {
      $this->erro_sql = " Campo Tipo Cadastro n�o informado.";
    ...
    $sql = "insert into pessoasobra102025(
                                       si194_sequencial
                                      ,si194_tipodocumento
                                      ,si194_tiporegistro
                                      ,si194_nrodocumento
    ...
    if ($result==false) {
      ...
      if ( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ) {
        $this->erro_sql   = "cadastro pessoas obra () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_banco = "cadastro pessoas obra j� Cadastrado";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      } else {
        $this->erro_sql   = "cadastro pessoas obra () nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
  ...
  function alterar ( $si194_sequencial=null ) {
    $this->atualizacampos();
    $sql = " update pessoasobra102025 set ";
    $virgula = "";
    ...
    if (trim($this->si194_justificativaalteracao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si194_justificativaalteracao"])) {
      ...
      if (trim($this->si194_justificativaalteracao) == null ) {
        $this->erro_sql = " Campo Justificativa Alteracao n�o informado.";
  ...
  function excluir ( $si194_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from pessoasobra102025
                    where ";
    $sql2 = "";
    ...
    if ($result==false) {
      $this->erro_banco = str_replace("\n","",@pg_last_error());
      $this->erro_sql   = "cadastro pessoas obra nao Exclu�do. Exclus�o Abortada.\\n";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result)==0) {
        $this->erro_banco = "";
        $this->erro_sql = "cadastro pessoas obra nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "1";
        $this->numrows_excluir = 0;
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:pessoasobra102025";
      $this->erro_msg   = "Usu�rio: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si194_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from pessoasobra102025 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si194_sequencial != "" && $si194_sequencial != null) {
        $sql2 = " where pessoasobra102025.si194_sequencial = '$si194_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
