...
class cl_orcprojetolei { 
   ...
   var $o138_altpercsuplementacao = 0;
   ...
   var $campos = "
                 ...
                 o138_altpercsuplementacao = Alteração Percentual Suplementação
                 ";
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->o138_altpercsuplementacao = ($this->o138_altpercsuplementacao == ""?@$GLOBALS["HTTP_POST_VARS"]["o138_altpercsuplementacao"]:$this->o138_altpercsuplementacao);
     }else{
       $this->o138_sequencial = ($this->o138_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["o138_sequencial"]:$this->o138_sequencial);
     }
   }
   ...
   function incluir ($o138_sequencial){ 
     ...
     $sql = "insert into orcprojetolei(
                ...
                values (
                               ...
                               ,$this->o138_instit 
                               ,'$this->o138_textolei' 
                               ,$this->o138_altpercsuplementacao
                      )";
     $result = db_query($sql); 
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
