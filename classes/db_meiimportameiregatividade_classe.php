...
//MODULO: ISSQN
//CLASSE DA ENTIDADE meiimportameiregatividade
class cl_meiimportameiregatividade { 
   ...
   function cl_meiimportameiregatividade() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("meiimportameiregatividade"); 
   ...
   function incluir ($q106_sequencial){ 
     ...
     if($q106_sequencial == "" || $q106_sequencial == null ){
       $result = db_query("select nextval('meiimportameiregatividade_q106_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: meiimportameiregatividade_q106_sequencial_seq do campo: q106_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from meiimportameiregatividade_q106_sequencial_seq");
     ...
     $sql = "insert into meiimportameiregatividade(
                                       q106_sequencial 
                                      ,q106_cnae 
                                      ,q106_descricao 
                                      ,q106_principal 
   ...
   function alterar ($q106_sequencial=null) { 
      $this->atualizacampos();
     $sql = " update meiimportameiregatividade set ";
     $virgula = "";
   ...
   function excluir ($q106_sequencial=null,$dbwhere=null) { 
     ...
     $sql = " delete from meiimportameiregatividade
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($q106_sequencial != ""){
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:meiimportameiregatividade";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $q106_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from meiimportameiregatividade ";
     $sql2 = "";
     if($dbwhere==""){
       if($q106_sequencial!=null ){
         $sql2 .= " where meiimportameiregatividade.q106_sequencial = $q106_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
