<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos202025
class cl_contratos202025 {
   ...
   var $si87_exerciciocontrato = null;
   var $si87_mes = 0;
   var $si87_instit = 0;
   ...
   var $campos = "
                 ...
                 si87_codaditivo = int8 = C�digo do Termo  Aditivo
                 si87_codorgao = varchar(2) = C�digo do �rg�o
                 si87_codunidadesub = varchar(8) = C�digo da unidade
                 si87_nrocontrato = int8 = N�mero do  Contrato Original
                 si87_dtassinaturacontoriginal = date = Data da assinatura  do Contrato
                 si87_nroseqtermoaditivo = varchar(2) = N�mero sequencial do Termo Aditivo
                 si87_dtassinaturatermoaditivo = date = Data da assinatura  do Termo Aditivo
                 si87_tipoalteracaovalor = int8 = Tipo de altera��o  de valor
                 si87_tipotermoaditivo = varchar(2) = Tipo de Termo de  Aditivo
                 si87_dscalteracao = varchar(250) = Descri��o da  altera��o
                 si87_novadatatermino = date = Nova Data de  T�rmino
                 si87_valoraditivo = float8 = Valor do Termo  Aditivo
                 si87_datapublicacao = date = Data da Publica��o
                 si87_veiculodivulgacao = varchar(50) = Ve�culo de  Divulga��o
                 si87_percentualreajuste = float8 = Percentual do Reajuste;
                 si87_indiceunicoreajuste = int8 = Indice do Reajuste;
                 si87_descricaoreajuste = varchar(300) - Descru��o do Reajuste;
                 si87_descricaoindice = varchar(300) = Descri��o do Indice;
                 si87_criterioreajuste = int = Criterio Reajuste;
                 si87_exerciciocontrato = int = Exercicio Contrato;
                 si87_mes = int8 = M�s
                 si87_instit = int8 = Institui��o
                 si87_codunidadesubatual = varchar(8) = C�digo Unidade Sub Atual;
                 ";
   //funcao construtor da classe
   function cl_contratos202025() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos202025");
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si87_exerciciocontrato = ($this->si87_exerciciocontrato == "" ? @$GLOBALS["HTTP_POST_VARS"]["si87_exerciciocontrato"] : $this->si87_exerciciocontrato);
     }else{
       $this->si87_sequencial = ($this->si87_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["si87_sequencial"]:$this->si87_sequencial);
     }
   }
   ...
   function incluir ($si87_sequencial){
     ...
     if($si87_sequencial == "" || $si87_sequencial == null ){
       $result = db_query("select nextval('contratos202025_si87_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("
","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos202025_si87_sequencial_seq do campo: si87_sequencial";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos202025_si87_sequencial_seq");
       if(($result != false) && (pg_result($result,0,0) < $si87_sequencial)){
         $this->erro_sql = " Campo si87_sequencial maior que �ltimo n�mero da sequencia.";
     ...
     $sql = "insert into contratos202025(
                                       si87_sequencial
                                      ,si87_tiporegistro
                                      ,si87_codaditivo
                                      ,si87_codorgao
                ...
                values (
                               ...
                               ,". ($this->si87_exerciciocontrato == "null" || $this->si87_exerciciocontrato == "" ? "null" : $this->si87_exerciciocontrato ). "
                      )";
     $result = db_query($sql);
    // print_r($sql);
     if($result==false){
...
","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos202025 ($this->si87_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos202025 j� Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos202025 ($this->si87_sequencial) nao Inclu�do. Inclusao Abortada.";
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si87_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos202025 set ";
     $virgula = "";
     ...
     if(trim($this->si87_percentualreajuste)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si87_percentualreajuste"])){
      $sql  .= $virgula." si87_percentualreajuste = '$this->si87_percentualreajuste' ";
      $virgula = ",";
    }
    if(trim($this->si87_indiceunicoreajuste)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si87_indiceunicoreajuste"])){
    ...
    if(trim($this->si87_descricaoindice)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si87_descricaoindice"])){
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si87_percentualreajuste"]) || $this->si87_percentualreajuste != "")
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos202025 nao Alterado. Alteracao Abortada.\n";
         $this->erro_sql .= "Valores : ".$this->si87_sequencial;
       $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos202025 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si87_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si87_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos202025
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si87_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("
","",@pg_last_error());
       $this->erro_sql   = "contratos202025 nao Exclu�do. Exclus�o Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si87_sequencial;
         $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
...
","",@pg_last_error());
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos202025";
        $this->erro_msg   = "Usu�rio: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
