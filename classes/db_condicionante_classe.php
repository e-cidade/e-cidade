...
class cl_condicionante {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->am10_tipolicenca = ($this->am10_tipolicenca == ""?@$GLOBALS["HTTP_POST_VARS"]["am10_tipolicenca"]:$this->am10_tipolicenca);
     }else{
       $this->am10_sequencial = ($this->am10_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["am10_sequencial"]:$this->am10_sequencial);
     }
   }
   ...
   function incluir ($am10_sequencial = null){
     ...
     if(($this->am10_sequencial == null) || ($this->am10_sequencial == "") ){
       $this->erro_sql = " Campo am10_sequencial nao declarado.";
     ...
     if (is_null($this->am10_tipolicenca) || $this->am10_tipolicenca == 0) {
      $this->am10_tipolicenca = "null";
     }
     $sql = "insert into condicionante(
                ...
                values (
                               ...
                               ,'$this->am10_descricao'
                               ,'$this->am10_padrao'
                               ,$this->am10_tipolicenca
                      )";
     $result = db_query($sql);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "Condicionante ($this->am10_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acount values($acount,3751,20849,'','".AddSlashes(pg_result($resaco,0,'am10_tipolicenca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   }
   ...
   public function alterar ($am10_sequencial=null) {
     ...
     if(trim($this->am10_tipolicenca)!="" || isset($GLOBALS["HTTP_POST_VARS"]["am10_tipolicenca"])){
        if(trim($this->am10_tipolicenca)=="" && isset($GLOBALS["HTTP_POST_VARS"]["am10_tipolicenca"])){
           $this->am10_tipolicenca = "0" ;
        }
       $sql  .= $virgula." am10_tipolicenca = $this->am10_tipolicenca ";
       $virgula = ",";
     }
     $sql .= " where ";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($this->numrows > 0) {
         ...
         for ($conresaco = 0; $conresaco < $this->numrows; $conresaco++) {
           ...
           if (isset($GLOBALS["HTTP_POST_VARS"]["am10_tipolicenca"]) || $this->am10_tipolicenca != "")
             $resac = db_query("insert into db_acount values($acount,3751,20849,'".AddSlashes(pg_result($resaco,$conresaco,'am10_tipolicenca'))."','$this->am10_tipolicenca',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     $result = db_query($sql);
     if (!$result) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Condicionante nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->am10_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Condicionante nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->am10_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function excluir ($am10_sequencial=null,$dbwhere=null) {
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $resac  = db_query("insert into db_acount values($acount,3751,20849,'','".AddSlashes(pg_result($resaco,$iresaco,'am10_tipolicenca'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
     ...
     if ($result == false) {
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "Condicionante nao Excluído. Exclusão Abortada.\\n";
       ...
       if (pg_affected_rows($result) == 0) {
         $this->erro_banco = "";
         $this->erro_sql = "Condicionante nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$am10_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   public function sql_query ($am10_sequencial = null,$campos = "*", $ordem = null, $dbwhere = "") {
     ...
     $sql .= "      left  join tipolicenca  on  tipolicenca.am09_sequencial = condicionante.am10_tipolicenca";
     $sql2 = "";
     if (empty($dbwhere)) {
       if (!empty($am10_sequencial)) {
