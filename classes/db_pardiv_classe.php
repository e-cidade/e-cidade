...
class cl_pardiv { 
   ...
   function incluir ($v04_instit){ 
     ...
     if($this->v04_peticaoinicial == null ){ 
       $this->erro_sql = " Campo Modelo de petição inicial nao Informado.";
     ...
     if($this->v04_ordemendcda == null ){ 
       $this->erro_sql = " Campo Ordem do endereço na CDA nao Informado.";
     ...
     if($this->v04_histjuros == null ){ 
       $this->erro_sql = " Campo Histórico de cálculo dos juros nao Informado.";
     ...
     if($this->v04_envolcdaiptu == null ){ 
       $this->erro_sql = " Campo Envolvidos na CDA (Imóvel) nao Informado.";
     ...
     if($this->v04_envolcdaiss == null ){ 
       $this->erro_sql = " Campo Envolvidos na CDA (Empresa) nao Informado.";
     ...
     if($this->v04_envolprinciptu == null ){ 
       $this->erro_sql = " Campo Imprimir Somente Principais nao Informado.";
     ...
     if($this->v04_imphistcda == null ){ 
       $this->erro_sql = " Campo Imprimir Histórico/Observações na CDA nao Informado.";
     ...
     if($this->v04_implivrofolha == null ){ 
       $this->erro_sql = " Campo Imprime Livro/Folha na CDA nao Informado.";
     ...
     if($this->v04_confexpfalec == null ){ 
       $this->erro_sql = " Campo Utilizar Expressão antes do Nome p/ Falecidos nao Informado.";
     ...
     if($this->v04_formgeracda == null ){ 
       $this->erro_sql = " Campo Forma de Geração de CDA nao Informado.";
     ...
     if(($this->v04_instit == null) || ($this->v04_instit == "") ){ 
       $this->erro_sql = " Campo v04_instit nao declarado.";
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "parametros da divida ($this->v04_instit) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
   ...
   function alterar ($v04_instit=null) { 
      $this->atualizacampos();
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parametros da divida nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->v04_instit;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parametros da divida nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->v04_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($v04_instit=null,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parametros da divida nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parametros da divida nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$v04_instit;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   // funcao do sql 
   function sql_query ( $v04_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $v04_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
