...
class cl_orcparametro {
    ...
    function incluir ($o50_anousu){
        ...
        if($result==false){
            ...
            if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
                ...
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_banco = "Parâmetros do Orçamento já Cadastrado";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
            }else{
                $this->erro_sql   = "Parâmetros do Orçamento ($this->o50_anousu) nao Incluído. Inclusao Abortada.";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
    ...
    function alterar ($o50_anousu=null) {
        ...
        /*OC2785*/
        if(trim($this->o50_controlafote1017)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o50_controlafote1017"])){
            $sql  .= $virgula." o50_controlafote1017 = '$this->o50_controlafote1017' ";
            $virgula = ",";
            if(trim($this->o50_controlafote1017) == null ){
                $this->erro_sql = " Campo Motivo Suplementação não informado.";
                $this->erro_campo = "o50_controlafote1017";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "0";
        ...
        if(trim($this->o50_controlafote10011006)!="" || isset($GLOBALS["HTTP_POST_VARS"]["o50_controlafote10011006"])){
            $sql  .= $virgula." o50_controlafote10011006 = '$this->o50_controlafote10011006' ";
            $virgula = ",";
            if(trim($this->o50_controlafote10011006) == null ){
                $this->erro_sql = " Campo Motivo Suplementação não informado.";
                $this->erro_campo = "o50_motivosuplementacao";
                $this->erro_banco = "";
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        ...
        if($result==false){
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "Parâmetros do Orçamento nao foi Alterado. Alteracao Executada.\\n";
                $this->erro_sql .= "Valores : ".$this->o50_anousu;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
    ...
    function excluir ($o50_anousu=null,$dbwhere=null) {
        ...
        if($result==false){
            ...
            if(pg_affected_rows($result)==0){
                $this->erro_banco = "";
                $this->erro_sql = "Parâmetros do Orçamento nao Encontrado. Exclusão não Efetuada.\\n";
                $this->erro_sql .= "Valores : ".$o50_anousu;
                $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
                $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
                $this->erro_status = "1";
