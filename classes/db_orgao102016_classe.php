<?
//MODULO: sicom
//CLASSE DA ENTIDADE orgao102016
class cl_orgao102016 { 
   ...
   function cl_orgao102016() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("orgao102016"); 
   ...
   function incluir ($si14_sequencial){ 
     ...
     if($si14_sequencial == "" || $si14_sequencial == null ){
       $result = db_query("select nextval('orgao102016_si14_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: orgao102016_si14_sequencial_seq do campo: si14_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from orgao102016_si14_sequencial_seq");
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:orgao102016";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si14_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from orgao102016 ";
     $sql2 = "";
     if($dbwhere==""){
       if($si14_sequencial!=null ){
         $sql2 .= " where orgao102016.si14_sequencial = $si14_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
