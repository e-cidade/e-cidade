<?
//MODULO: sicom
//CLASSE DA ENTIDADE contratos112023
class cl_contratos112023 {
   ...
   function cl_contratos112023() {
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("contratos112023");
   ...
   function incluir ($si84_sequencial){
     ...
     if($si84_sequencial == "" || $si84_sequencial == null ){
       $result = db_query("select nextval('contratos112023_si84_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: contratos112023_si84_sequencial_seq do campo: si84_sequencial";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from contratos112023_si84_sequencial_seq");
     ...
     $sql = "insert into contratos112023(
                                       si84_sequencial
                                      ,si84_tiporegistro
                                      ,si84_codcontrato
                                      ,si84_coditem
     ...
     if($result==false){
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "contratos112023 ($this->si84_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_banco = "contratos112023 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       }else{
         $this->erro_sql   = "contratos112023 ($this->si84_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
   ...
   function alterar ($si84_sequencial=null) {
      $this->atualizacampos();
     $sql = " update contratos112023 set ";
     $virgula = "";
     ...
     if($result==false){
       $this->erro_banco = str_replace("","",@pg_last_error());
       $this->erro_sql   = "contratos112023 nao Alterado. Alteracao Abortada.\n";
       $this->erro_sql .= "Valores : ".$this->si84_sequencial;
       $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos112023 nao foi Alterado. Alteracao Executada.\n";
         $this->erro_sql .= "Valores : ".$this->si84_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function excluir ($si84_sequencial=null,$dbwhere=null) {
     ...
     $sql = " delete from contratos112023
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si84_sequencial != ""){
     ...
     if($result==false){
       $this->erro_banco = str_replace("","",@pg_last_error());
       $this->erro_sql   = "contratos112023 nao Excluído. Exclusão Abortada.\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "contratos112023 nao Encontrado. Exclusão não Efetuada.\n";
         $this->erro_sql .= "Valores : ".$si84_sequencial;
         $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) {
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:contratos112023";
        $this->erro_msg   = "Usuário: \n\n ".$this->erro_sql." \n\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \n\n ".$this->erro_banco." \n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si84_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from contratos112023 ";
     $sql .= "      left  join contratos102023  on  contratos102023.si83_sequencial = contratos112023.si84_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si84_sequencial!=null ){
         $sql2 .= " where contratos112023.si84_sequencial = $si84_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
