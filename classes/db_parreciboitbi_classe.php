...
//MODULO: itbi
//CLASSE DA ENTIDADE parreciboitbi
class cl_parreciboitbi { 
   ...
   var $campos = "
                 it17_numcgm = int4 = Numcgm 
                 it17_codigo = int4 = codigo da receita 
                 ";
   //funcao construtor da classe 
   function cl_parreciboitbi() { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->it17_numcgm = ($this->it17_numcgm == ""?@$GLOBALS["HTTP_POST_VARS"]["it17_numcgm"]:$this->it17_numcgm);
       $this->it17_codigo = ($this->it17_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["it17_codigo"]:$this->it17_codigo);
     }else{
     }
   }
   ...
   function alterar ( $oid=null ) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parametros do recibo de itbi nao Alterado. Alteracao Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parametros do recibo de itbi nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_alterar = 0;
   ...
   function excluir ( $oid=null ,$dbwhere=null) { 
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "parametros do recibo de itbi nao Excluído. Exclusão Abortada.\\n";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "parametros do recibo de itbi nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
         $this->numrows_excluir = 0;
   ...
   function sql_query ( $oid = null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from parreciboitbi ";
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = parreciboitbi.it17_numcgm";
