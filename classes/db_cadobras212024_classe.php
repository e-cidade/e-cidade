<?php
//MODULO: sicom
//CLASSE DA ENTIDADE cadobras212024
class cl_cadobras212024 {
  ...
  function __construct() {
    ...
    $this->rotulo = new rotulo("cadobras212024");
  ...
  function incluir () {
    ...
    if ($this->si200_sequencial == null ) {
      $result = db_query("select nextval('cadobras212024_si200_sequencial_seq')");
      if($result==false){
        $this->erro_banco = str_replace("\n","",@pg_last_error());
        $this->erro_sql   = "Verifique o cadastro da sequencia: cadobras212024_si200_sequencial_seq do campo: si200_sequencial";
...
//    }
    ...
    $sql = "insert into cadobras212024(
                                       si200_sequencial
                                      ,si200_tiporegistro
                                      ,si200_codorgaoresp
                                      ,si200_codobra
  ...
  function excluir ( $si200_sequencial=null ,$dbwhere=null) {
    ...
    $sql = " delete from cadobras212024
                    where ";
    $sql2 = "";
  ...
  function sql_record($sql) {
    ...
    if ($this->numrows==0) {
      $this->erro_banco = "";
      $this->erro_sql   = "Record Vazio na Tabela:cadobras212024";
      $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
      $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
      $this->erro_status = "0";
      return false;
  ...
  function sql_query ( $si200_sequencial = null,$campos="*",$ordem=null,$dbwhere="") {
    ...
    $sql .= " from cadobras212024 ";
    $sql2 = "";
    if ($dbwhere=="") {
      if ( $si200_sequencial != "" && $si200_sequencial != null) {
        $sql2 = " where cadobras212024.si200_sequencial = '$si200_sequencial'";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
