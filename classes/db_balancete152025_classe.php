<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete152025
class cl_balancete152025
{
  ...
  function cl_balancete152025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete152025");
  ...
  function incluir($si182_sequencial)
  {
    ...
    if ($this->si182_tiporegistro == null) {
      $this->erro_sql = " Campo si182_tiporegistro n�o informado.";
    ...
    if ($this->si182_contacontabil == null) {
      $this->erro_sql = " Campo si182_contacontabil n�o informado.";
    ...
    if ($this->si182_atributosf == null) {
      $this->erro_sql = " Campo si182_atributosf n�o informado.";
    ...
    if ($this->si182_saldoinicialsf == null) {
      $this->erro_sql = " Campo si182_saldoinicialsf n�o informado.";
    ...
    if ($this->si182_naturezasaldoinicialsf == null) {
      $this->erro_sql = " Campo si182_naturezasaldoinicialsf n�o informado.";
    ...
    if ($this->si182_totaldebitossf == null) {
      $this->erro_sql = " Campo si182_totaldebitossf n�o informado.";
    ...
    if ($this->si182_totalcreditossf == null) {
      $this->erro_sql = " Campo si182_totalcreditossf n�o informado.";
    ...
    if ($this->si182_saldofinalsf == null) {
      $this->erro_sql = " Campo si182_saldofinalsf n�o informado.";
    ...
    if ($this->si182_naturezasaldofinalsf == null) {
      $this->erro_sql = " Campo si182_naturezasaldofinalsf n�o informado.";
    ...
    if ($this->si182_mes == null) {
      $this->erro_sql = " Campo si182_mes n�o informado.";
    ...
    if ($this->si182_instit == null) {
      $this->erro_sql = " Campo si182_instit n�o informado.";
    ...
    if ($si182_sequencial == "" || $si182_sequencial == null) {
      $result = db_query("select nextval('balancete152025_si182_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: balancete152025_si182_sequencial_seq do campo: si182_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from balancete152025_si182_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si182_sequencial)) {
        $this->erro_sql = " Campo si182_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into balancete152025(
                                       si182_sequencial
                                      ,si182_tiporegistro
                                      ,si182_contacontabil
                                      ,si182_codfundo
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete152025 ($this->si182_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete152025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete152025 ($this->si182_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete152025 set ";
    $virgula = "";
    if (trim($this->si182_sequencial) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si182_sequencial"])) {
      ...
      if (trim($this->si182_sequencial) == null) {
        $this->erro_sql = " Campo si182_sequencial n�o informado.";
    ...
    if (trim($this->si182_codfundo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["si182_codfundo"])) {
      ...
      if (trim($this->si182_codfundo) == null) {
        $this->erro_sql = " Campo si182_codfundo n�o informado.";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete152025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si182_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete152025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si182_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si182_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete152025
                    where ";
    $sql2 = "";
    if ($dbwhere == null || $dbwhere == "") {
      if ($si182_sequencial != "") {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete152025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete152025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si182_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:balancete152025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si182_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from balancete152025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si182_sequencial != null) {
        $sql2 .= " where balancete152025.si182_sequencial = $si182_sequencial ";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
