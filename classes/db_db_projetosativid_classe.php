...
class cl_db_projetosativid { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->at62_cor = ($this->at62_cor == ""?@$GLOBALS["HTTP_POST_VARS"]["at62_cor"]:$this->at62_cor);
     }else{
       $this->at62_codigo = ($this->at62_codigo == ""?@$GLOBALS["HTTP_POST_VARS"]["at62_codigo"]:$this->at62_codigo);
     }
   }
   ...
   function incluir ($at62_codigo){ 
     ...
     if($at62_codigo == "" || $at62_codigo == null ){
       $result = db_query("select nextval('db_projetoscadgrupos_at62_codigo_seq')"); 
       if($result==false){
     ...
     $sql = "insert into db_projetosativid(
                                       at62_codigo 
                                      ,at62_descr 
                                      ,at62_cor 
                       )
   ...
   function sql_query ( $at62_codigo=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from db_projetosativid ";
     $sql2 = "";
     if($dbwhere==""){
       if($at62_codigo!=null ){
         $sql2 .= " where db_projetosativid.at62_codigo = $at62_codigo "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
