...
class cl_configuracaoged {
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       $this->db141_sequencial = ($this->db141_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db141_sequencial"]:$this->db141_sequencial);
       $this->db141_ativo = ($this->db141_ativo == "f"?@$GLOBALS["HTTP_POST_VARS"]["db141_ativo"]:$this->db141_ativo);
       $this->db141_webserviceuri = ($this->db141_webserviceuri == ""?@$GLOBALS["HTTP_POST_VARS"]["db141_webserviceuri"]:$this->db141_webserviceuri);
       $this->db141_webservicelocation = ($this->db141_webservicelocation == ""?@$GLOBALS["HTTP_POST_VARS"]["db141_webservicelocation"]:$this->db141_webservicelocation);
     }else{
       $this->db141_sequencial = ($this->db141_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["db141_sequencial"]:$this->db141_sequencial);
     }
   }
   // funcao para inclusao
   function incluir ($db141_sequencial){
      $this->atualizacampos();
     if($this->db141_ativo == null ){
     ...
     if($db141_sequencial == "" || $db141_sequencial == null ){
       $result = db_query("select nextval('configuracaoged_db141_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: configuracaoged_db141_sequencial_seq do campo: db141_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       if(($result != false) && (pg_result($result,0,0) < $db141_sequencial)){
         ...
         $this->db141_sequencial = $db141_sequencial;
       }
     }
     if(($this->db141_sequencial == null) || ($this->db141_sequencial == "") ){
       $this->erro_sql = " Campo db141_sequencial nao declarado.";
     ...
     $sql = "insert into configuracaoged(
                                       db141_sequencial
                                      ,db141_ativo
                                      ,db141_webserviceuri
                                      ,db141_webservicelocation
                       )
                values (
                                $this->db141_sequencial
                               ,'$this->db141_ativo'
                               ,'$this->db141_webserviceuri'
                               ,'$this->db141_webservicelocation'
                      )";
     $result = db_query($sql);
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
     ...
     $this->erro_sql = "Inclusao efetuada com Sucesso\\n";
         $this->erro_sql .= "Valores : ".$this->db141_sequencial;
     $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
     $this->erro_status = "1";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       $resaco = $this->sql_record($this->sql_query_file($this->db141_sequencial  ));
   ...
   function alterar ($db141_sequencial=null) {
      $this->atualizacampos();
     ...
     $sql .= " where ";
     if($db141_sequencial!=null){
       $sql .= " db141_sequencial = $this->db141_sequencial";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "configuracaoged nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->db141_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "configuracaoged nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->db141_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($db141_sequencial=null,$dbwhere=null) {
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($db141_sequencial));
       } else {
     ...
     $sql = " delete from configuracaoged
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($db141_sequencial != ""){
          ...
          $sql2 .= " db141_sequencial = $db141_sequencial ";
        }
     }else{
       $sql2 = $dbwhere;
     }
     ...
     if($result==false){
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "configuracaoged nao Excluído. Exclusão Abortada.\\n";
       $this->erro_sql .= "Valores : ".$db141_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "configuracaoged nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$db141_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_query ( $db141_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= " from configuracaoged ";
     $sql2 = "";
     if($dbwhere==""){
       if($db141_sequencial!=null ){
         $sql2 .= " where configuracaoged.db141_sequencial = $db141_sequencial ";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
