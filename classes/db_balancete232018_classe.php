<?
//MODULO: sicom
//CLASSE DA ENTIDADE balancete232018
class cl_balancete232018
{
  ...
  function cl_balancete232018()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("balancete232018");
  ...
  function incluir()
  {
    ...
    $sql = "insert into balancete232018(
                                       si190_sequencial 
                                      ,si190_tiporegistro 
                                      ,si190_contacontabil 
                                      ,si190_codfundo 
                ...
                values (
                                nextval('balancete232018_si190_sequencial_seq')
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "balancete232018 () nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "balancete232018 já Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "balancete232018 () nao Incluído. Inclusao Abortada.";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
  ...
  {
    $this->atualizacampos();
    $sql = " update balancete232018 set ";
    $virgula = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete232018 nao Alterado. Alteracao Abortada.\n";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete232018 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si190_sequencial = null, $dbwhere = null)
  {
    ...
    $sql = " delete from balancete232018
                    where ";
    $sql2 = "";
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "balancete232018 nao Excluído. Exclusão Abortada.\n";
      $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "balancete232018 nao Encontrado. Exclusão não Efetuada.\n";
        $this->erro_msg = "Usuário: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
";
  ...
  // funcao do sql
  function sql_query($oid = null, $campos = "balancete232018.oid,*", $ordem = null, $dbwhere = "")
  {
    $sql = "select ";
    if ($campos != "*") {
    ...
    $sql .= " from balancete232018 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($oid != "" && $oid != null) {
        $sql2 = " where balancete232018.oid = $oid";
      }
    } else {
      if ($dbwhere != "") {
        $sql2 = " where $dbwhere";
