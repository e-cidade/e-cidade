...
class cl_ext142014 { 
   ...
   var $campos = "
                 ...
                 si128_mes = int8 = Mês 
                 si128_reg10 = int8 = reg10 
                 ";
   //funcao construtor da classe 
   function cl_ext142014() { 
     //classes dos rotulos dos campos
     $this->rotulo = new rotulo("ext142014"); 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->si128_reg10 = ($this->si128_reg10 == ""?@$GLOBALS["HTTP_POST_VARS"]["si128_reg10"]:$this->si128_reg10);
     }else{
       $this->si128_sequencial = ($this->si128_sequencial == ""?@$GLOBALS["HTTP_POST_VARS"]["si128_sequencial"]:$this->si128_sequencial);
     }
   }
   ...
   function incluir ($si128_sequencial){ 
     ...
     if($this->si128_codreduzidoop == null ){ 
       $this->erro_sql = " Campo Código  Identificador da  Ordem nao Informado.";
     ...
     if($this->si128_tiporetencao == null ){ 
       $this->erro_sql = " Campo Tipo de Retenção nao Informado.";
     ...
     if($this->si128_vlretencao == null ){ 
       $this->erro_sql = " Campo Valor da retenção nao Informado.";
     ...
     if($this->si128_reg10 == null ){ 
       $this->erro_sql = " Campo reg10 nao Informado.";
       $this->erro_campo = "si128_reg10";
       $this->erro_banco = "";
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
     ...
     if($si128_sequencial == "" || $si128_sequencial == null ){
       $result = db_query("select nextval('ext142014_si128_sequencial_seq')"); 
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: ext142014_si128_sequencial_seq do campo: si128_sequencial"; 
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false; 
       ...
       $result = db_query("select last_value from ext142014_si128_sequencial_seq");
     ...
     if($result==false){ 
       ...
       if( strpos(strtolower($this->erro_banco),"duplicate key") != 0 ){
         $this->erro_sql   = "ext142014 ($this->si128_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_banco = "ext142014 já Cadastrado";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       }else{
         $this->erro_sql   = "ext142014 ($this->si128_sequencial) nao Incluído. Inclusao Abortada.";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,2010357,2010895,'','".AddSlashes(pg_result($resaco,0,'si128_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($si128_sequencial=null) { 
     ...
     if(trim($this->si128_sequencial)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si128_sequencial"])){ 
       ...
       $virgula = ",";
       if(trim($this->si128_sequencial) == null ){ 
         $this->erro_sql = " Campo sequencial nao Informado.";
         $this->erro_campo = "si128_sequencial";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->si128_codreduzidoop)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si128_codreduzidoop"])){ 
       ...
       $virgula = ",";
       if(trim($this->si128_codreduzidoop) == null ){ 
         $this->erro_sql = " Campo Código  Identificador da  Ordem nao Informado.";
         $this->erro_campo = "si128_codreduzidoop";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si128_tiporetencao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si128_tiporetencao"])){ 
       ...
       $virgula = ",";
       if(trim($this->si128_tiporetencao) == null ){ 
         $this->erro_sql = " Campo Tipo de Retenção nao Informado.";
         $this->erro_campo = "si128_tiporetencao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si128_vlretencao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si128_vlretencao"])){ 
       ...
       $virgula = ",";
       if(trim($this->si128_vlretencao) == null ){ 
         $this->erro_sql = " Campo Valor da retenção nao Informado.";
         $this->erro_campo = "si128_vlretencao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if(trim($this->si128_reg10)!="" || isset($GLOBALS["HTTP_POST_VARS"]["si128_reg10"])){ 
       $sql  .= $virgula." si128_reg10 = $this->si128_reg10 ";
       $virgula = ",";
       if(trim($this->si128_reg10) == null ){ 
         $this->erro_sql = " Campo reg10 nao Informado.";
         $this->erro_campo = "si128_reg10";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["si128_reg10"]) || $this->si128_reg10 != "")
           $resac = db_query("insert into db_acount values($acount,2010357,2010895,'".AddSlashes(pg_result($resaco,$conresaco,'si128_reg10'))."','$this->si128_reg10',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ext142014 nao Alterado. Alteracao Abortada.\\n";
         $this->erro_sql .= "Valores : ".$this->si128_sequencial;
       $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
       $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
       $this->erro_status = "0";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ext142014 nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->si128_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function excluir ($si128_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,2010357,2010895,'','".AddSlashes(pg_result($resaco,$iresaco,'si128_reg10'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $sql = " delete from ext142014
                    where ";
     $sql2 = "";
     if($dbwhere==null || $dbwhere ==""){
        if($si128_sequencial != ""){
     ...
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
       $this->erro_sql   = "ext142014 nao Excluído. Exclusão Abortada.\\n";
       ...
       if(pg_affected_rows($result)==0){
         $this->erro_banco = "";
         $this->erro_sql = "ext142014 nao Encontrado. Exclusão não Efetuada.\\n";
         $this->erro_sql .= "Valores : ".$si128_sequencial;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
   ...
   function sql_record($sql) { 
     ...
     $this->numrows = pg_numrows($result);
      if($this->numrows==0){
        $this->erro_banco = "";
        $this->erro_sql   = "Record Vazio na Tabela:ext142014";
        $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
        $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
        $this->erro_status = "0";
        return false;
   ...
   function sql_query ( $si128_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= " from ext142014 ";
     $sql .= "      inner join ext102014  on  ext102014.si124_sequencial = ext142014.si128_reg10";
     $sql2 = "";
     if($dbwhere==""){
       if($si128_sequencial!=null ){
         $sql2 .= " where ext142014.si128_sequencial = $si128_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
