...
class cl_idedcasp2017 {
   ...
   function incluir ($si200_sequencial){
     ...
     if(empty($si200_sequencial)){
       $result = db_query("select nextval('idedcasp2017_si200_sequencial_seq')");
       if($result==false){
         $this->erro_banco = str_replace("\n","",@pg_last_error());
         $this->erro_sql   = "Verifique o cadastro da sequencia: idedcasp2017_si200_sequencial_seq do campo: si200_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = db_query("select last_value from idedcasp2017_si200_sequencial_seq");
