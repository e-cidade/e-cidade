...
class cl_conv202025
{
  ...
  var $campos = "
                 ...
                 si94_codorgao = varchar(2) = C�digo do �rg�o
                 si94_nroconvenio = varchar(30) = N�mero do  Conv�nio Original
                 si94_dtassinaturaconvoriginal = date = Data da assinatura  do Conv�nio
                 si94_nroseqtermoaditivo = varchar(2) = N�mero sequencial do Termo Aditivo
                 si94_codconvaditivo = varchar(20) = C�digo Conv�nio Aditivo
                 si94_dscalteracao = varchar(500) = Descri��o da  altera��o
                 si94_dtassinaturatermoaditivo = date = Data da assinatura  do Termo Aditivo
                 si94_datafinalvigencia = date = Data final da  vig�ncia do  conv�nio
                 si94_valoratualizadoconvenio = float8 = Valor atualizado do  Conv�nio
                 si94_valoratualizadocontrapartida = float8 = Valor atualizado da  Contrapartida
                 si94_mes = int8 = M�s
                 si94_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_conv202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("conv202025");
  ...
  function incluir($si94_sequencial)
  {
    ...
    if ($si94_sequencial == "" || $si94_sequencial == null) {
      $result = db_query("select nextval('conv202025_si94_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: conv202025_si94_sequencial_seq do campo: si94_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from conv202025_si94_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si94_sequencial)) {
        $this->erro_sql = " Campo si94_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "conv202025 ($this->si94_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "conv202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "conv202025 ($this->si94_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
...
//    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "conv202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si94_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "conv202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si94_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
//    }
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "conv202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "conv202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si94_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:conv202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si94_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    if ($dbwhere == "") {
      if ($si94_sequencial != null) {
        $sql2 .= " where conv202025.si94_sequencial = $si94_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
