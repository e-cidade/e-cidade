<?
//MODULO: sicom
//CLASSE DA ENTIDADE homolic202025
class cl_homolic202025
{
  ...
  var $campos = "
                 ...
                 si64_codorgao = varchar(2) = C�digo do �rg�o
                 si64_codunidadesub = varchar(8) = C�digo da unidade
                 si64_exerciciolicitacao = int8 = Exerc�cio em que foi instaurado
                 si64_nroprocessolicitatorio = varchar(12) = N�mero sequencial  do processo
                 si64_tipodocumento = int8 = Tipo de documento
                 si64_nrodocumento = varchar(14) = N�mero do  documento
                 si64_nrolote = int8 = N�mero do Lote
                 si64_coditem = varchar(15) = C�digo do item
                 si64_percdesconto = float8 = Percentual do  desconto
                 si64_mes = int8 = M�s
                 si64_instit = int8 = Institui��o
                 ";

  //funcao construtor da classe
  function cl_homolic202025()
  {
    //classes dos rotulos dos campos
    $this->rotulo = new rotulo("homolic202025");
  ...
  function incluir($si64_sequencial)
  {
    ...
    if ($si64_sequencial == "" || $si64_sequencial == null) {
      $result = db_query("select nextval('homolic202025_si64_sequencial_seq')");
      if ($result == false) {
        $this->erro_banco = str_replace("
", "", @pg_last_error());
        $this->erro_sql = "Verifique o cadastro da sequencia: homolic202025_si64_sequencial_seq do campo: si64_sequencial";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "0";
      ...
      $result = db_query("select last_value from homolic202025_si64_sequencial_seq");
      if (($result != false) && (pg_result($result, 0, 0) < $si64_sequencial)) {
        $this->erro_sql = " Campo si64_sequencial maior que �ltimo n�mero da sequencia.";
...
", "", @pg_last_error());
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql = "homolic202025 ($this->si64_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_banco = "homolic202025 j� Cadastrado";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      } else {
        $this->erro_sql = "homolic202025 ($this->si64_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
  ...
  function alterar($si64_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "homolic202025 nao Alterado. Alteracao Abortada.\n";
      $this->erro_sql .= "Valores : " . $this->si64_sequencial;
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "homolic202025 nao foi Alterado. Alteracao Executada.\n";
        $this->erro_sql .= "Valores : " . $this->si64_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
  ...
  function excluir($si64_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("
", "", @pg_last_error());
      $this->erro_sql = "homolic202025 nao Exclu�do. Exclus�o Abortada.\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "homolic202025 nao Encontrado. Exclus�o n�o Efetuada.\n";
        $this->erro_sql .= "Valores : " . $si64_sequencial;
        $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
        $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
        $this->erro_status = "1";
...
", "", @pg_last_error());
    ...
    if ($this->numrows == 0) {
      $this->erro_banco = "";
      $this->erro_sql = "Record Vazio na Tabela:homolic202025";
      $this->erro_msg = "Usu�rio: \n\n " . $this->erro_sql . " \n\n";
      $this->erro_msg .= str_replace('"', "", str_replace("'", "", "Administrador: \n\n " . $this->erro_banco . " \n"));
      $this->erro_status = "0";
  ...
  function sql_query($si64_sequencial = null, $campos = "*", $ordem = null, $dbwhere = "")
  {
    ...
    $sql .= " from homolic202025 ";
    $sql2 = "";
    if ($dbwhere == "") {
      if ($si64_sequencial != null) {
        $sql2 .= " where homolic202025.si64_sequencial = $si64_sequencial ";
      }
    } else if ($dbwhere != "") {
      $sql2 = " where $dbwhere";
    }
