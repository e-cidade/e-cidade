      ...
      <div class="input">
        ...
        <select id="departamentos" name="departamentos">
          <?php foreach ($this->departamentos as $departamento) : ?>
            <option <?php if ($departamento['coddepto'] == $this->departamento) {
                      echo 'selected';
      ...
      <div class="input">
        ...
        <select id="exercicios" name="exercicios" class="chosen-select">
          <?php foreach ($this->exercicios as $exercicio) : ?>
            <option <?php if ($exercicio == $this->exercicio && !isset($this->dataSistemaAno) || isset($this->dataSistemaAno) && $this->dataSistemaAno == $exercicio) {
                      echo 'selected';
      ...
      <?php if (!empty($this->dataSistema)) : ?>
        ...
        <div class="input">
          ...
          <script type="text/javascript">
            var CurrentWindow = window.frameElement.CurrentWindow.parent;
          </script>
  ...
  <script type="text/javascript">
    ...
    (function($, global) {
      ...
      var alert = alertify.alert,
        CurrentWindow = parent.CurrentWindow || window.frameElement.CurrentWindow;
      ...
      $('form').on('submit', function(e) {
        ...
        if ($("#data").val() == '') {
          alert('Data do sistema n�o informada.');
          return false;
        }
