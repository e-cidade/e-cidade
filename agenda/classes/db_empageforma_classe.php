...
class cl_empageforma { 
   ...
   function incluir ($e96_codigo){ 
     ...
     if($e96_codigo == "" || $e96_codigo == null ){
       $result = @pg_query("select nextval('empageforma_e96_codigo_seq')"); 
       if($result==false){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7015,'$this->e96_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1156,7015,'','".AddSlashes(pg_result($resaco,0,'e96_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1156,7016,'','".AddSlashes(pg_result($resaco,0,'e96_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function excluir ($e96_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7015,'$e96_codigo','E')");
         $resac = pg_query("insert into db_acount values($acount,1156,7015,'','".AddSlashes(pg_result($resaco,$iresaco,'e96_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1156,7016,'','".AddSlashes(pg_result($resaco,$iresaco,'e96_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
