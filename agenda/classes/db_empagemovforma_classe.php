...
//     echo "<BR><BR>$sql";		      
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7017,'$this->e97_codmov','I')");
       $resac = pg_query("insert into db_acount values($acount,1157,7017,'','".AddSlashes(pg_result($resaco,0,'e97_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1157,7018,'','".AddSlashes(pg_result($resaco,0,'e97_codforma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($e97_codmov=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7017,'$this->e97_codmov','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e97_codmov"]))
           $resac = pg_query("insert into db_acount values($acount,1157,7017,'".AddSlashes(pg_result($resaco,$conresaco,'e97_codmov'))."','$this->e97_codmov',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["e97_codforma"]))
           $resac = pg_query("insert into db_acount values($acount,1157,7018,'".AddSlashes(pg_result($resaco,$conresaco,'e97_codforma'))."','$this->e97_codforma',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($e97_codmov=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7017,'$e97_codmov','E')");
         $resac = pg_query("insert into db_acount values($acount,1157,7017,'','".AddSlashes(pg_result($resaco,$iresaco,'e97_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1157,7018,'','".AddSlashes(pg_result($resaco,$iresaco,'e97_codforma'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
