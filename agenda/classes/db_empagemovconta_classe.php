...
//echo "<BR><BR>$sql";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7100,'$this->e98_codmov','I')");
       $resac = pg_query("insert into db_acount values($acount,1175,7100,'','".AddSlashes(pg_result($resaco,0,'e98_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1175,7101,'','".AddSlashes(pg_result($resaco,0,'e98_contabanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function excluir ($e98_codmov=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7100,'$e98_codmov','E')");
         $resac = pg_query("insert into db_acount values($acount,1175,7100,'','".AddSlashes(pg_result($resaco,$iresaco,'e98_codmov'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1175,7101,'','".AddSlashes(pg_result($resaco,$iresaco,'e98_contabanco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
