...
class cl_empagegera { 
   ...
   function incluir ($e87_codgera){ 
     ...
     if($e87_codgera == "" || $e87_codgera == null ){
       $result = @pg_query("select nextval('empagegera_e87_codgera_seq')"); 
       if($result==false){
...
//		      echo "<BR><BR>".$sql;
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6194,'$this->e87_codgera','I')");
       $resac = pg_query("insert into db_acount values($acount,1002,6194,'','".AddSlashes(pg_result($resaco,0,'e87_codgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1002,6195,'','".AddSlashes(pg_result($resaco,0,'e87_descgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1002,6196,'','".AddSlashes(pg_result($resaco,0,'e87_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1002,6197,'','".AddSlashes(pg_result($resaco,0,'e87_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1002,7235,'','".AddSlashes(pg_result($resaco,0,'e87_dataproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function excluir ($e87_codgera=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6194,'$e87_codgera','E')");
         $resac = pg_query("insert into db_acount values($acount,1002,6194,'','".AddSlashes(pg_result($resaco,$iresaco,'e87_codgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1002,6195,'','".AddSlashes(pg_result($resaco,$iresaco,'e87_descgera'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1002,6196,'','".AddSlashes(pg_result($resaco,$iresaco,'e87_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1002,6197,'','".AddSlashes(pg_result($resaco,$iresaco,'e87_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1002,7235,'','".AddSlashes(pg_result($resaco,$iresaco,'e87_dataproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
