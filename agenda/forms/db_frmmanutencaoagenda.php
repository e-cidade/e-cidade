    ...
    for (var iNotas = 0; iNotas < oResponse.aNotasLiquidacao.length; iNotas++) {
      ...
      with (oResponse.aNotasLiquidacao[iNotas]) {
         ...
         var nValor =  e81_valor;
          ...
          aLinha[7]   = js_createComboContasForne(aContasFornecedor, e98_contabanco, e81_codmov, z01_numcgm, lDisabled);
          ...
          gridNotas.aRows[iRowAtiva].aCells[6].sEvents  = "onmouseover='js_setAjuda(\""+z01_nome.urlDecode()+"\",true)'";
