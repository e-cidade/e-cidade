contrato = function () {
    ...
    this.mostraLicitacoesContratado = function(oResponse)  {
        ...
        oGridDados.setHeader(new Array("Código","Número", "Objeto", "Número do Exerccício", "Data da Inclusão"));
        ...
        if(iReajuste==0){
            ...
            if(iCriterioreajuste==1){
                if(iIndicereajuste==0){
                    alert("Usuário: Campo Indice de Reajuste não informado.");
                    $('ac16_indicereajuste').focus();
                    return false;
                }
                if(iIndicereajuste==6){
                    if(sDescricaoindice==""){
                        alert("Usuário: Campo Descrição do indice não informado.");
