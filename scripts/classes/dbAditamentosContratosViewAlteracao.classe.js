function dbViewAlteracaoAditamentoContrato(iTipoAditamento, sNomeInstance, oNode, Assinatura) {
  ...
  this.main = function () {
    ...
    if (me.lTipoAlteracao) {
      ...
      me.oCboTipoAditivo.addEvent("onChange", me.sInstance + ".pesquisarDadosAcordo();" + me.sInstance + ".js_changeTipoAditivo();" + me.sInstance + ".ocultaDescricaoAlteracao();" + me.sInstance + ".exibicaocamposreajuste();");
  ...
  this.lidaDadosAlteracao = (aditamento) => {
    ...
    $('oCboTipoAditivo').style.cssText = me.desativaInputsCss;
