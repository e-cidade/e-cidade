...
if ($imprimevalidmin=="true"){
  ...
  $this->objpdf->rect($xcol+140,$xlin+$getdoy,43,6,2,'DF','12');
}
...
// Caixa das marcas
if ($imprimevalidmin=="true"){
$this->objpdf->rect($xcol+140,$xlin+$getdoy+6,43,$alturaini,2,'DF','34');
}else{
$this->objpdf->rect($xcol+140,$xlin+$getdoy+6,43,$alturaini,2,'DF','34');
}
...
if ($imprimevalidmin=="true"){
  ...
  $this->objpdf->text($xcol+ 147,$xlin+$getdoy+4,'MARCA');
}
if ($imprimevalidmin=="true"){
...
//         $this->objpdf->rect($xcol+138,$xlin+54,26,($linha-25),2,'DF','34');
      ...
      // Label das colunas
         ...
         if ($imprimevalidmin=="true"){
          $this->objpdf->text($xcol+ 134,$xlin+58,'MARCA');
         }else{
         $this->objpdf->text($xcol+ 147,$xlin+58,'MARCA');
         }

         if ($imprimevalidmin=="true"){
           $this->objpdf->text($xcol+ 154,$xlin+58,'VALIDAD. MIN.');
         }
