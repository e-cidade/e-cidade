...
if (($this->qtdcarne % 3 ) == 0 ){
  ...
  $this->objpdf->Rect(178,$top,24,7,'DF');
  $this->objpdf->Text(179,$top+3,"Contrato PMP - ECT ");
  $this->objpdf->Text(183,$top+6,"9912297820");*/
  ...
  // $this->objpdf->Text(187,$top+11,substr($this->descr3_1, 0, 100));
  $this->objpdf->Rect(116,$top+12,20,6,'DF');
  $this->objpdf->Text(117,$top+14.2,"CÓDIGO PESSOA");
  $this->objpdf->Rect(136,$top+12,21,6,'DF');
  $this->objpdf->Text(138,$top+14.2,"CÓDIGO IMÓVEL");
  $this->objpdf->Rect(157,$top+12,45,6,'DF');
  $this->objpdf->Text(158,$top+14.2,"INSCRIÇÃO IMOBILIÁRIA");
  ...
  $this->objpdf->Text(84,$top+28,"FRAÇÃO IDEAL");
  ...
  $this->objpdf->SetFont('Arial','',6);
  $this->objpdf->Text(12,$top+34,"ALÍQUOTA CONSTR.");
  $this->objpdf->Text(37,$top+34,"ÁREA CONSTRUÍDA");
  $this->objpdf->Text(62,$top+34,"FATOR");
  $this->objpdf->Text(84,$top+34,"TESTADA");
  $this->objpdf->Text(109,$top+34,"VLR. M2 CONST.");
  $this->objpdf->Text(133,$top+34,"VALOR CONSTRUÇÃO");
