...
$this->objpdf->text($xcol+109,$xlin+21,$this->labtipo);
...
$this->objpdf->text($xcol+141,$xlin+ 13,':  '.$this->orcprazo);
$this->objpdf->text($xcol+141,$xlin+ 17,':  '.$this->orcvalidade);
...
$esp="";
if(strlen($Sresumo) > 50){
	$esp = "...";
}
$this->objpdf->multicell(175,4,substr(stripslashes($Sresumo),0,50).$esp,0,"J");
//$this->objpdf->multicell(80,4,stripslashes($Sresumo),0,"J");
...
$this->objpdf->Setfont('Arial','B',8);
$this->objpdf->text($xcol+2,$xlin+54,'Observações :');
$this->objpdf->setxy($xcol+24.5,$xlin+50);
$posini = $this->objpdf->gety();
$this->objpdf->multicell(175,5,substr(trim(stripslashes($this->orcobs)),0,839),0,"J");
$setaut = $this->objpdf->gety();
$this->objpdf->rect($xcol,$xlin+50,$xcol+198,$setaut-$posini,2,'DF','1234');
...
$maiscol = 0;
$this->objpdf->SetWidths(array(12,15,19,70,26,23,19,19));
...
// Caixa externa
      ...
      // Caixas dos label's
         ...
         $this->objpdf->rect($xcol+ 24,$xlin+54,18,6,2,'DF','12');
         $this->objpdf->rect($xcol+ 42,$xlin+54,70,6,2,'DF','12');
         $this->objpdf->rect($xcol+112,$xlin+54,26,6,2,'DF','12');
         ...
         $this->objpdf->rect($xcol+ 24,$xlin+54,18,($linha-25),2,'DF','34');
         $this->objpdf->rect($xcol+ 42,$xlin+54,70,($linha-25),2,'DF','34');
         $this->objpdf->rect($xcol+112,$xlin+54,26,($linha-25),2,'DF','34');
      ...
      // Label das colunas
         ...
         $this->objpdf->text($xcol+  26,$xlin+58,'UNIDADE');
         $this->objpdf->text($xcol+  56,$xlin+58,'MATERIAL OU SERVIÇO');
         $this->objpdf->text($xcol+ 119,$xlin+58,'MARCA');
         $this->objpdf->text($xcol+ 139,$xlin+58,'VALIDAD. MINIMA');
...
$this->objpdf->rect($xcol,    $linha,138,10,2,'DF','34');
$this->objpdf->rect($xcol+138,$linha, 26,10,2,'DF','34');
