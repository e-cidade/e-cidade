...
//	$this->objpdf->text(40,$xlin- 7,$this->municpref);
  ...
  $this->objpdf->sety($xlin+24);
	...
	$this->objpdf->rect($xcol+ 12,$xlin+24,19,6,2,'DF','12');
	$this->objpdf->rect($xcol+ 31,$xlin+24,13,6,2,'DF','12');//$this->objpdf->rect($xcol+ 27,$xlin+24,11,6,2,'DF','12');
	$this->objpdf->rect($xcol+ 44,$xlin+24,99,6,2,'DF','12');//$this->objpdf->rect($xcol+ 38,$xlin+24,104,6,2,'DF','12');
	...
	$this->objpdf->rect($xcol+ 12,$xlin+30,19,205  -$xlin ,2,'DF','34');
	$this->objpdf->rect($xcol+ 31,$xlin+30,13,205  -$xlin ,2,'DF','34'); //$this->objpdf->rect($xcol+ 27,$xlin+30,11,205  -$xlin ,2,'DF','34');
	$this->objpdf->rect($xcol+ 44,$xlin+30,99,205 -$xlin ,2,'DF','34'); //$this->objpdf->rect($xcol+ 38,$xlin+30,104,205 -$xlin ,2,'DF','34');
  ...
  $iVoltaImp = 0;
    ...
    /////// troca de pagina
      ...
      $this->objpdf->rect($xcol    ,$xlin+54,12,6,2,'DF','12');
	    ...
	    $this->objpdf->rect($xcol+ 44,$xlin+54,99,6,2,'DF','12'); //$this->objpdf->rect($xcol+ 38,$xlin+54,104,6,2,'DF','12');
	    ...
	    $this->objpdf->rect($xcol+ 12,$xlin+60,19,252,2,'DF','34');
	    $this->objpdf->rect($xcol+ 31,$xlin+60,13,252,2,'DF','34'); //$this->objpdf->rect($xcol+ 27,$xlin+60,11,252,2,'DF','34');
	...
	if(@pg_numrows($resItemTabela) > 0){
		...
		for($contitem=0;$contitem < @pg_numrows($resItemTabela);$contitem++){
			...
			//// troca de pagina
			if (($posi > $this->objpdf->h + 50 && $pagina == 1)
				|| ($posi > $this->objpdf->h + 300 && $pagina != 1)
			) {
    ...
    if (isset($texto2) && trim($texto2) != ""){
	  ...
	  $this->objpdf->rect($xcol+ 44,$xlin+312,99,10,2,'DF','34'); //$this->objpdf->rect($xcol+ 38,$xlin+312,104,10,2,'DF','34');
