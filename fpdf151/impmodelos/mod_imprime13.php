...
for ($ii = 0; $ii < $this->linhasdositens; $ii++) {
    ...
    if ($volta_impressao == 0) {
        if ($reservado == "t") {
            $this->objpdf->Row(array(
                ...
                $unid,
                stripslashes('[ITEM ME/EPP] ' . $descricaoitem) . "\n",
                '',
                '',
                '',
                '',
    ...
    if ((isset($resumo) && $resumo != "" && $volta_impressao == 0) || $volta_impressao == 1) {
        ...
        $resumo = $this->objpdf->Row_multicell(
            array('', '', '', stripslashes($resumo), '', ''),
            $dist,
            false,
            5,
            0,
    ...
    if ((isset($prazo) && $prazo != "" && $volta_impressao == 0) || $volta_impressao == 2) {
        $volta_impressao = 0;
        $prazo = $this->objpdf->Row_multicell(
            array('', '', '', stripslashes($prazo), '', ''),
            $dist,
            false,
            5,
            0,
    ...
    if ((isset($pgto) && $pgto != "" && $volta_impressao == 0) || $volta_impressao == 3) {
        $volta_impressao = 0;
        $pgto = $this->objpdf->Row_multicell(
            array('', '', '', stripslashes($pgto), '', ''),
            $dist,
            false,
            5,
            0,
