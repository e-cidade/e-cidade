...
$this->objpdf->Text($coluna,$linha+9,'DADOS GERAIS:'); // inscricao
...
$this->objpdf->SetFont('Arial','B',13);
$this->objpdf->Cell(135,9,"DADOS DA BAIXA: ",0,0,"L",0) ; // descrição da atividade principal

$fWidthDescAtiv = 175;
$iMaxCaracDescAtiv = 65;

$this->objpdf->Cell(24,9,"",0,0,"C",0);
$this->objpdf->Cell(24,9,"",0,1,"C",0);
...
$this->objpdf->setx(15);
$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Cell(60,6,"NÚMERO: ",0,0,"L",0) ; // descrição da atividade principal
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Cell(100,6,$this->numerobaixa,0,1,"L",0);
$this->objpdf->setx(15);
$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Cell(60,6,"PROCESSO: ",0,0,"L",0) ; // descrição da atividade principal
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Cell(100,6,$this->processobaixa,0,1,"L",0);
$this->objpdf->setx(15);
$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Cell(60,6,"DATA: ",0,0,"L",0) ; // descrição da atividade principal
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Cell(100,6,db_formatar($this->dtbaixa,'d'),0,1,"L",0);
$this->objpdf->setx(15);
$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Cell(60,6,"OBSERVAÇÃO: ",0,0,"L",0) ; // descrição da atividade principal
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Cell(100,6,$this->obsbaixa,0,1,"L",0);


/*
$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Text($fWidthDescAtiv,$fWidthDescAtiv+45,"NÚMERO: "); // 
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Text($fWidthDescAtiv + 60,$fWidthDescAtiv+45,$this->bairropri);

$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Text($coluna,$linha+45,"PROCESSO: "); // 
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Text($coluna + 60,$linha+45,$this->bairropri);

$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Text($coluna,$linha+45,"DATA: "); // 
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Text($coluna + 60,$linha+45,$this->bairropri);

$this->objpdf->SetFont('Arial','B',$fonte);
$this->objpdf->Text($coluna,$linha+45,"OBSERVAÇÃO: "); // 
$this->objpdf->SetFont('Arial','',$fonte);
$this->objpdf->Text($coluna + 60,$linha+45,$this->bairropri);
*/
...
if ($num_outras >0) {
  ...
  $this->objpdf->SetFont('Arial','B',13);
  $this->objpdf->Cell(135,5,"ATIVIDADE" . ($num_outras > 1?"S":"") . ":",0,0,"L",0);
  if ($this->impdatas == 't'){
