...
<script>
 ...
 window.open("teste002.php?nome=teste&titulo="+titulo+"&finalidade="+finalidade+"&limite="+limite+"&visualizacao="+visualizacao+"&veri=res","Relatório","toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,directories=no,status=no");
 }
</script>
<br>
...
<form name="form1" method="post">
 ...
 <tr > 
   ...
   <td>select r13_codigo,r13_descr,r13_descro from lotacao where r13_anousu = 2005 and r13_mesusu = 3 order by r13_codigo</td>
 </tr> 
 <tr> 
   <td height="35"><b>Titulo:</b></td>
   <td><input type="text" name="titulo" value="teste"></td>
 </tr> 
 <tr> 
   <td height="35"><b>Finalidade:</b></td>
   <td><input type="text" name="finalidade" value="teste"></td>
 <tr> 
