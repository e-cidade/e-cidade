...
<form name="form1" method="post">
 ...
 <tr > 
   ...
   <td>select arrehist.* from arrehist inner join arrepaga on arrepaga.k00_numpre = arrehist.k00_numpre where k00_histtxt like '%TP08%' </td>
 </tr> 
 <tr> 
   <td height="35"><b>Titulo:</b></td>
   <td><input type="text" name="titulo" value="Relatório"></td>
 </tr> 
 <tr> 
   <td height="35"><b>Finalidade:</b></td>
   <td><input type="text" name="finalidade" value="Relatório"></td>
 <tr> 
   ...
   <td><input  type="text" name="limite" value="100"></td>
 </tr> 
 <tr>
