...
<script>
 ...
 window.open("autorizacao_requisicao002.php?nome=autorizacao_requisicao&titulo="+titulo+"&finalidade="+finalidade+"&limite="+limite+"&visualizacao="+visualizacao+"&veri=res","Relatório","toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,directories=no,status=no");
 }
</script>
<br>
...
and e54_numsol=0</td>
 ...
 <tr> 
   ...
   <td><input type="text" name="titulo" value="autorizacao_requisicao"></td>
 </tr> 
 <tr> 
   <td height="35"><b>Finalidade:</b></td>
   <td><input type="text" name="finalidade" value="gerar relatorio de autorizacao de empenho"></td>
 <tr> 
