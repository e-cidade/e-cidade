...
<script>
 ...
 window.open(".002.php?nome=.&titulo="+titulo+"&finalidade="+finalidade+"&limite="+limite+"&visualizacao="+visualizacao+"&veri=res","Relatório","toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,directories=no,status=no");
 }
</script>
<br>
...
from rhpessoal
     ...
     inner join rhlota       on rhpessoalmov.rh02_lota = rhlota.r70_codigo
     inner join rhregime      on rhpessoalmov.rh02_codreg = rhregime.rh30_codreg

where rh02_anousu = 2007
  and rh02_mesusu = 03
  and rh05_recis is null


order by z01_nome</td>
 </tr> 
 <tr> 
 ...
 <tr> 
   ...
   <td><input type="text" name="finalidade" value="."></td>
 <tr> 
