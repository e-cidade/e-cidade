...
<script>
 ...
 window.open("sad002.php?nome=sad&titulo="+titulo+"&finalidade="+finalidade+"&limite="+limite+"&visualizacao="+visualizacao+"&veri=res","Relatório","toolbar=no,menubar=no,scrollbars=no,resizable=yes,location=no,directories=no,status=no");
 }
</script>
<br>
...
<form name="form1" method="post">
 ...
 <tr> 
   ...
   <td><input type="text" name="finalidade" value="sa"></td>
 <tr> 
   ...
   <td><input  type="text" name="limite" value="5"></td>
 </tr> 
 <tr>
