...
if($limite==0||$limite=="" ){
  ...
  $resultsql = pg_exec(str_replace('\\','','select r13_codigo,r13_descr,r13_descro from lotacao where r13_anousu = 2005 and r13_mesusu = 3 order by r13_codigo'.@$limit));
  if($resultsql==false){
    echo "Verifique os dados a serem gerados.<br>";
    echo "select r13_codigo,r13_descr,r13_descro from lotacao where r13_anousu = 2005 and r13_mesusu = 3 order by r13_codigo";
  }
  $head1 = $nome;
  $head2 = "";
  $head3 = "";
