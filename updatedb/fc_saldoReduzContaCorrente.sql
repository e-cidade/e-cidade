CREATE OR REPLACE FUNCTION fc_saldocontacorrente(integer, integer, integer, integer, integer)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fc_saldocontacorrente(integer, integer, integer, integer, integer)
  OWNER TO dbportal;