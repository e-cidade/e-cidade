...
CREATE OR REPLACE FUNCTION public.fc_calculaprecomedio(integer, integer, double precision, boolean) RETURNS numeric LANGUAGE plpgsql AS $function$
...
begin
   ...
   */
  if iCodigoMovimento in(8, 1, 3, 12, 14, 15, 23) then
