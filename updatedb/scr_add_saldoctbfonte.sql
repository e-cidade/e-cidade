...
INSERT INTO db_itensmenu VALUES (3000263, 'Saldo Ctb Fonte', '','con1_conctbsaldo001.php',1,1,'','t');

INSERT INTO db_menu VALUES (29,3000263,(select max(menusequencia)+1 from db_menu where id_item = 29),209);
