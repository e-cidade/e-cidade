...
insert into acordogarantia values(1,'CAUÇÃO EM DINHEIRO','CAUÇÃO EM DINHEIRO','CAUÇÃO EM DINHEIRO','2099-12-01');
insert into acordogarantia values(2,'TÍTULO DA DÍVIDA PÚBLICA','TÍTULO DA DÍVIDA PÚBLICA','TÍTULO DA DÍVIDA PÚBLICA','2099-12-01');
