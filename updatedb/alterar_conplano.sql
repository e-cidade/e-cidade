...
alter table conplano alter column c60_estrut type varchar(15);
...
update db_syscampo set tamanho=15 where nomecam='c60_estrut';
update db_syscampo set conteudo='varchar(15)' where nomecam='c60_estrut';
commit;
