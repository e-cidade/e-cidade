...
-- CREATE TABLE IF NOT EXISTS respinf2019(
--   si197_sequencial                    bigint default 0 not null
...
-- ALTER TABLE ONLY dclrf402019
--       ADD CONSTRAINT dclrf402019_sequ_pk PRIMARY KEY (si193_sequencial);

-- ALTER TABLE ONLY dclrf402019
--       ADD CONSTRAINT dclrf402019_reg10_fk FOREIGN KEY (si193_reg10) REFERENCES dclrf102019(si157_sequencial);
