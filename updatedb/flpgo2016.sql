...
DROP TABLE IF EXISTS pessoaflpgo102016 CASCADE;
DROP TABLE IF EXISTS respinf102016 CASCADE;
...
DROP SEQUENCE IF EXISTS pessoaflpgo102016_si193_sequencial_seq;
DROP SEQUENCE IF EXISTS respinf102016_si197_sequencial_seq;
...
CREATE SEQUENCE pessoaflpgo102016_si193_sequencial_seq
INCREMENT 1
MINVALUE 1
MAXVALUE 9223372036854775807
START 1
...
CREATE SEQUENCE respinf102016_si197_sequencial_seq
INCREMENT 1
MINVALUE 1
MAXVALUE 9223372036854775807
START 1
...
-- Módulo: sicom
CREATE TABLE pessoaflpgo102016(
...
CONSTRAINT pessoaflpgo102016_sequ_pk PRIMARY KEY (si193_sequencial));


-- Módulo: sicom
CREATE TABLE respinf102016(
...
CONSTRAINT respinf102016_sequ_pk PRIMARY KEY (si197_sequencial));
