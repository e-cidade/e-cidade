...
alter table veicmanut add column ve62_tipogasto integer ;
...
select 							 (select max(codcam)+1 from db_syscampo) as codcam
                               ,'ve62_tipogasto'::character(40) nomecam
                               ,'int4'::character(40) conteudo
                               ,'Tipo do Gasto'::text descricao
                               ,''::character(100) valorinicial
                               ,'Tipo do Gasto'::character(50) rotulo
                               ,4 tamanho
                               ,'false'::boolean nulo
                               ...
                               ,'Tipo do Gasto'::character(40) rotulorel;
