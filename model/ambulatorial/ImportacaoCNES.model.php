...
class ImportacaoCNES {
  ...
  protected function processarProfissionais($oDadosProfissionalXML, UnidadeProntoSocorro $oUPS) {
    ...
    foreach ( $aDadosVinculoXML as $oDadosVinculoXML) {
      ...
      $oDaoUnidadeMedico->sd04_c_sus        = $oDadosProfissionalXML->getAttribute('TP_SUS_NAO_SUS');
  ...
  private function salvarDadosCGM($oDadosProfissionalXML) {
    ...
    $oCgm->setNome($oDadosProfissionalXML->getAttribute('NOME_PROF'));
    $oCgm->setNomeMae($oDadosProfissionalXML->getAttribute('NOME_MAE'));

    $oDtNascimento = new DBDate( $oDadosProfissionalXML->getAttribute('DATA_NASC') );
    $oCgm->setDataNascimento( $oDtNascimento->getDate() );
    ...
    $oCgm->setTelefone($oDadosProfissionalXML->getAttribute('TELEFONE'));
    ...
    $oCgm->setNomePai($oDadosProfissionalXML->getAttribute('NOME_PAI'));
