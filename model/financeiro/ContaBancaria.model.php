...
class ContaBancaria {
   ...
   */
     ...
     * @return int
     * @throws Exception
     * Método salvar para o pcasp
     */
    public function salvar_conta_pcasp(){
...
//        $this->setSequencialContaBancaria();
  ...
  public function getAgenciaBancaria() {
   ...
   public function getContaAntiga($iCodigoContaBancaria = null) {

    if (!empty($iCodigoContaBancaria)) {

      $oDaoContaBancaria     = db_utils::getDao("contabancaria");
      $sSqlContaBancaria     = $oDaoContaBancaria->sql_query("",'*','',"db83_conta = '$iCodigoContaBancaria' ");
      $rsSqlContaBancaria    = $oDaoContaBancaria->sql_record($sSqlContaBancaria);
      $iNumRowsContaBancaria = $oDaoContaBancaria->numrows;
      $oRetorno->numrows     = $iNumRowsContaBancaria;
