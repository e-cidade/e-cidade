...
class agendaPagamento {
  ...
  function emiteCheque($aNotasLiquidacao, $dtData, $sCredor='', $aCheques = null) {
    ...
    $NumeroCheque     = db_utils::fieldsMemory($rsCodigoContaReduz, 0)->e83_sequencia;
...
//    die($sSqlMovimentos);
  ...
  function configurarPagamentos($dtPagamento, stdClass $oMovimento, $iCodigoOrdemAuxiliar = null, $lGerarOpAuxiliar=true, $lEfetuarPagamento=false) {
    ...
    if ($oMovimento->iCodForma == 0) {
      ...
      // $oDaoEmpageConcar                     = db_utils::getDao("empageconcarpeculiar");
      // $oDaoEmpageConcar->excluir(null, "e79_empagemov      = {$oMovimento->iCodMov}");
      // if ($oDaoEmpageConcar->erro_status == 0) {

      //   $sErroMsg = "Erro [5] - Erro ao cancelar Caracteristica Peculiar (Movimento {$oMovimento->iCodMov})";
      //   throw new Exception($sErroMsg);
      // }
      ...
      if ($lGerarOpAuxiliar || $oDaoOrdemAgenda->e42_sequencial != null) {
