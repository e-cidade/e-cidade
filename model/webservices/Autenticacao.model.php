...
class Autenticacao {
  ...
  public static function validaConexao($sMetodo) {
    ...
    try {
      ...
      $sSqlValidaUsuario  = "SELECT db46_id_usuario, db46_dtinicio,                          ";
      $sSqlValidaUsuario .= "       db46_horaini,    db46_datafinal, db46_horafinal          ";
      ...
      $oResultado = db_utils::fieldsMemory($rsResult);
