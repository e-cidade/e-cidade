...
abstract class BaseRepository {
  ...
  public static function getBase($sCodigo, DBCompetencia $oCompetencia, Instituicao $oInstituicao) {
    ...
    if (array_key_exists($sCodigo, BaseRepository::$aBases)) {
      
      foreach (BaseRepository::$aBases as $oBase) {
   ...
   * @throws DBException
   */
  private function procurarBase($sCodigo, DBCompetencia $oCompetencia, Instituicao $oInstituicao) {
