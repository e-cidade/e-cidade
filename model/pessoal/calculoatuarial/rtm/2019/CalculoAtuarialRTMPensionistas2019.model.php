...
/**
 * Calculo Atuarial RTM Pensionistas
 * @author Robson de Jesus <robson.silva@contassconsultoria.com.br>
 */
class CalculoAtuarialRTMPensionistas extends CalculoAtuarialRTMBase {
    ...
    */
	...
	public function processar($anofolha,$mesfolha,$where) {
		...
		CASE WHEN rh02_validadepensao IS NOT NULL THEN ((rh02_validadepensao-date(now()))/360)::varchar ELSE ' ' END ||'# '||
