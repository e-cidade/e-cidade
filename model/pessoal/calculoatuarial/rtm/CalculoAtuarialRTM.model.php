 ...
 class CalculoAtuarialRTM {
 	...
 	function __construct()
	{
 	...
 	private function getSpecificInstance($anofolha,$sArquivo) {
 		...
 		if (file_exists($sPathRTM."{$anofolha}/CalculoAtuarialRTM{$sArquivo}{$anofolha}.model.php")) {
 			require_once($sPathRTM."{$anofolha}/CalculoAtuarialRTM{$sArquivo}{$anofolha}.model.php");
 			$sClassName = "CalculoAtuarialRTM{$sArquivo}";
 			return new $sClassName;
 		}
 		require_once($sPathRTM."CalculoAtuarialRTM{$sArquivo}.model.php");
 		$sClassName = "CalculoAtuarialRTM{$sArquivo}";
 		return new $sClassName;
 	}
 }