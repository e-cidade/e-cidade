...
require_once("model/pessoal/calculoatuarial/cnm/InformcaoCalculoAtuarial.model.php");
/**
...
class InformacaoCalculoAtuarialInativos extends InformacaoCalculoAtuarial{
  ...
  public function setDataNascimento ($dDataNascimento) {
      $this->oDataNascimento = new DBDate($dDataNascimento);
  }
   ...
   */
  public function setDataInicioBeneficio ($dDataInicioBeneficio) {
      $this->oDataInicioBeneficio = new DBDate($dDataInicioBeneficio);
  }
  ...
  public function getDataNascimentoConjuge() { 
      return $this->oDataNascimentoConjuge;
  }
   ...
   */
  public function setDataNascimentoConjuge ($dDataNascimentoConjuge) {
      $this->oDataNascimentoConjuge = new DBDate($dDataNascimentoConjuge);
  }
  ...
  public function toArray() {
    ...
    $oRetorno[] = $this->getDataNascimentoConjuge()->getDate(DBDate::DATA_PTBR);
