...
/**
 * Classe reponsável por Tratar as informações referentes aos Inativos Pensionistas 
...
class InformacaoCalculoAtuarialPensionistas extends InformacaoCalculoAtuarial {
  ...
  /**
   * Data de Nascimento do Instituidor (Servidor Falecido)da Pensão
   * @var DBDate
   */
  private $oDataNascimentoInstituidor;
  
  /**
   * Data de Nascimento do Recebedor da Pensão
   * @var DBDate
   */
  ...
  /**
   * Retorna a Data Nascimento do Recebedor da Pensão
  ...
  /**
   * Seta a Data de Nascimento do Recebedor da Pensão
