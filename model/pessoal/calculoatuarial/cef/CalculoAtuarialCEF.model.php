 ...
 class CalculoAtuarialCEF {
 	...
 	function __construct()
	{
 	...
 	private function getSpecificInstance($anofolha,$sArquivo) {
 		$sPathCEF = 'model/pessoal/calculoatuarial/cef/';
 		if (file_exists($sPathCEF."{$anofolha}/CalculoAtuarialCEF{$sArquivo}{$anofolha}.model.php")) {
 			require_once($sPathCEF."{$anofolha}/CalculoAtuarialCEF{$sArquivo}{$anofolha}.model.php");
 			$sClassName = "CalculoAtuarialCEF{$sArquivo}";
 			return new $sClassName;
 		}
 		require_once($sPathCEF."CalculoAtuarialCEF{$sArquivo}.model.php");
 		$sClassName = "CalculoAtuarialCEF{$sArquivo}";
 		return new $sClassName;
 	}
 }