...
class CalculoDescontoPrevidencia {
  ...
  public function __construct( CalculoFolha $oCalculo) {
    ...
    $this->oRubricaAbono = $this->getRubricaAbono();
    return;
  }
   ...
   * @return void
   */
  private function getRubricaAbono() {
  ...
  public function lancarAbonoPermanencia() {
    ...
    $aEventos = $this->oCalculo->getEventosFinanceiros(null, self::RUBRICA_DESCONTO_PREVIDENCIA);
