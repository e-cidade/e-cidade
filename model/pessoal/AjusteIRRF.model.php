...
abstract class AjusteIRRF {
  ...
  static public function ajustar($arquivo, $rubrica_base, $sequencia, $sigla_ajuste) {
    ...
    $sSqlRegistros = "select * from ajusteir ".bb_condicaosubpes("r61_").$condicaoaux;
    ...
    if (count($ajusteir) > 0) {
      ...
      while ($Iajuste < $tot_ajusteir) {
        ...
        $soma_desc_previdencia = $nDescontoPrevidencia;
        ...
        //        $condicaoaux .= " and upper(r61_folha) in ('$sAjusteCalculo') ";
        $condicaoaux .= " and r61_altera = 't' ";
        $sSqlAjusteIRRF = "select * from ajusteir ".bb_condicaosubpes("r61_" ).$condicaoaux;
        global $ajusteir_;
