...
class ProporcionalizacaoPontoSalario {
  ...
  public function processar() {
    ...
    $oDiasAfastado         = $this->getDiasAfastado();
  ...
  /**
   * Retorna os registros do ponto que podem ser proporcionalizados na inicialização
   *
   * @return RegistroPonto[]
   */
  private function getRegistrosProporcionalizáveis() {
  ...
  private function getDiasAfastado() {
