  ...
  public function getDados() {
    ...
    foreach ($aListaDados as $oIndiceDados => $oValorDados) {
      ...
      if (strlen($oValorDados->nomeinstabrev) >10 ) {
      	$sAbreviatura = substr($oValorDados->nomeinstabrev, 0, 10);
      } else {
      ...
      $oLinha->dadosOrgao->nome              = DBString::removerCaracteresEspeciais($oValorDados->nomeinst);
      $oLinha->dadosOrgao->razaoSocial       = DBString::removerCaracteresEspeciais($oValorDados->nomeinst);
      $oLinha->dadosOrgao->sigla             = DBString::removerCaracteresEspeciais($sAbreviatura);
