...
class ArquivoSiprevCargos extends  ArquivoSiprevBase {
  ...
  public function getDados() {
    ...
    foreach ($aListaDados as $oIndiceDados => $oValorDados) {
     ...
     // Dados Cargo
      $oLinha->dadosCargo->nome                  = DBString::removerCaracteresEspeciais($oValorDados->rh37_descr);
      ...
      $oLinha->dadosCargo->aposentadoriaEspecial = 0; 
    	...
    	// Dados Vinculo
      $oLinha->dadosCargo->carreira->orgao->nome = DBString::removerCaracteresEspeciais($oValorDados->nomeinst);
