...
class GeracaoArquivoRetornoConsignet {
  ...
  private function getRegistros() {
    ...
    foreach ( $aRegistros as $oRegistro ) {
      ...
      $oRetorno->valor_descontado  = ($oRegistro->getValorDescontado() == "null" 
                                      || $oRegistro->getValorDescontado() == null 
                                      || $oRegistro->getValorDescontado() == '') ? '0' : $oRegistro->getValorDescontado();
