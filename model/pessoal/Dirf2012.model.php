...
class Dirf2012 extends Dirf {
  ...
  public function processarDadosContabilidade() {
    ...
    $sSqlDadosContabilidade .= " AND o56_elemento IN ('3339035010000','3339035020000','3339035030000','3339035040000','3339035050000','3339035060000','3339035990000','3339040010000','3339040020000','3339040030000','3339040040000','3339040050000','3339040060000','3339040070000','3339040080000','3339040090000','3339040100000','3339040110000','3339040990000','3339036190000','3339036220000','3339036990000','3339039990000','3339036140000','3339036260000','3339039360000','3449051010000','3339032000000','3339036060000','3339039050000','3339039160000','3339039150000','3339034000000','3339036300000','3339036040000','3339036060000','3339036100000','3339036110000','3339036120000','3339036130000','3339036150000','3339036170000','3339036180000','3339036190000','3339036200000','3339036210000','3339036230000','3339036240000','3339036250000','3339036270000','3339036280000','3339036290000','3339036310000','3339036320000','3339036330000','3339036340000','3339036420000','3339036430000','3339036440000','3339036450000','3339030070000')
    ...
    //db_criatabela($rsDadosContabilidade);
  ...
  public function gerarArquivo($oDados, $lGerarContabil=true) {
    ...
    //$sSqlTipoReceitas .= "    and rh96_numcgm = 550    ";
    //echo $sSqlTipoReceitas;exit;
  ...
  public function Busca_INFPA($cgm){
          ...
          $sSql = "SELECT DISTINCT r52_anousu,
                                ...
                                INNER JOIN cgm a ON a.z01_numcgm = rhpessoal.rh01_numcgm
                                LEFT JOIN db_bancos ON db_bancos.db90_codban::char(3) = pensao.r52_codbco
                                LEFT JOIN pensaoretencao ON pensaoretencao.rh77_numcgm = pensao.r52_numcgm
                                AND pensaoretencao.rh77_regist = pensao.r52_regist
                                AND pensaoretencao.rh77_anousu = pensao.r52_anousu
                                AND pensaoretencao.rh77_mesusu = pensao.r52_mesusu
                                LEFT JOIN retencaotiporec ON retencaotiporec.e21_sequencial = pensaoretencao.rh77_retencaotiporec
                                ...
                                LEFT JOIN pensaocontabancaria ON pensaocontabancaria.rh139_anousu = pensao.r52_anousu
                                AND pensaocontabancaria.rh139_mesusu = pensao.r52_mesusu
                                AND pensaocontabancaria.rh139_regist = pensao.r52_regist
                                AND pensaocontabancaria.rh139_numcgm = pensao.r52_numcgm
