...
class importacaoCenso2022 extends ImportacaoCenso2012
{
    ...
    public function atualizaDadosEscola(DBLayoutLinha $oLinha)
    {
        ...
        $oDadosEscola = new DadosCensoEscola2022($this->iEscola, null, null);
        ...
        if ($aDadosAluno != null) {
            ...
            foreach ($aDadosAluno as $iCont => $oDadosAluno) {
                ...
                if ($this->lModuloEscola) {
                    ...
                    $oAlunoCenso = new DadosCensoAluno2022($oDadosAluno->ed47_i_codigo, null);
            ...
            if ($this->lIncluirAlunoNaoEncontrado && !$this->lModuloEscola) {
                $oAlunoCenso = new DadosCensoAluno2022(null, null);
     ...
     * @todo  trazer os metodos comentados da classe importacaoCodigoInep2014 alterando para que atenda o layout de 2022
     */
