...
class DadosCensoDocente extends DadosCenso {
  ...
  public function getEnderecoDocumento() {
    ...
    $oDadosDocumentoDocente->complemento                      = substr($oDadosDocumentoDocente->complemento, 0, 19);
  ...
  protected function getDadosOutrosCursos() {
    ...
    $sSqlPerguntas    = $oDaoPerguntas->sql_query_avaliacao( null, $sCamposPerguntas, null, "db102_avaliacao = 3000002" );
  ...
  public function getDadosDocencia() {
    ...
    $sSqlTurmasRecursoHumano = $oDaoRegenciaHorario->sql_query_censo(null, $sCampos, "ed57_i_codigo", $sWhere);
  ...
  protected function getOutrasFuncoesExercidas() {
    ...
    return db_utils::getCollectionByRecord($rsDadosDocente);
  }
  ...
  public function getDisciplinasNaTurma( $iTurma ) {
    ...
    $sWhere           .= " and (cgmcgm.z01_numcgm = {$this->iCodigoCgm} or cgmrh.z01_numcgm = {$this->iCodigoCgm})";
    $sWhere           .= " and ed58_ativo is true ";
