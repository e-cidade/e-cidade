...
class DadosCenso {
  ...
  static function getUltimoAnoEtapaCenso() {
    ...
    if ( !$rsEtapaCenso ) {
      throw new DBException("Não foi possivel buscar ultimo ano do censo\n" . pg_last_error() );
    }
  ...
  static function getAtividadesComplementaresExcluidasCenso2015() {
    return array(31001, 31002, 31003, 31004, 31005, 31006, 31007, 31011, 31012, 31013, 91001, 91002, 99999, 13102, 13103, 13108, 13201, 22010);
  }
