...
class DadosCensoEscola extends DadosCenso {
	 ...
	 * @return boolean
	 */
	public function validarEquipamentosExistentes (IExportacaoCenso $oExportacaoCenso, $sEquipamento) {
    ...
    if( DBNumber::isInteger($sEquipamento) && $sEquipamento == 0 ) {
      ...
      $lTodosDadosValidos  = false;
      $sMensagem           = "A quantidade informada para um ou mais equipamentos existentes na escola é inválido. Não";
      $sMensagem          .= " deve ser informado o valor 0. Caso a escola não possua o equipamento, deixar o campo vazio.";
      $oExportacaoCenso->logErro( $sMensagem, ExportacaoCensoBase::LOG_ESCOLA );
    }
