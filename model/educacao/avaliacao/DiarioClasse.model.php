...
class DiarioClasse {
  ...
  public function aprovadoComProgressaoParcial() {
    ...
    $aProgressoes                = ProgressaoParcialAlunoRepository::getProgressoesAtivas( $this->getMatricula()->getAluno() );
  ...
  public function periodosCalculoResultadoFinal() {
    ...
    if( !$rsDiarioRegraCalculo ) {
      ...
      throw new DBException( _M( MENSAGENS_DIARIOCLASSE . "erro_buscar_ordem_periodos", $oErro ) );
    }
