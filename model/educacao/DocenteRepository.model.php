...
class DocenteRepository {
   ...
   * @return Docente|null
   */
  public static function getDocenteLogado( $iCodigoUsuario, $iEscola = null ) {
    ...
    if ($oDaoDBUsusario->numrows > 0) {
      ...
      if( !empty( $iEscola ) ) {
        ...
        $sWhere .= " AND exists( select 1 from rechumanoescola recescola ";
        $sWhere .= "                           inner join rechumanoativ on rechumanoativ.ed22_i_rechumanoescola = recescola.ed75_i_codigo";
        $sWhere .= "                           inner join atividaderh   on atividaderh.ed01_i_codigo            = rechumanoativ.ed22_i_atividade";
        $sWhere .= "                     where recescola.ed75_i_codigo      = rechumanoescola.ed75_i_codigo ";
        $sWhere .= "                       and ed01_c_regencia              = 'S'";
        $sWhere .= "                       and recescola.ed75_i_saidaescola is null )";
      }

      $sSqlDocente = $oDaoRecHumano->sql_query_rechumano_cgm( null, "distinct ed20_i_codigo", null, $sWhere );
