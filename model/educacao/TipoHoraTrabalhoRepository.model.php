...
class TipoHoraTrabalhoRepository {
  ...
  public static function getByCodigo($iCodigo) {
    ...
    if (!array_key_exists($iCodigo, TipoHoraTrabalhoRepository::getInstance()->aTipoHora)) {
      TipoHoraTrabalhoRepository::getInstance()->aTipoHora[$iCodigo] = new TipoHoraTrabalho($iCodigo);
    }

    return TipoHoraTrabalhoRepository::getInstance()->aTipoHora[$iCodigo];
  }
  ...
  public static function adicionarTipoHora(TipoHoraTrabalho $oTipoHoraTrabalho) {
    ...
    if(!array_key_exists($oTipoHoraTrabalho->getCodigo(), TipoHoraTrabalhoRepository::getInstance()->aTipoHora)) {
      TipoHoraTrabalhoRepository::getInstance()->aTipoHora[$oTipoHoraTrabalho->getCodigo()] = $oTipoHoraTrabalho;
    }
    return true;
  }
  ...
  public static function removerAluno(TipoHoraTrabalho $oTipoHoraTrabalho) {
    ...
    if (array_key_exists($oTipoHoraTrabalho->getCodigo(), TipoHoraTrabalhoRepository::getInstance()->aTipoHora)) {
      unset(TipoHoraTrabalhoRepository::getInstance()->aTipoHora[$oTipoHoraTrabalho->getCodigo()]);
    }
    return true;
  }
