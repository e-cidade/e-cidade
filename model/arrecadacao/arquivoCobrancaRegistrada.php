...
class arquivoCobrancaRegistrada {
  ...
  public function geraArquivoRemessaBanco($dtProcessamento,$sNomeArq) {
    ...
    $oHeader->prefixo_agencia                     = str_pad($oConvenioCobranca->db89_codagencia ,  4, "0", STR_PAD_LEFT);
    ...
    /*
     * Monstamos os dados do detalhe do arquivo
     * 
     ...
     */  
     ...
     foreach ( $oRegistros as $aDados ) {
        ...
        $oDetalhe->prefixo_agencia                      = str_pad($oConvenioCobranca->db89_codagencia       ,  4, "0", STR_PAD_LEFT);
        ...
        $oDetalheAuxiliar->prefixo_agencia_credito1     = str_pad($aDados->codagencia_TJ                    ,  4, "0", STR_PAD_LEFT);
        ...
        $oDetalheAuxiliar->prefixo_agencia_credito2     = str_pad($aDados->codagencia_FUNPERJ                ,  4, "0", STR_PAD_LEFT);
        ...
        $oDetalheAuxiliar->prefixo_agencia_credito3     = str_pad($aDados->codagencia_CAARJ                  ,  4, "0", STR_PAD_LEFT);
        ...
        $oDetalheAuxiliar->prefixo_agencia_credito4     = str_pad($aDados->codagencia_FUNDPERJ               ,  4, "0", STR_PAD_LEFT);
        ...
        $oDetalheAuxiliarPref->prefixo_agencia_credito1     = str_pad($aDados->codagencia_INSTITUICAO                ,  4, "0", STR_PAD_LEFT);
  ...
  public function getDadosReciboPartilha($iTipoArq,$dtProcessamento) {
     ...
     */   
    $sWhere    = " recibopaga.k00_dtoper = '{$dtProcessamento}'                                                           \n";
    ...
    $sSqlDados = $oProcessoForoPartilhaCusta->sql_query_recibo(null, "distinct {$sCampos}", $sOrderBy, $sWhere);
    ...
    if ( $rsDados && pg_num_rows($rsDados) > 0 ) {
      ...
      for ($iInd = 0; $iInd < pg_num_rows($rsDados); $iInd ++) {
        ...
        if ( $rsSqlCustas && pg_num_rows($rsSqlCustas) > 0 ){
          ...
          $oDados->valor_recibo             = $oRegistro->valor_recibo;
          $oDados->valor_total_taxa         = $oRegistro->valor_total_taxas;
          $oDados->valor_total_recibo       = $oRegistro->valor_recibo+$oRegistro->valor_total_taxas;  
          ...
          switch (trim($oRegistro->favorecido_cgccpf)) {
            ...
            case "28538734000148":
             ...
             if (!in_array($oRegistro->taxa_codigo,$aTaxas)) {  
               ...
               $oDados->codagencia_TJ      = $oRegistro->favorecido_agencia;
            ...
            case "08778206000159":
             ...
             $oDados->codagencia_FUNPERJ       = $oRegistro->favorecido_agencia;
            ...
            case  "33755174000113":
             ...
             $oDados->codagencia_CAARJ         = $oRegistro->favorecido_agencia;
            ...
            case "31443526000170":
             ...
             $oDados->codagencia_FUNDPERJ      = $oRegistro->favorecido_agencia;
          ...
          $oDados->codagencia_INSTITUICAO      = $oDadosInstituicao->db89_codagencia;
