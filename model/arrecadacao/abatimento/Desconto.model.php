...
class Desconto extends Abatimento {
  ...
  const APLICACAO_DESCONTO_MULTA = 1;
  const APLICACAO_DESCONTO_JUROS = 2;
  const APLICACAO_DESCONTO_JUROS_MULTA = 3;
  const APLICACAO_DESCONTO_CORRECAO = 4;
  const APLICACAO_DESCONTO_JUROS_MULTA_CORRECAO = 5;
  const APLICACAO_DESCONTO_VALOR_HISTORICO = 6;
