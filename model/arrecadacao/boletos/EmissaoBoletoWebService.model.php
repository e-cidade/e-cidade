...
class EmissaoBoletoWebService extends EmissaoBoleto{
  ...
  public function regerarBoleto($iNumpreDebito, $sData, $iNumparDebito, $nDesconto=0, $sCompetencia=null) {
     ...
     * If verificar numpre
     *
     * Esta função foi alterada devido ao fato de que os parametros estavam na ordem errada ($iNumpreDebito, $iNumparDebito, $sData)
     * Dessa forma, o numpar era sempre a data do debito. Além disso, a numpar não era passado, dessa forma foi necessário
