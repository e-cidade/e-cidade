...
class AutenticacaoArrecadacao extends Autenticacao {
   ...
   * @return void
   */
  public function estornar($dataLancamento = null) {
    ...
    $lReceitaContabil = $this->efetuarLancamentos($oDadosAutenticacao->data,
                              ...
                              $oDadosAutenticacao->codautent,
                              $this->iContaDebito,
                              true, false, false, $dataLancamento ?? null);
    /**
    ...
    if ($lReceitaContabil) {
      ...
      $this->efetuarLancamentos($oDadosAutenticacao->data,
                                ...
                                $oDadosAutenticacao->codautent,
                                $this->iContaDebito,
                                true, true, true, $dataLancamento ?? null);

      $this->efetuarLancamentos($oDadosAutenticacao->data,
                              $oDadosAutenticacao->id,
                              $oDadosAutenticacao->codautent,
                              $this->iContaDebito,
                              true, true, false, $dataLancamento ?? null);
    }

    $lReceitaExtra = $this->efetuarLancamentosReceitaExtra(true,
                                          $oDadosAutenticacao->data,
                                          $oDadosAutenticacao->codautent,
                                          $oDadosAutenticacao->id, $dataLancamento ?? null);
  ...
  public function efetuarLancamentos($dtAutenticacao="", $iId="", $iAutent="",
                                     $iCodigoContaDebito, $lEstorno, $lDesconto=false, $lArrecadaDesconto = false, $dataLancamento = null) {
   ...
   * @return boolean
   */
  public function efetuarLancamentosReceitaExtra($lEstorno = false, $dtAutenticacao, $iAutenticacao, $iId, $dataLancamento = null) {
    ...
    for ($iRowAutenticacao = 0; $iRowAutenticacao < $iTotalReceitasExtras; $iRowAutenticacao++) {
      ...
      $oEventoContabil->executaLancamento($oLancamentoAuxiliar, $dataLancamento ?? $dtAutenticacao);
