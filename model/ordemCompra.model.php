...
class ordemCompra {
  ...
  public function anularEntradaNota($iCodNota) {
    ...
    try {
      ...
      $clmatestoqueini->m80_obs      = "Anulação da entrada de material.";
          ...
          if ($clmatestoqueinimei->numrows  > 0) {
            ...
            try {
               $oMaterial->cancelarSaidaMaterial($oItemAtivo["m71_quant"],
                                                $oSaidaMaterial->m82_codigo, 'Anulação de saída de serviço automático');
        ...
        if (USE_PCASP) {
          ...
          if (in_array($iGrupoContaOrcamento, array(7, 8, 10))) {
            ...
            if ($oDaoMatEstoqueIniMeiPM->numrows == 0) {
              throw new BusinessException("Não foi localizado o preço médio para o material.");
            }
