...
class retencaoNota
{
   ...
   * @param  boolean $lInSession define se o objeto sera adicionado apenas na sessao, ou sera apenas adicionado a
   *   classe.
    ...
    if (count($aRetencoes) > 0) {
      ...
      */
      foreach ($aRetencoes as $oRetencao) {
        ...
        $sSqlRetencao = $oDaoRetencaoReceita->sql_query_notas(null, "e23_sequencial,
            e23_ativo,
            e23_dtcalculo,
            e23_recolhido", null, "e27_empagemov={$this->iCodMovimento}
        and e23_ativo     = true
  ...
  function desativarRetencao($iCodigoRetencao, $iNotaLiquidacao = null)
  {
    ...
    if (!empty($iNotaLiquidacao)) {
      ...
      $oDaoRetencaoReceitas = db_utils::getDao("retencaoreceitas");
      $sSqlRetencaoRecieitas = $oDaoRetencaoReceitas->sql_query_notas(null, "*", null, "e20_pagordem = {$iNotaLiquidacao}
      and e23_recolhido = false
  ...
  function getRetencoesByMovimento($iCodMovimento, $iTipoRetencao = '', $lRecolhida = false, $lPrincipal = false)
  {
    ...
    $sSqlRetencaoReceitas = $oDaoRetencaoReceitas->sql_query_notas(null, "distinct tabrec.*,retencaotiporec.*,
        retencaoreceitas.*,e27_principal,k108_slip,null as k17_slip ", "e21_sequencial
  ...
  function getRetencaoByCodigo($iCodigoRetencao, $lRecolhida = false)
  {
    ...
    $sWhere .= " and e27_principal is true ";
    $sSqlRetencaoReceitas = $oDaoRetencaoReceitas->sql_query_notas(null, "distinct tabrec.*,retencaotiporec.*,
        retencaoreceitas.*,e27_principal,k108_slip,e27_empagemov ", "e21_sequencial
