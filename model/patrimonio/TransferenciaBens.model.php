...
class TransferenciaBens {
  ...
  /**
   * situação do bem a ser transferido
   * @var integer
   */
  protected $iSituacao;
  ...
  /**
   * metodo que realizará o recebimento de uma
  ...
  public function transferenciaAutomatica($iCodigoHistbem){
    ...
    /**
     *  primeiro verificamos se o departamento atual do bem é igual ao de destino
     *  se for o mesmo, é desnecessario a transferencia
     */
    if ($iDepartamentoAtual != $this->getDepartamentoDestino()) {

      if ( !db_utils::inTransaction() ) {
        throw new DBException("[ 1 - transferenciaAutomatica ] - Nenhuma transação encontrada!");
      }
