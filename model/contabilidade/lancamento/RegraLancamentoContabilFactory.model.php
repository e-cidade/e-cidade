...
class RegraLancamentoContabilFactory {
  ...
  private function getInstanciaPorDocumento ($iDocumento) {
    ...
    ,124 => "RegraArrecadacaoReceita"
    ,125 => "RegraArrecadacaoReceita"
    ,126 => "RegraArrecadacaoReceita"
    ,127 => "RegraArrecadacaoReceita"
    ,128 => "RegraArrecadacaoReceita"
    ,129 => "RegraArrecadacaoReceita"
    ...
    ,164 => "RegraPagamentoSlip"
    ,166 => "RegraPagamentoSlip"
    ,162 => "RegraAnulacaoSlip"
    ,163 => "RegraAnulacaoSlip"
    ,165 => "RegraAnulacaoSlip"
    ,167 => "RegraAnulacaoSlip"
