...
abstract class ContaPlano {
    ...
    protected $iTipoLancamento = null;
    protected $iSubTipo = null;
    ...
    public function __construct($iCodigoConta = null, $iAnoUsu = null, $iReduz = null, $iInstituicao = null) {
        ...
        if (!empty($sWhere)) {
            ...
            if ($oDaoConPlano->numrows > 0) {
                ...
                $this->setNaturezadaReceita($oContaPlano->c60_naturezadareceita);
    ...
    /**
     * Retorna o código do tce
     * @return interger
     */
    public function getCodigoTce() {
        return $this->iCodigoTce;
    }

    /**
     * Recebe o código do tce
     * @param $iCodigoTce
     */
    ...
    /*Dados adicionados por motivo da criação da tabela de lancamentopcasp*/
    ...
    public function getSubTipo() {
        return $this->iSubTipo;
    }

    public function setSubTipo($iSubTipo) {
        $this->iSubTipo = $iSubTipo;
        return $this;
    }
    ...
    public function getNaturezadaReceita(){
        return $this->iNaturezadaReceita;
    }
