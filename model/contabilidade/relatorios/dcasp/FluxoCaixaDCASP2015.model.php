...
class FluxoCaixaDCASP2015 extends RelatoriosLegaisBase {

  const CODIGO_RELATORIO = 150;

  const QUADRO_PRINCIPAL_INICIAL           = 1;
  const QUADRO_PRINCIPAL_FINAL             = 34;
  const QUADRO_RECEITAS_DERIVADAS_INICIAL  = 35;
  const QUADRO_RECEITAS_DERIVADAS_FINAL    = 44;
  const QUADRO_TRANSFERENCIAS_INICIAL      = 45;
  const QUADRO_TRANSFERENCIAS_FINAL        = 61;
  const QUADRO_DESEMBOLSOS_PESSOAL_INICIAL = 62;
  const QUADRO_DESEMBOLSOS_PESSOAL_FINAL   = 90;
  const QUADRO_DIVIDA_INICIAL              = 91;
  const QUADRO_DIVIDA_FINAL                = 94;
  ...
  public function getDados() {
     ...
     */
    foreach (array(3, 4, 7, 8, 9) as $iLinha) {
