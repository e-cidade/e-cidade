...
class RelatoriosLegaisMultiplosFiltrosBase {
  ...
  /**
   * Processa as formulas do relatório
   * @param $aLinhas
   * @throws \Exception
   */
  ...
  protected static function calcularValorDaLinhaComValoresDerivados($Recordset, $RecordsetPosterior, stdClass $oLinha, $iTipoCalculo) {
    ...
    for ($iLinha = 0; $iLinha < $iTotalLinhas; $iLinha++) {
      ...
      // Percorre as contas de uma linha - 1º nível
  ...
  /**
   * Executa o Balancete da Receita - Fonte de dados para este relatório
   */
  ...
  /**
   * Processa as colunas que serão usadas para o calculo
   *
