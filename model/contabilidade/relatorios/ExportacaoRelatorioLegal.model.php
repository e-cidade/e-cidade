...
class ExportacaoRelatorioLegal{
  ...
  private function getDadosRelatorio(){
    ...
    $oDadosRelatorio->o42_descrrel         = urlencode($oRelatorio->o42_descrrel);
    $oDadosRelatorio->o42_orcparamrelgrupo = $oRelatorio->o42_orcparamrelgrupo;
    $oDadosRelatorio->o42_notapadrao       = urlencode($oRelatorio->o42_notapadrao);
  ...
  public function exportar(){
    ...
    $oRelatorio->descricao           = $this->getDadosRelatorio()->o42_descrrel;
    $oRelatorio->grupo_relatorio     = $this->getDadosRelatorio()->o42_orcparamrelgrupo;
    $oRelatorio->nota_padrao         = $this->getDadosRelatorio()->o42_notapadrao;
