...
/**
 * Classe Singleton para verificação de vinculo de Orgãos e Responsáveis
...
class SigfisVinculoOrgaoResponsavel {
	...
	protected function __construct() {
		...
		$oDomXml->load('legacy_config/sigfis/vinculaorgaoresponsavel.xml');
	...
	/**
	 * Verifica se o Orgão passado no parametro está incluso no array de orgãos do xml
	 * @param integer $iCodigoOrgao
	 * @return retorna objeto do orgão, ou false se ele não existir no array de orgãos
	 */
