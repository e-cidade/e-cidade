...
/**
 * Classe Singleton para verificação de vinculo de Despesa do e-cidade para o Sigfis
...
class SigfisVinculoDespesa {
  ...
  protected function __construct() {
    ...
    $aDespesas = array();
    if (file_exists('legacy_config/sigfis/vinculodespesa.xml')) {

      $oDomXml->load('legacy_config/sigfis/vinculodespesa.xml');
  ...
  /**
   *
   * Este método é para garantir a integridade do Singleton
   */
