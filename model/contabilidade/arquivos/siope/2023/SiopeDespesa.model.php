...
class SiopeDespesa extends Siope {
    ...
    public function gerarDadosFundeb() {
        ...
        $f118 = $clDeParaFonte->getDePara(118);
        $f119 = $clDeParaFonte->getDePara(119);
        $f166 = $clDeParaFonte->getDePara(166);
        $f167 = $clDeParaFonte->getDePara(167);

        foreach ($this->aDespesas as $oDespesa) {
            
            if (in_array($oDespesa->o58_codigo, array($f118, $f166))) {
                $this->agrupaFundeb($oDespesa, 13);
            }
            
            if (in_array($oDespesa->o58_codigo, array($f118, $f119, $f166, $f167))) {
                $this->agrupaFundeb($oDespesa, 14);
            }

            if (in_array($oDespesa->o58_codigo, array($f166, $f167))) {
                $this->agrupaFundeb($oDespesa, 16);
            }
            ...
            if (in_array($oDespesa->o58_codigo, array($f166, $f167)) && substr($oDespesa->elemento,0,2) == '34') {
                $this->agrupaFundeb($oDespesa, 18);
            }
        }
    ...
    public function getCod174190191274290291($iSubFuncao, $iTipoEnsino, $iTipoPasta) {
