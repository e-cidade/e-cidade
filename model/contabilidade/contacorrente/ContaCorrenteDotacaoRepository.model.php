 ...
 */
class ContaCorrenteDotacaoRepository extends ContaCorrenteRepositoryBase
{
    ...
    public function __construct($dtInicial, $dtFinal)
    {
        ...
        parent::__construct(ContaCorrenteDotacao::CONTA_CORRENTE, $dtInicial, $dtFinal);
        $this->setAtributos();
    }
    ...
    private function setAtributos()
    {
        ...
        $sWhere = "     c19_contacorrente = " . ContaCorrenteDotacao::CONTA_CORRENTE;
