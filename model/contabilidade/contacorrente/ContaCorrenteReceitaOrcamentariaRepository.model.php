 ...
 */
class ContaCorrenteReceitaOrcamentariaRepository extends ContaCorrenteRepositoryBase {
  ...
  public function __construct($dtInicial, $dtFinal) {
    ...
    parent::__construct(ContaCorrenteReceitaOrcamentaria::CONTA_CORRENTE, $dtInicial, $dtFinal);
    $this->setAtributos();
  }
  ...
  private function setAtributos() {
    ...
    $sWhere                   = "     c19_contacorrente = " . ContaCorrenteReceitaOrcamentaria::CONTA_CORRENTE;
