...
class dbGeradorRelatorio
{
        ...
        if ($rsConsultaCampos) {
            ...
            if ($iNroLinhas > 0) {
                ...
                for ($iInd = 0; $iInd < $iNroLinhas; $iInd++) {
                    ...
                    $oRetornoCampo = new dbColunaRelatorio(
                        $iId,
                        $oCampos->nomecam,
                        $oCampos->rotulo,
                        $oCampos->tamanho * 2,
    ...
    public function converteAgt($sXml)
    {
        ...
        foreach ($aPropriedades as $oPropriedades) {
            ...
            #sety095';
                ...
                $sRodape    = '#lineH800
            #setfan06
            Base: $db_base  #tab270$db_programa  Emissor: $db_nomeusu  Exercício: $db_anousu  Data: $db_datausu  Hora: $db_horausu  #tab735 Página: $page de {nb} ';
            } else {
            ...
            #tab365$head7';
                ...
                $sRodape    = '#lineH550
            #setfan06
            Base: $db_base  $db_programa    Emissor: $db_nomeusu Exercício: $db_anousu Data: $db_datausu Hora: $db_horausu #tab503Página: $page de {nb}';
            }
    ...
    public function gerarRelatorio($sNomeArquivo = null, $aParametros = array())
    {
        ...
        $sCaminhoAgt  = $this->geraArquivoAgt($this->sEstruturaXML);
