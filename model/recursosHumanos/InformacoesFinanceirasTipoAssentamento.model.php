...
class InformacoesFinanceirasTipoAssentamento {
  ...
  public static function getInstance(TipoAssentamento $oTipoAssentamento) {
    ...
    if ( !array_key_exists($oTipoAssentamento->getCodigo(), self::$aInstance ) ) {
      self::$aInstance[$oTipoAssentamento->getCodigo()] = new InformacoesFinanceirasTipoAssentamento($oTipoAssentamento);
    }
