...
function js_pesquisarh63_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_nome.php?funcao_js=parent.js_mostranome1|z01_numcgm|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.rh63_numcgm.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','func_nome','func_nome.php?pesquisa_chave='+document.form1.rh63_numcgm.value+'&funcao_js=parent.js_mostranome','Pesquisa',false);
     }else{
...
function js_pesquisarh62_regist(mostra, cgm){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhpessoal.php?testarescisao=ra&funcao_js=parent.js_mostrarhpessoal1|rh01_regist|z01_nome&instit=<?=db_getsession("DB_instit")?>','Pesquisa',true);
  }else{
     if(cgm == true){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhpessoal.php?testarescisao=ra&chave_rh01_numcgm='+document.form1.rh63_numcgm.value+'&funcao_js=parent.js_mostrarhpessoal2|rh01_regist|z01_nome&instit=<?=db_getsession("DB_instit")?>','Pesquisa',true);
     }else if(document.form1.rh62_regist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhpessoal.php?testarescisao=ra&pesquisa_chave='+document.form1.rh62_regist.value+'&funcao_js=parent.js_mostrarhpessoal&instit=<?=db_getsession("DB_instit")?>','Pesquisa',false);
     }else{
       document.form1.z01_nome.value = '';
     }
  }
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhipe','func_rhipe.php?depend=func&testarescisao=ra&funcao_js=parent.js_preenchepesquisa|rh14_sequencia','Pesquisa',true);
}
