...
//MODULO: Ambulatorial
$clsau_procsemfatura->rotulo->label();
?>
<br><br>
<center>
<fieldset style="width:50%;" ><legend><b>Procedimento Sem Fatura</b></legend>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Ts146_i_codigo?>">
       <?=@$Ls146_i_codigo?>
    </td>
    <td>
<?
