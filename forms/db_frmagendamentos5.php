...
function js_valida(){
 ...
 if(document.form1.sd23_i_especialidade.value==""){
  if(confirm("Especialidade está em branco\n\nA especialidade será 0 - NÃO OBRIGATÓRIO\n\nDeseja continuar?")){
   ...
   CurrentWindow.corpo.iframe_a2.location.href='sau1_agendamentos002.php?unidade='+document.form1.sd23_i_unidade.value+'&medico='+document.form1.sd23_i_medico.value+'&especialidade=0';
   parent.mo_camada('a2');
  }
 }else{
  parent.document.formaba.a2.disabled=false;
  CurrentWindow.corpo.iframe_a2.location.href='sau1_agendamentos002.php?unidade='+document.form1.sd23_i_unidade.value+'&medico='+document.form1.sd23_i_medico.value+'&especialidade='+document.form1.sd23_i_especialidade.value;
  parent.mo_camada('a2');
 }
}

function js_pesquisasd23_i_medico(){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_a1','db_iframe_medicos','func_unidademedicos.php?unidade='+document.form1.sd23_i_unidade.value+'&funcao_js=parent.js_mostramedicos1|sd03_i_id|z01_nome|sd27_i_especialidade|sd05_c_descr','Pesquisa',true);
}
...
function js_pesquisasd23_i_unidade(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_a1','db_iframe_unidades','func_unidades.php?funcao_js=parent.js_mostraunidades1|sd02_i_codigo|sd02_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd23_i_unidade.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_a1','db_iframe_unidades','func_unidades.php?pesquisa_chave='+document.form1.sd23_i_unidade.value+'&funcao_js=parent.js_mostraunidades','Pesquisa',false);
     }else{
