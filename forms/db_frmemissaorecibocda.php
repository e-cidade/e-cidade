...
function js_processar() {
  ...
  new AjaxRequest(sRpc, oParametros, function(oRetorno, erro) {
    ...
    oDownload.addGroups( 'pdf', 'Recibo de CDA');
    oDownload.addFile( oRetorno.sNomeArquivoRelatorio, 'Download do Relatório', 'pdf' );
    oDownload.addFile( oRetorno.sNomeArquivoRecibos, 'Download do(s) Recibo(s)', 'pdf' );
    oDownload.show();
