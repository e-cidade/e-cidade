          ...
          <legend>Parâmetros do Cálculo</legend>
              ...
              <td>
                ...
                ?>
					  ...
					  <tr>
					    ...
					    <td>
								<?
								db_input('j18_rterri',15,$Ij18_rterri,true,'text',$db_opcao,"")
								?>
					    </td>
					  </tr>
					  <tr>
					    ...
					    <td>
								<?
								db_input('j18_rpredi',15,$Ij18_rpredi,true,'text',$db_opcao,"")
								?>
					    </td>
					  </tr>
            <tr>
            ...
            <tr>
              <td nowrap title="<?=@$Tj18_iptuhistisen?>">
                 <?
                  db_ancora("<b>Código do Histórico de Isenção:</b>","js_pesquisaj08_histiseni(true);",$db_opcao);
                 ?>
              </td>
              <td>
                <?
        ...
        <fieldset>
          ...
          <table>
            ...
            <tr id="linhaTemplate" style="display:none;">
              <td nowrap="nowrap" title="<?=@$Tp90_db_documentotemplate?>">
                <?
                  db_ancora("<B>Documento Template:</B>","js_pesquisaDocumentoIsencao(true);",$db_opcao);
                ?>
              </td>
              <td nowrap="nowrap">
                <?
...
<input name="<?=($db_opcao==1?"incluir":($db_opcao==2||$db_opcao==22?"alterar":"excluir"))?>" type="submit" id="db_opcao" onclick = "return js_validaCampos();" value="<?=($db_opcao==1?"Incluir":($db_opcao==2||$db_opcao==22?"Alterar":"Excluir"))?>" <?=($db_botao==false?"disabled":"")?> >
...
function js_validaCampos(){
  ...
  /*if ($F('j18_templatecertidaoexitencia') == ''){
    alert('Campo Template Certidão de Existência é de preenchimento obrigatório!')
    return false;
  }*/
