...
<div>
  <form name="form1" method="post" action="">
    <fieldset>
      <legend><strong>Solicitação</strong></legend>
      <table border="0">
        <tr>
          ...
          <td>
            ...
            db_inputdata('pc10_data', $pc10_datadia, $pc10_datames, $pc10_dataano, true, 'text', 1);
            ?>
          </td>
        </tr>
        ...
        if (isset($param) && trim($param) != "") {
          ...
          if (
            isset($chavepesquisa) && trim($chavepesquisa) != "" &&
