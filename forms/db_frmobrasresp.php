  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_obras','func_obras.php?funcao_js=parent.js_mostraobras1|ob01_codobra|ob01_nomeobra','Pesquisa',true);
     ...
     if(document.form1.ob10_codobra.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_obras','func_obras.php?pesquisa_chave='+document.form1.ob10_codobra.value+'&funcao_js=parent.js_mostraobras','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_nome.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.ob10_numcgm.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_nome.php?pesquisa_chave='+document.form1.ob10_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_obrasresp','func_obrasresp.php?funcao_js=parent.js_preenchepesquisa|ob10_codobra','Pesquisa',true);
}
