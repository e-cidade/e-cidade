...
<form name="form1" method="post" action="" onsubmit="return js_buscavalores();">
<center>
<table border='0' width=98%>
  <tr>
    <td>
      <table border="0" style="border:1px solid #888888">
        <tr>
          ...
          <td><?db_input('z01_nome',40,$Iz01_nome,true,'text',3)?></td>
	 </tr>
        <tr>
          ...
          <td nowrap><?db_input('z01_email',40,$Iz01_email,true,'text',3)?>
...
?>
	 ...
	 <table border=0 style="border:1px solid #888888">
	 <tr>
	  <td nowrap title="<?=@$Te69_numero?>"  ><?=@$Le69_numero?></td>
          <td><? db_input('e69_numero', 20, $Ie69_numero, true, 'text', $opcao, "") ?></td>
         </tr>
         <tr>
           <td nowrap title="<?=@$Te69_dtnota?>"><?=@$Le69_dtnota?></td>
           <td><?
...
?></td>
	 ...
	 <tr>
          <td nowrap title="<?=@$e70_valor?>"><b> Valor da Nota: </b></td>
          <td><? db_input('e70_valor', 20, $Ie70_valor, true, 'text', 3, "","","","text-align:right") ?></td>
         </tr>
	 </table>
	</td>
	<td align='right'><b>Obs:</b></td>
        <td colspan='1' align='left'><? db_textarea("m51_obs","","50",$Im51_obs,true,'text',1); ?></td>
	</tr>
        <tr>
         <td> &nbsp; </td>
...
?>
      <table  border=0 width=100%>
        <tr>
         <td>
           <iframe name="itens" id="itens" src="forms/db_frmmatordemitem.php?e60_numcgm=<?=$e60_numcgm?>&erro=false" width="100%" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>
         </td>
        </tr>
      </table>
     <?
...
?>
      <table border=0 width=98%>
        <tr>
         <td>
           <iframe name="itens" id="itens" src="forms/db_frmmatordemitem_liquida.php?e60_numcgm=<?=$e60_numcgm?>&erro=false&e60_codemp=<?=@$e60_codemp?>&e60_numemp=<?=@$e60_numemp?>" width="100%" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>
         </td>
        </tr>
      </table>
     <?
...
function js_buscavalores(){
   ...
   // verifica se esta digitado numero da nota
   ...
   if (submeter==true){
         ...
         alert('Selecione a menos um íten para prosseguir !');
   		 return false;
   }
}
</script>
