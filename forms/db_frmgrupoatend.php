...
//MODULO: saude
$clgrupoatend->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tsd15_i_codigo?>">
       <?=@$Lsd15_i_codigo?>
    </td>
    <td>
<?
db_input('sd15_i_codigo',10,$Isd15_i_codigo,true,'text',3,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tsd15_c_descr?>">
       <?=@$Lsd15_c_descr?>
    </td>
    <td>
<?
db_input('sd15_c_descr',50,$Isd15_c_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
