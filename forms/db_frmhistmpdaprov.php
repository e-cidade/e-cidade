  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_historico','func_historico.php?funcao_js=parent.js_mostrahistorico1|ed61_i_codigo|ed61_i_codigo','Pesquisa',true);
     ...
     if(document.form1.ed70_i_historico.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_historico','func_historico.php?pesquisa_chave='+document.form1.ed70_i_historico.value+'&funcao_js=parent.js_mostrahistorico','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_disciplina','func_disciplina.php?funcao_js=parent.js_mostradisciplina1|ed12_i_codigo|ed12_i_codigo','Pesquisa',true);
     ...
     if(document.form1.ed70_i_disciplina.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_disciplina','func_disciplina.php?pesquisa_chave='+document.form1.ed70_i_disciplina.value+'&funcao_js=parent.js_mostradisciplina','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_histmpdaprov','func_histmpdaprov.php?funcao_js=parent.js_preenchepesquisa|ed70_i_codigo','Pesquisa',true);
}
