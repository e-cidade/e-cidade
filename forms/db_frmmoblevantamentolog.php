  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_mobimportacao','func_mobimportacao.php?funcao_js=parent.js_mostramobimportacao1|j95_codimporta|j95_pda','Pesquisa',true);
     ...
     if(document.form1.j98_codimporta.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_mobimportacao','func_mobimportacao.php?pesquisa_chave='+document.form1.j98_codimporta.value+'&funcao_js=parent.js_mostramobimportacao','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_moblevantamentolog','func_moblevantamentolog.php?funcao_js=parent.js_preenchepesquisa|j98_sequen','Pesquisa',true);
}
