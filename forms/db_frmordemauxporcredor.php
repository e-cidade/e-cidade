         ...
         <tr>
          ...
          <tr>
           ...
           <td colspan='2' width="80%">
            <?
              db_textarea('historico',5,48,0,true,'text',1);
          ...
          <tr>
            <td colspan="3" align="center">
              <input id="alterardata" type="button"  value="Alterar"   onclick='return js_alterarData();'>
            </td>
          </tr>
        </table>
    </td>
 ...
 <table style="width: 100%">
  ...
  <tr>
    <td align='center' colspan="5" >
      <input id="pesquisar" type="button" value="Pesquisar" onclick='return js_pesquisarOrdens(1);'>
      <input id="incluir"   type="button" value="Incluir"   onclick='return js_incluir();'>
      <input id="excluir"   type="button" value="Excluir"   onclick='return js_desautorizaOrdem();'>
      <input id="imprimir"  type="button" value="Imprimir"  onclick='js_emitir()'>
    </td>
  </tr>
  <tr>
  <td colspan='5'>
...
function js_pesquisarOrdens(iTipo) {
  ...
  oParametros.iSlipInicial   = '';
  oParametros.iSlipFim       = '';
  oParametros.iNumCgm        = sNumCgm;
...
function js_emitir() {
  ...
  var e42_sequencial = $F('e42_sequencial');
...
function js_alterarData() {
   ...
   oParam.e94_sequencial  = e94_sequencial;
   oParam.historico       = encodeURIComponent(tagString($F('historico')));

   js_divCarregando("Aguarde, gravando alterações.","msgBox");
...
parent.$('CFdb_iframe_op').cells[0].innerHTML = "Manutenção de OP nº "+$F('e42_sequencial')+" - ("+sNumCgm+") "+sNomeCgm;
js_init();
</script>
