...
if(isset($opcao) && $opcao == "excluir"){
  echo "<script>parent.iframe_compnome.location.href='itb1_itbinomecomp003.php?chavepesquisa=$it03_guia&chavepesquisa1=$it03_seq&db_opcao=3&db_botao=true'</script>";
}
...
<script type="text/javascript">
  ...
  function js_novo(){
    ...
    parent.iframe_compnome.location.href='itb1_itbinomecomp001.php?it03_guia='+document.form1.it03_guia.value;
  }
...
function js_mostracgm(chave,erro){
  ...
  parent.iframe_compnome.location.href='itb1_itbinomecomp001.php?mostraitbinomecgm=t&it21_numcgm='+document.form1.it21_numcgm.value+'&it03_guia='+document.form1.it03_guia.value;
}
...
function js_mostracgm1(chave1,chave2){
  ...
  db_iframe_cgm.hide();
  parent.iframe_compnome.location.href='itb1_itbinomecomp001.php?mostraitbinomecgm=t&it21_numcgm='+chave1+'&z01_nome='+chave2+'&it03_guia='+document.form1.it03_guia.value;
}
