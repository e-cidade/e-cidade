         ...
         <fieldset>
             ...
             <table border="0">
                 ...
                 <tr>
                     ...
                     <td>
                         <?
                            $aUsaPCASP = array('f' => 'Não', 't' => 'Sim');
                            db_select('c90_usapcasp', $aUsaPCASP, true, 1, "style='width:80px;'");
                            ?>
                     </td>
                 </tr>
                 <tr>
                     <td nowrap title="<?= @$Tc90_dataimplantacao ?>">
                         <?= @$Lc90_dataimplantacao ?>
                     </td>
                     <td>
                         <? db_inputdata("c90_dataimplantacao", @$c90_dataimplantacao_dia, @$c90_dataimplantacao_mes, @$c90_dataimplantacao_ano, true, "text", $db_opcao, ""); ?>
                        </td>
                 </tr>
             </table>
         </fieldset>
