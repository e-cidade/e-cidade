  							...
  							<fieldset class="separator">
    							...
    							<table>
    								...
    								<tr>
    									...
    									<td>
    										<? db_inputdatasaude( 'document.form1.sd27_i_codigo.value','sd23_d_consulta',@$sd23_d_consulta_dia,@$sd23_d_consulta_mes,@$sd23_d_consulta_ano,true,'text',$db_opcao," onchange='js_diasem(1)' onFocus=\"nextfield='sd03_i_codigo2'\" ", "", "", "parent.js_diasem(1); "); ?>
    									</td>
    									<td colspan="2">
    										<?
