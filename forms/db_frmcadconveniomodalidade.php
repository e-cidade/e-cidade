...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tar15_sequencial?>">
       <?=@$Lar15_sequencial?>
    </td>
    <td>
<?
db_input('ar15_sequencial',10,$Iar15_sequencial,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tar15_nome?>">
       <?=@$Lar15_nome?>
    </td>
    <td>
<?
db_input('ar15_nome',50,$Iar15_nome,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
