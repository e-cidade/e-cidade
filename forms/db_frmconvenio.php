                        ...
                        <table>
                            <tr>
                                <td nowrap title="<?= @$Tr56_posq01 ?>">
                                    <strong>01 VALOR:</strong>
                                </td>
                                <td>
                                    <?
                                    db_input('r56_posq011', 4, $Ir56_posq01, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição valor da rubrica 1\",\"f\",\"t\",event);'");
                                    db_input('r56_posq012', 4, $Ir56_posq01, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição valor da rubrica 1\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                                <td>
                                    <strong>QUANTIDADE: </strong>
                                    <?
                                    db_input('r56_posq041', 4, $Ir56_posq04, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 1\",\"f\",\"t\",event);'");
                                    db_input('r56_posq042', 4, $Ir56_posq04, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 1\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap title="<?= @$Tr56_posq02 ?>">
                                    <strong>02 VALOR:</strong>
                                </td>
                                <td>
                                    <?
                                    db_input('r56_posq021', 4, $Ir56_posq02, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição valor da rubrica 2\",\"f\",\"t\",event);'");
                                    db_input('r56_posq022', 4, $Ir56_posq02, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição valor da rubrica 2\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                                <td>
                                    <strong>QUANTIDADE: </strong>
                                    <?
                                    db_input('r56_posq051', 4, $Ir56_posq05, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 2\",\"f\",\"t\",event);'");
                                    db_input('r56_posq052', 4, $Ir56_posq05, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 2\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                            </tr>
                            <tr>
                                <td nowrap title="<?= @$Tr56_posq03 ?>">
                                    <strong>03 VALOR:</strong>
                                </td>
                                <td>
                                    <?
                                    db_input('r56_posq031', 4, $Ir56_posq03, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição Valor da rubrica 3\",\"f\",\"t\",event);'");
                                    db_input('r56_posq032', 4, $Ir56_posq03, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição Valor da rubrica 3\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                                <td>
                                    <strong>QUANTIDADE: </strong>
                                    <?
                                    db_input('r56_posq061', 4, $Ir56_posq06, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 3\",\"f\",\"t\",event);'");
                                    db_input('r56_posq062', 4, $Ir56_posq06, true, 'text', $db_opcao, "onChange='js_preenche_zeros(this.name);' onKeyUp='js_controla_campo(this.name);js_ValidaCampos(this,1,\"Posição quantidade da rubrica 3\",\"f\",\"t\",event);'");
                                    ?>
                                </td>
                            </tr>
                        </table>
...
<script>
    function js_verifica_posicoes() {
        ...
        if (x.r56_codrel.value == "") {
            ...
            alert("Posição do valor (01) incorreto.");
        ...
        else if ((x.r56_posq041.value != "" && x.r56_posq042.value == "") || (x.r56_posq041.value == "" && x.r56_posq042.value != "") || x.r56_posq041.value == "000" || x.r56_posq042.value == "000") {
            alert("Posição da quantidade (01) incorreto.");
            x.r56_posq041.select();
            x.r56_posq041.focus();
            return false;
        }
        else if ((x.r56_posq051.value != "" && x.r56_posq052.value == "") || (x.r56_posq051.value == "" && x.r56_posq052.value != "") || x.r56_posq051.value == "000" || x.r56_posq052.value == "000") {
            alert("Posição da quantidade (01) incorreto.");
            x.r56_posq051.select();
            x.r56_posq051.focus();
            return false;
        } else if ((x.r56_posq061.value != "" && x.r56_posq062.value == "") || (x.r56_posq061.value == "" && x.r56_posq062.value != "") || x.r56_posq061.value == "000" || x.r56_posq062.value == "000") {
            alert("Posição da quantidade (01) incorreto.");
            x.r56_posq061.select();
            x.r56_posq061.focus();
            return false;
        }
        return true;
