...
<form name="form1" method="post" action="">
    ...
    <fieldset style="margin-top: 20px; width: 750px;">
        ...
        <table border="0" align='left'>
            ...
            <tr>
                ...
                <td>
                    ...
                    db_inputdata(
                        ...
                        @$k29_datasaldocontasextra_mes,
                        @$k29_datasaldocontasextra_ano,
                        true,
                        'text',
                        $db_opcao,
                        ""
            ...
            <tr>
                <td nowrap title="<?= @$Tk29_exibeobservacao ?>">
                    <?= @$Lk29_exibeobservacao ?>
                </td>
                <td>
                    <?
                    $x = array('f' => 'Não', 't' => 'Sim');
                    db_select('k29_exibeobservacao', $x, true, $db_opcao, "");
                    ?>
                </td>
            </tr>
        </table>
        ...
        <fieldset style="width: 97%; border-left: none; border-right: none; border-bottom: none;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $aTipoTransmissao = array("1" => "CNAB240", "2" => "OBN");
                        db_select('tipo_transmissao', $aTipoTransmissao, true, $db_opcao);
                        ?>
                    </td>
                </tr>
