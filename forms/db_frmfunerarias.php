...
function js_pesquisacm17_i_funeraria(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.cm17_i_funeraria.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.cm17_i_funeraria.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_mostracgm(chave,erro){
  ...
  if(erro==true){
    document.form1.cm17_i_funeraria.focus();
    document.form1.cm17_i_funeraria.value = '';
  }
}
function js_mostracgm1(chave1,chave2){
  document.form1.cm17_i_funeraria.value = chave1;
  document.form1.z01_nome.value = chave2;
  db_iframe_cgm.hide();
}
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_funerarias','func_funerarias.php?funcao_js=parent.js_preenchepesquisa|cm17_i_funeraria','Pesquisa',true);
}
