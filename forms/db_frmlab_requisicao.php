    ...
    <fieldset>
      ...
      <fieldset>
        ...
        <table class="form-container alinhaColuna">
          ...
          <tr>
            <td>
              <b><?php echo $Lla24_i_laboratorio; ?></b>
            </td>
            <td>
              <?php
            ...
            <td>
              <a onclick="pegaPosMouse(event);js_calendario();"
               id="ancora_calend"
...
var aHeader = ['Cod.', 'Laboratório', 'Exame', 'Quantidade', 'Coleta', 'Hora', 'Entrega', 'Opções','Urgênte'];
...
function js_autorizaExames() {
  ...
  oParametros.aExemes     = aSelecionados;
