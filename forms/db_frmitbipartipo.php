  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cargrup','func_cargrup.php?funcao_js=parent.js_mostracargrup1|j32_grupo|j32_descr','Pesquisa',true);
     ...
     if(document.form1.it12_grupo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cargrup','func_cargrup.php?pesquisa_chave='+document.form1.it12_grupo.value+'&funcao_js=parent.js_mostracargrup','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_itbipartipo','func_itbipartipo.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
