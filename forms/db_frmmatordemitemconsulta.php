...
require(__DIR__ . "/../std/label/rotulocampo.php");
require(__DIR__ . "/../std/label/RotuloCampoDB.php");
require(__DIR__ . "/../std/label/RotuloDB.php");
require(__DIR__ . "/../std/label/rotulo.php");
