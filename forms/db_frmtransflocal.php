...
//MODULO: educação
$cltransflocal->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Ted131_i_codigo?>">
       <?=@$Led131_i_codigo?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Ted131_i_escola?>">
       <?=@$Led131_i_escola?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Ted131_i_alunocurso?>">
       <?=@$Led131_i_alunocurso?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Ted131_i_curso?>">
       <?=@$Led131_i_curso?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Ted131_i_transfrede?>">
       <?=@$Led131_i_transfrede?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Ted131_c_situacao?>">
       <?=@$Led131_c_situacao?>
    </td>
    <td>
<?
