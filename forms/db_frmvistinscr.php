...
function js_pesquisay71_codvist(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistorias','func_vistorias.php?pesquisa_chave='+document.form1.y71_codvist.value+'&funcao_js=parent.js_mostravistorias','Pesquisa',false);
  }
}
...
function js_pesquisay71_inscr(mostra){
  if(mostra==true){
    ...
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_issbase','func_issbase.php?pesquisa_chave='+document.form1.y71_inscr.value+'&funcao_js=parent.js_mostraissbase','Pesquisa',false);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_vistinscr','func_vistinscr.php?funcao_js=parent.js_preenchepesquisa|y71_codvist','Pesquisa',true);
}
