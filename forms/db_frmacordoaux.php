    ...
    function js_pesquisaac16_contratado(mostra) {
        ...
        if (mostra == true) {
            ...
            js_OpenJanelaIframe(
                ...
                'db_iframe_contratado',
                'func_pcforne.php?infoValidacaoRepresentanteAcordo=true&validacaoCadastroFornecedor=true&validaRepresentante=true&funcao_js=parent.js_mostracontratado1|z01_nome|pc60_numcgm|z01_cgccpf',
                'Pesquisa',
                true,
                '0',
                '1'
