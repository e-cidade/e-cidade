...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcparamseqcoluna','func_orcparamseqcoluna.php?funcao_js=parent.js_preenchepesquisa|o115_sequencial','Pesquisa',true);
}
