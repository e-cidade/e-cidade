    ...
    <tr>
      <td align="center">
        <fieldset>
          ...
          <table width="100%">
            <tr>
              <td nowrap title="<?= @$Trh05_recis ?>" align="left">
                <?= @$Lrh05_recis ?>
              </td>
              <td>
                <?php db_inputdata(
            ...
            <tr>
              <td nowrap title="<?= @$Trh05_causa ?>" align="left">
            ...
            <tr>
              <td nowrap title="<?= @$Trh05_caub ?>" align="left">
            ...
            <tr>
              <td nowrap title="<?= @$Trh05_taviso ?>" align="left">
                <?php
            ...
            <tr>
              <td nowrap title="<?= @$Trh05_aviso ?>" align="left">
                <?= @$Lrh05_aviso ?>
              </td>
              <td>
                <?php db_inputdata(
            ...
            <tr>
              <td nowrap title="<?= @$Trh05_mremun ?>" align="left">
