...
//$result_tipo = $claverbatipo->sql_record($claverbatipo->sql_query("","*","j93_codigo"));
    ...
    <?
	   ...
	   ?>
	    <tr>
           ...
           $yy = array('1'=>'Sim','2'=>'Não');
           db_select('guia',$yy,true,$db_opcao,"onChange='js_mostraGuiaSistema(document.form1.guia.value);'");
           ?>
           </td>
        </tr>
	   <tr id="guia_sim" >
...
db_select('j75_situacao',$yy,true,3,"");
  ...
  <br>
	...
	<?
	 ...
	 if(!isset($cadastromunicipal)) {
		 if(isset($botaoprocessar) and $botaoprocessar== true ){ ?>
