  ...
  function js_pesquisam63_codpcmater(mostra) {
    if (mostra == true) {
      ...
      if (document.form1.m63_codpcmater.value != '') {
        js_OpenJanelaIframe('', 'db_iframe_pcmater', 'func_pcmater.php?pesquisa_chave=' + document.form1.m63_codpcmater.value + '&funcao_js=parent.js_mostrapcmater', 'Pesquisa', false);
      } else {
