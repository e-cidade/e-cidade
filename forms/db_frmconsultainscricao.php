        ...
        <form name="form1" method="post" action="">
            <table>
                ...
                <?php if ($parametrosRedesim->q180_active) { ?>
                    <tr>
                        <td nowrap>
                            <strong>Inscrição REDESIM:</strong></td>
                        <td nowrap>
                ...
                <tr>
                    <td nowrap>
                        <strong>Escritório de contabilidade:</strong></td>
                    <td nowrap>
                ...
                <tr>
                    <td nowrap>
                        <strong>Código do bairro :</strong>
                    </td>
                    <td nowrap>
