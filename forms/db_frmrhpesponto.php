...
<table border="0">
    ...
    <td>
      <fieldset>
        ...
        <table align="center">
				  ...
				  <tr>
				    <td align="right" nowrap title="<?=@$Tr90_lotac?>">
				      <?
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      <table border="0">
        <tr>
          <td id="ancoraEnable" align="left" nowrap title="<?=@$Tr90_rubric?>">
            <?
...
function js_mostrarubricas(chave,chave2,chave3,chave4,chave5,chave6,erro){
...
function js_mostrarubricas1(chave1,chave2,chave3,chave4,chave5,chave6,chave7){
