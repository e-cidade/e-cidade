  ...
  <center>
    <fieldset style="width: 500px">
      ...
      <table border="0">
        ...
        <tr>
          <td nowrap title="<?php echo $Te81_codmov; ?>">
        ...
        <tr>
          ...
          <td>
            <?php db_inputdata('e45_datalimiteaplicacao', $e45_datalimiteaplicacao_dia, $e45_datalimiteaplicacao_mes, $e45_datalimiteaplicacao_ano, true, 'text', $db_opcao); ?>
          </td>
        </tr>
        <tr>
