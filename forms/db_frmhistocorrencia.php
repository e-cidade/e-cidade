...
//	js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_histocorrencia','func_histocorrencia.php?funcao_js=parent.js_preenchepesquisa|ar23_sequencial','Pesquisa',true);
