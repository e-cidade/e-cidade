...
$result = db_query("select * from veicmanut where ve62_codigo ='".$_GET['ve63_veicmanut']."' ");
$rsResultado = db_utils::getCollectionByRecord($result);
//var_dump($rsResultado[0]);
$fValorTotal = ($rsResultado[0]->ve62_valor);
//echo $fValorTotal;
?>
...
<td colspan="2" width="100%">
                                <fieldset>
                                  ...
                                  <strong>Valor:</strong>
  <input title="Valor total da manutenção Campo:ve62_valor" style="background-color: #DEB887;" name="ve62_valor" id="ve62_valor" value="<?php echo $fValorTotal; ?>" size="15" maxlength="8" readonly="" onblur="js_ValidaMaiusculo(this,'f',event);" oninput="js_ValidaCampos(this,4,'Valor','f','f',event);" onkeydown="return js_controla_tecla_enter(this,event);" autocomplete="off" type="text">
                                  </fieldset>
                              </td>
</table>
<table>
  <tr>
    <td valign="top"  align="center">
      ...
      $cliframe_alterar_excluir->campos        = "ve63_codigo,ve63_veicmanut,ve63_descr,ve63_quant,ve63_vlruni,ve64_pcmater,pc01_descrmater,ve63_vlrtot";
