...
function js_pesquisa(){
  ...
  ?>
  js_OpenJanelaIframe('','db_iframe_rhbases','func_basesdescontos.php?funcao_js=parent.js_preenchepesquisa|r08_codigo&instit=<?=db_getsession("DB_instit")?>','Pesquisa',true,<?=$altura?>);
}
