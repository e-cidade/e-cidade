...
function js_pesquisaat27_atendcadarea(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_atendcadarea','func_atendcadarea.php?funcao_js=parent.js_mostraatendcadarea1|at26_sequencial|at25_descr','Pesquisa',true);
  }else{
     if(document.form1.at27_atendcadarea.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_atendcadarea','func_atendcadarea.php?pesquisa_chave='+document.form1.at27_atendcadarea.value+'&funcao_js=parent.js_mostraatendcadarea','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
     ...
     if(document.form1.at27_usuarios.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.at27_usuarios.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_atendareatec','func_atendareatec.php?funcao_js=parent.js_preenchepesquisa|at27_sequencial','Pesquisa',true);
}
