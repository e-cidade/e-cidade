...
<form name="form1" method="post">
	<table width='100%'>
		<tr>
			<td>
				<fieldset><legend>Anular Agendamento</legend>
				<table width='100%'>
					<tr>
						<td valign="top">
					...
					<tr>
						<td><br>
							<fieldset><legend>Pacientes Agendados:</legend>
          ...
          <tr>
              ...
              <select multiple  name='select_agendamento[]' id='select_agendamento' style="display: none;">
					...
					<tr>
						<td align="center">
             	<fieldset id='fieldsetAnulacao' style="display: none;"><legend>Informa&ccedil;&otilde;es da Anula&ccedil;&atilde;o</legend>
                <table border="0">
                  <tr>
                    <td nowrap>
                      <b>Data Anula&ccedil;&atilde;o:</b>
                    </td>
                    <td> 
                      <?
...
function show_calendarsaudeAutomatico(obj, shutdown_function, especmed) {
  ...
  js_OpenJanelaIframe('','iframe_data_'+obj,'func_calendariosaude2.php?nome_objeto_data='+obj+'&shutdown_function='+shutdown_function+'&sd27_i_codigo='+especmed+'&fechar=true','Calend&aacute;rio',true,PosMouseY,PosMouseX,250,270);
