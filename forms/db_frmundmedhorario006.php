                  ...
                  <td rowspan="2">
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                           <input type="checkbox" name="chk_seg" value="2" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 2 ? 'checked' : '' ?> >Seg
                           <input type="checkbox" name="chk_ter" value="3" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 3 ? 'checked' : '' ?> >Ter
                           <input type="checkbox" name="chk_qua" value="4" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 4 ? 'checked' : '' ?> >Qua<br>
                           <input type="checkbox" name="chk_qui" value="5" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 5 ? 'checked' : '' ?> >Qui
                           <input type="checkbox" name="chk_sex" value="6" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 6 ? 'checked' : '' ?> >Sex
                           <input type="checkbox" name="chk_sab" value="7" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 7 ? 'checked' : '' ?> >Sáb
                           <input type="checkbox" name="chk_dom" value="1" onchange="js_diasemana(<?php echo $db_opcao?>, this)" <?php echo $db_opcao != 1 ? 'disabled1' : '' ?> <?php echo @$sd30_i_diasemana == 1 ? 'checked' : '' ?> >Dom
...
(function () {
  ...
  if ( ($('possui_agenda') && $F('possui_agenda') == "t") || lValidaDataFinal ) {
    ...
    $('sd30_c_tipograde').disabled  = "disabled";
    $('sd30_i_tipoficha').disabled  = "disabled";
