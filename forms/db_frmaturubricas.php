...
<table border="0" cellspacing="8" cellpadding="0">
  <tr>
    <td align='center'>
      <hr>
      <b>Rubrica: <?=$rubrica." - ".$rh27_descr?><i><?=str_repeat("&nbsp;",5)?>(<?=($iae=="i"?"Inclusão":($iae=="a"?"Alteração":"Exclusão"))?>)</i></b>
      <hr>
    </td>
  </tr>
  <tr>
...
db_input('rubrica',15, "", true, 'hidden', 3);
db_input('selecao',15, "", true, 'hidden', 3);
