...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Trh03_seqpes?>">
       <?=@$Lrh03_seqpes?>
    </td>
    <td>
<?
db_input('rh03_seqpes',6,$Irh03_seqpes,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Trh03_padrao?>">
       <?=@$Lrh03_padrao?>
    </td>
    <td>
<?
db_input('rh03_padrao',10,$Irh03_padrao,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
