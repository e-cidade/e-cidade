...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_tipoleito','func_sau_tipoleito.php?funcao_js=parent.js_preenchepesquisa|sd80_i_codigo','Pesquisa',true);
}
