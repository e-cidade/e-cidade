...
function js_pesquisao116_codseq(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?funcao_js=parent.js_mostraorcparamseq1|o69_codparamrel|o69_codparamrel','Pesquisa',true,'0','1');
  }else{
     if(document.form1.o116_codseq.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?pesquisa_chave='+document.form1.o116_codseq.value+'&funcao_js=parent.js_mostraorcparamseq','Pesquisa',false);
     }else{
...
function js_pesquisao116_codseq(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?funcao_js=parent.js_mostraorcparamseq1|o69_codseq|o69_codparamrel','Pesquisa',true,'0','1');
  }else{
     if(document.form1.o116_codseq.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?pesquisa_chave='+document.form1.o116_codseq.value+'&funcao_js=parent.js_mostraorcparamseq','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?funcao_js=parent.js_mostraorcparamseq1|o69_codparamrel|o69_codparamrel','Pesquisa',true,'0','1');
     ...
     if(document.form1.o116_codparamrel.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseq','func_orcparamseq.php?pesquisa_chave='+document.form1.o116_codparamrel.value+'&funcao_js=parent.js_mostraorcparamseq','Pesquisa',false);
     }else{
       document.form1.o69_codparamrel.value = '';
     }
  }
...
function js_pesquisao116_orcparamseqcoluna(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseqcoluna','func_orcparamseqcoluna.php?funcao_js=parent.js_mostraorcparamseqcoluna1|o115_sequencial|o115_descricao','Pesquisa',true,'0','1');
  }else{
     if(document.form1.o116_orcparamseqcoluna.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna','db_iframe_orcparamseqcoluna','func_orcparamseqcoluna.php?pesquisa_chave='+document.form1.o116_orcparamseqcoluna.value+'&funcao_js=parent.js_mostraorcparamseqcoluna','Pesquisa',false);
     }else{
