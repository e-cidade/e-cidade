...
function js_pesquisave41_veiccadcentral(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmotoristascentral','db_iframe_veiccadcentral','func_veiccadcentral.php?funcao_js=parent.js_mostraveiccadcentral1|ve36_sequencial|descrdepto','Pesquisa',true,'0');
  }else{
     if(document.form1.ve41_veiccadcentral.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_veicmotoristascentral','db_iframe_veiccadcentral','func_veiccadcentral.php?pesquisa_chave='+document.form1.ve41_veiccadcentral.value+'&funcao_js=parent.js_mostraveiccadcentral','Pesquisa',false);
     }else{
