    ...
    <table width='80%' cellspacing='0' style='padding:0px' border='0'>
                        ...
                        <tr>
                            ...
                            <td colspan='3' nowrap>
                                ...
                                $rsEmpAnuladoTipo = $oEmpAnuladoTipo->sql_record(
                                    $oEmpAnuladoTipo->sql_query(null,"*","e38_sequencial")
                                );
                                $e94_empanuladotipo = $sTipoDeAnulacaoPadrao;
                                db_selectrecord("e94_empanuladotipo",$rsEmpAnuladoTipo,true,1);
                                ?>
                                <input type='checkbox' name='imprimir' id='imprimir' value='1'>
                                <label for='imprimir'>Imprimir Documento</label></td>
                            </td>
                        </tr>
                    </table>
                </fieldset>
        ...
        <tr style="display:<?=$sMostraItens;?>">
            <td colspan='2'>
              ...
              js_consultaEmpenho(iNumEmp);ss='table_footer' colspan='1'>&nbsp;</td>
                                 </td>
                              </tr>
                           </tfoot>
                          -->
