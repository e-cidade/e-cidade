    ...
    <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  db_input(
                    ...
                    10,
                    $Iac15_acordopenalidade,
                    true,
                    'text',
                    $db_opcao,
                    " onchange='js_pesquisaac15_acordopenalidade(false);'"
                  );
              ...
              <tr>
                <td nowrap title="<?= @$Tac15_texto ?>" colspan="3">
                  <fieldset>
                    ...
                    <?
                    db_textarea('ac15_texto', 5, 0, $Iac15_texto, true, 'text', $db_opcao, "style='width:100%'", "", "", 100);
                    ?>
                  </fieldset>
                </td>
              </tr>
      ...
      <tr>
        <td colspan="2" align="center">
          <input name="<?= ($db_opcao == 1 ? "incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "alterar" : "excluir")) ?>" type="button" id="db_opcao" value="Incluir">
          <input name="Assinar Contrato" type="button" value="Assinar Contrato" onclick="js_AssinarContrato()">
          <input name="Novo" style="display:none" onclick="js_limpar()" type="button" id="btnNovo" value="Novo">
        </td>
      </tr>
      <tr>
        <td>
...
<script>
  ...
  function js_getPenalidades(iPenalidade) {
    ...
    oParam.iAcordo = document.form1.ac15_acordo.value;
    var oAjax = new Ajax.Request(sUrlRpc, {
      method: 'post',
      parameters: 'json=' + Object.toJSON(oParam),
