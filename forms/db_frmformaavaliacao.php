...
<form name="form1" method="post" action="" onsubmit="return js_validaVariacao()">
  <fieldset style="width:95%">
    <legend><b>Forma de Avaliação</b></legend>
    <center>
            ...
            <span name="nota" id="nota" style="visibility:hidden;">
              <table>
                ...
                <tr>
                  ...
                  <td>
                    <input title="Mínimo para Aprovação Campo:ed37_c_minimoaprov " name="ed37_c_minimoaprovnota" type="text" id="ed37_c_minimoaprovnota" value="<?= @$ed37_c_minimoaprovnota ?>" size="10" maxlength="10" onKeyDown="return js_controla_tecla_enter(this,event);" <?= $db_opcao == 3 ? "disabled bgcolor='#DEB887'" : "" ?>>
                  </td>
                </tr>
              </table>
            </span>
...
<? if (@$ed37_c_tipo == "NIVEL") { ?>
  <center>
    <table width="100%">
      <tr>
        <td align="center">
          <iframe src="" name="iframe_conceitos" id="iframe_conceitos" width="100%" height="400" frameborder="0" scrolling="no">
          </iframe>
        </td>
      </tr>
    </table>
...
<script>
  $("ed37_i_menorvalor").attr("maxlength", 10)
