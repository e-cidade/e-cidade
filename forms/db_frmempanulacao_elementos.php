        ...
        function js_coloca(tot) {
            ...
            for (i = 0; i < obj.length; i++) {
                ...
                if (nome == "generico") {
                    ...
                    anulado = new Number(eval("document.form1.e64_vlranu_" + codele + ".value"));
                    if (tot >= vlrlimite) {
                    ...
                    dados += vir + codele + "-" + obj[i].value + "-" + anulado;
                    vir = '#';
                }
            }
        ...
        function js_calcular() {
            ...
            for (i = 0; i < obj.length; i++) {
                ...
                if (nome == "generico") {
                    ...
                    dados += vir + codele + "-" + soma + "-" + anulado;
                    vir = '#';
                    tot = (soma + tot);
                }
            }
            val = new Number(tot);
            parent.document.form1.vlranu.value = val.toFixed(2);
            parent.document.form1.dados.value = dados;
        }
    ...
    <table border="0" cellspacing="0" cellpadding="0" width='100%'>
	    ...
	    <tr class='bordas'>
	      ...
	      <td class='bordas' align='center'><b><small>$RLe64_vlranu</small></b></td>
              ...
              <td class='bordas' align='center'><b><small>Valor disponivel</small></b></td>
	      <td class='bordas' align='center'><b><small>Valor à anular</small></b></td>
	  </tr>
	  ";
                                    for ($i = 0; $i < $numrows; $i++) {
	            ...
	            <td	 class='bordas_corp' align='center' title='$o56_descr'><small>" . substr($o56_descr, 0, 11) . "...</small></td>
       	            <td	 class='bordas_corp' align='center'><small>";
                                        db_input("e64_vlremp_$o56_codele", 8, 0, true, 'text', 3);
                                        echo "\n</small></td>
	            <td	 class='bordas_corp' align='center'><small>";
                                        db_input("e64_vlrliq_$o56_codele", 8, 0, true, 'text', 3);
                                        echo "</small></td>
                    <td	 class='bordas_corp' align='center'><small>";
                                        db_input("e64_vlranu_$o56_codele", 8, 0, true, 'text', 3);
                                        echo "</small></td>
                    <td	 class='bordas_corp' align='center'><small>";
                                        db_input("e64_vlrpag_$o56_codele", 8, 0, true, 'text', 3);
                                        echo "</small></td>
                    <td	 class='bordas_corp' align='center'><small>";
                                        db_input("disponivel_$o56_codele", 8, 0, true, 'text', 3);
                                        echo "</small></td>
                    <td	 class='bordas_corp' align='center'><small>";
                                        db_input("generico_$o56_codele", 8, 4, true, 'text', $db_opcao, "onchange='js_verificar(this,$vlrdis);'") . "</small></td>
	          </tr>
	         ";
                                    }
                                }
