...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
 ...
 <tr valign="top">
  <td width="45%" valign="top">
   <fieldset style="height:210px"><legend><b>Endereço Residencial / Contato do Aluno</b></legend>
    <table border="0" cellspacing="1" cellpadding="0" width="100%">
     <tr>
      <td colspan="2">
       <b>Libera Endereço:</b>
...
var oSelectContato             = document.createElement('select');
    ...
    oSelectContato.add(new Option('Mãe', 1));
    oSelectContato.add(new Option('Pai', 2));
...
function js_validaCadastroCidadaoFiliacao() {
  ...
  if ($F('ed47_i_filiacao') == 1) {
    ...
    if ( empty(oInputCodigoMae.value) && empty(oInputCodigoPai.value) ) {
      oVariavel.sMensagem = 'Pai e/ou Mãe';
    }
