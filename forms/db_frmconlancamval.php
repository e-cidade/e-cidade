  ...
  <tr>
    <td nowrap title="<?=@$Tc69_debito ?>">
      ...
      <div id='ctnDebito' style="font-weight: bold; ">
        ...
        <a class='dbancora' onclick='js_pesquisac69_debito(true);' style='text-decoration: underline;' href='#'>
          Conta Débito:
        </a>
      </div>
  ...
  <tr>
    <td nowrap title="<?=@$Tc69_credito ?>">
      <div id='ctnCredito' style="font-weight: bold;">
        ...
        <a class='dbancora' onclick='js_pesquisac69_credito(true);' style='text-decoration: underline;' href='#'>
          Conta Crédito:
        </a>
      </div>
  ...
  <tr>
    <td nowrap title="<?=@$Tc69_codhist ?>">
      ...
      <div id='ctnHistorico' style="font-weight: bold;">
        ...
        <a class='dbancora' onclick='js_pesquisac69_codhist(true);' style='text-decoration: underline;' href='#'>
          Histórico:
        </a>
      </div>
...
if (!isset($consulta)) {
	if ($db_opcao != "33") {
 ?>
       <input name="db_opcao" type="button" id="db_opcao" value="<?=($db_opcao
				== 1 ? "Incluir"
				: ($db_opcao == 2 || $db_opcao == 22 ? "Alterar" : "Excluir"))
																 ?>"           <?=($db_botao
																				 == false ? "disabled"
																				 : "")
...
/**
    ...
    onde foi acrescentado logica para seleção de documentos
    do tipo 3000
