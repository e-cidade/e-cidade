...
<form name="form1" class="container" id="formulario_principal" method="POST">
    ...
    <td>
      <?php
        if ( $existnota == true ) {
          ...
          db_input('y08_notain',6,$Iy08_notain,true,'text', $opc," class='field-size2'");
        }else{
          db_input('y08_notain',6,$Iy08_notain,true,'text', $opc," class='field-size2'");
        }
      ?>
  ...
  <tr>
    ...
    <td>
      <?php
        db_input('y08_quantsol',6,$Iy08_quantsol,true,'text',$db_opcao," class='field-size2'")
      ?>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <?php
        db_input('y08_quantlib',6,$Iy08_quantlib,true,'text',$db_opcao,"onchange='js_notafin(this.value);' class='field-size2'")
      ?>
    </td>
  </tr>
  <tr>
