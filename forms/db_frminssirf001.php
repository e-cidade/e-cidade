                    ...
                    <fieldset>
                        ...
                        <table width="100%">
                            ...
                            if ($alteraform == true) {
                                ...
                                $sSqlInssirf = $clinssirf->sql_query_dados(
                                    null,
                                    "r33_nome,
																									r33_tipo,
																									r33_rubmat,
                            ...
                            <? if ($codtab > 2) { ?>
                                <tr>
                                    ...
                                    <td nowrap title="<?= $Tr33_tiporegime ?>">
                                        <?= $Lr33_tiporegime ?>
                                    </td>
                                    <td nowrap title="<?= $Tr33_tiporegime ?>">
                                        <?
                                        $arr_tiposregime = array("0" => "Selecione", "1" => "RGPS", "2" => "RPPS");
                                        db_select("r33_tiporegime", $arr_tiposregime, true, $db_opcao);
                                        ?>
                                    </td>
                                </tr>
                            <? } ?>
