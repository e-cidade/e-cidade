...
<form name="form1" method="post" action="" >
  <table width="90%" height="" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
	<tr>
...
//							 $sqlAutentica .= "			   rireceita      as db_receita, ";
							 ...
							 $sqlAutentica .= "       inner join conciliapendcorrente on ricaixa            = k89_id ";
							 $sqlAutentica .= "                                      and riautent           = k89_autent ";
							 $sqlAutentica .= "                                      and ridata             = k89_data ";
							 $sqlAutentica .= "                                      and k89_conciliaorigem = 3 ";
...
function js_ajaxRequest(obj){
  var url       = 'cai4_carregadatasexcluiimplantacao.php';
