...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_colecaoacervo','func_colecaoacervo.php?funcao_js=parent.js_preenchepesquisa|bi29_sequencial','Pesquisa',true);
}
