...
function js_pesquisasd35_i_familia(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_familia','func_familia.php?funcao_js=parent.js_mostrafamilia1|sd33_i_codigo|sd33_v_descricao','Pesquisa',true);
  }else{
     if(document.form1.sd35_i_familia.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_familia','func_familia.php?pesquisa_chave='+document.form1.sd35_i_familia.value+'&funcao_js=parent.js_mostrafamilia','Pesquisa',false );
     }else{
...
function js_pesquisasd35_i_microarea(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_microarea','func_microarea.php?funcao_js=parent.js_mostramicroarea1|sd34_i_codigo|sd34_v_descricao','Pesquisa',true);
  }else{
     if(document.form1.sd35_i_microarea.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_microarea','func_microarea.php?pesquisa_chave='+document.form1.sd35_i_microarea.value+'&funcao_js=parent.js_mostramicroarea','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_familiamicroarea','func_familiamicroarea.php?funcao_js=parent.js_preenchepesquisa|sd35_i_codigo','Pesquisa',true);
}
