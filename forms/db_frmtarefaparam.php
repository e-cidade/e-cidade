...
//MODULO: atendimento
$cltarefaparam->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tat53_horasdia?>">
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tat53_horaini_manha?>">
       <?=@$Lat53_horaini_manha?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tat53_horafim_manha?>">
       <?=@$Lat53_horafim_manha?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tat53_horaini_tarde?>">
       <?=@$Lat53_horaini_tarde?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tat53_horafim_tarde?>">
       <?=@$Lat53_horafim_tarde?>
    </td>
    <td>
<?
