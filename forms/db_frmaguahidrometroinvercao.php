...
<div class="container">
  <form class='form' name="form1" method="post" action="">
    <fieldset>
      <legend>
        <b>Inver&ccedil;&atilde;o de hidr&ocirc;metros</b>
      </legend>
        ...
        <fieldset class='fieldsetinterno'>
          ...
          <table>
            <tr>
              ...
              <td>
              <?php
                db_input('x04_nrohidro_destino',30,$Ix04_nrohidro,true,'text',3,'','x04_nrohidro_destino');
                db_input('x04_codhidrometro_destino',6,$Ix04_codhidrometro,true,'hidden',3,'','x04_codhidrometro_destino');
              ?>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <?php db_input('x04_qtddigito_destino',12,$Ix04_qtddigito,true,'text',3,'','x04_qtddigito_destino'); ?>
              </td>
            </tr>
            <tr>
              <td title="<?=@$Tx03_nomemarca?>">
              ...
              <td>
                <?php db_input('x03_nomemarca_destino',30,$Ix03_nomemarca,true,'text',3,'','x03_nomemarca_destino'); ?>
              </td>
            </tr>
            <tr>
              <td title="<?=@$Tx15_diametro?>">
              ...
              <td>
                <?php db_input('x15_diametro_destino',12,$Ix15_diametro,true,'text',3,'','x15_diametro_destino'); ?>
              </td>
            </tr>
            <tr>
              <td title="<?=@$Tx04_dtinst?>">
              ...
              <td>
                <?php db_inputdata('x04_dtinst_destino',@$x21_dtleituraant_dia,@$x21_dtleituraant_mes,@$x21_dtleituraant_ano,true,'text',3,'','x04_dtinst_destino');
                //db_input('x04_dtinst_destino',8,$Ix04_dtinst,true,'text',3,'','x04_dtinst_destino'); ?>
              </td>
            </tr>
            <tr>
              <td title="<?=@$Tx04_leitinicial?>">
              ...
              <td>
                <?php db_input('x04_leitinicial_destino',8,$Ix04_leitinicial,true,'text',3,'','x04_leitinicial_destino'); ?>
              </td>
            </tr>
            <tr>
              <td title="<?=@$Tx04_observacao?>">
              ...
              <td>
                <?php db_textarea('x04_observacao_destino',4,47,$Ix04_observacao,true,'text',3,'','x04_observacao_destino'); ?>
              </td>
            </tr>
          </table>
        </fieldset>
...
<script type="text/javascript" language="javascript">
  ...
  function js_pesquisa_x04_matric_origem(mostra) {
    ...
    if (mostra == true) {
      ...
      if (document.form1.x04_matric_origem.value != '' && document.form1.x04_matric_origem.value != document.form1.x04_matric_destino.value) {
        ...
        js_limpa_dados_hidrometro_origem();
  ...
  function js_limpa_dados_hidrometro_origem() {
  ...
  function js_pesquisa_x04_matric_destino(mostra) {
    ...
    if (mostra == true) {
      ...
      if (document.form1.x04_matric_destino.value != '' && document.form1.x04_matric_destino.value != document.form1.x04_matric_origem.value) {
        ...
        js_limpa_dados_hidrometro_destino();
  ...
  function js_retornoProcessamento_destino(oAjax) {
    ...
    if (oRetorno.status == 1) {
      ...
      document.form1.x04_nrohidro_destino.value      = oRetorno.aDadosHidrometro[0]['x04_nrohidro'].urlDecode();
      document.form1.x04_codhidrometro_destino.value = oRetorno.aDadosHidrometro[0]['x04_codhidrometro'].urlDecode();
      document.form1.x04_qtddigito_destino.value     = oRetorno.aDadosHidrometro[0]['x04_qtddigito'].urlDecode();
      document.form1.x03_nomemarca_destino.value     = oRetorno.aDadosHidrometro[0]['x03_nomemarca'].urlDecode();
      document.form1.x15_diametro_destino.value      = oRetorno.aDadosHidrometro[0]['x15_diametro'].urlDecode();
      document.form1.x04_leitinicial_destino.value   = oRetorno.aDadosHidrometro[0]['x04_leitinicial'].urlDecode();
      document.form1.x04_observacao_destino.value    = oRetorno.aDadosHidrometro[0]['x04_observacao'].urlDecode();
      document.form1.x04_dtinst_destino.value        = js_formatar(oRetorno.aDadosHidrometro[0]['x04_dtinst'].urlDecode(),'d');
  ...
  function js_limpa_dados_hidrometro_destino() {

    document.form1.x04_matric_destino.value        = '';
    document.form1.z01_nome_destino.value          = '';
    document.form1.x04_nrohidro_destino.value      = '';
    document.form1.x04_codhidrometro_destino.value = '';
    document.form1.x04_qtddigito_destino.value     = '';
    document.form1.x03_nomemarca_destino.value     = '';
    document.form1.x15_diametro_destino.value      = '';
    document.form1.x04_leitinicial_destino.value   = '';
    document.form1.x04_observacao_destino.value    = '';
    document.form1.x04_dtinst_destino.value        = '';
