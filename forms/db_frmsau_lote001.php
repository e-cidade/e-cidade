	...
	<td colspan="3">
		...
		<table>
			...
			<tr>
				...
				<td colspan=3>
					<?
					  db_inputdata('z01_d_nasc',@$z01_d_nasc_dia,@$z01_d_nasc_mes,@$z01_d_nasc_ano,true,"text\"  onFocus='js_foco(this, \"sd70_c_cid\");' ",$db_opcao, "onchange='js_atualizarIdade();'", "", "", "parent.js_atualizarIdade();");
					  $iIdade = "";
