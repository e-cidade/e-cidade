...
if($ed110_i_numsuspdisc==0){
 db_msgbox("N° de suspensões disciplinares é zero (Configurações)!");
 $db_opcao = 3;
 $db_opcao1 = 3;
 $db_botao = false;
}
...
<table border="0">
 <tr>
  <td nowrap title="<?=@$Ted119_i_codigo?>">
   <?=@$Led119_i_codigo?>
  </td>
  <td>
   <?db_input('ed119_i_codigo',10,$Ied119_i_codigo,true,'text',3,"")?>
  </td>
 </tr>
 <tr>
  <td nowrap title="<?=@$Ted119_i_progmatricula?>">
   <?db_ancora(@$Led119_i_progmatricula,"js_pesquisaed119_i_progmatricula(true);",$db_opcao1);?>
  </td>
  <td>
   <?db_input('ed119_i_progmatricula',10,$Ied119_i_progmatricula,true,'hidden',3,"")?>
 ...
 <tr>
  <td nowrap title="<?=@$Ted119_d_data?>">
   <?=@$Led119_d_data?>
  </td>
  <td>
   <?db_inputdata('ed119_d_data',@$ed119_d_data_dia,@$ed119_d_data_mes,@$ed119_d_data_ano,true,'text',$db_opcao," onchange=\"js_data();\"","","","parent.js_data();","js_data();")?>
  </td>
 </tr>
 <tr>
  <td nowrap title="<?=@$Ted119_t_obs?>">
   <?=@$Led119_t_obs?>
  </td>
  <td>
   <?db_textarea('ed119_t_obs',2,70,$Ied119_t_obs,true,'text',$db_opcao,"")?>
  </td>
 </tr>
</table>
</center>
...
function js_mostraprogmatricula1(chave1,chave2,chave3,chave4,chave5){
 document.form1.ed119_i_progmatricula.value = chave1;
...
function js_data(){
 if(document.form1.ed119_i_progmatricula.value==""){
  alert("Informe a Matrícula!");
  document.form1.ed119_d_data_dia.value = "";
  document.form1.ed119_d_data_mes.value = "";
  document.form1.ed119_d_data_ano.value = "";
  js_pesquisaed119_i_progmatricula(true);
 }else{
  ...
  data = document.form1.ed119_d_data_ano.value+document.form1.ed119_d_data_mes.value+document.form1.ed119_d_data_dia.value;
  if(dataini>data && document.form1.ed119_d_data_dia.value!="" && document.form1.ed119_d_data_mes.value!="" && document.form1.ed119_d_data_ano.value!=""){
   alert("Data deve ser maior que a Data de Início na Classe!");
   document.form1.ed119_d_data_dia.value = "";
   document.form1.ed119_d_data_mes.value = "";
   document.form1.ed119_d_data_ano.value = "";
   document.form1.ed119_d_data_dia.focus();
  }
 }
}
