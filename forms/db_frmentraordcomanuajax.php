     ...
     // aki
      ...
      if (oJson.totalItens > 0){//3
         ...
         for (i = 0; i < oJson.itens.length; i++){
           ...
           if (oJson.itens[i].m70_quant <  nSaldoItemEstoque && oJson.itens[i].pc01_servico == false ){
              lLiberar = true;
           }
...
function js_anularEntrada() {
  ...
  sJson = '{"method":"anularEntradaOrdem","m51_codordem":"'+iCodOrdem+'","e69_codnota":"'+iCodNota+'"}';
  url   = 'mat4_matordemRPC.php';
