...
function js_pesquisat60_id_usuario(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_benscomissao','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
  }else{
     if(document.form1.t60_id_usuario.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_benscomissao','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.t60_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_benscomissao','db_iframe_benscomissao','func_benscomissao.php?funcao_js=parent.js_preenchepesquisa|t60_codcom','Pesquisa',true);
}
