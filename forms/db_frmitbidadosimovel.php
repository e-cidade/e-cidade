...
<center>
  <form name="form1" method="post" action="">
                  ...
                  <fieldset>
                    ...
                    <table width="100%">
                      <tr>
                        ...
                        <td>
                          <?php
                            db_input( 'it01_areaterreno',
                                      20,
                                      $Iit01_areaterreno,
                                      true,
                                      'text',
                                      $db_opcao,
                                      " onblur=\"js_limpaCalculo()\"" );
                          ?>
                        ...
                        <td>
                          <?php
                            db_input( "it01_percentualareatransmitida",
                                      10,
                                      $Iit01_percentualareatransmitida,
                                      true,
                                      "text",
                                      $db_opcao,
                                      " onblur=\"js_calculaPorcentagem(this, $('it01_areatrans'), false)\"" );
                          ?>
                        </td>
                        ...
                        <td  align="right">
                          <?php
                            db_input( 'it01_areatrans',
                                      20,
                                      $Iit01_areatrans,
                                      true,
                                      'text',
                                      $db_opcao,
                                      " onblur=\"js_calculaPorcentagem(this, $('it01_percentualareatransmitida'), true)\"" );
                          ?>
                          <strong><?php echo $sMedida1; ?></strong>
                        </td>
                      </tr>
                      ...
                      <?php } else { ?>
                        ...
                        <tr>
                          ...
                          <td nowrap title="<?php echo @$Tit18_fundos; ?>" align="right">
    ...
    <?php if ( $db_opcao != 1 ) { ?>
      ...
      <input name="liberacao" type="submit" id="liberacao" value="<?=$sBtnLiberacao?>" <?=($db_botao==false?"disabled":"")?>>
