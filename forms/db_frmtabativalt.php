...
if (empty($excluir) && empty($alterar) && isset($opcao) && $opcao != "") {
    $result19 = $cltabativ->sql_record($cltabativ->sql_query($q07_inscr, $q07_seq, '*'));
                    ...
                    <fieldset style="margin-top: 20px;">
                        ...
                        <fieldset class="separator">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td nowrap title="Dados Extras">
                                        <strong>Isenção:</strong>
                                    </td>
                                    <td colspan="2">
                                        <input type="radio" id="escondeCamposDadosExtras" checked name="isencao"
                                               value="n"> Não
                                        <input type="radio" id="mostraCamposDadosExtras" name="isencao"
                                               value="camposIsencao"> Sim
                                    </td>
                                </tr>
                                <!-- Campos isencao-->
                                <tr class="camposIsencao" style="display: none;">
                                    <td nowrap title="Início do período">
                                        <b>Início: </b>
                                    </td>
                                    <td colspan="2">
                                        <?
                                        db_inputdata('q07_dataini_isen', @$q07_dataini_isen_dia, @$q07_dataini_isen_mes, @$q07_dataini_isen_ano, false, 'text', $db_opcao);
                                        ?>
                                    </td>
                                </tr>
                                <tr class="camposIsencao" style="display: none;">
                                    <td nowrap title="Fim do período">
                                        <b>Fim: </b>
                                    </td>
                                    <td colspan="2">
                                        <?
                                        db_inputdata('q07_datafim_isen', @$q07_datafim_isen_dia, @$q07_datafim_isen_mes, @$q07_datafim_isen_ano, false, 'text', $db_opcao, "");
                                        ?>
                                    </td>
                                </tr>
                                <tr class="camposIsencao" style="display: none;">
                                    <td nowrap title="Aliquota">
                                        <b>Alíquota: </b>
                                    </td>
                                    <td colspan="2">
                                        <?php
                                        $arrAliquotas = getAliquotas();
                                        db_select('q07_aliquota_incentivo',$arrAliquotas,true,$db_opcao);
//                                        db_input('q07_aliquota_incentivo', 10, 4, true, 'text', $db_opcao, "");
                                        ?>
                                    </td>
                                </tr>
                                <tr class="camposIsencao" style="display: none;">
                                    ...
                                    <td colspan="2">
                                        <?php
                                        db_textarea('q07_justificaisencao',3,40,'q07_justificaisencao',true,'text',$db_opcao);
                                        ?>
                                    </td>
                                </tr>
                                <!-- fim Campos isencao-->
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
        <tr>
            <td>
                ...
                $campos = "q07_inscr,q07_seq,q88_inscr,q03_ativ,q03_descr,q07_datain,q07_horaini,q07_horafim,q07_datafi,q07_databx,q07_perman,q07_quant,q07_dataini_isen,q07_datafim_isen,q07_aliquota_incentivo,q07_justificaisencao";
...
<script>
    var bHasIsencao = <?=!empty($q07_dataini_isen) ? 'true' : 'false'?>;
    ...
    function js_pesquisaq07_ativ(mostra) {
        ...
        if (CurrentWindow.corpo.iframe_issbase.document.getElementById('z01_cgccpf').value.length == 14) {
            tipo = 'cnpj';
        } else {
            tipo = 'cpf';
        }
...
<script src="./scripts/tabativ/tabativalt/FrmTabAtivManager.js"></script>
<script src="./scripts/tabativ/tabativalt/frmtabativalt.js"></script>
