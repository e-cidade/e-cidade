...
<script>
  ...
  function js_pesquisar(tipo) {
    ...
    if (form.k00_codseqpag.value != "") {
      query += "&k00_codseqpag=" + form.k00_codseqpag.value;
    }
    ...
    if (form.data_para_pagamento.value != '') {
      query += "&data_para_pagamento=" + form.data_para_pagamento.value;
    }
            ...
            <table border='0' style='border-right:2px groove white'>
              ...
              <tr>
                ...
                <td colspan=3 nowrap>
                  ...
                  <?
                  $result05 = $clempagetipo->sql_record($clempagetipo->sql_query(null, "e83_conta, e83_codtipo as codtipo,
                                                                      e83_descr, c61_codigo", "e83_descr"));
                  $numrows05 = $clempagetipo->numrows;
                  $arr['0'] = "Nenhum";
                  for ($r = 0; $r < $numrows05; $r++) {
                    db_fieldsmemory($result05, $r);
              ...
              <tr>
                <td nowrap title="<?= @$k00_codseqpag ?>">
                  <? db_ancora("<b>Ordem Bancária</b>", "js_pesquisak00_codseqpag(true);", $db_opcao); ?>
                </td>
                <td nowrap>
                  <?
                  db_input('k00_codseqpag', 10, $Ik00_codseqpag, true, 'text', $db_opcao, " onchange='js_pesquisak00_codseqpag(false);'");
                  ?>
                </td>
              </tr>

              <tr>
                <td nowrap class="textright">
                  <b>Data para pagamento:</b>
                </td>
                <td colspan='1'>
                  <?php // $dAnoUsu = db_getsession("DB_datausu"); ?>
                  <?php db_inputdata("data_para_pagamento", '', '', '', true, "text", 1); ?>
                </td>
              </tr>
            </table>
          </td>
          <td valign='top' width="20%" height="100%" style='border-right:2px groove white'>
            <table border='0'>
              <tr>
                ...
                <td nowrap>
                  <?= db_input('k17_codigo', 10, '', true, 'text', 1, "onchange='js_slip(false);'") ?>
                </td>
                <td class="textright">
                  <b> <? db_ancora("Até:", "js_slip2(true);", 1); ?></b>
                </td>
                <td>
                  <?= db_input('k17_codigo', 10, '', true, 'text', 1, "onchange='js_slip2(false);'", "k17_codigo2") ?>
              ...
              <tr>
                ...
                <td nowrap class="textright"><b>A</b>
                </td>
                <td nowrap>
                  <?
...
<script>
  ...
  function js_pesquisak00_codseqpag(mostra) {
    if (mostra == true) {
      js_OpenJanelaIframe('CurrentWindow.corpo',
        'db_iframe_ordempag',
        'func_ordembancariapagamento.php?funcao_js=parent.js_mostrak00_codseqpag|ordem',
      ...
      js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_ordempag',
        'func_ordembancariapagamento.php?pesquisa_chave=' + $F('k00_codseqpag') + '&funcao_js=parent.js_mostrak00_codseqpag1', 'Pesquisa', false);
    }
  }
  function js_mostrak00_codseqpag(chave1) {
    document.form1.k00_codseqpag.value = chave1;
    db_iframe_ordempag.hide();
  }
  function js_mostrak00_codseqpag1(chave, erro) {
    if (erro == true) {
      document.form1.k00_codseqpag.value = "";
      document.form1.k00_codseqpag.focus();
    }
  }
