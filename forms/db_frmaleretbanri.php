...
<table border="0">
  ...
  <tr>
    <td align="left" nowrap title="<?=@$Tdb50_codigo?>">
  ...
  <tr>
    ...
    <td>
<?
db_input('r54_codrel',6,$Ir54_codrel,true,'text',1,"onchange='js_pesquisar54_codrel(false);' onblur='document.form1.r56_dirarq.focus()'");
...
?>
      ...
      <tr>
				<td align="left"><strong>Teste:</strong></td>
	<td nowrap align='left'>

               <?
                 $x = array("f"=>"NÃO","t"=>"SIM");
                 db_select('teste',$x,true,4,"");
               ?>
				</td>
      </tr>
...
<input name="gerar" type="submit" id="db_opcao" value="Gerar retorno" <?=($db_botao==false?"disabled":"")?> onclick="return js_verifica_campos();">
</form>
<script>
function js_verifica_campos(){
  if(document.form1.r54_anousu.value == "" || document.form1.r54_mesusu.value == ""){
    ...
    return false;
  }else if(document.form1.r54_codrel.value == ""){
