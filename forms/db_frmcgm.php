            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr align="center">
                        ...
                        <td align="left">
                            <input style="text-align:right" type="text" value="" name="cpf" size="18" maxlength="11"
                    ...
                    <tr align="center" title="<?= $TDBtxt31 ?>">
                        ...
                        <td align="left">
                            <input style="text-align:right" type="text" value="" name="cnpj" size="18" maxlength="14"
                                   onBlur="js_verificaCGCCPF(this)"
                                   onKeyDown="return js_controla_tecla_enter(this,event);">
                    ...
                    <tr>
                        <td align="center" colspan="2" height="30">
                            ...
                            if ($lPermissaoImportaCidadao) {
                                ?>
                                <input type="button" name="enviar" value="Importar Cadastro do Cidadão"
                                       onClick="js_importaCadastroCidadao();">
