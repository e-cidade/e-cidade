...
function js_pesquisam01_cadmodcarne(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadmodcarne','func_cadmodcarne.php?funcao_js=parent.js_mostracadmodcarne1|k47_sequencial|k47_descr','Pesquisa',true,'0');
  }else{
     if(document.form1.m01_cadmodcarne.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadmodcarne','func_cadmodcarne.php?pesquisa_chave='+document.form1.m01_cadmodcarne.value+'&funcao_js=parent.js_mostracadmodcarne','Pesquisa',false);
     }else{
...
function js_pesquisam02_db_layouttxt(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_db_layouttxt','func_db_layouttxt.php?funcao_js=parent.js_mostralayouttxt1|db50_codigo|db50_descr','Pesquisa',true,'0');
  }else{
     if(document.form1.m02_db_layouttxt.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_db_layouttxt','func_db_layouttxt.php?pesquisa_chave='+document.form1.m02_db_layouttxt.value+'&funcao_js=parent.js_mostralayouttxt','Pesquisa',false);
     }else{
...
function js_pesquisak48_cadtipomod(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadtipomod','func_cadtipomod.php?funcao_js=parent.js_mostracadtipomod1|k46_sequencial|k46_descr','Pesquisa',true,'0');
  }else{
     if(document.form1.k48_cadtipomod.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadtipomod','func_cadtipomod.php?pesquisa_chave='+document.form1.k48_cadtipomod.value+'&funcao_js=parent.js_mostracadtipomod','Pesquisa',false,'0');
     }else{
...
function js_pesquisak48_cadconvenio(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadconvenio','func_cadconvenio.php?funcao_js=parent.js_mostracadconvenio1|ar11_sequencial|ar11_nome','Pesquisa',true,'0');
  }else{
     if(document.form1.k48_cadconvenio.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_cadconvenio','func_cadconvenio.php?pesquisa_chave='+document.form1.k48_cadconvenio.value+'&funcao_js=parent.js_mostracadconvenio','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_modcarnepadrao','db_iframe_modcarnepadrao','func_modcarnepadrao.php?funcao_js=parent.js_preenchepesquisa|k48_sequencial','Pesquisa',true,'0');
}
