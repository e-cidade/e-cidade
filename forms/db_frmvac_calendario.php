...
?>
<fieldset style='width: 75%;'> <legend><b>Calendario</b></legend>
...
function js_valida() {
  ...
  if ((oF.vc05_i_idadeini.value != '') || (oF.vc05_i_idadefim.value != '')) {
    ...
    if ((parseInt(oF.vc05_i_idadeini.value,10)) > (parseInt(oF.vc05_i_idadefim.value,10))) {

      alert('Idade final maior que a inicial!');
      oF.vc05_i_idadefim.value='';
      return false;
