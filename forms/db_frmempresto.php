...
function js_pesquisae91_codtipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_emprestotipo','func_emprestotipo.php?funcao_js=parent.js_mostraemprestotipo1|e90_codigo|e90_descr','Pesquisa',true);
  }else{
     if(document.form1.e91_codtipo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_emprestotipo','func_emprestotipo.php?pesquisa_chave='+document.form1.e91_codtipo.value+'&funcao_js=parent.js_mostraemprestotipo','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orctiporec','func_orctiporec.php?funcao_js=parent.js_mostraorctiporec1|o15_codigo|o15_descr','Pesquisa',true);
     ...
     if(document.form1.e91_recurso.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orctiporec','func_orctiporec.php?pesquisa_chave='+document.form1.e91_recurso.value+'&funcao_js=parent.js_mostraorctiporec','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_empresto','func_empresto.php?funcao_js=parent.js_preenchepesquisa|e91_anousu|e91_numemp','Pesquisa',true);
}
