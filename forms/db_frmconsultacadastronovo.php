...
<script>
    ...
    function js_pesquisaMatricula(lMostra) {
        let sQueryString = 'func_iptubase.php?';
        if (lMostra) {
    ...
    function js_comTeclaEnter(event) {

        const evt = (event) ? event : (window.event) ? window.event : "";
        if (evt.keyCode === 13) {
            ...
            <form name="form1" method="post" action="" onsubmit="js_append()">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td colspan="2">
                            <fieldset>
                                <legend><b>Dados referentes a matrícula</b></legend>
                                <table border="0">
                                    ...
                                    <?php if ($rsSetorLoc) { ?>
                                        <tr>
                                            <td width="34%" nowrap
                                                title="<?= $Tj06_setorloc ?>"><?= $Lj06_setorloc ?></td>
                                            <td>
                                                <?php
                                        ...
                                        <tr>
                                            <td width="34%" nowrap
                                                title="<?= $Tj06_quadraloc ?>"><?= $Lj06_quadraloc ?></td>
                    ...
                    <tr>
                        <td colspan="3" align="left" valign="top" nowrap><?php $db_opcao = 1; ?>
                            <fieldset>
                                <legend><b>Dados referentes ao registro de imóveis</b></legend>
                                <table>
                                    <tr>
                    ...
                    <tr align="center">
                        <td colspan="3">
                            <input name="pesquisar" type="button" onClick="mostraJanelaPesquisa()" id="pesquisar"
                                   value="Pesquisar">
                        </td>
                    </tr>
                </table>
...
<script type="text/javascript">
    ...
    function js_mostraQuadra() {
        ...
        const cboQuadras = new DBComboBox('j06_quadraloc', 'j06_quadraloc', aOptions, '180');
    ...
    function js_mostraLotes() {
        ...
        const cboLotes = new DBComboBox('j06_lote', 'j06_lote', aOptions, '180');
    ...
    function js_carregaQuadra(iCodSetor) {
        ...
        const oAjax = new Ajax.Request('func_iptubase.RPC.php',
            {
                method: 'POST',
    ...
    function js_retornaQuadra(oAjax) {
        ...
        if (oRetorno.status === 1) {
            for (let i = 0; i < oRetorno.oQuadras.length; i++) {
    ...
    function js_retornaLote(oAjax) {
        ...
        if (oRetorno.status === 1) {
            for (let i = 0; i < oRetorno.oLotes.length; i++) {
