...
<script>
	...
	if(F.j01_matric.value.length > 0) {
	  VisualizacaoMatricula.jan.location.href = 'cad3_conscadastro_002.php?cod_matricula=' + F.j01_matric.value;
    ...
    VisualizacaoSetorQuadraLote.jan.location.href = 'func_lotealt.php?funcao_js=parent.mostraTodasMatCadIDBQL|0&' + $parametro;
	  ...
	  VisualizacaoSetorQuadraLote.focus();
	} else if((F.j05_codigoproprio.value.length > 0 && F.j05_codigoproprio.value != 'todos') || ( F.j06_quadraloc.value.length > 0) || ( F.j06_lote.value.length > 0 && F.j06_lote.value != 'undefined')) {
		...
		if(F.j06_lote.value.length > 0) {
			sQueryString += sAnd + 'j06_loteloc=' + F.j06_lote.value;
			sAnd = '&';
	  }
	  ...
	  VisualizacaoMatricula.jan.location.href = 'cad3_conscadastro_002.php?cod_matricularegimo=' + F.j04_matricregimo.value;
	  VisualizacaoMatricula.mostraMsg();
	  VisualizacaoMatricula.show();
          VisualizacaoMatricula.focus();
  ...
  function mostraTodasMatCadIDBQL(numidbql){
    ...
    VisualizacaoTodasMatCad.jan.location.href = 'cad3_conscadastro_002.php?cod_matricula=' + numidbql;
    VisualizacaoTodasMatCad.mostraMsg();
    VisualizacaoTodasMatCad.show();
	VisualizacaoTodasMatCad.focus();
  }
  function mostraJanelaDadosImovel(numeroMat){
    VisualizacaoMatricula.jan.location.href = 'cad3_conscadastro_002.php?cod_matricula=' + numeroMat;
    VisualizacaoMatricula.mostraMsg();
    VisualizacaoMatricula.show();
	VisualizacaoMatricula.focus();
  }
  ...
  function mostraregistro(matricula){
  	VisualizacaoSetorQuadraLote.jan.location.href = 'cad3_conscadastro_002.php?cod_matricula=' + matricula;
    VisualizacaoSetorQuadraLote.mostraMsg();
    VisualizacaoSetorQuadraLote.show();
	  VisualizacaoSetorQuadraLote.focus();
  }
  ...
  function mostraTodasMatriculasSetorLoc(iMatricula) {
	  VisualizacaoSetorQuadraLoteLoc.jan.location.href = 'cad3_conscadastro_002.php?cod_matricula=' + iMatricula;
	  VisualizacaoSetorQuadraLoteLoc.mostraMsg();
	  VisualizacaoSetorQuadraLoteLoc.show();
	  VisualizacaoSetorQuadraLoteLoc.focus();
  }
