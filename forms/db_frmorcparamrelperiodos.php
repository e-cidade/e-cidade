...
function js_pesquisao113_periodo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamrelperiodos','db_iframe_periodo','func_periodo.php?funcao_js=parent.js_mostraperiodo1|o114_sequencial|o114_descricao','Pesquisa',true,'0','1');
  }else{
     if(document.form1.o113_periodo.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamrelperiodos','db_iframe_periodo','func_periodo.php?pesquisa_chave='+document.form1.o113_periodo.value+'&funcao_js=parent.js_mostraperiodo','Pesquisa',false);
     }else{
...
function js_pesquisao113_orcparamrel(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamrelperiodos','db_iframe_orcparamrel','func_orcparamrel.php?funcao_js=parent.js_mostraorcparamrel1|o42_codparrel|o42_descrrel','Pesquisa',true,'0','1');
  }else{

		alert('else');

     if(document.form1.o113_orcparamrel.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcparamrelperiodos','db_iframe_orcparamrel','func_orcparamrel.php?pesquisa_chave='+document.form1.o113_orcparamrel.value+'&funcao_js=parent.js_mostraorcparamrel','Pesquisa',false);
     }else{
