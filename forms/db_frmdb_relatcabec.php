...
function js_pesquisadb95_codrel(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_db_relatcabec','db_iframe_db_relat','func_db_relat.php?funcao_js=parent.js_mostradb_relat1|db91_codrel|db91_descr','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.db95_codrel.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_db_relatcabec','db_iframe_db_relat','func_db_relat.php?pesquisa_chave='+document.form1.db95_codrel.value+'&funcao_js=parent.js_mostradb_relat','Pesquisa',false);
     }else{
