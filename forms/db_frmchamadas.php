...
function js_valida(){
 ...
 if(document.form1.ed22_i_disciplina.value==""){
  ...
  CurrentWindow.corpo.iframe_a2.location.href='edu1_chamadas002.php?turma='+document.form1.ed05_i_codigo.value+'&nometurma='+document.form1.ed05_c_nome.value+'&disciplina='+document.form1.ed22_i_disciplina.value+'&nomedisciplina='+document.form1.ed27_c_nome.value;
  parent.mo_camada('a2');
 }
}
