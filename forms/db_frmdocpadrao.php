...
function js_retornaimport(cod,descr,erro){
     ...
     if (erro=="true"){
         alert("Operação Cancelada!!Contate Suporte!!");
      	...
      	CurrentWindow.corpo.iframe_parag.location.href='con4_docpadrao003.php?db60_coddoc='+cod;
        CurrentWindow.corpo.iframe_doc.location.href='con4_docpadrao004.php?chavepesquisa='+cod;
     }
}
</script>
