...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_aguaconsumo','db_iframe_aguaconsumo','func_aguaconsumo.php?funcao_js=parent.js_preenchepesquisa|x19_codconsumo','Pesquisa',true,'0');
}
