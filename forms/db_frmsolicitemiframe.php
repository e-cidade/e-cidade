    ...
    <tr>
        <td nowrap title="<?= @$Tpc13_coddot ?>">
            ...
            $ancora_dotac = $clsolicitem->sql_record(
                $clsolicitem->sql_query_ancoradotorc(
                    $pc13_codigo,
                    "pc13_codigo as codigo_dotac",
                    null,
                    "pc11_codigo = $pc13_codigo"
                )
            );
	  ...
	  ";
            ...
            $result_quant_rest = $clpcdotac->sql_record($clpcdotac->sql_query_depart(
                null,
                null,
                null,
        ...
        if (isset($pc13_coddot)) {
           ...
           */
                    ...
                    if ($oDaoDotacaocontr->numrows == 0) {
                        ...
                        $rsContrapartidas = $oDaoTipoRec->sql_record(
                            $oDaoTipoRec->sql_query_convenios(
                                date("Y-m-d", db_getsession("DB_datausu")),
                                null,
                                "o15_codigo,o15_descr"
                            )
        ...
        <tr>
            ...
            <td nowrap>
                ...
                if ($db_opcao != 1 && isset($pc13_coddot) && isset($pc13_codigo) && isset($pc13_sequencial)) {
                    $result_pesq_pcdotac = $clorcreservasol->sql_record($clorcreservasol->sql_query_orcreserva(
                        null,
                        null,
                        "o82_codres",
                        "",
    ...
    <script>
        ...
        function js_pesquisapc13_coddot(mostra){
          ...
          if(mostra==true){
            ...
            js_OpenJanelaIframe('top.corpo.iframe_solicitem','db_iframe_orcdotacao','func_permorcdotacao.php?'+qry,'Pesquisa',true,'0');
          }else{
            qry+= '&pesquisa_chave='+document.form1.pc13_coddot.value;
            js_OpenJanelaIframe('top.corpo.iframe_solicitem','db_iframe_orcdotacao','func_permorcdotacao.php?'+qry+'&funcao_js=parent.js_mostraorcdotacao','Pesquisa',false);
          }
        }
        */
