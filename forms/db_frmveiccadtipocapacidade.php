...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tve24_codigo?>">
       <?=@$Lve24_codigo?>
    </td>
    <td>
<?
db_input('ve24_codigo',10,$Ive24_codigo,true,'text',3,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tve24_descr?>">
       <?=@$Lve24_descr?>
    </td>
    <td>
<?
db_input('ve24_descr',40,$Ive24_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
