...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tsd92_i_codigo?>">
       <?=@$Lsd92_i_codigo?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tsd92_c_saisih?>">
       <?=@$Lsd92_c_siasih?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tsd92_i_tipoproc?>">
       <?=@$Lsd92_i_tipoproc?>
    </td>
    <td>
       <?
  ...
  <tr>
    <td nowrap title="<?=@$Tsd92_i_anocomp?>">
