...
if (isset($pc11_numero) && (!isset($opcao) || (isset($opcao) && $opcao != "alterar" && $opcao != "excluir")) && isset($verificado)) {
  ...
  //	 $where_pc11_seq = " pc11_numero = ".$pc11_numero;
  //     $result_pc11_seq = $clsolicitem->sql_record($clsolicitem->sql_query_file(null, "max(pc11_seq) as pc11_seq", "", $where_pc11_seq));
  ...
  <center>
    <table border="0" height="100%">
      <tr>
        ...
        <td>
          <input name="info" type="button" id="info" value="Outras informações" onclick="js_abrejan();" disabled>
        </td>
      </tr>
      <tr>
        ...
        <td colspan="7">
          ...
          db_input("pc17_quant", 5, $Ipc17_quant, true, 'hidden', $db_opcaounidade, "onblur='if (this.value <= 0) alert(\"valor deve ser maior que zero,\");'");
          ?>
        </td>
      </tr>
      <?
      if (isset($opcao) && isset($pc11_codigo) && $opcao != "incluir") {
        $rsVeiculo = $clsolicitemveic->sql_record($clsolicitemveic->sql_query(null, "pc14_sequencial,pc14_veiculos,ve01_placa", "", " pc14_solicitem = $pc11_codigo"));
      ...
      ?>
        <tr id="MostraVeiculos">
          ...
          <td>
            <?
            db_input("pc14_veiculos", 8, $Ipc14_veiculos, true, 'text', $tranca, "onchange='js_pesquisave01_veiculo(false)';");
            ?>
          </td>
          <td>
            <?
      ...
      <table width="100%" height="40%" border="0">
        <tr>
          <td width="100%" height="100%">
            <iframe name="lanc_dotac" id="lanc_dotac" marginwidth="0" marginheight="0" frameborder="0" src="com1_solicitemiframe001.php?<?= $qry ?>" width="100%" height="250">
            </iframe>
          </td>
        </tr>
      </table>
    ...
    <table border="0" width="100%" height="50%">
      ...
      <tr>
        <td valign="top" align="center" width="100%">
          ...
          $codigos = "";
          if ($pc30_ultdotac == "t") {
            $res_itens = $clsolicitem->sql_record($clsolicitem->sql_query_pcmater(null, "pc11_codigo as codigo", "pc11_codigo", "pc11_numero= " . @$pc11_numero));
            if ($clsolicitem->numrows > 0) {
              $virgula = "";
          ...
          $chavepri = array("pc11_numero" => $pc11_numero, "pc11_codigo" => @$pc11_codigo);
          ...
          if ($pc30_ultdotac == "t") {
            ...
            $cliframe_alterar_excluir->iframe_alterar_excluir($db_opcao); //$db_opcao;
          }
          ?>
        </td>
      </tr>
...
<script>
  ...
  function js_buscarQuantidadeRestanteItemEstimativa() {
    ...
    var oAjax = new Ajax.Request("com4_solicitacaoComprasRegistroPreco.RPC.php", {
      method: 'post',
      parameters: 'json=' + js_objectToJson(oParametros),
