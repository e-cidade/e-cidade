...
//MODULO: saude
$clsau_detalhe->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tsd73_i_codigo?>">
       <?=@$Lsd73_i_codigo?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tsd73_c_detalhe?>">
       <?=@$Lsd73_c_detalhe?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tsd73_i_anocomp?>">
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_detalhe','func_sau_detalhe.php?funcao_js=parent.js_preenchepesquisa|sd73_i_codigo','Pesquisa',true);
}
