...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhsindicato','func_rhsindicato.php?funcao_js=parent.js_preenchepesquisa|rh116_sequencial','Pesquisa',true);
}
