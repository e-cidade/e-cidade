  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_historicomps','func_historicomps.php?funcao_js=parent.js_mostrahistoricomps1|ed62_i_codigo|ed62_i_codigo','Pesquisa',true);
     ...
     if(document.form1.ed66_i_historicomps.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_historicomps','func_historicomps.php?pesquisa_chave='+document.form1.ed66_i_historicomps.value+'&funcao_js=parent.js_mostrahistoricomps','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_disciplina','func_disciplina.php?funcao_js=parent.js_mostradisciplina1|ed12_i_codigo|ed12_i_codigo','Pesquisa',true);
     ...
     if(document.form1.ed66_i_disciplina.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_disciplina','func_disciplina.php?pesquisa_chave='+document.form1.ed66_i_disciplina.value+'&funcao_js=parent.js_mostradisciplina','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_histmpsadap','func_histmpsadap.php?funcao_js=parent.js_preenchepesquisa|ed66_i_codigo','Pesquisa',true);
}
