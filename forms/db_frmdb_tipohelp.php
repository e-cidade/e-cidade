...
<table border="0">
  <tr>
    ...
    <td>
<?
db_input('id_codtipo',5,$Iid_codtipo,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tdescrtipohelp?>">
       <?=@$Ldescrtipohelp?>
    </td>
    <td>
<?
db_input('descrtipohelp',40,$Idescrtipohelp,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
