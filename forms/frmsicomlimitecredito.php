...
<fieldset style="width: 700px; height: 274px;"><legend><b>Limites Crédito Adicional</b></legend>
  ...
  <tr>
  <td><strong>Tipo de Lei de Alteração:</strong></td>
  <td>
    <select name="tipoLeiAlteracao" id="tipoLeiAlteracao" >
  ...
  <tr>
  <td><strong>Número da Lei que Autoriza a Alteração:</strong></td>
  <td>
  <input type="text" name="nroLeiAlteracao" id="nroLeiAlteracao" maxlength="10" >
  </td>
  </tr>

  <tr>
  <td><strong>Data da Lei que Autoriza a Alteração: </strong></td>
  <td>
  <input type="text" name="dataLeiAlteracao" id="dataLeiAlteracao" onfocus="js_validaEntrada(this);" onkeyup="return js_mascaraData(this,event)" 
  ...
  <script>
    ...
    function js_comparaDatasdataPublicacao(dia,mes,ano){
      var objData = document.getElementById('dataLeiAlteracao');
  ...
  <tr>
  <td><strong>Número Artigo que Autoriza Alteração: </strong></td>
  <td>
  <input type="text" name="artigoLeiAlteracao" id="artigoLeiAlteracao" maxlength="10">
  </td>
  </tr>
  
  <tr>
	<td><strong>Descrição Artigo que Autoriza Alteração: </strong></td>
	<td>
  ...
  <td>
  <input type="text" name="vlAutorizadoAlteracao" id="vlAutorizadoAlteracao" onkeyup="js_ValidaCampos(this,4,'Valor','f','f',event);">
  </td>
  </tr>
...
function pesquisar() {
	...
	var oAjax = new Ajax.Request("con4_pesquisarxmllimitecredito.php",
			{
		method:"post",
...
function pegar_valor(param1, param2, param3, param4, param5, param6, param7) {
	...
	$('codigo').value = param1;
	document.getElementById('tipoLeiAlteracao').options['0'+param2].selected = "true";
...
function cria_tabela(json) {
	...
	try {
		...
		for (var i = 0; i < jsonObj.length; i++) {
			...
			tabela += "<a onclick=\"pegar_valor('"+jsonObj[i].codigo+"','"+jsonObj[i].tipoLeiAlteracao+"','"+jsonObj[i].nroLeiAlteracao+"','"
			+jsonObj[i].dataLeiAlteracao+"','"+jsonObj[i].artigoLeiAlteracao+"','"+jsonObj[i].descricaoArtigo+"','"
			+jsonObj[i].vlAutorizadoAlteracao+"')\">"+jsonObj[i].descricaoArtigo.substr(0, 50)+"</a>";
