...
<form name="form1" method="post" action="">
  <div class="container">
    ...
    <input name="<?= ($db_opcao == 1 ? "incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "alterar" : "excluir")) ?>" type="button" id="db_opcao" value="<?= ($db_opcao == 1 ? "Incluir" : ($db_opcao == 2 || $db_opcao == 22 ? "Alterar" : "Excluir")) ?>" <?= ($db_botao == false ? "disabled" : "") ?> onclick="return js_valida();">
...
<script>
  function js_pesquisaed254_i_rechumano(mostra) {
    ...
    sUrl += '|identificacao|z01_cgccpf|ed01_c_descr';
    if (mostra == true) {
