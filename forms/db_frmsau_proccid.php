  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?funcao_js=parent.js_mostrasau_procedimento1|sd63_i_codigo|sd63_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd72_i_procedimento.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?pesquisa_chave='+document.form1.sd72_i_procedimento.value+'&funcao_js=parent.js_mostrasau_procedimento','Pesquisa',false);
     }else{
...
function js_pesquisasd72_i_cid(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_cid','func_sau_cid.php?funcao_js=parent.js_mostrasau_cid1|sd70_i_codigo|sd70_c_nome','Pesquisa',true);
  }else{
     if(document.form1.sd72_i_cid.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_cid','func_sau_cid.php?pesquisa_chave='+document.form1.sd72_i_cid.value+'&funcao_js=parent.js_mostrasau_cid','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_proccid','func_sau_proccid.php?funcao_js=parent.js_preenchepesquisa|sd72_i_codigo','Pesquisa',true);
}
