...
function js_pesquisaed122_i_progmatricula(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_progmatricula','func_progmatricula.php?funcao_js=parent.js_mostraprogmatricula1|ed112_i_codigo|ed112_i_rhpessoal|z01_nome|ed112_d_datainicio|ed107_c_descr','Pesquisa Matrículas',true);
 }
}
...
function js_pesquisaed122_i_proglicenca(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_proglicenca','func_proglicenca.php?funcao_js=parent.js_mostraproglicenca1|ed121_i_codigo|ed121_c_descr','Pesquisa de Tipos de Licenças/Afastamentos',true);
 }else{
  if(document.form1.ed122_i_proglicenca.value != ''){
   js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_proglicenca','func_proglicenca.php?pesquisa_chave='+document.form1.ed122_i_proglicenca.value+'&funcao_js=parent.js_mostraproglicenca','Pesquisa',false);
  }else{
...
function js_pesquisa(){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_proglicencamatr','func_proglicencamatr.php?funcao_js=parent.js_preenchepesquisa|ed122_i_codigo','Pesquisa Licenças/Afastamentos',true);
}
