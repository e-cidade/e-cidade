  ...
  <center>
    ...
    <tr>
	  ...
	  <tr>
        ...
        <td>
		  <?
			db_input('it08_area',15,$Iit08_area,true,'text',$db_opcao," onChange='document.form1.it08_areatrans.value = this.value;document.form1.it08_ano.focus()'");
		  ?>
	    </td>
	    <td>
		  <?=@$Lit08_areatrans?>
  	  ...
  	  <? if ( $oGet->tipo == "rural" ) {?>
      <tr>
        <td nowrap title="<?=@$Tit08_coordenadas?>">
          <?=@$Lit08_coordenadas?>
        </td>
        <td colspan="5">
         <?
