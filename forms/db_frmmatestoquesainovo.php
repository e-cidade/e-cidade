...
if(isset($m70_codmatmater) && trim($m70_codmatmater)!=""){
  $result_matestoque = $clmatestoqueitem->sql_record($clmatestoqueitem->sql_query(null,"distinct m70_codmatmater,m60_descr,m60_quantent,descrdepto,m70_quant,m70_valor",""," m70_codmatmater=$m70_codmatmater and m71_quant>m71_quantatend and m70_quant<>0 and m70_coddepto=".db_getsession("DB_coddepto")));
...
?>
  <tr>
    <td colspan='2' >
      <iframe name="iframe_matestoquesai" id="iframe_matestoquesai" marginwidth="0" marginheight="0" frameborder="0" src="mat1_matestoquesaiiframe<?=(isset($mostraiframeexclui)?"exc":"")?>001.php?m70_codmatmater=<?=$m70_codmatmater?>" width="760" height="300"></iframe>
    </td>
  </tr>
</table>
</center>
