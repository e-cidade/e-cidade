...
var lProfissional        = false;
var oGet                 = js_urlToObject();
var sRpcFichaAtendimento = "sau4_fichaatendimento.RPC.php";

<?php

if( isset( $lProfSaude ) && $lProfSaude ) {
  echo " lProfissional = true; ";
}
?>
...
function js_pesquisaprontuarios() {
  ...
  var sUrl  = 'func_consultamedicaprontuarios.php';
      sUrl += '?funcao_js=parent.js_preenchepesquisapront|sd24_i_codigo|z01_v_nome|sd24_i_numcgs';
