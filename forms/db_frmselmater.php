...
function js_pesquisapc16_codmater(mostra){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pcmater','func_pcmater.php?funcao_js=CurrentWindow.corpo.db_iframe_selmater.jan.js_mostrapcmater1|pc01_codmater|pc01_descrmater<?=$db_opcao==1?"&opcao_bloq=3&opcao=f":"&opcao_bloq=1&opcao=i"?>'+qry,'Pesquisa',true);
  }else{
    if(document.form1.pc16_codmater.value != ''){
       js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pcmater','func_pcmater.php?pesquisa_chave='+document.form1.pc16_codmater.value+'&funcao_js=CurrentWindow.corpo.db_iframe_selmater.jan.js_mostrapcmater<?=$db_opcao==1?"&opcao_bloq=3&opcao=f":"&opcao_bloq=1&opcao=i"?>'+qry,'Pesquisa',false);
    }else{
      document.form1.pc01_descrmater.value = '';
    }
  }
