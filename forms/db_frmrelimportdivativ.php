...
function js_validarGenerico(param){
  ...
  if(lParam == true){
    if(data_fin < data_ini){
      ...
      var sDatas     = 'dataini='+data_ini+'&datafim='+data_fin;
      var sNome      = '&z01_numcgm='+numcgm;
      var sMatricula = '&j01_matric='+nummatric;
      var sInscricao = '&q02_inscr='+numinscr;
      var sTipoper   = '&tipoper='+tipoper;
      var sTiporel   = '&tiporel='+tiporel;
      var sTipoimp   = '&tipoimp='+tipoimp;
      var sOrdenar   = '&ordenar='+ordenar;
      var sAgrupar   = '&agrupar='+agrupar;
      var sUrl       = sDatas+sNome+sMatricula+sInscricao+sTipoper+sTiporel+sTipoimp+sOrdenar+sAgrupar;

      jan = window.open('div2_reldivimporta002.php?'+sUrl,'',
