...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?funcao_js=parent.js_mostraorcprograma1|o54_anousu|o54_anousu','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcprograma','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?funcao_js=parent.js_mostraorcprograma1|o54_programa|o54_anousu','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcprograma','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?funcao_js=parent.js_mostraorcelemento1|o56_anousu|o56_codele','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcelemento','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?funcao_js=parent.js_mostraorcelemento1|o56_codele|o56_codele','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcelemento','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?funcao_js=parent.js_mostraorcprojativ1|o55_anousu|o55_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcprojativ','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?funcao_js=parent.js_mostraorcprojativ1|o55_projativ|o55_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcprojativ','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcorgao','func_orcorgao.php?funcao_js=parent.js_mostraorcorgao1|o40_anousu|o40_descr','Pesquisa',true);
     ...
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcorgao','func_orcorgao.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcorgao','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_anousu|o41_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_orgao|o41_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false);
     }else{
...
function js_pesquisao08_ano(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_unidade|o41_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_ano.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o08_ano.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcorgao','func_orcorgao.php?funcao_js=parent.js_mostraorcorgao1|o40_anousu|o40_descr','Pesquisa',true);
     ...
     if(document.form1.o08_orgao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcorgao','func_orcorgao.php?pesquisa_chave='+document.form1.o08_orgao.value+'&funcao_js=parent.js_mostraorcorgao','Pesquisa',false);
     }else{
       document.form1.o40_descr.value = '';
     }
  }
...
function js_pesquisao08_orgao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_anousu|o41_descr','Pesquisa',true);
     ...
     if(document.form1.o08_orgao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o08_orgao.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false);
     }else{
       document.form1.o41_descr.value = '';
     }
  }
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_anousu|o41_descr','Pesquisa',true);
     ...
     if(document.form1.o08_unidade.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o08_unidade.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false);
     }else{
       document.form1.o41_descr.value = '';
     }
  }
...
function js_pesquisao08_funcao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcfuncao','func_orcfuncao.php?funcao_js=parent.js_mostraorcfuncao1|o52_funcao|o52_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_funcao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcfuncao','func_orcfuncao.php?pesquisa_chave='+document.form1.o08_funcao.value+'&funcao_js=parent.js_mostraorcfuncao','Pesquisa',false);
     }else{
...
function js_pesquisao08_subfuncao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcsubfuncao','func_orcsubfuncao.php?funcao_js=parent.js_mostraorcsubfuncao1|o53_subfuncao|o53_descr','Pesquisa',true);
  }else{
     if(document.form1.o08_subfuncao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcsubfuncao','func_orcsubfuncao.php?pesquisa_chave='+document.form1.o08_subfuncao.value+'&funcao_js=parent.js_mostraorcsubfuncao','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?funcao_js=parent.js_mostraorcprograma1|o54_anousu|o54_anousu','Pesquisa',true);
     ...
     if(document.form1.o08_programa.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprograma','func_orcprograma.php?pesquisa_chave='+document.form1.o08_programa.value+'&funcao_js=parent.js_mostraorcprograma','Pesquisa',false);
     }else{
       document.form1.o54_anousu.value = '';
     }
  }
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?funcao_js=parent.js_mostraorcprojativ1|o55_anousu|o55_descr','Pesquisa',true);
     ...
     if(document.form1.o08_projativ.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcprojativ','func_orcprojativ.php?pesquisa_chave='+document.form1.o08_projativ.value+'&funcao_js=parent.js_mostraorcprojativ','Pesquisa',false);
     }else{
       document.form1.o55_descr.value = '';
     }
  }
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?funcao_js=parent.js_mostraorcelemento1|o56_anousu|o56_codele','Pesquisa',true);
     ...
     if(document.form1.o08_elemento.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcelemento','func_orcelemento.php?pesquisa_chave='+document.form1.o08_elemento.value+'&funcao_js=parent.js_mostraorcelemento','Pesquisa',false);
     }else{
       document.form1.o56_codele.value = '';
     }
  }
...
function js_pesquisao08_localizadorgastos(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_ppasubtitulolocalizadorgasto','func_ppasubtitulolocalizadorgasto.php?funcao_js=parent.js_mostrappasubtitulolocalizadorgasto1|o11_sequencial|o11_codigo','Pesquisa',true);
  }else{
     if(document.form1.o08_localizadorgastos.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_ppasubtitulolocalizadorgasto','func_ppasubtitulolocalizadorgasto.php?pesquisa_chave='+document.form1.o08_localizadorgastos.value+'&funcao_js=parent.js_mostrappasubtitulolocalizadorgasto','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_ppadotacao','func_ppadotacao.php?funcao_js=parent.js_preenchepesquisa|o08_sequencial','Pesquisa',true);
}
