...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_numatend','func_numatend.php?funcao_js=parent.js_preenchepesquisa|0','Pesquisa',true);
}
