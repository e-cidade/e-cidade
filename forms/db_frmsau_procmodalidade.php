...
function js_pesquisasd83_i_modalidade(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_modalidade','func_sau_modalidade.php?funcao_js=parent.js_mostrasau_modalidade1|sd82_i_codigo|sd82_c_nome','Pesquisa',true);
  }else{
     if(document.form1.sd83_i_modalidade.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_modalidade','func_sau_modalidade.php?pesquisa_chave='+document.form1.sd83_i_modalidade.value+'&funcao_js=parent.js_mostrasau_modalidade','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?funcao_js=parent.js_mostrasau_procedimento1|sd63_i_codigo|sd63_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd83_i_procedimento.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?pesquisa_chave='+document.form1.sd83_i_procedimento.value+'&funcao_js=parent.js_mostrasau_procedimento','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procmodalidade','func_sau_procmodalidade.php?funcao_js=parent.js_preenchepesquisa|sd83_i_codigo','Pesquisa',true);
}
