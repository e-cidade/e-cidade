    ...
    <fieldset>
      ...
      <table class="form-container">
        ...
        <tr id="ctnDisciplinaGlobalBase">
          <td nowrap='nowrap'><label>Disciplina Global:</label></td>
          <td nowrap='nowrap' colspan="3">
        ...
        <tr id="ctnDisciplinaGlobalTurma">
          <td nowrap='nowrap'><label>Controle de Frequência:</label></td>
          <td nowrap='nowrap' colspan="3">
        ...
        <tr>
          <td nowrap='nowrap'><label>Tipo de Base:</label></td>
          <td nowrap='nowrap'>
            <select id="tipoBase">
          ...
          <td nowrap='nowrap'><label>Caráter Reprobatório:</label></td>
          <td nowrap='nowrap'>
        ...
        <tr>
          <td nowrap='nowrap'><label>Quantidade de horas-aula:</label></td>
          <td nowrap='nowrap'>
            <?php
        ...
        <tr>
          <td nowrap='nowrap'><label>Matrícula:</label></td>
          <td nowrap='nowrap'>
          ...
          <td nowrap='nowrap'><label>Lançar na Documentação:</label></td>
          <td nowrap='nowrap'>
