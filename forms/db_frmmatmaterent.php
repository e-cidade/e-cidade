...
if ($clpcmater->numrows>0){
    ...
    $sqlUnd = "SELECT  pc01_unid AS m61_codmatunid,
                       m61_descr AS m61_descr
                FROM pcmater
                JOIN matunid ON m61_codmatunid = pc01_unid
                WHERE pc01_codmater =".$m63_codpcmater;

    // 1 - UNIDADE
    $result_unidade=$clmatunid->sql_record($sqlUnd);
