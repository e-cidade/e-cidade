  ...
  <fieldset style="width: 700px">
    ...
    <table border="0" style="width: 700px;">
      ...
      <tr>
        ...
        <td>
          <?php
            $afiltroTipoTransmissao = array(1 => "CNAB240", 2 => "OBN");
...
function js_pesquisaCNPJBanco(sCNPJ) {
  ...
  $("filtroTipoTransmissao").disabled = false;

  if (iCodigoBancoSelecionado != iCodigoBancoBrasil) {

    $("filtroTipoTransmissao").value    = 1;
    $("filtroTipoTransmissao").disabled = true;
  }
