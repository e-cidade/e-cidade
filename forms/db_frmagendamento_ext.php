...
function js_pesquisasd03_i_codigo2(mostra,depara){
  ...
  if (mostra == true) {
	...
	js_OpenJanelaIframe('','db_iframe_medicos','func_medicos.php?prof_ativo=1&funcao_js=parent.js_mostramedicos_21|'
...
function js_pesquisaz01_v_nome(){
     ...
     if(document.form1.z01_v_nome.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgs_und','func_cgs_und.php?chave_z01_v_nome='+document.form1.z01_v_nome.value+'&funcao_js=parent.js_mostracgs1|z01_i_cgsund|z01_v_nome|z01_d_nasc&retornacgs=document.form1.z01_i_cgsund.value&retornanome=document.form1.z01_v_nome.value','Pesquisa',true);
     }else{
           document.form1.rh70_estrutural.focus();
     }
