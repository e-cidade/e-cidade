        ...
        <td colspan="2">
          <fieldset style='border: 0px;border-top: 2px groove white;' class="interno">
            ...
            <table>
              ...
              <tr>
                <td nowrap title="Sigaf">
                  <b>Sigaf:</b>
                </td>
                <td>
                  <?
                  $aX = array('t' => 'Sim', 'f' => 'Não');
                  db_select('m90_sigaf', $aX, true, $db_opcao, "style='width:250px;'");
                  ?>
                </td>
              </tr>
            </table>
...
function js_pesquisa() {
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_matparam', 'func_matparam.php?'+
