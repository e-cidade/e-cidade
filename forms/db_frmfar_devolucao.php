...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tfa22_i_codigo?>">
       <?=@$Lfa22_i_codigo?>
    </td>
    <td>
<?
...
db_input('z01_i_cgsund',40,$Iz01_i_cgsund,true,'text',3,'')
  ...
  <tr>
    <td nowrap title="<?=@$Tfa22_c_motivo?>">
       <?=@$Lfa22_c_motivo?>
    </td>
    <td>
<?
...
function js_mostradb_usuarios(chave,erro){
  ...
  if(erro==true){
    document.form1.fa22_i_login.focus();
    document.form1.fa22_i_login.value = '';
  }
}
function js_mostradb_usuarios1(chave1,chave2){
  document.form1.fa22_i_login.value = chave1;
