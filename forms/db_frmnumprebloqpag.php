...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_numprebloqpag','func_numprebloqpag.php?funcao_js=parent.js_preenchepesquisa|ar22_sequencial','Pesquisa',true);
}
