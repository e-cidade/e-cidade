...
//MODULO: Laboratório
$cllab_valorreferenciasel->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tla28_i_codigo?>">
       <?=@$Lla28_i_codigo?>
    </td>
    <td>
<?
...
?>
  ...
  <tr>
    <td nowrap title="<?=@$Tla28_c_descr?>">
       <?=@$Lla28_c_descr?>
    </td>
    <td>
<?
db_input('la28_c_descr',40,$Ila28_c_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
