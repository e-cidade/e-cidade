  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_sysregrasacesso','func_db_sysregrasacesso.php?funcao_js=parent.js_mostradb_sysregrasacesso1|db46_idacesso|db46_observ','Pesquisa',true);
     ...
     if(document.form1.db48_idacesso.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_sysregrasacesso','func_db_sysregrasacesso.php?pesquisa_chave='+document.form1.db48_idacesso.value+'&funcao_js=parent.js_mostradb_sysregrasacesso','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_sysregrasacessoip','func_db_sysregrasacessoip.php?funcao_js=parent.js_preenchepesquisa|db48_idacesso','Pesquisa',true);
}
