...
function js_pesquisaq51_id_usuario(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_issnotaavulsa','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
  }else{
     if(document.form1.q51_id_usuario.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_issnotaavulsa','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.q51_id_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
     }else{
...
function js_pesquisaq51_inscr(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_issnotaavulsa','db_iframe_issbase','func_issbase.php?funcao_js=parent.js_mostraissbase1|q02_inscr|z01_nome','Pesquisa',true);
  }else{
     if(document.form1.q51_inscr.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_issnotaavulsa','db_iframe_issbase','func_issbase.php?pesquisa_chave='+document.form1.q51_inscr.value+'&funcao_js=parent.js_mostraissbase','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_issnotaavulsa','db_iframe_issnotaavulsa','func_issnotaavulsaemitidos.php?funcao_js=parent.js_preenchepesquisa|q51_sequencial','Pesquisa',true);
}
