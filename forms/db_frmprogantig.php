...
function js_pesquisa(){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_progantig','func_progantig.php?funcao_js=parent.js_preenchepesquisa|ed113_i_codigo','Pesquisa de Pontuação por Tempo de Serviço',true);
}
