...
$lancado = 0;
$result_lancado = $clmatestoqueitemoc->sql_record($clmatestoqueitemoc->sql_query(null,
                      null, "sum(m71_valor) as soma", null, "m52_codordem=$m51_codordem and m73_cancelado is false"));
if ($clmatestoqueitemoc->numrows != 0) {
