        ...
        <tr id='servico' style="display: <?php echo $sServicoStyle ?> ">
          <td colspan="2">
            <fieldset style="margin-top: 10px;">
              <legend><strong>Lista de Serviços </strong></legend>
              <div id="gridServicos">
...
<script type="text/javascript">
  ...
  function js_retornoBusca(oJson) {
    ...
    /**
     * Adicionado aqui para gerar a grid de serviços depois de carregar o outro grid pra não dar conflito.
     */
    if(servico != 'SERVIÇO'){
  ...
  function js_pesquisaServicos() {
    js_divCarregando('Carregando lista de serviços', 'msgBox');
    oGridServ.nameInstance = 'oGridServ';
    oGridServ.setCellAlign(new Array('left', 'left','left','center'));
    oGridServ.setCheckbox(0);
    oGridServ.setHeader(new Array('Código', 'Estrutural', 'Descricao', 'Valor'));
