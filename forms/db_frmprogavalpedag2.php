...
function js_pesquisaed117_i_progmatricula(mostra){
 if(mostra==true){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_progmatricula','func_progmatricula.php?funcao_js=parent.js_mostraprogmatricula1|ed112_i_codigo|ed112_i_rhpessoal|z01_nome','Pesquisa de Matrículas',true);
 }
}
...
function js_pesquisa(){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_progavalpedag','func_progavalpedag.php?funcao_js=parent.js_preenchepesquisa|ed112_i_rhpessoal|ed117_i_ano|ed117_c_tipo','Pesquisa de Avaliação Pedagógica',true);
}
