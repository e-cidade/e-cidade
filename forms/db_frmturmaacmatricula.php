    ...
    <fieldset>
      <table class="form-container">
        ...
        <tr>
          ...
          <td>
            <?php
              db_inputdata('ed269_d_data', @$ed269_d_data_dia, @$ed269_d_data_mes, @$ed269_d_data_ano , true, 'text', $db_opcao);
              //db_input('ed269_d_data', 10, $Ied269_d_data, true, 'text', 1);
            ?>
          </td>
        </tr>
      </table>
    ...
    <tr>
      <td valign="top">
        <?
          ...
          $cliframe_alterar_excluir->campos        = "ed269_aluno, ed269_i_codigo, ed269_i_turmaac, ed269_d_data, ed268_c_descr, ed47_v_nome";
