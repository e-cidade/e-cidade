  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cidadao','func_cidadao.php?funcao_js=parent.js_mostracidadao1|ov02_seq|ov02_sequencial','Pesquisa',true);
     ...
     if(document.form1.ov08_seq.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cidadao','func_cidadao.php?pesquisa_chave='+document.form1.ov08_seq.value+'&funcao_js=parent.js_mostracidadao','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cidadao','func_cidadao.php?funcao_js=parent.js_mostracidadao1|ov02_seq|ov02_sequencial','Pesquisa',true);
     ...
     if(document.form1.ov08_cidadao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cidadao','func_cidadao.php?pesquisa_chave='+document.form1.ov08_cidadao.value+'&funcao_js=parent.js_mostracidadao','Pesquisa',false);
     }else{
       document.form1.ov02_sequencial.value = '';
     }
  }
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cidadaoemail','func_cidadaoemail.php?funcao_js=parent.js_preenchepesquisa|ov08_sequencial','Pesquisa',true);
}
