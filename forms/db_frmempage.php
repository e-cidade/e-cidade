...
function js_pesquisae50_codord(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pagordem','func_pagordem.php?funcao_js=parent.js_mostrapagordem1|e50_codord&e80_codage=<?=@$e80_codage?>','Pesquisa',true);
  }else{
    ord01 = new Number(document.form1.e50_codord.value);
    if(ord01 != ""){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pagordem','func_pagordem.php?pesquisa_chave='+ord01+'&funcao_js=parent.js_mostrapagordem&e80_codage=<?=@$e80_codage?>','Pesquisa',false);
    }else{
...
function js_pesquisae50_codord02(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pagordem','func_pagordem.php?funcao_js=parent.js_mostrapagordem102|e50_codord&e80_codage=<?=@$e80_codage?>','Pesquisa',true);
  }else{
    ord02 = new Number(document.form1.e50_codord02.value);
    if(ord02 != ""){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pagordem','func_pagordem.php?pesquisa_chave='+ord02+'&funcao_js=parent.js_mostrapagordem02&e80_codage=<?=@$e80_codage?>','Pesquisa',false);
    }else{
