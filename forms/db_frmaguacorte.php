...
function js_pesquisax40_codsituacao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_aguacorte','db_iframe_aguacortesituacao','func_aguacortesituacao.php?funcao_js=parent.js_mostraaguacortesituacao1|x43_codsituacao|x43_descr','Pesquisa',true,5);
  }else{
     if(document.form1.x40_codsituacao.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_aguacorte','db_iframe_aguacortesituacao','func_aguacortesituacao.php?pesquisa_chave='+document.form1.x40_codsituacao.value+'&funcao_js=parent.js_mostraaguacortesituacao','Pesquisa',false);
     }else{
