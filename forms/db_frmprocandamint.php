        ...
        <table border="0">
                        ...
                        <table>
                            ...
                            <tr id="trdespacho">
                                ...
                                <td>
                                    ...
                                    db_input("p201_descricao", 32, false, 3, "text", 3, "", "","", "width:202%;");
                                    ?>
                                </td>
                            </tr>
            ...
            <tr>
                <td colspan=4 align='center' >
                    ...
                    <input name="voltar" type="button" id="voltar" value="Voltar" onclick='CurrentWindow.corpo.location.href="pro4_procandamint001.php"' >
                    <?
...
<script>
    ...
    function js_mostradespacho(p201_sequencial,p201_descricao,p201_textopadrao,erro){
        ...
        document.form1.p78_despacho.value = p201_textopadrao;
        document.form1.p78_despacho.value = document.form1.p78_despacho.value.replace(/<br>/g , "\n");

        if(erro==false){
            document.form1.p201_sequencial.focus();
            document.form1.p201_descricao.value = '';
            document.form1.p78_despacho.value = '';
        }
    }
