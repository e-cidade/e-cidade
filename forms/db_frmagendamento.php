...
function js_pesquisasd03_i_codigo2(mostra,depara){
  ...
  if(mostra==true){
      js_OpenJanelaIframe('','db_iframe_medicos','func_medicos.php?prof_ativo=1&funcao_js=parent.js_mostramedicos_21|z01_nome|sd03_i_codigo|sd27_i_codigo&chave_sd06_i_unidade='+document.form1.sd02_i_codigo.value,'Pesquisa',true);
  }else{
    if(document.form1.sd03_i_codigo.value != ''){
        js_OpenJanelaIframe('','db_iframe_medicos','func_medicos.php?prof_ativo=1&pesquisa_chave='+document.form1.sd03_i_codigo.value+'&funcao_js=parent.js_mostramedicos_21&chave_sd06_i_unidade='+document.form1.sd02_i_codigo.value,'Pesquisa',false);
    }else{
      document.form1.z01_nome.value = '';
    }
  }
