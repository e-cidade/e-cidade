...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_issporte','func_issporte.php?funcao_js=parent.js_preenchepesquisa|q40_codporte','Pesquisa',true);
}
