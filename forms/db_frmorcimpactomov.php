...
function js_nov_orgao(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcorgao','orc1_orcorgao001.php?novo=true&funcao_js=parent.js_ret_orgao','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_unidade(){
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','orc1_orcunidade001.php?orgao='+orgao+'&novo=true&funcao_js=parent.js_ret_unidade','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_funcao(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcfuncao','orc1_orcfuncao001.php?novo=true&funcao_js=parent.js_ret_funcao','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_subfuncao(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcsubfuncao','orc1_orcsubfuncao001.php?novo=true&funcao_js=parent.js_ret_subfuncao','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_programa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprograma','orc1_orcprograma001.php?novo=true&funcao_js=parent.js_ret_programa','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_acao(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprojativ','orc1_orcprojativ001.php?novo=true&funcao_js=parent.js_ret_acao','Pesquisa',true,'0','1','770','390');
}
...
function js_nov_produto(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcproduto','orc1_orcproduto001.php?novo=true&funcao_js=parent.js_ret_produto','Pesquisa',true,'0','1','770','390');
}
...
function js_produto(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcproduto','func_orcproduto.php?funcao_js=parent.js_mostraproduto1|o22_codproduto|o22_descrprod','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcproduto','func_orcproduto.php?pesquisa_chave='+document.form1.o63_produto.value+'&funcao_js=parent.js_mostraproduto','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_orgao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcorgao','func_orcorgao.php?funcao_js=parent.js_mostraorcorgao1|o40_orgao|o40_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcorgao','func_orcorgao.php?pesquisa_chave='+document.form1.o63_orgao.value+'&funcao_js=parent.js_mostraorcorgao','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_unidade(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_anousu|o41_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o63_unidade.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_unidade(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_orgao|o41_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o63_unidade.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_unidade(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?funcao_js=parent.js_mostraorcunidade1|o41_unidade|o41_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcunidade','func_orcunidade.php?pesquisa_chave='+document.form1.o63_unidade.value+'&funcao_js=parent.js_mostraorcunidade','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_funcao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcfuncao','func_orcfuncao.php?funcao_js=parent.js_mostraorcfuncao1|o52_funcao|o52_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcfuncao','func_orcfuncao.php?pesquisa_chave='+document.form1.o63_funcao.value+'&funcao_js=parent.js_mostraorcfuncao','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_subfuncao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcsubfuncao','func_orcsubfuncao.php?funcao_js=parent.js_mostraorcsubfuncao1|o53_subfuncao|o53_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcsubfuncao','func_orcsubfuncao.php?pesquisa_chave='+document.form1.o63_subfuncao.value+'&funcao_js=parent.js_mostraorcsubfuncao','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_programa(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprograma','func_orcprograma.php?funcao_js=parent.js_mostraorcprograma1|o54_programa|o54_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprograma','func_orcprograma.php?pesquisa_chave='+document.form1.o63_programa.value+'&funcao_js=parent.js_mostraorcprograma','Pesquisa',false,0);
  }
}
...
function js_pesquisao63_projativ(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprojativ','func_orcprojativ.php?funcao_js=parent.js_mostraorcprojativ1|o55_projativ|o55_descr','Pesquisa',true,0);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcprojativ','func_orcprojativ.php?pesquisa_chave='+document.form1.o63_acao.value+'&funcao_js=parent.js_mostraorcprojativ','Pesquisa',false,0);
  }
}
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcimpactomov','func_orcimpactomov.php?funcao_js=parent.js_preenchepesquisa|o63_codimpmov|db_tipo','Pesquisa',true,0,'1','770','390');
}
...
function js_consultar(){
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_orcimpactomov','db_iframe_orcimpactomov','func_orcimpactomov.php?'+query+'&funcao_js=parent.js_preenchepesquisa|o63_codimpmov|db_tipo','Pesquisa',true,'0','1','770','390');
}
</script>
