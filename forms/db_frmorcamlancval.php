                        ...
                        "<tr>
                            <td colspan='2' align='center'>
                                ...
                                if($voltar==true){
                                    ...
                                    echo  " <input name='Preço de Referência' type='button' id='Preço de Referência' value='Preço de Referência'  onclick='document.location.href=\"sic1_precoreferencia001.php?si01_processocompra=$p80_codproc\"'>";
                                }
