  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?funcao_js=parent.js_mostrasau_procedimento1|sd63_i_codigo|sd63_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd81_i_procedimento.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procedimento','func_sau_procedimento.php?pesquisa_chave='+document.form1.sd81_i_procedimento.value+'&funcao_js=parent.js_mostrasau_procedimento','Pesquisa',false);
     }else{
...
function js_pesquisasd81_i_leito(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_tipoleito','func_sau_tipoleito.php?funcao_js=parent.js_mostrasau_tipoleito1|sd80_i_codigo|sd80_c_nome','Pesquisa',true);
  }else{
     if(document.form1.sd81_i_leito.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_tipoleito','func_sau_tipoleito.php?pesquisa_chave='+document.form1.sd81_i_leito.value+'&funcao_js=parent.js_mostrasau_tipoleito','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_sau_procleito','func_sau_procleito.php?funcao_js=parent.js_preenchepesquisa|sd81_i_codigo','Pesquisa',true);
}
