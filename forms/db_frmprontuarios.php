  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_unidades','func_unidades.php?funcao_js=parent.js_mostraunidades1|sd02_i_codigo|sd02_c_nome','Pesquisa',true);
     ...
     if(document.form1.sd24_i_unidade.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_unidades','func_unidades.php?pesquisa_chave='+document.form1.sd24_i_unidade.value+'&funcao_js=parent.js_mostraunidades','Pesquisa',false);
     }else{
...
function js_pesquisasd24_i_grupoatend(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_grupoatend','func_grupoatend.php?funcao_js=parent.js_mostragrupoatend1|sd15_i_codigo|sd15_c_descr','Pesquisa',true);
  }else{
     if(document.form1.sd24_i_grupoatend.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_grupoatend','func_grupoatend.php?pesquisa_chave='+document.form1.sd24_i_grupoatend.value+'&funcao_js=parent.js_mostragrupoatend','Pesquisa',false);
     }else{
...
function js_pesquisasd24_c_cid(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cids','func_cids.php?funcao_js=parent.js_mostracids1|sd22_c_codigo|sd22_c_codigo','Pesquisa',true);
  }else{
     if(document.form1.sd24_c_cid.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cids','func_cids.php?pesquisa_chave='+document.form1.sd24_c_cid.value+'&funcao_js=parent.js_mostracids','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true);
     ...
     if(document.form1.sd24_i_numcgm.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.sd24_i_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_prontuarios','func_prontuarios.php?funcao_js=parent.js_preenchepesquisa|sd24_i_codigo','Pesquisa',true);
}
