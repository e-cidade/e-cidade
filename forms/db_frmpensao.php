  ...
  <tr>
    <td>
      <fieldset>
        ...
        <table border="0" width="63%">
          <tr>
            <td nowrap title="<?=@$Tr52_codbco?>" align="right">
              <?
          ...
          <tr>
            <td nowrap title="<?=@$Tr52_codage?>" align="right">
              <?=@$Lr52_codage?>
            </td>
            <td>
              <?
          ...
          <tr>
            <td nowrap title="<?=@$Tr52_conta?>" align="right">
              <?=@$Lr52_conta?>
            </td>
            <td>
              <?
              db_input('r52_conta',15,$Ir52_conta,true,'text',$db_opcao," tabIndex='9' ");
              ?>
            </td>
            <td nowrap title="<?=@$Tr52_dvconta?>" align="right">
              <?=@$Lr52_dvconta?>
            </td>
            <td>
              <?
