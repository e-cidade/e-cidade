  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_liclicita','func_liclicita.php?funcao_js=parent.js_mostraliclicita1|l20_codigo|l20_codigo','Pesquisa',true);
     ...
     if(document.form1.l29_liclicita.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_liclicita','func_liclicita.php?pesquisa_chave='+document.form1.l29_liclicita.value+'&funcao_js=parent.js_mostraliclicita','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_liclicitaweb','func_liclicitaweb.php?funcao_js=parent.js_preenchepesquisa|l29_sequencial','Pesquisa',true);
}
