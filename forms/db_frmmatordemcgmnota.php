     ...
     ?>
      <table>
        <tr>
         <td>
          <fieldset>
           <iframe name="itens" id="itens" src="forms/db_frmmatordemitemnota.php?e60_numcgm=<?=$e60_numcgm?>&erro=false" width="800" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>
          </fieldset>
         </td>
        </tr>
      </table>
     ...
     ?>
      <table>
        <tr>
         <td>
          <fieldset>
           <iframe name="itens" id="itens" src="forms/db_frmmatordemitemnota.php?e60_numcgm=<?=$e60_numcgm?>&erro=false&e60_codemp=<?=@$e60_codemp?>&e60_numemp=<?=@$e60_numemp?>" width="800" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>
           </fieldset>
         </td>
        </tr>
      </table>
