...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_ouvidoriaparametro','func_ouvidoriaparametro.php?funcao_js=parent.js_preenchepesquisa|ov_06_instit|ov06_anousu','Pesquisa',true);
}
