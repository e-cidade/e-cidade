...
function js_pesquisa(){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_progavaladmin','func_progavaladmin.php?funcao_js=parent.js_preenchepesquisa|ed112_i_rhpessoal|ed116_i_ano|ed116_c_tipo','Pesquisa de Avaliação Administrativa',true);
}
