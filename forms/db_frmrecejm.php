							...
							<fieldset><Legend align="left"><b> Correção</b></Legend>
								<table width="100%">
									...
									<tr>
										...
										<td align="left">
											<select name="k02_corven" id="k02_corven">
												<option value="f" <? echo isset($k02_corven)?($k02_corven=="f"?"selected":""):"" ?>>N&atilde;o</option>
												<option value="t" <? echo isset($k02_corven)?($k02_corven=="t"?"selected":""):"" ?>>Sim</option>
											</select>
										</td>
								</table>
							</fieldset>
									...
									<tr>
										...
										<td align="left">
											<select name="k02_juracu" id="k02_juracu">
												<option value="f" <? echo isset($k02_juracu)?($k02_juracu=="f"?"selected":""):"" ?>>N&atilde;o</option>
												<option value="t" <? echo isset($k02_juracu)?($k02_juracu=="t"?"selected":""):"" ?>>Sim</option>
											</select>
										</td>
										<td>&nbsp;</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<select name="k02_integr" id="k02_integr">
												<option value="f" <? echo isset($k02_integr)?($k02_integr=="f"?"selected":""):"" ?>>N&atilde;o</option>
												<option value="t" <? echo isset($k02_integr)?($k02_integr=="t"?"selected":""):"" ?>>Sim</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td align="left">
											<select name="k02_caldes" id="k02_caldes">
												<option value="f" <? echo isset($k02_caldes)?($k02_caldes=="f"?"selected":""):"" ?>>N&atilde;o</option>
												<option value="t" <? echo isset($k02_caldes)?($k02_caldes=="t"?"selected":""):"" ?>>Sim</option>
											</select>
										</td>
									</tr>
