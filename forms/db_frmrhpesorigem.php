...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Trh21_regist?>">
       <?=@$Lrh21_regist?>
    </td>
    <td>
<?
db_input('rh21_regist',6,$Irh21_regist,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Trh21_regpri?>">
       <?=@$Lrh21_regpri?>
    </td>
    <td>
<?
db_input('rh21_regpri',6,$Irh21_regpri,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
