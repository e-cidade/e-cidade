      ...
      <td>
        <fieldset>
          ...
          <table class="subtable">
            ...
            <tr>
              <td align="center"><br>
                <input type="button" id='relatorioagenda' name="relatorioagenda" value="Emitir Relatório" onclick="js_relatorioagenda()"  disabled >
              </td>
              <td align="center"><br>
                <input type="button" name="limpar" value="Limpar" onclick="location.href='sau2_relatorioagendamento001.php' ">
              </td>
            </tr>
            <tr>
              <td colspan="3">
...
function js_agendados() {
  ...
  if( sd23_d_consulta != "" ) {
    ...
    x  = 'sau2_relatorioagendamento003.php';
...
function js_pesquisasd04_i_cbo(lMostra) {
...
function js_pesquisasd03_i_codigo( lMostra ) {
...
function js_limpaDados() {
  ...
  $('sd23_d_consulta_dia').value = '';
  $('sd23_d_consulta_mes').value = '';
  $('sd23_d_consulta_ano').value = '';
  $('diasemana').value           = '';
  document.getElementById('frameagendados').src = "";
}

function js_validaLiberaBotao() {

  $('relatorioagenda').disabled = true;
  if ( $F('sd03_i_codigo') != '' && $F('rh70_estrutural') != '' && $F('sd23_d_consulta') != '' ) {
    $('relatorioagenda').removeAttribute('disabled')
  }
