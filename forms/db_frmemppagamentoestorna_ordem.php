	...
	for(i=0; i<obj.length; i++ ){
	  ...
	  if(nome=="generico"){
	    codele = obj[i].name.substring(9);
  	    ...
  	    total_ele  = new Number(eval("document.form1.e64_vlrpag_"+codele+".value"));
	    if(tot >= vlrlimite){
	    ...
	    dados += vir+codele+"-"+obj[i].value+"-"+total+"-"+total_ele;
	    vir='#';
	  }
	}
	...
	echo "
	    <tr>
	      ...
	      <td class='bordas' align='center'><b><small>$RLe64_vlranu</small></b></td>
              ...
              <td class='bordas' align='center'><b><small>Aulado ordem</small></b></td>
	                        
              <td class='bordas' align='center'><b><small>Dísponivel</small></b></td>";
       echo " <td class='bordas' align='center'><b><small>Estornar</small></b></td>";
   echo "  </tr>";
	  $eles = '';
	  $vir = "";
         for($i=0; $i<$numrows; $i++){
	    db_fieldsmemory($result,$i,true);
		 ...
		 //rotina que pega os valores de pagordemele
		    ...
		    if($db_opcao==2 ||$db_opcao==33 || ($db_opcao==3 && $e50_codord!="")){
