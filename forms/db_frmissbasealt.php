...
if(@$q02_inscr!="") {
  ...
  $sSqlIss  = " select issbase.*, issruas.z01_cep as cepissruas, escrito.q10_numcgm, cgm.z01_nome as z01_nome_escrito, q179_inscricaoredesim ";
  ...
  $sSqlIss .= "   left join inscricaoredesim on q179_inscricao  = issbase.q02_inscr ";
  ...
  <fieldset class='separator'>
    ...
    <table border="0" width="100%"  >
      <tr>
        ...
        <tr>
            <?php
            if (!empty($q179_inscricaoredesim)) {
            ?>
        <tr>
            <td nowrap title="Inscrição Redesim" width="150px">
                <strong>Inscrição Redesim:</strong>
            </td>
            <td>
                <?php
                db_input('q179_inscricaoredesim',10,$Iq02_inscr,true,'text',3);
                ?>
            </td>
        </tr>
        <?php } ?>
