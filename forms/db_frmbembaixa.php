  ...
  <fieldset>
    ...
    <table class="form-container">
      ...
      <tr>
        ...
        <td>
          <?
          $t55_baixa_dia = date("d", db_getsession("DB_datausu"));
          $t55_baixa_mes = date("m", db_getsession("DB_datausu"));
          $t55_baixa_ano = date("Y", db_getsession("DB_datausu"));
          db_inputdata('t55_baixa', @$t55_baixa_dia, @$t55_baixa_mes, @$t55_baixa_ano, true, 'text', 3, "");
          ?>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <?
            db_ancora("Destino", "js_pesquisa_cgm(true)", $db_opcao);
          ?>
        </td>
        <td>
          <?
            db_input('t55_destino', 10, $It55_destino, true, 'text', $db_opcao, "onchange='js_pesquisa_cgm(false)'");
