...
?>
  <form name="form1" method="post" action="">
    ...
    ?>
    <input name="relatorio" type="button" id="db_opcao" value="Relatório de autorização" onclick="CurrentWindow.corpo.iframe_prazos.js_relatorio();"  <?=($db_botao==false||$db_botao_c==false?"disabled":"")?>>
  </form>
<?
if(isset($nops)){
  db_msgbox($nops);
...
?>
  <script>
    ...
    function js_pesquisao47_coddot(mostra){
      ...
      if(mostra==true){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_empautidot','db_iframe_orcdotacao','func_permorcdotacao.php?'+query+'funcao_js=parent.js_consultarDataDoSistema|o58_coddot','Pesquisa',true,0);
      }else{
