...
<form name="form1" method="post" action="" >
  <center>
    <table border="0">
	 ...
	 <tr>
	   <td nowrap title="<?=@$Tk49_modcarnepadrao?>">
	     <?=@$Lk49_modcarnepadrao?>
	   </td>
       <td>
		 <?
    ...
    <tr>
      <td valign="top"  align="center">
	    <?
		  ...
		  $cliframe_alterar_excluir->campos  	   = "k49_sequencial,k49_modcarnepadrao,k49_tipo";
...
function js_pesquisak49_tipo(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_arretipo','func_arretipo.php?funcao_js=parent.js_mostraarretipo1|k00_tipo|k00_descr','Pesquisa',true,0);
     ...
     if(document.form1.k49_tipo.value != ''){
        js_OpenJanelaIframe('','db_iframe_arretipo','func_arretipo.php?pesquisa_chave='+document.form1.k49_tipo.value+'&funcao_js=parent.js_mostraarretipo','Pesquisa',false);
     }else{
...
function js_mostraarretipo(chave,erro){
  ...
  if(erro==true){
    document.form1.k49_tipo.focus();
    document.form1.k49_tipo.value = '';
  }
}
function js_mostraarretipo1(chave1,chave2){
  document.form1.k49_tipo.value = chave1;
