...
function js_pesquisae21_retencaotipocalc(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_retencaotipocalc','func_retencaotipocalc.php?funcao_js=parent.js_mostraretencaotipocalc1|e32_sequencial|e32_descrição','Pesquisa',true);
  }else{
     if(document.form1.e21_retencaotipocalc.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_retencaotipocalc','func_retencaotipocalc.php?pesquisa_chave='+document.form1.e21_retencaotipocalc.value+'&funcao_js=parent.js_mostraretencaotipocalc','Pesquisa',false);
     }else{
...
function js_pesquisae21_retencaonatureza(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_retencaonatureza',
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tabrec','func_tabrec.php?funcao_js=parent.js_mostratabrec1|k02_codigo|k02_descr','Pesquisa',true);
     ...
     if(document.form1.e21_receita.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_tabrec','func_tabrec.php?pesquisa_chave='+document.form1.e21_receita.value+'&funcao_js=parent.js_mostratabrec','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_retencaotiporec','func_retencaotiporec.php?funcao_js=parent.js_preenchepesquisa|e21_sequencial','Pesquisa',true);
}
