...
function js_pesquisah55_rhestagio(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_rhestagioperiodo','db_iframe_rhestagio','func_rhestagio.php?funcao_js=parent.js_mostrarhestagio1|h50_sequencial|h50_sequencial','Pesquisa',true);
  }else{
     if(document.form1.h55_rhestagio.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_rhestagioperiodo','db_iframe_rhestagio','func_rhestagio.php?pesquisa_chave='+document.form1.h55_rhestagio.value+'&funcao_js=parent.js_mostrarhestagio','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo.iframe_rhestagioperiodo','db_iframe_rhestagioperiodo','func_rhestagioperiodo.php?funcao_js=parent.js_preenchepesquisa|h55_sequencial','Pesquisa',true);
}
