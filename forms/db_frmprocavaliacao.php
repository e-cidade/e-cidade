...
if( !isset( $excluir ) ) {
  ...
  $result1 = $clprocavaliacao->sql_record( $sSql );
...
if( isset( $ed41_i_formaavaliacao ) && $ed41_i_formaavaliacao != "" ) {
  ...
  $sSql   = $clformaavaliacao->sql_query( "", "ed37_c_tipo as formaaval", "", "ed37_i_codigo = {$ed41_i_formaavaliacao}");
  $result = $clformaavaliacao->sql_record( $sSql );
