...
<form name="form1" method="post" action="">
    ...
    <table border="0">
      ...
      <tr>
        ...
        <td>
          <? db_input(
            ...
            'text',
            $db_opcao,
            " onchange='js_pesquisaed05_i_tipoato(false)'; "
          )
          ?>
      ...
      <tr>
        ...
        <td>
          <? db_inputdata(
            'ed05_d_publicado',
            @$ed05_d_publicado_dia,
            @$ed05_d_publicado_mes,
            @$ed05_d_publicado_ano,
            true,
            'text',
            $db_opcao,
            ""
      ...
      <tr>
        ...
        <td>
          <b style="margin-left: -200px;"> Aparece nos Relatórios: </b>
        </td>
        <td>
          <div style="margin-left: -55px;">
            <?
            $aX = array('f' => 'NÃO', 't' => 'SIM');
            db_select('ed05_i_aparecerelatorio', $aX, true, $db_opcao);
            ?>
          </div>
        </td>
      </tr>
  ...
  <input name="pesquisar" type="button" id="pesquisar" value="Pesquisar" onclick="js_pesquisa();" </form>
  <script>
