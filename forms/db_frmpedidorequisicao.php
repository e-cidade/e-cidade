...
<tr>
<td>
<fieldset><legend><b>Pedido de Requisição</b></legend>
<table border="0">
  <tr>
...
db_input('descrdepto',40,$Idescrdepto,true,'text',3,'');
  ...
  <table>
   <tr>
     ...
     <fieldset><legend><b>&nbsp;Materiais da Requisição&nbsp;</b></legend>
        ...
        <table  cellspacing=0 cellpadding=0 width='100%' style='border:2px inset white'>
          <tr>
            ...
            <th class='table_header'>Qtde Anulada</th>
    ...
    <tr>
    <td>
      <!--  <iframe name="itens" id="itens" src="mat1_atendrequiitemalt001mat1_atendrequi001.php.php?m40_codigo=<?=$m40_codigo?>" width="720" height="220" marginwidth="0" marginheight="0" frameborder="0"></iframe>-->
     </td>
    </tr>
  </table>
  </center>
...
function js_saida(oAjax) {
  ...
  if (obj.itens) {
	    ...
	    for (iInd = 0; iInd < obj.itens.length; iInd++){
	        ...
	        saida +=     qtdeestoque;
	        saida += "  </td>";
	        saida += "  <td class='linhagrid' style='text-align:right' id='quantanulada"+m41_codigo+"'>";
	        saida +=     quantanulada;
	        saida += "  </td>";
	        saida += "  <td class='linhagrid' style='text-align:right' id='quantpendente"+m41_codigo+"'>";
	        saida +=     qtdpendente;
	        saida += "  </td>";
	        ...
	        saida += "           onblur='js_verificaQuantidade(this.value, "+(qtdpendente)+",\"Quantidade maior que o saldo.\")'";
	        saida += "           value='"+(qtdpendente)+"' size='5' class='valores' disabled ";
