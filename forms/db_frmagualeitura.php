...
<form name="form1" method="post" action="">
          ...
          <fieldset>
            ...
            <table width="100%">
              ...
              <tr>
                ...
                <td nowrap><?
                db_input('x01_tipoimovel', 8, @$Ix01_tipoimovel, true, 'hidden',3);
                ?>
                </td>
          ...
          <fieldset>
            ...
            <table width="100%">
              ...
              <tr>
                ...
                <td nowrap><?
                db_input('x21_consumo',6,$Iz01_nome,true,'text',(db_permissaomenu(db_getsession("DB_anousu"),4555,5070)=="true"?1:3),"","");
                ?>
                </td>
                <td nowrap title="<?=@$Tx21_excesso?>" align="right"><?
                db_ancora(@$Lx21_excesso,"",3);
                ...
                <td nowrap><?
                db_input('x21_excesso',6,$Ix21_excesso,true,'text',(db_permissaomenu(db_getsession("DB_anousu"),4555,5071)=="true"?1:3),"","");
                ?>
                </td>
                <td nowrap title="<?=@$Tx21_saldo?>" align="right"><?
                db_ancora(@$Lx21_saldo, '', 3);
  ...
  <input name="<?=($db_opcao==1?"incluir":($db_opcao==2||$db_opcao==22?"alterar":"excluir"))?>" type="submit" id="db_opcao"
    ...
    onclick="return js_verifica_campos();"> <input name="pesquisar" type="button" id="pesquisar" value="Pesquisar" onclick="js_pesquisa();"> <input
    name="anteriores" type="button" id="anteriores" value="Leituras anteriores" onclick="js_pesquisa_anterior();"
