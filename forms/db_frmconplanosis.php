...
$clconplanosis->rotulo->label();
?>
<form name="form1" method="post" action="">
<center>
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tc64_codpla?>">
       <?=@$Lc64_codpla?>
    </td>
    <td>
<?
...
<?
       if($db_opcao!=1){
         ...
         $clestrutura_sistema->size   =20;
	 $clestrutura_sistema->estrutura_sistema('c90_estrutsistema');
?>
  <tr>
    <td nowrap title="<?=@$Tc64_descr?>">
       <?=@$Lc64_descr?>
    </td>
    <td>
<?
