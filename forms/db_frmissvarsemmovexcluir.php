      ...
      <tr>
        <td>
          ...
          if (isset($q07_inscr) && $q07_inscr != '') {
            ...
            $cliframe_seleciona->sql = "SELECT ISSVAR.*, ARREINSCR.* FROM ARREINSCR INNER JOIN ISSVAR ON ISSVAR.Q05_NUMPRE = ARREINSCR.K00_NUMPRE INNER JOIN ARRECANT ON ARRECANT.K00_NUMPRE = Q05_NUMPRE AND K00_NUMPAR = ISSVAR.Q05_NUMPAR WHERE ARRECANT.K00_VALOR='0' AND K00_INSCR = $q07_inscr AND Q05_VALOR = 0 ORDER BY Q05_ANO, Q05_MES";
          }
