...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_db_tipoinstit','func_db_tipoinstit.php?funcao_js=parent.js_preenchepesquisa|db21_codtipo','Pesquisa',true);
}
