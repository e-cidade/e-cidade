  ...
  <div class='container'>
    <fieldset>
      ...
      <fieldset class='separator'>
        ...
        <table class="form-container">
          <tr>
            <td class='field-size2 bold' nowrap="nowrap">Data Saída:</td>
            <td nowrap="nowrap">
              <?php
            ...
            <td class='bold text-right' nowrap="nowrap">Hora Saída:</td>
            <td nowrap="nowrap" >
              <?php
      ...
      <fieldset class='separator'>
        ...
        <fieldset class='separator'>
          ...
          <tr>
            ...
            <td class='bold' nowrap="nowrap"> = Lugares Disponíveis: </td>
