...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Trh20_seqpes?>">
       <?=@$Lrh20_seqpes?>
    </td>
    <td>
<?
db_input('rh20_seqpes',6,$Irh20_seqpes,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Trh20_cargo?>">
       <?=@$Lrh20_cargo?>
    </td>
    <td>
<?
db_input('rh20_cargo',5,$Irh20_cargo,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  </table>
