...
<table border="0">
  <tr>
    <td nowrap title="<?=@$Tma04_i_codigo?>">
       <?=@$Lma04_i_codigo?>
    </td>
    <td>
<?
db_input('ma04_i_codigo',10,$Ima04_i_codigo,true,'text',3,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tma04_c_descr?>">
       <?=@$Lma04_c_descr?>
    </td>
    <td>
<?
db_input('ma04_c_descr',40,$Ima04_c_descr,true,'text',$db_opcao,"")
?>
    </td>
  </tr>
  <tr>
    <td nowrap title="<?=@$Tma04_c_subdistrito?>">
       <?=@$Lma04_c_subdistrito?>
    </td>
    <td>
    <?
db_input('ma04_c_subdistrito',40,$Ima04_c_subdistrito,true,'text',$db_opcao,"")
    ?>
    </td>
  </tr>
  </table>
