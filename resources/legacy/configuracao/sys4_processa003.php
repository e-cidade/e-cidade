...
//
// Variaveis para configuração dos metodos a serem gerados
//
...
if (! is_writable($root . "/classes")) {
  ...
  <tr>
    <td align="center">
    <h6>Sem permissão para gravar em "classes/" ou não existe.</h6>
    </td>
  </tr>
</table>
</body>
...
<table width="100%">
  <tr>
    <td align="center">
    <h6>Sem permissão para gravar "classes/db_<?=$nometab?>_classe"</h6>
    </td>
  </tr>
</table>
</body>
