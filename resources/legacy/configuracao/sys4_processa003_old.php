...
<?
  ...
  if(!is_writable($root."/classes")){
     ?>
     <table width="100%"><tr><td align="center"><h6>Sem permissão para gravar em "classes/" ou não existe.</h6></td></tr></table>
     </body>
     </html>
     <?
     exit;
  ...
  if(file_exists($arquivo) && !is_writable($arquivo)){
     ?>
     <table width="100%"><tr><td align="center"><h6>Sem permissão para gravar "classes/db_<?=$nometab?>_classe"</h6></td></tr></table>
     </body>
     </html>
     <?
     exit;
