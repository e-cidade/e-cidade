  ...
  <input name="processar" type="button" id="processar" value="Processar" onclick="js_processar();" >
    ...
    <script>
      function js_processar(){
        ...
        var lProcessa = confirm("Deseja realmente processar todas as classes ?");

        if ( lProcessa ) {
          js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_classes','sys4_processa003.php','Processa',true);
        }
