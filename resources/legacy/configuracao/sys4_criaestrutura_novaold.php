...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#cccccc" style='border:1px solid black'>
 ...
 ?>
  ...
  <tr><td colspan5><b>Nome do Arquivo</b></td></tr>
   <tr>
     <td><input type="text" name="nome_arq"class="input"></td></tr>
 </table>
<br>
  ...
  //define quantos checkboxes iram ficar por linha da tabela.
   ...
   while ($j < pg_numrows($rstab)){
	...
	if ($quebratab == 4){
        ...
        echo "<td width=135><input type='checkbox' name='chk".$nomearq.$codarq."' value='".$codarq."'>".$nomearq."</td>\n";
      }else{
         $quebratab=1;
         echo "</table>";
         ...
         echo "<tr>\n<td width=135><input type='checkbox' name='chk".$nomearq.$codarq."' value='".$codarq."'>".$nomearq."</td>\n";
     }
   $modulo = $nomemod;
   $j++;
   }
