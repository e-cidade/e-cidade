...
if (isset($opcao)) {
  ...
  if ($clvac_vacinadose->numrows > 0) {
    ...
    CurrentWindow.corpo.iframe_a3.iframe_a2.location.href   = 'vac1_vac_vacinadose005.php?'+
                                          'chavepesquisa=<?=$vc07_i_codigo?>';
    CurrentWindow.corpo.iframe_a3.iframe_a3.location.href   = 'vac1_vac_vacinadoserestricao004.php?'+
                                          'vc08_i_vacinadose=<?=$vc07_i_codigo?>&vc07_c_nome=<?=$vc07_c_nome?>'+
                                          '&vc06_i_codigo=<?=$vc07_i_vacina?>&vc06_c_descr=<?=$vc06_c_descr?>';
    CurrentWindow.corpo.iframe_a3.iframe_a4.location.href   = 'vac1_vac_dependencia004.php?'+
