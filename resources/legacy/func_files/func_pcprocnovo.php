  ...
  <table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
    ...
    <tr>
      <td align="center" valign="top">
        ...
        /**
         * Bloqueado para não trazer os processos de compra que jÃ¡ tem todos os itens vinculados a um orÃ§amento
         */
        ...
        if (!isset($pesquisa_chave)) {
          ...
          $sql .=  " and pc81_codprocitem in (select pc31_pcprocitem from pcorcamitemproc)";
