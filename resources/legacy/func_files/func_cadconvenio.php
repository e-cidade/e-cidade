    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ar11_sequencial) && (trim($chave_ar11_sequencial)!="") ){
          $sql = $clcadconvenio->sql_query("",$campos,"ar11_sequencial", "{$sWhere} and ar11_sequencial = $chave_ar11_sequencial ");
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          ...
          $sWhere .= " and cadconvenio.ar11_sequencial = ". $pesquisa_chave;

          $result = $clcadconvenio->sql_record($clcadconvenio->sql_query(null,"*",null,$sWhere));
