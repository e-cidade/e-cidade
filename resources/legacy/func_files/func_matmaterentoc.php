...
if( !isset($m38_visualizacaomatestoque) ) {
	     ...
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
           ...
           <tr>
            ...
            <?
              $x = array('f'=>'Não','t'=>'Sim');
              db_select('m38_visualizacaomatestoque',$x,true,2);
            ?>
            </td>
          </tr>
          <tr> 
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        $sWhereConfig = " and m60_ativo is true ";
        ...
        if(isset($chave_m60_codmater) && (trim($chave_m60_codmater)!="") ){
	         $sql = $clmatmater->sql_query_config($chave_m60_codmater,$campos,"m60_codmater","m60_codmater=$chave_m60_codmater and m60_ativo is true {$sWhereConfig}");
        }else if(isset($chave_m60_descr) && (trim($chave_m60_descr)!="") ){
	         $sql = $clmatmater->sql_query_config("",$campos,"m60_descr"," m60_descr like '$chave_m60_descr%' and m60_ativo is true {$sWhereConfig}");
        }else{
