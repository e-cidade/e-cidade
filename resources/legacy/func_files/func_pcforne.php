...
$lValidaRepr = isset($validaRepresentante);
      ...
      <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
          if (isset($campos) == false) {
            $campos = "pc60_numcgm,pc60_dtlanc,trim(from z01_nome) as z01_nome,z01_cgccpf,z01_telef,z01_email";
          }
          if ($lValidaRepr) {
          ...
          if (isset($chave_pc60_numcgm) && (trim($chave_pc60_numcgm) != "")) {
            ...
            $sql = $clpcforne->sql_query("", $campos, "pc60_dtlanc", " pc60_dtlanc like '$chave_pc60_dtlanc%' ", $lValidaRepr);
          } else if (isset($chave_z01_nome) && (trim($chave_z01_nome) != "")) {
            $sql = $clpcforne->sql_query("", $campos, "z01_nome", " z01_nome like '$chave_z01_nome%' ", $lValidaRepr);
