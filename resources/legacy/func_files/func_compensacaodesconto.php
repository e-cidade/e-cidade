            ...
            <td> 
              <fieldset>
                ...
                <table class="linhaZebrada">
                  <tr><td align="right">Código Abatimento :  &nbsp;</td><td><?php echo $oDadosDesconto->k125_sequencial;                ?></td></tr>
                  <tr><td align="right">Tipo de Abatimento : &nbsp;</td><td><?php echo $oDadosDesconto->k126_descricao;                 ?></td></tr>
                  <tr><td align="right">Data do Lançamento : &nbsp;</td><td><?php echo db_formatar($oDadosDesconto->k125_datalanc,'d'); ?></td></tr>
                  <tr><td align="right">Hora Lançamento :    &nbsp;</td><td><?php echo $oDadosDesconto->k125_hora;                      ?></td></tr>
