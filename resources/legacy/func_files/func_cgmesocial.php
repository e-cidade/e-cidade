            ...
            <td>
                ...
                <?php
                    if (isset($campos) == false) {
                       ...
                       z01_nome as z01_nomecgm,trim(z01_cgccpf) as z01_cgccpf,
                    ...
                    if (isset($nomeDigitadoParaPesquisa) && !empty($nomeDigitadoParaPesquisa)) {
                        ...
                        $sql = $clnome->sqlnome($nomeDigitadoParaPesquisa, $campos, "", " and Length(cgm.z01_cgccpf) like '11'");
                    } else if (isset($numcgmDigitadoParaPesquisa) && !empty($numcgmDigitadoParaPesquisa)) {
                        $sql = $clnome->sql_query($numcgmDigitadoParaPesquisa, $campos, "", " and Length(cgm.z01_cgccpf) like '11'");
                    } else if (isset($cpf) && !empty($cpf)) {
                        $sql = $clnome->sql_query("", $campos, "", " z01_cgccpf = '$cpf' and Length(cgm.z01_cgccpf) like '11' ");
                    } else {
                        $sql = "";
                        if (isset($z01_numcgm) && !empty($z01_numcgm)) {
                            $sql = $clnome->sql_query($z01_numcgm, $campos, "", " and Length(cgm.z01_cgccpf) like '11'");
                        }
                    }
