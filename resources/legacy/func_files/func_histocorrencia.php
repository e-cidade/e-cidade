...
<table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    if(!isset($pesquisa_chave)){
      ...
      /*$campos .= "fc_montamenu(histocorrencia.ar23_id_itensmenu) as Menu, ";
      $campos .= "db_config.nomeinst";*/
...
?>
<script type="text/javascript">
//js_tabulacaoforms("form2","chave_ar23_descricao",true,1,"chave_ar23_descricao",true);
