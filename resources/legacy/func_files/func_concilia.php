        ...
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          ...
          <tr> 
            ...
            <td width="96%" align="left" nowrap> 
              <?
              $sql_contas = " select db83_sequencial , db83_descricao || '  Conta:' || db83_conta ||'-'|| db83_dvconta from contabancaria where db83_contaplano is true";
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_concilia.php")==true){
             include("funcoes/db_func_concilia.php");
           }else{
           $campos = "concilia.*";
           }
        }
        ...
        if (isset($chave_k68_sequencial) && (trim($chave_k68_sequencial)!="") ) {
	         $sql = $clconcilia->sql_query($chave_k68_sequencial,$campos,"k68_sequencial");
        } else if (isset($db83_sequencial) && $db83_sequencial !=0 ) {
	         $sql = $clconcilia->sql_query("",$campos,"k68_data desc"," k68_contabancaria = $db83_sequencial");
        } else {
           $sql = $clconcilia->sql_query("",$campos,"k68_sequencial","");
        }
        ...
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
        	...
        	$result = $clconcilia->sql_record($clconcilia->sql_query($pesquisa_chave));
