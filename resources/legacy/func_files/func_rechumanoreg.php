    ...
    <tr>
      <td align="center" valign="top">
        <?php
          ...
          $sSqlRegencia = $clregencia->sql_query_turma_turno("","distinct ed59_i_disciplina, ed57_i_turno",""," ed59_i_codigo = $regencia");
          ...
          if (isset($campos) == false) {
            ...
            if (file_exists("funcoes/db_func_rechumano.php") == true) {
              include("funcoes/db_func_rechumano.php");
            } else {
              $campos = "rechumano.*";
            }
          }
          ...
          $sCampos .= "           then 'SIM'  ";
          $sCampos .= "           else 'NÃO'  ";
          $sCampos .= "       end as ed20_i_tiposervidor, ";
          $sCampos .= " ed23_i_codigo, ";
          $sCampos .= " case  ";
          ...
          $sql     .= "                    and ed17_i_turno = {$ed57_i_turno} ";
          $sql     .= "                ) ";
          $sql     .= "  $where ";
          ...
          if (!isset($pesquisa_chave)) {
            ...
            if (pg_num_rows($resul) == 0) {
              ...
              echo "<b>Nenhum professor com relações de trabalho cadastradas <br>ou nenhuma disponibilidade cadastrada.<br>
                    ...
                    (Cadastros / Recursos Humanos / Alteração / Aba Disponibilidade)</b>";
            }
          } else {
