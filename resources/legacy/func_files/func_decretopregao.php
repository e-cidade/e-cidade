	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_decretopregao.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_decretopregao.php")==true){
             include("funcoes/db_func_decretopregao.php");
           }else{
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $cldecretopregao->sql_record($cldecretopregao->sql_query($pesquisa_chave));
