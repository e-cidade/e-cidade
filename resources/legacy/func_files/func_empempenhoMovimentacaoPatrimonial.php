  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave) ){
        ...
        $dbwhere=" c71_coddoc = {$iDocumento} and e60_instit = ".db_getsession("DB_instit");
        ...
        if(isset($chave_e60_numemp) && (trim($chave_e60_numemp)!="") ){
          ...
          $sql = $clempempenho->sql_queryMovimentacaoPatrimonial($chave_e60_numemp,$campos,"e60_numemp","$dbwhere and e60_numemp=$chave_e60_numemp ");
          ...
          if ( $iDocumento == 212 ||  $iDocumento == 213) {

            $dbwhere_ano = "";
          }
          
          $sql = $clempempenho->sql_queryMovimentacaoPatrimonial("",$campos,"e60_numemp","$dbwhere and e60_codemp='".$arr[0]."'$dbwhere_ano");
          
        }else if(isset($chave_z01_nome) && (trim($chave_z01_nome)!="") ){

          $sql = $clempempenho->sql_queryMovimentacaoPatrimonial("",$campos,"e60_numemp","$dbwhere and z01_nome like '$chave_z01_nome%'");
        ...
        if($pesquisa_chave != null && $pesquisa_chave != ""){
          ...
          if ( isset($lPesquisaPorCodigoEmpenho) ) {
            ...
            if ( !empty($iAnoEmpenho) ) {
              $sWherePesquisaPorCodigoEmpenho = "c71_coddoc = {$iDocumento} and e60_anousu = " . $iAnoEmpenho;
            } else {
              $sWherePesquisaPorCodigoEmpenho = "c71_coddoc = {$iDocumento} and e60_anousu = ". db_getsession("DB_anousu");
            }

            $sWherePesquisaPorCodigoEmpenho .= " and e60_codemp = '$pesquisa_chave'";
            $sSql = $clempempenho->sql_queryMovimentacaoPatrimonial(null, '*', null, $sWherePesquisaPorCodigoEmpenho);

          } else {
            $sSql = $clempempenho->sql_queryMovimentacaoPatrimonial(null,'*',null,"c71_coddoc = {$iDocumento} and e60_numemp = {$pesquisa_chave} ");
          }
          ...
          if($clempempenho->numrows!=0){
            ...
            } else if ( isset($lPesquisaPorCodigoEmpenho) ) {
