      ...
      <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
          ...
          if ($pesquisa_chave != null && $pesquisa_chave != "") {
            ...
            } elseif (isset($veiccadcomb) && $veiccadcomb == "true" && $oDaoVeiculos->numrows != 0) {
              db_fieldsmemory($result, 0);
              echo "<script>" . $funcao_js . "('$ve01_placa','$ve26_codigo',false,'$ve01_ativo');</script>";
