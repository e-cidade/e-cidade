...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr> 
    ...
    if (isset($sFiltro)) {
      if ($sFiltro == "almox") {
        $where .= " m40_depto = ".db_getsession("DB_coddepto");
      }
     }
      ...
      $where .= ' and m41_quant <
       ...
       if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clmatrequi->sql_record($clmatrequi->sql_query_aatentimentos($pesquisa_chave,"*","m40_codigo desc","m40_codigo=$pesquisa_chave and $where"));
