    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_ve70_codigo) && (trim($chave_ve70_codigo)!="") ){
	         $sql = $clveicabast->sql_query_posto(null,$campos,"ve70_codigo","ve70_codigo = $chave_ve70_codigo and $dbwhere");
        }else if(isset($tipo_posto) && $tipo_posto == 1){  // interno
           $sql = $clveicabast->sql_query_posto("",$campos,"ve70_codigo","$dbwhere and (ve71_nota is null or ve71_nota = '')");
        }else if(isset($tipo_posto) && $tipo_posto == 2){ // externo
           $sql = $clveicabast->sql_query_posto("",$campos,"ve70_codigo","$dbwhere and ve34_veiccadposto is not null");
        }else {
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clveicabast->sql_record($clveicabast->sql_query(null,"*",null,"ve70_codigo = $pesquisa_chave and $dbwhere"));
