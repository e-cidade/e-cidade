...
if (isset($orgao) && $orgao != 0 ){
	...
	//$unidade = 0;
	$resultunidade = $clorcunidade->sql_record($clorcunidade->sql_query(null,null,null,"distinct o41_unidade,o41_descr",null,"o41_instit=$instit and o41_anousu=$anousu"));
}
if ($resultunidade) {
...
if (!isset($pesquisa_chave)) {
  ...
  if (isset($chave_coddepto) && (trim($chave_coddepto) != "") ) {
    ...
    $sql     = $cldb_depart->sql_query_div("", $campos, "descrdepto", $sWhere.$whereGeral);
  	...
  	$where = "db01_unidade = $unidade and ";
  	if (isset($unidades) && $unidades != "") {
  		$where = "db01_unidade in $unidades and ";
  	}
