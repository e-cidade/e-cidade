          ...
          <form name="form1" method="post" action="">
            ...
            <tr>
              <td width="33%" nowrap>
                ...
                ?>
                <select name="atividaderh" id="atividaderh" onchange="atividade(this.value)" onFocus="nextfield='pesquisar2'" style="font-size: 10px; width: 150px;">
              ...
              <td width="34%" nowrap>
                <?= $Led12_i_ensino ?>
                <select name="grupo" onFocus="nextfield='pesquisar2'" onChange="fillSelectFromArray(this.form.subgrupo, ((this.selectedIndex == -1) ? null : team[this.selectedIndex-1]));" style="font-size: 9px; width: 200px; height: 18px;">
                  <option></option>
                  <?php
              ...
              <td width="33%" nowrap>
                <?= $Led23_i_disciplina ?>
                <select name="subgrupo" onFocus="nextfield='pesquisar2'" style="font-size:9px;width:200px;height:18px;" disabled>
                  <option value=""></option>
                </select>
                <? if (isset($subgrupo)) { ?>
                  <script>
