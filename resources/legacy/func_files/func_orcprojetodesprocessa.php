  ...
  <tr> 
	...
	// echo $sql;
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clorcprojeto->sql_record($clorcprojeto->sql_query($pesquisa_chave,"","","o49_codsup is null and retif.o48_retificado is null and to_char(o46_data,'YYYY')::int4=".db_getsession("DB_anousu")));
