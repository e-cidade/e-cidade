...
if(!isset($pesquisa_chave)){
  ...
  o58_coddot,
  o58_instit,
  orcorgao.o40_orgao,orcorgao.o40_descr,
  orcunidade.o41_unidade,orcunidade.o41_descr,
  o55_projativ,o55_anousu,o55_descr,
  o15_codigo,o15_descr,
  o54_programa,o54_descr,
  o52_funcao,o52_descr,
  o53_subfuncao,o53_descr";
  $sWhere = "$where_instit and o58_anousu=".db_getsession('DB_anousu')." $dbwhere";
  $sql = $clorcdotacao->sql_query(db_getsession("DB_anousu"), null, $campos, null, $sWhere);
  ...
  if($pesquisa_chave!=null && $pesquisa_chave!=""){
      ...
      if($clorcdotacao->numrows!=0){
         ...
         echo "<script>".$funcao_js."('$o55_descr',false, '$o40_orgao', '$o40_descr', '$o41_unidade', '$o41_descr', '$o55_projativ', '$o55_descr', '$o15_codigo', '$o15_descr', '$o54_programa', '$o54_descr', '$o52_funcao', '$o52_descr', '$o53_subfuncao', '$o53_descr');</script>";
      }else{
