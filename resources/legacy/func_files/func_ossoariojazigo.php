  ...
  <tr>
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
          ...
          <tr>
            <td width="4%" align="right" nowrap title="<?=$Tcm25_i_codigo?>">
              <?=$Lcm25_i_codigo?>
            </td>
		  ...
		  <tr>
           <td width="4%" align="right" nowrap title="<?=$Tcm25_c_numero?>">
            <?=$Lcm25_c_numero?>
           </td>
           <td width="96%" align="left" nowrap>
		  ...
		  <tr>
           <td width="4%" align="right" nowrap title="<?=@$Tcm25_c_tipo?>">
            <?=@$Lcm25_c_tipo?>
           </td>
           <td>
            <?
              $x = array(''=>'Selecione','O'=>'Ossoário','J'=>'Jazigo');
    ...
    <td align="center" valign="top">
      ...
      if(!empty($where)){
		...
		if(isset($chave_cm25_i_codigo) && (trim($chave_cm25_i_codigo)!="") ){
              $sql = $clossoariojazigo->sql_query($chave_cm25_i_codigo,$campos,"cm25_i_codigo",@$where);
