      ...
      <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
          ...
          if (isset($chave_pc54_sequencial) && (trim($chave_pc54_sequencial) != "")) {
            $sql = $clsolicitaregistropreco->sql_query_solicitaanulada(
              null,
              $campos,
              "pc54_sequencial desc",
            ...
            $sql = $clsolicitaregistropreco->sql_query_solicitaanulada("", $campos, "pc54_sequencial desc", "{$sWhere}");
          }
          ...
          if ($pesquisa_chave != null && $pesquisa_chave != "") {
            $result = $clsolicitaregistropreco->sql_record($clsolicitaregistropreco->sql_query($numero));
