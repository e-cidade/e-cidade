            ...
            <td align="center" valign="top">
                ...
                if (!isset($pesquisa_chave)) {
                    ...
                    if (isset($chave_ed05_i_codigo) && (trim($chave_ed05_i_codigo) != "")) {
                        $sql = $clatolegal->sql_query("", $campos, "ed05_i_codigo", " ed05_i_codigo = $chave_ed05_i_codigo AND ed19_i_escola = $escola");
                    } else if (isset($chave_ed05_c_numero) && (trim($chave_ed05_c_numero) != "")) {
                        $sql = $clatolegal->sql_query("", $campos, "ed05_c_numero", " ed05_c_numero = '$chave_ed05_c_numero' AND ed19_i_escola = $escola");
                    } else {
                    ...
                    if ($pesquisa_chave != null && $pesquisa_chave != "") {
                        $result = $clatolegal->sql_record($clatolegal->sql_query("", "*", "", " ed05_i_codigo = '$pesquisa_chave' AND ed19_i_escola = $escola"));
