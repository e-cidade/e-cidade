...
$cl_acordo = new cl_acordo;


$sql = isset($chave_ac10_sequencial) && (trim($chave_ac10_sequencial) != "")
    ? $cl_acordo->queryAcordosAssinadosHomologados((int)$chave_ac10_sequencial)
    : $cl_acordo->queryAcordosAssinadosHomologados();
?>
<html>
<head>
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr>
            <td width="4%" align="right" nowrap title="acordo">
