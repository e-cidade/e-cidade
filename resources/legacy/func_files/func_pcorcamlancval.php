...
if ($pc20_dtatei == '--') {
  $pc20_dtatei = '1900-01-01';
}
if ($pc20_dtatef == '--') {
  $pc20_dtatef = '3000-12-31';
}
      ...
      <td height="63" align="center" valign="top">
        <table border="0" align="center" cellspacing="0">
          <form name="form2" method="post" action="">
            ...
            <tr>
              <td align="left" title="<?= $Tpc80_codproc ?>">
                <?= $Lpc80_codproc ?>
              </td>
              <td align="left">
                <?
    ...
    <tr>
      <td align="center" valign="top">
        ...
        if (isset($sol) && $sol == 'true') {
          ...
          if (isset($sel) && !isset($julg)) {
            $where_sol = " and pc29_orcamitem is not null ";
          }
          if (isset($numero)) {
            $where_sol .= " and c.pc10_correto='t'";
        ...
        if (isset($exc)) {
          ...
          $where_sol .= "              select 1                                                                                            ";
          $where_sol .= "                from empautitem                                                                                   ";
          $where_sol .= "                     inner join empautoriza           on empautoriza.e54_autori          = empautitem.e55_autori  ";
          $where_sol .= "                     inner join empautitempcprocitem  on empautitempcprocitem.e73_autori = empautitem.e55_autori  ";
          $where_sol .= "                                                     and empautitempcprocitem.e73_sequen = empautitem.e55_sequen  ";
          $where_sol .= "               where empautitempcprocitem.e73_pcprocitem = pcprocitem.pc81_codprocitem                            ";
          $where_sol .= "                 and empautoriza.e54_anulad is null                                                               ";
          $where_sol .= "            )                                                                                                     ";
        }
        ...
        if (isset($rel) && $rel == "true") {
          if (isset($sol) && $sol == 'true') {
            $where_sol .= " and a.pc11_numero=$numero ";
          } else if (isset($sol) && $sol == 'false') {
