...
<?
$db_where = "r08_instit = ".db_getsession("DB_instit")." and r08_anousu = ".db_anofolha()." and r08_mesusu = ".db_mesfolha()." and (r08_codigo >= 'S00%' and r08_codigo <= 'S017%' or r08_codigo = 'SP99')  ";
if(!isset($pesquisa_chave)){
    ...
    if(isset($chave_r08_codigo) && (trim($chave_r08_codigo)!="") ){
        $sql = $clbases->sql_query(db_anofolha(),db_mesfolha(),$chave_r08_codigo,db_getsession('DB_instit'),$campos,"r08_codigo",$db_where);
        ...
        $sql = $clbases->sql_query(db_anofolha(),db_mesfolha(),null,db_getsession('DB_instit'),$campos,"r08_anousu#r08_mesusu#r08_codigo","$db_where");
    }
    ...
    if($pesquisa_chave!=null && $pesquisa_chave!=""){
        $result = $clbases->sql_record($clbases->sql_query(db_anofolha(),db_mesfolha(),$pesquisa_chave,db_getsession('DB_instit'),'*','',$db_where));
