      ...
      if ( !isset( $pesquisa_chave ) ) {
        ...
        if ( isset( $campos ) == false ) {
           ...
           if ( isset( $lAcount ) ) {
             ...
             $campos = "db_itensmenu.id_item,
                        fc_montamenu(db_itensmenu.id_item) as dl_caminho, 
                        db_itensmenu.help,
                        db_itensmenu.desctec";
          }
        }
        ...
        if ( isset( $lAcount ) ) {
          $sql = $cldb_itensmenu->sql_queryArvoreMenus( $campos, null, $iFiltraModulo );
        }
        ...
        if ( $pesquisa_chave != null && $pesquisa_chave != "" ) {
          ...
          if ( isset( $lAcount ) ) {
            ...
            $campos = "db_itensmenu.id_item,
                       ...
                       db_itensmenu.help,
                       db_itensmenu.desctec";
            $result = $cldb_itensmenu->sql_record($cldb_itensmenu->sql_query($pesquisa_chave, "db_itensmenu.id_item, fc_montamenu(db_itensmenu.id_item) as descricao"));
          }
