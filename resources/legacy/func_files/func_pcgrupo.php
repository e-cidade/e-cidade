...
$clpcgrupo->rotulo->label("pc03_codgrupo");
$clpcgrupo->rotulo->label("pc03_descrgrupo");
?>
<html>
<head>
    ...
    <td height="63" align="center" valign="top">
        <table width="35%" border="0" align="center" cellspacing="0">
	     <form name="form2" method="post" action="" >
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tpc03_codgrupo?>">
              <?=$Lpc03_codgrupo?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("pc03_codgrupo",6,$Ipc03_codgrupo,true,"text",4,"","chave_pc03_codgrupo");
		       ?>
            </td>
          </tr>
          <tr> 
            <td width="4%" align="right" nowrap title="<?=$Tpc03_descrgrupo?>">
              <?=$Lpc03_descrgrupo?>
            </td>
            <td width="96%" align="left" nowrap> 
              <?
		       db_input("pc03_descrgrupo",40,$Ipc03_descrgrupo,true,"text",4,"","chave_pc03_descrgrupo");
		       ?>
            </td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_pcgrupo.hide();">
             </td>
          </tr>
        </form>
        </table>
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_pcgrupo.php")==true){
             include("funcoes/db_func_pcgrupo.php");
           }else{
           $campos = "pcgrupo.*";
           }
        }
        if(isset($chave_pc03_codgrupo) && (trim($chave_pc03_codgrupo)!="") ){
	         $sql = $clpcgrupo->sql_query($chave_pc03_codgrupo,$campos,"pc03_codgrupo","pc03_codgrupo=$chave_pc03_codgrupo and $where");
