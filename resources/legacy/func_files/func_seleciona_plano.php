...
<script>
function js_importarParametros(instituicao){
  var query = "";
  ...
  document.location.href = "func_importarparametros.php?"+query;
}
...
<table border="0" align="center">
 ...
 <tr>
   <td colspan="2" nowrap align="center">
      ...
      <input type="button" value="Importar Parametros" onClick="js_importarParametros(<?=db_getsession("DB_instit")?>);" <?=($flag_permissao=="false"?"disabled":"")?>>
  ...
  <table border="0" align="center">
    <tr>
      ...
      <?
         ...
         $cliframe_seleciona_plano->sql           = analiseQueryPlanoOrcamento($sql);
         $cliframe_seleciona_plano->sql_marca     = analiseQueryPlanoOrcamento($sql_marca);
