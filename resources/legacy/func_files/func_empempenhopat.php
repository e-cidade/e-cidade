	...
	if($clempempenho->numrows>0){
	  db_lovrot($sql,15,"()","",$funcao_js,"","NoMe",$repassa);
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clempempenho->sql_record($clempempenho->sql_query(null,"*",null,"e60_numemp = $pesquisa_chave and $dbwhere"));
          if($clempempenho->numrows!=0){
            db_fieldsmemory($result,0);
            echo "<script>".$funcao_js."('$z01_nome','$e60_codemp','$e60_anousu',false);</script>";
          }else{
