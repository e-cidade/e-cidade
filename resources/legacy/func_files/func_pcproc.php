      ...
      <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
          ...
          if (isset($chave_pc80_codproc) && (trim($chave_pc80_codproc) != "")) {
            ...
            $sql = $clpcproc->sql_query_proc_and(null, $campos, null, "pc80_codproc = " . $chave_pc80_codproc . " $where_lic and db_depart.instit = " . db_getsession("DB_instit") . $dbwhere . $sWhereContrato . $dbwherepncp);
          } else if (isset($chave_pc10_numero) && (trim($chave_pc10_numero) != "")) {

            $sql = $clpcproc->sql_query_proc_and("", $campos, null, " pc10_numero=$chave_pc10_numero $where_lic and db_depart.instit = " . db_getsession("DB_instit") . $dbwhere . $sWhereContrato . $dbwherepncp);
            ...
            $sql = $clpcproc->sql_query_proc_and("", $campos, null, " db_depart.instit = " . db_getsession("DB_instit") . $dbwhere . $where_lic . $dbwherepncp . " $where_data $sWhereContrato ");
          } else {

            $sql = $clpcproc->sql_query_proc_and("", $campos, null, " db_depart.instit = " . db_getsession("DB_instit") . $dbwhere . $where_lic . $dbwherepncp . " and pc80_data between '{$dataini}' and '{$datafim}' $sWhereContrato ");
          }
