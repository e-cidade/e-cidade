	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            ...
            <td width="96%" align="left" nowrap> 
              <? db_input("o39_codproj",8,$Io39_codproj,true,"text",4,"","chave_o39_codproj"); ?> </td>
          </tr>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
	    ...
	    $sql = $clorcprojeto->sql_query_projeto($chave_o39_codproj, 
	                                            $campos, "o39_codproj", 
	                                            "o39_codproj=$chave_o39_codproj 
	...
	// pesquisa oculta
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clorcprojeto->sql_record($clorcprojeto->sql_query_projeto($pesquisa_chave));
