...
function js_abre(botao){
  dataINI="";
  dataFIM="";
  if(document.form1.t55_dataINI_dia.value!="" && document.form1.t55_dataINI_mes.value!="" && document.form1.t55_dataINI_ano.value!=""){
    dataINI = document.form1.t55_dataINI_ano.value+'-'+document.form1.t55_dataINI_mes.value+'-'+document.form1.t55_dataINI_dia.value;
    inicio= new Date(document.form1.t55_dataINI_ano.value,document.form1.t55_dataINI_mes.value-1,document.form1.t55_dataINI_dia.value);
  }
  if(document.form1.t55_dataFIM_dia.value!="" && document.form1.t55_dataFIM_mes.value!="" && document.form1.t55_dataFIM_ano.value!=""){
    dataFIM = document.form1.t55_dataFIM_ano.value+'-'+document.form1.t55_dataFIM_mes.value+'-'+document.form1.t55_dataFIM_dia.value;
