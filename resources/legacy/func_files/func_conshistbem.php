...
function js_abre(botao){
  ...
  if(document.form1.t52_bem.value == ""){
    ...
    if(botao == "pesquisa"){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_func_conshistbem001','func_conshistbem001.php?t52_bem='+document.form1.t52_bem.value+query,'Pesquisa',true);
