      ...
      <td align="center" valign="top">
        ...
        if (!isset($pesquisa_chave)) {
          ...
          if ($pesquisa_chave != null && $pesquisa_chave != "") {
            $result = $clmatordem->sql_record($clmatordem->sql_query_anu($pesquisa_chave . " and " . $where_instit));
            if ($clmatordem->numrows != 0) {
              db_fieldsmemory($result, 0);
              if (isset($prot)) {
                echo "<script>" . $funcao_js . "('$m51_codordem','$z01_nome','$m51_data','$m51_valortotal',false);</script>";
              } else {
