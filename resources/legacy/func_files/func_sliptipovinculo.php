...
<div id="resultadoLovRot">
  ...
  if (!isset ($pesquisa_chave)) {
    ...
    if ($pesquisa_chave != null && $pesquisa_chave != "") {
      $result = $clslip->sql_record($clslip->sql_query_tipo_vinculo(null,"*",null,"k17_codigo = $pesquisa_chave $wh  and to_char(k17_data,'YYYY') = '".db_getsession("DB_anousu")."' $where_instit {$sTipoOperacao}"));
      if ($clslip->numrows != 0) {
