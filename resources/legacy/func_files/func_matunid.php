    ...
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
        ...
        if(isset($chave_m61_codmatunid) && (trim($chave_m61_codmatunid)!="") ){
	         $sql = $clmatunid->sql_query($chave_m61_codmatunid,$campos,"m61_codmatunid","m61_ativo='t'");
        }else if(isset($chave_m61_descr) && (trim($chave_m61_descr)!="") ){
	         $sql = $clmatunid->sql_query("",$campos,"m61_descr"," m61_descr like '$chave_m61_descr%' and m61_ativo='t'");
        }else{
           $sql = $clmatunid->sql_query("",$campos,"m61_codmatunid","m61_ativo='t'");
        }
        db_lovrot($sql,15,"()","",$funcao_js);
      }else{
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clmatunid->sql_record($clmatunid->sql_query(null,"*",null,"m61_ativo='t' and m61_codmatunid = $pesquisa_chave"));
