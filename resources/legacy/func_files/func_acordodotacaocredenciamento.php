  ...
  <table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
    ...
    <tr>
      <td align="center" valign="top">
        ...
        $aWhereAdicional[] = "ac16_acordosituacao = 1";
        $aWhereAdicional[] = "ac16_tipoorigem = 3";
        $aWhereAdicional[] = "(cflicita.l03_pctipocompratribunal = 102 or cflicita.l03_pctipocompratribunal = 103)";
        ...
        if (!isset($pesquisa_chave)) {
          ...
          $sql = $clacordo->sql_query_acordoscredenciamento("", $campos, "ac16_sequencial desc", implode(" and ", $aWhereAdicional));
          ...
          if ($pesquisa_chave != null && $pesquisa_chave != "") {
            ...
            $result = $clacordo->sql_record($clacordo->sql_query(
              null,
              "*",
              null,
