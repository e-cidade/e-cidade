	     ...
	     <form name="form2" method="post" action="" >
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_projecaoatuarial10.hide();">
             </td>
          </tr>
        </form>
        </table>
    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        ...
        if($pesquisa_chave!=null && $pesquisa_chave!=""){
          $result = $clprojecaoatuarial10->sql_record($clprojecaoatuarial10->sql_query($pesquisa_chave));
          if($clprojecaoatuarial10->numrows!=0){
