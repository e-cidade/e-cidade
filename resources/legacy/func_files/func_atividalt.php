    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           ...
           $campos = "ativid.*, classe.q12_descr, cnae.q71_estrutural, rhcbo.rh70_estrutural";
           }
        }
        if(isset($chave_q03_ativ) && (trim($chave_q03_ativ)!="") ){
	         $sql = $clativid->sql_query_dados($chave_q03_ativ,$campos,"q03_ativ");
        }else if(isset($chave_q03_descr) && (trim($chave_q03_descr)!="") ){
	         $sql = $clativid->sql_query_dados("",$campos,"q03_descr"," q03_descr like '$chave_q03_descr%' ");
        }else{
           $sql = $clativid->sql_query_dados("",$campos,"q03_ativ","");
        }
