  ...
  <tr>
   <td>
     ...
     <tr align=\"center\">
       <td width=\"100%\" colspan=\"7\" nowrap>
        <FONT SIZE='1' FACE='Verdana' COLOR='black'>
           <a href=\"func_calendario_position.php?".($this->shutdown_function!=""?"shutdown_function=".$this->shutdown_function."&":"")."nome_objeto_data=".$this->nome_objeto_data."&mes_solicitado=".($mes)."&ano_solicitado=".($ano-1)."\"> << </a>
     ...
     <tr align=\"center\">
       <td width=\"100%\" colspan=\"7\" nowrap>
        <FONT SIZE='1' FACE='Verdana' COLOR='black'>
         <a href=\"func_calendario_position.php?".($this->shutdown_function!=""?"shutdown_function=".$this->shutdown_function."&":"")."nome_objeto_data=".$this->nome_objeto_data."&ano_solicitado=".($ano)."&mes_solicitado=".($mes-1)."\"> << </a>
...
<script>
    function janela(d,m,a){
        let elemento = parent.db_iframe_dataenvio;
        let novoElem = elemento.janFrame.contentDocument.getElementById('data_envio').form;
		<?
		echo "let dia = novoElem.".$nome_objeto_data."_dia.value = (d<10?'0'+d:d);\n";
		echo "let mes = novoElem.".$nome_objeto_data."_mes.value = (m<10?'0'+m:m);\n";
		echo "let ano = novoElem.".$nome_objeto_data."_ano.value = a;\n";
		echo "novoElem.".$nome_objeto_data.".value = dia+'/'+mes+'/'+ano;\n";
