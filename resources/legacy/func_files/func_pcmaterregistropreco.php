    ...
    <table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
        ...
        <tr>
            <td align="center" valign="top">
                ...
                $where_ativo .= " and exists (select pc11_codigo";
                $where_ativo .= " from solicitemvinculo sv";
                $where_ativo .= " inner join solicitem si on";
                $where_ativo .= " sv.pc55_solicitempai = si.pc11_codigo";
                $where_ativo .= " inner join solicita s on s.pc10_numero = si.pc11_numero";
                $where_ativo .= " left join solicitaanulada sa on s.pc10_numero = sa.pc67_solicita";
                $where_ativo .= " where s.pc10_depto = " . db_getsession('DB_coddepto');
                $where_ativo .= " and sv.pc55_solicitemfilho = solicitem.pc11_codigo";
                $where_ativo .= " and sa.pc67_solicita is null)";
