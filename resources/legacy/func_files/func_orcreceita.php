    ...
    <td align="center" valign="top"> 
      ...
      if(!isset($pesquisa_chave)){
        if(isset($campos)==false){
           if(file_exists("funcoes/db_func_orcreceita.php")==true){
             include("funcoes/db_func_orcreceita.php");
           }else{
           $campos = "orcreceita.*";
           }
        }
        ...
        if(isset($chave_o70_codrec) && (trim($chave_o70_codrec)!="") ){
	         $sql = $clorcreceita->sql_query(null,null,$campos,"o70_codrec",$dbwhere." and o70_codrec = $chave_o70_codrec and {$sWhereReceita}");
        }else if(isset($chave_o70_codfon) && (trim($chave_o70_codfon)!="") ){
	         $sql = $clorcreceita->sql_query(null,null,$campos,"o70_codfon",$dbwhere." and o70_codfon like '$chave_o70_codfon%' and {$sWhereReceita}");
        }else if(isset($chave_o57_descr) && (trim($chave_o57_descr)!="") ){
	         $sql = $clorcreceita->sql_query(null,null,$campos,"o57_descr", $dbwhere." and upper(o57_descr) like '$chave_o57_descr%'  and {$sWhereReceita}");
        }else if(isset($chave_o57_fonte) && (trim($chave_o57_fonte)!="") ){
	         $sql = $clorcreceita->sql_query(null,null,$campos,"o57_descr",$dbwhere." and o57_fonte  like '$chave_o57_fonte%' and {$sWhereReceita}");
        }else{
           $sql = $clorcreceita->sql_query(null,null,$campos,"o70_anousu#o70_codrec",$dbwhere." and {$sWhereReceita}");
        }
        //  echo $funcao_js;	
        //  echo $campos;               
