...
try {
  ...
  switch ($oParametro->sExecuta) {
    ...
    case "alterarForncedorHabilitado":
        ...
        $oRetorno->habilitacaoCadastroFornecedor = false;

        $erroValidacaoRepresentante = $clHabilitacaoForn->validacaoRepresentanteLegal($oParametro->l206_forncedor);
        if($erroValidacaoRepresentante != ""){
          $oRetorno->habilitacaoCadastroFornecedor = true;
