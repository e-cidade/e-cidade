...
//itens orcamento
$result_itens = $clpcorcamitem->sql_record($clpcorcamitem->sql_query_pcmaterlic(null, "distinct pc22_codorc,pc01_codmater,pc11_seq,pc01_descrmater,pc01_complmater,m61_abrev,pc11_quant, pc81_codproc,l21_ordem,l04_descricao,pc22_orcamitem,pc11_reservado ", " pc81_codproc,l21_ordem,l04_descricao,pc22_orcamitem ", "pc20_codorc = $pc22_codorc AND pc21_orcamforne = $pc21_orcamforne"));
...
for ($i = 0; $i < $numrows_itens; $i++) {
    ...
    if ($pc11_reservado == "t") {
        $sheet->setCellValue($collC, iconv('UTF-8', 'ISO-8859-1//IGNORE', "[ME/EPP] " . str_replace($what, $by, $pc01_descrmater)));
    } else {
