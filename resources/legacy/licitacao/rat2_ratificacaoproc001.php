...
<head>
    ...
    <script>
        function js_emite(){
            jan = window.open('rat2_ratificaproc002.php?l20_codigo='+document.form1.l20_codigo.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
            jan.moveTo(0,0);
