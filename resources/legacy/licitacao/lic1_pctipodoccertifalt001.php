...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <center>
	<?
	include("forms/db_frmpctipodoccertifalt.php");
	?>
    </center>
	</td>
  </tr>
...
if($clpctipodoccertif->erro_status=="0"){
  ...
  if($clpctipodoccertif->erro_campo!=""){
    echo "<script> document.form1.".$clpctipodoccertif->erro_campo.".style.backgroundColor='#99A9AE';</script>";
    echo "<script> document.form1.".$clpctipodoccertif->erro_campo.".focus();</script>";
  }
}else{
  $clpctipodoccertif->erro(true,false);
}
