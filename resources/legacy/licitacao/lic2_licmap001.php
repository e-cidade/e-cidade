    ...
    <table align="center">
        <form name="form1" method="post" action="">
            ...
            <tr>
                ...
                <td>
                    <?
                    $tipo_ordem = array("1" => "Modelo 1", "2" => "Modelo 2", "3" => "Modelo 3");
            ...
            <tr>
                <td align="right" nowrap title="Imprimir justificativa de desclassificacao">
                    <b>Imprimir justificativa de desclassificacao:&nbsp;&nbsp;</b>
                </td>
                <td>
                    <?
            ...
            <tr>
                <td align="right" nowrap title="Imprimir justificativa de troca de fornecedor">
                    <b>Imprimir justificativa de troca de fornecedor:&nbsp;&nbsp;</b>
                </td>
                <td>
                    <?
            ...
            <tr>
                <td align="right" nowrap title="Imprimir justificativa de lote/itens anulados">
                    <b>Imprimir justificativa de lote/itens anulados:&nbsp;&nbsp;</b>
                </td>
                <td>
                    <?
