...
if (isset($licitacao) && trim($licitacao) != "") {
    $res_liclicitem     = $clliclicitemlote->sql_record($clliclicitemlote->sql_query_licitacao(
        null,
        "pc81_codprocitem,pc01_codmater,pc01_descrmater,pc11_quant,
        case
        when pc80_criterioadjudicacao = 3 then si02_vlprecoreferencia
        else si02_vlpercreferencia end as vlrun,
   si02_vlprecoreferencia,
   case
        when l21_reservado = 't' then 'SIM'
        else 'NÃO' end as reservado,
    l21_codigo,l04_descricao,l21_situacao",
        "pc81_codprocitem,l04_codigo asc",
...
<head>
    ...
    <style>
        ...
        <? $corfundo = "E4F471" ?>.bordas_corp_anul {
            border: 1px solid #cccccc;
            border-right-color: <?= $cor ?>;
            border-bottom-color: <?= $cor ?>;
    ...
    <form name="form1">
        <table border="0" cellspacing="0" cellpadding="0" width="80%" align="center">
            ...
            <tr class="bordas">
                ...
                <td nowrap class='bordas' align='center'><b>Vlr. Médio.</b> </td>
                <td nowrap class='bordas' align='center'><?= $cabec_lote ?></td>
                <td nowrap class='bordas' align='center'><b>ME/EPP</b></td>
            </tr>
            <?
            ...
            ?>
                    <tr class="<?= $class ?>" width="15%">
                        ...
                        <td align="right" class="<?= $class ?>" width="15%"><? echo db_formatar($vlrun, "f"); ?></td>
                        ...
                        <td align="center" class="<?= $class ?>" width="15%"><? echo $reservado; ?></td>
                    <?
                }
                    ?>
