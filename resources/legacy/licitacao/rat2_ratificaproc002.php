...
$oLibDocumento = new libdocumento(9001,null);
...
$head3 = "RATIFICAÇÃO DE PROCESSO";
$head4 = "LICITAÇÃO : $l20_edital/$l20_anousu".substr($l20_datacria,0,4);
$head5 = "SEQUENCIAL: $l20_codigo";
$oPDF->addpage();
$oPDF->setfont('arial','b',14);
$oPDF->ln();
$oPDF->cell(0,8,"TERMO DE RATIFICAÇÃO",0,1,"C",0);
...
$oLibDocumento->ano = date ('Y',db_getsession("DB_datausu"));
