...
<table valign="top" marginwidth="0" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
            ...
            $clcriaabas->identifica = array("empautoriza"=>"Autorização",
                "empautitem"=>"Itens",
                "empautidot"=>"Dotação");

            $clcriaabas->sizecampo =  array("anulacao"=>"20");

            $clcriaabas->title      =  array("empautoriza"=>"Autorização",
                "empautitem"=>"Itens",
                "empautidot"=>"Dotação");

            $clcriaabas->src = array("empautoriza"=>"lic1_gerarempautorizacredenciamento004.php$query");

            $clcriaabas->disabled   =  array("empautitem"=>"true",
                "empautidot"=>"true");
