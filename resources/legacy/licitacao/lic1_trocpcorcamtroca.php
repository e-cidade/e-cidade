                    ...
                    if ($numrows_pcorcamitem == 0) {
                        ...
                        if ($tipojulg == 3) {
                            ...
                            if($pc80_criterioadjudicacao == 2 || $pc80_criterioadjudicacao == 1) {
                                ...
                                echo "  <td colspan='12' nowrap class='bordas02' align='left'><strong>Lote</strong></td>\n";
                            }else{
                        ...
                        if($pc80_criterioadjudicacao == 2 || $pc80_criterioadjudicacao ==1) {
                            echo "<td nowrap class='bordas02' align='center'><strong>Taxa/Tabela %</strong></td>\n";
                        }
          ...
          ";
                            ...
                            if ($flag == false){
                                ...
                                if($pc80_criterioadjudicacao == 2){
                                    ...
                                    echo "  <td nowrap class='$bordas' align='right' >$pc23_percentualdesconto</td>\n";
                                }else if($pc80_criterioadjudicacao == 1){
                                    if(!$pc23_perctaxadesctabela == null || $pc23_perctaxadesctabela = ""){
                                        $pc23_perctaxadesctabela = $pc23_perctaxadesctabela."%";
                                    }
                                    echo "  <td nowrap class='$bordas' align='right' >$pc23_perctaxadesctabela</td>\n";
                                }
