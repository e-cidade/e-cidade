...
if(isset($incluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $cllicpregao->incluir($l45_sequencial);
  if($cllicpregao->erro_status==0){
    $sqlerro=true;
  } 
  $erro_msg = $cllicpregao->erro_msg; 
  db_fim_transacao($sqlerro);
   $l45_sequencial= $cllicpregao->l45_sequencial;
   $db_opcao = 1;
   $db_botao = true;
}
?>
...
if(isset($incluir)){
  if($sqlerro==true){
   ...
   db_msgbox($erro_msg);
   db_redireciona("lic1_licpregao005.php?liberaaba=true&chavepesquisa=$l45_sequencial");
  }
}
?>
