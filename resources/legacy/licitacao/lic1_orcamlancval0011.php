...
<head>
    ...
    <style>
        ...
        <? $corfundo = "E4F471" ?>.bordas_corp_descla {
            border: 1px solid #cccccc;
            border-right-color: <?= $cor ?>;
            border-bottom-color: <?= $cor ?>;
        ...
        <? $corfundomeepp = "c0bfff" ?>.bordas_corp_meepp {
            border: 1px solid #cccccc;
            border-right-color: <?= $cor ?>;
            border-bottom-color: <?= $cor ?>;
    ...
    <form name="form1" method="post">
                ...
                <td align="center" valign="top" bgcolor="#CCCCCC">
                    <table border='1' cellspacing="0" cellpadding="0">
                        ...
                        if (isset($pc20_codorc) && trim($pc20_codorc) != '') {
                            ...
                            /*Acrescentado o campo pc80_criterioadjudicacao OC3770*/
       ...
       ";
        ...
        <tr class='bordas'>
          ...
          ";
                                        if ($mostra_lote == true) {
                                            echo "<td nowrap class='bordas' width='10%' align='center'>Seq. Lote</td>";
                                        } else {
                                            echo "<td nowrap class='bordas' width='10%' align='center'>Seq. Item</td>";
                                        }
                                        echo "<td nowrap class='bordas' width='55%' align='center'><b>Descrição</b></td>";

                                        if ($mostra_lote == true) {
                                            echo "<td nowrap class='bordas' align='center'><b>Lote</b></td>";
                                        }

                                        echo "<td nowrap class='bordas' align='center'><b>Obs / Marca</b></td> ";
                                        ...
                                        /*OC3770*/
                                        echo "<td nowrap class='bordas' align='center'><b>Taxa/Tabela %</b></td>";
                                        /*FIM - OC3770*/
                                    ...
                                    if ($ok == true) {
                                        if ($pc80_criterioadjudicacao == 1) {
                                            $result_lancados = $clpcorcamval->sql_record($clpcorcamval->sql_query_file(@$pc21_orcamforne, @$pc22_orcamitem, "pc23_valor as valor_$pc22_orcamitem,pc23_perctaxadesctabela as percdesctaxa_$pc22_orcamitem,pc23_vlrun as vlrun_$pc22_orcamitem,pc23_obs as obs_$pc22_orcamitem, pc23_quant as qtde_$pc22_orcamitem,pc23_validmin  as pc23_validmin_$pc22_orcamitem", "pc23_orcamitem"));
                                        } else if ($pc80_criterioadjudicacao == 2) {
                                            $result_lancados = $clpcorcamval->sql_record($clpcorcamval->sql_query_file(@$pc21_orcamforne, @$pc22_orcamitem, "pc23_valor as valor_$pc22_orcamitem,pc23_percentualdesconto as percdesctaxa_$pc22_orcamitem,pc23_vlrun as vlrun_$pc22_orcamitem,pc23_obs as obs_$pc22_orcamitem, pc23_quant as qtde_$pc22_orcamitem,pc23_validmin  as pc23_validmin_$pc22_orcamitem", "pc23_orcamitem"));
                                        } else {
        ...
        <tr class='$class " . ($pc11_reservado == 't' ? 'bordas_corp_meepp' : '') . "' width='15%'>
          ...
          <td align='left'    class='$class' width='10%'>
            $pc81_codprocitem
                                    ...
                                    if ($mostra_lote == true) {
                                        echo "<td align='center' class='$class' width='10%'>
                                         $l04_seq
                                        </td>";
                                    } else {
                                        echo "<td align='center' class='$class' width='10%'>
                                    ...
                                    echo "<td align='left' class='$class' style='padding-left: 10px;' width='55%' onMouseOver=\"js_mostra_text(true,'div_text_$pc22_orcamitem',event,this);\" onMouseOut=\"js_mostra_text(false,'div_text_$pc22_orcamitem',event,this);\">
            $pc01_descrmater
          </td>";
