...
if (isset($l20_codigo) && trim($l20_codigo) != "") {
    ...
    try {
        ...
        if ($oDaoAcordoliclicitem->numrows > 0) {
            ...
            $sqlerro       = true;
            $erro_msg      = "a Licitao est vinculada ao acordo {$iNumeroAcordo}, ";
            $erro_msg     .= "No ser possivel cancelar o julgamento da Solicitao";
        }
    ...
    if (!$importado['status']) {
        ...
        if ($oDaoAcordoliclicitem->numrows > 0) {
            ...
            $iNumeroAcordo = db_utils::fieldsMemory($rsDadosAcordo, 0)->ac26_acordo;
            $sqlerro       = true;
            $erro_msg      = "a LicitaÁ„o est· vinculada ao acordo {$iNumeroAcordo}, ";
            $erro_msg     .= "N„o ser· possivel cancelar o julgamento da SolicitaÁ„o";
        }
        $sql = "select pcorcamjulg.pc24_orcamitem,
                       pcorcamjulg.pc24_orcamforne
                  from pcorcamjulg
        ...
        if ($lRegistroPreco) {
            ...
            if (count($aRegistroPreco) > 0) {
                ...
                $sqlerro  = true;
                $erro_msg  = "N„o È possÌ≠vel cancelar o julgamento. LicitaÁ„o {$l20_codigo} ";
                $erro_msg .= "possui vinculo com as seguintes solicitaÁıes: {$sSolicitacaoGeradas}.";
            }
            ...
            if (!$sqlerro) {
                ...
                if (count($aReequilibrios) > 0) {
                    ...
                    $erro_msg = "N„o È possÌ≠vel cancelar o julgamento, LicitaÁ„o {$l20_codigo}, possui reequilÌrios.";
                    $sqlerro  = true;
                }
            }
        }
        ...
        if ($sqlerro == false) {
            ...
            if ($clpcorcamjulg->numrows > 0) {
                ...
                for ($i = 0; $i < $numrows; $i++) {
                    ...
                    $sSqlLogJulgamento   = $oDaoLogJulgamentoItem->sql_query_file(
                        null,
                    ...
                    /**
                     * Verifica se a licitaÁ„o usa Registro de Preco. Caso use, È excluido tambÈm os registros
        ...
        if ($sqlerro == false) {
            ...
            $clliclicitasituacao->l11_obs         = "Julgamento da licita√ß√£o cancelado.";
        ...
        $result = (new CancelaJulgamento)->execute($importado['id'], (int)$l20_codigo, $lRegistroPreco);
    ...
    <script>
        function js_confirmar() {
            if (document.form1.l20_codigo.value == "") {
                ...
                alert("Informe o c√≥digo da Licita√ß√£o");
            } else {
            ...
            <table border='0'>
                ...
                <tr>
                    <td align="left" nowrap title="<?= $Tl20_codigo ?>">
                        <b>
                            <? db_ancora('LicitaÁ„o', "js_pesquisa_liclicita(true);", 1); ?>&nbsp;:
                        </b>
                    </td>
