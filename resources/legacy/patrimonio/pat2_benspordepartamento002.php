 ...
 * Esta parte do WHERE deve ser concatenado pois utiliza um OR ao invés de AND
 */
if (!empty($dtBaixaInicial) && !empty($dtBaixaFinal)) {
  $sWhereParametros .= " and ( t55_codbem is not null or t55_baixa between cast('{$dtBaixaInicial}' as date) and cast('{$dtBaixaFinal}' as date) )";
}
