...
<table width="790" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
            ...
            if ($lFormNovo) {
                $clcriaabas->src = array("bens"=>"pat1_bensglobalnovo001.php".$iCodigoEmpNotaItem);
            } else {
                $clcriaabas->src = array("bens"=>"pat1_bensglobal001.php");
            }
            $clcriaabas->disabled = array('bensfotos'=> 'true');
...
<script type="text/javascript">
    ...
    let bens = document.getElementById('div_bens');
    bens.style.zIndex = 0;
