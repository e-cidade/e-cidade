...
require_once("classes/db_benstransfdiv_classe.php");
  	...
  	if ( $clbenstransfdes->numrows > 0 ) {
	    ...
	    if ( trim($oTransfDes->t94_divisao) != "" && $oTransfDes->t94_divisao != 0 )  {
          ...
          if (!$lSqlErro) {
            ...
            $oDaoBensTransfOrigemDestino->t34_divisaoorigem       = $oTransfDes->t93_divisao;
            $oDaoBensTransfOrigemDestino->t34_divisaodestino      = $oTransfDes->t94_divisao;
...
<table align="center" style="padding-top:15px;" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
			<?
		  	include("forms/db_frmbenstransfcodigolote.php");
			?>
    </center>
	</td>
  </tr>
