...
function js_envia() {
	...
	if (iCodClaInicial == "") {
		...
		alert("Informe a classificação inicial.");
		return false;
	}
	if (iCodClaFinal == "") {

		alert("Informe a classificação final.");
		return false;
	}
	if (iCodClaInicial > iCodClaFinal) {

		alert("A classificação inicial deve ser menor que a final.");
		return false;
	}
...
function js_processaTipoDepreciacao() {
  ...
  if (oTxtCodTipoDepreciacao.getValue() == "") {
    ...
    alert("Informe o tipo de depreciação.");
    return false;
  }
  if (oTxtVidaUtil.getValue() == "") {

		alert("Informe a vida útil.");
		return false;
  }
  if (oTxtCodTipoAquisicao.getValue() == "") {

    alert("Informe o tipo de aquisição.");
    return false;
  }
