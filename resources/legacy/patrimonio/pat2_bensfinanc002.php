...
$sJoin .= "  left join db_departorg    on db01_coddepto          = coddepto    and db_departorg.db01_anousu = ".db_getsession("DB_anousu");
...
if (isset($listabens) && $listabens != "") {
  ...
  if ($listabens == 'b') {
    ...
    $sWhere .= ($lPeriodoBaixa) ? $sWhereSemBaixa : " and t55_codbem is null "; 
