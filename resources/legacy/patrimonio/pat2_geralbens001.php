        ...
        <table class="form-container">
            ...
            if ($t06_pesqorgao == 't') {
                ...
                <tr>
                    <td colspan=2>
                        <fieldset style="border: none;border-top:2px groove white;">
                            <a id='esconderorgao' style="-moz-user-select: none;cursor: pointer"
                               onClick="js_escondeOrgao('');">
                ...
                <tr>
                    <td colspan=2>
                        <fieldset style="border: none;border-top:2px groove white;">
                            <a id='esconderunidades' style="-moz-user-select: none;cursor: pointer"
                               onClick="js_escondeUnidade('');">
                ...
                <tr>
                    <td colspan=2>
                        <fieldset style="border: none;border-top:2px groove white;">
                            <a id='esconderdepartamentos' style="-moz-user-select: none;cursor: pointer"
                               onClick="js_escondeDepartamento('');">
            ...
            <? } else { ?>
                <tr>
                    <td align="right" nowrap
                        title="<?= $Tcoddepto ?>"> <? db_ancora(@$Lcoddepto, "js_pesquisa_depart(true);", 1); ?>  </td>
            ...
            <tr>
              <td align="right"  nowrap title="<?=@$Tpc21_numcgm?>">
                 <? db_ancora("Fornecedor/CGM","js_pesquisapc21_numcgm(true);",$db_opcao); ?>
              </td>
              <td>
                <? db_input('pc21_numcgm',10,$Ipc21_numcgm,true,'text',$db_opcao," onchange='js_pesquisapc21_numcgm(false);'") ?>
                <? db_input('z01_nomefornecedor',50,$Iz01_nome,true,'text',3); ?>
              </td>
            </tr>
            <tr id="datas">
            ...
            <tr>
                <td nowrap align="right"><b>Descrição:</b></td>
                <td>
...
// Ocorrência 2505
  ...
  function js_emite(csv=false) {
    ...
    query += "&t53_empen=" + $('t53_empen').value;
    ...
    /* paramêtro filtro CGM */
    if(document.getElementById('pc21_numcgm').value){
      query += '&cgmFornecedor='+document.getElementById('pc21_numcgm').value;
...
function js_BuscaDadosArquivodepartamentos(chave) {
    ...
    function js_pesquisapc21_numcgm(mostra){
      if(mostra==true){
        ...
        if(document.form1.pc21_numcgm.value != ''){
          ...
          document.form1.z01_nomefornecedor.value = '';
        }
      }
    }

    function js_mostracgm(erro,chave){
      document.form1.z01_nomefornecedor.value = chave;
      if(erro==true){
    ...
    function js_mostracgm1(chave1,chave2){
      ...
      document.form1.z01_nomefornecedor.value = chave2;
      func_nome.hide();
    }
