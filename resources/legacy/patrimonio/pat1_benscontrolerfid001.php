...
<script type="text/javascript">
  ...
  function js_buscarDocumentos() {
    ...
    js_divCarregando('mensagem_buscando_bens_pendentes', 'msgbox');

    var oParametros = new Object();

    oParametros.exec = 'carregaBenspendentes';
    oParametros.controle = 2;
...
js_divCarregando('mensagem_enviando_bens_pendentes', 'msgbox');        


oParametros.exec = 'enviarBenspendentes';
...
var oAjax = new Ajax.Request(
  sUrlRpc, {
    ...
    onComplete: function(oAjax) {
      ...
      return alert(_M('patrimonial.patrimonio.db_frm_bensnovo.pedentes_falha')); 
    }
  }
);
