...
function js_preencheGrid(aBens) {
  ...
  /* INPUT VALOR Depreciavel */
    ...
    /* BOX SITUACAO */
    var oComboBoxSituacao = window["oComboBoxSituacao"+oItem.codigo_bem] = new DBComboBox("oComboBoxSituacao" + oItem.codigo_bem, "oComboBoxSituacao" + oItem.codigo_bem, null, null);
    ...
    /* BOX DEPARTAMENTO */
    var oComboBoxDepartamento = window["oComboBoxDepartamento" + oItem.codigo_bem] = new DBComboBox("oComboBoxDepartamento" + oItem.codigo_bem, "oComboBoxDepartamento" + oItem.codigo_bem, null, null);
    ...
    /* BOX DIVISAO */
    var oComboBoxDivisao = window["oComboBoxDivisao" + oItem.codigo_bem] = new DBComboBox("oComboBoxDivisao" + oItem.codigo_bem, "oComboBoxDivisao" + oItem.codigo_bem, null, null);
  ...
  aBensHint.each(function(oBem, iIndice) {
    ...
    var oDBHint     = window["oDBHint_"+oBem.codigo_bem] = new DBHint("oDBHint_"+oBem.codigo_bem);
