...
<form class="container" name="form1" method="post" action="">
  <fieldset>
    <legend>Desprocessamento de Inventário</legend>
...
/**
 * Método para buscar os itens de um Inventário
 */
...
/**
 * Método para exibir os itens de um Inventário na Grid
 */
