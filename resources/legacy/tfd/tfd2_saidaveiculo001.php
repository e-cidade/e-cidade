...
function impCabecalho($oPdf) {
  ...
  $oPdf->cell( 68, 4, "Local Destino",     1, 0, "L", 1 );
...
function impPaciente($oPdf, $oPaciente) {
  ...
  $oPdf->cell( 68, 4, limitaString( $oPaciente->nomeempresa, 36 ),          1, 0, "L", 1 );
  ...
  foreach ($oPedido->getAcompanhantes() as $oAcompanhante) {
    ...
    $oPdf->cell( 68, 4, '', 1, 0, "L", 1 );
    $oPdf->cell( 10, 4, '', 1, 0, "L", 1 );
    $oPdf->cell( 30, 4, implode( " / ", $aContatos ), 1, 0, "L", 1 );
    $oPdf->cell( 15, 4, '', 1, 1, "L", 1 );
  }
}
