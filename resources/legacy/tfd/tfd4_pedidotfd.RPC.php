...
if ($oParam->exec == 'getCgsCns') {
  ...
  if ( !empty($oParam->z01_i_numero) )  {
    $oDaoCgsUnd->z01_i_numero = $oParam->z01_i_numero;
  }

  $oDaoCgsUnd->z01_v_compl    = !empty($oParam->z01_v_compl) ? $oParam->z01_v_compl : " ";
  $oDaoCgsUnd->z01_v_compl    = db_stdClass::normalizeStringJsonEscapeString($oDaoCgsUnd->z01_v_compl);
  ...
  $oDaoCgsUnd->z01_v_email    = db_stdClass::normalizeStringJsonEscapeString($oParam->z01_v_email);
