...
<html>
  <head>
    ...
    ?>
    <script type="text/javascript" language="JavaScript" src="scripts/strings.js"></script>
    ...
    <script type="text/javascript" language="JavaScript" src="scripts/datagrid.widget.js"></script>
    <script type="text/javascript" language="JavaScript" src="scripts/widgets/DBInputHora.widget.js"></script>
  </head>
  <body class="body-default">

    <?php
     //Esse require é alterado pelo plugin SMSTFD
     require_once("forms/db_frm_agendasaida.php");
    ?>
