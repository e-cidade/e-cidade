      ...
      <table>
		...
		<tr>
		  <td colspan='2' align='center'>
		    <input name="emite" type="button" id="emite" value="Emitir estorno" onclick="js_emite();" >
		  </td>
		</tr>
      </table>
      </form>
...
function js_emite(){
  ...
  if(document.form1.e50_codord.value != ""){
  	query = "ordem="+document.form1.e50_codord.value;
  	jan = window.open('emp2_emiteestornoemp002.php?'+query,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  }else
  */
  if(document.form1.e60_numemp.value != ""){
  	query = "numemp="+document.form1.e60_numemp.value;
  	jan = window.open('emp2_emiteestornoemp002.php?'+query,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  }else  if(document.form1.e60_codemp.value != ""){
  	query = "codemp="+document.form1.e60_codemp.value;
  	jan = window.open('emp2_emiteestornoemp002.php?'+query,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  }else{
	alert("Seleciona um numero de empenho!");
 	return false;
  }
}
