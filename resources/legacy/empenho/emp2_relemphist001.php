                    ...
                    <table border="0" >
                        ...
                        <tr>
                            ...
                            <td nowrap><table border="0">
                                    <?
                                    $cl_empprestatip                 = new cl_arquivo_auxiliar;
                                    $cl_empprestatip->nome_botao     = "db_lanca_tipoanu";
                                    $cl_empprestatip->cabecalho      = "<strong>Tipo Anulação</strong>";
                                    $cl_empprestatip->codigo         = "e38_sequencial";  //chave de retorno da func
                                    $cl_empprestatip->descr          = "e38_descr"; //chave de retorno
                                    $cl_empprestatip->nomeobjeto     = 'tipoanulacao';
                                    $cl_empprestatip->funcao_js      = 'js_mostra4';
                                    $cl_empprestatip->funcao_js_hide = 'js_mostra5';
                                    $cl_empprestatip->sql_exec       = "";
                                    $cl_empprestatip->func_arquivo   = "func_empanuladotipo.php";  //func a executar
                                    $cl_empprestatip->nomeiframe     = "db_iframe_empanuladotipo";
                                    $cl_empprestatip->localjan       = "";
                                    $cl_empprestatip->onclick        = "";
                                    $cl_empprestatip->db_opcao       = 2;
                                    $cl_empprestatip->tipo           = 2;
