...
if (isset($k00_codseqpag) && $k00_codseqpag != '') {
  $sSqlOrdemPag = "select k00_codord from ordembancariapagamento where k00_codordembancaria = ".$k00_codseqpag;
  $rsResultOrdemPag = db_query($sSqlOrdemPag);
  $aOrdemPag = array();
  for ($iCont = 0; $iCont < pg_num_rows($rsResultOrdemPag); $iCont++) {
    $aOrdemPag[] = db_utils::fieldsMemory($rsResultOrdemPag, $iCont)->k00_codord;
   }
   $dbwhere .= " and e82_codord in (".implode(",", $aOrdemPag).") ";
}
