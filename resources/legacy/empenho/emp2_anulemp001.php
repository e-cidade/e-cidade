    ...
    <script>
        function js_abre() {
            ...
            if (query == '') {
                ...
                jan = window.open('emp2_anulemp002.php?' + query+'&assinar=false', '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0 ');
                jan.moveTo(0, 0);
            }
        }
    </script>
                ...
                <table>
                    <tr>
                        ...
                        <td nowrap>
                            ...
                            <input name="e60_codemp" title='<?= $Te60_codemp ?>' size="8" type='text'
...
<script>
    ...
    function js_solicitarAssinatura() {
        ...
        obj = document.form1;
        if (obj.e94_codanu.value == '') {
            alert("Selecione uma anulação!");
            return;
        }
        var oParametros = new Object();
        oParametros.iAnulacao = obj.e94_codanu.value;
        oParametros.sExecuta = 'enviarAnulacaoEmpenhoAssinatura';
    ...
    function js_solicitarImpressaoComAssinatura() {
        ...
        var oParametros = new Object();
        oParametros.e94_codanu_ini = obj.e94_codanu.value;
        oParametros.method = 'post';
        oParametros.sExecuta = 'immprimirDocumentoAssinadoAnulacao';
