	...
	?>
        ...
        <tr <?php echo $sCssBloqueada ;?>>
          ...
          <td class='linhagrid' align='right'><!-- COLUNA   1 CHECKBOX  -->
            ...
            <input class = 'codmovimento'value = "<?=$e81_codmov?>" <?=$sDisabled?>  <?=$sChecked?> name="<?=$e81_codmov?>" type='checkbox' >
          </td>
          ...
          <!-- COLUNA  3 ORDEM / SLIP   -->
          <td class='linhagrid' style='text-align:right' id='codord<?=$e81_codmov?>' title='<?=($RLe50_codord)?> - Data de emissão:<?=db_formatar($e50_data,"d")?>'>
            <?=$e50_codord?>
          </td>
          ...
          <? //$z01_nome = " ";?>
          <!-- COLUNA  6 NOME   -->
          <td class='linhagrid' style='text-align:left' title='<?=($RLz01_nome)?> -  Numcgm:<?=$z01_numcgm?>'>
            <?PHP
               if ($z01_nome == "" && !$lPossuiCodigoBarra) {
