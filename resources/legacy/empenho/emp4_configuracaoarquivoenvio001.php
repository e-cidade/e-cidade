...
function js_viewConfiguracao (iCodMov) {
    ...
    if (typeof(windowDetalhes) != 'undefined' && windowDetalhes instanceof windowAux) {
      ...
      sConteudoDetalhes += "      <tr nowrap>     ";
      sConteudoDetalhes += "        <td>   ";
      sConteudoDetalhes += "         <strong>Tipo de Transmissão: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
      ...
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
      sConteudoDetalhes += "           <select id='iTipoFatura' name='iTipoFatura' style='width:100px;' >";
      ...
      sConteudoDetalhes += "      <tr nowrap>     ";
      sConteudoDetalhes += "        <td >   ";
      sConteudoDetalhes += "         <strong> Valor: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
      ...
      sConteudoDetalhes += "      <tr nowrap>     ";
      sConteudoDetalhes += "        <td >   ";
      sConteudoDetalhes += "         <strong> Data: </strong>  ";
      sConteudoDetalhes += "        </td>  ";
      sConteudoDetalhes += "        <td align='left'>   ";
