...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
     ...
     <?
       if ($anousu <= 2007){
         $clcriaabas->identifica = array("g1"=>"Principal","g2"=>"Credor/Gestor","g3"=>"Histórico/Evento/Tipo","g4"=>"Contrato/Tipo de Compra","g5"=>"Material/Serviço","filtro"=>"Filtro");
         ...
         $clcriaabas->identifica = array("g1"=>"Principal","g2"=>"Credor/Gestor","g3"=>"Histórico/Evento/Tipo","g4"=>"Contrato/Tipo de Compra","g5"=>"Material/Serviço","g6"=>"Convênios","filtro"=>"Filtro");
         $clcriaabas->title      = array("g1"=>"Principal","g2"=>"Selecionar credores","g3"=>"Selecionar evento ou histórico","g4"=>"Selecionar tipo de compra","g5"=>"Selecionar serviço ou material","g6"=>"Selecione convênio","filtro"=>"Filtro");
         $clcriaabas->src        = array("g1"=>"emp2_relempenho011.php","g2"=>"emp2_relempcredor001.php","g3"=>"emp2_relemphist001.php","g4"=>"emp2_relempcom001.php","g5"=>"emp2_relempitem001.php","g6"=>"emp2_relempconvenio001.php","filtro"=>"func_selorcdotacao_aba.php?desdobramento=true");
