        ...
        <form name="form1" method="post" action="resources/legacy/cadastro/cad2_iptuconstr002.php" target="rel">
	       ...
	       <tr>
                 <td align="left" colspan="3">
                   <table>
                     <tr>
	               <td valign='center' nowrap align="left" colspan="1" title="<?=@$Tid_usuario?>">
	               <strong>Usuários de</strong>
		       </td>
		       <td valign='center'>
		     <?
                 db_input('id_usuario',8,$Iid_usuario,true,'text',1,"onChange=\"js_testa('i',this.value)\"","id_usuarioINI","");
	             ?>
		       <strong>&nbsp;À&nbsp;</strong>
		     <?
		 db_input('id_usuario',8,$Iid_usuario,true,'text',1,"onChange=\"js_testa('f',this.value)\"","id_usuarioFIM","");
		     ?>
		       </td>
                     </tr>
                   </table>
		 ...
		 <td align="left">&nbsp;&nbsp;&nbsp;
		   ...
		   db_select('param_db_usuarios',$xxx,true,2);
		   ?>
		 </td>
	       </tr>
	     </table>
...
function js_testa(campo,valor){
  ...
  erro = false;
  if(campo=="i"){
    if(document.form1.id_usuarioFIM.value!="" && parseInt(valor)>=parseInt(document.form1.id_usuarioFIM.value)){
      erro = true;
    }
  }else if(campo=="f"){
    if(document.form1.id_usuarioINI.value!="" && parseInt(valor)<=parseInt(document.form1.id_usuarioINI.value)){
      erro = true;
    }
  }
  if(erro == true){
