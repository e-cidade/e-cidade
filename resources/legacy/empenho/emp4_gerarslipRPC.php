...
switch ($oParam->exec) {
  ...
  case "getArrecExtra" :
    ...
    $sSqlArrecadacoesExtra .= "       left  join slipcorrente             on k112_data           = corrente.k12_data ";
    ...
    $sSqlArrecadacoesExtra .= "   and (k112_sequencial is null or k112_ativo is false) ";
  ...
  case "gerarSlipsExtra" :
    ...
    try {
      ...
      $aSlips = array();
      require_once("model/slip.model.php");
//       echo("<pre>".print_r($oParam->aSlips, 1)."</pre>");exit;
