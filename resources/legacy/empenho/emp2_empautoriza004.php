        ...
        <form name="form1" method="post" action="resources/legacy/cadastro/cad2_iptuconstr002.php" target="rel">
	       ...
	       <tr>
                 <td align="left" colspan="3">
                   <table>
                     <tr>
	               <td valign='center' nowrap align="left" colspan="1" title="<?=@$Tz01_numcgm?>">
...
function js_testa(campo,valor){
  ...
  erro = false;
  if(campo=="i"){
    if(document.form1.z01_numcgmFIM.value!="" && parseInt(valor)>=parseInt(document.form1.z01_numcgmFIM.value)){
      erro = true;
    }
  }else if(campo=="f"){
    if(document.form1.z01_numcgmINI.value!="" && parseInt(valor)<=parseInt(document.form1.z01_numcgmINI.value)){
      erro = true;
    }
  }
  if(erro == true){
    alert(msg);
    document.form1.z01_numcgmINI.value = "";
    document.form1.z01_numcgmFIM.value = "";
    document.form1.z01_numcgmINI.focus();
  }
}
</script>
</html>