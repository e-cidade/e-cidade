...
function js_pesquisa(){
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_empempenho','func_empempenho.php?funcao_js=parent.js_preenchepesquisa|e60_numemp|e60_codemp|z01_nome','Pesquisa',true);
}
function js_preenchepesquisa(numemp,codemp,nome){
  document.form1.e60_numemp.value = numemp;
  document.form1.e60_codemp.value = codemp;
...
function js_verifica(){
  ...
  //comple = 'e60_numemp='+document.form1.e60_numemp.value+'&historico_anular='+document.form1.historico_anular.value+'&valor_anular='+document.form1.valor_anular.value;
  //jan = window.open('emp2_anulardespesa002.php?'+comple,'safo','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
...
<form name="form1" method="post" action='emp2_anulardespesa002.php' ><br><br>
