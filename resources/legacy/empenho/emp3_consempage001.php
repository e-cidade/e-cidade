...
function js_consultar(){
    ...
    if(obj.e80_data_dia.value != "" && obj.e80_data_mes.value !="" && obj.e80_data_ano.value !=""){
     ...
     js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_consultar','emp3_consempage002.php?'+query,'Pesquisa',true);
}
</script>
</head>
...
function js_movs(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_movs','func_empagemov.php?funcao_js=parent.js_mostramov1|e81_codmov','Pesquisa',true);
  }else{
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_movs','func_empagemov.php?pesquisa_chave='+document.form1.e81_codmov.value+'&funcao_js=parent.js_mostramov','Pesquisa',false);
  }
}
