    ...
    <div class="ritz grid-container" dir="ltr">
        ...
        <table class="waffle" cellspacing="0" cellpadding="0" >
            ...
            for ($cont = 0; $cont < count($aFornecedores); $cont++) {
                ...
                $fornecedorMensal->fm101_valortotal = $oFornecedores->e70_valor;
                $fornecedorMensal->fm101_data = implode('-', array_reverse(explode('-', $oFornecedores->e69_dtnota)));
                $fornecedorMensal->fm101_numnota = $oFornecedores->e69_numero;
