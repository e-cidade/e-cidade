...
if (isset($m51_codordem) && $m51_codordem != '') {
  $where .= " and m51_codordem = $m51_codordem and e60_instit = " . db_getsession('DB_instit');
}
      ...
      <tr align='left'>
        <td align="left">
          <table border="0">
            ...
            <tr>
              <td align='right'><b>Obs (Motivo da anulação):</b></td>
              <td colspan='3' align='left'>
                <?
                db_textarea("m53_obs", "", "85", $Im53_obs, true, 'text', 3);
            ...
            <table>
              ...
              <tr>
                <td align='right'>
                  <? $lanca = 0;
                  $lancado = 0;
                  $result_lancado = $clmatestoqueitemoc->sql_record($clmatestoqueitemoc->sql_query(
                    null,
                    null,
                    "sum(m71_valor) as soma",
                    null,
                    "m52_codordem=$m51_codordem and m73_cancelado is false"
                  ));
