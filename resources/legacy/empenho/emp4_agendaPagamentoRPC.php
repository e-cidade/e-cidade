...
include("model/impressaoCheque.model.php");
...
switch($oParam->exec) {
  ...
  case "emitirCheque" :
  	...
  	db_query("UPDATE empagetipo SET e83_sequencia = {$oParam->params[0]->numeroCheque} 
  	WHERE  e83_conta=(SELECT e83_conta FROM empagetipo WHERE e83_codtipo={$oParam->params[0]->aNotasLiquidacao[0]->iCodTipo})");
  	//die($oParam->params[0]->numeroCheque); 
    $oAgenda = new agendaPagamento();
    $oAgenda->setUrlEncode(true);
    try {
