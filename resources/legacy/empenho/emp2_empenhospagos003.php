...
function validarDatas($dtDataInicial, $dtDataFinal, $dtDataInicialBanco, $dtDataFinalBanco, $sWhereContaPagadora, $iInstituicaoSessao){
      if ( !empty($dtDataInicial) && !empty($dtDataFinal) ) {
        ...
        $head5    = "Ordem de {$dtDataInicial} até {$dtDataFinal}";
...
fputs($fp, "DATA AUTENT;COD.CON;DESCRIÇÃO CONTA;FONTE;DOT.;EMP/SLIP;ORDEM;NOTAS FISCAIS;CREDOR;VLR.AUTENT;NºCHEQUE;TIPO;CONTRATO;\n");
