...
$db_opcao       = 1;
$oDaoParam      = db_utils::getDao("empparametro");
$rsParam        = $oDaoParam->sql_record($oDaoParam->sql_query_file(DB_getsession("DB_anousu")));
$sFonte         = "emp1_empempenho004.php";
if ($oDaoParam->numrows > 0) {

    $oParam = db_utils::fieldsMemory($rsParam, 0);
    if ($oParam->e30_notaliquidacao != '') {
        $sFonte = "emp4_empempenho004.php";
    }
}
        ...
        <tr>
            <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
                ...
                if (isset($chavepesquisa)) {
                    ...
                    $clcriaabas->src = array("empempenho" => "{$sFonte}?chavepesquisa=" . $chavepesquisa . "&lanc_emp=" . @$lanc_emp, "empempitem" => "", "empempdot" => "", "empprazos" => "");
                } else {
                    // $clcriaabas->src = array("empempenho"=>"emp1_empempenho004.php?lanc_emp=".@$lanc_emp,"empempitem"=>"","empempdot"=>"","empprazos"=>"","empempret"=>"");
                    $clcriaabas->src = array("empempenho" => "{$sFonte}?lanc_emp=" . @$lanc_emp, "empempitem" => "", "empempdot" => "", "empprazos" => "");
                }
