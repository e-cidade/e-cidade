...
function js_pesquisarRecurso(mostra){
    if(mostra==true){
        js_OpenJanelaIframe('','db_iframe_orctiporec','func_orctiporec.php?funcao_js=parent.js_mostraRecurso1|o15_codigo|o15_descr','Pesquisa',true,0);
    }else{
        if(document.form1.o15_codigo.value != ''){
            js_OpenJanelaIframe('','db_iframe_orctiporec','func_orctiporec.php?pesquisa_chave='+document.form1.o15_codigo.value+'&funcao_js=parent.js_mostraRecurso','Pesquisa',false);
        }else{
