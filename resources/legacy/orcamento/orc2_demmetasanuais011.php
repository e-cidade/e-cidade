...
<script>
	...
	function js_mostrappalei1(chave1,chave2, iAnoInicio, iAnoFinal) {
    ...
    js_getVersoesPPA(chave1);
	  ...
	  js_recarregaParametros(iAnoInicio, iAnoFinal);
	}
  ...
  function js_emite(){
    ...
    var sQuery  = '?iLei='+doc.o05_ppalei.value;
     ...
     var jan = window.open('orc2_demmetasanuais002.php'+sQuery,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
         jan.moveTo(0,0);
  }
  ...
  function js_recarregaParametros(iAnoInicial, iAnoFinal) {
    ...
    CurrentWindow.corpo.iframe_parametros.location.href = sUrl+"&iAnoInicial="+iAnoInicial+"&iAnoFinal="+iAnoFinal ;
  }
