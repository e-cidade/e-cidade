...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clorcsuplementacaoparametro->alterar($o134_anousu);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcsuplementacaoparametrocriterio.location.href='orc1_orcsuplementacaoparametrocriterio001.php?o135_orcsuplementacaoparametro=".@$o134_anousu."';
     ";
         if(isset($liberaaba)){
