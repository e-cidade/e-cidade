...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clorctiporec->alterar($o15_codigo);
...
if(isset($chavepesquisa) && $o15_tipo == 2){
 echo "
  <script>
      function js_db_libera(){
         parent.document.formaba.orctiporecconvenio.disabled=false;
         CurrentWindow.corpo.iframe_orctiporecconvenio.location.href='orc1_orctiporecconvenio001.php?o16_orctiporec=".@$o15_codigo."';
     ";
         if(isset($liberaaba)){
