...
if ($iValrYReceita > $iValrYDespesa) {
    $iValorYPatronais = ($iValrYReceita + 9);
} else {
    $iValorYPatronais = ($iValrYDespesa + 9);
}
...
$oPdf->setfont('arial', 'B', $iFonte);
$oPdf->cell($iColunaDescr, $iAlt, setIdentacao($aDadosSumarioGeral[27]->nivellinha) . $aDadosSumarioGeral[27]->descricao, 0, 0, "L", 0);
$oPdf->cell($iColunaValor, $iAlt, db_formatar($aDadosSumarioGeral[27]->total, 'f'), 0, 1, "R", 0);
 ...
 */
$oPdf->setfont('arial', 'B', $iFonte);
$oPdf->cell($iColunaDescr, $iAlt, setIdentacao($aDadosSumarioGeral[25]->nivellinha) . $aDadosSumarioGeral[25]->descricao, 0, 0, "L", 0);
$oPdf->cell($iColunaValor, $iAlt, db_formatar($aDadosSumarioGeral[25]->total, 'f'), 0, 1, "R", 0);

$oPdf->setXY(100, $iValorYTotal);

$oPdf->setfont('arial', 'B', $iFonte);
$oPdf->cell($iColunaDescr, $iAlt, setIdentacao($aDadosSumarioGeral[28]->nivellinha) . $aDadosSumarioGeral[28]->descricao, 0, 0, "L", 0);
$oPdf->cell($iColunaValor, $iAlt, db_formatar($aDadosSumarioGeral[28]->total, 'f'), 0, 1, "R", 0);
