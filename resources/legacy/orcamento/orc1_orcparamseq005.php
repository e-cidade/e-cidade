...
if(isset($alterar)){
	...
	if ($clorcparamseq->numrows > 0 && $lValidaSeq) {
	  ...
	  echo "<script>CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna.location.href='orc1_orcparamseqorcparamseqcoluna001.php?";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna.location.href='orc1_orcparamseqorcparamseqcoluna001.php?o116_codparamrel=".@$o69_codparamrel."&o116_codseq=".@$o69_codseq."';
         parent.document.formaba.configuracao.disabled=false;
         CurrentWindow.corpo.iframe_configuracao.location.href='orc4_orcparamseqfiltropadrao.php?o116_codparamrel=".@$o69_codparamrel."&o116_codseq=".@$o69_codseq."';
     ";
         if(isset($liberaaba)){
