  ...
  <table  align="center" width="450">
    <form name="form1" method="post" action="" >
    		...
    		<td colspan=2  class='table_header'>
      		 DEMONSTRATIVO X - Despesas com ASPS
    		</td>
  		</tr>
      <tr>
...
<script>
  ...
  function js_emite(){
    ...
    var sQuery  = '?iLei='+doc.o05_ppalei.value;
     ...
     var jan = window.open('orc2_demreceitasdespesassaude002.php'+sQuery,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
         jan.moveTo(0,0);
  }
  ...
  function js_recarregaParametros(iAnoInicial, iAnoFinal) {
    ...
    CurrentWindow.corpo.iframe_parametro.location.href = sUrl+"&iAnoInicial="+iAnoInicial+"&iAnoFinal="+iAnoFinal ;
  }
