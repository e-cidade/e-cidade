...
require_once(modification("classes/db_orcreserva_classe.php")); // reserva de sald)o
require_once(modification("classes/db_orcreservasup_classe.php")); // reserva de saldo das suplementaçõe)s
require_once(modification("classes/db_orcsuplemval_classe.php")); // lançamento das suplementaçõe)s
...
require_once(modification("dbforms/db_suplementacao.php")); // contem a função que processa a suplementaçã)o
