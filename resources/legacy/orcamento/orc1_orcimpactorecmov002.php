	...
	<tr>
	  ...
	  <?
		...
		if(isset($opcao)){
		    ...
		    echo "<script>";
		    echo "
			CurrentWindow.corpo.iframe_orcimpactorecmov.document.form1.o69_codperiodo.value = $o69_codperiodo;
			CurrentWindow.corpo.iframe_orcimpactorecmov.document.form1.o69_proces.value = $o69_proces;

			obj=CurrentWindow.corpo.iframe_orcimpactorecmov.document.createElement('input');
			obj.setAttribute('name','opcao');
			obj.setAttribute('type','hidden');
			obj.setAttribute('value','$opcao');
			CurrentWindow.corpo.iframe_orcimpactorecmov.document.form1.appendChild(obj);
			CurrentWindow.corpo.iframe_orcimpactorecmov.document.form1.submit();
