...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clorcsuplementacaoparametrocriterio->o135_sequencial=$o134_anousu;
  $clorcsuplementacaoparametrocriterio->excluir($o134_anousu);

  if($clorcsuplementacaoparametrocriterio->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clorcsuplementacaoparametrocriterio->erro_msg;
  $clorcsuplementacaoparametro->excluir($o134_anousu);
  ...
  db_fim_transacao($sqlerro);
   ...
   $db_opcao = 3;
   $db_botao = true;
   $result = $clorcsuplementacaoparametro->sql_record($clorcsuplementacaoparametro->sql_query($chavepesquisa));
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='orc1_orcsuplementacaoparametro003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcsuplementacaoparametrocriterio.location.href='orc1_orcsuplementacaoparametrocriterio001.php?db_opcaoal=33&o135_sequencial=".@$o134_anousu."';
     ";
         if(isset($liberaaba)){
