...
<head>
    ...
    <script>
        function emite_relatorio() {
            ...
            jan = window.open('orc2_execucaoexcessoarrecadacao002.php?db_selinstit=' + obj.db_selinstit.value + '&dt_ini=' + dt_ini + '&dt_fim=' + dt_fim, '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0');
            jan.moveTo(0, 0);
        }
    </script>
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
    ...
    <form name="form1" method="post" action="">
        <table align="center" border="0">
            ...
            <tr>
                <th align="center" colspan="3"> Relatorio de Execução do Excesso de Arrecadação </th>
            </tr>
            ...
            <tr>
                <td colspan=3 align="center">
                    <br/>
                    <input name="emitir" type="button" value="Gerar Relatório" onclick="emite_relatorio();">
                </td>
            </tr>
        </table>
    </form>
