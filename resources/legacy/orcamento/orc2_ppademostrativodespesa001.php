...
if (isset($oPost->o05_ppalei) && $oPost->o05_ppalei != "") {
  ...
  if ($oDaoPPALei->numrows > 0) {
    ...
    $sSqlEstimativas = $clppaestimativa->sql_query(null,"*",
      "o119_ppalei /*o05_ppalei*/ limit 1",
      "o119_ppalei /*o05_ppalei*/ = {$oPost->o05_ppalei}");
  ...
  <table>
    <tr>
      <td>
        <fieldset>
          <legend>
            <b>Demonstrativo das Projeções da Despesa</b>
          </legend>
          <table>
           <tr>
...
function js_imprimePPAReceita() {
  ...
  if (iProcessado == 1) {
    ...
    sQuery += "&nivel="+$F('nivel');
    sQuery += '&sListaInstit='+form1.db_selinstit.value;


    jan = window.open('orc2_ppademostrativodespesa002.php'+sQuery,
      '',
