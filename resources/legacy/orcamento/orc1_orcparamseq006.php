 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcparamseqorcparamseqcoluna.location.href='orc1_orcparamseqorcparamseqcoluna001.php?db_opcaoal=33&o116_sequencial=".@$o69_codparamrel."';
     ";
         if(isset($liberaaba)){
