...
if(empty($o90_codperiodo)){
  $result=$clorcimpactoperiodo->sql_record($clorcimpactoperiodo->sql_query_file(null,"o96_codperiodo as o90_codperiodo,o96_descr||' '||o96_anoini||'-'||o96_anofim","o96_codperiodo desc"));
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcimpactoval.location.href='orc1_orcimpactoval001.php?o91_codimp=".@$o90_codimp."';
     ";
         if(isset($liberaaba)){
