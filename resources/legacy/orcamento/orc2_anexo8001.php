...
function js_emite(opcao,origem){
  ...
  valor_nivel = document.form1.orgaos.value;
 ...
 //alert(valor_nivel);
    var iTipoAgrupa = document.form1.tipo_agrupa.value;
    jan = window.open('','safo' + variavel,'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    document.form1.target = 'safo' + variavel++;
    document.form1.action = "orc2_anexo8002.php?perfin="+perfin+"&perini="+perini+"&opcao="+opcao+"&origem="+origem+"&sel_instit="+sel_instit;

    //document.form1.action = "orc2_anexo8002.php?perfin="+perfin+"&perini="+perini+"&opcao="+opcao+"&origem="+origem+"&sel_instit="+sel_instit+"&nivel="+valor_nivel+
    //                          "&tipo_agrupa="+iTipoAgrupa;
    //document.form1.action = "orc2_anexo8002.php?perfin="+perfin+"&perini="+perini+"&opcao="+opcao+"&origem="+origem;
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
  ...
  <table  align="center">
    <form name="form1" method="post" action="orc2_anexo8002.php" >
      <tr>
         <td >&nbsp;</td>
         <td >&nbsp;</td>
      </tr>
