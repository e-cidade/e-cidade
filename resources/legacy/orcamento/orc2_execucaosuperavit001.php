...
<head>
    ...
    <script>
        function emite_relatorio() {
            ...
            jan = window.open('orc2_execucaosuperavit002.php?db_selinstit=' + obj.db_selinstit.value + '&dt_ini=' + dt_ini + '&dt_fim=' + dt_fim, '', 'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0');
            jan.moveTo(0, 0);
        }
    </script>
