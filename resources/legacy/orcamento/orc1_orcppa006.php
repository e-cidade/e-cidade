...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clorcppaval->o24_codseqppa=$o23_codppa;
  $clorcppaval->excluir($o23_codppa);

  if($clorcppaval->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clorcppaval->erro_msg;
  $clorcppa->excluir($o23_codppa);
  ...
  db_fim_transacao($sqlerro);
   ...
   $db_opcao = 3;
   $db_botao = true;
   $result = $clorcppa->sql_record($clorcppa->sql_query($chavepesquisa));
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='orc1_orcppa003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_orcppaval.location.href='orc1_orcppaval001.php?db_opcaoal=33&o24_codseqppa=".@$o23_codppa."';
     ";
         if(isset($liberaaba)){
