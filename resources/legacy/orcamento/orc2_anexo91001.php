...
function js_emite(opcao,origem){
  ...
  if(valor_nivel == 0){
    ...
    document.form1.action = "orc2_anexo91002.php?perfin="+perfin+"&perini="+perini+"&opcao="+opcao+"&origem="+origem;
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
  ...
  <table  align="center">
    <form name="form1" method="post" action="orc2_anexo91002.php" >
      <tr>
         <td >&nbsp;</td>
         <td >&nbsp;</td>
      </tr>
