...
<form name="form1" method="post" action="">
  ...
  <table align="center" border="0">
    ...
    <tr align="center">
      <td>
        <input name="emitir" id="emitir" type="button" value="Visualizar" onclick="js_mandadados(1);"/>
        <input name="emitir" id="emitir" type="button" value="Exportar para Excel" onclick="js_mandadados(2);"/>
      </td>
    </tr>
  </table>
</form>
...
function js_mandadados(tipo){
  ...
  for ( x = 0; x < iTam; x++ ) {
    ...
    listaTipo += sVir+$('fornecedor').options[x].value;
 	...
 	jan = window.open('mat2_relcompra002.php?'+sUrl,'',
