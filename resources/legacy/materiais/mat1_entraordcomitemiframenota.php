...
if (isset ($m51_codordem) && $m51_codordem != "") {
  ...
  if ($numrows > 0) {
    ...
    <td class='table_header' align='center'><b><small>$RLe60_codemp</small></b></td>
    <td class='table_header' align='center'><b><small>$RLpc01_descrmater</small></b></td>
    <td class='table_header' align='center'><b><small>$RLe62_descr</small></b></td>
    <td class='table_header' align='center'><b><small>$RLm52_valor</small></b></td>
    <td class='table_header' align='center'><b><small>Valor Total</small></b></td>
    <td class='table_header' align='center'><b><small>$RLm52_quant</small></b></td>
    <td class='table_header' align='center'><b><small>Recebido</small></b></td>
    <td class='table_header' align='center'><b><small>Valor Rec.</small></b></td>
    <td class='table_header' align='center'><b><small>Unidade de Entrada</small></b></td>
    <td class='table_header' align='center'><b><small>Quant. Unid.</small></b></td>
    <td class='table_header' align='center'><b><small>Item de Entrada</small></b></td>
    <td class='table_header' align='center'><b><small>Receber</small></b></td>
    <td class='table_header' align='center'><b><small>Incluir Item de Entrada Novo</small></b></td>";
  }else{
  ...
  for ($i = 0; $i < $numrows; $i ++) {
    ...
    $sSQLItensAnulados .= " where m36_matordemitem = {$m52_codlanc}";
    ...
    $valortotal         =  db_formatar(($m52_valor - $oItensAnulados->vlranulado), 'p');
    $m52_valor          =  db_formatar($m52_valor - $oItensAnulados->vlranulado, 'p');
    $m52_quant          =  db_formatar($m52_quant - $oItensAnulados->qtdanulada, 'p');
    ...
    if ($clmatestoqueitemoc->numrows != 0) {
      ...
      if (($quantidade == 0) && ($vlto == 0)) {
        ...
        if ($clmatordemitement->numrows != 0) {
          ...
          $vlto = ($quantidade - $oItensAnulados->qtdanulada) * $valoruni;
        }
        if (($quantidade != 0 || $clmatordemitement->numrows != 0) || $pc01_servico == 't') {
          ...
          if ($pc01_servico == "f") {
            ...
            db_input("quant_$e62_codele"."_"."$m52_numemp"."_".$m52_codlanc."_"."$i", 10, 0, true, 'text', 1, "onchange='js_verifica($quantidade,this.value,this.name," . db_formatar($valoruni, 'p') . ",$i);' ondblclick='js_zera(this.name,$i);'onkeypress='return js_teclas(event)' ");
            echo "</small></td>";
            echo "<td class='linhagrid' align='center'><small>";
            $js_script = "onChange=\"js_recalcula('valor_".$i."','total_".$i."')\" onkeypress='return js_teclas(event)'";
          ...
          $disab = "";
          echo " <td class='linhagrid' align='left' style='text-align:left' nowrap ><small>";
          ...
          if ($clmatordemitement->numrows != 0) {
            ...
            for ($y = 0; $y < $clmatordemitement->numrows; $y ++) {
              ...
              echo "<tr>";
              echo "
              <td class='linhagrid' align='center'><small><a onClick=\"js_consemp($e60_numemp);\" id=\"cons_emp\" href=#>$e60_codemp</a>".
              //db_ancora($e60_codemp,"js_consemp($e60_numemp)",1).
              " </small></td>
              <td class='linhagrid' nowrap align='left' title='$e62_descr'><small>".substr($pc01_descrmater, 0, 20)."&nbsp;</small></td>
              <td class='linhagrid' nowrap align='left' title='$e62_descr'><small>".substr($e62_descr, 0, 30)."&nbsp;</small></td>
              <td class='linhagrid' align='right'><small>".db_formatar($m54_valor_unitario, 'p', ' ', 4)."</small></td>
              <td class='linhagrid' align='right'><small>".trim(db_formatar($vltot, 'p'))."</small></td>
              <td class='linhagrid' align='center'><small>$m54_quantidade</small></td>
              ...
              <td class='linhagrid' align='center' nowrap ><b> $m54_quantmulti </b></td>
              <td class='linhagrid' align='center' nowrap ><b> $m60_descr</b> </td>
              <td class='linhagrid' align='center'  nowrap colspan='2' >
      ...
      if ($m52_quant != 0 || $clmatordemitement->numrows != 0) {
        ...
        if ($clmatordemitement->numrows != 0) {
          ...
          for ($y = 0; $y < $clmatordemitement->numrows; $y ++) {
            ...
            db_fieldsmemory($result_lancaitens, $y);
            $vltot              = db_formatar($m54_valor_unitario * ($m54_quantidade-$oItensAnulados->qtdanulada), 'p');
            $m54_valor_unitario = db_formatar($m54_valor_unitario, 'p');
            $m54_quantidade     = db_formatar($m54_quantidade - $oItensAnulados->qtdanulada, 'p');
            $conitens ++;
            echo "<tr>";
            echo "
            <td class='linhagrid' align='center'><small><a onClick=\"js_consemp($e60_numemp);\" id=\"cons_emp\" href=#>$e60_codemp</a>".
            ...
            <td class='linhagrid' nowrap align='left' title='$e62_descr'><small>".substr($pc01_descrmater, 0, 20)."&nbsp;</small></td>
            <td class='linhagrid' nowrap align='left' title='$e62_descr'><small>".substr($e62_descr, 0, 30)."&nbsp;</small></td>
            <td class='linhagrid' align='right'><small>".db_formatar($m54_valor_unitario, ' ', 4)."</small></td>
            <td class='linhagrid' align='right'><small>".db_formatar($vltot, 'p')."</small></td>
            <td class='linhagrid' align='center'><small> $m54_quantidade </small></td>
            <td class='linhagrid' align='center' nowrap ><b> $m54_quantidade </b></td>
