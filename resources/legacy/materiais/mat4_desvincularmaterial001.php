...
<body bgcolor=#CCCCCC>
  <form class="container" name="form1" method="post" action="">
    <fieldset>
      <legend>Exclusão de Materiais do inventário</legend>
...
<br>
<input onclick='js_excluirMateriais();' name="excluir" type="button" id="db_opcao" value="Desvincular Ítens"  >
</form>
...
function js_excluirMateriais() {

  var iInventario     = $F('iInventario');
  var aListaCheckbox  = oGridMateriais.getSelection();
  var aListaMateriais      = new Array();
  var msgDiv          = "Excluindo...";
  aListaCheckbox.each(
    function ( aRow ) {
      aListaMateriais.push(aRow[1]);
    }
    );

 // console.log(aListaMateriais);
  oParametros.exec = 'excluirMateriais';
  oParametros.iInventario = iInventario;
  oParametros.sListaMateriais  = aListaMateriais.join(',');
  ...
  var oAjaxLista  = new Ajax.Request(sUrlRPC,
    ...
    onComplete: js_retornoExcluirMateriais
  });


}
function js_retornoExcluirMateriais(oAjax) {
  //console.log(oAjax);
  js_removeObj('msgBox');
...
function js_exibirMateriais() {
  ...
  oParametros.exec            = 'getMateriaisVinculados';
  oParametros.iInventario     = iInventario;
...
function js_pesquisa(){
  ...
  var sQuery  = "func_inventario.php?situacao=1&funcao_js=parent.js_preenchepesquisa|t75_sequencial|t75_dataabertura|t75_periodoinicial|t75_periodofinal|t75_processo|t75_exercicio|t75_acordocomissao|ac08_descricao|t75_observacao";
