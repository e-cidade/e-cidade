...
<body bgcolor=#CCCCCC>
  <form class="container" name="form1" method="post" action="">
    <fieldset>
      <legend>Processar inventário</legend>
...
<br>
<input onclick='js_processar();' name="excluir" type="button" id="db_opcao" value="Processar"  >
</form>
...
function js_processar() {
  ...
  oParametros.exec = 'processaInventario';
 ...
 */
 ...
 function js_gridMateriais() {
  ...
  oGridMateriais.hasTotalizador=false;
