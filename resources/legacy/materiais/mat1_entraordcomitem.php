...
function js_lanca(codele,valor,valoruni,numemp,matordemitem,i,codpcmater){
  ...
  js_OpenJanelaIframe('','db_iframe_lanca','../mat1_lancaitens.php?codmatordemitem='+matordemitem+'&quantidade='+quant+'&codmatmater='+codmatmater+'&codpcmater='+codpcmater+'&valor_unitario='+valoruni,'Pesquisa',false,'0','0','0','0');
}
//-----------------------------------------------------------
