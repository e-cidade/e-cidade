...
function js_mostraempnotatesta(chave,erro){
  if(erro==true){
    ...
    location.href='mat1_entraordcom004.php?e69_codnota='+document.form1.e69_codnota.value+'&m51_codordem='+document.form1.m51_codordem.value;
  }
}
function js_manda(chave){
  location.href='mat1_entraordcom004.php?e69_codnota='+chave+'&m51_codordem='+document.form1.m51_codordem.value;
}
function js_limpa(){
   location.href='mat1_entraordcom003.php';
}
  </script>
