...
if(isset($alterar)){
  ...
  $clmatunid->m61_codsicom = $m61_codsicom;
  $clmatunid->m61_ativo = $m61_ativo;
  $clmatunid->alterar($m61_codmatunid);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 2;
   $result = $clmatunid->sql_record($clmatunid->sql_query($chavepesquisa));
