      ...
      <table style="width:550px">
        ...
        <tr>
          ...
          <td>
           ...
           $ativo = array("t" => "Sim",
                          "f" => "Não");
           db_select("ativo",$ativo,true,2, "class=inputPadrao");
           ?>
          </td>
        </tr>
        <tr>
          <td>
            <strong>Lista estoque zerado: </strong>
          </td>
          <td>
           <?
           $ativo = array("t" => "Sim",
                          "f" => "Não");
           db_select("listestz",$ativo,true,2, "class=inputPadrao");
           ?>
          </td>
        </tr>
      </table>
...
function js_mandadados() {
 ...
 query+= "&ativo=" + document.form1.ativo.value;
 query+= "&listestz=" + document.form1.listestz.value;
