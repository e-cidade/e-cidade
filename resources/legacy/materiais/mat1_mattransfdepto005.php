...
if(isset($chavepesquisa)){
  if($clmatestoqueinimei->numrows>0){
   echo "
   <script>
     CurrentWindow.corpo.iframe_itens.location.href = 'mat1_mattransfitens001.php?departamentodestino=$departamentodestino&departamentoorigem=$departamentoorigem&valores=$valores';
