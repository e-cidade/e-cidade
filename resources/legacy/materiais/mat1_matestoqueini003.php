...
if (isset($excluir)) {
  ...
  $result_matestoque = $clmatestoqueini->sql_record($clmatestoqueini->sql_query_mater(null,"matestoqueini.m80_codigo,
                                                                                            m70_codigo,
                                                                                            m71_codlanc,
                                                                                            m70_valor,
                                                                                            m70_codmatmater,
     ...
     if ($m80_codtipo == 1) {
      ...
      if ($sqlerro == false && USE_PCASP  &&  (ParametroIntegracaoPatrimonial::possuiIntegracaoMaterial($oDataAtual, $oInstituicao) ))  {
        ...
        try {
          ...
          $oDadosEntrada->iMovimentoEstoque    = $iCodidoMovimentacaoEstoque;
          $oDadosEntrada->sObservacaoHistorico = $m80_obs;
          $oDadosEntrada->nValorLancamento     = round(($oMaterialEstoque->getPrecoMedio()*$m71_quant), 2);
