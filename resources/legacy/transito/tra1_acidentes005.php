 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_veiculos_env.location.href='tra1_veiculos_env001.php?tr08_id=".@$tr07_id."';
         parent.document.formaba.vitimas_acid.disabled=false;
         CurrentWindow.corpo.iframe_vitimas_acid.location.href='tra1_vitimas_acid001.php?tr10_id=".@$tr07_id."';
     ";
         if(isset($liberaaba)){
