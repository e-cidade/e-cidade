...
<body>
  ...
  ?>
  <script>
    const ARQUIVO_MENSAGEM = "recursoshumanos.pessoal.pes4_consignadorelatorioimportacao.";
    ...
    function js_carregarCompetencia() {
      ...
      var sUrl        = 'pes4_consignadorelatorioimportacao.RPC.php';
    ...
    function js_gerarRelatorioImportacao(iAno, iMes) {
      ...
      var oParam      = new Object();
          oParam.exec = 'gerarRelatorioImportacaoConsignet';
          oParam.iAno = iAno;
          oParam.iMes = iMes;
      ...
      new AjaxRequest(sUrl, oParam, function(oRetorno, erro) {
        ...
        if(!erro) {
          ...
          oDownload.addFile(oRetorno.sArquivo.urlDecode(), oRetorno.sNomeArquivo.urlDecode(), "txt");
          oDownload.show();
