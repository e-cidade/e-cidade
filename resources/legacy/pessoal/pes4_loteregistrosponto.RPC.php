 ...
 */
// $Id: pes4_loteregistrosponto.RPC.php,v 1.19 2015/04/14 13:52:10 dbrenan.silva Exp $
...
try {
  ...
  case "salvarLote":
    ...
    $oLoteRegistros->setDescricao($oParam->sDescricaoLote);
  ...
  case "cancelarFechamento":
    ...
    $oMensagem->sDescricao = $oParam->sDescricao;
