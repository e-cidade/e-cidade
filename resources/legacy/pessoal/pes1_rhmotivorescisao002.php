...
if (isset($alterar)) {
    db_inicio_transacao();
    $db_opcao = 2;
    $clrhmotivorescisao->alterar($rh173_sequencial);
    db_fim_transacao();
} elseif (isset($chavepesquisa)) {
    $db_opcao = 2;
    $result = $clrhmotivorescisao->sql_record($clrhmotivorescisao->sql_query($chavepesquisa));
...
?>
<script>
  js_tabulacaoforms("form1", "rh173_descricao", true, 1, "rh173_descricao", true);
</script>
