...
switch ($oParam->exec) {
    ...
    case 'processarDadosConvenio':
        ...
        $sCampos    = "r54_codrel as codrel, 
                               ...
                               sum(r54_quant4) as quant4, 
						       sum(r54_quant2) as quant2,
						       sum(r54_quant2) as quant5, 
						       sum(r54_quant3) as quant3,
						       sum(r54_quant3) as quant6 ";
        ...
        if ($clmovrel->numrows > 0) {
            ...
            for ($iClmovrelRow = 0; $iClmovrelRow < $clmovrel->numrows; $iClmovrelRow++) {
                ...
                $iValor1 = $oRsImportados->quant1;
                $iQuant1 = $oRsImportados->quant4;
                $iValor2 = $oRsImportados->quant2;
                $iQuant2 = $oRsImportados->quant5;
                $iValor3 = $oRsImportados->quant3;
                $iQuant3 = $oRsImportados->quant6;

                $r1 = false;
                $r2 = false;
                $r3 = false;

                $sSqlConvenio = $clconvenio->sql_query_file($iCodrel, db_getsession('DB_instit'), null);
                ...
                $sSqlRhPessoalRecisao   = $clrhpessoal->sql_query_rescisao(
                    null,
                    "z01_nome as nome, 
	                 rh02_lota as lotaca",
                    "",
                ...
                if ($r1 == true) {
                    ...
                    $sWherePontoFS     = "r10_anousu=$iAno 
                                            and r10_mesusu=$iMes 
                                            and r10_regist=$iRegist 
                ...
                if ($r2 == true) {
                    ...
                    $sSqlPontoFS02     = $clpontofs->sql_query_file(
                        null,
                        null,
                        null,
                        null,
                        ...
                        "r10_anousu = {$iAno}
                            and r10_mesusu = {$iMes}
                            and r10_regist = {$iRegist} and r10_rubric ='{$rub02}'"
                    );
                ...
                if ($r3 == true) {
                    $sSqlPontoFS03     = $clpontofs->sql_query_file(
                        null,
                        null,
                        null,
                        null,
