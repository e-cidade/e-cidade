...
if($sqlerro == false){
  $campos = "
               ...
               z01_numcgm
";
  $sql = $clfolha->sql_query_gerarqbagContass(null,"$campos,length(trim(r38_agenc)) as qtddigitosagencia,
                                             r70_descr,
...
//      }
    ...
    $head5 = "SEQUENCIAL DO ARQUIVO  :  ".$sequenciaarqui;
    $head6 = "GERAÇÃO  :  ".db_formatar($datageracao,"d").' AS '.$horageracao.' HS';
