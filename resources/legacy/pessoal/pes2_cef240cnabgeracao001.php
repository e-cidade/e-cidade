...
<style>
  #datagera, #datadeposit, #rh34_codarq, #rh34_codban, #rh34_agencia{
    width: 90px;
  }
  ...
  #layout, #ambientecliente{width: 135px;}
</style>
<script>
function js_valores(){
...
function js_emite(){
  if(document.form1.rh34_codban.value != '104'){
    alert('Este menu só pode ser usado para Caixa Econômica Federal. Verifique!');
    return false;
  }
  js_controlarodape(true);
  qry  = 'rh34_codarq='+document.form1.rh34_codarq.value;
  qry += '&ambientecliente='+document.form1.ambientecliente.value;
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_geraarqbanco','pes2_cef240cnabgeracao002.php?'+qry,'Gerando Arquivo',true);
}
