 ...
 */
// $Id: pes4_processamento_loteregistroponto.php,v 1.9 2015/04/13 15:06:42 dbmarcos Exp $
...
<script>
    ...
    var oAjaxRequest = new AjaxRequest(
      ...
      function (oAjax, lResposta) {
        ...
        for (var iLote = 0; iLote < oAjax.aResposta.length; iLote++) {
          ...
          sConteudoAcao             += ' <input type="button" value="Consultar" class="botoes_especificos" onClick=\'js_consultarLote(' + oLote.iCodigo + ', " ' + oLote.sDescricao + '");\'/>';
  ...
  function js_executarAcao(sAcao, iCodigoLote, sDescricao, sAnoCompetencia, sMesCompetencia) {
    ...
    sDescricao = sDescricao.urlDecode();
