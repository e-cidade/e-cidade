...
require_once(modification("classes/db_planosaude_classe.php"));
require_once(modification("classes/db_infoambiente_classe.php"));
require_once(modification("classes/db_atividadesdesempenhadas_classe.php"));
require_once(modification("classes/db_agentesnocivos_classe.php"));
require_once(modification("classes/db_inforelativasresp_classe.php"));
...
if (isset($excluir)) {
    ...
    if ($sqlerro == false) {
        $clplanosaude->excluir($rh01_regist);
        $erro_msg = $clplanosaude->erro_msg;
    ...
    if ($sqlerro == false) {
        $clinfoambiente->excluir($rh01_regist);
    ...
    if ($sqlerro == false) {
        $clatividadesdesempenhadas->excluir($rh01_regist);
    ...
    if ($sqlerro == false) {
        $clagentesnocivos->excluir($rh01_regist);
    ...
    if ($sqlerro == false) {
        $clinforelativasresp->excluir($rh01_regist);
