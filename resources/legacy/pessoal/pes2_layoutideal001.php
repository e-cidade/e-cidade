...
function js_emite(){
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_geraideal','pes2_layoutideal002.php?'+qry,'Gerando Arquivo',false);
}

function js_erro(msg){
  //js_controlarodape(false);
  CurrentWindow.corpo.db_iframe_geraideal.hide();
  alert(msg);
}
