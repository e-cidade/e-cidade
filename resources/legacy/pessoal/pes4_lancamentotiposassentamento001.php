 ...
 */
  ...
  try {
    ...
    if (isset($incluir)) {
       ...
       */
      $sSqlTipoAsseFinanceiro  = $cltipoassefinanceiro->sql_query_file(null, "rh165_tipoasse", null, "rh165_tipoasse = {$rh165_tipoasse}");
  ...
  include("forms/db_lancamentotipoassentamento.php");
?>