...
<html>
  ...
  <body>
    <form id="form1" name="form1" action="" method="post" class="container">
      <fieldset>
        ...
        <table class="container-form">
          ...
          <tr>
          <td>
              <a id="procurarOrgao"><b>Secretaria: </b></a>
            </td>
            <td>
              <?php db_input('o40_orgao', 10, '', true, 'text', 1); ?>
              <?php db_input('o40_descr', 50, '', true, 'text', 3); ?>
            </td>
          </tr>
        </table>
      </fieldset>
    ...
    <script type="text/javascript">
      ...
      var oLookupOrgao = new DBLookUp($("procurarOrgao"), $("o40_orgao"), $("o40_descr"), {
        "sArquivo"              : "func_orcorgao.php",
        "sObjetoLookUp"         : "db_iframe_orcorgao",
        "aParametrosAdicionais" : ["FiltraInstituicao=true&funcao_js=parent.js_completaOrgao"]
      });
      ...
      function js_validacampos() {
        ...
        if(document.form1.rh01_regist.value == "" && document.form1.rh164_datainicio.value == "" && document.form1.rh164_datafim.value == "" && document.form1.o40_orgao.value == "") {
      ...
      function js_emiteRelatorio() {
        ...
        aParametros.push( new js_criaObjetoVariavel('$sOrgao', sOrgao));
