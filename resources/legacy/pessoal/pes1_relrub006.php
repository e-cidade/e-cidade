...
if(isset($excluir)){
  ...
  $sWhereRelRubRelRubCampos = "rh121_relrub = $rh45_codigo";
  $oDaoRelRubRelRubCampos->excluir(null, $sWhereRelRubRelRubCampos);


  $clrelrubmov->rh46_seq=$rh45_codigo;
  $clrelrubmov->excluir($rh45_codigo);

  if($clrelrubmov->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clrelrubmov->erro_msg;
  $clrelrub->excluir($rh45_codigo);
   ...
   echo "
    <script>
      function js_db_tranca(){
        parent.location.href='pes1_relrub003.php';
      }\n
      js_db_tranca();
    </script>\n
   ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_relrubmov.location.href='pes1_relrubmov001.php?db_opcaoal=33&rh46_seq=".@$rh45_codigo."';
         CurrentWindow.corpo.iframe_relrubmov.location.href='pes1_relrubmov001.php?db_opcaoal=33&rh46_seq=".@$rh45_codigo."';
         CurrentWindow.corpo.iframe_relrubcampos.location.href   = 'pes1_relrubcampos001.php?rh45_codigo=" . @$rh45_codigo . "&db_opcao=" . $db_opcao . "'; \n
     ";
         if(isset($liberaaba)){
