...
<tr><td>
<fieldset>
<legend><strong>Termos de Rescisão Novo</strong></legend>
<table>
  <?
  if(!isset($tipo)){
    $tipo = "l";
  ...
  $geraform->usarecu = true;                      // PERMITIR SELEÇÃO DE LOCAL DE TRABALHO
...
function js_emite(){
  ...
  jan = window.open('pes4_termorescisaonovo002.php'+qry,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
