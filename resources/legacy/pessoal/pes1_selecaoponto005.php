...
if( isset($oPost->alterar) ){
  ...
  $clselecaoponto->alterar($oPost->r72_sequencial);
...
if(isset($oPost->alterar)){
  ...
  if($lSqlErro){
    ...
    echo "<script> parent.mo_camada('selecaopontorubricas');</script>";
  }
}
...
if(isset($oGet->chavepesquisa)){
 ...
 echo "
  <script>
    ...
    CurrentWindow.corpo.iframe_selecaopontorubricas.location.href='pes1_selecaopontorubricas001.php?chavepesquisa=".@$r72_sequencial."';
  </script>
  ";
