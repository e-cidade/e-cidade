...
const CANCELAR = 'cancelar';
  ...
  (function(oWindow){
    ...
    oWindow.oGridServidores.setHeader([  sIncluir, sCancelar, "Dias",    "Data Concessão",  "Quantidade", "Valor"]);
    oWindow.oGridServidores.setCellWidth(["50px",    "50px",     "65px",    "100px",           "100px",      "100px"]);
        ...
        for (var iServidor = 0; iServidor < aServidores.length; iServidor++) {
          ...
          for ( var iAssentamento=0; iAssentamento < oServidor.assentamentos.length; iAssentamento++ ) {
            ...
            aDadosAssentamento = [
              ...
              sInputCancelar,
              oAssentamento.dias,
              js_formatar(oAssentamento.data_concessao, "d"),
