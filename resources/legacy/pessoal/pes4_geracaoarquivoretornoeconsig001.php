...
<html>
  ...
  <body>
    ...
    <script language="JavaScript" type="text/javascript" >
      ...
      const ARQUIVO_MENSAGEM = "recursoshumanos.pessoal.pes4_geracaoarquivoretornoeconsig.";
      ...
      function js_carregarFolhasPagamentos() {
        ...
        var sUrl        = 'pes4_geracaoarquivoremessaeconsig.RPC.php';
      ...
      function js_processarRetornoArquivo(iAno, iMes) {
        ...
        var oParam      = new Object();
            oParam.exec = 'processamentoRetornoArquivo';
            oParam.iAno = iAno;
            oParam.iMes = iMes;
      ...
      /**
       * Exibe a janela para fazer download do arquivo de retorno do E-Consig
       * 
