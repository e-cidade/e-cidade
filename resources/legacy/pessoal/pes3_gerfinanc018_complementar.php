...
$sWhere            .= " and rh141_tipofolha = " . FolhaPagamento::TIPO_FOLHA_COMPLEMENTAR;
    ...
    <form name="form1" method="post">
     ...
     <?php
       ...
       foreach ( $aFolhas as $oFolha ) {
          ...
          echo "<fieldset class='folha-complementar' id='folha-{$oFolha->rh141_codigo}'>\n";
          echo "  <Legend>Complementar nº {$oFolha->rh141_codigo}</Legend>           \n";
          ...
          foreach ( $oFolha->aDadosValores as $oValores ) {
            ...
            $sRubrica = "<a href='#'>{$oValores->rubrica}</a>";
