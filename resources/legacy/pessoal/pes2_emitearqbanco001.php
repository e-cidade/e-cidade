...
function js_valores(){
  if(document.form1.rh34_codarq.value==""){
    ...
    for(i=0; i<document.form1.recursos.length; i++){
      recursos += vir+document.form1.recursos.options[i].value;
      vir = ",";
    }
    document.form1.recursossel.value = recursos;
    return true;
  }
}
function js_emite(){
  ...
  qry += "&recursos="+document.form1.recursossel.value;

  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_geraarqbanco','pes2_gerabbrasil001.php?'+qry,'Gerando Arquivo',false);
}
...
<table align="center" border="0">
  ...
  <tr>
    <td align="center" colspan="4">
      ...
      $clarquivo_auxiliar = new cl_arquivo_auxiliar;
      $clarquivo_auxiliar->cabecalho  = "<strong>RECURSOS SELECIONADOS</strong>";
      $clarquivo_auxiliar->codigo     = "o15_codigo";
      $clarquivo_auxiliar->descr      = "o15_descr";
      $clarquivo_auxiliar->nomeobjeto = "recursos";
      $clarquivo_auxiliar->funcao_js  = 'js_mostrarecurso';
      $clarquivo_auxiliar->funcao_js_hide = 'js_mostrarecurso1';
      $clarquivo_auxiliar->func_arquivo = "func_orctiporec.php";
      $clarquivo_auxiliar->nomeiframe = "db_iframe_orctiporec";
      $clarquivo_auxiliar->executa_script_apos_incluir = "document.form1.o15_codigo.focus();";
      $clarquivo_auxiliar->executa_script_lost_focus_campo = "js_insSelectrecursos();";
      $clarquivo_auxiliar->executa_script_change_focus = "document.form1.o15_codigo.focus();";
      $clarquivo_auxiliar->tamanho_campo_descricao = 40;
      $clarquivo_auxiliar->mostrar_botao_lancar = false;
      $clarquivo_auxiliar->db_opcao = 2;
      $clarquivo_auxiliar->tipo = 2;
      $clarquivo_auxiliar->top = 20;
      $clarquivo_auxiliar->linhas = 12;
      $clarquivo_auxiliar->vwidth = "400";
      $clarquivo_auxiliar->funcao_gera_formulario();
      db_input('recursossel',15,0,true,'hidden',3,"")
      ?>
      </table>
    </td>
  </tr>
...
function js_pesquisa(mostra){
  if(mostra==true){
    ...
    if(document.form1.rh34_codarq.value != ''){
      ...
      location.href = 'pes2_emitearqbanco001.php';
    }
  }
}
