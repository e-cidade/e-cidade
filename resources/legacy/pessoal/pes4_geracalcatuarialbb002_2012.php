  ...
  if ($_POST["vinculo"] == "A"){
    ...
    $sql = "
      select rh01_regist as matricula,
         ...
         ||rh37_descr
         $xseparador
         ||(case when rh37_reqcargo = 3 then 1 else 0 end)
         $xseparador
         ||1
         $xseparador
         $xseparador
         ||translate(to_char(base2013,'9999999999.99'),'.',',')
         $xseparador
         ||translate(to_char(base2014,'9999999999.99'),'.',',')
         $xseparador
         ||translate(to_char(base2015,'9999999999.99'),'.',',')
         $xseparador
         ||translate(to_char(base2016,'9999999999.99'),'.',',')
