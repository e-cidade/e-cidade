...
if (isset($incluir)) {
    ...
    if ($sqlerro == false) {
        ...
        $result_parametros_matr = $clrhcfpessmatr->sql_record($clrhcfpessmatr->sql_query_file(
            null,
            "rh13_matricula,
                                                                                           rh13_unificada",
            null,
    ...
    if ($rhimp != '') {
        ...
        if ($clrhdepend->numrows > 0) {
            for ($i = 0; $i < $numrows; $i++) {
                ...
                $clrhdepend->rh31_sexo = $rh31_sexo;
        ...
        if (!$sqlerro) {
            ...
            $sSqlPesMov = $oDaoPesMov->sql_query_file(
                null,
                null,
                "*",
                null,
            ...
            if ($iNumRowsMov > 0) {
                ...
                for ($iInd  = 0; $iInd < $iNumRowsMov; $iInd++) {
                    ...
                    $oDaoPesMov->rh02_plansegreg      = $oMovimento->rh02_plansegreg;
                    $oDaoPesMov->rh02_datainicio      = $oMovimento->rh02_datainicio;
