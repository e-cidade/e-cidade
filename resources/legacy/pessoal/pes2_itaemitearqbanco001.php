...
function js_emite(){
  ...
  js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_geraarqbanco','pes2_itaemitearqbanco002.php?'+qry,'Gerando Arquivo',false);
}
...
<table align="center" border="0">
  ...
  <tr>
    ...
    <td nowrap  align="right"> <b>Tipo :<b>
    </td>
    <td>
      <?
...
function js_pesquisa(mostra){
  if(mostra==true){
    ...
    if(document.form1.rh34_codarq.value != ''){
      ...
      location.href = 'pes2_itaemitearqbanco001.php';
    }
  }
}
