 ...
 */
  ...
  try {
    ...
    if (isset($alterar) || isset($excluir)) {
      ...
      $sWhereAssenta  = "h16_assent = $rh167_tipoasse";
      $sWhereAssenta .= "and (h16_dtterm is null or extract(month from h16_dtterm) = {$rh167_mesusu}) ";
      $sWhereAssenta .= "and h16_codigo in (SELECT  h81_assenta FROM  afastaassenta)";
      $sSqlAssenta    = $oDaoAssenta->sql_query_file(null, "h16_codigo", null, $sWhereAssenta);
  ...
  include("forms/db_tipoassentamentoinformacoesexternas.php");
?>