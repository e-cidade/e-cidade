  ...
  switch ($oPost->sMethod) {
    ...
    case 'anularEmpenho':
        ...
        $sSqlEmpenhos .= "          rh72_coddot,                                                                           ";
	      ...
	      $sSqlEmpenhos .= "          rh72_anousu,                                                                           ";
	      $sSqlEmpenhos .= "          rh72_recurso,                                                                          ";
	      $sSqlEmpenhos .= "          rh72_siglaarq, rh76_numemp                                                             ";
	      ...
	      if (count($aEmpenhos) > 0) {
	        ...
	        foreach ($aEmpenhos as $oEmpenho) {
              ...
              $iLotacao = $oEmpenho->rh02_lota;
            } else {
              $iLotacao = null;
            }
	          $oEmpenhoFolha = new empenhoFolha($oEmpenho->rh72_sequencial, $iLotacao);
        ...
        if($assintaraDigital->verificaAssituraAtiva()) {
            foreach ($aEmpenhos as $oEmpenho) {
                ...
                $formularioAnulacaoEmpenho->gerarFormularioAnulacaoEmpenhoByEmpenho($oEmpenho->rh76_numemp);
