...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="a=1" bgcolor="#cccccc">
  ...
  <table  align="center">
    <form name="form1" method="post" action="" enctype="multipart/form-data">
      ...
      <tr>
    <td align="left" nowrap title="Indique o Arquivo a Importar Guaibaprev/Câmara Vereadores" >
      <strong>Indique o Arquivo a Importar Guaibaprev/Câmara Vereadores &nbsp;&nbsp;</strong>
    </td>
    <td >&nbsp;</td>
      </tr>
      <tr>
