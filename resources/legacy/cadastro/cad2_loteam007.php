...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="parent.iframe_g1.document.form1.qruas.value = 't'" >
...
<table border="0">
  <tr><br>
    <td align="center">
      ...
      <select name="qruas" onChange="parent.iframe_g1.document.form1.qruas.value = this.value">
        <option value="t">Com as ruas abaixo</option>
        <option value="f">Sem as ruas abaixo</option>
      </select>
    </td>
  </tr>
  <tr>
