...
function js_checa(){
  ...
  if(document.form1.j52_matric.value==""){
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="document.form1.j52_matric.focus();" >
...
<form name="form1" method="post" action="cad4_constrescr002.php">
  <tr>
