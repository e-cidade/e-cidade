...
require_once("classes/db_iptuconstr_ext_classe.php");
require_once("classes/db_iptuconstr_classe.php");

require_once("classes/db_carconstr_classe.php");
...
require_once("classes/db_iptuconstrdemo_classe.php");
require_once("classes/db_iptuconstrpontos_classe.php");
...
<table align="center" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
      <? include("forms/db_frmiptuconstralt.php"); ?>
    </center>
    </td>
  </tr>
</table>
