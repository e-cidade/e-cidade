          ...
          <td>
            <fieldset style="width:500px;" class="separator">
              ...
              for($n=0; $n<$numrows; $n++){
                ...
                echo "<tr><td style='width:200px;'>$j19_receit - $k02_descr </td><td><input id='receit' class='receit' name='".$k02_descr."xx".$j19_receit."' type='text' size='10' onChange=\"js_validapercentual(this);\"  onKeyUp=\"js_ValidaCampos(this,1,'$k02_descr','f','f',event);\" value='".@$j56_perc."'  ".($db_opcao==3?"disabled":"")."  ></td></tr>";
              }
              echo "</table>";
              ?>
            </fieldset>
