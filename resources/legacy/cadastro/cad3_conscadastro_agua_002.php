    ...
    <td colspan="4" align="left"><table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr valign="top">
          <td width="16%"><table width="80%" border="0" cellspacing="2" cellpadding="0">
              <tr>
                <td title="Caracteristicas do Imóvel" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand" ><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=CaracteristicasDoImovel&parametro=<?=$x01_matric?>" target="iframeDetalhes">
          &nbsp;Caracter&iacute;sticas</a>
        </td>
              </tr>
              <tr>
                <td title="Isenções Lançadas" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Isencoes&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          &nbsp;Isen&ccedil;&otilde;es</a>
        </td>
              </tr>
              <tr>
                <td title="Construções" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Construcoes&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          Constru&ccedil;&otilde;es</a>
        </td>
              </tr>
              <tr>
                <td title="Endereço de Entrega do Carnê" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=EnderecoDeEntrega&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          Endere&ccedil;o entrega</a>
        </td>
              </tr>

        <tr>
                <td title="Hidrômetros Cadastrados" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Hidrometro&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          Hidrometros</a>
        </td>
              </tr>

              <tr>
                <td title="Leituras efetuadas" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Leitura&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          Leituras</a>
        </td>
              </tr>

        <tr>
                <td title="Cálculo Efetuado no Exercício" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Calculo&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          C&aacute;lculo</a>
        </td>
              </tr>
              <tr>
          ...
          Imprime BIC</a>
              ...
              <tr>
                <td title="Histórico de Cortes" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Corte&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
          Hist&oacute;rico de Cortes</a>
        </td>
              </tr>
              <tr>
            <td title="Condomínio" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Condominio&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
              Condomínio</a>
          </td>
          </tr>
        <tr>
           <td title="Ocorrências" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=Ocorrencia&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
              Ocorrências</a>
           </td>
        </tr>
        <tr>
           <td title="Ocorrências" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="resources/legacy/agua/agu3_conscadastro_002_detalhes.php?solicitacao=BaixaImoveis&parametro=<?=$cod_matricula?>" target="iframeDetalhes">
              Baixas de Imóveis</a>
           </td>
        </tr>
