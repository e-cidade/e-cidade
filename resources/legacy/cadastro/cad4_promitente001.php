...
<script>
function js_checa(){
  if(document.form1.j41_matric.value==""){
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="document.form1.j41_matric.focus();">
...
<form name="form1" method="post" action="cad4_promitente002.php">
  <tr>
...
?>
        ...
        <td>
<?
  db_input('j41_matric',4,$Ij41_matric,true,'text',$db_opcaom," onchange='js_pesquisaj41_matric(false);'");
  db_input('z01_nomematri',45,$Iz01_nome,true,'text',3,"","z01_nomematri");
?>
        </td>
      </tr>
      </table>
...
if(isset($excluir)){
  if($clpromitente->erro_status=="0"){
    ...
    $clpromitente->erro(true,false);
    db_redireciona("cad4_promitente001.php");
  }
}
if(isset($atualizar)){
  if($clpromitente->erro_status=="0"){
