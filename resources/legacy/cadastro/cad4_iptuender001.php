...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="document.form1.j43_matric.focus();" >
...
<form name="form1" method="post" action="cad4_iptuender002.php">
  <tr>
    <td align="left" valign="center" bgcolor="#CCCCCC">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>
<?
  db_ancora($Lj43_matric,' js_matri(true); ',1);
?>
          </td>
          <td>
<?
  db_input('j43_matric',5,0,true,'text',1,"onchange='js_matri(false)'");
...
function js_matri(mostra){
  var matri=document.form1.j43_matric.value;
  if(mostra==true){
