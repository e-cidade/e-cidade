...
for ( $iInd = 0; $iInd  < $iNumRows; $iInd++ ) {
   ...
   */
  if ( isset($oGet->caracteristicaslote) ) {
   ...
   */
  if ( isset($oGet->caracteristicasface) ) {
   ...
   * Testadas Internas
   */
  if ( isset($oGet->testadasinternas) ) {
   ...
   */
  if ( isset($oGet->outrosproprietarios) ) {
   ...
   * Outros Promitentes
   */
  if ( isset($oGet->outrospromitentes) ) {
   ...
   * Imobiliarias
   */
  if ( isset($oGet->imobiliaria) && !empty($oDados->j44_numcgm)) {
  ...
  if ( isset($oGet->edificacoes) ) {
    ...
    if ($iNumRowsEdificacoes > 0) {
      ...
      for ( $xIndEdificacoes = 0; $xIndEdificacoes  < $iNumRowsEdificacoes; $xIndEdificacoes++ ) {
         ...
         */
        if ( isset($oGet->caracteristicasconstrucoes) ) {
   ...
   * Registro de Imoveis
   */
  if ( isset($oGet->dadosregistroimoveis) ) {
  ...
  if ( isset($oGet->isencoes) ) {
    ...
    if ($iNumRowsIsencoes > 0) {
      ...
      for ( $xIndIsencoes = 0; $xIndIsencoes  < $iNumRowsIsencoes; $xIndIsencoes++ ) {
        ...
        $sSqlTaxas .= "        INNER JOIN iptutaxamatric on j09_iptucadtaxaexe = j08_iptucadtaxaexe and j09_matric = {$oDados->j01_matric}";
  ...
  if ( isset($oGet->calculos) ) {
    ...
    if ( !isset($oGet->calculosanteriores) ) {
...
//        $sSqlValoresLancados .= "                             end as j21_valorisen                                                                                               ";
        $sSqlValoresLancados .= "                             0 as j21_valorisen                                                                                                 ";
...
if ( isset($oGet->dadosimovel) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Dados do Imóvel');
...
if ( isset($oGet->caracteristicaslote) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Características do Lote');
...
if ( isset($oGet->testadaslote) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Testadas do Lote');
...
if ( isset($oGet->testadasinternas) ) {
  ...
  if ( count($aDadosTestadaInterna) > 0 ) {
    imprimirCabecalhoFixo($pdf, $iAlt, true, 'Testadas Internas');
...
if ( isset($oGet->caracteristicasface) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Características da Face');
...
if ( isset($oGet->proprietarios) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Proprietário');
...
if ( isset($oGet->outrosproprietarios) ) {
  ...
  if ( count($aDadosOutrosProprietarios) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Outros Proprietários');
...
if ( isset($oGet->promitentes) ) {
  ...
  if ( count($aDadosPromitentes) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Promitentes');
...
if ( isset($oGet->outrospromitentes) ) {
  ...
  if ( count($aDadosOutrosPromitentes) > 0 ) {
    ...
    imprimirCabecalhoFixo($pdf, $iAlt, true, 'Outros Promitentes');
 ...
 */
if ( isset($oGet->imobiliaria) ) {


  if ( count($aDadosImobiliaria) > 0 ) {

  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Imobiliária');
...
if ( isset($oGet->enderecoentrega) ) {
  ...
  if ( count($aDadosEnderecoEntrega) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Endereço de Entrega');
...
if ( isset($oGet->edificacoes) ) {
  ...
  if ( count($aDadosEdificacoes) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Cadastro Edificações');
...
if ( isset($oGet->dadosregistroimoveis) ) {
  ...
  if ( count($aDadosRegistroImovel) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Dados Registro de Imóveis');
...
if ( isset($oGet->isencoes) ) {
  ...
  if ( count($aDadosIsencoes) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Isenções');
...
if ( isset($oGet->averbacoes) ) {
  ...
  if ( count($aDadosAverbacoes) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Averbações');
...
if ( isset($oGet->calculos) ) {
  ...
  imprimirCabecalhoFixo($pdf, $iAlt, true, 'Dados para Cálculo');
...
if ( isset($oGet->outrosdados) ) {
  ...
  if ( count($aDadosOutrosDados) > 0 ) {
  	...
  	imprimirCabecalhoFixo($pdf, $iAlt, true, 'Outros Dados');
 ...
 */
function imprimirCabecalhoFixo($pdf, $iAlt, $lImprime, $sDescricao) {
