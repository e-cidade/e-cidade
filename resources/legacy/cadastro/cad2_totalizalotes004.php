    ...
    <center>
       ...
       <tr>
           <td align="center">
                ...
                <select name="ver">
                    <option name="condicao2" value="com">Com os ruas selecionados</option>
                    <option name="condicao2" value="sem">Sem os ruas selecionadas</option>
                </select>
          </td>
       </tr>
       <tr>
