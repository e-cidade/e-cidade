...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clsetorfiscalvalor->j82_setorfiscal=$j90_codigo;
  $clsetorfiscalvalor->excluir(null,"j82_setorfiscal=$j90_codigo");

  if($clsetorfiscalvalor->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clsetorfiscalvalor->erro_msg;
  $clsetorfiscal->excluir($j90_codigo);
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include("forms/db_frmsetorfiscal.php");
	?>
    </center>
	</td>
  </tr>
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='cad1_setorfiscal003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_setorfiscalvalor.location.href='cad1_setorfiscalvalor001.php?db_opcaoal=33&j82_setorfiscal=".@$j90_codigo."&j90_descr=".@$j90_descr."';
     ";
         if(isset($liberaaba)){
