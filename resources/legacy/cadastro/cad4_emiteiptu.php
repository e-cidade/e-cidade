...
<div class="container">
  <form name="form1" action="" method="post">
    <fieldset>
      <legend>Emissão Geral de IPTU</legend>
      ...
      <fieldset style="margin-top: 20px;">
        ...
        <tr>
         ...
         <tr>
           <td>
             <strong>Expressão "Isento" Quando Taxa/Imposto Zerado:</strong>
           </td>
           <td>
         ...
         <tr>
            <td>
                <strong>Imprimir somente Cota Única:</strong>
            </td>
            <td>
...
var sHintZerado   = "Se esse campo estiver marcado, sempre que gerar <br> carnê de uma matrícula que possuir isenção <br> no ";
    sHintZerado  += "IPTU ou taxa, será impresso no carnê, <br> no local onde seria impresso o valor a expressão 'ISENTO'.";
