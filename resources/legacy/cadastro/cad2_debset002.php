...
$result_ultdata = pg_exec("select k22_data from debitos where k22_instit = $instit order by k22_data desc limit 1");
...
if(isset($quadra) && $quadra != ""){
  ...
  for($i=0;$i<count($arr_quadra);$i++){
	...
	$where .= " $and lote.j34_quadra in ($qua)";
  $and = " and ";
               ...
               proprietario.j39_numero,
				...
				from proprietario
				     ...
				     inner join arrematric on arrematric.k00_matric = iptubase.j01_matric 
						 inner join debitos on debitos.k22_numpre = arrematric.k00_numpre and k22_instit = $instit
