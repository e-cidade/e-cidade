...
require_once("classes/db_zonasvalor_classe.php");
          ...
          <tr>
            ...
            <td>
               ...
               <?php
          	     ...
          	     $result = $clzonasvalor->sql_record($clzonasvalor->sql_query_file("", "", " distinct j51_anousu", "j51_anousu desc"));
