...
<form name="form1" method="post" action="cad4_setfisclograd002.php">
<center>
<table border="0">
  <tr>
...
<table border="0">
  ...
  <tr>
    <td colspan="3" align="center">
       <input name="Enviar" type="submit"  value="Enviar" onclick="return js_pesquisar();" >
    </td>
  </tr>
</table>
    </td>
