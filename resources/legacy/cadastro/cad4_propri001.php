...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="document.form1.j42_matric.focus();">
...
<form name="form1" method="post" action="cad4_propri002.php">
  <tr>
...
<?
  db_ancora(@$Lj42_matric,"js_pesquisaj42_matric(true);",$db_opcao);
?>
        </td>
        <td>
<?
  db_input('j42_matric',4,$Ij42_matric,true,'text',$db_opcaom," onchange='js_pesquisaj42_matric(false);'")
?>
<?
...
if(isset($excluir)){
  if($clpropri->erro_status=="0"){
    ...
    $clpropri->erro(true,false);
    db_redireciona("cad4_propri001.php");
  }
}
if(isset($atualizar)){
  if($clpropri->erro_status=="0"){
