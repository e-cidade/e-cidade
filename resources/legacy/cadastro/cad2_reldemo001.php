...
<tr align="center" width="100%">
   ...
   <td width="15%" height="30" colspan=""><font size="3">
	...
	<td align="left" width="50%" height="30" colspan=""><font size="3">
	     <input name="processa" id="emite2" type="button" value="Processar" onClick="js_relatorio()">&nbsp;&nbsp;
	</td>
	<td width="25%" height="30" colspan=""><font size="3">
	</td>
	</tr>
...
function js_relatorio(){
   ...
   jan = window.open('cad2_reldemo002.php?tiporel='+document.form1.tiporel.value+'&datai='+datai+'&dataf='+dataf,"",'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
   jan.moveTo(0,0);
