...
<form name="form1" method="post" action="cad4_averba004.php">
  <tr>
    <td align="left" valign="center" bgcolor="#CCCCCC">
      ...
      <input name="entrar" type="submit" id="pesquisa" value="Entrar">
      </center>
    </td>
  </tr>
</form>
...
$func_iframe->mostrar();
if(isset($inexistente)){
  echo "<script>alert('Não foi encontrado nenhuma averbação para o numero de matrícula fornecido!')</script>";
}
?>
