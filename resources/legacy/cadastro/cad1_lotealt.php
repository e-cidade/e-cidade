			...
			db_fim_transacao($trans_erro);
				...
				if ($cllote->erro_status == 1) {
					...
					if ($sqlerro == false) {
						...
						//echo ($cltesinter->sql_query_file(null,'j39_sequencial',null,"j39_idbql = $j34_idbql"));
          ...
          for ($i = 0; $i < sizeof($matriztesta); $i++) {
              ...
              if ($j54_codigo != "" && $j54_distan != "" ) {
				...
				$db_opcao = 2;
					...
					//setor fiscal ================================================================================================================
					$rsResultsetfis = $cllotesetorfiscal->sql_record($cllotesetorfiscal->sql_query_file("", "j91_codigo", "", " j91_idbql = $j34_idbql"));
      ...
      <form name="form1" method="post" action="" onSubmit="return js_verifica_campos_digitados();">
        <tr>
          <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
            ...
            <center>
              <?  require_once("forms/db_frmlotealt.php"); ?>
            </center>
          </td>
        </tr>
      </form>
