...
if (isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"]=="Incluir"){
   ...
   if(!isset($j30_codi)||$j30_codi==""){
   	$result_seq = pg_query("select nextval('setor_j30_codi_seq')as j30_codi");
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="document.form1.j30_descr.focus();" >
