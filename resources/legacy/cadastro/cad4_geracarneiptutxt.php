...
$sqlprinc .= "       j34_quadra,";
$sqlprinc .= "       j34_lote,";
$sqlprinc .= "       j34_distrito,";
$sqlprinc .= "       j01_unidade,";
...
for ($vez = 0; $vez <= 1; $vez++) {
  ...
  if ($clabre_arquivo->arquivo != false) {
    ...
    for ($i = 0; $i < $quantidade; $i ++) {
      ...
      $inscricaoimobiliaria = ''.str_pad($j34_distrito, 2, "0", STR_PAD_LEFT).$j34_setor.$j34_quadra.$j34_lote.$j01_unidade.'';
          ...
          if ($gerar == "dados") {
            ...
            if ($tipo == "txt") {
              ...
              if (trim($j23_cxpostal) != "" and $j23_cxpostal > 0) {
                ...
                $linha10 .= substr( str_pad(substr( cad4_geracarneiptutxt . phpaddslashes(trim($j23_ender)) . trim($j23_numero) . (strlen(trim($j23_compl)) > 0?"/":"") . trim($j23_compl) . "-" . $j23_bairro ,0,40),40," ",STR_PAD_RIGHT) ,0,40);
              }
              ...
              $linha10 .= str_pad($anousu, 4, "0", STR_PAD_LEFT) . " cad4_geracarneiptutxt.php";
              ...
              $imp_linha31 = " ";
              $imp_linha31 .= addslashes($tipopri) . " cad4_geracarneiptutxt.php" . addslashes($nomepri) . ", " . $j39_numero . "/" . $j39_compl;
              if (trim($j23_cxpostal) != "" and $j23_cxpostal > 0) {
            ...
            for ($unica=0; $unica < sizeof($unicas); $unica++) {
              ...
              if (pg_num_rows($resultfin) > 0) {
                ...
                for ($unicont = 0; $unicont < pg_numrows($resultfin); $unicont ++) {
                  ...
                  $numpre  = cad4_geracarneiptutxt . phpdb_numpre($k00_numpre);
                  $numpref = cad4_geracarneiptutxt . phpdb_numpre($k00_numpre);
               ...
               if ($gerar == "dados") {
                ...
                if( $oRegraEmissao->isCobranca() ) {
                  ...
                  if ($gerar == "dados") {
                    ...
                    $numpreunica = cad4_geracarneiptutxt . phpdb_numpre($k03_numpreunica);
                    if ($tipo == "txt") {
                ...
                if ($gerar == "dados") {
                  if ($tipo == "txt") {
                    ...
                    $linha20 .= "00";
                    $linha20 .= cad4_geracarneiptutxt . phpsubstr($vencunica, 8, 2) . substr($vencunica,2,2);
                ...
                if( $oRegraEmissao->isCobranca() ) {
                  ...
                  if ($gerar == "dados") {
                    ...
                    if ($gerarparcelado == true  and $achoua) {
                      $numprepar = cad4_geracarneiptutxt . phpdb_numpre($k03_numprepar);
                      if ($tipo == "txt") {
                    ...
                    if ($tipo == "txtbsj") {
                      ...
                      $linha21 .= cad4_geracarneiptutxt . phpsubstr($k00_dtvenc, 8, 2) . substr($k00_dtvenc,2,2);
                  ...
                  $numpre = cad4_geracarneiptutxt . phpdb_numpre($k03_numprepar);
