    ...
    <Td colspan="6" align="left"><table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr valign="top">
          <td width="16%"><table width="80%" border="0" cellspacing="2" cellpadding="0">
              ...
              <tr>
                <td title="Ocorrências" align="center" nowrap bgcolor="#CCCCCC" style="cursor:hand"><a href="../agua/agu3_conscadastro_002_detalhes.php?solicitacao=Ocorrencia&parametro=<?=$cod_matricula?>" target="iframeDetalhes">Ocorrências</a></td>
              </tr>
              <?
