...
function js_emite() {
 ...
 if (ano==""){
 	alert("Preencha o Ano para proseguir!!Campo Vazio!!");
 	ano="";
   ...
   vir="";
   listazona="";
   for(x=0;x<parent.iframe_g5.document.form1.zona.length;x++){
     listazona+=vir+parent.iframe_g5.document.form1.zona.options[x].value;
     vir=",";
   }

   setor=document.form1.setor.value;
   quadra=document.form1.quadra.value;


   jan = window.open('cad2_posiptu022.php?quadras'+quadra+'&setores='+setor+'&zonas='+listazona+'&ruas='+listarua+'&bairros='+listabairro+'&ano='+ano+'&verbairro='+document.form1.ver.value+'&verrua='+parent.iframe_g2.document.form1.ver.value+'&verzona='+parent.iframe_g5.document.form1.ver.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
   jan.moveTo(0,0);
 }
}
</script>
