              ...
              <table border="0" class="bordas" id="constr" cellpadding="3" cellspacing="0" width="12%">
               <tr>
                <td nowrap id="link_constr">
                  <input disabled  readonly type="text" value="Construções" size="12" maxlength="12"  class="nomes"  name="constr" title="Construções" onClick="mo_camada('constr',true,'Iframe3');">
            ...
            <table border="0" class="bordas" id="escrit" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_constrescr" nowrap>
                  <input disabled readonly type="text" value="Escrituradas" size="12" maxlength="12"  class="nomes"  name="escrit" title="Construções Escrituradas" onClick="mo_camada('escrit',true,'Iframe4');">
            ...
            <table border="0" class="bordas" id="imobiliaria" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_imobil" nowrap>
                  <input disabled readonly type="text" value="Imobiliária" size="11" maxlength="11"  class="nomes"  name="imobiliaria" title="Manutenção de Imobiliária"  onClick="mo_camada('imobiliaria',true,'Iframe5');">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table border="0" class="bordas" id="promitente" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_promit" nowrap>
                  <input disabled readonly type="text" value="Promitente" size="10" maxlength="10"  class="nomes"  name="promitente" title="Manutenção de Promitente Comprador" onClick="mo_camada('promitente',true,'Iframe6');">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table border="0" class="bordas" id="outros" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_propri" nowrap >
                  <input disabled readonly type="text" value="Outros Propr" size="12" maxlength="12"  class="nomes"  name="outros"  title="Outros Proprietários"  onClick="mo_camada('outros',true,'Iframe7');">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table border="0" class="bordas" id="ender" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_entreg" nowrap>
                  <input disabled readonly type="text" value="End.Entrega" size="11" maxlength="11"  class="nomes"  name="ender" title="Manutenção de Endereços de Entrega" onClick="mo_camada('ender',true,'Iframe8');">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table border="0" class="bordas" id="isencao" cellpadding="3" cellspacing="0" width="12%">
              <tr>
                <td id="link_isencao" nowrap>
                  <input disabled readonly type="text" value="Isenção" size="11" maxlength="11"  class="nomes"  name="isencao" title="Isenção" onClick="mo_camada('isencao',true,'Iframe10');">
                </td>
              </tr>
            </table>
          </td>
            ...
            <table border="0" class="bordas" id="dadosdiver" cellpadding="<?=($j18_utidadosdiver=='t'?"3":"0")?>" cellspacing="0" width="12%">
              <tr>
                <td id="link_dadosdiver" nowrap>
                  <input disabled readonly type="<?=($j18_utidadosdiver=='t'?"text":"hidden")?>" value="Dados diversos" size="11" maxlength="11"  class="nomes"  name="dadosdiver" title="Manutenção de dados diversos" onClick="mo_camada('dadosdiver',true,'Iframe9');">
                </td>
              </tr>
            </table>
          </td>
