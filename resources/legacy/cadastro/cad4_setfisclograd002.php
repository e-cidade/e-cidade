...
function js_bairro(mostra){
  if(mostra==true){
     js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_bairro.php?funcao_js=parent.js_completabairro1|0|1','Pesquisa',true);
  }else{
     js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_bairro.php?pesquisa_chave='+$('j34_bairro').value+'&funcao_js=parent.js_completabairro','Pesquisa',false);
  }
}
...
function js_pesquisaj34_bairro(mostra, iFace){
  ...
  if(mostra==true){
     js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_bairroFaces.php?iFace='+iFace+'&funcao_js=parent.js_mostrabairro1|0|1|dl_Face','Pesquisa',true);
  }else{
     js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe','func_bairroFaces.php?dl_Face='+iFace+'&pesquisa_chave='+$F('j34_bairro_'+iFace)+'&funcao_js=parent.js_mostrabairro','Pesquisa',false);
  }
}
