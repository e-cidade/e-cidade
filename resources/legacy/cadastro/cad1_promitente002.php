...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Alterar"){
  db_inicio_transacao();
  $clpromitente->alterar($j41_matric);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $result = $clpromitente->sql_record($clpromitente->sql_query($chavepesquisa));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include("forms/db_frmpromitente.php");
	?>
    </center>
	</td>
  </tr>
