...
if ($oDaoDocumento->erro_status == "0") {
  db_msgbox("Não há templates cadastrados no Banco de Dados.");
}
...
/**
 * Função que chama a lookup de Processos de compra
 */
...
/**
 * Função que trata o retorno da função que pesquisa os processos de compra
 */
