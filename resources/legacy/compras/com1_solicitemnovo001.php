...
$db_botao = true;
$iframe   = true;
$pc17_unid = $pc17_unid == NULL ? $pc17_unid2 : $pc17_unid;
...
if (isset($incluir) && $sqlerro == false) {
	...
	if ($sqlerro == false) {
		...
		$array_pc11_codigo = array();
		$array_pc81_codprocitem = array();
...
if (isset($alterar) || isset($excluir) || isset($incluir)) {
	...
	if ($sqlerro == true) {
		...
		if ($naodig == true) {
			...
			if (isset($alterar)) {
				echo "<script> document.location.href = 'com1_solicitemnovo001.php?pc11_numero=$pc11_numero&pc11_codigo=$pc11_codigo&opcao=alterar&selecao=" . @$selecao . "$parametro'; </script>";
			}
		}
	} else {
