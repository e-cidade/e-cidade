...
function js_abre(){
  if(document.form1.pc20_codorc.value=="" && document.form1.pc10_numero.value!=""){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_pcorcam','func_pcorcamlancval.php?numero='+document.form1.pc10_numero.value+'&sol=true&rel=true&funcao_js=parent.js_mostrapcorcamsol|pc20_codorc','Pesquisa',true);
