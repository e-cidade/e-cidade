...
if (isset ($atualizar)) {
    ...
    if($sqlerro==false){
        ...
        $result_dtcadcgm = db_query("select z09_datacadastro from historicocgm where z09_numcgm = {$pc74_pcforne} and z09_tipo = 1");
...
function js_atualizar(){
  ...
  document.form1.pc74_observacao.value  = parent.document.form1.pc74_observacao.value;
