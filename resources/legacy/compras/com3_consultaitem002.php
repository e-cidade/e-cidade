				...
				<table border="0">
  					<tr>
    					...
    					<td>
							...
							<strong style="padding-left: 249px;">Data de cadastro</strong>
							<?
  					...
  					<tr>
    					...
    					<td><?db_input('pc01_descrmater',68,$Ipc01_descrmater,true,'text',$db_opcao,"")?></td>
  					</tr>
  					<tr>
    					<td nowrap title="<?=@$Tpc01_complmater?>"><?=@$Lpc01_complmater?></td>
    					<td><?db_textarea('pc01_complmater',0,66,$Ipc01_complmater,true,'text',$db_opcao,"")?></td>
  					</tr>
  					<tr>
					  <td nowrap title="<?=@$Tpc01_libaut?>"><?=@$Lpc01_libaut?></td>
						<td>
							<?
							// Selecionando valor de pc01_libaut
							$arrlibaut_truefalse = array('t'=>'Sim','f'=>'Não');
							db_select("pc01_libaut", $arrlibaut_truefalse, true, $db_opcao);
							?>
							<?=$Lpc01_ativo?>
							<?
							// Selecionando valor de pc01_ativo
							$arr_truefalse = array('f'=>'Não','t'=>'Sim');
							db_select("pc01_ativo", $arr_truefalse, true, $db_opcao);
							?>
							<strong style="padding-left: 6px;">Tipo:</strong>
							<?
							$arr_tipo = array('t' => 'Serviço/Material Permanente', 'f' => 'Material');
							db_select("pc01_servico", $arr_tipo, true, $db_opcao);
							?>
						</td>
...
function js_mostrainfo(mostra){
		js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_mostrainfo','com3_consultaiteminfo.php?pc01_codmater='+document.form1.pc01_codmater.value+'&mostra='+mostra,'..::Consulta Item::..',true);
}
</script>
