...
<div class="container">
    <form action="../../../FrontController.php" method="post" enctype="multipart/form-data">
        <fieldset class="form-container">
            <legend><strong>Importação de SubGrupos</strong></legend>
            <div id="ctnImportacao"></div>
        </fieldset>
    </form>
    <div style="margin-top: 20px">
        <button class="btn btn-success" type="button" onclick="migrarSubgrupos();">Migrar Subgrupos</button>
...
<script>
    ...
    function js_gerarPlanilha(){
        const jan = window.open('com1_planilhasubgrupos.php');
    }
</script>
</html>
