...
if (isset($incluir) && $sqlerro == false) {
    ...
    if (isset($param) && trim($param) != "") {
        $result_pcproc = $clpcproc->sql_record($clpcproc->sql_query_autitem(
            ...
            null,
            "pc81_solicitem = $pc13_codigo and
...
if (isset($opcao) && $opcao != "incluir") {
    $result_pcdotac = $clpcdotac->sql_record($clpcdotac->sql_query_depart(
        null,
        null,
        null,
        "pc13_coddot,
...
if (isset($alterar) || isset($excluir) || isset($incluir)) {
    ...
    if ($sqlerro == true) {
        ...
        if ($clsolicitem->erro_campo != "") {
            ...
            //      echo "<script> CurrentWindow.corpo.iframe_solicitem.location.href = 'com1_solicitem001.php?pc11_numero=$pc11_numero&pc11_codigo=$pc13_codigo&opcao=alterar'; </script>";
        }
    }
}
?>