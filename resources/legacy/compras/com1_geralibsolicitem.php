...
if (isset($solicita) && trim($solicita) != "") {
	...
	$sSqlSolicitem = $clsolicitem->sql_query_pcmater(null, "distinct pc11_numero,pc11_codigo,m61_descr, pc11_quant,pc11_seq,pc11_vlrun,pc11_resum,pc01_codmater,pc01_descrmater,pc11_liberado", "pc11_seq", "pc11_numero=$solicita");
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<form name="form1">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <legend><strong>Ítens da Solicitação</strong>
...
x.pc11_codigo,
			...
			where p64_codtran is null and p68_codproc is null and x.pc11_codigo = $pc11_codigo";
								...
								if ($i == 0) {
									...
									echo "  </tr>\n";
									echo "  <tr>";
									echo "  <td nowrap class='bordas02' align='center'><strong>";
									db_ancora('M', 'js_marcar();', 1);
									echo "</strong></td>\n";
								...
								echo "  <td nowrap class='$bordas' align='center' " . ($ok != "OK" ? " title='Clique para selecionar o tipo de material' " : " title='Tipo material selecionado. Item pode ser liberado' ") . ">";
								db_ancora($ok, "js_selmater($pc11_codigo,$pc11_numero);", ($ok == "OK" ? "3" : "1"));
								echo "</td>\n";
								...
								echo "  <td nowrap class='$bordas' align='center' title='Ver dotações com este item foi incluído.'>";
								db_ancora("Ver", "js_verdotac($pc11_codigo,'$pc01_codmater','$pc11_numero');", 1);
								echo "</td>\n";
								echo "</tr>\n";
							}
							echo "</table>\n";
	...
	<script>
		function js_selmater(codigo, solicita) {
			...
			qry += '&libera=true';
			js_OpenJanelaIframe('top.corpo', 'db_iframe_selmater', 'com1_selmater001.php?' + qry, 'Consulta', true, '20');
			// top.corpo.document.location.href = 'com1_selmater001.php?'+qry;
		}

		function js_verdotac(codigo, mater, numero) {
			js_OpenJanelaIframe('top.corpo', 'db_iframe_dotac', 'com1_seldotac001.php?consulta=true&pc13_codigo=' + codigo + '&pc16_codmater=' + mater + '&numero=' + numero, 'Consulta', true, '20');
			// top.corpo.document.location.href = 'com1_seldotac001.php?pc13_codigo='+codigo+'&pc16_codmater='+mater+'&numero='+numero;
		}
