      ...
      <center>
        <form name="form1" method="post" action="resources/legacy/cadastro/cad2_iptuconstr002.php" target="rel">
		 ...
		 <td colspan="3" align="center">
		   <table>
		     <tr>
			  ...
			  $aux->cabecalho = "<strong>MATERIAIS DOS ITENS</strong>";
			  $aux->codigo = "pc01_codmater";
			  $aux->descr  = "pc01_descrmater";
			  $aux->nomeobjeto = 'mater';
			  $aux->funcao_js = 'js_mostra';
			  $aux->funcao_js_hide = 'js_mostra1';
			  $aux->sql_exec  = "";
			  $aux->func_arquivo = "func_pcmater.php";
		 ...
		 <td align="left">&nbsp;&nbsp;&nbsp;
		   ...
		   db_select('param_mater',$xxx,true,2);
		   ?>
		 </td>
	       </tr>
	     </table>
