...
<div class="container">
    <form action="../../../FrontController.php" method="post" enctype="multipart/form-data">
        <fieldset class="form-container">
            <legend><strong>Migração de Materiais</strong></legend>
            <div id="ctnImportacao"></div>
        </fieldset>
    </form>
    <div style="margin-top: 20px">
        <button class="btn btn-success" type="button" onclick="migrarMateriais();">Migrar Materiais</button>
...
<script>
    ...
    function migrarMateriais() {

        let oParametros                 = {};
        oParametros.sExecuta        = 'migrarMateriais';
        ...
        oAjaxRequest.setMessage( "Aguarde! Migrando Materiais..." );
    ...
    function js_gerarPlanilha(){
        const jan = window.open('com1_planilhamateriais.php');
    }
</script>
</html>
