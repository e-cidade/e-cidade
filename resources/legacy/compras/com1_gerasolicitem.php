...
if (isset($solicita) && trim($solicita) != "") {
  ...
  $sSqlItensSolicitem = $clsolicitem->sql_query_pcmater(null, $sCamposSolicitem, "pc11_seq", $sWhereSolicitem);
          ...
          <td align="left" valign="top" bgcolor="#CCCCCC">
            <center>
              ...
              if ($clsolicitem->numrows == 0) {
                ...
                echo "  <td nowrap class='tdcabecalhotabela' align='center'><strong>";
