...
<table valign="top" marginwidth="0" width="790" border="0" cellspacing="0" cellpadding="0">
  <tr> 
     ...
     $clcriaabas->src        = array("registro" => "com4_alteraestimativaregistro011.php?alterar=true&pc10_numero=$pc10_numero");    
...
if (!$lTemParametroRegistro){
  ...
  db_msgbox('Parâmetros do registro de preço nao configurado!');
