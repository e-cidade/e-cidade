...
$result_itens = $clpcorcamitemproc->sql_record(
    $clpcorcamitemproc->sql_query_solicitem(
        null,
        null,
        "distinct pc11_codigo,pc11_seq,pc11_reservado,pc11_quant,case when pc01_complmater is not null then pc01_descrmater ||'. '|| pc01_complmater else pc01_descrmater end as pc01_descrmater,pc01_codmater,pc11_resum,pc11_pgto,pc11_prazo,pc81_codprocitem,pc10_numero,pc81_codproc as pc80_codproc,m61_usaquant,m61_descr,pc17_codigo,pc17_quant,pc01_servico,pc01_validademinima",
        "pc81_codprocitem",
