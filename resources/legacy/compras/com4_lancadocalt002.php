...
function js_atualizar(){
  var oFormParent = parent.document.form1;

  document.form1.pc74_solicitante.value= oFormParent.pc74_solicitante.value;
  document.form1.pc74_validade.value= oFormParent.pc74_validade.value;
  document.form1.pc74_observacao.value= oFormParent.pc74_observacao.value;
  document.form1.atualizar.value="ok";
  document.form1.oSocial.value =  oFormParent.oSocial.value;
...
<body>
  ...
  <tr>
    <td align="center" valign="top">
		<textarea name="pc74_observacao" style="display: none;"></textarea>
<?
...
<td></td>
                   ...
                   <tr>
							 <td class='cabec' align='center'  title='$Tpc71_codigo'>".str_replace(":", "", $Lpc71_codigo)."</td>
						 	 ...
						 	 <td class='cabec' align='center'  title='NumDoc'><b>N° do Documento</b></td>
    ...
    $numdocumento = "NUMDOC_$pc71_codigo";
    $result_docforne = $clpcfornecertifdoc->sql_record($clpcfornecertifdoc->sql_query_file(null,"*",null,"pc75_pcdoccertif=$pc72_pcdoccertif and pc75_pcfornecertif = $pc74_codigo"));
        ...
        $$numdocumento = $pc75_numdocumento;
		}
    ...
    db_input("NUMDOC_{$pc71_codigo}",14,"text",true,'text',1);
    echo "       </td>
                         <td  class='$corpo'  align='center' title='Validade' nowrap >";

    db_textarea("OBS_$pc71_codigo", 0, 33, "", true, "text", 1);
		echo "       </td>
		              </tr>";
	}
}
