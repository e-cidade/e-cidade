...
$sWhere      = "pc81_codproc = {$iProcesso}";
$sCampos     = "distinct abertura.pc10_numero, abertura.pc10_data, pc80_depto, descrdepto";
$sSQL        = $oDaoPcproc->sql_query_proc_solicita_abertura(null,$sCampos, null, $sWhere);
