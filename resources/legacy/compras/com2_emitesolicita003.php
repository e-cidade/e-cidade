...
$result_pcparam = $clpcparam->sql_record($clpcparam->sql_query_file(
...
if (trim($erros) == "") {
  ...
  if ($clsolicitem->numrows > 0) {
    ...
    for ($i = 0; $i < $num_rows; $i++) {
      ...
      /*
			 * verificará as dotações e reserva somente se o item nao for servico, ou ou nao for ontrolado
			 */
