  ...
  <script language="JavaScript" type="text/javascript">
    ...
    function js_pesquisar_orcamento_processo(lMostra) {
      ...
      if (lMostra) {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_pcorcam', sUrl, 'Pesquisar Orçamento do Processo de Compras', true);
      } else {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_pcorcam', sUrl, 'Pesquisar Orçamento do Processo de Compras', false);
      }
    }
    ...
    function js_pesquisar_orcamento_solicitacao(lMostra) {
      ...
      if (lMostra) {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_pcorcam', sUrl, 'Pesquisar Orçamento da Solicitação de Compras', true);
      } else {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_pcorcam', sUrl, 'Pesquisar Orçamento da Solicitação de Compras', false);
      }
    }
