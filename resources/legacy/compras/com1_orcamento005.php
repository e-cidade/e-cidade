...
if(isset($retorno)){
  ...
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_fornec.location.href='com1_fornec001.php?pc21_codorc=$retorno&solic=true&pc10_numero=$pc10_numero';
       }\n
    js_db_libera();
  </script>\n
       ";
  ...
  <script>
      function js_db_bloqueia(){
         ...
         CurrentWindow.corpo.iframe_fornec.location.href='com1_fornec001.php?solic=true&pc21_codorc=".@$pc20_codorc."';
      }\n
    js_db_bloqueia();
  </script>\n
       ";
...
if($db_open==true){
  ...
  if($clpcorcamitemsol->numrows>0){
    ...
    echo "<script>
            CurrentWindow.corpo.iframe_orcam.location.href = 'com1_orcamento005.php?retorno=$chavepesquisa&pc10_numero=$pc11_numero';
          </script>
         ";
  }else{
    ...
    echo "<script>
            CurrentWindow.corpo.iframe_orcam.location.href = 'com1_selsolic001.php?op=alterar&sol=true';
	  </script>
	  ";
    }else{
    echo "<script>
            alert('Usuário:\\n\\nOrçamento inexistente ou solicitação incluída em processo de compras.\\n\\nAdministrador.');
	    CurrentWindow.corpo.iframe_orcam.location.href = 'com1_orcamento005.php';
	  </script>
	  ";
    }
  }
