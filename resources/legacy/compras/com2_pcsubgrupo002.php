...
for($x = 0; $x < $pcsubgrupo->numrows;$x++){
   ...
   if ($pdf->gety() > $pdf->h - 30 || $troca != 0 ){
      ...
      $pdf->cell(77,$alt,$RLpc04_descrsubgrupo,1,0,"C",1);
      $pdf->cell(15,$alt,$RLpc04_codgrupo,1,0,"C",1);
      $pdf->cell(77,$alt,$RLpc03_descrgrupo,1,0,"C",1);
      $pdf->cell(15,$alt,$RLpc04_codtipo,1,0,"C",1);
      $pdf->cell(77,$alt,$RLpc05_descr,1,1,"C",1);
      $troca = 0;
   }
   $pdf->setfont('arial','',7);
   $pdf->cell(17,$alt,$pc04_codsubgrupo,0,0,"C",0);
   $pdf->cell(77,$alt,$pc04_descrsubgrupo,0,0,"L",0);
   $pdf->cell(15,$alt,$pc04_codgrupo,0,0,"C",0);
   $pdf->cell(77,$alt,$pc03_descrgrupo,0,0,"L",0);
   $pdf->cell(15,$alt,$pc04_codtipo,0,0,"C",0);
   $pdf->cell(77,$alt,$pc05_descr,0,1,"L",0);
   $total++;
}
