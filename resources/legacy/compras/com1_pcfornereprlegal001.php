...
if(isset($incluir)){
  ...
  $result = $clpcfornereprlegal->sql_record($clpcfornereprlegal->sql_query(null,"pc81_sequencia, pc81_cgmforn, pc81_cgmresp, pc81_datini, pc81_datfin, pc81_obs, a.z01_nome as z01_nome, b.z01_nome as z01_nome1,pc81_tipopart","","pc81_sequencia = " . $pc81_sequencia));
