  ...
  if (isset($chavepesquisa) && trim($chavepesquisa) != "" && $liberaaba == "false") {
    ...
    if ($clpcproc->numrows > 0) {
      ...
      if ($oSolicitacao->pc10_solicitacaotipo != 5) {
        ...
        echo "<script>location.href='com1_solicitanovo005.php';</script>";
        exit;
      }
    }
  }
  ...
  if (isset($param) && trim($param) == "") {
    ...
    if ($clpcprocitem->numrows > 0) {
      ...
      if ($iTipoSolicitacao == TIPO_SOLICITACAO_REGISTRO_PRECO) {
        ...
        db_msgbox(_M('patrimonial.compras.com1_solicitanovo005.erro_processo_vinculado_mais_um_item_solicitacao_tipo_registro_de_preco', $oStdMensagemErro));
      } else {
