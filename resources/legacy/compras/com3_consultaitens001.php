		...
		<form name="form1" method="post" action="com3_conssolic002.php">
				...
				if ($solicitacao == "1") {
					...
					for ($i = 0; $i < $numrows_itensdotac; $i++) {
						...
						if ($clpcdotac->numrows > 0) {
							...
							echo "  <tr>\n";
							echo "    <td colspan='4' align='center'  bgcolor='#CCCCCC'>";
							db_ancora("Clique aqui para ver dotações do item $pc11_codigo", "js_verdotac($pc11_codigo,$pc01_codmater,$numero)", 1);
							echo "</td>\n";
							echo "  </tr>\n";
						}
			...
			?>
						...
						<table border="0">
							<tr>
								<td align="center">
									<h3><strong>Essa solicitação não esta em processo licitatório.</strong></h3>
								</td>
							</tr>
						</table>
			<?
