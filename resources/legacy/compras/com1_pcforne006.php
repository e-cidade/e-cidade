...
if (isset ($chavepesquisa)) {
  ...
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_pcfornecon.location.href='com1_pcfornecon001.php?db_opcaoal=33&pc63_numcgm=".@ $pc60_numcgm."';
         parent.document.formaba.pcfornemov.disabled=false;
         CurrentWindow.corpo.iframe_pcfornemov.location.href='com1_pcfornemov001.php?db_opcaoal=33&pc62_numcgm=".@ $pc60_numcgm."';
         parent.document.formaba.pcfornecert.disabled=false;
         CurrentWindow.corpo.iframe_pcfornecert.location.href='com1_pcfornecert001.php?db_opcaoal=33&pc61_numcgm=".@ $pc60_numcgm."';
         parent.document.formaba.subgrupo.disabled=false;
         CurrentWindow.corpo.iframe_subgrupo.location.href='com1_pcfornesub001.php?db_opcao=3&pc76_pcforne=".@ $pc60_numcgm."';
         parent.document.formaba.pcfornereprlegal.disabled=false;
         CurrentWindow.corpo.iframe_pcfornereprlegal.location.href='com1_pcfornereprlegal001.php?db_opcaoal=3&pc81_cgmforn=".@ $pc60_numcgm."';
