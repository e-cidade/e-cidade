...
function js_pesquisaIsencao(mostra){
 js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_isencao','func_sepultamentoisencao.php?funcao_js=parent.js_mostraisencao1|cm33_sequencial','Pesquisa',true);
}
