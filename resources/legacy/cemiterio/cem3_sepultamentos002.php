...
$db_opcao        = 3;
$result          = $clsepultamentos->sql_record($clsepultamentos->sql_query($sepultamento,"cm01_c_livro, cm01_i_folha, cm01_i_registro, cm01_i_medico, cm01_i_causa, cm04_c_descr, cm01_c_local, cm01_c_cartorio, cm01_i_hospital, cgm1.z01_nome as nome_hospital ,cm01_i_funeraria, cgm2.z01_nome as nome_funeraria, cm01_i_declarante, cgm3.z01_nome as nome_declarante, cgm4.z01_nome as cm32_nome"));
