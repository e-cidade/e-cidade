...
if(isset($excluir)){
  db_inicio_transacao();
  $db_opcao = 3;
  $clquadracemit->excluir($cm22_i_codigo);
  db_fim_transacao();
...
if(isset($cm22_i_codigo) && $cm22_i_codigo != ""){
?>
 <script>
  parent.document.formaba.a2.disabled=false;
  CurrentWindow.corpo.iframe_a2.location.href='cem1_lotecemit001.php?cm23_i_quadracemit=<?=$cm22_i_codigo?>';
 </script>
 <?
 }
?>
