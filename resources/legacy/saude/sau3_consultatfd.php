...
if(isset($alterar)) {
  db_redireciona('tfd4_pedidotfdnovo.php?chavepesquisa='.$tf28_i_pedidotfd);
}
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
      <fieldset style='width: 75%;'> <legend><b>Consulta TFD</b></legend>
	      <?
        require_once("forms/db_frmconsultatfd.php");
        ?>
      </fieldset>
    </center>
	</td>
