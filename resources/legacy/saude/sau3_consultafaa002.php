  ...
  <div class="subcontainer" style="width: 99%;">
    <fieldset>
      ...
      <?php
        ...
        $oTabDetalhes->add("abaEmitirFAA", "Emitir FAA", "javascript:void(0)");
        $oTabDetalhes->add("abaExames", "Exames", "sau3_requisicaoexames001.php?iProntuario={$oGet->iProntuario}");
        $oTabDetalhes->add("abaMovimentacao", "Movimentação", "func_movimentacaofaa.php?iProntuario={$oGet->iProntuario}");
        $oTabDetalhes->add("abaProcedimentos", "Procedimentos", "sau3_procedimentosfaa.php?iProntuario={$oGet->iProntuario}");
        $oTabDetalhes->add("abaTriagem", "Triagem", "sau3_triagensfaa.php?iProntuario={$oGet->iProntuario}&iCgs={$oGet->iCgs}");
        $oTabDetalhes->show();
      ?>
    </fieldset>
  </div>
...
document.getElementById('abaEmitirFAA').onclick = function() {  js_marcaTab(this);this.blur();js_emitirFaa() }
