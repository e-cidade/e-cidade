...
<table valign="top" marginwidth="0" width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td height="100%" align="left" valign="top" bgcolor="#CCCCCC">
   <?
   $clcriaabas->identifica = array("a1"=>"Procedimentos","a2"=>"Diagnóstico", 'a3' => 'Receita', 'a4'=>'Encaminhamentos', "a5" => "Requisição de Exame");
   $clcriaabas->sizecampo  = array("a1"=>"20","a2"=>"30","a3"=>"30", 'a4' => '30', 'a5' => '30');
   $clcriaabas->src        = array("a1"=>"sau4_consultamedica001.php","a2"=>"","a3"=>"", 'a4' => '');
   $clcriaabas->disabled   = array("a2"=>"true","a3"=>"true", "a5"=> "true");
