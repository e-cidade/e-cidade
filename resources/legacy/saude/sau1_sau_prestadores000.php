...
<table valign="top" marginwidth="0" width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td height="100%" align="left" valign="top" bgcolor="#CCCCCC">
   <?php
   $clcriaabas->identifica  = array( "a1" => "Prestadores", "a2" => "Vínculos", "a3" => "Horários" );
   $clcriaabas->sizecampo   = array( "a1" => "20", "a2" => "30", "a3" => "30" );
   $clcriaabas->src         = array( "a1" => "{$arquivo}", "a2" => "sau1_sau_prestadorvinculos001.php", "a3" => "sau1_sau_prestadorhorarios001.php" );
