...
/**
 * Se o formul?io for carregado pela m?ulo do e-Social
 * deve dar manuten?o apenas em avalia?es do tipo e-Social
 */
...
if (isset($chavepesquisa)) {
    ...
    echo "<script>
          ...
          parent.corpo.iframe_avaliacaolista.location.href=sUrl;
        </script>";
