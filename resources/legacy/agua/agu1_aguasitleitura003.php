...
include("classes/db_aguasitleitura_classe.php");
...
if(isset($excluir)){
  ...
  db_fim_transacao();
   ...
   $db_opcao = 3;
   $result = $claguasitleitura->sql_record($claguasitleitura->sql_query($chavepesquisa));
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include("forms/db_frmaguasitleitura.php");
	?>
    </center>
	</td>
  </tr>
