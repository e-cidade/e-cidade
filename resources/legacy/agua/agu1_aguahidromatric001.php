 ...
 */
  ...
  if (isset($incluir)) {
    ...
    if ($sql_erro == false) {
      ...
      db_query("alter table agualeitura disable trigger tr_agua_atualizaultimaleitura;");
      db_query("alter table agualeitura disable trigger tr_agua_atualizaultimaleitura_beforedelete;");
      db_query("alter table agualeitura disable trigger tr_agua_calculaconsumo;");
      db_query("alter table agualeitura disable trigger tr_agua_calculasaldoposterior;");
      ...
      db_query("alter table agualeitura enable trigger tr_agua_atualizaultimaleitura;");
      db_query("alter table agualeitura enable trigger tr_agua_atualizaultimaleitura_beforedelete;");
      db_query("alter table agualeitura enable trigger tr_agua_calculaconsumo;");
      db_query("alter table agualeitura enable trigger tr_agua_calculasaldoposterior;");
    }
