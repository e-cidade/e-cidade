...
if(isset($alterar)){
  ...
  db_fim_transacao();
   ...
   $db_opcao = 2;
   $result = $claguacortematnumpre->sql_record($claguacortematnumpre->sql_query($chavepesquisa));
...
if(isset($alterar)){
  if($claguacortematnumpre->erro_status=="0"){
    $claguacortematnumpre->erro(true,false);
    $db_botao=true;
    echo "<script> document.form1.db_opcao.disabled=false;</script>  ";
    if($claguacortematnumpre->erro_campo!=""){
    ...
    $claguacortematnumpre->erro(true,true);
  };
};
if($db_opcao==22){
