    ...
    echo "
      <script>
        function js_db_libera(){
           ...
           CurrentWindow.corpo.iframe_aguabaseresp.location.href='agu1_aguabaseresp001.php?db_opcaoal=33&x14_matric=" . @$x01_matric . "';
           parent.document.formaba.aguabasecorresp.disabled=false;
           CurrentWindow.corpo.iframe_aguabasecorresp.location.href='agu1_aguabasecorresp001.php?db_opcaoal=33&x32_matric=" . @$x01_matric . "';
           //parent.document.formaba.aguabasecar.disabled=false;
           //CurrentWindow.corpo.iframe_aguabasecar.location.href='agu1_aguabasecar001.php?db_opcaoal=33&x30_matric=" . @$x01_matric . "';
           parent.document.formaba.aguaconstr.disabled=false;
           //CurrentWindow.corpo.iframe_aguaconstr.location.href='agu1_aguaconstr001.php?db_opcaoal=33&x11_codconstr=" . @$x01_matric . "';
           CurrentWindow.corpo.iframe_aguaconstr.location.href='agu1_aguaconstr001.php?db_opcaoal=33&x11_matric=" . @$x01_matric . "';
           parent.document.formaba.aguabasevenc.disabled=false;
           CurrentWindow.corpo.iframe_aguabasevenc.location.href='agu1_aguabasevenc001.php?db_opcaoal=33&x27_matric=" . @$x01_matric . "';
           parent.document.formaba.histocorrencia.disabled=false;
           CurrentWindow.corpo.iframe_histocorrencia.location.href='agu1_histocorrencia001.php?db_opcaoal=33&ar25_matric=" . @$x01_matric . "';
         ";
         if (isset($liberaaba)) {
