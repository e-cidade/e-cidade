...
if($nexclui == true){
  db_msgbox("Não será possível EXCLUIR a Leitura ($chavepesquisa). Existem leituras posteriores!");
  echo "<script>location.href = 'agu1_agualeitura006.php';</script>";
}
if(isset($x04_matric)){
  echo "
        <script>
          CurrentWindow.corpo.iframe_anteriores.location.href = 'agu3_agualeitura002.php?matric=$x04_matric';
	</script>
       ";
}
?>
