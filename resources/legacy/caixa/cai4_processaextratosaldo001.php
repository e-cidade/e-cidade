  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_contabancaria','func_contabancaria.php?funcao_js=parent.js_mostracontabancaria1|db83_sequencial|db83_descricao','Pesquisa',true,'20');
     ...
     if(document.form1.k86_contabancaria.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_contabancaria','func_contabancaria.php?tp=1&pesquisa_chave='+document.form1.k86_contabancaria.value+'&funcao_js=parent.js_mostracontabancaria','Pesquisa',false);
     }else{
