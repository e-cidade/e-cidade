  ...
  <script>
    ...
    function js_loadTable(resposta){
      ...
      for (i = 0; i < objJ.length; i++) {
        ...
        "   <td nowrap id='chk"+i+"'     align='center' > <input type='hidden' name='objJSON"+i+"' id='objJSON"+i+"' value='"+objJ[i].toSource()+"' > " + 
        ...
        if ( objJ[i].classe == 'pendente' || objJ[i].classe == 'normal' ) {
          ...
          "             onclick='js_justificativaAutenticacao(\"tabLinha"+i+"\", \"objJSON"+i+"\", "+ iCaixaLinha +", " + iAutenticacao + ", \"" + objJ[i].data + "\");' /> ";
        }
        tabela+="   </td>"+
        " </tr>  ";
      }
     ...
     */ 
    function js_justificativaAutenticacao(sIdLinha, sIdJsonElemento, iCaixaLinha, iAutenticacao, sDataConciliacao ) {
      ...
      sConteudoJanela     += '       onclick="js_salvarJustificativa('+sIdJsonElemento+', \'ctnrTextArea\', ' + iCaixaLinha + ', ' + iAutenticacao + ', \''+ sDataConciliacao + '\');" />';
      sConteudoJanela     += '</center>';
      sConteudoJanela     += '</div>';
     ...
     */
    function js_salvarJustificativa(sIdJsonElemento, sIdJustificativa, iCaixaLinha, iAutenticacao, sDataConciliacao) {
      ...
      oIdJsonElemento.value        = oJsonEstrutura.toSource();
      oWindowAux.destroy();
       ...
       */
       ...
       var oAjax   = new Ajax.Request("cai4_processaconciliacao.php",{
         ...
         parameters   : {
           ...
           sDataConciliacao    : sDataConciliacao,
