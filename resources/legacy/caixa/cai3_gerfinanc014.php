...
$sSqlPagamentos .= "        arrematric.k00_matric,j34_quadra,j34_lote,j04_quadraregimo,j04_loteregimo,                                    ";
...
$sSqlPagamentos .= "        left join iptubase            on iptubase.j01_matric                = arrematric.k00_matric                  ";
$sSqlPagamentos .= "        left join lote                on iptubase.j01_idbql                 = lote.j34_idbql                         ";
$sSqlPagamentos .= "        left join iptubaseregimovel   on iptubaseregimovel.j04_matric       = arrematric.k00_matric                  ";
...
$rsPagamentos    = db_query($sSqlPagamentos) or die($sSqlPagamentos);
...
$pdf->cell(10,04,"Quadra"     ,1,0,"C",0);
$pdf->cell(10,04,"Lote"       ,1,0,"C",0);
$pdf->cell(10,04,"Q.R.I"      ,1,0,"C",0);
$pdf->cell(10,04,"L.R.I"      ,1,0,"C",0);
$pdf->cell(15,04,"Inscr"      ,1,0,"C",0);
$pdf->cell(15,04,"Exerc"      ,1,0,"C",0);
$pdf->cell(15,04,"Venc"       ,1,0,"C",0);
$pdf->cell(30,04,"Descrição"  ,1,0,"C",0);
...
foreach ($aPagamentos as $oPagamento) {
  ...
  $pdf->Cell(10,04,$oPagamento->j34_quadra,0,0,"C",0);
  $pdf->Cell(10,04,$oPagamento->j34_lote,0,0,"C",0);
  $pdf->Cell(10,04,$oPagamento->j04_quadraregimo,0,0,"C",0);
  $pdf->Cell(10,04,$oPagamento->j04_loteregimo,0,0,"C",0);
  ...
  $pdf->Cell(30,04,$oPagamento->k01_descr  ,0,0,"L",0);
