...
$cllista      = db_utils::getDao("lista");
$cllistadeb   = db_utils::getDao("listadeb");
$cllistatipos = db_utils::getDao("listatipos");
$clusuarios   = db_utils::getDao("db_usuarios");
$clarretipo   = db_utils::getDao("arretipo");
$clBairros    = db_utils::getDao("bairro");
$clRuas       = db_utils::getDao("ruas");
$clZonas      = db_utils::getDao("zonas");
...
if (!empty($oGet->iQtdParcAtrasoIni) AND !empty($oGet->iQtdParcAtrasoFim)) {
  $sWhereParcelas .= " BETWEEN {$oGet->iQtdParcAtrasoIni} AND {$oGet->iQtdParcAtrasoFim} \n";
