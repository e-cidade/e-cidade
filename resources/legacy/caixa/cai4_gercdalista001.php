...
require_once ("classes/db_pardivultcodcert_classe.php");
...
try {
	  ...
	  if ($linhasperm > 0) {
	    ...
	    $sqltipo .= " where k60_codigo = {$k60_codigo} and k60_instit = {$instit}; ";
	    ...
	    if ($campos!="") {
	      ...
	      $sql = "select * from (select  distinct v01_coddiv,
	                                ...
	                                where k60_codigo = {$k60_codigo} and cadtipo.k03_tipo = 5 and lista.k60_instit = {$instit}
	                          union
