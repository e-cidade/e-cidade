                    ...
                    <?
                      if ($db21_codcli == 19985) {
                        ...
                        if (in_array($oInstit->getCodigoCliente(), $codInstituicao)) {
                            ...
                            $oldDate = new DateTime(date('Y-m-d', db_getsession("DB_datausu")));
                            ...
                            $k00_dtoper     = $oldDate->format('Y-m-d');
                            $k00_dtoper_dia = substr($newDate->format('Y-m-d'), 8);
                            $k00_dtoper_mes = substr($newDate->format('Y-m-d'), 5, 2);;
                            $k00_dtoper_ano = substr($newDate->format('Y-m-d'), 0, 4);
