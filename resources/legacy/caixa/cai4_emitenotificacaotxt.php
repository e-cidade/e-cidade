...
for($indx=0;$indx < $numrows; $indx++) {
    ...
    if ($lServicoArDigital) {
        $notificacao->nomeDestinatario = $z01_nome;
        $notificacao->nomeLogradouroDestinatario = $z01_ender;
        $notificacao->numeroLogradouro = $z01_numero;
        $notificacao->bairroDestinatario = $z01_bairro;
