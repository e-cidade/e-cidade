...
if(isset($excluir)){
  db_inicio_transacao();
  $db_opcao = 3;
  $clcontroleextvlrtransf->excluir($k168_codprevisao,$k168_mescompet);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 3;
   $result = $clcontroleextvlrtransf->sql_record($clcontroleextvlrtransf->sql_query($chavepesquisa,$chavepesquisa1)); 
...
if(isset($excluir)){
  if($clcontroleextvlrtransf->erro_status=="0"){
    ...
    $clcontroleextvlrtransf->erro(true,true);
  }
}
if($db_opcao==33){
