...
$clrotulo->label('bi07_qtdlivros');
$clrotulo->label('bi07_tempo');
...
function js_mostraleitor(chave1, chave2, chave3, erro) {
  ...
  if (erro == true) {
    ...
    document.form1.bi18_devolucao.disabled         = true;
    document.form1.bi18_devolucao.style.background = "#DEB887";
