...
if(isset($alterar)){
  if($clconsideracoes->erro_status=="0"){
    ...
    if($clconsideracoes->erro_campo!=""){
      echo "<script> document.form1.".$clconsideracoes->erro_campo.".style.backgroundColor='#99A9AE';</script>";
      echo "<script> document.form1.".$clconsideracoes->erro_campo.".focus();</script>";
    }
  }else{
