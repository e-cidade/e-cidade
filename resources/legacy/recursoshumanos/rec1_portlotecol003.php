...
if (isset($oPost->incluir)) {
  ...
  if ($oPost->selTipoPortaria == "l") {
        ...
        $iCodido = $oAssentamento->getCodigo();
		  }
      ...
      if (!empty($db_cadattdinamicovalorgrupo)) {
          ...
          $oDaoAssentaAttr->h80_assenta                     = $iCodido;      
          $oDaoAssentaAttr->h80_db_cadattdinamicovalorgrupo = $iSequencialGrupo;
          $oDaoAssentaAttr->incluir($iSequencialGrupo, $iCodido);
        }

        $clportariaassenta->h33_assenta  = $iCodido;
