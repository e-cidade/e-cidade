...
if(isset($alterar)){
  db_inicio_transacao();
  $db_opcao = 2;
  $clrhestagiocurricular->alterar($h83_sequencial);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 2;
   $result = $clrhestagiocurricular->sql_record($clrhestagiocurricular->sql_query($chavepesquisa, "rhestagiocurricular.*,cgm.z01_nome,cgmsupervisor.z01_nome as z01_nome_supervisor")); 
