...
function js_pesquisarh01_regist(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhestagioagenda.php?funcao_js=parent.js_mostrarhpessoal1|h57_regist|z01_nome','Consulta Matrícula',true);
  }else{
     if(document.form1.rh01_regist.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhestagioagenda.php?regist='+document.form1.rh01_regist.value+'&funcao_js=parent.js_mostrarhpessoal','Consulta Matrícula',false);
     }else{
...
function js_montaQuery(){
   ...
   if (($F('h64_dataini') == '' || $F('h64_datafim') == '') && $F('rh01_regist') == ''){
      ...
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_resultado','rec3_rhestagioavaliacoes002.php?'+strQuery,'Resultado da Consulta',true);
