...
function js_emite(){
  ...
  qry += "&tipo=" + document.form1.qual_tipo.value;
  jan = window.open('rec2_meiodiaassentafast002.php'+qry,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
}
