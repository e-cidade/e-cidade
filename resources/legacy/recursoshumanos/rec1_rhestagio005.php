...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clrhestagio->alterar($h50_sequencial);
  ...
  db_fim_transacao($sqlerro);
   ...
   $db_opcao = 2;
   $db_botao = true;
   $campos = "rhestagio.*,reprova.h12_assent as descr_reprova, aprova.h12_assent as descr_aprova";
   $result = $clrhestagio->sql_record($clrhestagio->sql_query_assenta($chavepesquisa, $campos));
   db_fieldsmemory($result,0);
   $h12_assent2 = $descr_reprova;
   $h12_assent  = $descr_aprova;
}
?>
<html>
<head>
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_rhestagiocriterio.location.href='rec1_rhestagiocriterio001.php?h52_rhestagio=".@$h50_sequencial."';
     ";
         if(isset($liberaaba)){
