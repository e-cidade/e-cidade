...
<html>
  ...
  function js_pesquisaServidor(mostra){
    ...
    if( mostra == true ){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhpessoal.php?funcao_js=parent.js_mostraServidor1|rh01_regist|z01_nome&sAtivos=A','Pesquisa',true);
    }else{

      if($F('rh126_regist') != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_rhpessoal','func_rhpessoal.php?pesquisa_chave='+$F('rh126_regist')+'&funcao_js=parent.js_mostraServidor&sAtivos=A','Pesquisa',false);
      }else{
        $('z01_nome').value = '';
      }
    }
