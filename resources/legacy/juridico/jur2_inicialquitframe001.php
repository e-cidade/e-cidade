...
if(isset($iniciais)){
  ...
  echo "
  <script>
  jan = window.open('{$sProgramaRelatorio}?dadosini=$dadosini&sTipoPeticao=inicialquitada&{$peticao}', '', 'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
