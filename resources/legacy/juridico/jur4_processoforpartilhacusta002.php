...
$sWherePartilha .= "                                    where cancrecibopaga.k134_numnov = processoforopartilhacusta.v77_numnov) else true end) ";

$sSqlProcessoForoPartilhaCusta = $clprocessoforopartilhacusta->sql_query(null," v77_processoforopartilha,v76_tipolancamento", $sOrderPartilha,$sWherePartilha);
...
if ($clprocessoforopartilhacusta->numrows > 0) {
  ...
  if ( $oPartilha ->v76_tipolancamento == 1) {
    ...
    $sStyleProcessar = "disabled='disabled' ";
    $db_opcao        = 3;
    $situacao        = "Emitido";
...
if (isset($incluir)) {
  ...
  try {
    ...
    db_msgbox("Cadastro Efetuado com Sucesso !!");
...
if (isset($alterar)) {
  ...
  try {
    ...
    db_fim_transacao(false);
    db_msgbox("Alteração Efetuado com Sucesso !!");
    db_redireciona("jur4_processoforopartilhacusta001.php");    
...
<center>
  <form name="form1" method="post" action="" onsubmit="return js_valida();">
      ...
      <table border="0" width="100%" align="left" >
        ...
        <tr>
          ...
          <td align="left">
            ...
            ?>
            <?
              if ($v76_tipolancamento == "1") {
                $v76_tipolancamento = "Automático";
                db_input("v76_tipolancamento",  30, "",  true, "text", $db_opcao, "");
              } else {
       ...
       <div id="ctnCustas">
          ...
          <table border="0" width="100%" align="left" >
           <!--  <tr>
              ...
              <td align="left">
                <?
                //  db_input("valor_debito",  30, "",  true, "text", 3, "");
                ?>
              </td>
            </tr>  --> 
           <?php 
             if ( count($aTaxas) > 0 ) {
               ...
               db_msgbox("Não foram encontradas taxas configuradas para a regra de emissão do convênio. \n Configure !!.");
               db_redireciona("jur4_processoforopartilhacusta001.php");
             }
    ...
    <?php if ($v76_tipolancamento == 3 || $v76_tipolancamento == 2) { ?>
...
function js_valida(){
  ...
  if (iLancamento == 3 && $F("v76_obs").trim() == "") {
	  alert("Campo observação obrigatório quando tipo lançamento for igual a isento");
	  $("v76_obs").focus();
	  return false;
	}

	if (iLancamento == 2 && $F("v76_dtpagamento").trim() == "") {
		alert("Campo Data do Pagamento obrigatório quando tipo lançamento for igual a manual");
