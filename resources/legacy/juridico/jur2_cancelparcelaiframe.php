...
if(isset($iniciais)){
  ...
  for($s=0; $s < sizeof($matriz); $s++){
    ...
    if($inicial!=""){
      ...
      if($numrows==0){
        db_redireciona("jur2_cancelaparcela.php?testini=false");
      }
      ...
      if($numrows==0){
        db_redireciona("jur2_cancelaparcela.php?codforo=false");
      }
      $sql="
  ...
  echo "
  <script>
  jan = window.open('jur2_geradoc.php?dadosini=$dadosini&cancelparcela=true','','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
  //location.href='jur2_cancelaparcela.php';
  </script>";  
}
...
function js_pesquisar(inicial){
  location.href="jur2_cancelaparcela.php?v50_inicial="+inicial;
}
...
<b>CANCELA PARCELAMENTO EM ANDAMENTO</b>
</td>
</tr>  
<tr>
...
<?
//          die($clinicial->sql_query_sitpar("","cgm.z01_nome,v50_inicial,v52_descr,v53_descr,v54_descr","v50_inicial",""));
