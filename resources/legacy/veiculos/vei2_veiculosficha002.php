...
$result_itensobrig=$clveicitensobrig->sql_record($clveicitensobrig->sql_query(null,"distinct(ve08_descr)",null,"ve09_veiculos=$veiculo and ve10_veicitensobrig is null"));
...
$result_utilizacao=$clveicutilizacao->sql_record($clveicutilizacao->sql_query(null,"distinct(ve14_descr)",null,"ve15_veiculos=$veiculo"));
...
$result_combustiveis = $clveiculoscomb->sql_record($clveiculoscomb->sql_query(null,"distinct ve06_padrao,ve26_descr",null,"ve06_veiculos = $veiculo"));
