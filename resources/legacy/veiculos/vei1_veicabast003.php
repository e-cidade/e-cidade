...
if(isset($excluir)){
    ...
    $result = $clveicabastposto->sql_record($clveicabastposto->sql_query(null,"ve71_codigo",null,"ve71_veicabast =$ve70_codigo"));
    db_fieldsmemory($result,0);

    if($sqlerro==false){
        $clveicabastpostoempnota->excluir(null,"ve72_veicabastposto =$ve71_codigo");
