...
<head>
    ...
    <script>
        function js_emite(){
            ...
            query += "ve62_veiccadtiposervico="+obj.ve62_veiccadtiposervico.value;

            if (query != ""){
                query += "&";
            }

            query += "pc60_numcgm="+obj.pc60_numcgm.value;
    ...
    <form name="form1" method="post" action="">
        ...
        <tr>
            <td nowrap title="<?=@$Tve62_veiccadtiposervico?>">
                <?
                db_ancora(@$Lve62_veiccadtiposervico,"js_pesquisave62_veiccadtiposervico(true);",1);
                ?>
            </td>
            <td>
                <?
                db_input('ve62_veiccadtiposervico',10,$Ive62_veiccadtiposervico,true,'text',1,
