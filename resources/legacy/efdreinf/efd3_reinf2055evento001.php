...
<body bgcolor=#CCCCCC>
    <form action="">
        <fieldset style="margin-top:50px;">
            <legend>Consulta do evento R-2055 Aquisição de produção rural</legend>
...
<script>
    function js_showGrid() {
        ...
        oGridEvento.setCellWidth(new Array("30%", "8%","8%", "8%", "8%", "8%","10%", "10%", "10%","10%"));
        oGridEvento.setHeader(new Array("CPF/CNPJ Produtor","Valor Bruto","Valor CP", "Valor GILRAT","Valor Senar","Detalhes","Protocolo","Data Envio","Status","Mensagem retorno"))
    ...
    function js_getEventos() {
        ...
        oParam.exec = "getConsultarEvento2055";
