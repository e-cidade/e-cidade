...
<body bgcolor=#CCCCCC>
    <form action="">
        <fieldset style="margin-top:50px;">
            <legend>Consulta do evento R-4099 Fechamento/Reabertura dos eventos </legend>
...
<script>
    function js_showGrid() 
    {
        ...
        oGridEvento.setCellAlign(new Array("Center", "Center","Center", "Center", "Center", "Center", "Center", "Center", "Left"));
        oGridEvento.setCellWidth(new Array("5%", "7%", "7%","5%", "20%", "10%", "10%", "10%", "40%"));
        oGridEvento.setHeader(new Array("Código","Mês Competência","Ano Competência","Tipo","Responsável","Data Envio","Nº Recibo", "Status", "Mensagem Retorno"))
    ...
    function js_retornogetEventos(oAjax)
    {
        ...
        if (oRetornoEventos.iStatus == 1) {
            ...
            var seq = 0;
            oRetornoEventos.efdreinfr4099.each(function(oLinha, iLinha) {
