...
<body bgcolor=#CCCCCC>
    <form action="">
        <fieldset style="margin-top:50px;">
            <legend>Consulta do evento R-4010 pessoa física </legend>
...
<script>
    function js_showGrid() 
    {
        ...
        oGridEvento.setHeader(new Array("CPF Beneficiário","OP","Nat Rendimento","Data PG","Valor Bruto","Valor Base", "Valor IRRF","Status","Mensagem retorno","Protocolo","Data Envio",))
    ...
    function js_getEventos() 
    {
        ...
        oParam.exec     = "getConsultarEvento4010";
