...
<script>
    //Responsável (CPF+Nome), Serviços CP, Produção Rural
    function js_showGrid() 
    {
        ...
        oGridEvento.setHeader(new Array("Código","Mês Competência","Ano Competência","Tipo","Responsável","Serviços CP", "Produção Rural","Data Envio","Nº Recibo", "Status", "Mensagem Retorno"))
