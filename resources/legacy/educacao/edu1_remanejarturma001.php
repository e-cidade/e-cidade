...
if ( isset( $processar ) ) {
  ...
  for ($e = 0; $e < $linhas; $e++) {
    ...
    for ($i = 0; $i < $linhasregencia; $i++) {    	
      ...
      $clregencia->ed59_lancarhistorico      = $ed59_lancarhistorico;
      $clregencia->ed59_caracterreprobatorio = $ed59_caracterreprobatorio;
      $clregencia->ed59_basecomum            = $ed59_basecomum;
