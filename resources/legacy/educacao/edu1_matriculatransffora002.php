...
<html>
  ...
  <form name="form1" METHOD="POST" action="">
    <br>
    <fieldset style="width:95%;height:450"><legend><b>Importação de Aproveitamento - Aluno: <?=$ed56_i_aluno?> - <?=$ed47_v_nome?></b></legend>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
        <td colspan="5" valign="top" bgcolor="#CCCCCC">
         <br>
         <b>
          ATENÇÃO! O sistema irá importar da origem e transportar o aproveitamento do aluno para a turma atual,<br>
          somente dos períodos que não estejam em branco na turma de origem.
        </b>
        <br><br>
      </td>
    </tr>
...
function js_processar() {
  ...
  if(msggeral!=""){
    ...
    if(confirm(msggeral+"\n\nConfirmar importação para este aluno?")){
...
if(isset($incluir)) {
  ...
  /**
   * Cria o diário de classe do aluno na nova turma.
   * assim não precisaso validar se turma de origem te menos periodos de avaliação que o destino
   */
  ...
  for ($x=0; $x < count($periodos); $x++) {
    ...
    for ($r = 0; $r < count($regencias); $r++) {
      ...
      /**
       * Faz toda essa mão para garantir que o código do periodo de origem é o código periodo
       * da avaliação vinculado a regencia de origem
       */
       ...
       * sobrescrevendo a variável $periododestino
       */
      ...
      /**
       * Busca o código do diário de classe do aluno na regencia de ORIGEM
       */
      ...
      // inclui diário do aluno para regencia na nova turma
      if ($cldiario->numrows == 0) {
      ...
      // Inclui diário final se não houver
      ...
      /**
       * Valida se a avaliação precisa ser convertida
       */
      $ed72_c_convertido = "N";
      ...
      /**
       * Valida se tem avaliação para importar;
       * Se houver uma avaliação no periodo na origem, altera a escola de origem
       */
      $ed72_i_escola = $escola;
      $ed72_c_tipo   = "M";
      ...
      /**
       * Verifica se há avaliação no destino
       */
