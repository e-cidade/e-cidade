...
/**
 * Verifica se frequência da turma é Individual e trás todas as disciplinas
 * ou se a frequência é Globalizada e trás apénas a disciplina que controla a frenquência
 * @param  {integer} iTurma
 * @param  {integer} iEtapa
 */
function buscaDisciplina( iTurma, iEtapa ) {
  ...
  oDisciplina.clear();
  oDisciplina.setSomenteDisciplinasGlobais( lTemDisciplinaGlobal );
