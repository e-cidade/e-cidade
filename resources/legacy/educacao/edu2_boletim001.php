        ...
        <table border="0" align="left">
            ...
            <td colspan="3">
              <table border="0" align="left">
                <tr>
                  ...
                  <td valign='bottom'>
                    <input type="checkbox" name="inativos" value="" <?= @$inativos == "yes" ? "checked" : "" ?>> Somente alunos inativos
          ...
          ?>
            ...
            <tr>
              <td valign="top">
                <?
                $result_proced = $clturma->sql_record(
              ...
              <td align="center">
                ...
                <table border="0">
                  <tr>
                    <td>
                      <input name="incluirum" title="Incluir" type="button" value=">" onclick="js_incluir();" style="border:1px outset;border-top-color:#f3f3f3;border-left-color:#f3f3f3;
               background:#cccccc;font-size:12px;font-weight:bold;width:30px;height:15px;padding:0px;" disabled>
                  ...
                  <tr>
                    <td>
                      <input name="incluirtodos" title="Incluir Todos" type="button" value=">>" onclick="js_incluirtodos();" style="border:1px outset;border-top-color:#f3f3f3;border-left-color:#f3f3f3;background:#cccccc;
               font-size:12px;font-weight:bold;width:30px;height:15px;padding:0px;" <?= $linhas == 0 ? "disabled" : "" ?>>
                  ...
                  <tr>
                    <td>
                      <input name="excluirum" title="Excluir" type="button" value="<" onclick="js_excluir();" style="border:1px outset;border-top-color:#f3f3f3;border-left-color:#f3f3f3;
               background:#cccccc;font-size:12px;font-weight:bold;width:30px;height:15px;padding:0px;" disabled>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <input name="excluirtodos" title="Excluir Todos" type="button" value="<<" onclick="js_excluirtodos();" style="border:1px outset;border-top-color:#f3f3f3;border-left-color:#f3f3f3;
               background:#cccccc;font-size:12px;font-weight:bold;width:30px;height:15px;padding:0px;" disabled>
                    </td>
                  </tr>
                </table>
            ...
            $sSql = $clprocresultado->sql_query(
              "",
              $sCampos,
              "",
            ...
            if ($clprocresultado->numrows > 0) {
              ...
              $sCampos      = "ed37_c_tipo,ed37_i_menorvalor,ed37_i_maiorvalor,ed37_c_minimoaprov";
              $result_proc1 = $clprocavaliacao->sql_record(
                $clprocavaliacao->sql_query(
                  "",
                  $sCampos,
            ...
            ?>
              <tr>
                <td colspan="3">
                  ...
                  $sql2   .= "               case ";
                  $sql2   .= "                when ed43_i_codigo>0 then 'R' end as tipo ";
              ...
              <tr>
                <td colspan='3'>
                  ...
                  <input type="checkbox" id="assinaturaregente" name="assinaturaregente" value="" checked> <b>Imprimir assinatura do professor</b><br>
                </td>
              </tr>
            <?
            } else {
            ...
            <tr>
              <td valign="top" colspan="3">
                <?
                $resultobs = $clobsboletim->sql_record($clobsboletim->sql_query("", "ed252_t_mensagem", "", " ed252_i_escola = $escola"));
                if ($clobsboletim->numrows > 0) {
                ...
                ?>
                <b>Mensagem do Boletim:</b><br>
                <? db_textarea('obs', 2, 110, 0, true, 'text', @$db_opcao, "", "", "", 240) ?><br>
              </td>
            </tr>
            <tr>
              <td align="center" colspan="3">
                <? if (trim($ed37_c_tipo) == "PARECER") { ?>
                  ...
                  <input name="pesquisar" type="button" id="pesquisar" value="Processar" onclick="js_pesquisa2(document.form1.subgrupo.value);" disabled>
...
<script>
  ...
  function js_pesquisa(turma) {
    ...
    jan = window.open(sUrlBoletim + '?padraotipo=' + document.form1.padraotipo.value + '&grade=' + grade +
      ...
      '&periodo=' + document.form1.periodo.value + '&turma=' + turma + '&obs1=' + document.form1.obs.value, '',
  ...
  function js_pesquisa2(turma) {
    ...
    jan = window.open(sUrlBoletim + '?padraotipo=' + document.form1.padraotipo.value +
      ...
      '&alunos=' + alunos + '&obs1=' + document.form1.obs.value, '',
      'width=' + (screen.availWidth - 5) + ',height=' + (screen.availHeight - 40) + ',scrollbars=1,location=0 ');
