...
if( $oPost->sAction == 'PesquisaEtapaDivisao' ) {
  ...
  $sCampos = "DISTINCT ed223_i_codigo, ed11_i_codigo, ed11_i_codcenso, ed11_c_descr, ed223_i_ordenacao, ed266_c_descr";
  ...
  $sSql    = $clserieregimemat->sql_query_turma( "", $sCampos, "ed223_i_ordenacao", $sWhere );
