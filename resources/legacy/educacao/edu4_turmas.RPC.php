...
try {
  ...
  switch($oParam->exec) {
    ...
    case 'salvarTrocaTurmaSemRegistro':
      ...
      if ( isset($oParam->iMatricula) && isset($oParam->iTurmaDestino) && !$oRetorno->lProcedimentosInconsistentes ) {
     ...
     * Se o parâmetro lSomenteComAlunosMatriculados estiver setado, retorna somente turmas com alunos matriculados
     */
    ...
    case 'periodosCompoemResultado':
      ...
      foreach ($oProcedimentoAvaliacao->getResultados() as $oElementoResultado) {
        ...
        if ( $oElementoResultado->geraResultadoFinal() ) {
          $oResultadoFinal = $oElementoResultado;
          break;
        }
      }

      if ( is_null($oResultadoFinal)) {
