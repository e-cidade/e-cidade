...
try {
    switch ($oParam->exec) {
        case 'buscarAvaliacao':
            ...
            $formularioId = $configuracao->getFormulario(Tipo::getConst($oParam->Tipo));
        ...
        case 'salvarAvaliacao':
            ...
            $oAvaliacaoESocial->salvar($iCodigoGrupoPerguntas, "lotacaoTributaria");
