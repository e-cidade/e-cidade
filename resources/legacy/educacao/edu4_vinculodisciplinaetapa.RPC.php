...
try {
  ...
  switch ($oParam->exec) {
    ...
    case 'getEtapasBase':
      ...
      $sWhere = " ed77_i_escola = {$iEscola} ";
      if ( isset($oParam->iEscola)) {
        $sWhere = " ed77_i_escola = {$oParam->iEscola} ";
      }

      $sWhere       .= " and ed31_i_codigo = {$oParam->iBase} ";
      ...
      $sSqlBaseSerie = $oDaoBaseSerie->sql_query(null, $sCampos, null, $sWhere);
