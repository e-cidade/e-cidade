...
function js_processar( inicio, fim ) {
  ...
  regequiv = "";
  sepreg   = "";
  msgreg   = "Atenção:\nAs informações das seguintes disciplinas não serão transportadas, pois as mesmas não contêm disciplinas equivalentes na turma de destino:\n\n";
  regnull  = false;
  ...
  perequiv = "";
  sepper   = "";
  msgper   = "Atenção:\nAs informações dos seguintes períodos de avaliação não serão transportadas, pois os mesmos não contêm períodos de avaliação equivalentes na turma de destino:\n\n";
  pernull  = false;
  ...
  foreach ( $aRegencias as $sRegencia ) {
    ...
    if ( $iTotalDiarioTurmaIgual > 0 ) {
        ...
        for ( $z = 0; $z < $iLinhasExclusao; $z++ ) {
          ...
          $oDaoDiarioResultadoRecuperacao->excluir( null, "ed116_diarioresultado in( select ed73_i_codigo
