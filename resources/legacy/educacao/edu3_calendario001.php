...
<?
 ...
 $result = $clcalendario->sql_record($clcalendario->sql_query("","extract(month from ed52_d_inicio) as minimo,extract(month from ed52_d_fim) as maximo,ed52_i_ano,ed52_d_inicio,ed52_d_fim",""," ed52_i_codigo = $calendario"));
 ...
 <table width="97%" border="1" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   ...
   <td colspan="4" bgcolor="#f3f3f3" align="right" style="font-size:16px;font-weight:bold;" valign="top"> Total &nbsp;&nbsp;&nbsp;<?=$contgeral?></td>
  </tr>
  <tr>
