 ...
 ?>
  <script>
   ...
   parent.document.formaba.a6.disabled = false;
    ...
    CurrentWindow.corpo.iframe_a2.location.href = 'edu1_disciplinaetapa001.php?' + sParametros;
   ...
   CurrentWindow.corpo.iframe_a4.location.href = sHRefAbaAluno;
   ...
   CurrentWindow.corpo.iframe_a6.location.href = 'edu1_outrosprofissionaisturma001.php?iTurma=<?=$ed57_i_codigo?>' ;
  </script>
 <?
}
?>
  ...
  ?>
   <script>
    ...
    CurrentWindow.corpo.iframe_a5.location.href = 'edu1_parecerturma001.php?ed105_i_turma=<?=$ed57_i_codigo?>'+
                                        '&ed57_c_descr=<?=$ed57_c_descr?>&ed52_c_descr=<?=$ed52_c_descr?>';
    CurrentWindow.corpo.iframe_a6.location.href = 'edu1_outrosprofissionaisturma001.php?iTurma=<?=$ed57_i_codigo?>' ;
    CurrentWindow.corpo.iframe_a1.location.href = 'edu1_turma002.php?chavepesquisa=<?=$ed57_i_codigo?>';
   </script>
  <?
 }
}
