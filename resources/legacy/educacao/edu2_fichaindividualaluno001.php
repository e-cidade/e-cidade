...
function js_pesquisa(turma) {
 ...
 jan = window.open('edu2_fichaindividualaluno002.php?calendario='+document.form1.grupo.value+
       '&alunos='+alunos+'&sObs='+document.form1.sObs.value+'&incluirobs&iAssinaturaAdicional='+$F('ed20_i_codigo')+
       '&lExibeAssinaturaProfessor='+$F('lExibeAssinaturaProfessor')+'&iAtividade='+oCboAtividades.getValue(),'',
...
function js_pesquisa2(turma) {
 ...
 jan = window.open('edu2_fichaindividualaluno003.php?punico='+punico+
		 '&disciplinas='+disciplinas+
         '&turma='+turma+
         '&alunos='+alunos+'&obs1='+document.form1.sObs.value+'&incluirobs&iAssinaturaAdicional='+$F('ed20_i_codigo')+
         '&lExibeAssinaturaProfessor='+$F('lExibeAssinaturaProfessor')+'&iAtividade='+oCboAtividades.getValue(),'',
         'width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
