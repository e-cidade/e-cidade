...
switch ($oParam->exec) {
  ...
  case 'getDatasProfessorDisciplina':
    ...
    try {
      ...
      /**
       * Criamos uma collection de com os feriados cadastrados para o(s) Calendarios que o Professor está vinculado.
       */
      ...
      for ($iDia = 0; $iDia <= $oDadosAnoLetivo->numero_dias_aula; $iDia++) {
        ...
        /**
         * Carregamos apenas as datas iguais  ou anteriores ao dia da sessão.
         */
