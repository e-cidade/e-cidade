...
$campos = "ed100_i_codigo,
           ...
           ed100_basecomum
          ";
$result = $oDaoHistMpsDiscFora->sql_record($oDaoHistMpsDiscFora->sql_query("","$campos"," ed100_basecomum desc, ed100_i_ordenacao"," ed100_i_historicompsfora = $ed100_i_historicompsfora"));
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
 <tr class='titulo'>
  <td colspan="8"><?=pg_result($result,0,'ed11_c_descr')?> - <?=pg_result($result,0,'ed29_c_descr')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
