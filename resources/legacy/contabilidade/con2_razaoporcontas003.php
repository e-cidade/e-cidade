...
$sSqlBuscaLancamentos .= "      select distinct c61_reduz,";
...
$sSqlBuscaLancamentos .= "             case when c71_coddoc = 980";
$sSqlBuscaLancamentos .= "                then c28_tipo";
$sSqlBuscaLancamentos .= "                else (case when c69_debito = conplanoreduz.c61_reduz";
$sSqlBuscaLancamentos .= "                then 'D'";
$sSqlBuscaLancamentos .= "                  else 'C'";
$sSqlBuscaLancamentos .= "                end) end as tipo";
...
$sSqlBuscaLancamentos .= "             left  join contacorrentedetalheconlancamval on c28_conlancamval = c69_sequen";
