...
for ($linha = 51; $linha <= 76; $linha++) {
  ...
  /**
   * Somamos os valores de edição manual
   */
  $oLinhaRelatorio = new linhaRelatorioContabil($iCodigoRelatorio, $linha);
  $oLinhaRelatorio->setPeriodo($iCodigoPeriodo);
...
$aReceitas[25]["label"] = "          1.4.5-(-) Deduções da Receita de IRRF";
 ...
 * Transferencias
 */
$aReceitas[44]["label"] = "5 - RECEITA DE TRANSFERÊNCIAS DO FNDE";
...
// Cabecalho de receitas
  $pdf->cell(90,($alt*2),"RECEITA RESULTANTES DE IMPOSTOS (caput do art. 212 da Constituição)",'TBR',0,"C",0);
...
//  $pdf->addpage();
 // $pdf->cell(190,($alt*2),'Continuação '.($pdf->PageNo()-1)."/{nb}",0,1,"R",0);
  ...
  $sNotaPadrao .= "inclusive relativos à complementação da União recebidos nos termos do §1º do art. 6º desta Lei, poderão ser";
  $sNotaPadrao .= "utilizados no 1º trimestre do exercício imediatamente subseqüente, mediante abertura de crédito adicional\".\n";
  $sNotaPadrao .= "3 Caput do art. 212 da CF/1988\n";
  $sNotaPadrao .= "4 Os valores referentes à parcela dos Restos a Pagar inscritos sem disponibilidade financeira ";
  $sNotaPadrao .= "vinculada à educação deverão ser informados somente no RREO do último bimestre do exercício.\n";
  $sNotaPadrao .= "5 Limites mínimos anuais a serem cumpridos no encerramento do exercício, no âmbito de atuação ";
  $sNotaPadrao .= "prioritária, conforme LDB, art. 11, V.";
