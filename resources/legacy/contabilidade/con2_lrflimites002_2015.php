...
if ($pessoal == 'true') {
  ...
  /*
   * Instância da classe do relatório 89 para cálculos da despesa pessoal.
   */
...
$sDescricaoPrefeitura   = "MUNICÍPIO DE " . strtoupper($munic) . " - {$oInstituicaoPrefeitura->getUf()} - ";

if ($temcamara == true && ($temprefa == true || $temadmind == true)) {
  $head2 = $sDescricaoPrefeitura . "PODERES EXECUTIVO E LEGISLATIVO";
}

if ($temcamara == true && $temprefa == false && $temadmind == false) {
  $head2 = $sDescricaoPrefeitura . "PODER LEGISLATIVO";
}

if ($temprefa == true && $temcamara == false && $temadmind == false) {
  $head2 = $sDescricaoPrefeitura . "PODER EXECUTIVO/ADM. INDIRETA";
}
