...
function js_relatorio1() {
  ...
  jan = window.open('con2_emitenotificprevia002.php?edital='+document.form1.d01_codedi.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  jan.moveTo(0,0);
