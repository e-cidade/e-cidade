...
<script>
 ...
 function js_pesquisa(){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_conlancamsup','func_conlancamsup.php?funcao_js=parent.js_preenchepesquisa|c79_codsup','Pesquisa',true);
  }
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table border="0">
    <tr>
      <td nowrap><? db_ancora("Codigo da suplementação",'js_pesquisa();',1); ?> </td>
	...
	if (isset($codigo) && ($codigo!="")){
	   $txt_where=" c79_codsup=$codigo  ";
	   if ($data1!="") {
               $txt_where.=" and c79_data >= '$data1' and c79_data <='$data2' ";
	   }
	} else {
	   $txt_where ="";
	}
	if ($txt_where!=""){
          $sql="select c69_data,
              ...
              from conlancamsup
                  inner join conlancamval on c69_codlan  = c79_codlan
