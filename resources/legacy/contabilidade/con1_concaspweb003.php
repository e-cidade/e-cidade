...
if(isset($excluir)){
    db_inicio_transacao();
    $db_opcao = 3;
    $clvinculocaspweb->excluir($c232_estrutecidade,$c232_estrutcaspweb,$c232_anousu);
    db_fim_transacao();
}else if(isset($chavepesquisa)){//
    $db_opcao = 3;
    $result = $clvinculocaspweb->sql_record($clvinculocaspweb->sql_query($chavepesquisa,$chavepesquisa1));
