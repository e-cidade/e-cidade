...
if (!isset($arqinclude)){
  ...
  switch($bimestre){
    ...
    case 1:
      ...
      break;  
    case 2:
      $txt   .= " - BIMESTRE ".strtoupper(db_mes('03'))." - ".strtoupper(db_mes('04')); 
      break;  
    case 3:
...
$param[1]  = $orcparamrel->sql_parametro('27','1', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[2]  = $orcparamrel->sql_parametro('27','2', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[3]  = $orcparamrel->sql_parametro('27','3', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[4]  = $orcparamrel->sql_parametro('27','4', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[5]  = $orcparamrel->sql_parametro('27','5', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[6]  = $orcparamrel->sql_parametro('27','6', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[7]  = $orcparamrel->sql_parametro('27','7', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[8]  = $orcparamrel->sql_parametro('27','8', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[9]  = $orcparamrel->sql_parametro('27','9', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[10] = $orcparamrel->sql_parametro('27','10', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[11] = $orcparamrel->sql_parametro('27','11', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[12] = $orcparamrel->sql_parametro('27','12', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[13] = $orcparamrel->sql_parametro('27','13', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[14] = $orcparamrel->sql_parametro('27','14', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[15] = $orcparamrel->sql_parametro('27','15', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[16] = $orcparamrel->sql_parametro('27','16', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[17] = $orcparamrel->sql_parametro('27','17', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[18] = $orcparamrel->sql_parametro('27','18', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
//deducoes
$param[19] = $orcparamrel->sql_parametro('27','19', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[20] = $orcparamrel->sql_parametro('27','20', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
$param[21] = $orcparamrel->sql_parametro('27','21', 'f', str_replace('-', ', ', $db_selinstit), $anousu - 1,false);
...
$rec[12][0] = "    Cota-Parte do IPVA";
$rec[13][0] = "    Cota-Parte do ITR";
$rec[14][0] = "    Transferências da LC 87/1996";
$rec[15][0] = "    Transferências da LC 61/1989";
$rec[16][0] = "    Transferências do FUNDEB";
$rec[17][0] = "    Outras Transferências Correntes";
$rec[18][0] = "  Outras Receitas Correntes";

// - Deduções
$rec[19][0] = "    Contrib.Plano Prev.Assist.Social Servidor";
$rec[20][0] = "    Compensação Financ. entre Regimes Previd.";
$rec[21][0] = "    Deduções da Receitas para Formação do FUNDEB";

// gera matris com todos os estruturais selecionados nas configurações do relatorio
$m_todos = $orcparamrel->sql_parametro('27',"","f",str_replace("-",",",$db_selinstit),$anousu,false);
$virgula='';
$lista = '(';
$tt = sizeof($m_todos);
...
// busca os estruturais que o usuário selecionou nos parametros
$param[1]  = $orcparamrel->sql_parametro('27','1', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[2]  = $orcparamrel->sql_parametro('27','2', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[3]  = $orcparamrel->sql_parametro('27','3', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[4]  = $orcparamrel->sql_parametro('27','4', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[5]  = $orcparamrel->sql_parametro('27','5', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[6]  = $orcparamrel->sql_parametro('27','6', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[7]  = $orcparamrel->sql_parametro('27','7', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[8]  = $orcparamrel->sql_parametro('27','8', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[9]  = $orcparamrel->sql_parametro('27','9', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[10] = $orcparamrel->sql_parametro('27','10', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[11] = $orcparamrel->sql_parametro('27','11', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[12] = $orcparamrel->sql_parametro('27','12', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[13] = $orcparamrel->sql_parametro('27','13', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[14] = $orcparamrel->sql_parametro('27','14', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[15] = $orcparamrel->sql_parametro('27','15', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);

$param[16] = $orcparamrel->sql_parametro('27','16', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[17] = $orcparamrel->sql_parametro('27','17', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[18] = $orcparamrel->sql_parametro('27','18', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[19] = $orcparamrel->sql_parametro('27','19', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[20] = $orcparamrel->sql_parametro('27','20', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
$param[21] = $orcparamrel->sql_parametro('27','21', 'f', str_replace('-', ', ', $db_selinstit), $anousu,false);
...
if (!isset($arqinclude)){
  ...
  for ($x=1;$x<=21;$x++){ // 18 é a qtd de parametros existentes
  ...
  $pdf->ln();
  // ----------------------------------------------------------------
  notasExplicativas(&$pdf, 27,"{$bimestre}B",280); 
  $pdf->ln(15);
