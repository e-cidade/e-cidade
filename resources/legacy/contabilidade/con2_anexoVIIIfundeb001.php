...
<table width="790" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
            <center>
                <?
                $clcriaabas->identifica = array("g1"=>"Rel. Fundeb Anexo VIII");
                $clcriaabas->title      = array("g1"=>"Rel. Fundeb Anexo VIII");
                $clcriaabas->src        = array("g1"=>"con2_anexoVIIIfundeb011.php");
