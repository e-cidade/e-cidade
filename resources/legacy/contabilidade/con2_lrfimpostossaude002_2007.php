...
$desp['1']['funcao'] = $orcparamrel->sql_funcao('10', '14');
...
$desp['2']['funcao'] = $orcparamrel->sql_funcao('10', '16');
...
$desp['3']['funcao'] = $orcparamrel->sql_funcao('10', '17');
...
$desp['4']['funcao'] = $orcparamrel->sql_funcao('10', '19');
...
$desp['5']['funcao'] = $orcparamrel->sql_funcao('10', '20');
...
$desp['6']['funcao'] = $orcparamrel->sql_funcao('10', '21');
...
$desp_p[1]['funcao'] = $orcparamrel->sql_funcao('10', '23');
...
$desp_p[2]['funcao'] = $orcparamrel->sql_funcao('10', '24');
...
$desp_p[3]['funcao'] = $orcparamrel->sql_funcao('10', '25');
...
$desp_p[4]['funcao'] = $orcparamrel->sql_funcao('10', '26');
...
$desp_p[5]['funcao'] = $orcparamrel->sql_funcao('10', '27');
...
if (!isset($arqinclude)){  
 ...
 $pdf->cell(20, $alt, "Até ".$txtper, "TBL", 0, "C", 0);
 $pdf->cell(20, $alt, "% (e/desp saúde)", "LTB", 1, "C", 0);
 ...
 $pdf->cell(110, $alt, "(-)RP INSCRITOS NO EXERCÍCIO SEM DISPONIBILIDADE FINANCEIRA DE REC.PROPRIOS VINCULADOS", "0", 0, "L", 0);
 $pdf->cell(20, $alt, '-', "L", 0, "R", 0);
 $pdf->cell(20, $alt, '-', "L", 0, "R", 0);
 
 $pdf->cell(20, $alt, db_formatar($VARIAVEL_COMPENSACAO, 'f'), "L", 0, "R", 0);
 ...
 $pdf->cell(110, $alt, "CONTROLE DE RESTOS A PAGAR INSCRITOS EM EXERCÍCIOS ", "RT", 0, "C", 0);
 $pdf->cell(80, $alt, "RESTOS A PAGAR", "BTL", 1, "C", 0);
 
 $pdf->cell(110, $alt, "ANTERIORES VINCULADOS A SAÚDE", "", 0, "C", 0);
 $pdf->cell(60, $alt, "Inscritos em 31 de dezembro de ", "L", 0, "C", 0);
 $pdf->cell(20, $alt, "Cancelados em ", "L", 1, "C", 0);

 $pdf->cell(110, $alt, "", "B", 0, "C", 0);
 $pdf->cell(60, $alt, ($anousu -1), "BL", 0, "C", 0);
 $pdf->cell(20, $alt, $anousu." (h)", "LB", 1, "C", 0);
 
 $pdf->cell(110, $alt, "RP DE DESPESA PRÓPRIAS COM AÇÕES E SERVIÇOS", "R", 0, "L", 0);
 $pdf->cell(60, $alt, "", "L", 0, "C", 0);
 $pdf->cell(20, $alt, "", "L", 1, "C", 0);
 
 $pdf->cell(110, $alt, "PÚBLICOS DE SAÚDE", "RB", 0, "L", 0);
 $pdf->cell(60, $alt, db_formatar($soma_vlr_inscritos, 'f'), "BL", 0, "R", 0);
 $pdf->cell(20, $alt, db_formatar($soma_vlr_cancelados, 'f'), "LB", 1, "R", 0);
 
 
 $pdf->Ln(2);
 
 @$t_participacao = (($total_V_atebim)/$total_I_atebim)*100;
