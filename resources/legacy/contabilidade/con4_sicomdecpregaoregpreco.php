...
if (isset($_POST['btnSalvar'])){
    ...
    $oRoot  = $oDOMDocument->createElement('decpregaoregprecos');
  	...
  	$iUltimoCodigo = $oRow->getAttribute("codigo");
  	   ...
  	   */
		  ...
		  $oDOMDocument->save($sArquivo);
			if (filesize($sArquivo) > filesize("legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomdecpregaoregpreco.xml")/2) {
		    system("cp $sArquivo legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomdecpregaoregpreco.xml");
		  }
			echo"
  ...
  if (!$oDado) {
  	...
  	unset($_POST['btnSalvar']);
  	$oDado  = $oDOMDocument->createElement('decpregaoregpreco');
  	$oDado->setAttribute("instituicao", db_getsession("DB_instit"));
...
<table width="790" border="0" cellpadding="0" cellspacing="0" bgcolor="#5786B2">
  <tr>
    ...
    <center>
	<?
	include("forms/frmsicomdecpregaoregpreco.php");
	?>
    </center>
	</td>
  </tr>
