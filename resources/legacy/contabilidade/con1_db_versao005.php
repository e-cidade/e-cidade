...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $cldb_versao->alterar($db30_codver);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_db_versaocpd.location.href='con1_db_versaocpd001.php?db33_codver=".@$db30_codver."';
         parent.document.formaba.db_versaousu.disabled=false;
         CurrentWindow.corpo.iframe_db_versaousu.location.href='con1_db_versaousu001.php?db32_codver=".@$db30_codver."';
         parent.document.formaba.db_versaotarefa.disabled=false;
         CurrentWindow.corpo.iframe_db_versaotarefa.location.href='con1_db_versaotarefa_001.php?db29_codver=".@$db30_codver."';
          parent.document.formaba.db_versaoclientes.disabled=false;
         CurrentWindow.corpo.iframe_db_versaoclientes.location.href='con1_db_versaoclientes_001.php?db29_codver=".@$db30_codver."';
     ";
         if(isset($liberaaba)){
