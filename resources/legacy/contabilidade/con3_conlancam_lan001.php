...
<script>
 ...
 function js_pesquisa(){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_conlancamlan','func_conlancamlan.php?funcao_js=parent.js_preenchepesquisa|c70_codlan','Pesquisa',true);
 }
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table border="0">
    <tr>
      <td nowrap><? db_ancora("Codigo do Lançamento",'js_pesquisa();',1); ?> </td>
      <td><?  db_input("codigo",12,"",true,'text',1);   ?> </td>
    </tr>

    <tr>
      <td nowrap> Valor </td>
      <td><?  db_input("valor",12,"",true,'text',1);  ?>
        <i>* pesquisa todos os lançamentos que contenham este valor !   </i>  </td>
    </tr>
	...
	//
	   ...
	   $txt_where = "c69_valor = $valor  ";
	} else if (isset($codigo) && ($codigo!="")){
	   $txt_where=" c69_codlan=$codigo  ";
	} else if ($data1!=""){
           $txt_where=" c69_data >= '$data1' and c69_data <='$data2'  ";
	} else {
	   $txt_where ="";
	}
	...
	if ($txt_where!=""){
		     ...
		     r2.c61_instit
              from conlancamval
                  ...
                  inner join conplanoreduz r1 on  r1.c61_anousu=".db_getsession("DB_anousu")." and r1.c61_reduz = c69_debito and r1.c61_instit = ".db_getsession("DB_instit")."
                  inner join conplano c1 on c1.c60_codcon =r1.c61_codcon and c1.c60_anousu =r1.c61_anousu

                  inner join conplanoreduz r2 on r2.c61_anousu=".db_getsession("DB_anousu")." and r2.c61_reduz = c69_credito and r1.c61_instit = ".db_getsession("DB_instit")."
	   ...
	   echo "*** Clique sobre o Lançamento para ver outros dados.<br>";
