...
for($x=1;$x<=21;$x++){
    ...
    $m_rec[$x][1]     = 0 ; // previsão atualizada
    $m_rec[$x][2]     = 0 ; // arrecadado no bimestre
    $m_rec[$x][3]     = 0 ; // arrecadado ate o bimestre
    $m_rec[$x][4]     = 0 ; // reservado para período no exercicio anterior       
...
$receitas_de_capital[1] = $m_rec[16][1]+$m_rec[17][1]+$m_rec[18][1]+$m_rec[19][1]+$m_rec[20][1]+$m_rec[21][1]; // previsão atualizada
...
$receitas_de_capital[4] = $m_rec[16][4]+$m_rec[17][4]+$m_rec[18][4]+$m_rec[19][4]+$m_rec[20][4]+$m_rec[21][4]; // reservado para período no exercicio anterior       
...
for($x=1;$x<=15;$x++){
  ...
  $receita_primaria_total[1] += $m_rec[$x][1]; // previsão atualizada
  $receita_primaria_total[2] += $m_rec[$x][2]; // arrecadado no bimestre
  $receita_primaria_total[3] += $m_rec[$x][3]; // arrecadado ate o bimestre
  $receita_primaria_total[4] += $m_rec[$x][4]; // reservado para período no exercicio anterior       

  $receita_primaria[1] += $m_rec[$x][1]; // previsão atualizada
  $receita_primaria[2] += $m_rec[$x][2]; // arrecadado no bimestre
  $receita_primaria[3] += $m_rec[$x][3]; // arrecadado ate o bimestre
  $receita_primaria[4] += $m_rec[$x][4]; // reservado para período no exercicio anterior       

}
$receita_primaria_total[1] -= $m_rec[9][1]; // previsão atualizada
$receita_primaria_total[2] -= $m_rec[9][2]; // arrecadado no bimestre
$receita_primaria_total[3] -= $m_rec[9][3]; // arrecadado ate o bimestre
$receita_primaria_total[4] -= $m_rec[9][4]; // reservado para período no exercicio anterior       

$receita_primaria[1] -= $m_rec[9][1]; // previsão atualizada
$receita_primaria[2] -= $m_rec[9][2]; // arrecadado no bimestre
$receita_primaria[3] -= $m_rec[9][3]; // arrecadado ate o bimestre
$receita_primaria[4] -= $m_rec[9][4]; // reservado para período no exercicio anterior       

$receita_primaria_total[1] += $m_rec[19][1]+$m_rec[20][1]+$m_rec[21][1]; // previsão atualizada
...
$receita_primaria_total[4] += $m_rec[19][4]+$m_rec[20][4]+$m_rec[21][4]; // reservado para período no exercicio anterior
...
if (!isset($arqinclude)){ 
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,($alt*2),"DESPESAS PRIMÁRIAS",'TB',0,"C",0);
  $pdf->cell(33,($alt*2),"DOTAÇÃO ATUALIZADA",'1',0,"C",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(2)."Juros e Encargos da Dívida(IX) ",'R',0,"L",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(2)."Inversões Financeiras",'R',0,"L",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(3)."Concessão de Emprestimos (XII)",'R',0,"L",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(3)."Aquisição de Título de Capital já Integralizado (XIII)",'R',0,"L",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(3)."Demais Inversões Financeiras",'R',0,"L",0);
  ...
  $pdf->setfont('arial','',6);
  $pdf->cell(65,$alt,espaco(2)."Amortização da Dívida (XIV)",'R',0,"L",0);
