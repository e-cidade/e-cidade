...
if (isset($_POST['btnSalvar'])){
    ...
    $oRoot  = $oDOMDocument->createElement('projatuarialrppsN');
  ...
  foreach ($oDados as $oRow) {
  	   ...
  	   */
		  ...
		  if (filesize($sArquivo) > filesize("legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomprojatuarialrpps.xml")/2) {
		    system("cp $sArquivo legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomprojatuarialrpps.xml");
		  }
			echo"
  ...
  if (!$oDado) {
  	...
  	$oDado  = $oDOMDocument->createElement('projatuarialrpps');
...
<table width="790" border="0" cellpadding="0" cellspacing="0" bgcolor="#5786B2">
  <tr>
    ...
    <center>
	<?
	include("forms/frmsicomprojatuarialrpps.php");
	?>
    </center>
	</td>
  </tr>
