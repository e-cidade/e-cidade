...
switch ($oParam->exec) {
  ...
  case "vincularReceita":
    ...
    if (!file_exists('legacy_config/sigfis/vinculoreceita.xml')) {
      ...
      $rsXML     = fopen('legacy_config/sigfis/vinculoreceita.xml', 'w');
      ...
      $oDomXML->load('legacy_config/sigfis/vinculoreceita.xml');
      ...
      if ($lAchouReceita) {
        ...
        $oDomXML->save('legacy_config/sigfis/vinculoreceita.xml');
      }
    }
    unlink($sLockFile);
    break;
