    ...
    <form name="form1" method="post" action="">
        ...
        <div style="margin-top: 50px; width: 700px;">
            ...
            <fieldset>
                ...
                <legend><strong>Manutenção de Saldo de Conta Corrente</strong></legend>
...
<script>
    var sUrlRPC = "con4_manutsaldocontacorrente.RPC.php";
...
//            }
    ...
    function js_habilitaBotao() {
        ...
        var nValorDistribuido = $("TotalForCol3").innerHTML;
    ...
    function js_retornoDetalhamento(oAjax) {
        ...
        if (oRetorno.aDados.length > 0) {
            ...
            oRetorno.aDados.each(function (oDado, iInd) {
                ...
                var nValorImplantado = oDado.nValorImplantado;
                var nValor = oDado.nValor;

                if (nValorImplantado == "") {
                    nValorImplantado = 0;
                }

                aRow[2] = eval("qtditemimp" + iInd + " = new DBTextField('qtditemimp" + iInd + "','qtditemimp" + iInd + "','" + nValorImplantado + "')");
                aRow[2].addStyle("text-align", "right");
                aRow[2].addStyle("height", "100%");
                aRow[2].addStyle("width", "100px");
                aRow[2].setReadOnly(true);
                aRow[2].addEvent("onBlur", "qtditemimp" + iInd + ".sValue=this.value;");
                aRow[2].addEvent("onChange", "js_somavaloresImp();");


                aRow[0] = oDado.iCodigo;
                aRow[1] = oDado.sConta.urlDecode();
                aRow[3] = eval("qtditem" + iInd + " = new DBTextField('qtditem" + iInd + "','qtditem" + iInd + "','" + nValor + "')");
                aRow[3].addStyle("text-align", "right");
                aRow[3].addStyle("height", "100%");
                aRow[3].addStyle("width", "100px");
    ...
    function js_criaGridDetalhamento() {
        ...
        oGridDetalhamento.setCellWidth(new Array('70px',
            '360px',
            '115px',
            '115px'
        ));
        ...
        oGridDetalhamento.setHeader(new Array('Código',
            'Descrição',
        'Saldo Implantado',
            'Saldo a Implantar'
    ))
