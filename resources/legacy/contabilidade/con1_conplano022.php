	...
	// se a conta tiver uma filha analitica, ela deve ser obrigatoriamente sintetica
      ...
      if ( $cortado == "" ){
  		...
  		if (isset ($bloqueada) && $bloqueada == 'true') {
  			echo "<script>
							                         CurrentWindow.corpo.document.formaba.reduzido.style.visibility='hidden';
							                         CurrentWindow.corpo.iframe_reduzido.disable='true';
							                 </script>";
  		} else {
	  		echo "<script>
						                         CurrentWindow.corpo.iframe_reduzido.disable='false';
						                         CurrentWindow.corpo.document.formaba.reduzido.style.visibility='visible';
						                 </script>";
  			echo "<script> CurrentWindow.corpo.iframe_reduzido.location.href='con1_conplano004.php?c60_codcon=$c60_codcon';</script>";
  		}
  	} else {
	  	echo "<script>
              CurrentWindow.corpo.iframe_reduzido.disable='false';
		          CurrentWindow.corpo.document.formaba.reduzido.style.visibility='visible';
  		        CurrentWindow.corpo.iframe_reduzido.location.href='con1_conplano004.php?c60_codcon=$c60_codcon';
