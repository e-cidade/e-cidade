...
$formulario =  Formulario::getById($_GET["formulario"]);
if (empty($formulario)) {
...
<body>
    <form class="container" style="width: 800px;">
        ...
        <br>
        <div id="btnsenviar">
            <label><strong>Ambientes:</strong></label>
            <select name="tipodeenvio" id="tipodeenvio">
...
<script>
    ...
    (function(exports) {
        ...
        function getUltimoGrupoResposta() {

            var iCodigoFormulario = oGet.formulario;
            var request = {
                'exec': 'getUltimoGrupoResposta',
                'formulario': iCodigoFormulario
            };
            var oAjaxRequest = new AjaxRequest(URL_RPC, request, montarUltimaResposta);
            oAjaxRequest.setMessage('Buscando dados do formulario...');
            oAjaxRequest.execute();
        }

        function montarUltimaResposta(oResponse, lErro) {
            getDadosFormulario(oResponse.codigoResposta);
        }
         ...
         */
        pesquisar = function(iCodigFormulario, instituicao, iTipo) {
            ...
            if (janelaCarregada) {
                ...
                pagina = 1
                janelaPesquisa.show();
                pesquisarDados(null, false, pagina, iCodigoFormulario, instituicao, iTipo);
                return;
            };
            ...
            $('btnProximaPagina').observe('click', function() {
                ...
                pesquisarDados($F('filtro'), false, pagina, iCodigoFormulario, instituicao, iTipo);
            });
            ...
            oDataGridDadosFormulario.setPesquisaConteudo(true);
            ...
            pesquisarDados(null, true, pagina, iCodigoFormulario, instituicao, iTipo);
        }
         ...
         */
        function pesquisarDados(data, buildGrid, pagina, iCodigoFormulario, instituicao, iTipo, sCampo = null) {
            ...
            request.send('api/v1/configuracao/formulario/' + iCodigoFormulario + '/instituicao/' + instituicao, {
                ...
                if (buildGrid) {
                    ...
                    for (field of data.data.fields) {
                        ...
                        if (field.identificador == 'id_grupo_resposta' || field.identificador == 'instituicao-no-ecidade') {
                            continue;
                        }
        ...
        pesquisarPorConteudo = function(data, iCodigoFormulario, instituicao, iTipo, sCampo) {
            pesquisarDados(data, false, 1, iCodigoFormulario, instituicao, iTipo, sCampo);
        };
