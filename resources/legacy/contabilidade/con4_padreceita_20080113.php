    ...
    for($i=1;$i<$clreceita_saldo_mes->numrows;$i++){
      ...
      if ($o70_anousu > 2007){
        $sql_orcreceita = "select o70_concarpeculiar 
                           from orcreceita
                                inner join orcfontes on orcfontes.o57_codfon = orcreceita.o70_codfon and
                                                        orcfontes.o57_anousu = orcreceita.o70_anousu
                           where orcreceita.o70_anousu = $anousu and 
                                 orcfontes.o57_fonte = $o57_fonte";
        $res_orcreceita = @pg_query($sql_orcreceita);
