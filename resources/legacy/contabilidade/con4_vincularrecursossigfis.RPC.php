...
switch ($oParam->exec) {
  ...
  case 'vincularRecursos' :
    ...
    if (!file_exists('legacy_config/sigfis/vinculorecursos.xml')) {
      ...
      $rsXMl      = fopen('legacy_config/sigfis/vinculorecursos.xml', 'w');
      ...
      $oDomXml->load('legacy_config/sigfis/vinculorecursos.xml');
      ...
      if ($lAchouRecurso) {
        ...
        $oDomXml->save('legacy_config/sigfis/vinculorecursos.xml');
      }
    }
    unlink($sLockFile);
    break;
