...
if((isset($HTTP_POST_VARS["db_opcao"]) && $HTTP_POST_VARS["db_opcao"])=="Incluir"){
  db_inicio_transacao();
    ...
    $db60_coddoc=$cldb_documentopadrao->db60_coddoc;
...
if($cldb_documentopadrao->erro_status=="0"){
  ...
  echo "<script>
          ...
          CurrentWindow.corpo.iframe_parag.location.href='con4_docpadrao003.php?db60_coddoc=$db60_coddoc';
          parent.mo_camada('parag');
        </script>";
  db_msgbox($erro_msg);
  echo "<script>CurrentWindow.corpo.iframe_doc.location.href='con4_docpadrao004.php?chavepesquisa=$db60_coddoc';</script>";
}
}
?>
