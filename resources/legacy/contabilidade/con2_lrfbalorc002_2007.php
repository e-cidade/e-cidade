...
$m_oper_int_mobiliaria = $orcparamrel->sql_parametro('15','39',"f",$instituicao,db_getsession("DB_anousu"));
...
$m_intraorcamentarias = $orcparamrel->sql_parametro('15','44',"f",$instituicao,db_getsession("DB_anousu")); // receitas intraorcamentarias
