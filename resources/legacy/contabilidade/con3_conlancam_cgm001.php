...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table border="0">
    <tr>
      <td nowrap><? db_ancora("CGM",'js_pesquisa();',1); ?> </td>
	...
	if (isset($codigo) && ($codigo!="")){
	   $txt_where=" c76_numcgm=$codigo  ";
	    if ($data1!="")
               $txt_where.="and  c76_data >= '$data1' and c76_data <='$data2'  ";
	} else {
	   $txt_where ="";
	}
	if ($txt_where!=""){
             $sql="select c69_data,
              ...
              from conlancamcgm
                  inner join conlancamval on c69_codlan  = c76_codlan
