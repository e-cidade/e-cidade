...
<tr>
 <td>
   ...
   <tr>
	...
	$cliframe_alterar_excluir->sql = $clorcparamrecursoval->sql_query(null,"*","o48_codrec", "o48_grupo=1 and o48_anousu=".db_getsession("DB_anousu"));
...
function js_pesquisarec(mostra){
     if(mostra==true){
       js_OpenJanelaIframe('CurrentWindow.corpo.iframe_p','db_iframe_rec','func_orctiporec.php?funcao_js=parent.js_mostrarec1|0|3','Pesquisa',true,'15');
     }else{
       js_OpenJanelaIframe('CurrentWindow.corpo.iframe_p','db_iframe_rec','func_orctiporec.php?pesquisa_chave='+document.form1.o48_codrec.value+'&funcao_js=parent.js_mostrarec','Pesquisa',false);
     }
}
