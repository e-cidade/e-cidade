...
require ("classes/db_infocomplementaresinstit_classe.php");
...
if (isset($incluir)) {
	...
	db_msgbox($sMsg);
  if ($cldb_config->erro_status=="0" || $clinfocomplementaresinstit->erro_status=="0") {
  	
  	$erro_campo = $cldb_config->erro_status=="0"?$cldb_config->erro_campo:$clinfocomplementaresinstit->erro_campo;
    $db_botao = true;
