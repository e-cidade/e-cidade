...
switch ($oParam->exec) {
    ...
    if (!file_exists('legacy_config/sigfis/vinculaorgaoresponsavel.xml')) {
      ...
      $rsXMl      = fopen('legacy_config/sigfis/vinculaorgaoresponsavel.xml', 'w');
      ...
      foreach ($aOrgaos as $oOrgaoAtual) {
        ...
        if ($iCodigoOrgao == $oParam->iCodigoOrgao) {
        	...
        	$oDomXml->save('legacy_config/sigfis/vinculaorgaoresponsavel.xml');
        	$lAchouOrgao = true;
          break;
        }
      }
