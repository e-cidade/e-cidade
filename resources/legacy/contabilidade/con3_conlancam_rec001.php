...
<script>
 ...
 function js_pesquisa(){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_conlancamrec','func_conlancamrec.php?funcao_js=parent.js_preenchepesquisa|c74_codrec','Pesquisa',true);
 }
...
<table width="790" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	if (isset($codigo) && ($codigo!="")){
	   $txt_where=" c74_codrec=$codigo and c74_anousu=$anousu ";
	   if ($data1!="")
              $txt_where.="and c74_data >= '$data1' and c74_data <='$data2'";
	} else {
	   $txt_where ="";
	}
	if ($txt_where!=""){
          $sql="select c69_data,
              ...
              from conlancamrec
                  inner join conlancamval on c69_codlan  = c74_codlan
