...
$db_opcao = 1;
   if(isset($d01_codedi) && $d01_codedi!=""){
     $result01 = $cleditalrua->sql_record($cleditalrua->sql_query("","d02_contri,d01_numero","","d02_codedi=$d01_codedi"));
     $numrows01=$cleditalrua->numrows;
     if($numrows01>0){
      db_fieldsmemory($result01,0);
     }else{
         db_redireciona("con3_conscontri001.php?edital=false&d01_codedi=$d01_codedi");
     }
  }
?>
  <html>
