  ...
  switch( $oParam->sExecucao ) {
     ...
     */
  	...
  	case 'getContasPcasp':
  	  ...
  	  /**
       * Abre o arquivo que se encontra salvo dentro de legacy_config/pcasp
  	   */
  	  $aVinculos = array();
  	  if ( file_exists( "legacy_config/pcasp/arquivo_vinculo_pcasp.txt" ) ) {

  	    $rArquivoVinculo = fopen( "legacy_config/pcasp/arquivo_vinculo_pcasp.txt", "r" );
