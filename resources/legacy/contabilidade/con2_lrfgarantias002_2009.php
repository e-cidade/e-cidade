...
if (substr($periodo,1,1) == "Q") {
	...
	$total_rcl = calcula_rcl2($anousu,$anousu.'-01-01',$anousu.'-08-31',$todasinstit,false,81);
  ...
  $total_rcl = calcula_rcl2($anousu,$anousu.'-01-01',$anousu.'-06-30',$todasinstit,false,81);
