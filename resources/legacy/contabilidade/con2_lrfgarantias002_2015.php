...
$head2 = "MUNICÍPIO DE " . strtoupper($munic) . " - " . strtoupper($uf);
$head3 = "RELATÓRIO DE GESTÃO FISCAL";
$head4 = "DEMONSTRATIVO DAS GARANTIAS E CONTRAGARANTIAS DE VALORES";
...
if (!isset($arqinclude)){
  ...
  $pdf->ln();
  $pdf->setfont('arial','b',7);
  $pdf->cell(110,$alt," RGF - ANEXO 3 (LRF, art. 55, inciso I, alínea \"c\" e art. 40, § 1º)",'B',0,"L",0);
  ...
  $aTotalizadores[9]["saldoanterior"]   = $aTotalizadores[7]["saldoanterior"] + $aTotalizadores[8]["saldoanterior"];
  $aTotalizadores[9]["primeiroperiodo"] = $aTotalizadores[7]["primeiroperiodo"] + $aTotalizadores[8]["primeiroperiodo"];
  $aTotalizadores[9]["segundoperiodo"]  = $aTotalizadores[7]["segundoperiodo"] + $aTotalizadores[8]["segundoperiodo"];
  $aTotalizadores[9]["terceiroperiodo"] = $aTotalizadores[7]["terceiroperiodo"] + $aTotalizadores[8]["terceiroperiodo"];
