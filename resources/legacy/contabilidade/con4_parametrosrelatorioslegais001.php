...
function js_editar_colunas(iCodRel, iLinha){
    ...
    oWindowColunas = new windowAux("windowColunas", "Configuração Padrao",iWidth, iHeight);
 ...
 function js_mostrafiltrousuario(iLinha, iRelatorio) {
   ...
   oWindowFiltroUsuario = new windowAux("windowFiltroUsuario", "Configuração Usuário", 1000, 600);
   ...
   var oMessageBoardUsuario = new messageBoard("msg1",
                                       "Configurações para linha "+
                                       $('descr'+iLinha+"_"+iRelatorio).innerHTML,
                                       'Informe contas para a linha, e vínculo com orçamento.',
  ...
  function js_mostrapadrao(iLinha, iRelatorio) {
   ...
   oWindowFiltroPadrao  = new windowAux("windowFiltrosPadrao", "Configuração Padrao", 1000, 600);
