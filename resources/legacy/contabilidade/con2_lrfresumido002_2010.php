...
if ($sSiglaPeriodo == "2S"|| $sSiglaPeriodo == "6B") {
  ...
  $oAnexoXI  = new AnexoXIRREO($anousu, 105, $bimestre);
  $oAnexoXI->setInstituicoes($instituicao);
    
  $oAnexoXIII = new AnexoXIIILRF($anousu, 106, $bimestre);
  $oAnexoXIII->setInstituicoes($instituicao);
    
  $oAnexoXIV  = new AnexoXIVRREO($anousu, 107, $bimestre);
...
if ($emite_resultado==1){
  ...
  include("con2_lrfnominal002_2010.php");    
...
if ($emite_mde==1) {
  ...
  if ($anousu == 2008) {
    ...
    include("con2_lrfmdefundeb002_2010.php");
  }
...
if ($emite_alienacao==1){
  ...
  $sele_work     = ' o70_instit in (' . str_replace('-',', ',$db_selinstit) . ')';
      ...
      $txtper     = "";
      $periodo    = $iCodigoPeriodo;
      include("con2_lrfimpostossaude002_2010.php"); 
