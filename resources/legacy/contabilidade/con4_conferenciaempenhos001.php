...
<table valign="top" marginwidth="0" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        <td align="center" valign="top">
            <form name='form1'>
                <fieldset>
                    <legend><b>Conferência de Empenhos</b></legend>
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <strong>Mês:</strong>
                                <input type="text" id="mesIni" maxlength="2" size="5" oninput="js_ValidaCampos(this,1,'Mês Início','t','f',event);"/>
                                <b>até</b>
                                <input type="text" id="mesFim" maxlength="2" size="5" oninput="js_ValidaCampos(this,1,'Mês Fim','t','f',event);"/>
                            </td>
                        </tr>
