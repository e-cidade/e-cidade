...
$sCaminhoMensagem  = "financeiro.contabilidade.con1_conplanoorcamento.";
  ...
  case 'getDadosContaOrcamento':
    ...
    $oRetorno->dados->c60_descr          = urldecode(utf8_encode($oContaOrcamento->getDescricao()));
    ...
    $oRetorno->dados->c60_finali        = urlencode(utf8_encode($oContaOrcamento->getFinalidade()));
