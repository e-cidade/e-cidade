 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_db_sysregrasacessocanc.location.href='con1_db_sysregrasacessocanc001.php?db_opcaoal=33&db49_idacesso=".@$db46_idacesso."';
         parent.document.formaba.db_sysregrasacessousu.disabled=false;
         CurrentWindow.corpo.iframe_db_sysregrasacessousu.location.href='con1_db_sysregrasacessousu001.php?db_opcaoal=33&db47_idacesso=".@$db46_idacesso."';
         parent.document.formaba.db_sysregrasacessoip.disabled=false;
         CurrentWindow.corpo.iframe_db_sysregrasacessoip.location.href='con1_db_sysregrasacessoip001.php?db_opcaoal=33&db48_idacesso=".@$db46_idacesso."';
     ";
         if(isset($liberaaba)){
