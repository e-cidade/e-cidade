...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clcadenderrua->alterar($db74_sequencial);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_cadenderbairrocadenderrua.location.href='con1_cadenderbairrocadenderrua001.php?db74_descricao=".@$db74_descricao."&db87_cadenderrua=".@$db74_sequencial."';
     ";
         if(isset($liberaaba)){
