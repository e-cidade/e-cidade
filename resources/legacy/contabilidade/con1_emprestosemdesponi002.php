...
if(isset($alterar)){
  db_inicio_transacao();
  $db_opcao = 2;
  $clemprestosemdesponi->alterar($c218_numemp,$c218_anousu);
  db_fim_transacao();
}else if(isset($chavepesquisa)){
   $db_opcao = 2;
   $result = $clemprestosemdesponi->sql_record($clemprestosemdesponi->sql_query($chavepesquisa,$chavepesquisa1)); 
