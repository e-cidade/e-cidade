...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $cldb_depusu->id_usuario=$id_usuario;
  $cldb_depusu->excluir($id_usuario);

  if($cldb_depusu->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $cldb_depusu->erro_msg;
  $cldb_usuarios->excluir($id_usuario);
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='con1_db_usuarios003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_db_depusu.location.href='con1_db_depusu001.php?db_opcaoal=33&id_usuario=".@$id_usuario."';
     ";
         if(isset($liberaaba)){
