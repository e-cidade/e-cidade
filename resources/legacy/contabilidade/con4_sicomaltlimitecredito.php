...
if (isset($_POST['btnSalvar'])){
    ...
    $oRoot  = $oDOMDocument->createElement('altlimitecreditos');
  ...
  foreach ($oDados as $oRow) {
  	...
  	$iUltimoCodigo = $oRow->getAttribute("codigo");
  	   ...
  	   */
		  ...
		  if (filesize($sArquivo) > filesize("legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomaltlimitecredito.xml")/2) {
		    system("cp $sArquivo legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomaltlimitecredito.xml");
		  }
			echo"
  ...
  if (!$oDado) {
  	...
  	$oDado  = $oDOMDocument->createElement('altlimitecredito');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include("forms/frmsicomaltlimitecredito.php");
	?>
    </center>
	</td>
  </tr>
