...
function js_relatorio(){
  ...
  for(i=0; i<form.usuariossel.length; i++){
    form.usuariossel.options[i].selected = true;
  }

  /*
  for(i=0; i<form.departamentossel.length; i++){
    form.departamentossel.options[i].selected = true;
  }
  */
