...
if ($uf == 'RO') {
  ...
  $db_filtro=" o70_codigo in (select o15_codigo from orctiporec where o15_codtri = '102') ";
}
...
if ($uf == 'RO') {
  ...
  $sele_work = " o58_codigo in (select o15_codigo from orctiporec where o15_codtri = '102') ";
}
