...
if ($uf == 'RO') {
  ...
  $db_filtro=" o70_codigo in (select o15_codigo from orctiporec where o15_codtri = '101') ";
}
...
if ($uf == 'RO') {
  ...
  $sele_work = " o58_codigo in (select o15_codigo from orctiporec where o15_codtri = '101') ";
}
...
$sSqlValorCP502 .= "   and e60_concarpeculiar = '995';";
...
$pdf->setfont('arial','',8);
$pdf->setX(20);
$pdf->cell(130,$alt,"Receitas Dedutoras FUNDEF/FUNDEB",0,0,"L");
$pdf->cell(40,$alt,db_formatar($plus_fundeb,'f'),0,1,"R");
/*
$pdf->setX(20);
