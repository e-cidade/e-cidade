...
if (isset($_POST['btnSalvar'])){
    ...
    $oRoot  = $oDOMDocument->createElement('limitecreditos');
  	...
  	$iUltimoCodigo = $oRow->getAttribute("codigo");
  	   ...
  	   */
		  ...
		  $oDOMDocument->save($sArquivo);
			if (filesize($sArquivo) > filesize("legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomlimitecredito.xml")/2) {
		    system("cp $sArquivo legacy_config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomlimitecredito.xml");
		  }
			echo"
  ...
  if (!$oDado) {
  	...
  	$oDado  = $oDOMDocument->createElement('limitecredito');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <center>
	<?
	include("forms/frmsicomlimitecredito.php");
	?>
    </center>
	</td>
  </tr>
