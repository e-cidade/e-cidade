...
$db_opcao = 1;
   if(isset($d02_contri) && $d02_contri!=""){
     $result01 = $cleditalrua->sql_record($cleditalrua->sql_query($d02_contri,"d02_contri,d01_numero"));
     $numrows01=$cleditalrua->numrows;
     if($numrows01>0){
         db_fieldsmemory($result01,0);
     }else{
         db_redireciona("con3_conscontri001.php?contri=false&d02_contri=$d02_contri");
     }
  }
?>
  <html>
