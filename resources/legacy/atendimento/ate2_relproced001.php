...
function js_emite(){
 ...
 if (data_fin < data_ini){
    ...
    jan = window.open('ate2_relproced002.php?&data='+data_ini+'&data1='+data_fin+'&tipo='+obj.tipo.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
    jan.moveTo(0,0);
  }
}  
</script>  
