...
<table width="60%">
    <tr>
   	   <td align="center"><br><br><font face="Arial, Helvetica, sans-serif"><strong>Relatório de Atendimentos</strong></font></td>
    </tr>
    <tr>
      <td><table width="100%">
  <tr>
...
?>
    ...
    <tr>
      <td align="center"><input name="consulta" type="button" value="Consulta" onClick="js_consulta()">
      </td>
      </tr>
  </table>
</form>
...
function js_relatorio(chave1){
  window.open('ate2_relatorio001.php?at02_codatend='+chave1+'&at03_id_usuario='+document.form1.at03_id_usuario.value+'&at01_codcli='+document.form1.at02_codcli.value,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
  db_iframe.hide();
}
