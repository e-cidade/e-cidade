...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clatendcadareamod->at26_sequencia=$at26_sequencial;
  $clatendcadareamod->excluir($at26_sequencial);

  if($clatendcadareamod->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clatendcadareamod->erro_msg;
  $clatendcadarea->excluir($at26_sequencial);
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='ate1_atendcadarea003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_atendcadareamod.location.href='ate1_atendcadareamod001.php?db_opcaoal=33&at26_sequencia=".@$at26_sequencial."';
     ";
         if(isset($liberaaba)){
