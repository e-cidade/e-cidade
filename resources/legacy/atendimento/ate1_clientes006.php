 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_atendemail.location.href='ate1_atendemail001.php?db_opcaoal=33&at12_codcli=".@$at01_codcli."';
         parent.document.formaba.clientesmodulos.disabled=false;
         CurrentWindow.corpo.iframe_clientesmodulos.location.href='ate1_clientesmodulos001.php?db_opcaoal=33&at74_sequencial=".@$at01_codcli."';
     ";
         if(isset($liberaaba)){
