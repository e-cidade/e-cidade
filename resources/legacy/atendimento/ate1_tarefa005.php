...
if(@$tipotar=='T' and @$chavepesquisa!=""){
  ...
  function js_db_libera(){
    ...
    CurrentWindow.corpo.iframe_tarefa.location.href='ate1_tarefa010.php?tarefa=".$chavepesquisa."';
  }
  js_db_libera();
  </script>\n
  ";
...
if (isset ($chavepesquisa)) {
  ...
  if($cltarefalog->numrows>0 and 1==2) {
    ...
    CurrentWindow.corpo.iframe_tarefalog.location.href='ate1_tarefalogand002.php?at43_tarefa=".@$at40_sequencial."&at43_usuario=".db_getsession("DB_id_usuario")."';
    ";		*/
  }
  //die($liberado);
  echo "
