...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clatendusucli->alterar($at80_codatendcli);
  ...
  echo "
        <script>
          function js_db_libera(){
            ...
            CurrentWindow.corpo.iframe_atendusucliitem.location.href='ate1_atendusucliitem001.php?at81_codatendcli=".@$at80_codatendcli."';
       ";
  if(isset($liberaaba)){
