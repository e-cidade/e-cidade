...
//include("classes/db_atenditemproc_classe.php");
...
include ("classes/db_atenditemsyscadproced_classe.php");
include ("classes/db_tarefasyscadproced_classe.php");
include ("classes/db_tarefacadmotivo_classe.php");
include ("classes/db_atenditemmotivo_classe.php");
include ("classes/db_atenditemtarefa_classe.php");
include ("classes/db_atenditemmenu_classe.php");
include ("classes/db_atendimentoversao_classe.php");
...
if (isset ($incluir) && $incluir != "") {
  ...
  if ($sqlerro == false) {
    ...
    if ($at40_sequencial != "" and $item_menu == "") {
			...
			$resultitem = pg_exec($sql) or die($sql);
...
if (isset ($alterar) && $alterar != "") {
  ...
  if ($sqlerro == false) {
    ...
    include ("forms/db_frmatendsup.php");
    ?>
    </td>
    </tr>
    <?
