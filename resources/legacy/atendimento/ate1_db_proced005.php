 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_db_procedgrupos.location.href='ate1_db_procedgrupos001.php?at52_proced=".@$at30_codigo."';
         parent.document.formaba.db_procedusu.disabled=false;
         CurrentWindow.corpo.iframe_db_procedusu.location.href='ate1_db_procedusu001.php?at31_proced=".@$at30_codigo."';
         parent.document.formaba.db_procedcliente.disabled=false;
         CurrentWindow.corpo.iframe_db_procedcliente.location.href='ate1_db_procedcliente001.php?at50_proced=".@$at30_codigo."';
     ";
         if(isset($liberaaba)){
