...
if (isset ($alterar)) {
	if ($sqlerro == true) {
		...
		db_msgbox($erro_msg);
		echo "<script>CurrentWindow.corpo.iframe_tarefausu.location.href='ate1_tarefausu001.php?at42_tarefa=".@$at40_sequencial."'</script>";
	}
}
if (isset ($chavepesquisa)||isset($at40_sequencial)) {
  ...
  <script>
      function js_db_libera(){
         ...
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefaobs.location.href='ate1_tarefaobs001.php?at42_tarefa=".@$at40_sequencial."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefaclientes.location.href='ate1_tarefaclientes002.php?at70_tarefa=".@$at40_sequencial."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefausu.location.href='ate1_tarefausu002.php?at42_tarefa=".@$at40_sequencial."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefaenvol.location.href='ate1_tarefaenvol002.php?at45_tarefa=".@$at40_sequencial."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefalog.location.href='ate1_tarefalogand002.php?at43_tarefa=".@$at40_sequencial."&at43_usuario=".db_getsession("DB_id_usuario")."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_agenda.location.href='ate1_tarefaagenda002.php?at13_tarefa=".@$at40_sequencial."';
         ".(isset($menu)?"parent":"CurrentWindow.corpo").".iframe_tarefaanexos.location.href='ate3_constarefaanexos.php?at25_tarefa=".@$at40_sequencial."';
     ";
	if (isset ($liberaaba)) {
