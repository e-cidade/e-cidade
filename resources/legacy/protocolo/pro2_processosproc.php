...
<center>
	<form name="form1" method="post" action="">
		<table>
					...
					<fieldset>
						...
						<fieldset class="fieldsetinterno">
							...
							<table border="0">
								...
								<tr>
									<td><b>Mostra Apensados:</b> </td>
									<td>
										<?
										$aApensados = array ('s' => 'Sim',
											'n' => 'Não');
										db_select('apensados', $aApensados, true, 1);
										?>
									</td>
								</tr>
							</table>
          ...
          <input type="button" value="Relatório" onclick="js_self('pdf')">
					<input type="button" value="Relatório CSV" onclick="js_self('csv')">
        </td>
			</tr>
		</table>
	</form>
...
<script>
	function js_self(tipo){

    var tipos = {
      pdf: 'pro2_processos002.php',
      csv: 'pro2_processos002_csv.php'
    };
    ...
    if (!tipos[tipo]) {
      return;
		...
		var sApensados       = document.form1.apensados.value;
		var iTipoCGMProcesso = document.form1.cboTitularProcesso.value;

		/* Monta URL */
		var sUrlOpen  = tipos[tipo] + '?';
		...
		sUrlOpen += '&listaApensados='+sApensados;
