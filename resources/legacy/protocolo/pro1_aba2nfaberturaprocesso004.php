...
<table height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
    <tr>
      ...
      AND p58_instit = " . db_getsession("DB_instit");
            ...
            $sql = $clprotprocesso->sql_query_abertura_processo("", $campos, " p111_sequencial DESC ", $where);
            $repassa = array();
            if (isset($p58_codproc)) {
                $repassa = array("p58_codproc" => $p58_codproc);
            }
            db_lovrot($sql . " ", 15, "()", "", "js_addFornecedorAP|p58_numero|p111_sequencial", "", "NoMe", $repassa);
            ?>
        </td>
    </tr>
</table>
...
<script>
    ...
    function js_addFornecedorAP(chave1,chave2) {
    ...
    function js_buscarInformacoesFornecedores() {
        ...
        var oParams = {
            ...
            aba: 'aberturaprocesso',
            aCodAberturaProcesso: fornecedores.join(',')
        };
    ...
    function js_confirmar() {
        ...
        for (var oRow of oGridFornecedores.getRows()) {
            if (oRow.isSelected) {
                ...
                oFornecedorAdd.codproc_p111        = oRow.aCells[8].getValue();
    ...
    function setInformacoes (oRetorno) {
        ...
        aFornecedores.each(function(oFornecedor, iSeq) {
            ...
            oNfe = new DBTextField('nfe' + iSeq, 'nfe' + iSeq, oFornecedor.p111_nfe);
            ...
            aLinha[7] = oFornecedor.p58_codproc+'-'+oFornecedor.p111_sequencial;
