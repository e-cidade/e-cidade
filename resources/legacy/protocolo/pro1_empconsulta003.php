...
<script>
function js_showAutori(iAutori,iRazao,iEmissao,iTotal) {
  var Emissao = iEmissao.split('-').reverse().join('/');
  js_OpenJanelaIframe('',
    'db_iframe_',
    'pro1_aba2protprocesso004?e54_autori='+iAutori+'&z01_nome='+iRazao+'&e54_emiss='+Emissao+'&e55_vltot='+iTotal,'Dados da Autorização');
