            ...
            <fieldset>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <input type="text" size="12" maxlength="10" id="p58_numero" name="p58_numero" title="Protocolo geral" onchange="js_pesquisaProcesso(false, false) ">
                            <input type="hidden" id="p58_codproc" name="p58_codproc" value="">
                            <?
                            //db_input('p58_numero',12,$Ip30_procapensado,true,'text',$db_opcao," onchange='js_pesquisaProcesso(false, false);'");
...
<script type="text/javascript">
    ...
    function js_pesquisaProcesso(mostra, apensado) {
        ...
        var p58_numero = document.form1.p58_numero.value;
        var p58_numero_apensado = document.form1.p58_numero_apensado.value;
    ...
    function js_mostratipoproc(chave1, chave2, chave3, erro) {

        if (lApensado) {

            $('p58_numero_apensado').value = chave1;
            $('z01_nome').value = chave2;
            $('p30_procapensado').value = chave3;
        } else {

            $('p58_numero').value = chave1;
            $('z01_nome_principal').value = chave2;
            $('p58_codproc').value = chave3;
            buscaProcessosApensados(chave3);
        }
        if (erro) {
    ...
    function js_mostratipoproc1(chave1, chave2, chave3) {
    ...
    function js_preencheGrid(aDados) {
        ...
        for (var i = 0; i < aDados.length; i++) {
            ...
            with (aDados[i]) {
                ...
                aRowProcesso[0] = protocologeral+'/'+anoprotocologeral;
                aRowProcesso[1] = protocologeralapensado+'/'+anoprotocologeralapensado;
