...
if(isset($cancel)){
  db_inicio_transacao();
    $sqlerro=false;
    $result_cont=$clproctransferintand->sql_record($clproctransferintand->sql_query_file(null,"*",null,"p87_codtransferint=$codtransfer"));
...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" style='margin-top: 25px'  marginheight="0" onLoad="a=1" >
<?
include("forms/db_frmcanceltransint.php");
if (isset($cancel)) {
  ...
  if($sqlerro==true) {
    ...
    echo"<script>CurrentWindow.corpo.location.href='pro4_canceltransint001.php';</script>";
  }
}
?>
</body>
