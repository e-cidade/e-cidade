...
<html>
  ...
  <body bgcolor="#cccccc">
      <form class="container" name="form1" id="form1">
        <fieldset>
          <legend>Exclusão de Arquivo do INSS:</legend>
      ...
      <input name="excluir"   type="button"  value="Excluir"  onclick="js_salvarRPC(2, $('ob16_codobrasenvio'));">
      </form>
      <?php
...
<script>
  ...
  function js_salvarRPC(iAcao, oCodigoTxt) {
    ...
    if (!oCodigoTxt || iCodigoTxt == "") {
      ...
      alert(_M('tributario.projetos.pro1_excluitxt003.preencha_codigo'));
      oCodigoTxt.focus();
      return false;
    }
    ...
    switch (iAcao) {
      ...
      break;
      default:
        alert(_M('tributario.projetos.pro1_excluitxt003.defina_opcao'));
        return false;
      break;
    }

    js_divCarregando(_M('tributario.projetos.pro1_excluitxt003.processando_operacao'), 'msgBox');
  ...
  function js_retornoRequisicao(oRetornoAjax) {
    ...
    if (oRetorno.iStatus != "2") {
      window.location = 'pro1_excluitxt003.php';
    }
