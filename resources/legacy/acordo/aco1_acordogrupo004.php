...
if (isset($incluir)) {
  ...
  $clacordogrupo->incluir($ac02_sequencial);
  ...
  $ac02_sequencial = $clacordogrupo->ac02_sequencial;
  $db_opcao        = 1;
  $db_botao        = true;
}
?>
...
if (isset($incluir)) {
  ...
  if ($sqlerro == true) {
    ...
    db_msgbox($erro_msg);
    db_redireciona("aco1_acordogrupo005.php?liberaaba=true&chavepesquisa=$ac02_sequencial");
  }
}
?>
</html>
