...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clacordocomissao->alterar($ac08_sequencial);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_acordocomissaomembro.location.href='aco1_acordocomissaomembro001.php?ac07_acordocomissao=".@$ac08_sequencial."';
     ";
         if(isset($liberaaba)){
