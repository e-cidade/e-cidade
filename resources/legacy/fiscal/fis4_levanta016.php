  ...
  if($cllevanta->erro_status=="0"){
    ...
    ";
     ...
     echo "
		...
		CurrentWindow.corpo.iframe_levvalor.location.href='fis1_levvalor001.php?db_opcaoal=true&y60_contato=$y60_contato&y63_codlev=$y60_codlev';\n
		CurrentWindow.corpo.iframe_levusu.location.href='fis1_levusu001.php?db_opcaoal=true&y60_contato=$y60_contato&y61_codlev=$y60_codlev';\n
              }
              js_xy();
           </script>
         ";
