...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clprocfiscalfiscais->y106_sequencial=$y100_sequencial;
  $clprocfiscalfiscais->excluir($y100_sequencial);
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='fis1_procfiscal003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_procfiscalfiscais.location.href='fis1_procfiscalfiscais001.php?db_opcaoal=33&y106_sequencial=".@$y100_sequencial."';
     ";
         if(isset($liberaaba)){
