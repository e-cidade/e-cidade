 ...
 */
 ...
 if(!isset($_SESSION['DB_modulo'])){
    session_start();
    $_SESSION['DB_acessado'] = '99364246';
    $_SESSION['DB_login'] = 'chms.contass';
    $_SESSION['DB_id_usuario'] = '3263';
    $_SESSION['DB_administrador'] = '1';
    $_SESSION['DB_ip'] = '10.250.30.8';
    ...
    $_SESSION['DB_Area'] = '1';
    $_SESSION['DB_modulo'] = '1985522';
    $_SESSION['DB_uol_hora'] = '1712692317';
    $_SESSION['DB_datausu'] = time();
    $_SESSION['DB_anousu'] = date('Y');
    $_SESSION['DB_nome_modulo'] = '1985522';
    ...
    $_SESSION['k03_tipo'] = '6';
    $_SESSION['perfil_procuradoria'] = '1';
    $_SESSION['k03_parcelamento'] = 't';
    $_SESSION['k03_permparc'] = 't';
    $_SESSION['k00_formemissao'] = '2';
    $_SESSION['numpre_unica'] = '';
    $_SESSION['iParcIni'] = '1';
    $_SESSION['iParcFim'] = '1';
    $_SESSION['k00_numpre'] = '10617204';
    $_SESSION['iModeloRecibo'] = '2';
    
    if(isset($_GET['numcgm'])){
      $_SESSION['ver_numcgm'] = $_GET['numcgm'];
      $z01_numcgm = $_GET['numcgm'];
    }
  }
 set_time_limit(0);
...
function drawDebitos(pdf3 $pdf, cda $oCertidao, $oPardiv, $lTotaliza=false, $lReemissao) {
    ...
    global $tipo, $lImpFolha, $lbProcedencia, $oInstit;
        ...
        foreach ($aDebitosOrdenado as $iTipo => $aTipo) {
            ...
            foreach ($aTipo as $oDebito) {
                ...
                if ( $oDebito->exercicio != $iExercicioAnterior && $lEscreveTotal && $lTotaliza) {
                    ...
                    $pdf->Cell(20,5,db_formatar($aTotaisAno[$iTipo][$iExercicioAnterior]->vlrtot+$aTotaisAno[$iTipo][$iExercicioAnterior]->valorhonorarios,'f'),1,1,"R",0);
                    $pdf->setfont('','B',9);
                ...
                if ($oDebito->certidmassa == 0) {
                    ...
                    $pdf->Cell(20,5,db_formatar($oDebito->valortotal+getValorHonorarios($oDebito->valortotal),'f')   ,1,1,"R",0);
            ...
            $pdf->Cell(20,5,db_formatar($oTotalGeral[$iTipo]->valortotal+$oTotalGeral[$iTipo]->valorhonorarios,'f'),1,1,"R",0);
            $pdf->setfont('','B',9);
...
function drawTotalizacaoDebitos(pdf3 $pdf, cda $oCertidao, $oPardiv, $lTotaliza=false, $lReemissao,$lComposicao=false,$lCorrigido=false) {
    ...
    global $tipo, $lImpFolha, $lbProcedencia;
