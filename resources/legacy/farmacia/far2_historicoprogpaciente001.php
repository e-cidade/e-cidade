...
function js_mandadados(){
  ...
  if(js_validaenvio())
  {
   ...
   jan = window.open('far2_historicoprogpaciente002.php?'+programas+datas+nomes_programas,'','width='+(screen.availWidth-5)+',height='+(screen.availHeight-40)+',scrollbars=1,location=0 ');
   jan.moveTo(0,0);
  }
}
