...
if ( isset($incluir) ) {
  ...
  /**
   * Valida se o medicamento já esta cadastrado
   */
  ...
  if ( $rs && pg_num_rows($rs) > 0 ) {
    ...
    db_msgbox("Medicamento ({$m60_descr}) já cadastrado.");
    $lErro = true;
  }

  /**
   * Valida se o código de barras já existe no banco
   */
...
$sLegenda = "Inclusão de Medicamentos";
?>
