...
function js_consultaItens(iCodMater,iCodEstoque, nValor, iControle){
   
   js_divCarregando("Aguarde, efetuando pesquisa","msgBox");
   strJson = '{"exec":"getLotes","params":[{"iCodMater":'+iCodMater+',"iCodEstoque":'+iCodEstoque+',"nValor":'+nValor+',"iControle":'+iControle+'}]}';
...
<?
echo "js_consultaItens({$iCodMater},{$oGet->iCodDepto},{$oGet->nValor},{$oGet->iControle});\n";
?>
</script>
