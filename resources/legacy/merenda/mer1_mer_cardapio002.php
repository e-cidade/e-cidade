...
if (isset($alterar)) {
 ...
 db_fim_transacao();
  ...
  <script>
   ...
   CurrentWindow.corpo.iframe_a2.location.href   = 'mer1_mer_cardapioitem001.php?me07_i_cardapio=<?=$me01_i_codigo?>'+
                                          '&me01_c_nome=<?=$me01_c_nome?>&naopode=<?=$naopode?>';
   CurrentWindow.corpo.iframe_a3.location.href   = 'mer1_mer_modpreparo001.php?me05_i_cardapio=<?=$me01_i_codigo?>'+
                                          '&me01_c_nome=<?=$me01_c_nome?>&naopode=<?=$naopode?>';
   CurrentWindow.corpo.iframe_a4.location.href   = 'mer1_mer_caractpreparo001.php?me06_i_cardapio=<?=$me01_i_codigo?>'+
                                          '&me01_c_nome=<?=$me01_c_nome?>&naopode=<?=$naopode?>';
   CurrentWindow.corpo.iframe_a5.location.href   = 'mer1_mer_alunorestrialimentar001.php?me06_i_cardapio=<?=$me01_i_codigo?>'+
                                          '&me01_c_nome=<?=$me01_c_nome?>&naopode=<?=$naopode?>';
   CurrentWindow.corpo.iframe_a6.location.href   = 'mer1_mer_escolarefeicao001.php?me06_i_cardapio=<?=$me01_i_codigo?>'+
                                          '&me01_c_nome=<?=$me01_c_nome?>';
   CurrentWindow.corpo.iframe_a7.location.href   = 'mer1_mer_cardapionutri001.php?me04_i_cardapio=<?=$me01_i_codigo?>'+
                                         '&me01_c_nome=<?=$me01_c_nome?>';
  </script>
  <?
}
