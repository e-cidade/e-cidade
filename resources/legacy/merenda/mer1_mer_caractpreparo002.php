...
if (isset($alterar)) {
  ...
  if ($clmer_caractpreparo->erro_status=="0") {
    ...
    $clmer_caractpreparo->erro(true,false);
    ?><script>
      CurrentWindow.corpo.iframe_a4.location.href='mer1_mer_caractpreparo002.php?me06_i_cardapio=<?=$aux?>'+
...
if ($db_opcao == 22) {
  ...
  ?>
  <script>
    CurrentWindow.corpo.iframe_a4.location.href='mer1_mer_caractpreparo001.php?me06_i_cardapio=<?=$aux?>'+
                                       '&me01_c_nome=<?=$me01_c_nome?>';
  </script>
  <?
