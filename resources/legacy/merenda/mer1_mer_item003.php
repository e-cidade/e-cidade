...
if (isset($excluir)) {
  ...
  db_inicio_transacao();
  $db_opcao = 3;
  $result1  = $clmer_item->sql_record($clmer_item->sql_query("","me10_i_codigo","","me10_i_codigo=$chavepesquisa"));
  ...
  <script>
   ...
   CurrentWindow.corpo.iframe_a2.location.href      ='mer1_mer_infnutricional001.php?me10_i_codigo=<?=$me10_i_codigo?>'+
