...
if (isset($alterar)){
	...
	if ($clmer_cardapionutri->erro_status=="0") {
		...
		?>
<script>
      CurrentWindow.corpo.iframe_a5.location.href='mer1_mer_cardapionutri002.php?me04_i_cardapio=<?=$aux?>'+
...
if ($db_opcao==22) {
	...
	?>
<script>
     CurrentWindow.corpo.iframe_a5.location.href='mer1_mer_cardapionutri001.php?me04_i_cardapio=<?=$aux?>'+
                                        '&me01_c_nome=<?=$me01_c_nome?>';
    </script>
	<?
