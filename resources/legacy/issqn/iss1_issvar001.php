...
<table height="430" width="790" border="1" valign="top" cellspacing="0" cellpadding="0" bgcolor="#cccccc">
  ...
  <form name="form1" method="post" action="iss1_issvar014.php"  onSubmit="return js_verifica_campos_digitados();" >
...
<?
if(isset($baixa) && $baixa=="invalida"){
  db_msgbox("Inscrição já encerrada.");
}
if(isset($inscricao) && $inscricao=="invalida"){
  db_msgbox("Inscrição inválida.");
}
if(isset($numcgm) && $numcgm=="invalida"){
  db_msgbox("Numcgm inválido.");
}
if(isset($aliquota) && $aliquota=="invalida"){
  db_msgbox("Inscrição sem atividade em funcionamento cadastrado.");
}
?>
