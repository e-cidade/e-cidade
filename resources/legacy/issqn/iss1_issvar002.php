...
function js_testacamp(){
  ...
  if(inscr=="" && numcgm==""){
    alert("Informe um campo para pesquisa!");
		...
		js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_issvar','func_issvar.php?inscr='+inscr+'&numcgm='+numcgm+'&funcao_js=parent.js_submit|q05_codigo','Pesquisa',true);
  }
}
...
<center>
<table  valign="top" cellspacing="0" cellpadding="0" bgcolor="#cccccc">
  <tr>
  <td align="center" valign="top" bgcolor="#cccccc">
  <form name="form1" method="post" action="iss1_issvar015.php"  onSubmit="return js_verifica_campos_digitados();" >
  <center>
