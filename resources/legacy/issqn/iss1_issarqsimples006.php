...
if(isset($excluir)){
  $sqlerro=false;
  db_inicio_transacao();
  $clissarqsimplesreg->q23_sequencial=$q17_sequencial;
  $clissarqsimplesreg->excluir($q17_sequencial);

  if($clissarqsimplesreg->erro_status==0){
    $sqlerro=true;
  }
  $erro_msg = $clissarqsimplesreg->erro_msg;
  $clissarqsimples->excluir($q17_sequencial);
 ...
 echo "
  <script>
    function js_db_tranca(){
      parent.location.href='iss1_issarqsimples003.php';
    }\n
    js_db_tranca();
  </script>\n
 ";
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_issarqsimplesreg.location.href='iss1_issarqsimplesreg001.php?db_opcaoal=33&q23_sequencial=".@$q17_sequencial."';
     ";
         if(isset($liberaaba)){
