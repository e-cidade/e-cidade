...
if(isset($alterar)){
  ...
  $clisstipoalvara->alterar($q98_sequencial);
  db_fim_transacao();
...
if(isset($alterar)){
  if($clisstipoalvara->erro_status=="0"){
    ...
    $clisstipoalvara->erro(true,false);
    db_redireciona("iss1_isstipoalvara005.php?liberaaba=true&chavepesquisa=".$clisstipoalvara->q98_sequencial);
  }
}
if($db_opcao==22){
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_departamento.location.href='iss1_tabalvara_depto001.php?q98_sequencial=".@$chavepesquisa."&q98_descricao=".$q98_descricao."&dbopcao=".$db_opcao."';
     ";
         if(isset($liberaaba)){
