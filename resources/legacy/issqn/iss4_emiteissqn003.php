                ...
                if ($resultfin != false) {
                    ...
                    for ($unicont = 0; $unicont < pg_numrows($resultfin); $unicont++) {
                        ...
                        try {
                            ...
                            /**
                             * Necessario gerar pix novamente devido ao valor de desconto que é calculado aqui e nao no model recibo
                             */
                            if ($usePixIntegration) {
                                ...
                                $body['valorOriginalSolicitacao'] = $utotal;
                                $body['k00_numnov'] = $oDadosPgtoUnica->k00_numnov;
                        ...
                        if ($usePixIntegration) {
                            $pdf1 = usePixIntegration($pdf1, $oDadosPgtoUnica->k00_numnov);
                            $pdf1->hasQrCode = true;
                        }
        ...
        if ($lImprimeParcelas) {
            ...
            if ($tipo_debito != "3") {
                ...
                try {
                    ...
                    $oRecibo->emiteRecibo();
                    if ($usePixIntegration) {
                        $pdf1 = usePixIntegration($pdf1, $oRecibo->getNumpreRecibo());
                        $pdf1->hasQrCode = true;
                    }
                } catch (Exception $eException) {
