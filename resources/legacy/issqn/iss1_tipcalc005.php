...
if(isset($alterar)){
  ...
  $result = $cltipcalcexe->sql_record($cltipcalcexe->sql_query_venc(null,"q83_codigo",null,"q83_tipcalc = $q81_codigo and q83_anousu = ".db_getsession("DB_anousu")));
  if($result!=false && $cltipcalcexe->numrows>0){
  db_fieldsmemory($result,0);
	  $cltipcalcexe->q83_codigo = $q83_codigo;
  ...
  if ($sqlerro==false){
  	$cltipcalc->q81_codigo = $q81_codigo;
	  $cltipcalc->alterar($q81_codigo);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_tipcalcexe.location.href='iss1_tipcalcexe001.php?iVencSimples=".$q81_cadcalc."&q83_tipcalc=".@$q81_codigo."';
     ";
         if(isset($liberaaba)){
