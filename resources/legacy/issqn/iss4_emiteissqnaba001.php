...
<body class="body-default abas" onload="js_mostraTipoImp(document.form1.arq);">
    ...
    <tr>
        <td>
            ...
            if (isset($k03_tipo)) {
                ...
                $sSql .= "      (select min(recibounica.k00_dtvenc) as k00_dtvenc,                  ";
                $sSql .= "              min(recibounica.k00_dtoper) as k00_dtoper,                  ";
    ...
    <tr>
        <td colspan="2" align="center">
            <input name="geracarnes" type="submit" id="geracarnes" value="Gerar Carnes" onclick="return js_processar();" />
        </td>
    </tr>
