...
if(isset($alterar)){
  $sqlerro=false;
  db_inicio_transacao();
  $clissnotaavulsa->alterar($q51_sequencial);
 ...
 echo "
  <script>
      function js_db_libera(){
         ...
         CurrentWindow.corpo.iframe_issnotaavulsaservico.location.href='iss1_issnotaavulsaservico001.php?q51_sequencial=".@$chavepesquisa."';
         CurrentWindow.corpo.iframe_issnotaavulsatomador.location.href='iss1_issnotaavulsatomador001.php?q51_sequencial=".@$chavepesquisa."';
     ";
         if(isset($liberaaba)){
