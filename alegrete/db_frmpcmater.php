  ...
  */
   ...
   <tr>
    <td colspan="2" align="center">
      <div align="left"><?=$Lo56_elemento?></div>
      <iframe width="630" height="200" name="pcmater0011" <?=$vaiIframe?>></iframe>
    </td>
  </tr>
  <?if($db_opcao!=1){?>
  <tr>
    <td colspan=2 bgcolor="#CCFF99" align="center"><strong>***   Elementos que não podem ser alterados por estar na autorização de empenho.</strong></td>
  </tr>
  <?}?>
  </table>
  </center>
