  ...
  switch($chave) {
    case "situacao":
      if($chave_valor!= "" && $lista == ""){
        $sql = "select (v52_codigo || '##' || v52_descr) as db_codigo,v52_codigo,v52_descr
	          from situacao
			  where v52_codigo = ".$chave_valor."
		      order by v52_codigo";
        $result = pg_exec($sql);
      ...
      $sql = "select (v52_codigo || '##' || v52_descr) as db_codigo,v52_codigo,v52_descr
	          from situacao
		      where v52_codigo like '".$chave_valor."%'
		      order by v52_codigo";
      
	  break;
    case "situacaodescr":
      $sql = "select (v52_descr || '##' || v52_codigo) as db_codigo,v52_codigo,v52_descr
	          from situacao
			  where upper(v52_descr) like upper('".$chave_valor."%')
		      order by v52_descr";
	  break;
   }
?>
...
<td align="center">
<?
db_lov($sql,15,"db_situacao.php?".base64_encode("campo=$campo&campoaux=$campoaux"),$HTTP_POST_VARS["filtro"]);
?>
</td>
</tr>
</table>
