  ...
  switch($chave) {
    case "localizacao":
      if($chave_valor!= "" && $lista == ""){
        $sql = "select (v54_codigo || '##' || v54_descr) as db_codigo,v54_codigo,v54_descr
	          from localiza
			  where v54_codigo = ".$chave_valor."
		      order by v54_codigo";
        $result = pg_exec($sql);
      ...
      $sql = "select (v54_codigo || '##' || v54_descr) as db_codigo,v54_codigo,v54_descr
	          from localiza
		      where v54_codigo like '".$chave_valor."%'
		      order by v54_codigo";
      
	  break;
    case "localizacaodescr":
      $sql = "select (v54_descr || '##' || v54_codigo) as db_codigo,v54_codigo,v54_descr
	          from localiza
			  where upper(v54_descr) like upper('".$chave_valor."%')
		      order by v54_descr";
	  break;
   }
?>
