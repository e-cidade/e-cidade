  ...
  switch($chave) {
    case "nome":
      if($chave_valor!= "" && $lista == ""){
        $sql = "select (z01_numcgm || '##' || z01_nome) as db_codigo,z01_numcgm as numcgm,z01_nome as nome
	          from cgm
			  where z01_numcgm = ".$chave_valor."
		      order by z01_numcgm";
        $result = pg_exec($sql);
      ...
      $sql = "select (z01_numcgm || '##' || z01_nome) as db_codigo,z01_numcgm as numcgm,z01_nome as nome
	          from cgm
		      where z01_numcgm like '".$chave_valor."%'
		      order by z01_numcgm";
      
	  break;
    case "descrnome":
      $sql = "select (z01_nome || '##' || z01_numcgm) as db_codigo,z01_numcgm as numcgm,z01_nome as nome
	          from cgm
			  where upper(z01_nome) like upper('".$chave_valor."%')
		      order by z01_nome";
	  break;
   }
?>
