...
if(empty($HTTP_POST_VARS["filtro"]))
  ...
  switch($campo) {
    case "numpre":
      $sql = "select (k00_numpre || '##' || k00_numpre) as db_codigo,a.k00_numpre,c.z01_nome,c.z01_numcgm
              from arrecad a
			  inner join cgm c
			  on c.z01_numcgm = a.k00_numcgm
		      where k00_numpre like '".$arg[1]."%'
		      order by k00_numpre";
	  break;
  }
?>
...
<td align="center">
<?
db_lov($sql,15,"db_arrecad.php?".base64_encode("campo=$campo"),$HTTP_POST_VARS["filtro"]);
?>
</td>
</tr>
</table>
