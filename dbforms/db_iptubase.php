...
if(empty($HTTP_POST_VARS["filtro"]))
  ...
  switch($campo) {
    case "matricula":
      $sql = "select (j01_matric || '##' || j01_matric) as db_codigo,j01_matric,z01_nome,z01_numcgm
              from iptubase
			  inner join cgm
			  on j01_numcgm = z01_numcgm
		      where j01_matric like '".$arg[1]."%'
		      order by j01_matric";
	  break;
  }
?>
...
<td align="center">
<?
db_lov($sql,15,"db_iptubase.php?".base64_encode("campo=$campo"),$HTTP_POST_VARS["filtro"]);
?>
</td>
</tr>
</table>
