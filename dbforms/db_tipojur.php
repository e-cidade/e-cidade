...
if(empty($HTTP_POST_VARS["filtro"]))
  ...
  switch($chave) {
    case "tipo":
      if($chave_valor != "" && $lista == "" && !isset($HTTP_POST_VARS["filtro"])) {
        $sql = "select (v51_codigo || '##' || v51_descr) as db_codigo,v51_codigo,v51_descr
	          from tipojur
			  where v51_codigo = ".$chave_valor."
		      order by v51_codigo";
        $result = pg_exec($sql);
      ...
      $sql = "select (v51_codigo || '##' || v51_descr) as db_codigo,v51_codigo,v51_descr
	          from tipojur
		      where v51_codigo like '".$chave_valor."%'
		      order by v51_codigo";
      
	  break;
    case "tipodescr":
      $sql = "select (v51_descr || '##' || v51_codigo) as db_codigo,v51_codigo,v51_descr
	          from tipojur
			  where upper(v51_descr) like upper('".$chave_valor."%')
		      order by v51_descr";
	  break;
   }
?>
...
<td align="center">
<?
db_lov($sql,15,"db_tipojur.php?".base64_encode("campo=$campo&campoaux=$campoaux"),$HTTP_POST_VARS["filtro"]);
?>
</td>
</tr>
</table>
