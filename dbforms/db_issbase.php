...
if(empty($HTTP_POST_VARS["filtro"]))
  ...
  switch($campo) {
    case "inscricao":
      $sql = "select (q02_inscr || '##' || q02_inscr) as db_codigo,q02_inscr,z01_nome,z01_numcgm
              from issbase
			  inner join cgm
			  on q02_numcgm = z01_numcgm
		      where q02_inscr like '".$arg[1]."%'
		      order by q02_inscr";
	  break;
  }
?>
...
<td align="center">
<?
db_lov($sql,15,"db_issbase.php?".base64_encode("campo=$campo"),$HTTP_POST_VARS["filtro"]);
?>
</td>
</tr>
</table>
