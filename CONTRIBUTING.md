...
Que bom que você resolveu contribuir conosco. Obrigado! A proposta do e-Cidade é
...
Se encontrou um bug no e-Cidade você pode reportá-lo usando a ferramenta de
[issues do GitHub](https://github.com/e-cidade/e-cidade/issues). Porém antes
...
[criar uma nova issue](https://github.com/e-cidade/e-cidade/issues/new). No
...
DB:FINANCEIRO > Empenho > Cadastros > Histórico do Empenho > Inclusão

**DESCRIÇÃO:**

No cadastro de Histórico do Empenho, ao digitar no campo e clicar no botão salvar esta ocorrendo um erro desconhecido.
...
`comunidade@contassconsultoria.com.br`. Ele será analisado, validado e corrigido de
...
Outra ótima forma de contribuir é indicando melhorias ao código do e-Cidade e em
...
2. Também verifique se a ideia já não está pressente em nossas
   [issues do GitHub](https://github.com/e-cidade/e-cidade/issues);
...
[criar uma nova issue](https://github.com/e-cidade/e-cidade/issues/new)
...
[criar uma nova issue](https://github.com/e-cidade/e-cidade/issues/new) usando
o label **recurso**.
...
contribuir com código. Para isso faça um fork do e-Cidade e trabalhe em cima de
...
Se você não trabalha com código mas quer ajudar o e-Cidade, existe muitas outras
formas de contribuir:

- Ajude com a documentação do projeto (mais informações em breve);
- Fale sobre o e-Cidade nas suas redes sociais, blogs, etc. Espalhe a palavra;
- Organize eventos e dê palestras sobre o e-Cidade;
...
para `comunidade@contassconsultoria.com.br` e conte sua história.
...
- [Comunidade i-Educaar](https://github.com/portabilis/i-educar)
