...
class RegistrarLanceSemValorRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'fornecedorCodigo.numeric' => StringHelper::toUtf8('O código do fornecedor deve ser numérico.'),
    ...
    protected function failedValidation(Validator $validator)
    {
        throw new HttpResponseException(response()->json([
            'message' => StringHelper::toUtf8('Erro de validação para registrar lance sem valor.'),
