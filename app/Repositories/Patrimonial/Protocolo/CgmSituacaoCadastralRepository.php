...
use App\Repositories\Contracts\Patrimonial\Protocolo\CgmSituacaoCadastralRepositoryInterface;

class CgmSituacaoCadastralRepository implements CgmSituacaoCadastralRepositoryInterface
{
    CONST REGULAR = 0;
    CONST SUSPENSA = 2;
