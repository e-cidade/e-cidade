...
class InserirParecerService{
  ...
  public function execute(object $data){
    ...
    $oData = new ParecerLicitacao([
      'l200_sequencial'   => $this->parecerLicitacaoRepository->getNextVal(),
      ...
      'l200_enviosicom'   => false
    ]);
    
    DB::beginTransaction();
    try{
      $oData = $this->parecerLicitacaoRepository->save($oData);

      DB::commit();
      return [
        'status' => 200,
        'message' => 'Parecer criada com sucesso',
        'data' => [
