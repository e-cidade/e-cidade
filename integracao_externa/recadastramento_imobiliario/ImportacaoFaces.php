...
class ImportacaoFaces {
  ...
  public function __construct( $sCaminhoArquivo ) {
    ...
    $this->oLog                  = new DBLog("TXT", "/tmp/log_importacao_faces.log");
    $this->oJson                 = new services_json();
    $this->aDadosCaracteristicas = $this->oJson->decode(str_replace("\\","", file_get_contents(PATH_IMPORTACAO . 'caracteristicas.json')));
  ...
  public function verificaSetor ($iCodigoSetor, $iSequencialArquivo) {
    ...
    $sSqlSetor = "select * from setor where j30_codi = $iCodigoSetor";
