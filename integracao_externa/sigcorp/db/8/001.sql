...
begin
  ...
  if cast( sNumbanco as integer ) not between rRecordConfig.faixa_inicial_numbanco and rRecordConfig.faixa_final_numbanco then
  ...
  if rRecordConfig.tipo_convenio = 2 and sNumbanco = 0 then
