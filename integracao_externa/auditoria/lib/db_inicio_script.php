...
// Desabilita tempo mсximo de execucao
set_time_limit(0);

// Arquivo de constantes de configuraчуo
...
include_once(PATH_ECIDADE."/std/DBCursor.php");
...
// Seta nome do arquivo de Log, caso jс nуo exista
