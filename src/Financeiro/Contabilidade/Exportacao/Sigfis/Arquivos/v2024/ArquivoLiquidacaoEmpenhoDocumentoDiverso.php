...
class ArquivoLiquidacaoEmpenhoDocumentoDiverso extends ArquivoBase
{
    ...
    $sql = pg_query("SELECT e178_sigfistipodocliquidacao, e177_codigo, e177_descr FROM sigfistipodocliquidacao INNER JOIN empnotasigfistipodocliquidacao ON e178_sigfistipodocliquidacao = e177_sequencial WHERE e178_empnota = {$codnota}");
    $resultado = pg_fetch_all($sql);
    return $resultado[0]["e178_sigfistipodocliquidacao"];
}
    ...
    {   
        ...
        foreach ($empenhos as $empenho) {
            //if($empenho->e60_codemp != 370){continue;}
            /*
            ...
            */
            ...
            if(empty($atestadores)){
                ...
                $tipo = $dadostipo["e178_sigfistipodocliquidacao"] == 4 ? 1 : 2;
