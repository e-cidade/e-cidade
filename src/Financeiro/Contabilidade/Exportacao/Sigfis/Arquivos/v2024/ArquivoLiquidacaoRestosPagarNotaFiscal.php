...
class ArquivoLiquidacaoRestosPagarNotaFiscal extends ArquivoBase
{
    ...
    public function voltaLiquidacaoes(){
        ...
        $resultado = array(); //c53_tipo in (20,21)
    ...
    public function validaTipo($codnota){
        ...
        $resultado = pg_fetch_all($sql);
        return ($resultado[0]["e177_codigo"] == 1) ? true : false;
    }
    ...
    public function gerarDados()
    {
        ...
        foreach ($empenhos as $empenho) {
            ...
            //if($empenho->e60_codemp != 1208){continue;}
            ...
            $chave = $empenho->e60_numemp . $codord;
            if(in_array($chave, $guardao)){continue;}
            array_push($guardao, $chave);
            ...
            $dadosNota = \JSON::create()->parse($dadosempnota["e69_outrosdados"]);
            ...
            $data = (object)[
                ...
                'NumeroLiquidacaoRestosPagar' => $codord,//$dadosempnota["e69_codnota"],
            ...
            /*if($xi == 3){
                $atestador = array();
                $atestador["Identificador"] = 194566;
                $atestador["NomeAtestador"] = "Nome aqui";
                $atestador["CPF"] = 56815760782;
                $data->Atestadores = (object)['Atestador' => $atestador];

                $atestador02 = array();
                $atestador02["Identificador"] = 222222;
                $atestador02["NomeAtestador"] = "Nome aqui DOIS";
                $atestador02["CPF"] = 56815760782;
                $data->Atestadores = (object)['Atestador' => $atestador02];
