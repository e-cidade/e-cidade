...
class BalanceteVerificacao2023Service extends PadService
{
    protected $fileName = 'BAL_VER.TXT';
     ...
     * @return string
     */
    protected function getHash($conta)
    {
        return sprintf(
            '%s#%s#%s#%s#%s',
            $conta->estrutural,
    ...
    /**
     * @return BalanceteVerificacao2023Builder
     * @throws Exception
     */
    protected function getBuilder()
    {
        return new BalanceteVerificacao2023Builder();
    }
    ...
    /**
     * ATENÇÃO - esse sql esta recalculando os saldos, pois no PAD apenas alguns complementos são válidos.
     * Portanto, recalculamos os saldos.
     *
     * @return stdClass[]
     * @throws Exception
     */
