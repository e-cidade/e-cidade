...
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Builders\v2024\BalanceteRubricaAnterior2024Builder;
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Servicies\BalanceteRubricaAnteriorService;

class BalanceteRubricaAnteriorService2024 extends BalanceteRubricaAnteriorService
{

    /**
     * Removido subrecurso da query e agrupado siconfi desde o inicio da query
     * @return string
     */
    protected function getSql()
    {
        ...
        $sql = "
          ...
          select o58_orgao,
	     		 ...
	     		 o58_codele,
	     		 o56_elemento,
	     		 SUBSTRING(codigo_siconfi, 2) as siconfi,
                 case
    ...
    {
        return new BalanceteRubricaAnterior2024Builder();
    }
}
