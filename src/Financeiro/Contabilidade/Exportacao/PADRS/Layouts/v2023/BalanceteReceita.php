...
class BalanceteReceita extends ParseArray implements LayoutPad
{
    protected $dePara = [
        ...
        "Previsão Atualizada da Receita" => "previsaoAtualizada",
     ...
     * @return string
     */
    public function getPrevisaoAtualizada()
    {
        return $this->previsaoAtualizada;
    }

    /**
     * @param string $previsaoAtualizada
     */
    public function setPrevisaoAtualizada($previsaoAtualizada)
    {
    ...
    public function toArray()
    {
        return [
            ...
            "nivel" => $this->getNivel(),
            "cp" => $this->getCp(),
            "previsaoAtualizada" => $this->getPrevisaoAtualizada(),
