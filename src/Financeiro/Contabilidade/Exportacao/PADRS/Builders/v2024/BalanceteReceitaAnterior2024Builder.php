...
use ECidade\Financeiro\Contabilidade\Exportacao\PADRS\Layouts\v2023\BalanceteReceitaAnterior;

class BalanceteReceitaAnterior2024Builder extends PadBuilder
{
    ...
    protected function processar()
    {
        ...
        $nomeReceita = str_replace(["\r\n", "\n", "\r"], ['', '', ''], trim($this->dados['descricao']));
