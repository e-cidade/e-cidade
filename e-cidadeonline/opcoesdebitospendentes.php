...
$rsRetornoConfig = pg_query("select * from configdbpref where w13_instit = {$instit}");
$sConfig = pg_fetch_assoc($rsRetornoConfig);

$sqlinst    = "select codigo as instituicao, db21_regracgmiptu, db21_usasisagua from db_config where codigo = {$instit}";
...
$result1 = pg_exec ( "SELECT distinct m_publico,m_arquivo,m_descricao
                   FROM db_menupref
