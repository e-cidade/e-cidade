...
include(__DIR__ . "/../classes/db_lotacao_classe.php");
include(__DIR__ . "/../classes/db_padroes_classe.php");
include(__DIR__ . "/../classes/db_cargo_classe.php");
include(__DIR__ . "/../classes/db_cfpess_classe.php");
include(__DIR__ . "/../classes/db_cedulas_classe.php");
include(__DIR__ . "/../classes/db_pessoal_classe.php");
include(__DIR__ . "/../classes/db_codmovsefip_classe.php");
include(__DIR__ . "/../classes/db_movcasadassefip_classe.php");
include(__DIR__ . "/../classes/db_afasta_classe.php");
include(__DIR__ . "/../classes/db_cadferia_classe.php");
include(__DIR__ . "/../classes/db_cheques_classe.php");
include(__DIR__ . "/../classes/db_desconto_classe.php");
include(__DIR__ . "/../classes/db_rubricas_classe.php");
include(__DIR__ . "/../classes/db_pesdiver_classe.php");
include(__DIR__ . "/../classes/db_bases_classe.php");
include(__DIR__ . "/../classes/db_basesr_classe.php");
include(__DIR__ . "/../classes/db_efetiv_classe.php");
include(__DIR__ . "/../classes/db_historic_classe.php");
include(__DIR__ . "/../classes/db_eventos_classe.php");
include(__DIR__ . "/../classes/db_folhaemp_classe.php");
include(__DIR__ . "/../classes/db_inssirf_classe.php");
include(__DIR__ . "/../classes/db_landesc_classe.php");
include(__DIR__ . "/../classes/db_lotativ_classe.php");
include(__DIR__ . "/../classes/db_pensao_classe.php");
include(__DIR__ . "/../classes/db_pontofa_classe.php");
include(__DIR__ . "/../classes/db_pontofx_classe.php");
include(__DIR__ . "/../classes/db_depend_classe.php");
include(__DIR__ . "/../classes/db_progress_classe.php");
include(__DIR__ . "/../classes/db_rescisao_classe.php");
include(__DIR__ . "/../classes/db_reposic_classe.php");
include(__DIR__ . "/../classes/db_rhpessoalmov_classe.php");
include(__DIR__ . "/../classes/db_rhpesbanco_classe.php");
include(__DIR__ . "/../classes/db_rhpespadrao_classe.php");
include(__DIR__ . "/../classes/db_rhpesrescisao_classe.php");
include(__DIR__ . "/../classes/db_gerfsal_classe.php");
include(__DIR__ . "/../classes/db_gerffer_classe.php");
include(__DIR__ . "/../classes/db_gerfs13_classe.php");
