...
class cl_gera_sql_folha
{
    ...
    var $usar_rec_folha = false; // Se usarï¿½ inner ou left join com a tabela orctiporec usando tabela rhempenhofolha.
    ...
    function gerador_sql($sigla, $ano = null, $mes = null, $regist = null, $rubric = null, $campos = " * ", $order = "", $where = "", $instit = null, $sWhereSup = '', $iVinc = 0, $relRetencoes = null)
    {
        ...
        if (
            $this->usar_doc == true || $this->usar_cgm == true || $this->usar_fun == true || $this->usar_lot == true ||
