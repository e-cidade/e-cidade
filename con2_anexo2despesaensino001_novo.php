...
<table width="790" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="430" align="left" valign="top" bgcolor="#CCCCCC">
            <center>
                <?
                $clcriaabas->identifica = array("g1"=>"Relatório Despesa Ensino - Anexo III");
                $clcriaabas->title      = array("g1"=>"Relatório Despesa Ensino - Anexo III");
                $clcriaabas->src        = array("g1"=>"con2_anexo2despesaensino011_novo.php");
