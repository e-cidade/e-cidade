...
$campos = "afasta.r45_codigo as db_r45_codigo,
           ...
           z01_nome,
					 case afasta.r45_situac 
                          ...
                          when 8 then 'Afastado doenчa +30 dias'
                          when 9 then 'Licenчa por Motivo de Afastamento do Cєnjuge'
                          when 10 then 'Afastado doenчa -15 dias'
                          when 11 then 'Licenчa para concorrer a mandato eletivo'
                          when 12 then 'Prorrogaчуo Licenчa Maternidade'
                          when 13 then 'Outras licenчas remuneradas'
					 end as r45_situac,
           afasta.r45_dtlanc,
           afasta.r45_dtafas,
           afasta.r45_dtreto,
